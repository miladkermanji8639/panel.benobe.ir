import { c as X, g as $ } from './_commonjsHelpers-BosuxZz1.js';
var N = { exports: {} };
/*!
  ...
  return (function () {
   var k = {
     686: function (l, c, t) {
      ...
      var j = function () {
        ...
        if (u !== void 0)
         if (u && x(u) === 'object' && u.nodeType === 1) {
          ...
          if (
           r === 'cut' &&
           (u.hasAttribute('readonly') || u.hasAttribute('disabled'))
          )
           throw new Error(
            `Invalid "target" attribute. You can't cut text from elements with "readonly" or "disabled" attributes`,
           );
         } else throw new Error('Invalid "target" value, use a valid Element');
        if (m) return A(m, { container: o });
        if (u) return r === 'cut' ? p(u) : A(u, { container: o });
       },
       D = j;
      function _(i) {
       '@babel/helpers - typeof';
      ...
      function U(i, n) {
       return n && (_(n) === 'object' || typeof n == 'function') ? n : Y(i);
      }
      function Y(i) {
       if (i === void 0)
         ...
         H(
          ...
          [
            ...
            value: function () {
             var o =
              arguments.length > 0 && arguments[0] !== void 0
               ...
               : {};
             (this.action =
              typeof o.action == 'function' ? o.action : this.defaultAction),
              (this.target =
               typeof o.target == 'function' ? o.target : this.defaultTarget),
              (this.text =
               typeof o.text == 'function' ? o.text : this.defaultText),
              (this.container =
               _(o.container) === 'object' ? o.container : document.body);
            },
           },
           {
            key: 'listenClick',
           ...
           },
           {
            key: 'onClick',
            value: function (o) {
             var u = o.delegateTarget || o.currentTarget,
              m = this.action(u) || 'copy',
              T = D({
               action: m,
            ...
            value: function () {
             ...
             return (
              u.forEach(function (T) {
               m = m && !!document.queryCommandSupported(T);
              }),
              m
             );
            },
     ...
     879: function (l, c) {
      (c.node = function (t) {
       ...
       (c.nodeList = function (t) {
        ...
        return (
         t !== void 0 &&
         (a === '[object NodeList]' || a === '[object HTMLCollection]') &&
         'length' in t &&
   ...
   function b(l) {
    ...
    var c = (S[l] = { exports: {} });
    return k[l](c, c.exports, b), c.exports;
   }
   return (
    (function () {
     b.n = function (l) {
    ...
    (function () {
     b.d = function (l, c) {
      for (var t in c)
       b.o(c, t) &&
        !b.o(l, t) &&
        Object.defineProperty(l, t, { enumerable: !0, get: c[t] });
     };
    })(),
    (function () {
     b.o = function (l, c) {
