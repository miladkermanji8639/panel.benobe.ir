import { l as u } from './index-CrI7K4FP.js';
var c = { exports: {} },
 f = {},
 p = { exports: {} },
 h = {};
 ...
 F = (function (i) {
  function n(t) {
   ...
   return (
    ...
    (e.invalidFormHandler = e.onFormInvalid.bind(e)),
    e
   );
  }
  return (
   ...
   (n.prototype.install = function () {
    this.core
     ...
     .registerPlugin(n.FIELD_STATUS_PLUGIN, new b.FieldStatus());
   }),
   (n.prototype.uninstall = function () {
    this.core
   ...
   (n.prototype.onFormInvalid = function () {
    if (this.isEnabled) {
     var t = this.core.getPlugin(n.FIELD_STATUS_PLUGIN).getStatuses(),
      e = Object.keys(this.core.getFields()).filter(function (m) {
       return t.get(m) === 'Invalid';
      });
     if (e.length > 0) {
      var o = e[0],
       l = this.core.getElements(o);
      if (l.length > 0) {
       var d = l[0],
        s = { firstElement: d, field: o };
...
var S = c.exports;
try {
 FormValidation.plugins.AutoFocus = S.AutoFocus;
} catch {}
