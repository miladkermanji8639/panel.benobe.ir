 ...
 */ var g = {
  luhn: function (r) {
   for (
    ...
    (n += t[i][parseInt(r.charAt(e), 10)]), (i = 1 - i);
   return n % 10 == 0 && n > 0;
  },
  mod11And10: function (r) {
   for (var e = r.length, t = 5, i = 0; i < e; i++)
    t = (((2 * (t || 10)) % 11) + parseInt(r.charAt(i), 10)) % 10;
   return t === 1;
  },
  mod37And36: function (r, e) {
   e === void 0 && (e = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ');
   for (
    var t = r.length, i = e.length, n = Math.floor(i / 2), s = 0;
    s < t;
    s++
   )
    n = (((2 * (n || i)) % (i + 1)) + e.indexOf(r.charAt(s))) % i;
   return n === 1;
  },
 ...
 y = (function () {
  function r(e, t) {
   (this.fields = {}),
    ...
    (this.ee = {
     ...
     off: function (i, n) {
      if (this.fns[i]) {
       var s = this.fns[i].indexOf(n);
       s >= 0 && this.fns[i].splice(s, 1);
      }
     },
     on: function (i, n) {
      (this.fns[i] = this.fns[i] || []).push(n);
     },
    }),
    (this.filter = {
     filters: {},
     add: function (i, n) {
      (this.filters[i] = this.filters[i] || []).push(n);
     },
     clear: function () {
      this.filters = {};
     },
     execute: function (i, n, s) {
      if (!this.filters[i] || !this.filters[i].length) return n;
      for (var a = n, l = this.filters[i], d = l.length, o = 0; o < d; o++)
       a = l[o].apply(a, s);
      return a;
     },
     remove: function (i, n) {
  ...
  return (
     ...
     (t = this.ee).emit.apply(
      ...
      (function (s, a, l) {
       if (l || arguments.length === 2)
        for (var d, o = 0, u = a.length; o < u; o++)
         (!d && o in a) ||
          (d || (d = Array.prototype.slice.call(a, 0, o)), (d[o] = a[o]));
   ...
   (r.prototype.executeFilter = function (e, t, i) {
   ...
   (r.prototype.validateElement = function (e, t) {
    ...
    var a = Object.keys(s).map(function (l) {
     return function () {
      return i.executeValidator(e, t, l, s[l]);
     };
    });
    return this.waterfall(a)
     .then(function (l) {
      var d = l.indexOf('Invalid') === -1;
   ...
   (r.prototype.executeValidator = function (e, t, i, n) {
    var s = this,
     a = this.elements[e],
   ...
   (r.prototype.getElementValue = function (e, t, i) {
    var n = (function (s, a, l, d) {
     var o = (l.getAttribute('type') || '').toLowerCase(),
      u = l.tagName.toLowerCase();
     if (u === 'textarea') return l.value;
     if (u === 'select') {
      var f = l,
       c = f.selectedIndex;
   ...
   (r.prototype.updateFieldStatus = function (e, t, i) {
    var n = this,
     s = this.elements[e],
     a = s[0].getAttribute('type');
    if (
     ((a === 'radio' || a === 'checkbox' ? [s[0]] : s).forEach(function (l) {
      return n.updateElementStatus(e, l, t, i);
     }),
     i)
    )
     t === 'Invalid' &&
   ...
   (r.prototype.updateElementStatus = function (e, t, i, n) {
    var s = this,
     a = this.elements[e],
     ...
     case 'Valid':
      d.forEach(function (o) {
       return s.emit('core.validator.validated', {
        ...
        elements: a,
        field: e,
        result: { message: l[o].message, valid: !0 },
        validator: o,
       });
      }),
     ...
     case 'Invalid':
      d.forEach(function (o) {
       return s.emit('core.validator.validated', {
        ...
        elements: a,
        field: e,
        result: { message: l[o].message, valid: !1 },
        validator: o,
       });
      }),
       this.emit('core.element.validated', {
   ...
   (r.prototype.updateValidatorOption = function (e, t, i, n) {
    return (
     this.fields[e] &&
   ...
   (r.prototype.normalizeResult = function (e, t, i) {
   ...
   (r.prototype.toggleValidator = function (e, t, i) {
    var n = this,
     ...
     i && s && s[i]
      ...
      : i ||
        Object.keys(s).forEach(function (a) {
         return (n.fields[t].validators[a].enabled = e);
        }),
 ...
 V = {
  call: function (r, e) {
   ...
   if (typeof r == 'string') {
    ...
    for (
     var i = t.split('.'), n = i.pop(), s = window, a = 0, l = i;
     a < l.length;
     a++
    )
     s = s[l[a]];
    return s[n] === void 0 ? null : s[n].apply(this, e);
   }
  },
     ...
     return (function (s, a) {
      a.split(' ').forEach(function (l) {
       s.classList
        ...
        : (s.className = s.className.replace(l, ''));
      });
     })(r, n);
    }),
    t.forEach(function (n) {
     return (function (s, a) {
      a.split(' ').forEach(function (l) {
       s.classList
        ? s.classList.add(l)
        : ' '.concat(s.className, ' ').indexOf(' '.concat(l, ' ')) &&
          (s.className += ' '.concat(l));
      });
     })(r, n);
    });
  },
  closest: function (r, e) {
   for (var t = r; t && !E(t, e); ) t = t.parentElement;
   return t;
  },
  fetch: function (r, e) {
  ...
  isValidDate: function (r, e, t, i) {
   ...
   if (i === !0) {
    var n = new Date(),
     ...
     a = n.getMonth(),
     l = n.getDate();
    return r < s || (r === s && e - 1 < a) || (r === s && e - 1 === a && t < l);
   }
   return !0;
  },
 ...
 (m.formValidation = function (r, e) {
  ...
  return (
   ...
   Object.keys(t.plugins).forEach(function (n) {
    return i.registerPlugin(n, t.plugins[n]);
   }),
   t.init(i),
   Object.keys(t.fields).forEach(function (n) {
    return i.addField(n, t.fields[n]);
   }),
   i
  );
 }),
