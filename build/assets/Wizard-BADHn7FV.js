var E = (s, u) => () => (u || s((u = { exports: {} }).exports, u), u.exports);
var O = E((g, S) => {
 (function (s, u) {
  typeof g == 'object' && typeof S < 'u'
   ? (S.exports = u())
   : typeof define == 'function' && define.amd
     ...
     : ((s = typeof globalThis < 'u' ? globalThis : s || self),
       ...
       (s.FormValidation.plugins.Wizard = u()));
 })(void 0, function () {
  function s(e, n) {
   if (!(e instanceof n))
  ...
  var w = FormValidation.Plugin,
   f = FormValidation.utils.classSet,
   v = FormValidation.plugins.Excluded,
   y = (function (e) {
    _(r, e);
    var n = P(r);
    function r(i) {
     ...
     return (
      ...
      (t.prevStepHandler = t.onClickPrev.bind(h(t))),
      (t.nextStepHandler = t.onClickNext.bind(h(t))),
      t
     );
    }
    return (
     x(r, [
       ...
       value: function () {
        ...
        (this.steps = [].slice.call(
         ...
         this.steps.forEach(function (p) {
          f(p, c({}, t.opts.stepClass, !0));
         }),
         f(this.steps[0], c({}, this.opts.activeStepClass, !0)),
      ...
      },
      {
       key: 'uninstall',
       value: function () {
        this.core.deregisterPlugin(r.EXCLUDED_PLUGIN),
      ...
      },
      {
       ...
       value: function () {
        var t = this,
         o = this.currentStep - 1;
        if (!(o < 0)) {
         var p = this.opts.isStepSkipped
          ? this.stepIndexes
          ...
          : o;
         this.goToStep(p), this.onStepActive();
        }
       },
      },
      {
       ...
       value: function () {
        var t = this;
        this.core.validate().then(function (o) {
         if (o === 'Valid') {
          var p = t.currentStep + 1;
          if (p >= t.numSteps) t.currentStep = t.numSteps - 1;
          else {
           var a = t.opts.isStepSkipped
            ? t.stepIndexes.slice(p, t.numSteps).find(function (m, V) {
               return !t.opts.isStepSkipped({
                currentStep: t.currentStep,
                numSteps: t.numSteps,
                targetStep: m,
          ...
          t.onStepActive(), t.onStepValid(), p === t.numSteps && t.onValid();
         } else o === 'Invalid' && t.onStepInvalid();
        });
       },
      },
      {
       key: 'goToStep',
       value: function (t) {
        f(this.steps[this.currentStep], c({}, this.opts.activeStepClass, !1)),
         f(this.steps[t], c({}, this.opts.activeStepClass, !0)),
         (this.currentStep = t);
       },
      },
      {
  ...
  return (y.EXCLUDED_PLUGIN = '___wizardExcluded'), y;
 });
});
export default O();
