...
var j = P((y, p) => {
 (function (i, f) {
  typeof y == 'object' && typeof p < 'u'
   ...
   : typeof define == 'function' && define.amd
     ...
     : ((i = typeof globalThis < 'u' ? globalThis : i || self),
       ...
       (i.FormValidation.plugins.Bulma = f()));
 })(void 0, function () {
  function i(e, t) {
   if (!(e instanceof t))
  ...
  var c = FormValidation.utils.classSet,
     ...
     h(n, [
      {
       key: 'onIconPlaced',
       value: function (o) {
        c(o.iconElement, { 'fv-plugins-icon': !1 });
        var a = document.createElement('span');
        a.setAttribute('class', 'icon is-small is-right'),
         o.iconElement.parentNode.insertBefore(a, o.iconElement),
         a.appendChild(o.iconElement);
        var d = o.element.getAttribute('type'),
         l = o.element.parentElement;
        d === 'checkbox' || d === 'radio'
         ? (c(l.parentElement, { 'has-icons-right': !0 }),
           c(a, { 'fv-plugins-icon-check': !0 }),
           l.parentElement.insertBefore(a, l.nextSibling))
         : c(l, { 'has-icons-right': !0 });
       },
      },
     ]),
     n
