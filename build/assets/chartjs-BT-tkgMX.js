...
var _o = (i, t, e) =>
 t in i
  ? xo(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
  : (i[t] = e);
var M = (i, t, e) => (_o(i, typeof t != 'symbol' ? t + '' : t, e), e);
/*!
 * @kurkle/color v0.3.2
...
const it = {
 ...
 xi = [...'0123456789ABCDEF'],
 yo = (i) => xi[i & 15],
 vo = (i) => xi[(i & 240) >> 4] + xi[i & 15],
 we = (i) => (i & 240) >> 4 === (i & 15),
 Mo = (i) => we(i.r) && we(i.g) && we(i.b) && we(i.a);
function ko(i) {
 var t = i.length,
  e;
 return (
...
let Se;
function Io(i) {
 Se || ((Se = Fo()), (Se.transparent = [0, 0, 0, 0]));
...
function Yo(i, t, e) {
 ...
 A(s) && A(n)
  ? re(s, n)
  : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ke(n));
}
const es = { '': (i) => i, x: (i) => i.x, y: (i) => i.y };
function Xo(i) {
 const t = i.split('.'),
  e = [];
 let s = '';
...
function Dn(i, t) {
 ...
 return o < -0.5 * B && (o += z), { angle: o, distance: n };
}
function _i(i, t) {
...
const On = ['push', 'pop', 'shift', 'splice', 'unshift'];
function sa(i, t) {
 if (i._chartjs) {
...
const Wi = (i) => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center'),
...
function Ln(i, t, e) {
 ...
 if (i._sorted) {
  ...
  d &&
   (n = Y(
    Math.min(mt(r, l, c).lo, e ? s : mt(t, l, a.getPixelForValue(c)).lo),
    0,
    s - 1,
   )),
   u
...
const De = (i) => i === 0 || i === 1,
 rs = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * z) / e)),
 ls = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * z) / e) + 1,
 ce = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
  ...
  easeInElastic: (i) => (De(i) ? i : rs(i, 0.075, 0.3)),
  easeOutElastic: (i) => (De(i) ? i : ls(i, 0.075, 0.3)),
  easeInOutElastic(i) {
   return De(i)
    ? i
    : i < 0.5
      ? 0.5 * rs(i * 2, 0.1125, 0.45)
      : 0.5 + 0.5 * ls(i * 2 - 1, 0.1125, 0.45);
  },
  easeInBack(i) {
...
function cs(i) {
 return Ni(i) ? i : new ue(i);
}
function ri(i) {
 return Ni(i) ? i : new ue(i).saturate(0.5).darken(0.1).hexString();
}
const aa = ['x', 'y', 'borderWidth', 'radius', 'tension'],
 ra = ['color', 'borderColor', 'backgroundColor'];
function la(i) {
 i.set('animation', {
  delay: void 0,
  duration: 1e3,
  ...
  i.set('animations', {
   colors: { type: 'color', properties: ra },
   numbers: { type: 'number', properties: aa },
  }),
...
const En = {
 ...
 numeric(i, t, e) {
  ...
  if (e.length > 1) {
   ...
   (c < 1e-4 || c > 1e15) && (n = 'scientific'), (o = da(i, e));
  }
...
function pa(i, t, e, s) {
 ...
 let l, c, h, d, u;
 for (l = 0; l < r; l++)
  if (((d = e[l]), d != null && !I(d))) a = Ge(i, n, o, a, d);
  else if (I(d))
   for (c = 0, h = d.length; c < h; c++)
    (u = d[c]), u != null && !I(u) && (a = Ge(i, n, o, a, u));
 i.restore();
 const f = o.length / 2;
 if (f > e.length) {
  ...
  switch ((i.beginPath(), f)) {
   ...
   case 'rectRounded':
    (c = p * 0.516),
     (l = p - c),
     (a = Math.cos(m + Ot) * l),
     (d = Math.cos(m + Ot) * (n ? n / 2 - c : l)),
     (r = Math.sin(m + Ot) * l),
     (u = Math.sin(m + Ot) * (n ? n / 2 - c : l)),
     i.arc(e - d, s - r, c, m - B, m - j),
     i.arc(e + u, s - a, c, m - j, m),
     i.arc(e + d, s + r, c, m, m + j),
     i.arc(e - u, s + a, c, m + j, m + B),
     i.closePath();
    break;
   case 'rect':
    if (!g) {
...
function me(i, t) {
 ...
 i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * B, B, !0),
  ...
  i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, B, j, !0),
  i.lineTo(e + n - a.bottomRight, s + o),
  i.arc(e + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, j, 0, !0),
  i.lineTo(e + n, s + a.topRight),
  i.arc(e + n - a.topRight, s + a.topRight, a.topRight, 0, -j, !0),
  i.lineTo(e + a.topLeft, s);
}
const va = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
 Ma = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function ka(i, t) {
 const e = ('' + i).match(va);
...
function Hi(i, t) {
 const e = {},
  s = A(t),
  n = s ? Object.keys(t) : t,
  o = A(i) ? (s ? (a) => D(i[a], i[t[a]]) : (a) => i[a]) : () => i;
 for (const a of n) e[a] = wa(o(a));
 return e;
}
function In(i) {
 return Hi(i, { top: 'y', right: 'x', bottom: 'y', left: 'x' });
}
function Ft(i) {
 return Hi(i, ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']);
}
function G(i) {
 const t = In(i);
...
function $(i, t) {
 ...
 const n = {
  ...
  lineHeight: ka(D(i.lineHeight, t.lineHeight), e),
  size: e,
  style: s,
  weight: D(i.weight, t.weight),
  string: '',
 };
 return (n.string = ga(n)), n;
}
function ie(i, t, e, s) {
 let n = !0,
  o,
...
function Da(i, t, e) {
 ...
 let r = s[t];
 return (
  wt(r) && a.isScriptable(t) && (r = Oa(t, r, i, e)),
  I(r) && r.length && (r = Ca(t, r, i, a.isIndexable)),
  $i(t, r) && (r = Xt(r, n, o && o[t], a)),
  r
 );
}
function Oa(i, t, e, s) {
 ...
 r.add(i);
 let l = t(o, a || s);
 return r.delete(i), $i(i, l) && (l = Yi(n._scopes, n, i, l)), l;
}
function Ca(i, t, e, s) {
...
const Aa = (i, t) => (i === !0 ? t : typeof i == 'string' ? kt(t, i) : void 0);
...
function Yi(i, t, e, s) {
 const n = t._rootScopes,
  ...
  r = new Set();
 r.add(s);
 let l = us(r, a, e, o || e, s);
 return l === null ||
  (typeof o < 'u' && o !== e && ((l = us(r, a, o, l, s)), l === null))
  ? !1
  : ji(Array.from(r), [''], n, o, () => La(t, e, s));
}
function us(i, t, e, s, n) {
 for (; e; ) e = Ta(i, t, e, s, n);
 return e;
}
function La(i, t, e) {
...
function Ra(i, t, e, s) {
 let n;
 for (const o of t)
  if (((n = Wn(Pa(o, i), e)), typeof n < 'u'))
   return $i(i, n) ? Yi(e, s, i, n) : n;
}
function Wn(i, t) {
 for (const e of t) {
  if (!e) continue;
 ...
 for (e = 0, s = i.length; e < s; ++e)
  (a = o),
   ...
   o &&
    ((n = i[e]),
    a &&
     ((n.cp1x = Oe(n.cp1x, t.left, t.right)),
     (n.cp1y = Oe(n.cp1y, t.top, t.bottom))),
    r &&
     ((n.cp2x = Oe(n.cp2x, t.left, t.right)),
     (n.cp2y = Oe(n.cp2y, t.top, t.bottom))));
}
...
const $a = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function Ya(i, t) {
 const e = i.touches,
  s = e && e.length ? e[0] : i,
 ...
 if (t === void 0 || e === void 0) {
  ...
  if (!o) (t = i.clientWidth), (e = i.clientHeight);
   ...
   (t = a.width - c.width - l.width),
    ...
    (s = Ze(r.maxWidth, o, 'clientWidth')),
    (n = Ze(r.maxHeight, o, 'clientHeight'));
  }
 }
...
function Ua(i, t, e, s) {
 const n = ni(i),
  o = It(n, 'margin'),
  a = Ze(n.maxWidth, i, 'clientWidth') || qe,
  r = Ze(n.maxHeight, i, 'clientHeight') || qe,
  l = Xa(i, t, e);
...
function Yn(i) {
 return i === 'angle'
  ? { between: pe, compare: Qo, normalize: et }
...
function Xn(i, t, e) {
 ...
 const { property: s, start: n, end: o } = e,
  ...
  { start: h, end: d, loop: u, style: f } = Qa(i, t, e),
  g = [];
 let p = !1,
  m = null,
  b,
  ...
  (x = t[S % a]),
   !x.skip &&
    ...
    b !== v &&
     ...
     m !== null &&
      w() &&
      (g.push(ms({ start: m, end: S, loop: u, count: a, style: f })),
      (m = null)),
     (P = S),
     (v = b)));
 return (
  m !== null && g.push(ms({ start: m, end: d, loop: u, count: a, style: f })), g
 );
}
function Un(i, t) {
 const e = [],
...
function ir(i, t) {
 ...
 if (!n) return [];
 const o = !!i._loop,
  { start: a, end: r } = tr(e, n, o, s);
 if (s === !0) return bs(i, [{ start: a, end: r, loop: o }], e, t);
 const l = r < a ? r + n : r,
  c = !!i._fullLoop && a === 0 && r === n - 1;
 return bs(i, er(e, a, l, c), e, t);
}
function bs(i, t, e, s) {
...
class rr {
 constructor(t, e, s, n) {
  ...
  (this._active = !0),
   (this._fn = t.fn || ar[t.type || typeof a]),
...
class Kn {
 ...
 configure(t) {
  if (!A(t)) return;
  const e = Object.keys(N.animation),
   s = this._properties;
  Object.getOwnPropertyNames(t).forEach((n) => {
   ...
   ((I(o.properties) && o.properties) || [n]).forEach((r) => {
 ...
 _animateOptions(t, e) {
  ...
  return (
   s.$shared &&
    lr(t.options.$animations, s).then(
     () => {
      t.options = s;
     },
     () => {},
...
function vs(i, t, e, s = {}) {
 ...
 if (t !== null) {
  for (a = 0, r = n.length; a < r; ++a) {
   ...
   (c = i.values[l]), W(c) && (o || t === 0 || ct(t) === ct(c)) && (t += c);
  }
  return t;
 }
}
...
const hi = (i) => i === 'reset' || i === 'none',
 Ss = (i, t) => (t ? i : Object.assign({}, i)),
 xr = (i, t, e) =>
  i && !t.hidden && t._stacked && { keys: qn(e, !0), values: null };
class ot {
 constructor(t, e) {
  (this.chart = t),
   (this._ctx = t.ctx),
 ...
 linkScales() {
  const t = this.chart,
   ...
   o = (e.xAxisID = D(s.xAxisID, ci(t, 'x'))),
   a = (e.yAxisID = D(s.yAxisID, ci(t, 'y'))),
   r = (e.rAxisID = D(s.rAxisID, ci(t, 'r'))),
   l = e.indexAxis,
 ...
 _destroy() {
  const t = this._cachedMeta;
  this._data && as(this._data, this), t._stacked && Gt(t);
 }
 _dataCheck() {
  const t = this.getDataset(),
   e = t.data || (t.data = []),
   s = this._data;
  if (A(e)) this._data = ur(e);
  else if (s !== e) {
   if (s) {
    as(s, this);
   ...
   e && Object.isExtensible(e) && sa(e, this),
    (this._syncList = []),
    (this._data = e);
  }
 }
 ...
 applyStack(t, e, s) {
  const n = this.chart,
   o = this._cachedMeta,
   a = e[t.axis],
   r = { keys: qn(n, !0), values: e._stacks[t.axis]._visualValues };
  return vs(r, a, o.index, { mode: s });
 }
 updateRangeFromParsed(t, e, s, n) {
  const o = s[e.axis];
  let a = o === null ? NaN : o;
  const r = n && s._stacks[e.axis];
  n && r && ((n.values = r), (a = vs(n, o, this._cachedMeta.index))),
 ...
 _update(t) {
  ...
  this.update(t || 'default'),
   (e._clip = dr(
    D(this.options.clip, hr(e.xScale, e.yScale, this.getMaxOverflow())),
   ));
 }
 update(t) {}
 draw() {
 ...
 getContext(t, e, s) {
  ...
  if (t >= 0 && t < this._cachedMeta.data.length) {
   ...
   (o = a.$context || (a.$context = br(this.getContext(), t, a))),
    (o.parsed = this.getParsed(t)),
    (o.raw = n.data[t]),
    (o.index = o.dataIndex = t);
  } else
   (o =
    this.$context || (this.$context = mr(this.chart.getContext(), this.index))),
    (o.dataset = n),
 ...
 _resolveAnimations(t, e, s) {
  ...
  const c = new Kn(n, l && l.animations);
...
function Gn(i, t, e, s) {
 return I(i) ? kr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
}
function Ps(i, t, e, s) {
 const n = i.iScale,
  o = i.vScale,
...
function Pr(i, t, e, s) {
 ...
 const { start: a, end: r, reverse: l, top: c, bottom: h } = Sr(i);
 n === 'middle' &&
  e &&
...
function Ds(i, t, e, s) {
 return s ? ((i = Dr(i, t, e)), (i = Os(i, e, t))) : (i = Os(i, t, e)), i;
}
function Dr(i, t, e) {
...
class Be extends ot {
 ...
 updateElements(t, e, s, n) {
  ...
  for (let f = e; f < e + s; f++) {
   ...
   Pr(x, v, b, a), Or(x, v, h.ratio), this.updateElement(t[f], f, x, n);
  }
 }
 _getStacks(t, e) {
 ...
 _calculateBarIndexPixels(t, e) {
  ...
  if (e.grouped) {
   const c = o ? this._getStackCount(t) : e.stackCount,
    h = n.barThickness === 'flex' ? Mr(t, e, n, c) : vr(t, e, n, c),
...
function Cr(i, t, e) {
 ...
 if (t < z) {
  const r = i,
   ...
   d = Math.cos(l),
   u = Math.sin(l),
   f = (v, y, _) => (pe(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e)),
   g = (v, y, _) => (pe(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e)),
   p = f(0, c, d),
   m = f(j, h, u),
   b = g(B, c, d),
   x = g(B + j, h, u);
...
class Et extends ot {
 ...
 update(t) {
  const e = this.chart,
   ...
   l = Math.min(jo(this.options.cutout, r), 1),
  ...
  for (let _ = 0; _ < v; ++_) {
   ...
   const S = this.getParsed(_),
    ...
    C = (w[f] =
     o || P
      ? r.getBasePixel()
      : r.getPixelForValue(l ? this.applyStack(r, S, l) : S[f], _));
   (w.skip = isNaN(O) || isNaN(C) || P),
    (w.stop = _ > 0 && Math.abs(S[u] - y[u]) > m),
    p && ((w.parsed = S), (w.raw = c.data[_])),
    d &&
     (w.options =
      h || this.resolveDataElementOptions(_, k.active ? 'active' : n)),
  ...
  for (let y = e; y < e + s; ++y) {
   const _ = t[y],
    ...
    O = (w[g] =
     o || S
      ? r.getBasePixel()
      : r.getPixelForValue(l ? this.applyStack(r, k, l) : k[g], y));
...
function Lr(i, t, e, s) {
 ...
 if (r && t === r.axis && t !== 'r' && a && o.length) {
  const l = r._reversePixels ? ea : mt;
  if (s) {
   if (n._sharedOptions) {
    const c = o[0],
 ...
 modes: {
  index(i, t, e, s) {
   const n = Lt(t, i),
    ...
    r = e.intersect ? ui(i, n, o, s, a) : fi(i, n, o, !1, s, a),
    l = [];
   return r.length
...
const Zn = ['left', 'top', 'right', 'bottom'];
function Zt(i, t) {
...
function se(i, t, e, s) {
 ...
 for (o = 0, a = i.length, c = 0; o < a; ++o) {
  (r = i[o]),
   (l = r.box),
   l.update(r.width || t.w, r.height || t.h, jr(r.horizontal, t));
  const { same: d, other: u } = Nr(t, e, r, s);
...
const to = Ka ? { passive: !0 } : !1;
function Ur(i, t, e) {
 i.addEventListener(t, e, to);
}
function Kr(i, t, e) {
 i.canvas.removeEventListener(t, e, to);
}
function qr(i, t) {
 const e = Yr[i.type] || i.type,
  { x: s, y: n } = Lt(i, t);
 return {
  type: e,
  chart: t,
...
function Gr(i, t, e) {
 const s = i.canvas,
  n = new MutationObserver((o) => {
   let a = !1;
   for (const r of o)
    (a = a || Je(r.addedNodes, s)), (a = a && !Je(r.removedNodes, s));
   a && e();
  });
...
function Zr(i, t, e) {
 const s = i.canvas,
  n = new MutationObserver((o) => {
   let a = !1;
   for (const r of o)
    (a = a || Je(r.removedNodes, s)), (a = a && !Je(r.addedNodes, s));
   a && e();
  });
 return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
function Jr(i, t) {
 be.size || window.addEventListener('resize', eo), be.set(i, t);
}
function Qr(i) {
 be.delete(i), be.size || window.removeEventListener('resize', eo);
}
function tl(i, t, e) {
 const s = i.canvas,
  n = s && Ui(s);
...
class il extends Qn {
 ...
 addEventListener(t, e, s) {
  ...
  const n = t.$proxies || (t.$proxies = {}),
   a = { attach: Gr, detach: Zr, resize: tl }[e] || el;
  n[e] = a(t, e, s);
 }
 removeEventListener(t, e) {
  const s = t.$proxies || (t.$proxies = {}),
   n = s[e];
  if (!n) return;
  (({ attach: gi, detach: gi, resize: gi })[e] || Kr)(t, e, n), (s[e] = void 0);
 }
 getDevicePixelRatio() {
...
function nl(i, t) {
 const e = i.options.ticks,
  ...
  o = e.major.enabled ? rl(t) : [],
  a = o.length,
  r = o[0],
  l = o[a - 1],
  c = [];
 if (a > n) return ll(t, c, o, a / n), c;
 const h = al(o, t, n);
 if (a > 0) {
  let d, u;
  const f = a > 1 ? Math.round((l - r) / (a - 1)) : null;
  for (Te(t, c, h, L(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++)
   Te(t, c, h, o[d], o[d + 1]);
  return Te(t, c, h, l, L(f) ? t.length : l + f), c;
 }
 return Te(t, c, h), c;
}
function ol(i) {
...
const hl = (i) => (i === 'left' ? 'right' : i === 'right' ? 'left' : i),
...
function pl(i, t, e) {
 let s = Wi(i);
 return ((e && t !== 'right') || (!e && t === 'right')) && (s = hl(s)), s;
}
function ml(i, t, e, s) {
 ...
 if (i.isHorizontal()) {
  ...
  if (A(e)) {
   ...
   e === 'center' ? (f = (c.left + c.right) / 2 - m + t) : (f = Fs(i, e, t));
...
class Vt extends at {
 ...
 getUserBounds() {
  ...
  return (
   ...
   { min: tt(t, s), max: tt(e, n), minDefined: W(t), maxDefined: W(e) }
  );
 }
 getMinMax(t) {
  ...
  for (d = 0; d < e; d += l) {
   if (
    ...
    for (u = 0, f = g.length; u < f; ++u)
     (_ = g[u]), !L(_) && !I(_) && ((v = Ge(n, b.data, b.gc, v, _)), (y += x));
 ...
 getPixelForDecimal(t) {
  ...
  return ta(this._alignToPixels ? Ct(this.chart, e, 0) : e);
 }
 ...
 getContext(t) {
  ...
  return this.$context || (this.$context = fl(this.chart.getContext(), this));
 }
 _tickSize() {
  ...
  if (a === 'top')
   ...
   if (a === 'center') x = b((t.top + t.bottom) / 2 + 0.5);
    ...
    const V = Object.keys(a)[0],
     H = a[V];
    x = b(this.chart.scales[V].getPixelForValue(H));
   }
  ...
  if (n === 'top') (k = this.bottom - g), (w = this._getXAxisLabelAlignment());
   ...
   if (n === 'center') k = (t.top + t.bottom) / 2 + f;
    ...
    const E = Object.keys(n)[0],
     V = n[E];
    k = this.chart.scales[E].getPixelForValue(V) + f;
   }
    ...
    ? ((_ = S),
      ...
      n === 'top'
       ? c === 'near' || p !== 0
         ? (T = -C * O + O / 2)
         : c === 'center'
           ? (T = -Q.highest.height / 2 - V * O + O)
           : (T = -Q.highest.height + O / 2)
       : c === 'near' || p !== 0
         ? (T = O / 2)
         : c === 'center'
           ? (T = Q.highest.height / 2 - V * O)
           : (T = Q.highest.height - C * O),
      d && (T *= -1),
      p !== 0 && !E.showLabelBackdrop && (_ += (O / 2) * Math.sin(p)))
    : ((k = S), (T = ((1 - C) * O) / 2));
   let ke;
 ...
 drawTitle() {
  ...
  e === 'bottom' || e === 'center' || A(e)
   ...
   : (l += a.top);
  const { titleX: c, titleY: h, maxWidth: d, rotation: u } = ml(this, l, e, r);
  Bt(t, s.text, 0, 0, o, {
   color: s.color,
   maxWidth: d,
   rotation: u,
...
class Le {
 ...
 register(t) {
  ...
  return (
   o in n ||
    ((n[o] = t), bl(t, a, s), this.override && N.override(t.id, t.overrides)),
   a
  );
 }
 get(t) {
 ...
 unregister(t) {
  const e = this.items,
   ...
   n = this.scope;
  s in e && delete e[s],
   n && s in N[n] && (delete N[n][s], this.override && delete zt[s]);
 }
}
function bl(i, t, e) {
 const s = fe(Object.create(null), [e ? N.get(e) : {}, N.get(t), i.defaults]);
 N.set(t, s),
  i.defaultRoutes && xl(t, i.defaultRoutes),
  i.descriptors && N.describe(t, i.descriptors);
}
function xl(i, t) {
...
function wl(i, { plugins: t, localIds: e }, s, n) {
 const o = [],
  a = i.getContext();
 for (const r of t) {
  const l = r.id,
  ...
  c !== null &&
   o.push({
    plugin: r,
    options: Sl(i.config, { plugin: r, local: e[l] }, c, a),
   });
 }
 return o;
}
function Sl(i, { plugin: t, local: e }, s, n) {
...
function Pl(i, t) {
 let e = i;
 return (
  i === '_index_' ? (e = t) : i === '_value_' && (e = t === 'x' ? 'y' : 'x'), e
 );
}
function Dl(i, t) {
...
function wi(i, ...t) {
 ...
 for (const e of t) {
  const s =
   e.axis || Ol(e.position) || (i.length > 1 && Vs(i[0].toLowerCase()));
  if (s) return s;
 }
 throw new Error(
...
function Al(i, t) {
 ...
 return (
  Object.keys(s).forEach((a) => {
   ...
   const l = wi(a, r, Cl(a, i), N.scales[r.type]),
    c = Dl(l, n),
    h = e.scales || {};
  ...
  i.data.datasets.forEach((a) => {
   const r = a.type || i.type,
    l = a.indexAxis || ki(r, t),
    h = (zt[r] || {}).scales || {};
   Object.keys(h).forEach((d) => {
    const u = Pl(d, l),
     f = a[u + 'AxisID'] || u;
    (o[f] = o[f] || Object.create(null)), re(o[f], [{ axis: u }, s[f], h[d]]);
   });
  }),
  Object.keys(o).forEach((a) => {
   const r = o[a];
   re(r, [N.scales[r.type], N.scale]);
  }),
  o
 );
}
function io(i) {
 ...
 (t.plugins = D(t.plugins, {})), (t.scales = Al(i, t));
}
function so(i) {
 return (
  (i = i || {}), (i.datasets = i.datasets || []), (i.labels = i.labels || []), i
 );
}
function Tl(i) {
 return (i = i || {}), (i.data = so(i.data)), io(i), i;
}
const Ns = new Map(),
 no = new Set();
function Re(i, t) {
 let e = Ns.get(i);
 return e || ((e = t()), Ns.set(i, e), no.add(e)), e;
}
const te = (i, t, e) => {
 const s = kt(t, e);
 s !== void 0 && i.add(s);
 ...
 getOptionScopes(t, e, s) {
  ...
  e.forEach((h) => {
   t && (l.add(t), h.forEach((d) => te(l, t, d))),
    ...
    h.forEach((d) => te(l, N, d)),
    h.forEach((d) => te(l, yi, d));
  });
  const c = Array.from(l);
  return (
   c.length === 0 && c.push(Object.create(null)), no.has(e) && a.set(e, c), c
  );
 }
 chartOptionScopes() {
  const { options: t, type: e } = this;
  return [t, zt[e] || {}, N.datasets[e] || {}, { type: e }, N, yi];
 }
...
const Rl = (i) => A(i) && Object.getOwnPropertyNames(i).some((t) => wt(i[t]));
function El(i, t) {
 ...
 for (const n of t) {
  const o = e(n),
   a = s(n),
   r = (a || o) && i[n];
  if ((o && (wt(r) || Rl(r))) || (a && I(r))) return !0;
 }
 return !1;
}
var Fl = '4.4.1';
const Il = ['top', 'bottom', 'left', 'right', 'chartArea'];
function js(i, t) {
 return i === 'top' || i === 'bottom' || (Il.indexOf(i) === -1 && t === 'x');
}
function $s(i, t) {
 return function (e, s) {
...
class gt {
 ...
 constructor(t, e) {
  ...
  (this.platform = new (s.platform || sl(n))()), this.platform.updateConfig(s);
  ...
  if (
   ...
   (this.scales = {}),
   (this._plugins = new vl()),
   (this.$proxies = {}),
   (this._hiddenIndices = {}),
   (this.attached = !1),
   (this._animationsDisabled = void 0),
   (this.$context = void 0),
   (this._doResize = na((d) => this.update(d), a.resizeDelay || 0)),
   (this._dataChanges = []),
   ($e[this.id] = this),
   !r || !l)
  ) {
  ...
  dt.listen(this, 'complete', Ys),
   dt.listen(this, 'progress', zl),
   this._initialize(),
 ...
 _initialize() {
  return (
   ...
   this.options.responsive
    ? this.resize()
    : gs(this, this.options.devicePixelRatio),
   this.bindEvents(),
 ...
 buildOrUpdateControllers() {
  ...
  for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
   ...
   if (
    ...
    (a.type = r),
    (a.indexAxis = o.indexAxis || ki(r, this.options)),
    (a.order = o.order || 0),
    (a.index = s),
    (a.label = '' + o.label),
    ...
    const l = lt.getController(r),
     { datasetElementType: c, dataElementType: h } = N.datasets[r];
    Object.assign(l, {
 ...
 _checkEventBindings() {
  const t = this.options,
   ...
   s = new Set(t.events);
  (!is(e, s) || !!this._responsiveListeners !== t.responsive) &&
 ...
 _getUniformDataChanges() {
  ...
  const e = this.data.datasets.length,
   ...
   n = s(0);
  for (let o = 1; o < e; o++) if (!is(n, s(o))) return;
  return Array.from(n)
   .map((o) => o.split(','))
 ...
 render() {
  this.notifyPlugins('beforeRender', { cancelable: !0 }) !== !1 &&
   (dt.has(this)
    ? this.attached && !dt.running(this) && dt.start(this)
 ...
 getContext() {
  return (
   this.$context || (this.$context = St(null, { chart: this, type: 'chart' }))
  );
 }
 ...
 _stop() {
  let t, e;
  for (
   this.stop(), dt.remove(this), t = 0, e = this.data.datasets.length;
   t < e;
   ++t
  )
 ...
 _updateHoverStyles(t, e, s) {
  const n = this.options.hover,
   o = (l, c) =>
    l.filter(
     (h) =>
      !c.some((d) => h.datasetIndex === d.datasetIndex && h.index === d.index),
    ),
   a = o(e, t),
   r = s ? t : o(t, e);
...
function Hl(i) {
 return Hi(i, ['outerStart', 'outerEnd', 'innerStart', 'innerEnd']);
}
function jl(i, t, e, s) {
 const n = Hl(i.options.borderRadius),
  o = (e - t) / 2,
  a = Math.min(o, (s * t) / 2),
  r = (l) => {
...
function Qe(i, t, e, s, n, o) {
 ...
 if ((i.beginPath(), o)) {
  ...
  const V = jt(T, x, a, r);
  if ((i.lineTo(V.x, V.y), k > 0)) {
   const U = jt(T, Q, a, r);
   i.arc(U.x, U.y, k, x + j, Q + Math.PI);
  }
  const H = (x - k / u + (b + _ / u)) / 2;
  if (
   (i.arc(a, r, u, x - k / u, H, !0), i.arc(a, r, u, H, b + _ / u, !0), _ > 0)
  ) {
   const U = jt(C, X, a, r);
...
function Yl(i, t, e, s, n) {
 ...
 f && Nl(i, t, g), o || (Qe(i, t, e, s, g, n), i.stroke());
}
class ne extends at {
 constructor(e) {
  super();
 ...
 draw(e) {
  ...
  const c = 1 - Math.sin(Math.min(B, n || 0)),
   h = o * c;
...
function Kl(i, t, e, s) {
 const { points: n, options: o } = t,
  { count: a, start: r, loop: l, ilen: c } = ro(n, e, s),
  h = Ul(o);
 ...
 for (f = 0; f <= c; ++f)
  (g = n[(r + (u ? c - f : f)) % a]),
   !g.skip &&
    (d ? (i.moveTo(g.x, g.y), (d = !1)) : h(i, p, g, u, o.stepped), (p = g));
 return l && ((g = n[(r + (u ? c : 0)) % a]), h(i, p, g, u, o.stepped)), !!l;
}
function ql(i, t, e, s) {
 const n = t.points,
  { count: o, start: a, ilen: r } = ro(n, e, s),
...
const Ql = typeof Path2D == 'function';
function tc(i, t, e, s) {
 Ql && !t.options.segment ? Zl(i, t, e, s) : Jl(i, t, e, s);
}
class yt extends at {
 constructor(t) {
  super(),
 ...
 updateControlPoints(t, e) {
  ...
  if (
   ...
   Na(this._points, s, t, n, e), (this._pointsUpdated = !0);
  }
 }
 set points(t) {
  (this._points = t),
 ...
 draw(t, e, s, n) {
  ...
  (this.points || []).length &&
   o.borderWidth &&
   (t.save(), tc(t, this, s, n), t.restore()),
...
class Ye extends at {
 ...
 inRange(e, s, n) {
  ...
  return (
   Math.pow(e - a, 2) + Math.pow(s - r, 2) < Math.pow(o.hitRadius + o.radius, 2)
  );
 }
 inXRange(e, s) {
...
const Pi = [
 ...
 qs = Pi.map((i) => i.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function co(i) {
 return Pi[i % Pi.length];
}
function ho(i) {
 return qs[i % qs.length];
}
function rc(i, t) {
 return (i.borderColor = co(t)), (i.backgroundColor = ho(t)), ++t;
}
function lc(i, t) {
...
var uc = {
 ...
 beforeLayout(i, t, e) {
  ...
  const {
   ...
   { elements: o } = n;
  if (!e.forceOverride && (Gs(s) || dc(n) || (o && Gs(o)))) return;
  const a = hc(i);
  s.forEach(a);
 },
};
 ...
 beforeElementsUpdate: (i, t, e) => {
  ...
  i.data.datasets.forEach((n, o) => {
   const { _data: a, indexAxis: r } = n,
    ...
    c = a || n.data;
   if (ie([r, i.options.indexAxis]) === 'y' || !l.controller.supportsDecimation)
    return;
   const h = i.scales[l.xAxisID];
   if ((h.type !== 'linear' && h.type !== 'time') || i.options.parsing) return;
   let { start: d, count: u } = pc(l, c);
...
function Di(i, t, e, s) {
 ...
 let n = t[i],
  o = e[i];
 return (
  i === 'angle' && ((n = et(n)), (o = et(o))), { property: i, start: n, end: o }
 );
}
function xc(i, t) {
...
function fo(i, t) {
 let e = [],
  s = !1;
 return (
  I(i) ? ((s = !0), (e = i)) : (e = xc(i, t)),
  e.length
   ? new yt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
   : null
 );
}
function Qs(i) {
...
function Sc(i) {
 const { scale: t, index: e, line: s } = i,
  ...
  a = s.points,
  r = Pc(t, e);
 r.push(fo({ x: null, y: t.bottom }, s));
 for (let l = 0; l < o.length; l++) {
  const c = o[l];
  for (let h = c.start; h <= c.end; h++) Dc(n, a[h], r);
 }
...
function Dc(i, t, e) {
 ...
 for (let n = 0; n < e.length; n++) {
  const o = e[n],
   { first: a, last: r, point: l } = Oc(o, t, 'x');
  if (!(!l || (a && r))) {
   if (a) s.unshift(l);
...
function Cc(i) {
 ...
 if (W(e)) return Ac(t, e);
 if (e === 'stack') return Sc(i);
 if (e === 'shape') return !0;
 const n = Tc(i);
 return n instanceof go ? n : fo(n, s);
}
function Ac(i, t) {
...
function Tc(i) {
 return (i.scale || {}).getPointPositionForValue ? Rc(i) : Lc(i);
}
function Lc(i) {
...
function Rc(i) {
 ...
 if (s.grid.circular) {
  ...
  return new go({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(a) });
 }
...
function bi(i, t, e) {
 ...
 s &&
  n.points.length &&
  (ii(i, e),
  Ec(i, { line: n, target: s, above: h, below: d, area: e, scale: o, axis: a }),
  si(i));
}
function Ec(i, t) {
 ...
 i.save(),
  l === 'x' &&
   o !== n &&
   (tn(i, s, a.top),
   en(i, { line: e, target: s, color: n, scale: r, property: l }),
   i.restore(),
   i.save(),
   tn(i, s, a.bottom)),
  en(i, { line: e, target: s, color: o, scale: r, property: l }),
  i.restore();
}
function tn(i, t, e) {
...
function en(i, t) {
 ...
 for (const { source: l, target: c, start: h, end: d } of r) {
  const { style: { backgroundColor: u = o } = {} } = l,
   f = s !== !0;
  i.save(), (i.fillStyle = u), Fc(i, a, f && Di(n, h, d)), i.beginPath();
  const g = !!e.pathSegment(i, l);
  let p;
  if (f) {
   g ? i.closePath() : sn(i, s, d, n);
...
var Ic = {
 ...
 afterDatasetsUpdate(i, t, e) {
  ...
  for (a = 0; a < s; ++a)
   (o = i.getDatasetMeta(a)),
    ...
    n.push(l);
  for (a = 0; a < s; ++a)
   (l = n[a]), !(!l || l.fill === !1) && (l.fill = _c(n, a, e.propagate));
 },
 beforeDraw(i, t, e) {
 ...
 beforeDatasetsDraw(i, t, e) {
  ...
  for (let n = s.length - 1; n >= 0; --n) {
   const o = s[n].$filler;
   Qs(o) && bi(i.ctx, o, i.chartArea);
  }
 },
 beforeDatasetDraw(i, t, e) {
  const s = t.meta.$filler;
  !Qs(s) || e.drawTime !== 'beforeDatasetDraw' || bi(i.ctx, s, i.chartArea);
 },
...
class on extends at {
 ...
 _fitCols(t, e, s, n) {
  ...
  return (
   this.legendItems.forEach((m, b) => {
    const { itemWidth: x, itemHeight: v } = Bc(s, e, o, m, n);
    b > 0 &&
     f + v + 2 * r > h &&
     ((d += u + r),
 ...
 adjustHitBoxes() {
  ...
  if (this.isHorizontal()) {
   ...
   for (const c of e)
    r !== c.row &&
     ((r = c.row), (l = K(s, this.left + n, this.right - this.lineWidths[r]))),
     (c.top += this.top + t + n),
   ...
   b = function (k, w, S) {
    ...
    if (
     ...
     const O = {
      ...
      C = l.xPlus(k, g / 2),
      T = w + u;
     Fn(n, O, C, T, a.pointStyleWidth && g);
    } else {
   ...
   l.setWidth(this.width),
    v
     ...
     : w > 0 &&
       ...
       f.line++,
       (T = f.y = K(o, this.top + y + h, this.bottom - e[f.line].height)));
   const X = l.x(C);
   if (
    (b(X, T, k),
    (C = oa(P, C + g + u, v ? C + O : this.right, t.rtl)),
    x(l.x(C), T, k),
    v)
   )
    f.x += O + h;
...
function Wc(i, t, e) {
 let s = i;
 return typeof t.text != 'string' && (s = po(t, e)), s;
}
function po(i, t) {
 ...
 _drawArgs(t) {
  ...
  return (
   this.isHorizontal()
    ...
    : (a.position === 'left'
       ? ((h = s + t), (d = K(r, n, e)), (l = B * -0.5))
       : ((h = o - t), (d = K(r, e, n)), (l = B * 0.5)),
      (c = n - e)),
...
function jc(i, t) {
 const e = new Gi({ ctx: i.ctx, options: t, chart: i });
...
var Yc = {
 id: 'subtitle',
 start(i, t, e) {
  const s = new Gi({ ctx: i.ctx, options: e, chart: i });
  q.configure(i, s, e), q.addBox(i, s), Fe.set(i, s);
 },
 stop(i) {
  q.removeBox(i, Fe.get(i)), Fe.delete(i);
 },
 beforeUpdate(i, t, e) {
  const s = Fe.get(i);
  q.configure(i, s, e), (s.options = e);
...
function rn(i, t, e) {
 const s = e.yAlign || t.yAlign || Uc(i, e);
 return { xAlign: e.xAlign || t.xAlign || qc(i, t, e, s), yAlign: s };
}
function Gc(i, t) {
 let { x: e, width: s } = i;
...
class Oi extends at {
 ...
 _resolveAnimations() {
  ...
  const e = this.chart,
   ...
   o = new Kn(this.chart, n);
  return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
 }
 getContext() {
  return (
   this.$context ||
   (this.$context = Jc(this.chart.getContext(), this, this._tooltipItems))
  );
 }
 getTitle(t, e) {
  const { callbacks: s } = e,
  ...
  return (
   R(t, (o) => {
    const a = { before: [], lines: [], after: [] },
     r = hn(s, o);
    rt(a.before, ut(Z(r, 'beforeLabel', this, o))),
     rt(a.lines, Z(r, 'label', this, o)),
     rt(a.after, ut(Z(r, 'afterLabel', this, o))),
     n.push(a);
   }),
   n
  );
  ...
  if (!n)
   return e.filter(
    (r) =>
     ...
     this.chart.getDatasetMeta(r.datasetIndex).controller.getParsed(r.index) !==
      void 0,
   );
...
function ih(i, t, e, s) {
 const n = i.indexOf(t);
 if (n === -1) return eh(i, t, e, s);
 const o = i.lastIndexOf(t);
 return n !== o ? e : n;
}
const sh = (i, t) => (i === null ? null : Y(Math.round(i), 0, t));
function dn(i) {
...
class Ci extends Vt {
 ...
 parse(t, e) {
  ...
  const s = this.getLabels();
  return (
   (e = isFinite(e) && s[e] === t ? e : ih(s, t, D(e, t), this._addedLabels)),
   sh(e, s.length - 1)
  );
 }
 determineDataLimits() {
...
M(Ci, 'id', 'category'), M(Ci, 'defaults', { ticks: { callback: dn } });
function nh(i, t) {
 const e = [],
  {
   bounds: n,
 ...
 (P = Math.ceil(m / _) - Math.floor(p / _)),
  P > g && (_ = ns((P * _) / g / f) * f),
  L(l) || ((k = Math.pow(10, l)), (_ = Math.ceil(_ * k) / k)),
  n === 'ticks'
   ? ((w = Math.floor(p / _) * _), (S = Math.ceil(m / _) * _))
   : ((w = p), (S = m)),
  b && x && o && Jo((r - a) / o, _ / 1e3)
   ...
   : v
     ...
     : ((P = (S - w) / _),
       le(P, Math.round(P), _ / 1e3)
        ? (P = Math.round(P))
        : (P = Math.ceil(P)));
 const O = Math.max(os(_), os(w));
 (k = Math.pow(10, L(l) ? O : l)),
  (w = Math.round(w * k) / k),
  (S = Math.round(S * k) / k);
 let C = 0;
 for (
  ...
  (u && w !== a
   ? (e.push({ value: a }),
     w < a && C++,
     le(Math.round((w + C * _) * k) / k, a, un(a, y, i)) && C++)
   : w < a && C++);
  C < P;
  ++C
 ) {
  const T = Math.round((w + C * _) * k) / k;
  if (x && T > r) break;
  e.push({ value: T });
 }
 return (
...
M(Ai, 'id', 'linear'),
 M(Ai, 'defaults', { ticks: { callback: ei.formatters.numeric } });
 ...
 determineDataLimits() {
  ...
  (this.min = W(t) ? Math.max(0, t) : null),
   ...
   this._zero &&
    ...
    !W(this._userMin) &&
    (this.min = t === Tt(this.min, 0) ? Tt(this.min, -1) : Tt(this.min, 0)),
   this.handleTickRangeOptions();
 }
 handleTickRangeOptions() {
  const { minDefined: t, maxDefined: e } = this.getUserBounds();
  ...
  return (
   ...
   t === null || isNaN(t)
    ...
    : this.getPixelForDecimal(
       t === this.min ? 0 : (_t(t) - this._startValue) / this._valueRange,
      )
  );
 }
 getValueForPixel(t) {
...
function rh(i, t, e) {
 return (
  (e = I(e) ? e : [e]), { w: pa(i, t.string, e), h: e.length * t.lineHeight }
 );
}
...
function uh(i, t, e) {
 const s = [],
  ...
  l = { extra: Li(o) / 2, additionalAngle: a ? B / n : 0 };
 let c;
 for (let h = 0; h < n; h++) {
  (l.padding = e[h]), (l.size = t[h]);
  const d = hh(i, h, l);
  s.push(d), r === 'auto' && ((d.visible = dh(d, c)), d.visible && (c = d));
 }
 return s;
}
function fh(i) {
...
function mh(i, t, e) {
 ...
 if (!L(r)) {
  ...
  Object.values(l).some((g) => g !== 0)
   ? (i.beginPath(), me(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill())
   : i.fillRect(h, d, u, f);
 }
}
function bh(i, t) {
...
class ae extends ti {
 ...
 setDimensions() {
  const t = (this._padding = G(Li(this.options) / 2)),
 ...
 drawGrid() {
  ...
  let r, l, c;
  if (
   (e.pointLabels.display && bh(this, a),
   n.display &&
...
class _e extends Vt {
 ...
 init(t, e = {}) {
  const s = t.time || (t.time = {}),
   n = (this._adapter = new Tr._date(t.adapters.date));
  n.init(e),
 ...
 buildTicks() {
  ...
  return (
   (this._unit =
    e.unit ||
    (s.autoSkip
     ? xn(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
     : yh(this, r.length, e.minUnit, this.min, this.max))),
   (this._majorUnit =
    !s.major.enabled || this._unit === 'year' ? void 0 : vh(this._unit)),
   this.initOffsets(n),
   t.reverse && r.reverse(),
 ...
 _getLabelCapacity(t) {
  const e = this.options.time,
   ...
   o = this._tickFormatFunction(t, 0, yn(this, [t], this._majorUnit), n),
   a = this._getLabelSize(o),
   r =
    Math.floor(this.isHorizontal() ? this.width / a.w : this.height / a.h) - 1;
  return r > 0 ? r : 1;
 }
 getDataTimestamps() {
...
function ze(i, t, e) {
 ...
 e
  ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = mt(i, 'pos', t)),
    ({ pos: o, time: r } = i[s]),
    ({ pos: a, time: l } = i[n]))
  : (t >= i[s].time && t <= i[n].time && ({ lo: s, hi: n } = mt(i, 'time', t)),
    ({ time: o, pos: r } = i[s]),
    ({ time: a, pos: l } = i[n]));
 const c = a - o;
...
class Ri extends _e {
 ...
 initOffsets() {
  ...
  (this._minPos = ze(e, this.min)),
   (this._tableRange = ze(e, this.max) - this._minPos),
   super.initOffsets(t);
 }
 buildLookupTable(t) {
...
M(Ri, 'id', 'timeseries'), M(Ri, 'defaults', _e.defaults);
