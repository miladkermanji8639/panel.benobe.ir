 ...
 * Licensed under the MIT license */ (function (_t) {
 (function (u, yt, Qt, l) {
  var Pt = ['', 'webkit', 'Moz', 'MS', 'ms', 'o'],
   jt = yt.createElement('div'),
   Kt = 'function',
   L = Math.round,
   S = Math.abs,
   at = Date.now;
...
`;
    ...
    var n = new Error('get-stack-trace'),
     s =
      n && n.stack
       ...
       : 'Unknown Stack Trace',
     a = u.console && (u.console.warn || u.console.log);
  ...
  function lt(t, e) {
   return typeof t == Kt ? t.apply((e && e[0]) || l, e) : t;
  }
  function At(t, e) {
   return t === l ? e : t;
  }
  ...
  function J(t, e) {
   for (var i, r, n = e[0].toUpperCase() + e.slice(1), s = 0; s < Pt.length; ) {
    if (((i = Pt[s]), (r = i ? i + n : e), r in t)) return r;
    s++;
   }
   return l;
  }
  ...
  var ie = /mobile|tablet|ip(ad|hone|od)|android/i,
   Mt = 'ontouchstart' in u,
   re = J(u, 'PointerEvent') !== l,
   ne = Mt && ie.test(navigator.userAgent),
   b = 'touch',
   se = 'pen',
   ct = 'mouse',
   ae = 'kinect',
  ...
  d.prototype = {
   ...
   init: function () {
    this.evEl && k(this.element, this.evEl, this.domHandler),
     ...
     this.evWin && k(Dt(this.element), this.evWin, this.domHandler);
   },
   destroy: function () {
    this.evEl && z(this.element, this.evEl, this.domHandler),
     this.evTarget && z(this.target, this.evTarget, this.domHandler),
     this.evWin && z(Dt(this.element), this.evWin, this.domHandler);
   },
  };
  function he(t) {
   var e,
   ...
   return (
    i ? (e = i) : re ? (e = ft) : ne ? (e = tt) : Mt ? (e = vt) : (e = $),
    new e(t, le)
   );
  }
  function le(t, e, i) {
  ...
  function ce(t, e) {
   ...
   i.firstInput || (i.firstInput = Lt(e)),
    n > 1 && !i.firstMultiple
     ? (i.firstMultiple = Lt(e))
     : n === 1 && (i.firstMultiple = !1);
   var s = i.firstInput,
    a = i.firstMultiple,
   ...
   (e.overallVelocityX = v.x),
    ...
    (e.overallVelocity = S(v.x) > S(v.y) ? v.x : v.y),
    (e.scale = a ? pe(a.pointers, r) : 1),
    (e.rotation = a ? ve(a.pointers, r) : 0),
  ...
  function fe(t, e) {
   var i = t.lastInterval || e,
    r = e.timeStamp - i.timeStamp,
    n,
    s,
    a,
    h;
   if (e.eventType != p && (r > oe || i.velocity === l)) {
    var c = e.deltaX - i.deltaX,
     v = e.deltaY - i.deltaY,
     y = Yt(r, c, v);
    (s = y.x),
     (a = y.y),
     (n = S(y.x) > S(y.y) ? y.x : y.y),
     (h = Ht(c, v)),
     (t.lastInterval = e);
   } else
  ...
  function xt(t) {
   var e = t.length;
   if (e === 1) return { x: L(t[0].clientX), y: L(t[0].clientY) };
  ...
  function Ht(t, e) {
   return t === e ? Q : S(t) >= S(e) ? (t < 0 ? X : F) : e < 0 ? V : W;
  }
  function K(t, e, i) {
   i || (i = Rt);
   var r = e[i[0]] - t[i[0]],
  ...
  function ve(t, e) {
   return ut(e[1], e[0], j) + ut(t[1], t[0], j);
  }
  function pe(t, e) {
   return K(e[0], e[1], j) / K(t[0], t[1], j);
  }
  var Te = { mousedown: f, mousemove: M, mouseup: o },
   de = 'mousedown',
  ...
  var Ee = {
   ...
   ge = { 2: b, 3: se, 4: ct, 5: ae },
   bt = 'pointerdown',
   Xt = 'pointermove pointerup pointercancel';
  u.MSPointerEvent &&
   !u.PointerEvent &&
   ((bt = 'MSPointerDown'), (Xt = 'MSPointerMove MSPointerUp MSPointerCancel'));
  function ft() {
   (this.evEl = bt),
    (this.evWin = Xt),
    d.apply(this, arguments),
  ...
  T(ft, d, {
   handler: function (e) {
    var i = this.store,
     ...
     s = Ee[n],
     a = ge[e.pointerType] || e.pointerType,
     h = a == b,
     c = Y(i, e.pointerId, 'pointerId');
    s & f && (e.button === 0 || h)
     ? c < 0 && (i.push(e), (c = i.length - 1))
     : s & (o | p) && (r = !0),
     !(c < 0) &&
      ((i[c] = e),
  ...
  var Ie = { touchstart: f, touchmove: M, touchend: o, touchcancel: p },
   _e = 'touchstart',
  ...
  T(Ft, d, {
   handler: function (e) {
    ...
    if ((i === f && (this.started = !0), !!this.started)) {
     var r = Pe.call(this, e, i);
     i & (o | p) && r[0].length - r[1].length === 0 && (this.started = !1),
      this.callback(this.manager, i, {
       pointers: r[0],
       changedPointers: r[1],
       pointerType: b,
  ...
  var Ne = { touchstart: f, touchmove: M, touchend: o, touchcancel: p },
  ...
  function Ae(t, e) {
   var i = B(t.touches),
    r = this.targetIds;
   if (e & (f | M) && i.length === 1) return (r[i[0].identifier] = !0), [i, i];
   var n,
    s,
   ...
   for (n = 0; n < a.length; )
    r[a[n].identifier] && h.push(a[n]),
     e & (o | p) && delete r[a[n].identifier],
     n++;
   if (h.length) return [St(s.concat(h), 'identifier', !0), h];
  }
  var Ce = 2500,
   Vt = 25;
  function vt() {
  ...
  T(vt, d, {
   handler: function (e, i, r) {
    var n = r.pointerType == b,
     s = r.pointerType == ct;
    if (!(s && r.sourceCapabilities && r.sourceCapabilities.firesTouchEvents)) {
     if (n) Se.call(this, i, r);
     else if (s && De.call(this, r)) return;
     this.callback(e, i, r);
    }
   },
   destroy: function () {
  ...
  function Se(t, e) {
   t & f
    ? ((this.primaryTouch = e.changedPointers[0].identifier), Wt.call(this, e))
    : t & (o | p) && Wt.call(this, e);
  }
  function Wt(t) {
  ...
  function De(t) {
   for (
    var e = t.srcEvent.clientX, i = t.srcEvent.clientY, r = 0;
    ...
    var n = this.lastTouches[r],
     s = Math.abs(e - n.x),
     a = Math.abs(i - n.y);
    if (s <= Vt && a <= Vt) return !0;
   }
   return !1;
  }
  var qt = J(jt.style, 'touchAction'),
   wt = qt !== l,
   Gt = 'compute',
   kt = 'auto',
   pt = 'manipulation',
   ...
   set: function (t) {
    t == Gt && (t = this.compute()),
     wt &&
      ...
      et[t] &&
      (this.manager.element.style[qt] = t),
  ...
  function Me(t) {
   ...
   var e = D(t, q),
    i = D(t, w);
   return e && i ? R : e || i ? (e ? q : w) : D(t, pt) ? pt : kt;
  }
  function Ue() {
   if (!wt) return !1;
   var t = {},
  ...
  function O(t) {
   (this.options = g({}, this.defaults, t || {})),
    (this.id = ee()),
    (this.manager = null),
    (this.options.enable = At(this.options.enable, !0)),
    (this.state = it),
    (this.simultaneous = {}),
    (this.requireFail = []);
  }
  O.prototype = {
   ...
   set: function (t) {
    return (
     g(this.options, t), this.manager && this.manager.touchAction.update(), this
    );
   },
   ...
   dropRecognizeWith: function (t) {
    return x(t, 'dropRecognizeWith', this)
     ? this
   ...
   requireFailure: function (t) {
    ...
    return (
     (t = rt(t, this)),
     Y(e, t) === -1 && (e.push(t), t.requireFailure(this)),
     this
    );
   },
   ...
   canEmit: function () {
    for (var t = 0; t < this.requireFail.length; ) {
     if (!(this.requireFail[t].state & (_ | it))) return !1;
     t++;
    }
    return !0;
   },
   recognize: function (t) {
    ...
    this.state & (N | G | _) && (this.state = it),
     (this.state = this.process(e)),
     this.state & (m | H | C | G) && this.tryEmit(e);
   },
   process: function (t) {},
  ...
  T(nt, E, {
   defaults: { event: 'pan', threshold: 10, pointers: 1, direction: Ut },
   getTouchAction: function () {
   ...
   attrTest: function (t) {
    return (
     ...
     (this.state & m || (!(this.state & m) && this.directionTest(t)))
    );
   },
   emit: function (t) {
  ...
  T(dt, E, {
   ...
   attrTest: function (t) {
    return (
     ...
     (Math.abs(t.scale - 1) > this.options.threshold || this.state & m)
    );
   },
   emit: function (t) {
    if (t.scale !== 1) {
  ...
  T(mt, O, {
   ...
   process: function (t) {
    ...
    else if (t.eventType & o) return N;
    return _;
   },
   reset: function () {
  ...
  T(Et, E, {
   ...
   attrTest: function (t) {
    return (
     this._super.attrTest.call(this, t) &&
     (Math.abs(t.rotation) > this.options.threshold || this.state & m)
    );
   },
  });
  function gt() {
    ...
    return (
     e & (I | U)
      ...
      : e & I
        ...
        : e & U && (i = t.overallVelocityY),
     this._super.attrTest.call(this, t) &&
      e & t.offsetDirection &&
      t.distance > this.options.threshold &&
      t.maxPointers == this.options.pointers &&
      S(i) > this.options.velocity &&
      t.eventType & o
    );
   },
   emit: function (t) {
  ...
  function A(t, e) {
   return (
    (e = e || {}),
    (e.recognizers = At(e.recognizers, A.defaults.preset)),
    new It(t, e)
   );
  }
  (A.VERSION = '2.0.7'),
   ...
   recognize: function (t) {
    ...
    if (!e.stopped) {
     ...
     for (var s = 0; s < r.length; )
      (i = r[s]),
       e.stopped !== Bt && (!n || i == n || i.canRecognizeWith(n))
        ? i.recognize(t)
        : i.reset(),
       !n && i.state & (m | H | C) && (n = e.curRecognizer = i),
       s++;
    }
   },
   get: function (t) {
  ...
  function Jt(t, e) {
   ...
   if (i.style) {
    ...
    P(t.options.cssProps, function (n, s) {
     (r = J(i.style, s)),
      e
       ? ((t.oldCssProps[r] = i.style[r]), (i.style[r] = n))
       : (i.style[r] = t.oldCssProps[r] || '');
    }),
     e || (t.oldCssProps = {});
   }
  }
  ...
  var xe = typeof u < 'u' ? u : typeof self < 'u' ? self : {};
  (xe.Hammer = A),
   typeof l == 'function' && l.amd
    ? l(function () {
       return A;
      })
    : _t.exports
