...
function $t(n, t, e) {
 ...
 t &&
  V(n) &&
  ((i = (n.offsetWidth > 0 && Dt(s.width) / n.offsetWidth) || 1),
  (r = (n.offsetHeight > 0 && Dt(s.height) / n.offsetHeight) || 1));
...
function Ee(n) {
 return z(n) === 'html'
  ? n
  : n.assignedSlot || n.parentNode || (Xe(n) ? n.host : null) || st(n);
}
function An(n) {
...
function Ei(n, t) {
 ...
 return { x: Dt(e * i) / i || 0, y: Dt(s * i) / i || 0 };
}
function Tn(n) {
 var t,
  e = n.popper,
 ...
 var D = Object.assign({ position: a }, h && gi),
...
function yi(n, t) {
 ...
 return { width: r, height: o, x: a + sn(n), y: l };
}
function wi(n) {
 var t,
  e = st(n),
...
function It(n, t) {
 ...
 var e = t,
  ...
  y = Ts({ reference: b, element: O, strategy: 'absolute', placement: i }),
...
function Si(n, t) {
 ...
 var f = _.reduce(function (A, m) {
  return (
   (A[m] = It(n, { placement: m, boundary: i, rootBoundary: r, padding: o })[
    U(m)
   ]),
   A
  );
 ...
 if (!t.modifiersData[s]._skip) {
  for (
   var i = e.mainAxis,
    ...
    w = T === E,
    O = l || (w || !A ? [ue(E)] : Di(E)),
    g = [E].concat(O).reduce(function (At, J) {
     return At.concat(
      U(J) === ge
       ? Si(t, {
          placement: J,
...
function xi(n) {
 var t = n.state,
  ...
  A = e.tetherOffset,
  m = A === void 0 ? 0 : A,
  E = It(t, { boundary: l, rootBoundary: h, padding: p, altBoundary: u }),
  T = U(t.placement),
  w = Lt(t.placement),
  O = !w,
  g = Je(T),
 ...
 if (b) {
  if (r) {
   var $,
    ...
    Vt = w === pt ? -S[M] : -y[M],
    te = t.elements.arrow,
    At = f && te ? Ze(te) : { width: 0, height: 0 },
    ...
    ri = F + ye - dn - ii,
    oi = F + si - dn,
    fn = jt(f ? fe(Zt, ri) : Zt, F, f ? ft(ct, oi) : ct);
   (b[g] = fn), (j[g] = fn - F);
  }
  if (a) {
   var pn,
    ...
    bn = f && Oe ? fi(En, ut, vn) : jt(f ? En : _n, ut, f ? vn : mn);
   (b[v] = bn), (j[v] = bn - ut);
  }
  t.modifiersData[s] = j;
 }
...
function Wi(n, t, e) {
 ...
 return (
  (s || (!s && !e)) &&
   ((z(t) !== 'body' || rn(r)) && (a = Vi(t)),
   V(t)
    ? ((l = $t(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop))
    : r && (l.x = sn(r))),
  {
      ...
      if (Sn(w, O)) {
       ...
       for (var g = 0; g < u.orderedModifiers.length; g++) {
        ...
        var v = u.orderedModifiers[g],
         ...
         N = v.name;
        typeof b == 'function' &&
         (u = b({ state: u, options: S, name: N, instance: f }) || u);
       }
      }
     }
    },
...
var Yi = ve(),
 Ui = [en, on, tn, Qe],
 zi = ve({ defaultModifiers: Ui }),
 Gi = [en, on, tn, Qe, Os, ys, Cs, bs, ws],
 an = ve({ defaultModifiers: Gi });
...
const c = {
 ...
 trigger(n, t, e) {
  ...
  const u = ln(new Event(t, { bubbles: a, cancelable: !0 }), e);
  return (
   h && u.preventDefault(),
   l && n.dispatchEvent(u),
...
class _e extends Ut {
 ...
 _eventIsPointerPenTouch(t) {
  return (
   this._supportPointerEvents && (t.pointerType === Sr || t.pointerType === Nr)
  );
 }
 static isSupported() {
  return (
...
class kt extends Y {
 constructor(t, e) {
  super(t, e),
   ...
   (this._indicatorsElement = d.findOne(Zr, this._element)),
  ...
  if (
   (this._config.parent &&
    (t = this._getFirstLevelChildren(Eo)
     ...
     .map((a) => Pt.getOrCreateInstance(a, { toggle: !1 }))),
...
class K extends Y {
 constructor(t, e) {
  super(t, e),
   ...
   (this._menu =
    d.next(this._element, de)[0] ||
    d.prev(this._element, de)[0] ||
    d.findOne(de, this._parent)),
...
class zs extends Ut {
 ...
 dispose() {
  this._isAppended &&
   (c.off(this._element, kn), this._element.remove(), (this._isAppended = !1));
 }
 _getElement() {
  if (!this._element) {
...
class mt extends Y {
 constructor(t, e) {
  super(t, e),
   (this._dialog = d.findOne(ba, this._element)),
 ...
 show(t) {
  this._isShown ||
   this._isTransitioning ||
   c.trigger(this._element, Xs, { relatedTarget: t }).defaultPrevented ||
   ((this._isShown = !0),
   (this._isTransitioning = !0),
 ...
 _showElement(t) {
  ...
  const s = () => {
   this._config.focus && this._focustrap.activate(),
    (this._isTransitioning = !1),
    c.trigger(this._element, da, { relatedTarget: t });
  };
...
const Oa = 'offcanvas',
 ...
 Va = { backdrop: '(boolean|string)', keyboard: 'boolean', scroll: 'boolean' };
class Q extends Y {
 constructor(t, e) {
  super(t, e),
   (this._isShown = !1),
...
const Ka = 'TemplateFactory',
 ...
 za = { entry: '(string|element|function|null)', selector: '(string|element)' };
class Ga extends Ut {
 constructor(t) {
...
class vt extends Y {
 ...
 show() {
  ...
  if (
   (this._element.ownerDocument.documentElement.contains(this.tip) ||
    (r.append(i), c.trigger(this._element, this.constructor.eventName(rc))),
 ...
 hide() {
  if (
   !this._isShown() ||
   c.trigger(this._element, this.constructor.eventName(ec)).defaultPrevented
  )
   return;
  if (
   (this._getTipElement().classList.remove(ae),
   'ontouchstart' in document.documentElement)
  )
 ...
 _isAnimated() {
  return (
   this._config.animation || (this.tip && this.tip.classList.contains(Me))
  );
 }
 _isShown() {
  ...
  for (const e of t)
   if (e === 'click')
    ...
    c.on(this._element, s, this._config.selector, (r) => {
     ...
     (o._activeTrigger[r.type === 'focusin' ? Re : Bt] = !0), o._enter();
    }),
     c.on(this._element, i, this._config.selector, (r) => {
      const o = this._initializeOnDelegatedTarget(r);
      (o._activeTrigger[r.type === 'focusout' ? Re : Bt] = o._element.contains(
       r.relatedTarget,
      )),
       o._leave();
     });
...
const pc = 'popover',
 ...
 Ec = { ...vt.DefaultType, content: '(null|string|element|function)' };
class Ae extends vt {
 static get Default() {
  return gc;
 }
...
class Xt extends Y {
 ...
 _maybeEnableSmoothScroll() {
  this._config.smoothScroll &&
   ...
   c.on(this._config.target, Xn, xe, (t) => {
...
class gt extends Y {
 ...
 _keydown(t) {
  ...
  s && (s.focus({ preventScroll: !0 }), gt.getOrCreateInstance(s).show());
 }
 _getChildren() {
...
c.on(document, Wc, ni, function (n) {
 ['A', 'AREA'].includes(this.tagName) && n.preventDefault(),
  !nt(this) && gt.getOrCreateInstance(this).show();
});
c.on(window, jc, () => {
 ...
 hide() {
  ...
  const e = () => {
   this._element.classList.add(ns),
    this._element.classList.remove(le, ce),
