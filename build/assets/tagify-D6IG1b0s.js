import { c as st, g as at } from './_commonjsHelpers-BosuxZz1.js';
var G = { exports: {} };
(function (B, rt) {
 (function (V, M) {
  B.exports = M();
  ...
  function M(t) {
   for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
     ? V(Object(i), !0).forEach(function (s) {
        Q(t, s, i[s]);
       })
     : Object.getOwnPropertyDescriptors
       ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
       : V(Object(i)).forEach(function (s) {
  ...
  function c(t, e, i) {
   return t
    ? (e && (t.__tagifyTagData = i ? e : T({}, t.__tagifyTagData || {}, e)),
      t.__tagifyTagData)
  ...
  function D(t) {
   if (t && t.parentNode) {
    var e = t,
     ...
     s = i.getRangeAt(0);
    i.rangeCount &&
     (s.setStartAfter(e), s.collapse(!0), i.removeAllRanges(), i.addRange(s));
   }
  }
  function X(t, e) {
   t.forEach((i) => {
  ...
  var Z = {
   ...
   show(t) {
    ...
    if (
     ((t = t === void 0 ? this.state.inputText : t),
     !(
      (n && !o && !a.templates.dropdownItemNoMatch) ||
      a.dropdown.enable === !1 ||
     ...
     if (
      ...
      t &&
       ...
       a.templates.dropdownItemNoMatch &&
        (s = a.templates.dropdownItemNoMatch.call(this, { value: t }))),
      !s)
     ) {
      if (this.suggestedListItems.length)
       t &&
        ...
        !E(this.suggestedListItems[0].value, t) &&
        this.suggestedListItems.unshift({ value: t });
      else {
       if (!t || !o || this.state.editing.scope)
        return (
         this.input.autocomplete.suggest.call(this), void this.dropdown.hide()
        );
      ...
      a.dropdown.highlightFirst &&
       this.dropdown.highlightOption(
        this.DOM.dropdown.content.querySelector(
         a.classNames.dropdownItemSelector,
        ),
       ),
   ...
   fillHeaderFooter() {
    ...
    e && (s == null || s.parentNode.replaceChild(e, s)),
   ...
   position(t) {
    ...
    if (e.position != 'manual') {
     var i,
      ...
      f = u.clientHeight,
      y =
       Math.max(u.clientWidth || 0, window.innerWidth || 0) > 480
        ? e.position
        : 'all',
     ...
     if (((t = t || h.clientHeight), this.state.dropdown.visible)) {
      if (
       (y == 'text'
        ? ((a = (i = (function () {
           ...
           if (w.rangeCount) {
            ...
            if (H > 0)
             return (
              ...
              { left: L.right, top: L.top, bottom: L.bottom }
             );
          ...
          (n = 'auto'))
        : ((r = (function (w) {
           for (var b = 0, x = 0; w && w != u; )
            (b += w.offsetTop || 0),
             (x += w.offsetLeft || 0),
             (w = w.parentNode);
           return { top: b, left: x };
          })(e.appendTarget)),
          (s = (i = N.getBoundingClientRect()).top - r.top),
          (a = i.bottom - 1 - r.top),
          (o = i.left - r.left),
          (n = i.width + 'px')),
       !p)
       ...
       let w = (function () {
        for (var b = 0, x = e.appendTarget.parentNode; x; )
         (b += x.scrollTop || 0), (x = x.parentNode);
        return b;
       })();
       (s += w), (a += w);
      }
      (s = Math.floor(s)),
       (a = Math.ceil(a)),
       (d = ((l = e.placeAbove ?? f - i.bottom < t) ? s : a) + m),
       (g = `left: ${o + ((v && i.width) || 0) + window.pageXOffset}px;`),
       (h.style.cssText = `${g}; top: ${d}px; min-width: ${n}; max-width: ${n}`),
       h.setAttribute('placement', l ? 'top' : 'bottom'),
       h.setAttribute('position', y);
     }
    }
   },
   events: {
      ...
      if (this.state.hasFocus && !this.state.composing) {
       var e = this.settings,
        i = this.DOM.dropdown.querySelector(
         e.classNames.dropdownItemActiveSelector,
        ),
        s = this.dropdown.getSuggestionDataByNode(i),
        a = e.mode == 'mix';
       e.hooks.beforeKeyDown(t, { tagify: this }).then((o) => {
        switch (t.key) {
         case 'ArrowDown':
         case 'ArrowUp':
         case 'Down':
         case 'Up':
          ...
          i && (i = this.dropdown.getNextOrPrevOption(i, !r)),
           (i && i.matches(e.classNames.dropdownItemSelector)) ||
            (i = n[r ? n.length - 1 : 0]),
         ...
         case 'Enter':
          t.preventDefault(),
           e.hooks
            .suggestionClick(t, { tagify: this, tagData: s, suggestionElm: i })
            .then(() => {
             if (i)
              return (
               this.dropdown.selectOption(i),
         ...
         case 'Backspace': {
          ...
          (d != '' && d.charCodeAt(0) != 8203) ||
           (e.backspace === !0
            ? this.removeTags()
            : e.backspace == 'edit' && setTimeout(this.editTag.bind(this), 0));
         }
        }
       });
      }
   ...
   selectOption(t, e) {
    ...
    if (!t)
     return (
      this.addTags(this.state.inputText, !0), void (o && this.dropdown.hide())
     );
    e = e || {};
    ...
    if (
     (this.trigger('dropdown:select', { data: l, elm: t, event: e }),
     n && (l || r))
    ) {
     if (this.state.editing) {
      let d = this.normalizeTags([l])[0];
      (l = i.transformTag.call(this, d) || d),
       this.onEditTagDone(null, T({ __isValid: !0 }, l));
     } else
      this[i.mode == 'mix' ? 'addMixTags' : 'addTags'](
       [l || this.input.raw.call(this)],
       a,
      );
   ...
   filterListItems(t, e) {
    ...
    if (
     ...
     return (
      (d = l.includeSelectedTags
       ? h
       : h.filter((f) => !this.isTagDuplicate(O(f) ? f.value : f))),
    ...
    function u(f, y) {
     return y
      .toLowerCase()
      .split(' ')
      .every((N) => f.includes(N.toLowerCase()));
    }
    for (
     n = l.caseSensitive ? '' + t : ('' + t).toLowerCase();
     m < h.length;
     m++
    ) {
     let f, y;
     i = h[m] instanceof Object ? h[m] : { value: h[m] };
     let N = Object.keys(i).some((w) => p.includes(w)) ? p : ['value'];
     l.fuzzySearch && !e.exact
      ? ((a = N.reduce((w, b) => w + ' ' + (i[b] || ''), '')
         .toLowerCase()
         .trim()),
        l.accentedSearch && ((a = C(a)), (n = C(n))),
        (f = a.indexOf(n) == 0),
        (y = a === n),
        (s = u(a, n)))
      : ((f = !0),
        (s = N.some((w) => {
         var b = '' + (i[w] || '');
         return (
          l.accentedSearch && ((b = C(b)), (n = C(n))),
          l.caseSensitive || (b = b.toLowerCase()),
          (y = b === n),
          e.exact ? b === n : b.indexOf(n) == 0
         );
        }))),
      (o = !l.includeSelectedTags && this.isTagDuplicate(O(i) ? i.value : i)),
      s &&
       !o &&
       (y && f
        ? g.push(i)
        : l.sortby == 'startsWith' && f
          ? d.unshift(i)
          : d.push(i));
    }
    return (
     ...
     typeof l.sortby == 'function'
      ? l.sortby(g.concat(d), n)
      : g.concat(d).slice(0, v)
    );
   },
   getMappedValue(t) {
   ...
   createListHTML(t) {
    return T([], t)
     .map((e, i) => {
      (typeof e != 'string' && typeof e != 'number') || (e = { value: e });
      var s = this.dropdown.getMappedValue(e);
      return (
       (s =
        typeof s == 'string' && this.settings.dropdown.escapeHTML ? I(s) : s),
    ...
    callbacks: {
     onFocusBlur(t) {
      ...
      var e = this.settings,
       ...
       s =
        (h = (g = this.value) == null ? void 0 : g[0]) == null
         ? void 0
         : h[e.tagTextProp],
       a = t.type,
      ...
      if (!r && !l)
       if (
        ((this.state.hasFocus = a == 'focus' && +new Date()),
        ...
        if (a == 'focus')
         return (
          ...
          void (
           (e.dropdown.enabled !== 0 && e.userInput) ||
         ...
         .then((s) => {
           ...
           switch (t.key) {
            ...
            case 'Backspace':
             ...
             var l,
              ...
              g,
              h = this.getTagElms(),
              v = a.anchorNode.length === 1 && a.anchorNode.nodeValue == '​';
             if (e.backspace == 'edit' && r)
              return (
               (l =
                a.anchorNode.nodeType == 1
                 ? null
             ...
             if (
              ((o || r) && a.anchorNode.nodeType == 1
               ...
               : o
                 ? (d = a.anchorNode.nextElementSibling)
                 : r instanceof Element && (d = r),
              a.anchorNode.nodeType == 3 &&
              ...
              ((r || o) && !e.backspace) ||
               (a.type != 'Range' &&
                !a.anchorOffset &&
                a.anchorNode == this.DOM.input &&
                t.key != 'Delete'))
             )
              return void t.preventDefault();
             if (a.type != 'Range' && d && d.hasAttribute('readonly'))
              return void D(W(d));
             t.key == 'Delete' &&
              v &&
              c(a.anchorNode.nextSibling) &&
              this.removeTags(a.anchorNode.nextSibling),
              clearTimeout(J),
              (J = setTimeout(() => {
               var m = document.getSelection();
               $(this.DOM.input.innerHTML),
                !o && m.anchorNode.previousSibling,
                (this.value = [].map
                 .call(h, (u, f) => {
                  var y = c(u);
                  if (u.parentNode || y.readonly) return y;
                  this.trigger('remove', { tag: u, index: f, data: y });
                 })
                 .filter((u) => u));
              }, 20));
           }
          ...
          switch (t.key) {
           ...
           case 'Enter':
            ...
            t.preventDefault(),
             setTimeout(() => {
              (this.state.dropdown.visible && !p) ||
               this.state.actions.selectOption ||
               !e.addTagOn.includes(t.key.toLowerCase()) ||
               this.addTags(i, !0);
             });
          }
         })
     ...
     onInput(t) {
      ...
      e.mode == 'select' && this.toggleScopeValidation(o),
       (a.isValid = o),
       this.state.inputText != i &&
        (this.input.set.call(this, i, !1),
        i.search(e.delimiters) != -1
         ? this.addTags(i) && this.input.set.call(this)
         : e.dropdown.enabled >= 0 && this.dropdown[s ? 'show' : 'hide'](i),
     ...
     onMixTagsInput(t) {
      ...
      if (
       ...
       X(this.getTagElms()),
       this.value.slice().forEach((u) => {
        u.readonly &&
         !m.includes(u.value) &&
         v.appendChild(this.createTagElem(u));
       }),
       v.childNodes.length &&
        (p.insertNode(v), this.setRangeAtStartEnd(!1, v.lastChild)),
       h.length != g)
      )
       return (
        (this.value = [].map.call(this.getTagElms(), (u) => c(u))),
        void this.update({ withoutChangeEvent: !0 })
       );
      if (this.hasMaxTags()) return !0;
      if (
       window.getSelection &&
       (n = window.getSelection()).rangeCount > 0 &&
       n.anchorNode.nodeType == 3
      ) {
       if (
        ((p = n.getRangeAt(0).cloneRange()).collapse(!0),
        p.setStart(n.focusNode, 0),
        (s =
         (e = p.toString().slice(0, p.endOffset)).split(d.pattern).length - 1),
        (i = e.match(d.pattern)) &&
        ...
        if (
         ...
         (this.state.tag.baseOffset =
          n.baseOffset - this.state.tag.value.length),
        ...
        try {
         (r =
          (r = this.state.flaggedTags[this.state.tag.baseOffset]).prefix ==
           this.state.tag.prefix && r.value[0] == this.state.tag.value[0]),
        ...
        (r || s < this.state.mixMode.matchedPatternCount) && (o = !1);
      ...
      setTimeout(() => {
       this.update({ withoutChangeEvent: !0 }),
        this.trigger(
         'input',
         T({}, this.state.tag, { textContent: this.DOM.input.textContent }),
        ),
        this.state.tag &&
      ...
      s.readonly ||
       ...
       s.hooks
        ...
        .then((a) => {
         a === void 0 && (a = i),
          a &&
           (this.injectAtCaret(a, window.getSelection().getRangeAt(0)),
           this.settings.mode == 'mix'
            ? this.events.callbacks.onMixTagsInput.call(this, t)
            : this.settings.pasteAsTags
              ? this.addTags(this.state.inputText + a, !0)
              : ((this.state.inputText = a), this.dropdown.show(a)));
        })
        .catch((a) => a));
     },
     onDrop(t) {
     ...
     onEditTagInput(t, e) {
      var i = t.closest('.' + this.settings.classNames.tag),
       ...
       n = { [this.settings.tagTextProp]: o, __tagId: a.__tagId },
       r = this.validateTag(n);
      this.editTagChangeDetected(T(a, n)) ||
       t.originalIsValid !== !0 ||
       (r = !0),
       i.classList.toggle(this.settings.classNames.tagInvalid, r !== !0),
       (a.__isValid = r),
       (i.title = r === !0 ? a.title || a.value : r),
       ...
       this.trigger('edit:input', {
        tag: i,
        index: s,
        data: T({}, this.value[s], { newValue: o }),
        event: e,
       });
     },
     onEditTagPaste(t, e) {
     ...
     onEditTagBlur(t) {
      if (
       ...
       var e,
        ...
        r = { [s.tagTextProp]: n, __tagId: o.__tagId },
        l = o.__originalData,
       ...
       if (n)
        if (d) {
         if (
          ((e = this.hasMaxTags()),
          (i = T({}, l, { [s.tagTextProp]: this.trim(n), __isValid: g })),
          s.transformTag.call(this, i, l),
          (g = (!e || l.__isValid === !0) && this.validateTag(i)) !== !0)
         ) {
          if (
           (this.trigger('invalid', { data: i, tag: a, message: g }),
      ...
      t.forEach((i) => {
       i.addedNodes.forEach((s) => {
        ...
        if (s.outerHTML == '<div><br></div>')
         ...
         s.nodeType == 1 &&
         s.querySelector(this.settings.classNames.tagSelector)
        ) {
...
`)),
          s.replaceWith(o, ...[...s.childNodes].slice(0, -1)),
          D(o);
        } else if (_.call(this, s))
         if (
          (((a = s.previousSibling) == null ? void 0 : a.nodeType) != 3 ||
...
​`);
         ...
         } else (s.previousSibling && !c(s.previousSibling)) || s.before('​');
       }),
   ...
   T(
    ...
    (function (s) {
     ...
     return {
      ...
      trigger(n, r, l) {
       var d;
       if (((l = l || { cloneData: !0 }), n))
        if (s.settings.isJQueryPlugin)
         n == 'remove' && (n = 'removeTag'),
          jQuery(s.DOM.originalInput).triggerHandler(n, [r]);
        else {
         try {
          var g = typeof r == 'object' ? r : { value: r };
          if (
           (((g = l.cloneData ? T({}, g) : g).tagify = this),
           r.event && (g.event = this.cloneEvent(r.event)),
           r instanceof Object)
          )
           for (var h in r) r[h] instanceof HTMLElement && (g[h] = r[h]);
          d = new CustomEvent(n, { detail: g });
         } catch (v) {
          console.warn(v);
         }
         a.dispatchEvent(d);
    ...
    (this.getPersistedData =
     ...
     (s) => {
      let a,
       o = '/' + s;
      if (localStorage.getItem(S + i + '/v', 1) == 1)
       try {
        a = JSON.parse(localStorage[S + i + o]);
       } catch {}
      return a;
     })),
    (this.setPersistedData = ((s) =>
     s
      ? (localStorage.setItem(S + s + '/v', 1),
        (a, o) => {
         let n = '/' + o,
          r = JSON.stringify(a);
         a &&
          o &&
          (localStorage.setItem(S + s + n, r),
          dispatchEvent(new Event('storage')));
        })
      : () => {})(e.id)),
    (this.clearPersistedData = ((s) => (a) => {
     const o = S + '/' + s + '/';
   ...
   (A.prototype = {
    ...
    applySettings(t, e) {
     ...
     if (
      ...
      'autoComplete' in e &&
       ...
       (s.autoComplete.enabled = e.autoComplete)),
      s.mode == 'mix' &&
       ((s.pattern = s.pattern || /@/),
       (s.autoComplete.rightKey = !0),
       (s.delimiters = e.delimiters || null),
       s.tagTextProp &&
     ...
     s.disabled && (s.userInput = !1),
      (this.TEXTS = M(M({}, tt), s.texts || {})),
      ((s.mode != 'select' || ((o = e.dropdown) != null && o.enabled)) &&
       s.userInput) ||
       (s.dropdown.enabled = 0),
      (s.dropdown.appendTarget =
       ((n = e.dropdown) == null ? void 0 : n.appendTarget) || document.body);
     let a = this.getPersistedData('whitelist');
     Array.isArray(a) &&
      (this.whitelist = Array.isArray(s.whitelist) ? q(s.whitelist, a) : a);
    },
    getAttributes(t) {
     var e,
    ...
    loadOriginalValues(t) {
     ...
     if (((this.state.blockChangeEvent = !0), t === void 0)) {
      ...
      t =
       s && !this.DOM.originalInput.value
        ? s
     ...
     if ((this.removeAllTags(), t))
      if (i.mode == 'mix')
       ...
       this.addTags(t, !0).forEach(
        (s) => s && s.classList.add(i.classNames.tagNoAnimation),
       );
      }
    ...
    tagLoading(t, e) {
     return (
      t &&
       t.classList[e ? 'add' : 'remove'](this.settings.classNames.tagLoading),
      this
     );
    },
    toggleClass(t, e) {
    ...
    insertAfterTag(t, e) {
     if (
      ((e = e || this.settings.mixMode.insertAfterTag), t && t.parentNode && e)
     )
      return (
     ...
     if (s) {
      if (!(o instanceof Object && 'editable' in o) || o.editable)
       return (
        ...
        c(o.__originalHTML, o.__originalData),
        s.setAttribute('contenteditable', !0),
        t.classList.add(i.classNames.tagEditing),
        s.addEventListener('focus', n.onEditTagFocus.bind(this, t)),
        s.addEventListener(
         'blur',
         n.onEditTagBlur.bind(this, this.getTagTextNode(t)),
        ),
        s.addEventListener('input', n.onEditTagInput.bind(this, s)),
        s.addEventListener('paste', n.onEditTagPaste.bind(this, s)),
        s.addEventListener('keydown', (l) =>
         n.onEditTagkeydown.call(this, l, t),
        ),
        s.addEventListener('compositionstart', n.onCompositionStart.bind(this)),
        s.addEventListener('compositionend', n.onCompositionEnd.bind(this)),
        e.skipValidation || (r = this.editTagToggleValidity(t)),
        (s.originalIsValid = r),
        this.trigger('edit:start', { tag: t, index: a, data: o, isValid: r }),
        s.focus(),
        this.setRangeAtStartEnd(!1, s),
        this
       );
    ...
    editTagToggleValidity(t, e) {
     ...
     if ((e = e || c(t)))
      return (
       (i = !('__isValid' in e) || e.__isValid === !0) ||
    ...
    onEditTagDone(t, e) {
     ...
     var i,
      s = { tag: t, index: this.getNodeIndex(t), previousData: c(t), data: e },
      a = this.settings;
     this.trigger('edit:beforeUpdate', s, { cloneData: !1 }),
      ...
      ((i = e[a.tagTextProp])
       ? i.trim() && i
       : !(a.tagTextProp in e) && e.value)
       ? ((t = this.replaceTag(t, e)),
         this.editTagToggleValidity(t, e),
         a.a11y.focusableTags ? t.focus() : D(t))
       : t && this.removeTags(t),
    ...
    replaceTag(t, e) {
     (e && e.value) || (e = t.__tagifyTagData),
      e.__isValid &&
       e.__isValid != 1 &&
       T(e, this.getInvalidTagAttrs(e, e.__isValid));
    ...
    injectAtCaret(t, e) {
     var s;
     if (
      !(e = e || ((s = this.state.selection) == null ? void 0 : s.range)) &&
      t
     )
    ...
    input: {
     set() {
      ...
      (this.state.inputText = t),
       e && (this.DOM.input.innerHTML = I('' + t)),
     ...
     normalize(t, e) {
      var i = t || this.DOM.input,
       s = [];
      i.childNodes.forEach((a) => a.nodeType == 3 && s.push(a.nodeValue)),
       (s = s.join(`
`));
      try {
       s = s.replace(
      ...
      return (
       (s = s.replace(/\s/g, ' ')), e != null && e.trim ? this.trim(s) : s
      );
     },
     autocomplete: {
      suggest(t) {
       if (this.settings.autoComplete.enabled) {
        typeof (t = t || { value: '' }) == 'string' && (t = { value: t });
    ...
    isTagDuplicate(t, e, i) {
     ...
     for (let a of this.value)
      E(this.trim('' + t), a.value, e) && i != a.__tagId && s++;
     return s;
    },
    getTagIndexByValue(t) {
     ...
     return (
      this.getTagElms().forEach((s, a) => {
       s.__tagifyTagData &&
        E(this.trim(s.__tagifyTagData.value), t, i) &&
        e.push(a);
      }),
      e
     );
    ...
    getWhitelistItem(t, e, i) {
     ...
     var s,
      a = this.settings;
     return (
      (i = i || a.whitelist).some((o) => {
       var n = typeof o == 'string' ? o : o[e] || o.value;
       if (E(n, t, a.dropdown.caseSensitive, a.trim))
        return (s = typeof o == 'string' ? { value: o } : o), !0;
      }),
      s ||
       e != 'value' ||
       a.tagTextProp == 'value' ||
       (s = this.getWhitelistItem(t, a.tagTextProp, i)),
      s
     );
    },
    validateTag(t) {
     ...
     var e = this.settings,
      ...
      g = (h) =>
       (h + '')
        .split(s)
        .filter((v) => v)
        .map((v) => ({ [o]: this.trim(v), value: this.trim(v) }));
      ...
      r &&
       ...
       (t.forEach((h) => {
        var v = n.map((u) => u.value),
         p = this.dropdown.filterListItems.call(this, h[o], { exact: !0 });
        this.settings.duplicates || (p = p.filter((u) => !v.includes(u.value)));
        var m = p.length > 1 ? this.getWhitelistItem(h[o], o, p) : p[0];
        m && m instanceof Object
         ? n.push(m)
         : a != 'mix' && (h.value == null && (h.value = h[o]), n.push(h));
       }),
       n.length && (t = n)),
      t
     );
    ...
    parseMixTags(t) {
     ...
     (t = t
      ...
      .map((g, h) => {
       ...
       try {
        ...
        p = this.normalizeTags(f)[0] || { value: f };
       }
       if (
        (a.call(this, p),
        y ||
         !(u.length > 1) ||
         (o && !this.isTagWhitelisted(p.value)) ||
         (!s && this.isTagDuplicate(p.value)))
       ) {
        if (g) return h ? i[0] + g : g;
       } else
        (p[(v = p[r] ? r : 'value')] = this.trim(p[v])),
         (m = this.createTagElem(p)),
         l.push(p),
         m.classList.add(this.settings.classNames.tagNoAnimation),
         (u[0] = m.outerHTML),
         this.value.push(p);
       return u.join('');
      })
     ...
     return (
      d.forEach((g, h) => c(g, l[h])),
      this.update({ withoutChangeEvent: !0 }),
      X(d, this.state.hasFocus),
      t
     );
    },
    replaceTextWithNode(t, e) {
     if (this.state.tag || e) {
      ...
      return (
       o.splitText(a.anchorOffset - n),
       (i = o.nodeValue.lastIndexOf(e)) == -1 ||
        ((s = o.splitText(i)), t && o.parentNode.replaceChild(t, s)),
       !0
      );
     }
    },
    ...
    addEmptyTag(t) {
     ...
     c(i, e), this.appendTag(i), this.editTag(i, { skipValidation: !0 });
    },
    addTags(t, e, i) {
     var s = [],
      a = this.settings,
     ...
     return (
      ...
      t.forEach((r) => {
       var l,
        d = {},
        g = Object.assign({}, r, { value: r.value + '' });
       if (
        ((r = Object.assign({}, g)),
        a.transformTag.call(this, r),
        (r.__isValid = this.hasMaxTags() || this.validateTag(r)),
        r.__isValid !== !0)
       ) {
        if (i) return;
        if (
         (T(d, this.getInvalidTagAttrs(r, r.__isValid), {
          __preInvalidData: g,
         }),
         r.__isValid == this.TEXTS.duplicate &&
          this.flashTag(this.getTagElmByValue(r.value)),
         !a.createInvalidTags)
        )
         return void o.push(r.value);
       }
       if (
        ('readonly' in r &&
         (r.readonly ? (d['aria-readonly'] = !0) : delete r.readonly),
        (l = this.createTagElem(r, d)),
        s.push(l),
        a.mode == 'select')
       )
        return this.selectTag(l, r);
       n.appendChild(l),
        r.__isValid && r.__isValid === !0
         ? (this.value.push(r),
           this.trigger('add', {
            tag: l,
         ...
         : (this.trigger('invalid', {
           ...
           a.keepInvalidTags || setTimeout(() => this.removeTags(l, !0), 1e3)),
    ...
    prefixedTextToTag(t) {
     ...
     return (
      (this.state.tag = null),
      this.trigger('add', T({}, { tag: e }, { data: t })),
      e
     );
    },
    appendTag(t) {
    ...
    createTagElem(t, e) {
     t.__tagId = z();
     var i,
      s = T({}, t, M({ value: I(t.value + '') }, e));
     return (
      (function (a) {
       for (
        var o,
         n = document.createNodeIterator(a, NodeFilter.SHOW_TEXT, null, !1);
        (o = n.nextNode());

       )
        o.textContent.trim() || o.parentNode.removeChild(o);
      })((i = this.parseTemplate('tag', [s, this]))),
      c(i, t),
      i
     );
    },
    reCheckInvalidTags() {
     ...
     this.getTagElms(t.classNames.tagNotAllowed).forEach((e, i) => {
      var s = c(e),
       ...
       n = o === !0 && !a;
      if ((t.mode == 'select' && this.toggleScopeValidation(o), n))
       return (
       ...
       return (
        n &&
         ...
         o.push({
          ...
          data: c(n, { __removed: !0 }),
         }),
        o
       );
      }, [])),
      (i = typeof i == 'number' ? i : this.CSSVars.tagHideTransition),
      a.mode == 'select' && ((i = 0), this.input.set.call(this)),
      s.length == 1 &&
       a.mode != 'select' &&
       ...
       .then(() => {
        function o(n) {
         n.node.parentNode &&
          ...
          e
           ? a.keepInvalidTags &&
             this.trigger('remove', { tag: n.node, index: n.idx })
           : (this.trigger('remove', {
              tag: n.node,
              index: n.idx,
              data: n.data,
        ...
        i && i > 10 && s.length == 1
         ? function (n) {
            (n.node.style.width =
             parseFloat(window.getComputedStyle(n.node).width) + 'px'),
             document.body.clientTop,
             n.node.classList.add(a.classNames.tagHide),
             setTimeout(o.bind(this), i, n);
           }.call(this, s[0])
         : s.forEach(o.bind(this)),
         e ||
          (this.removeTagsFromValue(s.map((n) => n.node)),
          this.update(),
     ...
     this.toggleClass(e.hasMaxTags, this.value.length >= t.maxTags),
      ...
      t.mode == 'select' &&
       this.toggleScopeValidation(
        (a = (s = this.value) == null ? void 0 : s[0]) == null
         ? void 0
         : a.__isValid,
       );
    },
...
`),
          ...
          r.getAttribute('style') || ['B', 'I', 'U'].includes(r.tagName)
           ? (t += r.textContent)
           : (r.tagName != 'DIV' && r.tagName != 'P') ||
             ((t += `\r
`),
             o(r));
   ...
   (A.prototype.removeTag = A.prototype.removeTags),
   A
  );
 });
})(G);
