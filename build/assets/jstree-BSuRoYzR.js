import { r as te } from './jquery-Czc5UB_B.js';
   ...
   */ if (!l.jstree) {
   ...
   !W &&
    ...
    (l.jstree.create = function (e, s) {
     var t = new l.jstree.core(++ee),
      i = s;
     return (
      (s = l.extend(!0, {}, l.jstree.defaults, s)),
      i && i.plugins && (s.plugins = i.plugins),
      l.each(s.plugins, function (r, a) {
    ...
    (l.jstree.reference = function (e) {
     var s = null,
      t = null;
     if (
      (e && e.id && (!e.tagName || !e.nodeType) && (e = e.id), !t || !t.length)
     )
      try {
       t = l(e);
      } catch {}
     ...
     return (
      t &&
      t.length &&
      (t = t.closest('.jstree')).length &&
      (t = t.data('jstree'))
       ? (s = t)
       : l('.jstree').each(function () {
          var i = l(this).data('jstree');
          if (i && i._model.data[e]) return (s = i), !1;
         }),
      s
     );
    }),
    (l.fn.jstree = function (e) {
     ...
     return e === !0 && !this.length
      ? !1
      : (this.each(function () {
         var r = l.jstree.reference(this),
          a = s && r ? r[e] : null;
         if (
          ((i = s && a ? a.apply(r, t) : null),
          !r &&
           !s &&
           (e === y || l.isPlainObject(e)) &&
           l.jstree.create(this, e),
          ((r && !s) || e === !0) && (i = r || !1),
          i !== null && i !== y)
         )
          return !1;
     ...
     keyboard: {
      ...
      right: function (e) {
       if ((e.preventDefault(), this.is_closed(e.currentTarget)))
        ...
        var s = this.get_node(e.currentTarget, !0).children(
         '.jstree-children',
        )[0];
    ...
    (l.jstree.core.prototype = {
     plugin: function (e, s) {
      ...
      return t
       ? ((this._data[e] = {}), (t.prototype = this), new t(s, this))
       : this;
     },
     init: function (e, s) {
      (this._model = {
       ...
       (this.element = l(e).addClass('jstree jstree-' + this._id)),
       (this.settings = s),
     ...
     _kbevent_to_func: function (e) {
      ...
      if (
       ...
       t.push(s[e.which] ? s[e.which].toLowerCase() : e.which),
       (t = t.sort().join('-').toLowerCase()),
       t === 'shift-shift' || t === 'ctrl-ctrl' || t === 'alt-alt')
      )
       return null;
      var i = this.settings.core.keyboard,
       r,
       a;
      for (r in i)
       if (
     ...
     bind: function () {
      var e = '',
       ...
       t = 0;
      this.element
       .on('dblclick.jstree', function (i) {
        if (i.target.tagName && i.target.tagName.toLowerCase() === 'input')
         return !0;
        if (T.selection && T.selection.empty) T.selection.empty();
       ...
       .on(
        ...
        function (i) {
         i.target === this.element[0] &&
          (i.preventDefault(), (t = +new Date()));
        }.bind(this),
       )
       .on('mousedown.jstree', '.jstree-ocl', function (i) {
        i.preventDefault();
       })
       .on(
        'click.jstree',
       ...
       .on(
        ...
        function (i) {
         i.preventDefault(),
          i.currentTarget !== T.activeElement &&
           l(i.currentTarget).trigger('focus'),
          this.activate_node(i.currentTarget, i);
        }.bind(this),
       )
       .on(
        'keydown.jstree',
        ...
        function (i) {
         if (i.target.tagName && i.target.tagName.toLowerCase() === 'input')
          return !0;
         this._data.core.rtl &&
          (i.which === 37 ? (i.which = 39) : i.which === 39 && (i.which = 37));
           ...
           setTimeout(
            function () {
             if (
              ...
              if (
               ((this._data.core.ready = !0), this._data.core.selected.length)
              ) {
               if (this.settings.core.expand_selected_onload) {
                ...
                for (n = 0, c = this._data.core.selected.length; n < c; n++)
                 a = a.concat(
                  this._model.data[this._data.core.selected[n]].parents,
                 );
                for (
                 a = l.vakata.array_unique(a), n = 0, c = a.length;
                 n < c;
                 n++
                )
       ...
       .on(
        ...
        function () {
         ...
         (this._data.core.themes.dots = i.dots),
          (this._data.core.themes.stripes = i.stripes),
          (this._data.core.themes.icons = i.icons),
          (this._data.core.themes.ellipsis = i.ellipsis),
          this.set_theme(i.name || 'default', i.url),
          this.set_theme_variant(i.variant);
        }.bind(this),
       )
       .on(
        'loading.jstree',
        function () {
         this[this._data.core.themes.dots ? 'show_dots' : 'hide_dots'](),
          ...
          this[
           this._data.core.themes.ellipsis ? 'show_ellipsis' : 'hide_ellipsis'
          ]();
        }.bind(this),
       )
       .on(
        ...
        function (i) {
         (this._data.core.focused = null),
          l(i.currentTarget).filter('.jstree-hovered').trigger('mouseleave'),
          this.element.attr('tabindex', '0'),
          l(i.currentTarget).attr('tabindex', '-1');
        }.bind(this),
       )
       .on(
        'focus.jstree',
        ...
        function (i) {
         ...
         r && (r.id || r.id === 0) && (this._data.core.focused = r.id),
          this.element
           .find('.jstree-hovered')
           .not(i.currentTarget)
           .trigger('mouseleave'),
          l(i.currentTarget).trigger('mouseenter'),
          this.element.attr('tabindex', '-1'),
          l(i.currentTarget).attr('tabindex', '0');
        }.bind(this),
       )
       .on(
        'focus.jstree',
     ...
     trigger: function (e, s) {
      s || (s = {}),
       (s.instance = this),
       this.element.triggerHandler(e.replace('.jstree', '') + '.jstree', s);
     },
     ...
     get_node: function (e, s) {
      e && (e.id || e.id === 0) && (e = e.id),
       e instanceof l && e.length && e[0].id && (e = e[0].id);
      var t;
      try {
       if (this._model.data[e]) e = this._model.data[e];
        ...
        typeof e == 'string' &&
        (t = l('#' + e.replace(l.jstree.idregex, '\\$&'), this.element))
         .length &&
        this._model.data[t.closest('.jstree-node').attr('id')]
       )
        e = this._model.data[t.closest('.jstree-node').attr('id')];
       else if (
        (t = this.element.find(e)).length &&
        this._model.data[t.closest('.jstree-node').attr('id')]
       )
        e = this._model.data[t.closest('.jstree-node').attr('id')];
       ...
       return (
        s &&
         (e =
          e.id === l.jstree.root
           ? this.element
           : l('#' + e.id.replace(l.jstree.idregex, '\\$&'), this.element)),
        e
       );
      } catch {
       return !1;
     ...
     get_path: function (e, s, t) {
      if (
       ...
       !e || e.id === l.jstree.root || !e.parents)
      )
       return !1;
      var i,
       r,
     ...
     get_next_dom: function (e, s) {
      ...
      if (s) {
       t = e[0];
       do t = this._nextSibling(t);
       while (t && t.offsetHeight === 0);
       return t ? l(t) : !1;
      }
      if (e.hasClass('jstree-open')) {
       for (
        t = this._firstChild(e.children('.jstree-children')[0]);
        t && t.offsetHeight === 0;
     ...
     get_prev_dom: function (e, s) {
      ...
      if (((e = this.get_node(e, !0)), e[0] === this.element[0])) {
       for (
        t = this.get_container_ul()[0].lastChild;
        t && t.offsetHeight === 0;
      ...
      return (
       (t = e[0].parentNode.parentNode),
       t && t.className && t.className.indexOf('jstree-node') !== -1 ? l(t) : !1
      );
     },
     get_parent: function (e) {
      return (
       (e = this.get_node(e)), !e || e.id === l.jstree.root ? !1 : e.parent
      );
     },
     ...
     load_node: function (e, s) {
      var t = this.get_node(e, !0),
       i,
       r,
       a,
       n,
       c;
      if (l.vakata.is_array(e)) return this._load_nodes(e.slice(), s), !0;
      if (((e = this.get_node(e)), !e)) return s && s.call(this, e, !1), !1;
      if (e.state.loaded) {
       for (e.state.loaded = !1, a = 0, n = e.parents.length; a < n; a++)
        this._model.data[e.parents[a]].children_d = l.vakata.array_filter(
         this._model.data[e.parents[a]].children_d,
         function (d) {
          return l.inArray(d, e.children_d) === -1;
         },
        );
       for (i = 0, r = e.children_d.length; i < r; i++)
        this._model.data[e.children_d[i]].state.selected && (c = !0),
         delete this._model.data[e.children_d[i]];
       c &&
        (this._data.core.selected = l.vakata.array_filter(
      ...
      return (
       ...
       (e.state.loading = !0),
       e.id !== l.jstree.root
        ? t.children('.jstree-anchor').attr('aria-busy', !0)
        : t.attr('aria-busy', !0),
       t.addClass('jstree-loading'),
       this._load_node(
        e,
        function (d) {
         ...
         e.state.loaded &&
          h &&
          h.length &&
          (h.removeClass('jstree-closed jstree-open jstree-leaf'),
          u
           ? e.id !== '#' &&
             h.addClass(e.state.opened ? 'jstree-open' : 'jstree-closed')
           : h.addClass('jstree-leaf')),
          e.id !== l.jstree.root
           ? h.children('.jstree-anchor').attr('aria-busy', !1)
           : h.attr('aria-busy', !1),
          h.removeClass('jstree-loading'),
          this.trigger('load_node', { node: e, status: d }),
          s && s.call(this, e, d);
        }.bind(this),
       ),
       !0
     ...
     _load_nodes: function (e, s, t, i) {
      ...
      for (c = 0, d = e.length; c < d; c++)
       n[e[c]] &&
        ((!n[e[c]].state.loaded && !n[e[c]].state.failed) || (!t && i)) &&
        (this.is_loading(e[c]) || this.load_node(e[c], a), (r = !1));
      if (r) {
       for (c = 0, d = e.length; c < d; c++)
     ...
     load_all: function (e, s) {
      if ((e || (e = l.jstree.root), (e = this.get_node(e)), !e)) return !1;
      var t = [],
       i = this._model.data,
       r = i[e.id].children_d,
       a,
       n;
      for (
       e.state && !e.state.loaded && t.push(e.id), a = 0, n = r.length;
       a < n;
       a++
      )
     ...
     _load_node: function (e, s) {
      var t = this.settings.core.data,
       i,
       r = function () {
        return this.nodeType !== 3 && this.nodeType !== 8;
       };
      return t
       ? l.vakata.is_function(t)
         ? t.call(
            this,
            e,
            function (a) {
             a === !1
              ...
              : this[
                 ...
                 e,
                 typeof a == 'string' ? l(l.parseHTML(a)).filter(r) : a,
                 function (n) {
                  s.call(this, n);
                 },
                );
         ...
         : typeof t == 'object'
           ? t.url
             ? ((t = l.extend(!0, {}, t)),
               l.vakata.is_function(t.url) && (t.url = t.url.call(this, e)),
               l.vakata.is_function(t.data) && (t.data = t.data.call(this, e)),
               l
                .ajax(t)
                .done(
                 function (a, n, c) {
                  var d = c.getResponseHeader('Content-Type');
                  return (d && d.indexOf('json') !== -1) || typeof a == 'object'
                   ? this._append_json_data(e, a, function (h) {
                      s.call(this, h);
                     })
                   : (d && d.indexOf('html') !== -1) || typeof a == 'string'
                     ? this._append_html_data(
                        e,
                        l(l.parseHTML(a)).filter(r),
                        function (h) {
                         s.call(this, h);
                        },
                       )
                     : ((this._data.core.last_error = {
                        ...
                        data: JSON.stringify({ id: e.id, xhr: c }),
                       }),
                ...
                .fail(
                 function (a) {
                  (this._data.core.last_error = {
                   ...
                   id: 'core_04',
                   reason: 'Could not load node',
                   data: JSON.stringify({ id: e.id, xhr: a }),
                  }),
                   s.call(this, !1),
                   this.settings.core.error.call(
                    this,
             ...
             : (l.vakata.is_array(t)
                ...
                : l.isPlainObject(t)
                  ...
                  : (i = t),
               e.id === l.jstree.root
                ? this._append_json_data(e, i, function (a) {
                   s.call(this, a);
                  })
                : ((this._data.core.last_error = {
                   error: 'nodata',
     ...
     _append_html_data: function (e, s, t) {
      ...
      for (
       i.each(
        function (u, g) {
         (o = this._parse_model_from_html(l(g), r, d.parents.concat())),
          o &&
           (a.push(o),
           n.push(o),
           c[o].children_d.length && (n = n.concat(c[o].children_d)));
        }.bind(this),
       ),
        d.children = a,
        d.children_d = n,
      ...
      this.trigger('model', { nodes: n, parent: r }),
       r !== l.jstree.root
        ? (this._node_changed(r), this.redraw())
        : (this.get_container_ul().children('.jstree-initial-node').remove(),
          this.redraw(!0)),
       this._data.core.selected.length !== h &&
        this.trigger('changed', {
         action: 'model',
         selected: this._data.core.selected,
        }),
     ...
     _append_json_data: function (e, s, t, i) {
      if (this.element !== null) {
       (e = this.get_node(e)),
        (e.children = []),
        (e.children_d = []),
        s.d && ((s = s.d), typeof s == 'string' && (s = JSON.parse(s))),
        l.vakata.is_array(s) || (s = [s]);
       var r = null,
        a = {
        ...
        c = function (h, o) {
         ...
         var f = h.dat,
          ...
          F = function (v, H, E) {
           ...
           for (w in m) m.hasOwnProperty(w) && (k.state[w] = m[w]);
           if (
            (v &&
             v.data &&
             v.data.jstree &&
             v.data.jstree.icon &&
             (k.icon = v.data.jstree.icon),
            (k.icon === o || k.icon === null || k.icon === '') && (k.icon = !0),
            v && v.data && ((k.data = v.data), v.data.jstree))
           )
           ...
           if (
            (k.li_attr.id || (k.li_attr.id = j),
            v && typeof v.a_attr == 'object')
           )
            for (w in v.a_attr)
           ...
           for (
            v &&
             v.children &&
             v.children === !0 &&
             ((k.state.loaded = !1), (k.children = []), (k.children_d = [])),
             x[k.id] = k,
             w = 0,
             B = k.children.length;
            w < B;
            ...
            (Y = F(x[k.children[w]], k.id, E)),
             (z = x[Y]),
             k.children_d.push(Y),
             z.children_d.length &&
              (k.children_d = k.children_d.concat(z.children_d));
           return (
            delete v.data,
            delete v.children,
            (x[k.id].original = v),
            k.state.selected && p.push(k.id),
            k.id
           );
          },
          X = function (v, H, E) {
           ...
           for (w in m) m.hasOwnProperty(w) && (k.state[w] = m[w]);
           if (
            (v && (v.id || v.id === 0) && (k.id = v.id.toString()),
            v && v.text && (k.text = v.text),
            v &&
             v.data &&
             v.data.jstree &&
             v.data.jstree.icon &&
           ...
           if (
            (k.li_attr.id &&
             !(k.id || k.id === 0) &&
             (k.id = k.li_attr.id.toString()),
            k.id || k.id === 0 || (k.id = j),
            k.li_attr.id || (k.li_attr.id = k.id),
            v && typeof v.a_attr == 'object')
           )
            for (w in v.a_attr)
             v.a_attr.hasOwnProperty(w) && (k.a_attr[w] = v.a_attr[w]);
         ...
         if (f.length && f[0].id !== o && f[0].parent !== o) {
          for (C = 0, S = f.length; C < S; C++)
           f[C].children || (f[C].children = []),
            f[C].state || (f[C].state = {}),
            (x[f[C].id.toString()] = f[C]);
          for (C = 0, S = f.length; C < S; C++) {
           if (!x[f[C].parent.toString()]) {
            typeof n < 'u' &&
             ((n._data.core.last_error = {
              error: 'parse',
              plugin: 'core',
              id: 'core_07',
              ...
              data: JSON.stringify({
               id: f[C].id.toString(),
               parent: f[C].parent.toString(),
              }),
             }),
             n.settings.core.error.call(n, n._data.core.last_error));
            continue;
           }
           x[f[C].parent.toString()].children.push(f[C].id.toString()),
            A.children_d.push(f[C].id.toString());
          }
          for (C = 0, S = A.children.length; C < S; C++)
           (P = F(x[A.children[C]], _, A.parents.concat())),
            g.push(P),
            x[P].children_d.length && (g = g.concat(x[P].children_d));
          for (C = 0, S = A.parents.length; C < S; C++)
           x[A.parents[C]].children_d = x[A.parents[C]].children_d.concat(g);
          L = { cnt: O, mod: x, sel: K, par: _, dpc: g, add: p };
         } else {
          for (C = 0, S = f.length; C < S; C++)
           (P = X(f[C], _, A.parents.concat())),
            P &&
             (u.push(P),
             g.push(P),
             x[P].children_d.length && (g = g.concat(x[P].children_d)));
          for (
           A.children = u, A.children_d = g, C = 0, S = A.parents.length;
           C < S;
           C++
          )
           x[A.parents[C]].children_d = x[A.parents[C]].children_d.concat(g);
         ...
         if (this.element !== null) {
          ...
          for (f in _)
           _.hasOwnProperty(f) &&
            ...
            _[f].state.loading &&
            h.mod[f] &&
            (h.mod[f].state.loading = !0);
          if (((this._model.data = h.mod), o)) {
           var u,
            g = h.add,
            p = h.sel,
            m = this._data.core.selected.slice();
           if (
            ((_ = this._model.data),
            p.length !== m.length ||
             l.vakata.array_unique(p.concat(m)).length !== p.length)
           ) {
            for (f = 0, u = p.length; f < u; f++)
             l.inArray(p[f], g) === -1 &&
              l.inArray(p[f], m) === -1 &&
              (_[p[f]].state.selected = !1);
            for (f = 0, u = m.length; f < u; f++)
             l.inArray(m[f], p) === -1 && (_[m[f]].state.selected = !0);
           }
          }
          h.add.length &&
           (this._data.core.selected = this._data.core.selected.concat(h.add)),
           this.trigger('model', { nodes: h.dpc, parent: h.par }),
           h.par !== l.jstree.root
            ? (this._node_changed(h.par), this.redraw())
            : this.redraw(!0),
           h.add.length &&
            this.trigger('changed', {
             action: 'model',
        ...
        try {
         this._wrk === null &&
          (this._wrk = window.URL.createObjectURL(
           new window.Blob(['self.onmessage = ' + c.toString()], {
           ...
           ? ((this._data.core.working = !0),
             ...
             a.par
              ...
              : this._data.core.worker_queue.length
                ...
                : (this._data.core.working = !1))
           : this._data.core.worker_queue.push([e, s, t, !0]);
        } catch {
         d.call(this, c(a), !1),
          this._data.core.worker_queue.length
           ? this._append_json_data.apply(
     ...
     _parse_model_from_html: function (e, s, t) {
      ...
      for (c in this._model.default_state)
       this._model.default_state.hasOwnProperty(c) &&
        (n.state[c] = this._model.default_state[c]);
      if (
       ((d = l.vakata.attributes(e, !0)),
       l.each(d, function (o, f) {
        if (((f = l.vakata.trim(f)), !f.length)) return !0;
        (n.li_attr[o] = f), o === 'id' && (n.id = f.toString());
       }),
       (d = e.children('a').first()),
       d.length &&
        ((d = l.vakata.attributes(d, !0)),
        l.each(d, function (o, f) {
         (f = l.vakata.trim(f)), f.length && (n.a_attr[o] = f);
        })),
       (d = e.children('a').first().length
        ? e.children('a').first().clone()
        : e.clone()),
      ...
      (d = e.children('a').children('.jstree-themeicon')),
       d.length &&
        (n.icon = d.hasClass('jstree-themeicon-hidden') ? !1 : d.attr('rel')),
       n.state.icon !== y && (n.icon = n.state.icon),
       (n.icon === y || n.icon === null || n.icon === '') && (n.icon = !0),
       (d = e.children('ul').children('li'));
      do h = 'j' + this._id + '_' + ++this._cnt;
      while (a[h]);
      return (
       (n.id = n.li_attr.id ? n.li_attr.id.toString() : h),
       d.length
        ? (d.each(
           function (o, f) {
            (i = this._parse_model_from_html(l(f), n.id, t)),
             (r = this._model.data[i]),
             n.children.push(i),
             r.children_d.length &&
              (n.children_d = n.children_d.concat(r.children_d));
           }.bind(this),
          ),
       ...
       (a[n.id] = n),
       n.state.selected && this._data.core.selected.push(n.id),
       n.id
      );
     },
     _parse_model_from_flat_json: function (e, s, t) {
      ...
      for (n in a) a.hasOwnProperty(n) && (o.state[n] = a[n]);
      if (
       (e &&
        e.data &&
        e.data.jstree &&
       ...
       (o.icon === y || o.icon === null || o.icon === '') && (o.icon = !0),
      ...
      if (
       (o.li_attr.id || (o.li_attr.id = i), e && typeof e.a_attr == 'object')
      )
       for (n in e.a_attr)
      ...
      for (
       ...
       (d = this._parse_model_from_flat_json(r[o.children[n]], o.id, t)),
        (h = r[d]),
        o.children_d.push(d),
        h.children_d.length &&
         (o.children_d = o.children_d.concat(h.children_d));
      return (
       delete e.data,
       delete e.children,
       (r[o.id].original = e),
     ...
     _parse_model_from_json: function (e, s, t) {
      ...
      for (r in h) h.hasOwnProperty(r) && (o.state[r] = h[r]);
      if (
       (e && (e.id || e.id === 0) && (o.id = e.id.toString()),
      ...
      if (
       ...
       e && typeof e.a_attr == 'object')
      )
       for (r in e.a_attr)
        e.a_attr.hasOwnProperty(r) && (o.a_attr[r] = e.a_attr[r]);
      if (e && e.children && e.children.length) {
       for (r = 0, a = e.children.length; r < a; r++)
        (n = this._parse_model_from_json(e.children[r], o.id, t)),
         (c = d[n]),
         o.children.push(n),
         c.children_d.length &&
          (o.children_d = o.children_d.concat(c.children_d));
     ...
     _redraw: function () {
      var e = this._model.force_full_redraw
        ? this._model.data[l.jstree.root].children.concat([])
      ...
      for (i = 0, r = e.length; i < r; i++)
       (t = this.redraw_node(e[i], !0, this._model.force_full_redraw)),
        t && this._model.force_full_redraw && s.appendChild(t);
      this._model.force_full_redraw &&
       ((s.className = this.get_container_ul()[0].className),
       s.setAttribute('role', 'presentation'),
       this.element.empty().append(s)),
       a !== null &&
        this.settings.core.restore_focus &&
        ((t = this.get_node(a, !0)),
        t && t.length && t.children('.jstree-anchor')[0] !== T.activeElement
     ...
     draw_children: function (e) {
      var s = this.get_node(e),
       ...
       a = T;
      if (!s) return !1;
      if (s.id === l.jstree.root) return this.redraw(!0);
      if (((e = this.get_node(e, !0)), !e || !e.length)) return !1;
      if (
       (e.children('.jstree-children').remove(),
       (e = e[0]),
       s.children.length && s.state.loaded)
      ) {
       for (
     ...
     redraw_node: function (e, s, t, i) {
      var r = this.get_node(e),
       ...
       x = !1;
      if (!r) return !1;
      if (r.id === l.jstree.root) return this.redraw(!0);
      if (
       ((s = s || r.children.length === 0),
       (e = T.querySelector
        ? this.element[0].querySelector(
           '#' +
            ('0123456789'.indexOf(r.id[0]) !== -1
             ? '\\3' +
               r.id[0] +
               ' ' +
               r.id.substr(1).replace(l.jstree.idregex, '\\$&')
             : r.id.replace(l.jstree.idregex, '\\$&')),
          )
        : T.getElementById(r.id)),
       e)
      )
       (e = l(e)),
        t ||
        ...
        !s &&
         ...
         (s = !0),
        s || (c = e.children('.jstree-children')[0]),
        (g = e.children('.jstree-anchor')[0] === T.activeElement),
        e.remove();
      else if (((s = !0), !t)) {
       if (
        ((a =
         r.parent !== l.jstree.root
          ? l('#' + r.parent.replace(l.jstree.idregex, '\\$&'), this.element)[0]
          : null),
        a !== null && (!a || !u[r.parent].state.opened))
       )
        return !1;
       n = l.inArray(
        r.id,
        a === null ? u[l.jstree.root].children : u[r.parent].children,
       );
      }
      ...
      for (
       r.a_attr.id || (r.a_attr.id = r.id + '_anchor'),
        e.childNodes[1].setAttribute('aria-selected', !!r.state.selected),
        e.childNodes[1].setAttribute('aria-level', r.parents.length),
        this.settings.core.compute_elements_positions &&
         (e.childNodes[1].setAttribute(
          'aria-setsize',
          u[r.parent].children.length,
         ),
         e.childNodes[1].setAttribute(
          'aria-posinset',
          u[r.parent].children.indexOf(r.id) + 1,
         )),
        r.state.disabled && e.childNodes[1].setAttribute('aria-disabled', !0),
        d = 0,
        h = r.children.length;
       d < h;
       d++
      ...
      if (
       ...
       u[r.parent] &&
       !r.state.hidden &&
       ((d = l.inArray(r.id, u[r.parent].children)), (x = r.id), d !== -1)
      )
       for (
        d++, h = u[r.parent].children.length;
        d < h &&
        (u[u[r.parent].children[d]].state.hidden ||
         (x = u[r.parent].children[d]),
        x === r.id);
        d++
       );
      r.state.hidden && (f += ' jstree-hidden'),
       r.state.loading && (f += ' jstree-loading'),
       r.state.loaded && !O
        ? (f += ' jstree-leaf')
        : ((f +=
           r.state.opened && r.state.loaded
            ? ' jstree-open'
            : ' jstree-closed'),
          e.childNodes[1].setAttribute(
           'aria-expanded',
       ...
       x === r.id && (f += ' jstree-last'),
       (e.id = r.id),
       (e.className = f),
       (f =
        (r.state.selected ? ' jstree-clicked' : '') +
        (r.state.disabled ? ' jstree-disabled' : ''));
      for (h in r.a_attr)
       if (r.a_attr.hasOwnProperty(h)) {
        if (h === 'href' && r.a_attr[h] === '#') continue;
        h !== 'class'
         ? e.childNodes[1].setAttribute(h, r.a_attr[h])
         : (f += ' ' + r.a_attr[h]);
       }
      if (
       (f.length && (e.childNodes[1].className = 'jstree-anchor ' + f),
       ((r.icon && r.icon !== !0) || r.icon === !1) &&
        (r.icon === !1
         ? (e.childNodes[1].childNodes[0].className +=
            ' jstree-themeicon-hidden')
         : r.icon.indexOf('/') === -1 && r.icon.indexOf('.') === -1
           ? (e.childNodes[1].childNodes[0].className +=
              ' ' + r.icon + ' jstree-themeicon-custom')
       ...
       this.settings.core.force_text
        ? e.childNodes[1].appendChild(_.createTextNode(r.text))
        : (e.childNodes[1].innerHTML += r.text),
       s && r.children.length && (r.state.opened || i) && r.state.loaded)
      ) {
       for (
        o = _.createElement('UL'),
      ...
      if ((c && e.appendChild(c), !t)) {
       for (
        a || (a = this.element[0]), d = 0, h = a.childNodes.length;
        d < h;
        d++
       )
        if (
         ...
         a.childNodes[d].className.indexOf('jstree-children') !== -1
        ) {
         p = a.childNodes[d];
         break;
        }
       p ||
        ((p = _.createElement('UL')),
     ...
     open_node: function (e, s, t) {
      ...
      if (((e = this.get_node(e)), !e || e.id === l.jstree.root)) return !1;
      if (
       ((t = t === y ? this.settings.core.animation : t), !this.is_closed(e))
      )
      ...
      if (this.is_loaded(e))
       return (
        ...
        (!t || !a.length) && this.trigger('after_open', { node: e }),
        !0
       );
     ...
     close_node: function (e, s) {
      ...
      if (
       ((e = this.get_node(e)),
       !e || e.id === l.jstree.root || this.is_closed(e))
      )
       return !1;
      (s = s === y ? this.settings.core.animation : s),
       (r = this),
       (a = this.get_node(e, !0)),
       (e.state.opened = !1),
          ...
          ? a
             ...
             .slideUp(s, function () {
              (this.style.display = ''),
               ...
               r.element && r.trigger('after_close', { node: e });
             })
          : ((a[0].className = a[0].className.replace(
             'jstree-open',
             'jstree-closed',
     ...
     toggle_node: function (e) {
      ...
      if (this.is_closed(e)) return this.open_node(e);
      if (this.is_open(e)) return this.close_node(e);
     },
     open_all: function (e, s, t) {
      if ((e || (e = l.jstree.root), (e = this.get_node(e)), !e)) return !1;
      var i =
        e.id === l.jstree.root ? this.get_container_ul() : this.get_node(e, !0),
       r,
       a,
       n;
      if (!i.length) {
       for (r = 0, a = e.children_d.length; r < a; r++)
        this.is_closed(this._model.data[e.children_d[r]]) &&
         (this._model.data[e.children_d[r]].state.opened = !0);
       return this.trigger('open_all', { node: e });
      }
      (t = t || i),
       (n = this),
       (i = this.is_closed(e)
        ? i.find('.jstree-closed').addBack()
        : i.find('.jstree-closed')),
       i.each(function () {
        n.open_node(
         this,
         function (c, d) {
       ...
       t.find('.jstree-closed').length === 0 &&
        this.trigger('open_all', { node: this.get_node(t) });
     },
     ...
     hide_all: function (e) {
      ...
      for (s in t)
       t.hasOwnProperty(s) &&
        s !== l.jstree.root &&
        !t[s].state.hidden &&
        ((t[s].state.hidden = !0), i.push(s));
      return (
       (this._model.force_full_redraw = !0),
       e || this.redraw(),
       this.trigger('hide_all', { nodes: i }),
       i
      );
     },
     show_all: function (e) {
      ...
      for (s in t)
       t.hasOwnProperty(s) &&
        s !== l.jstree.root &&
        t[s].state.hidden &&
        ((t[s].state.hidden = !1), i.push(s));
      return (
       (this._model.force_full_redraw = !0),
       e || this.redraw(),
       this.trigger('show_all', { nodes: i }),
       i
      );
     },
     activate_node: function (e, s) {
      ...
      if (
       ...
       (this._data.core.last_clicked =
        this._data.core.last_clicked && this._data.core.last_clicked.id !== y
       ...
       for (n = 0, c = r.length; n < c; n += 1)
        r[n] === t && (a = !a),
         r[n] === i && (a = !a),
         !this.is_disabled(r[n]) && (a || r[n] === t || r[n] === i)
          ? this.is_hidden(r[n]) || this.select_node(r[n], !0, !1, s)
          : s.ctrlKey || this.deselect_node(r[n], !0, s);
       this.trigger('changed', {
        action: 'select_node',
       ...
       this.is_selected(e)
        ? this.deselect_node(e, !1, s)
        : (s.ctrlKey && (this._data.core.last_clicked = this.get_node(e)),
          this.select_node(e, !1, !1, s));
     ...
     hover_node: function (e) {
      if (
       ...
       return !1;
      var s = this.element.find('.jstree-hovered'),
       t = this.element;
      s && s.length && this.dehover_node(s),
     ...
     deselect_node: function (e, s, t) {
      ...
      (a = this.get_node(e, !0)),
       e.state.selected &&
        ((e.state.selected = !1),
        (this._data.core.selected = l.vakata.array_remove_item(
         this._data.core.selected,
         e.id,
        )),
        a.length &&
     ...
     select_all: function (e) {
      var s = this._data.core.selected.concat([]),
       t,
       i;
      for (
       this._data.core.selected =
        this._model.data[l.jstree.root].children_d.concat(),
        t = 0,
       ...
       this._model.data[this._data.core.selected[t]] &&
        (this._model.data[this._data.core.selected[t]].state.selected = !0);
      this.redraw(!0),
     ...
     is_selected: function (e) {
      return (
       (e = this.get_node(e)),
       !e || e.id === l.jstree.root ? !1 : e.state.selected
      );
     },
     ...
     get_top_selected: function (e) {
      var s = this.get_selected(!0),
       t = {},
       i,
       r,
       a,
       n;
      for (i = 0, r = s.length; i < r; i++) t[s[i].id] = s[i];
      for (i = 0, r = s.length; i < r; i++)
       for (a = 0, n = s[i].children_d.length; a < n; a++)
        t[s[i].children_d[a]] && delete t[s[i].children_d[a]];
      s = [];
      for (i in t) t.hasOwnProperty(i) && s.push(i);
      return e
       ? l.map(
          s,
          function (c) {
     ...
     get_state: function () {
      ...
      for (s in this._model.data)
       this._model.data.hasOwnProperty(s) &&
        s !== l.jstree.root &&
        (this._model.data[s].state.loaded &&
         this.settings.core.loaded_state &&
         e.core.loaded.push(s),
        this._model.data[s].state.opened && e.core.open.push(s),
        this._model.data[s].state.selected && e.core.selected.push(s));
      return e;
     },
     set_state: function (e, s) {
      if (e) {
       if (
        (e.core &&
         e.core.selected &&
         e.core.initial_selection === y &&
         (e.core.initial_selection = this._data.core.selected
          .concat([])
          .sort()
          .join(',')),
        e.core)
        ...
        if (e.core.loaded)
         return (
          !this.settings.core.loaded_state ||
          !l.vakata.is_array(e.core.loaded) ||
          !e.core.loaded.length
           ? (delete e.core.loaded, this.set_state(e, s))
           : this._load_nodes(e.core.loaded, function (r) {
              delete e.core.loaded, this.set_state(e, s);
             }),
          !1
         );
        if (e.core.open)
         return (
          !l.vakata.is_array(e.core.open) || !e.core.open.length
           ? (delete e.core.open, this.set_state(e, s))
           : this._load_nodes(e.core.open, function (r) {
        ...
        if (e.core.selected)
         return (
          (t = this),
          (e.core.initial_selection === y ||
           e.core.initial_selection ===
            this._data.core.selected.concat([]).sort().join(',')) &&
           (this.deselect_all(),
           l.each(e.core.selected, function (r, a) {
            t.select_node(a, !1, !0);
           })),
          delete e.core.initial_selection,
        ...
        for (i in e)
         e.hasOwnProperty(i) &&
          i !== 'core' &&
          l.inArray(i, this.settings.plugins) === -1 &&
          delete e[i];
        if (l.isEmptyObject(e.core))
         return delete e.core, this.set_state(e, s), !1;
       }
       return l.isEmptyObject(e)
        ? ((e = null), s && s.call(this), this.trigger('set_state'), !1)
        : !0;
      }
      return !1;
     },
     refresh: function (e, s) {
      (this._data.core.state = s === !0 ? {} : this.get_state()),
       s &&
        l.vakata.is_function(s) &&
        (this._data.core.state = s.call(this, this._data.core.state)),
       (this._cnt = 0),
       (this._model.data = {}),
       (this._model.data[l.jstree.root] = {
        id: l.jstree.root,
      ...
      e ||
       ...
       this.element.attr('aria-activedescendant', 'j' + this._id + '_loading')),
       this.load_node(l.jstree.root, function (i, r) {
        r &&
         ((this.get_container_ul()[0].className = t),
         this._firstChild(this.get_container_ul()[0]) &&
          this.element.attr(
           'aria-activedescendant',
           this._firstChild(this.get_container_ul()[0]).id,
          ),
         this.set_state(l.extend(!0, {}, this._data.core.state), function () {
     ...
     refresh_node: function (e) {
      ...
      t.push(e.id),
       ...
       this._load_nodes(
        t,
        function (r) {
         this.open_node(s, !1, 0),
          this.select_node(i),
          this.trigger('refresh_node', { node: e, nodes: r });
        }.bind(this),
        !1,
        !0,
       );
     ...
     set_id: function (e, s) {
      ...
      for (
       s = s.toString(),
        r[e.parent].children[l.inArray(e.id, r[e.parent].children)] = s,
        t = 0,
        i = e.parents.length;
       t < i;
       t++
      )
       r[e.parents[t]].children_d[l.inArray(e.id, r[e.parents[t]].children_d)] =
        s;
      for (t = 0, i = e.children.length; t < i; t++)
       r[e.children[t]].parent = s;
      for (t = 0, i = e.children_d.length; t < i; t++)
       r[e.children_d[t]].parents[l.inArray(e.id, r[e.children_d[t]].parents)] =
        s;
      return (
       (t = l.inArray(e.id, this._data.core.selected)),
       t !== -1 && (this._data.core.selected[t] = s),
       (t = this.get_node(e.id, !0)),
       t &&
        (t.attr('id', s),
        this.element.attr('aria-activedescendant') === e.id &&
         this.element.attr('aria-activedescendant', s)),
       delete r[e.id],
       (e.id = s),
       (e.li_attr.id = s),
       (r[s] = e),
     ...
     set_text: function (e, s) {
      ...
      return (
       (e = this.get_node(e)),
       !e || e.id === l.jstree.root
        ? !1
        : ((e.text = s),
          this.get_node(e, !0).length && this.redraw_node(e.id),
          this.trigger('set_text', { obj: e, text: s }),
          !0)
      );
     },
     get_json: function (e, s, t) {
      if (((e = this.get_node(e || l.jstree.root)), !e)) return !1;
      s && s.flat && !t && (t = []);
      var i = {
        id: e.id,
        text: e.text,
        ...
        data:
         s && s.no_data
          ? !1
          : l.extend(!0, l.vakata.is_array(e.data) ? [] : {}, e.data),
       },
       r,
       a;
      if (
       (s && s.flat ? (i.parent = e.parent) : (i.children = []),
       !s || !s.no_state)
      )
       for (r in e.state)
      ...
      if (
       (s && s.no_li_attr && delete i.li_attr,
       s && s.no_a_attr && delete i.a_attr,
       s &&
        s.no_id &&
        (delete i.id,
        i.li_attr && i.li_attr.id && delete i.li_attr.id,
        i.a_attr && i.a_attr.id && delete i.a_attr.id),
       s && s.flat && e.id !== l.jstree.root && t.push(i),
       !s || !s.no_children)
      )
       for (r = 0, a = e.children.length; r < a; r++)
        s && s.flat
         ? this.get_json(e.children[r], s, t)
         : i.children.push(this.get_json(e.children[r], s));
     ...
     create_node: function (e, s, t, i, r) {
      ...
      if (
       ((t = t === y ? 'last' : t),
       !t.toString().match(/^(before|after)$/) && !r && !this.is_loaded(e))
      )
       return this.load_node(e, function () {
        this.create_node(e, s, t, i, !0);
       });
      s || (s = { text: this.get_string('New node') }),
       typeof s == 'string' ? (s = { text: s }) : (s = l.extend(!0, {}, s)),
       s.text === y && (s.text = this.get_string('New node'));
      var a, n, c, d;
      switch (
       (e.id === l.jstree.root &&
        (t === 'before' && (t = 'first'), t === 'after' && (t = 'last')),
       t)
      ) {
       case 'before':
        (a = this.get_node(e.parent)),
         (t = l.inArray(e.id, a.children)),
         (e = a);
        break;
       case 'after':
        (a = this.get_node(e.parent)),
         (t = l.inArray(e.id, a.children) + 1),
         (e = a);
        break;
       case 'inside':
       case 'first':
      ...
      if (
       (t > e.children.length && (t = e.children.length),
       s.id === y && (s.id = !0),
       !this.check('create_node', s, e, t))
      )
       return (
      ...
      if (
       (s.id === !0 && delete s.id,
       (s = this._parse_model_from_json(s, e.id, e.parents.concat())),
       !s)
      )
       return !1;
      for (
       ...
       this._model.data[e.parents[c]].children_d =
        this._model.data[e.parents[c]].children_d.concat(n);
     ...
     rename_node: function (e, s) {
      ...
      return (
       ...
       !e || e.id === l.jstree.root
        ? !1
        : ((r = e.text),
          this.check('rename_node', e, this.get_parent(e), s)
           ? (this.set_text(e, s),
             this.trigger('rename_node', { node: e, text: s, old: r }),
             !0)
     ...
     delete_node: function (e) {
      ...
      if (
       ...
       (r = l.inArray(e.id, i.children)),
       (o = !1),
       !this.check('delete_node', e, i, r))
      )
       return (
        this.settings.core.error.call(this, this._data.core.last_error), !1
       );
      for (
       r !== -1 && (i.children = l.vakata.array_remove(i.children, r)),
       ...
       this._model.data[e.parents[n]].children_d = l.vakata.array_filter(
      ...
      for (
       o &&
        ...
        this.trigger('delete_node', { node: e, parent: i.id }),
        o &&
         this.trigger('changed', {
          action: 'delete_node',
          node: e,
      ...
      return (
       l.inArray(this._data.core.focused, a) !== -1 &&
        ((this._data.core.focused = null),
        (f = this.element[0].scrollTop),
        (_ = this.element[0].scrollLeft),
        i.id === l.jstree.root
         ? this._model.data[l.jstree.root].children[0] &&
           this.get_node(this._model.data[l.jstree.root].children[0], !0)
            .children('.jstree-anchor')
            .trigger('focus')
         : this.get_node(i, !0).children('.jstree-anchor').trigger('focus'),
        (this.element[0].scrollTop = f),
     ...
     check: function (e, s, t, i, r) {
      ...
      var a = e.match(/^(move_node|copy_node|create_node)$/i) ? t : s,
       n = this.settings.core.check_callback;
      if (e === 'move_node' || e === 'copy_node') {
       if (
        (!r || !r.is_multi) &&
        e === 'move_node' &&
        l.inArray(s.id, t.children) === i
       )
        return (
         (this._data.core.last_error = {
          error: 'check',
       ...
       if (
        (!r || !r.is_multi) &&
        (s.id === t.id ||
         (e === 'move_node' && l.inArray(s.id, t.children) === i) ||
         l.inArray(t.id, s.children_d) !== -1)
       )
        return (
         (this._data.core.last_error = {
          error: 'check',
      ...
      return (
       a && a.data && (a = a.data),
       a && a.functions && (a.functions[e] === !1 || a.functions[e] === !0)
        ? (a.functions[e] === !1 &&
           (this._data.core.last_error = {
            error: 'check',
            plugin: 'core',
          ...
          a.functions[e])
        : n === !1 ||
            (l.vakata.is_function(n) && n.call(this, e, s, t, i, r) === !1) ||
            (n && n[e] === !1)
          ? ((this._data.core.last_error = {
             error: 'check',
             plugin: 'core',
             id: 'core_03',
             reason:
              'User config for core.check_callback prevents function: ' + e,
             data: JSON.stringify({
              chk: e,
              pos: i,
              obj: s && s.id ? s.id : !1,
     ...
     move_node: function (e, s, t, i, r, a, n) {
      ...
      if (((s = this.get_node(s)), (t = t === y ? 0 : t), !s)) return !1;
      ...
      if (l.vakata.is_array(e))
       if (e.length === 1) e = e[0];
        ...
        for (c = 0, d = e.length; c < d; c++)
         (p = this.move_node(e[c], s, t, i, r, !1, n)) &&
          ((s = p), (t = 'after'));
        return this.redraw(), !0;
       }
      if (
       ((e = e && e.id !== y ? e : this.get_node(e)),
       !e || e.id === l.jstree.root)
      )
       return !1;
      if (
       ((h = (e.parent || l.jstree.root).toString()),
       (f =
        !t.toString().match(/^(before|after)$/) || s.id === l.jstree.root
         ? s
         : this.get_node(s.parent)),
       (_ = n || (this._model.data[e.id] ? this : l.jstree.reference(e.id))),
       (u = !_ || !_._id || this._id !== _._id),
       (o =
        _ && _._id && h && _._model.data[h] && _._model.data[h].children
         ? l.inArray(e.id, _._model.data[h].children)
         : -1),
       _ && _._id && (e = _._model.data[e.id]),
       u)
      )
       return (p = this.copy_node(e, s, t, i, r, !1, n))
        ? (_ && _.delete_node(e), p)
        : !1;
      switch (
       (s.id === l.jstree.root &&
      ...
      if (
       (t > f.children.length && (t = f.children.length),
       !this.check('move_node', e, f, t, {
        core: !0,
        origin: n,
      ...
      if (e.parent === f.id) {
       for (
        g = f.children.concat(),
         p = l.inArray(e.id, g),
         p !== -1 && ((g = l.vakata.array_remove(g, p)), t > p && t--),
         p = [],
         m = 0,
         N = g.length;
        m < N;
       ...
       (p[t] = e.id),
        ...
        this.redraw(f.id === l.jstree.root);
      } else {
       for (
        p = e.children_d.concat(), p.push(e.id), m = 0, N = e.parents.length;
        m < N;
        m++
       ) {
        for (
         g = [],
          A = _._model.data[e.parents[m]].children_d,
          O = 0,
          x = A.length;
         O < x;
         O++
       ...
       for (
        _._model.data[h].children = l.vakata.array_remove_item(
         _._model.data[h].children,
         e.id,
        ),
         m = 0,
         N = f.parents.length;
        ...
        this._model.data[f.parents[m]].children_d =
         this._model.data[f.parents[m]].children_d.concat(p);
       ...
       for (
        g[t] = e.id,
         ...
         p = p.concat(),
         m = 0,
         N = e.children_d.length;
        m < N;
        m++
       )
        (this._model.data[e.children_d[m]].parents = this._model.data[
         e.children_d[m]
        ].parents.slice(0, A * -1)),
         Array.prototype.push.apply(
          this._model.data[e.children_d[m]].parents,
          p,
         );
       (h === l.jstree.root || f.id === l.jstree.root) &&
        (this._model.force_full_redraw = !0),
        this._model.force_full_redraw ||
         (this._node_changed(h), this._node_changed(f.id)),
        a || this.redraw();
      }
      return (
       i && i.call(this, e, f, t),
     ...
     copy_node: function (e, s, t, i, r, a, n) {
      ...
      if (l.vakata.is_array(e))
       if (e.length === 1) e = e[0];
        ...
        for (c = 0, d = e.length; c < d; c++)
         (o = this.copy_node(e[c], s, t, i, r, !0, n)) &&
          ((s = o), (t = 'after'));
        return this.redraw(), !0;
       }
      if (
       ...
       return !1;
      switch (
       ((g = (e.parent || l.jstree.root).toString()),
       (p =
        !t.toString().match(/^(before|after)$/) || s.id === l.jstree.root
         ? s
         : this.get_node(s.parent)),
       (m = n || (this._model.data[e.id] ? this : l.jstree.reference(e.id))),
       !m || !m._id || (this._id, m._id),
       m && m._id && (e = m._model.data[e.id]),
       s.id === l.jstree.root &&
        (t === 'before' && (t = 'first'), t === 'after' && (t = 'last')),
       t)
      ) {
      ...
      if (
       (t > p.children.length && (t = p.children.length),
       !this.check('copy_node', e, p, t, {
        core: !0,
        origin: n,
      ...
      if (
       ((u = m ? m.get_json(e, { no_id: !0, no_data: !0, no_state: !0 }) : e),
       !u ||
        (u.id === !0 && delete u.id,
        (u = this._parse_model_from_json(u, p.id, p.parents.concat())),
        !u))
      )
       return !1;
      for (
       o = this.get_node(u),
        e && e.state && e.state.loaded === !1 && (o.state.loaded = !1),
        h = [],
        h.push(u),
        h = h.concat(o.children_d),
        this.trigger('model', { nodes: h, parent: p.id }),
        f = 0,
        _ = p.parents.length;
       f < _;
       f++
      )
       this._model.data[p.parents[f]].children_d =
        this._model.data[p.parents[f]].children_d.concat(h);
      for (h = [], f = 0, _ = p.children.length; f < _; f++)
       h[f >= t ? f + 1 : f] = p.children[f];
      return (
       (h[t] = o.id),
       (p.children = h),
       p.children_d.push(o.id),
       (p.children_d = p.children_d.concat(o.children_d)),
       p.id === l.jstree.root && (this._model.force_full_redraw = !0),
       this._model.force_full_redraw || this._node_changed(p.id),
       a || this.redraw(p.id === l.jstree.root),
       i && i.call(this, o, p, t),
       this.trigger('copy_node', {
        ...
        old_parent: g,
        old_position:
         m && m._id && g && m._model.data[g] && m._model.data[g].children
          ? l.inArray(e.id, m._model.data[g].children)
          : -1,
        is_multi: m && m._id && m._id !== this._id,
        is_foreign: !m || !m._id,
        old_instance: m,
     ...
     cut: function (e) {
      ...
      for (i = 0, r = e.length; i < r; i++)
       (t = this.get_node(e[i])),
        t && (t.id || t.id === 0) && t.id !== l.jstree.root && s.push(t);
     ...
     copy: function (e) {
      ...
      for (i = 0, r = e.length; i < r; i++)
       (t = this.get_node(e[i])),
        t && t.id !== y && t.id !== l.jstree.root && s.push(t);
      if (!s.length) return !1;
     ...
     paste: function (e, s) {
      if (
       ((e = this.get_node(e)),
       !e || !q || !q.match(/^(copy_node|move_node)$/) || !D)
      )
       return !1;
      this[q](D, e, s, !1, !1, !1, J) &&
       this.trigger('paste', { parent: e.id, node: D, mode: q }),
       (D = !1),
       (q = !1),
       (J = !1);
     },
     ...
     edit: function (e, s, t) {
      ...
      (f = e),
       (s = typeof s == 'string' ? s : e.text),
       this.set_text(e, ''),
       (e = this._open_to(e)),
       (f.text = s),
       (i = this._data.core.rtl),
       (r = this.element.width()),
       (this._data.core.focused = f.id),
       (a = e.children('.jstree-anchor').trigger('focus')),
       (n = l('<span></span>'));
      /*!
...
*/ (c = s),
       ...
       (h = l('<input />', {
        ...
        blur: function (u) {
         ...
         var g = n.children('.jstree-rename-input'),
          p = g.val(),
          m = this.settings.core.force_text,
          N;
         p === '' && (p = c),
          d.remove(),
          n.replaceWith(a),
          n.remove(),
          (c = m ? c : l('<div></div>').append(l.parseHTML(c)).html()),
          (e = this.get_node(e)),
          this.set_text(e, c),
          (N = !!this.rename_node(
           e,
           m
            ? l('<div></div>').text(p).text()
            : l('<div></div>').append(l.parseHTML(p)).html(),
          )),
          N || this.set_text(e, c),
          (this._data.core.focused = f.id),
          setTimeout(
          ...
          t && t.call(this, f, N, _, p),
          (h = null);
        }.bind(this),
        keydown: function (u) {
         var g = u.which;
         g === 27 && ((_ = !0), (this.value = c)),
          (g === 27 ||
           g === 13 ||
           g === 37 ||
           g === 38 ||
          ...
          (g === 27 || g === 13) && (u.preventDefault(), this.blur());
        },
        click: function (u) {
         u.stopImmediatePropagation();
        },
       ...
       n.attr('class', a.attr('class')).append(a.contents().clone()).append(h),
       a.replaceWith(n),
       d.css(o),
       h
        .css(o)
        .width(Math.min(d.text('pW' + h[0].value).width(), r))[0]
        .select(),
       l(T).one(
          ...
          s === !1
           ...
           : s === !0 || s === null || s === y || s === ''
             ? (r
                ...
                .css('background', '')
                .removeAttr('rel'),
               a === !1 && this.show_icon(e))
             : s.indexOf('/') === -1 && s.indexOf('.') === -1
               ? (r.removeClass(a).css('background', ''),
                 r.addClass(s + ' jstree-themeicon-custom').attr('rel', s),
                 a === !1 && this.show_icon(e))
               : (r.removeClass(a).css('background', ''),
                 r
                  .addClass('jstree-themeicon-custom')
                  .css('background', "url('" + s + "') center center no-repeat")
                  .attr('rel', s),
                 a === !1 && this.show_icon(e)),
          !0)
      );
    ...
    (l.vakata = {}),
    (l.vakata.attributes = function (e, s) {
     e = l(e)[0];
     var t = s ? {} : [];
     return (
      e &&
       e.attributes &&
       l.each(e.attributes, function (i, r) {
        l.inArray(r.name.toLowerCase(), [
         'style',
         'contenteditable',
         'hasfocus',
         'tabindex',
         ...
         r.value !== null &&
         l.vakata.trim(r.value) !== '' &&
         (s ? (t[r.name] = r.value) : t.push(r.name));
       }),
      t
     );
    }),
    ...
    (l.vakata.array_filter = function (e, s, t, i, r) {
     if (e.filter) return e.filter(s, t);
     i = [];
     for (r in e)
    ...
    (l.jstree.plugins.changed = function (e, s) {
     ...
     (this.trigger = function (i, r) {
      ...
      if ((r || (r = {}), i.replace('.jstree', '') === 'changed')) {
       ...
       var c = {};
       for (a = 0, n = t.length; a < n; a++) c[t[a]] = 1;
       for (a = 0, n = r.selected.length; a < n; a++)
        c[r.selected[a]]
         ? (c[r.selected[a]] = 2)
         : r.changed.selected.push(r.selected[a]);
   ...
   (V.className = 'jstree-icon jstree-checkbox'),
    V.setAttribute('role', 'presentation'),
    (l.jstree.defaults.checkbox = {
     visible: !0,
     three_state: !0,
     whole_node: !0,
     ...
     (this.bind = function () {
      s.bind.call(this),
       ...
       this.element
        ...
        .on(
         ...
         function () {
          this[
           this._data.checkbox.visible ? 'show_checkboxes' : 'hide_checkboxes'
          ]();
         }.bind(this),
        ),
         ...
         function (t, i) {
          ...
          for (n = 0, c = a.length; n < c; n++)
           (r[a[n]].state.checked =
            r[a[n]].state.checked ||
            (r[a[n]].original &&
             r[a[n]].original.state &&
             r[a[n]].original.state.checked)),
            r[a[n]].state.checked && this._data.checkbox.selected.push(a[n]);
         }.bind(this),
        ),
        ...
        this.element
           ...
           if (g.indexOf('down') !== -1) {
            if (a.state[p ? 'selected' : 'checked']) {
             ...
             this._data[p ? 'core' : 'checkbox'].selected =
              this._data[p ? 'core' : 'checkbox'].selected.concat(n);
            } else
             for (h = 0, o = n.length; h < o; h++)
              if (r[n[h]].state[p ? 'selected' : 'checked']) {
               for (f = 0, _ = r[n[h]].children_d.length; f < _; f++)
                r[r[n[h]].children_d[f]].state[p ? 'selected' : 'checked'] = !0;
               this._data[p ? 'core' : 'checkbox'].selected = this._data[
                p ? 'core' : 'checkbox'
               ].selected.concat(r[n[h]].children_d);
              }
           }
           if (g.indexOf('up') !== -1) {
            for (h = 0, o = a.children_d.length; h < o; h++)
             r[a.children_d[h]].children.length ||
              c.push(r[a.children_d[h]].parent);
             ...
             for (a = r[c[f]]; a && a.id !== l.jstree.root; ) {
              ...
              if (d === o)
               (a.state[p ? 'selected' : 'checked'] = !0),
                this._data[p ? 'core' : 'checkbox'].selected.push(a.id),
                (u = this.get_node(a, !0)),
                u &&
                 u.length &&
                 u
                  .children('.jstree-anchor')
                  .attr('aria-selected', !0)
                  .addClass(p ? 'jstree-clicked' : 'jstree-checked');
              else break;
              a = this.get_node(a.parent);
             }
           }
           this._data[p ? 'core' : 'checkbox'].selected = l.vakata.array_unique(
            this._data[p ? 'core' : 'checkbox'].selected,
           );
          }.bind(this),
         )
         .on(
          ...
          function (t, i) {
           var r = i.node,
            ...
            u = {},
            g = this._data[_ ? 'core' : 'checkbox'].selected;
           for (c = 0, d = g.length; c < d; c++) u[g[c]] = !0;
           if (f.indexOf('down') !== -1) {
            var p = this._cascade_new_checked_state(r.id, !0),
             m = r.children_d.concat(r.id);
           ...
           g = [];
           for (c in u) u.hasOwnProperty(c) && g.push(c);
         ...
         .on(
          this.settings.checkbox.tie_selection
           ...
           : 'uncheck_all.jstree',
          function (t, i) {
           var r = this.get_node(l.jstree.root),
            a = this._model.data,
            n,
            c,
            d;
         ...
         .on(
          ...
          function (t, i) {
           ...
           var a,
            ...
            o = this._data[h ? 'core' : 'checkbox'].selected,
           ...
           if (d.indexOf('up') !== -1 && o.indexOf(r.id) === -1) {
            for (a = 0, n = r.parents.length; a < n; a++)
             (c = this._model.data[r.parents[a]]),
              (c.state[h ? 'selected' : 'checked'] = !1),
              c &&
               c.original &&
               c.original.state &&
               c.original.state.undetermined &&
               (c.original.state.undetermined = !1),
              (c = this.get_node(r.parents[a], !0)),
              c &&
               c.length &&
               c
                .children('.jstree-anchor')
                .attr('aria-selected', !1)
                .removeClass(h ? 'jstree-clicked' : 'jstree-checked');
            o = l.vakata.array_filter(o, function (u) {
         ...
         .on(
          ...
          function (t, i) {
           for (
            ...
            r && r.id !== l.jstree.root && !r.state[o ? 'selected' : 'checked'];

           ) {
            for (d = 0, n = 0, c = r.children.length; n < c; n++)
             d += a[r.children[n]].state[o ? 'selected' : 'checked'];
            if (c > 0 && d === c)
             (r.state[o ? 'selected' : 'checked'] = !0),
              this._data[o ? 'core' : 'checkbox'].selected.push(r.id),
              (h = this.get_node(r, !0)),
              h &&
               h.length &&
               h
          ...
          function (t, i) {
           ...
           if (!r)
            for (
             ...
             d &&
             d.id !== l.jstree.root &&
             !d.state[u ? 'selected' : 'checked'];

            ) {
             for (h = 0, o = 0, f = d.children.length; o < f; o++)
              h += c[d.children[o]].state[u ? 'selected' : 'checked'];
             if (f > 0 && h === f)
              (d.state[u ? 'selected' : 'checked'] = !0),
               this._data[u ? 'core' : 'checkbox'].selected.push(d.id),
               (_ = this.get_node(d, !0)),
               _ &&
                _.length &&
                _.children('.jstree-anchor')
                 .attr('aria-selected', !0)
                 .addClass(u ? 'jstree-clicked' : 'jstree-checked');
             else break;
           ...
           for (d = n; d && d.id !== l.jstree.root; ) {
            ...
            if (h === f)
             ...
             (d.state[u ? 'selected' : 'checked'] = !1),
              (this._data[u ? 'core' : 'checkbox'].selected =
               l.vakata.array_remove_item(
                this._data[u ? 'core' : 'checkbox'].selected,
                d.id,
               )),
              (_ = this.get_node(d, !0)),
              _ &&
               ...
               _.children('.jstree-anchor')
                .attr('aria-selected', !1)
                .removeClass(u ? 'jstree-clicked' : 'jstree-checked');
            else break;
            d = this.get_node(d.parent);
           }
          }.bind(this),
      ...
      (this.get_undetermined = function (t) {
       ...
       for (i = 0, r = o.length; i < r; i++)
        if (d[o[i]] && d[o[i]].parents)
         for (
          a = 0, n = d[o[i]].parents.length;
          a < n && c[d[o[i]].parents[a]] === y;
          a++
         )
          d[o[i]].parents[a] !== l.jstree.root &&
           ((c[d[o[i]].parents[a]] = !0), f.push(d[o[i]].parents[a]));
       for (
        this.element
         .find('.jstree-closed')
         .not(':has(.jstree-children)')
         .each(function () {
          var g = _.get_node(this),
           p;
          if (g) {
           if (g.state.loaded) {
            for (i = 0, r = g.children_d.length; i < r; i++)
             if (
              ...
              !p.state.loaded &&
               p.original &&
               p.original.state &&
               p.original.state.undetermined &&
               p.original.state.undetermined === !0)
             )
              for (
               c[p.id] === y &&
                p.id !== l.jstree.root &&
                ((c[p.id] = !0), f.push(p.id)),
                a = 0,
                n = p.parents.length;
               a < n;
               a++
               ...
               c[p.parents[a]] === y &&
                p.parents[a] !== l.jstree.root &&
                ((c[p.parents[a]] = !0), f.push(p.parents[a]));
           } else if (
            g.original &&
            g.original.state &&
            g.original.state.undetermined &&
            g.original.state.undetermined === !0
           )
            for (
             c[g.id] === y &&
              g.id !== l.jstree.root &&
              ((c[g.id] = !0), f.push(g.id)),
              a = 0,
              n = g.parents.length;
             a < n;
             a++
             ...
             c[g.parents[a]] === y &&
              g.parents[a] !== l.jstree.root &&
              ((c[g.parents[a]] = !0), f.push(g.parents[a]));
          }
         }),
         i = 0,
         r = f.length;
       ...
       if (((t = s.redraw_node.apply(this, arguments)), t)) {
        ...
        for (n = 0, c = t.childNodes.length; n < c; n++)
         if (
          ...
          t.childNodes[n].className.indexOf('jstree-anchor') !== -1
         ) {
          d = t.childNodes[n];
          break;
         }
        d &&
         ...
         this._model.data[t.id].state.checkbox_disabled &&
          (h.className += ' jstree-checkbox-disabled'),
         d.insertBefore(h, d.childNodes[0]));
       }
       return (
        !r &&
         this.settings.checkbox.cascade.indexOf('undetermined') !== -1 &&
      ...
      (this.is_undetermined = function (t) {
       ...
       var i = this.settings.checkbox.cascade,
        ...
        c = this._data[n ? 'core' : 'checkbox'].selected,
        d = this._model.data;
       if (
        !t ||
        t.state[n ? 'selected' : 'checked'] === !0 ||
        i.indexOf('undetermined') === -1 ||
        (i.indexOf('down') === -1 && i.indexOf('up') === -1)
       )
        return !1;
       if (!t.state.loaded && t.original.state.undetermined === !0) return !0;
       for (r = 0, a = t.children_d.length; r < a; r++)
        if (
         l.inArray(t.children_d[r], c) !== -1 ||
         (!d[t.children_d[r]].state.loaded &&
          d[t.children_d[r]].original.state.undetermined)
        )
         return !0;
       return !1;
      }),
      (this.disable_checkbox = function (t) {
       ...
       if (((t = this.get_node(t)), !t || t.id === l.jstree.root)) return !1;
       (a = this.get_node(t, !0)),
      ...
      (this.activate_node = function (t, i) {
       if (l(i.target).hasClass('jstree-checkbox-disabled')) return !1;
       if (
        (this.settings.checkbox.tie_selection &&
         (this.settings.checkbox.whole_node ||
          l(i.target).hasClass('jstree-checkbox')) &&
         (i.ctrlKey = !0),
        this.settings.checkbox.tie_selection ||
         (!this.settings.checkbox.whole_node &&
          !l(i.target).hasClass('jstree-checkbox')))
       ...
       if (this.is_disabled(t)) return !1;
      ...
      (this.delete_node = function (t) {
       ...
       if (((t = this.get_node(t)), !t || t.id === l.jstree.root)) return !1;
       for (
        i = t.children_d.concat([]), i.push(t.id), r = 0, a = i.length;
        r < a;
        r++
       )
       ...
       return (
        n &&
         (this._data.checkbox.selected = l.vakata.array_filter(
          this._data.checkbox.selected,
          function (c) {
      ...
      (this._cascade_new_checked_state = function (t, i) {
       var r = this,
        ...
        f;
       if (
        (this.settings.checkbox.cascade_to_disabled || !n.state.disabled) &&
        (this.settings.checkbox.cascade_to_hidden || !n.state.hidden)
       ) {
        if (n.children)
         for (h = 0, o = n.children.length; h < o; h++) {
          var _ = n.children[h];
          (f = r._cascade_new_checked_state(_, i)),
           (c = c.concat(f)),
           f.indexOf(_) > -1 && d.push(_);
         }
        var u = r.get_node(n, !0),
         g = d.length > 0 && d.length < n.children.length;
        n.original &&
         n.original.state &&
         n.original.state.undetermined &&
         (n.original.state.undetermined = g),
         g
          ...
          : i && d.length === n.children.length
            ? ((n.state[a ? 'selected' : 'checked'] = i),
              c.push(n.id),
              u
               .children('.jstree-anchor')
               .attr('aria-selected', !0)
        ...
        (f = this.get_checked_descendants(t)),
         n.state[a ? 'selected' : 'checked'] && f.push(n.id),
         (c = c.concat(f));
       return c;
      }),
      ...
      (this.uncheck_node = function (t, i) {
       ...
       (n = this.get_node(t, !0)),
        t.state.checked &&
         ((t.state.checked = !1),
         (this._data.checkbox.selected = l.vakata.array_remove_item(
          this._data.checkbox.selected,
          t.id,
         )),
         n.length && n.children('.jstree-anchor').removeClass('jstree-checked'),
      ...
      (this.uncheck_all = function () {
       ...
       var t = this._data.checkbox.selected.concat([]),
        i,
        r;
       for (i = 0, r = this._data.checkbox.selected.length; i < r; i++)
        this._model.data[this._data.checkbox.selected[i]] &&
         (this._model.data[this._data.checkbox.selected[i]].state.checked = !1);
       (this._data.checkbox.selected = []),
      ...
      (this.is_checked = function (t) {
       return this.settings.checkbox.tie_selection
        ? this.is_selected(t)
        : ((t = this.get_node(t)),
          !t || t.id === l.jstree.root ? !1 : t.state.checked);
      }),
      ...
      (this.load_node = function (t, i) {
       ...
       if (
        !l.vakata.is_array(t) &&
        !this.settings.checkbox.tie_selection &&
        ((n = this.get_node(t)), n && n.state.loaded)
       )
        for (r = 0, a = n.children_d.length; r < a; r++)
         this._model.data[n.children_d[r]].state.checked &&
          (this._data.checkbox.selected = l.vakata.array_remove_item(
           this._data.checkbox.selected,
           n.children_d[r],
          ));
      ...
      (this.get_state = function () {
       ...
       return (
        this.settings.checkbox.tie_selection ||
         (t.checkbox = this._data.checkbox.selected.slice()),
        t
       );
      }),
      ...
      (this.refresh = function (t, i) {
       return (
        this.settings.checkbox.tie_selection &&
         (this._data.checkbox.selected = []),
        s.refresh.apply(this, arguments)
       );
      });
    }),
     ...
     items: function (e, s) {
      return {
       create: {
        ...
        label: 'Create',
        action: function (t) {
         var i = l.jstree.reference(t.reference),
    ...
    (l.jstree.plugins.contextmenu = function (e, s) {
     (this.bind = function () {
      ...
      this.element
       ...
       .on(
        ...
        function (n, c) {
         n.target.tagName.toLowerCase() !== 'input' &&
          (n.preventDefault(),
          (t = n.ctrlKey ? +new Date() : 0),
          (c || i) && (t = +new Date() + 1e4),
          i && clearTimeout(i),
          this.is_loading(n.currentTarget) ||
           this.show_contextmenu(n.currentTarget, n.pageX, n.pageY, n));
        }.bind(this),
       )
       .on(
        'click.jstree',
       ...
       .on('touchstart.jstree', '.jstree-anchor', function (n) {
        !n.originalEvent ||
         !n.originalEvent.changedTouches ||
         !n.originalEvent.changedTouches[0] ||
         ((r = n.originalEvent.changedTouches[0].clientX),
         (a = n.originalEvent.changedTouches[0].clientY),
       ...
       .on('touchmove.vakata.jstree', function (n) {
        i &&
         ...
         n.originalEvent.changedTouches &&
         n.originalEvent.changedTouches[0] &&
         (Math.abs(r - n.originalEvent.changedTouches[0].clientX) > 10 ||
          Math.abs(a - n.originalEvent.changedTouches[0].clientY) > 10) &&
         (clearTimeout(i), l.vakata.context.hide());
       })
...
*/ l(T).on(
       ...
       function (n, c) {
        (this._data.contextmenu.visible = !1),
         l(c.reference).removeClass('jstree-context');
       }.bind(this),
      );
     }),
      (this.teardown = function () {
       this._data.contextmenu.visible && l.vakata.context.hide(),
        l(T).off('context_hide.vakata.jstree'),
      ...
      (this.show_contextmenu = function (t, i, r, a) {
       ...
       var n = this.settings.contextmenu,
        c = this.get_node(t, !0),
        d = c.children('.jstree-anchor'),
        h = !1,
        o = !1;
       (n.show_at_node || i === y || r === y) &&
        ((h = d.offset()),
        (i = h.left),
        (r = h.top + this._data.core.li_height)),
        this.settings.contextmenu.select_node &&
         !this.is_selected(t) &&
         this.activate_node(t, a),
        (o = n.items),
        l.vakata.is_function(o) &&
         (o = o.call(
          this,
          t,
          function (f) {
        ...
        l.isPlainObject(o) && this._show_contextmenu(t, i, r, o);
      }),
      (this._show_contextmenu = function (t, i, r, a) {
       var n = this.get_node(t, !0),
        c = n.children('.jstree-anchor');
       l(T).one(
        ...
        l.vakata.context.show(c, { x: i, y: r }, a),
     ...
     (e.vakata.context = {
      ...
      _execute: function (i) {
       return (
        ...
        i &&
        (!i._disabled ||
         (e.vakata.is_function(i._disabled) &&
          !i._disabled({
           item: i,
           reference: t.reference,
           element: t.element,
      ...
      _parse: function (i, r) {
       ...
       return (
        ...
        e.each(i, function (d, h) {
         ...
         t.items.push(h),
          ...
          (a +=
           ...
           (h._class || '') +
           (h._disabled === !0 ||
           (e.vakata.is_function(h._disabled) &&
            h._disabled({
             item: h,
             reference: t.reference,
             element: t.element,
            ...
            : '') +
           "' " +
           (h.shortcut ? " data-shortcut='" + h.shortcut + "' " : '') +
           '>'),
          (a +=
           "<a href='#' rel='" +
           (t.items.length - 1) +
          ...
          e.vakata.context.settings.icons &&
           ((a += '<i '),
           h.icon &&
            (h.icon.indexOf('/') !== -1 || h.icon.indexOf('.') !== -1
             ? (a +=
          ...
          (a +=
           (e.vakata.is_function(h.label)
            ? h.label({ item: d, reference: t.reference, element: t.element })
            : h.label) +
           (h.shortcut
           ...
           '</a>'),
          h.submenu &&
           ((c = e.vakata.context._parse(h.submenu, !0)), c && (a += c)),
          (a += '</li>'),
          h.separator_after &&
           ((a +=
            "<li class='vakata-context-separator'><a href='#' " +
        ...
        r && (a += '</ul>'),
        r || ((t.html = a), e.vakata.context._trigger('parse')),
        a.length > 10 ? a : !1
       );
      },
      _show_submenu: function (i) {
       if (((i = e(i)), !(!i.length || !i.children('ul').length))) {
        var r = i.children('ul'),
         ...
         f = e(window).height() + e(window).scrollTop();
        s
         ? i[n - (d + 10 + i.outerWidth()) < 0 ? 'addClass' : 'removeClass'](
            'vakata-context-left',
           )
         : i[n + d > o && a > o - n ? 'addClass' : 'removeClass'](
            'vakata-context-right',
           ),
         c + h + 10 > f && r.css('bottom', '-1px'),
         i.hasClass('vakata-context-right')
          ? a < d && r.css('margin-right', a - d)
          : o - n < d && r.css('margin-left', o - n - d),
         r.show();
       }
      },
      show: function (i, r, a) {
       ...
       switch ((t.element && t.element.length && t.element.width(''), g)) {
        ...
        case !r && !!i:
         (t.reference = i),
          (n = i.offset()),
          (t.position_x = n.left + i.outerHeight()),
          (t.position_y = n.top);
         break;
        case !!r && !i:
       ...
       i &&
        ...
        e.vakata.context._parse(a) && t.element.html(t.html),
        t.items.length &&
         (t.element.appendTo(T.body),
         (c = t.element),
         (d = t.position_x),
         (h = t.position_y),
         (o = c.width()),
         ...
         s &&
          ((d -= c.outerWidth() - e(i).outerWidth()),
          d < e(window).scrollLeft() + 20 && (d = e(window).scrollLeft() + 20)),
         d + o + 20 > _ && (d = _ - (o + 20)),
         h + f + 20 > u && (h = u - (f + 20)),
         t.element
          .css({ left: d, top: h })
      ...
      e(function () {
       ...
       var i = !1;
       (t.element = e("<ul class='vakata-context'></ul>")),
        t.element
         .on('mouseenter', 'li', function (r) {
          r.stopImmediatePropagation(),
           !e.contains(this, r.relatedTarget) &&
            (i && clearTimeout(i),
            t.element
         ...
         .on('click', 'a', function (r) {
          r.preventDefault(),
           !e(this)
            ...
            e.vakata.context._execute(e(this).attr('rel')) !== !1 &&
            e.vakata.context.hide();
         })
            ...
            t.is_visible &&
             ...
             a.length ||
              (a = t.element
               ...
               .last()),
             a.addClass('vakata-context-hover').children('a').trigger('focus'),
             r.stopImmediatePropagation(),
             r.preventDefault());
            break;
           case 39:
         ...
         .on('keydown', function (r) {
          r.preventDefault();
          var a = t.element
           .find('.vakata-contextmenu-shortcut-' + r.which)
           .parent();
          a.parent().not('.vakata-context-disabled') && a.trigger('click');
         }),
        e(T)
         .on('mousedown.vakata.jstree', function (r) {
          t.is_visible &&
           t.element[0] !== r.target &&
           !e.contains(t.element[0], r.target) &&
           e.vakata.context.hide();
         })
         .on('context_show.vakata.jstree', function (r, a) {
          t.element
           ...
           s &&
            t.element.addClass('vakata-context-rtl').css('direction', 'rtl'),
           t.element.find('ul').hide().end();
         });
      });
    })(l),
    (l.jstree.defaults.dnd = {
     copy: !0,
     open_timeout: 500,
     is_draggable: !0,
   ...
   (l.jstree.plugins.dnd = function (e, s) {
    (this.init = function (t, i) {
     s.init.call(this, t, i),
      (this.settings.dnd.use_html5 =
       this.settings.dnd.use_html5 && 'draggable' in T.createElement('span'));
    }),
     (this.bind = function () {
      s.bind.call(this),
       this.element.on(
        ...
        function (t) {
         if (
          (this.settings.dnd.large_drag_target &&
           l(t.target).closest('.jstree-node')[0] !== t.currentTarget) ||
          (t.type === 'touchstart' &&
         ...
         if (
          (this.settings.core.force_text && (a = l.vakata.html.escape(a)),
          i &&
           (i.id || i.id === 0) &&
           i.id !== l.jstree.root &&
           (t.which === 1 ||
           ...
           (this.settings.dnd.is_draggable === !0 ||
            (l.vakata.is_function(this.settings.dnd.is_draggable) &&
     ...
     (this.redraw_node = function (t, i, r, a) {
      if (
       ((t = s.redraw_node.apply(this, arguments)),
       t && this.settings.dnd.use_html5)
      )
       if (this.settings.dnd.large_drag_target) t.setAttribute('draggable', !0);
       else {
        var n,
         c,
         d = null;
    ...
    l(function () {
     var e = !1,
      ...
      t = !1,
      i = !1,
      r = l('<div id="jstree-marker">&#160;</div>').hide();
     l(T)
      .on('dragover.vakata.jstree', function (a) {
       M &&
        l.vakata.dnd._trigger('move', a, { helper: l(), element: M, data: I });
      })
      .on('drop.vakata.jstree', function (a) {
       M &&
        (l.vakata.dnd._trigger('stop', a, { helper: l(), element: M, data: I }),
        (M = null),
        (I = null));
      })
      .on('dnd_start.vakata.jstree', function (a, n) {
       (e = !1),
        (t = !1),
        !(!n || !n.data || !n.data.jstree) && r.appendTo(T.body);
      })
      .on('dnd_move.vakata.jstree', function (a, n) {
       var c = n.event.target !== t.target;
       if (
        (i && (!n.event || n.event.type !== 'dragover' || c) && clearTimeout(i),
        !(!n || !n.data || !n.data.jstree) &&
         !(n.event.target.id && n.event.target.id === 'jstree-marker'))
       ) {
        t = n.event;
        var d = l.jstree.reference(n.event.target),
         h = !1,
         o = !1,
         f = !1,
         _,
        ...
        if (d && d._data && d._data.dnd) {
         if (
          (r.attr(
           ...
           'jstree-' +
            d.get_theme() +
            (d.settings.core.themes.responsive ? ' jstree-dnd-responsive' : ''),
          ),
          (F =
           n.data.origin &&
           (n.data.origin.settings.dnd.always_copy ||
            (n.data.origin.settings.dnd.copy &&
             (n.event.metaKey || n.event.ctrlKey)))),
          n.helper
           .children()
           .attr(
            'class',
            'jstree-' +
             ...
             d.get_theme_variant() +
             ' ' +
             (d.settings.core.themes.responsive
              ? ' jstree-dnd-responsive'
              : ''),
           )
           .find('.jstree-copy')
           .first()
           [F ? 'show' : 'hide'](),
          (n.event.target === d.element[0] ||
           n.event.target === d.get_container_ul()[0]) &&
           (d.get_container_ul().children().length === 0 ||
            d.settings.dnd.blank_space_drop))
         ) {
          for (
           O = !0, x = 0, A = n.data.nodes.length;
           x < A &&
           ((O =
            O &&
            d.check(
             n.data.origin &&
              ...
              ? 'copy_node'
              : 'move_node',
             n.data.origin && n.data.origin !== d
              ? n.data.origin.get_node(n.data.nodes[x])
              : n.data.nodes[x],
             l.jstree.root,
             'last',
             {
              dnd: !0,
              ref: d.get_node(l.jstree.root),
              pos: 'i',
              origin: n.data.origin,
              is_multi: n.data.origin && n.data.origin !== d,
          ...
          if (O) {
           (e = { ins: d, par: l.jstree.root, pos: 'last' }),
            r.hide(),
            n.helper
             .find('.jstree-icon')
             .first()
            ...
            n.event.originalEvent &&
             n.event.originalEvent.dataTransfer &&
             (n.event.originalEvent.dataTransfer.dropEffect = F
              ? 'copy'
              : 'move');
           return;
          }
         } else if (
          ((h = d.settings.dnd.large_drop_target
           ? l(n.event.target)
              .closest('.jstree-node')
              .children('.jstree-anchor')
           : l(n.event.target).closest('.jstree-anchor')),
          h &&
           h.length &&
           h.parent().is('.jstree-closed, .jstree-open, .jstree-leaf') &&
           ((o = h.offset()),
           (f =
            (n.event.pageY !== y
             ? n.event.pageY
             : n.event.originalEvent.pageY) - o.top),
           (g = h.outerHeight()),
           f < g / 3
            ? (N = ['b', 'i', 'a'])
            : f > g - g / 3
           ...
           l.each(N, function (H, E) {
            switch (E) {
             case 'b':
              ...
              break;
             case 'i':
              (S = d.settings.dnd.inside_pos),
               (L = d.get_node(h.parent())),
               (_ = o.left - 2),
               (u = o.top + g / 2 + 1),
               (p = L.id),
               (m =
            ...
            for (O = !0, x = 0, A = n.data.nodes.length; x < A; x++)
             if (
              ...
              K === 'move_node' &&
               ...
               n.data.origin &&
               n.data.origin === d &&
               p === d.get_parent(n.data.nodes[x]) &&
               ((C = d.get_node(p)),
               P > l.inArray(n.data.nodes[x], C.children) && (P -= 1)),
              (O =
               O &&
               ((d &&
                d.settings &&
                d.settings.dnd &&
                d.settings.dnd.check_while_dragging === !1) ||
                d.check(
                 K,
                 n.data.origin && n.data.origin !== d
                  ? n.data.origin.get_node(n.data.nodes[x])
            ...
            if (
             (E === 'i' &&
              h.parent().is('.jstree-closed') &&
              d.settings.dnd.open_timeout &&
              (!n.event || n.event.type !== 'dragover' || c) &&
              (i && clearTimeout(i),
              (i = setTimeout(
               (function (j, w) {
                return function () {
             ...
             return (
              (X = d.get_node(p, !0)),
              X.hasClass('.jstree-dnd-parent') ||
               (l('.jstree-dnd-parent').removeClass('jstree-dnd-parent'),
               X.addClass('jstree-dnd-parent')),
              (e = {
               ins: d,
               par: p,
               pos:
                E === 'i' && S === 'last' && m === 0 && !d.is_loaded(L)
                 ? 'last'
                 : m,
              }),
              r.css({ left: _ + 'px', top: u + 'px' }).show(),
              r
        ...
        l('.jstree-dnd-parent').removeClass('jstree-dnd-parent'),
         ...
         n.helper
          ...
          .addClass('jstree-er'),
         n.event.originalEvent && n.event.originalEvent.dataTransfer,
         r.hide();
       }
      })
       ...
       if (
        ...
        if (e) {
         for (c = 0, d = n.data.nodes.length; c < d; c++)
          h[c] = n.data.origin
           ? n.data.origin.get_node(n.data.nodes[c])
           : n.data.nodes[c];
         e.ins[
          n.data.origin &&
          (n.data.origin.settings.dnd.always_copy ||
           ...
           ? 'copy_node'
           : 'move_node'
         ](h, e.par, e.pos, !1, !1, !1, n.data.origin);
        } else
         (c = l(n.event.target).closest('.jstree')),
          c.length &&
           s &&
           s.error &&
           s.error === 'check' &&
           ((c = c.jstree(!0)), c && c.settings.core.error.call(this, s));
        (t = !1), (e = !1);
       }
      })
         ...
         (a.type === 'keyup' && a.which === 27
          ...
          : (n.helper
             ...
             [
              n.data.origin &&
              (n.data.origin.settings.dnd.always_copy ||
               (n.data.origin.settings.dnd.copy && (a.metaKey || a.ctrlKey)))
               ? 'show'
               : 'hide'
             ](),
            t &&
    ...
    (function (e) {
     ...
     e.vakata.dnd = {
      ...
      _trigger: function (t, i, r) {
       r === y && (r = e.vakata.dnd._get()),
        (r.event = i),
        e(T).triggerHandler('dnd_' + t + '.vakata', r);
      },
      _get: function () {
       return { data: s.data, element: s.element, helper: s.helper };
      },
      _clean: function () {
       s.helper && s.helper.remove(),
        s.scroll_i && (clearInterval(s.scroll_i), (s.scroll_i = !1)),
        (s = {
         element: !1,
         target: !1,
         is_down: !1,
      ...
      _scroll: function (t) {
       ...
       if (t === !0) return !1;
       var i = s.scroll_e.scrollTop(),
        r = s.scroll_e.scrollLeft();
       s.scroll_e.scrollTop(
        i + s.scroll_t * e.vakata.dnd.settings.scroll_speed,
       ),
        s.scroll_e.scrollLeft(
         r + s.scroll_l * e.vakata.dnd.settings.scroll_speed,
        ),
        (i !== s.scroll_e.scrollTop() || r !== s.scroll_e.scrollLeft()) &&
         e.vakata.dnd._trigger('scroll', s.scroll_e);
      },
      start: function (t, i, r) {
       ...
       return (
        ...
        (s.target = t.target),
        (s.is_touch = t.type === 'touchstart'),
        r !== !1 &&
         (s.helper = e("<div id='vakata-dnd'></div>")
          .html(r)
          .css({
           display: 'block',
           margin: '0',
      ...
      drag: function (t) {
       if (
        ...
        if (!s.is_drag)
         if (
          Math.abs(t.pageX - s.init_x) >
           (s.is_touch
            ? e.vakata.dnd.settings.threshold_touch
            : e.vakata.dnd.settings.threshold) ||
          Math.abs(t.pageY - s.init_y) >
           (s.is_touch
            ? e.vakata.dnd.settings.threshold_touch
            : e.vakata.dnd.settings.threshold)
         )
          s.helper &&
           (s.helper.appendTo(T.body), (s.helper_w = s.helper.outerWidth())),
           (s.is_drag = !0),
           e(s.target).one('click.vakata', !1),
        ...
        return (
         ...
         e(e(t.target).parentsUntil('body').addBack().get().reverse())
          ...
          .each(function () {
           ...
           if (
            (this.scrollHeight > this.offsetHeight &&
             (g.top + u.height() - t.pageY <
              e.vakata.dnd.settings.scroll_proximity && (s.scroll_t = 1),
             t.pageY - g.top < e.vakata.dnd.settings.scroll_proximity &&
              (s.scroll_t = -1)),
            this.scrollWidth > this.offsetWidth &&
             (g.left + u.width() - t.pageX <
              e.vakata.dnd.settings.scroll_proximity && (s.scroll_l = 1),
             t.pageX - g.left < e.vakata.dnd.settings.scroll_proximity &&
              (s.scroll_l = -1)),
            s.scroll_t || s.scroll_l)
           )
         ...
         s.scroll_e ||
          ...
          (o = i.scrollLeft()),
          a > n &&
           t.pageY - h < e.vakata.dnd.settings.scroll_proximity &&
           (s.scroll_t = -1),
          a > n &&
           n - (t.pageY - h) < e.vakata.dnd.settings.scroll_proximity &&
           (s.scroll_t = 1),
          c > d &&
           t.pageX - o < e.vakata.dnd.settings.scroll_proximity &&
           (s.scroll_l = -1),
          c > d &&
           d - (t.pageX - o) < e.vakata.dnd.settings.scroll_proximity &&
           (s.scroll_l = 1),
          (s.scroll_t || s.scroll_l) && (s.scroll_e = i)),
         s.scroll_e && e.vakata.dnd._scroll(!0),
         s.helper &&
          ((f = parseInt(t.pageY + e.vakata.dnd.settings.helper_top, 10)),
          (_ = parseInt(t.pageX + e.vakata.dnd.settings.helper_left, 10)),
          a && f + 25 > a && (f = a - 50),
          c && _ + s.helper_w > c && (_ = c - (s.helper_w + 2)),
          s.helper.css({ left: _ + 'px', top: f + 'px' })),
      ...
      stop: function (t) {
       if (
        ...
        t.target !== s.target && e(s.target).off('click.vakata'),
    ...
    (l.jstree.defaults.massload = null),
    (l.jstree.plugins.massload = function (e, s) {
     (this.init = function (t, i) {
      ...
      (this._load_nodes = function (t, i, r, a) {
       ...
       if (!r) {
        for (h = 0, o = t.length; h < o; h++)
         (!d[t[h]] || (!d[t[h]].state.loaded && !d[t[h]].state.failed) || a) &&
          (c.push(t[h]),
          (f = this.get_node(t[h], !0)),
          f && f.length && f.addClass('jstree-loading').attr('aria-busy', !0));
        if (((this._data.massload = {}), c.length)) {
          ...
          return n.call(
           ...
           function (_) {
            ...
            for (u = 0, g = t.length; u < g; u++)
             (f = this.get_node(t[u], !0)),
              f &&
               f.length &&
               f.removeClass('jstree-loading').attr('aria-busy', !1);
         ...
         if (typeof n == 'object' && n && n.url)
          return (
           (n = l.extend(!0, {}, n)),
           l.vakata.is_function(n.url) && (n.url = n.url.call(this, c)),
           l.vakata.is_function(n.data) && (n.data = n.data.call(this, c)),
           l
            .ajax(n)
            .done(
             function (_, u, g) {
      ...
      (this._load_node = function (t, i) {
       var r = this._data.massload[t.id],
        a = null,
        n;
       return r
        ? ((a = this[
           typeof r == 'string' ? '_append_html_data' : '_append_json_data'
          ](
           t,
           typeof r == 'string'
            ? l(l.parseHTML(r)).filter(function () {
          ...
          (n = this.get_node(t.id, !0)),
          n &&
           n.length &&
           n.removeClass('jstree-loading').attr('aria-busy', !1),
          delete this._data.massload[t.id],
          a)
        : s._load_node.call(this, t, i);
      });
    }),
    ...
    (l.jstree.plugins.search = function (e, s) {
     (this.bind = function () {
         ...
         function (t, i) {
          if (this._data.search.som && i.res.length) {
           ...
           for (a = 0, n = i.res.length; a < n; a++)
            if (
             r[i.res[a]] &&
             !r[i.res[a]].state.hidden &&
             (c.push(i.res[a]),
             (c = c.concat(r[i.res[a]].parents)),
             this._data.search.smc)
            )
             for (d = 0, h = r[i.res[a]].children_d.length; d < h; d++)
              r[r[i.res[a]].children_d[d]] &&
               !r[r[i.res[a]].children_d[d]].state.hidden &&
               c.push(r[i.res[a]].children_d[d]);
           (c = l.vakata.array_remove_item(
            l.vakata.array_unique(c),
            l.jstree.root,
           )),
      ...
      (this.search = function (t, i, r, a, n, c) {
       ...
       (a = this.get_node(a)),
        (a = a && (a.id || a.id === 0) ? a.id : null),
        (t = t.toString());
       var d = this.settings.search,
        h = d.ajax ? d.ajax : !1,
        o = this._model.data,
        f = null,
        _ = [],
       ...
       if (
        ...
        r === y && (r = d.show_only_matches),
        c === y && (c = d.show_only_matches_children),
        !i && h !== !1)
       )
        return l.vakata.is_function(h)
         ? h.call(
            this,
            t,
            function (m) {
             m && m.d && (m = m.d),
              this._load_nodes(
               l.vakata.is_array(m) ? l.vakata.array_unique(m) : [],
               function () {
         ...
         : ((h = l.extend({}, h)),
           ...
           (this._data.search.lastRequest = l
            .ajax(h)
            .fail(
             function () {
              (this._data.core.last_error = {
       ...
       if (
        (n ||
         ((this._data.search.str = t),
         (this._data.search.dom = l()),
         (this._data.search.res = []),
         (this._data.search.opn = []),
         (this._data.search.som = r),
         (this._data.search.smc = c)),
        (f = new l.vakata.search(t, !0, {
         caseSensitive: d.case_sensitive,
         fuzzy: d.fuzzy,
        })),
        l.each(o[a || l.jstree.root].children_d, function (m, N) {
         var O = o[N];
         O.text &&
          !O.state.hidden &&
          (!d.search_leaves_only ||
           (O.state.loaded && O.children.length === 0)) &&
          ((d.search_callback && d.search_callback.call(this, t, O)) ||
           (!d.search_callback && f.search(O.text).isMatch)) &&
          (_.push(N), (u = u.concat(O.parents)));
        }),
        _.length)
       ) {
        for (u = l.vakata.array_unique(u), g = 0, p = u.length; g < p; g++)
         u[g] !== l.jstree.root &&
          o[u[g]] &&
          this.open_node(u[g], null, 0) === !0 &&
          this._data.search.opn.push(u[g]);
        n
            ...
            l(
             this.element[0].querySelectorAll(
              '#' +
               l
                .map(_, function (m) {
                 return '0123456789'.indexOf(m[0]) !== -1
                  ? '\\3' +
                     m[0] +
                     ' ' +
                     m.substr(1).replace(l.jstree.idregex, '\\$&')
                  : m.replace(l.jstree.idregex, '\\$&');
                })
                .join(', #'),
             ),
            ),
           )),
           (this._data.search.res = l.vakata.array_unique(
            this._data.search.res.concat(_),
           )))
         : ((this._data.search.dom = l(
            this.element[0].querySelectorAll(
             '#' +
           ...
           '#' +
            l
             .map(this._data.search.res, function (t) {
              return '0123456789'.indexOf(t[0]) !== -1
               ? '\\3' +
                  t[0] +
                  ' ' +
                  t.substr(1).replace(l.jstree.idregex, '\\$&')
               : t.replace(l.jstree.idregex, '\\$&');
             })
             .join(', #'),
          ),
         )),
      ...
      (this.redraw_node = function (t, i, r, a) {
       if (
        ((t = s.redraw_node.apply(this, arguments)),
        t && l.inArray(t.id, this._data.search.res) !== -1)
       ) {
        var n,
         c,
         d = null;
    ...
    (function (e) {
     (e.vakata.search = function (s, t, i) {
      (i = i || {}),
       ...
       i.fuzzy !== !1 && (i.fuzzy = !0),
       (s = i.caseSensitive ? s : s.toLowerCase());
      var r = i.location,
       a = i.distance,
       n = i.threshold,
       c = s.length,
      ...
      return (
       ...
       i.fuzzy &&
        ...
        (h = (function () {
         var _ = {},
          u = 0;
         for (u = 0; u < c; u++) _[s.charAt(u)] = 0;
         for (u = 0; u < c; u++) _[s.charAt(u)] |= 1 << (c - u - 1);
         return _;
        })()),
        (o = function (_, u) {
         var g = _ / c,
       ...
       (f = function (_) {
        if (
         ((_ = i.caseSensitive ? _.toString() : _.toString().toLowerCase()),
         s === _ || _.indexOf(s) !== -1)
        )
        ...
        for (
         N !== -1 &&
          ((m = Math.min(o(0, N), m)),
          (N = _.lastIndexOf(s, r + c)),
          N !== -1 && (m = Math.min(o(0, N), m))),
          N = -1,
          u = 0;
         u < c;
         u++
         ...
         for (
          ...
          if (
           ...
           if (((m = F), (N = g - 1), N > r)) P = Math.max(1, 2 * r - N);
           else break;
         if (o(u + 1, r) > m) break;
         K = S;
        }
        return { isMatch: N >= 0, score: F };
       }),
       t === !0 ? { search: f } : f(t)
      );
     }),
    ...
    (l.jstree.defaults.sort = function (e, s) {
      ...
      s.bind.call(this),
       this.element
        ...
        .on(
         ...
         function (t, i) {
          this.sort(i.parent || i.node.parent, !1),
           this.redraw_node(i.parent || i.node.parent, !0);
         }.bind(this),
        )
        .on(
      ...
      (this.sort = function (t, i) {
       ...
       if (
        ...
        t &&
         t.children &&
         t.children.length &&
         (t.children.sort(this.settings.sort.bind(this)), i))
       )
        for (r = 0, a = t.children_d.length; r < a; r++)
   ...
   (l.jstree.defaults.state = {
    ...
    (l.jstree.plugins.state = function (e, s) {
     (this.bind = function () {
      ...
      (this.restore_state = function () {
       ...
       return t && t.ttl && t.sec && +new Date() - t.sec > t.ttl
        ? !1
        : (t && t.state && (t = t.state),
          t &&
           l.vakata.is_function(this.settings.state.filter) &&
    ...
    (l.jstree.defaults.types = { default: {} }),
    (l.jstree.defaults.types[l.jstree.root] = {}),
    (l.jstree.plugins.types = function (e, s) {
     (this.init = function (t, i) {
      var r, a;
       ...
       for (r in i.types)
        if (r !== 'default' && r !== l.jstree.root && i.types.hasOwnProperty(r))
         for (a in i.types.default)
          i.types.default.hasOwnProperty(a) &&
           i.types[r][a] === y &&
           (i.types[r][a] = i.types.default[a]);
      }
      s.init.call(this, t, i),
       (this._model.data[l.jstree.root].type = l.jstree.root);
     }),
      (this.refresh = function (t, i) {
       s.refresh.call(this, t, i),
        (this._model.data[l.jstree.root].type = l.jstree.root);
      }),
      (this.bind = function () {
       this.element.on(
        ...
        function (t, i) {
         ...
         for (c = 0, d = a.length; c < d; c++) {
          if (
           ...
           r[a[c]].original &&
            r[a[c]].original.type &&
            n[r[a[c]].original.type] &&
            (h = r[a[c]].original.type),
           r[a[c]].data &&
            r[a[c]].data.jstree &&
            r[a[c]].data.jstree.type &&
            n[r[a[c]].data.jstree.type] &&
            (h = r[a[c]].data.jstree.type),
           (r[a[c]].type = h),
           r[a[c]].icon === !0 && n[h].icon !== y && (r[a[c]].icon = n[h].icon),
           n[h].li_attr !== y && typeof n[h].li_attr == 'object')
          ) {
           for (o in n[h].li_attr)
            if (n[h].li_attr.hasOwnProperty(o)) {
             if (o === 'id') continue;
             r[a[c]].li_attr[o] === y
              ? (r[a[c]].li_attr[o] = n[h].li_attr[o])
              : o === 'class' &&
                (r[a[c]].li_attr.class =
                 n[h].li_attr.class + ' ' + r[a[c]].li_attr.class);
            }
          }
          if (n[h].a_attr !== y && typeof n[h].a_attr == 'object') {
           for (o in n[h].a_attr)
            if (n[h].a_attr.hasOwnProperty(o)) {
             if (o === 'id') continue;
             r[a[c]].a_attr[o] === y
              ? (r[a[c]].a_attr[o] = n[h].a_attr[o])
              : o === 'href' && r[a[c]].a_attr[o] === '#'
                ? (r[a[c]].a_attr.href = n[h].a_attr.href)
                : o === 'class' &&
                  (r[a[c]].a_attr.class =
                   n[h].a_attr.class + ' ' + r[a[c]].a_attr.class);
            }
          }
         }
      ...
      (this.get_json = function (t, i, r) {
       var a,
        n,
        c = this._model.data,
        d = i ? l.extend(!0, {}, i, { no_id: !1 }) : {},
        h = s.get_json.call(this, t, d, r);
       if (h === !1) return !1;
       if (l.vakata.is_array(h))
        for (a = 0, n = h.length; a < n; a++)
         (h[a].type =
          (h[a].id || h[a].id === 0) && c[h[a].id] && c[h[a].id].type
           ? c[h[a].id].type
           : 'default'),
          i &&
           i.no_id &&
           (delete h[a].id,
           h[a].li_attr && h[a].li_attr.id && delete h[a].li_attr.id,
           h[a].a_attr && h[a].a_attr.id && delete h[a].a_attr.id);
       else
        (h.type =
         (h.id || h.id === 0) && c[h.id] && c[h.id].type
          ? c[h.id].type
          : 'default'),
         i && i.no_id && (h = this._delete_ids(h));
       return h;
      }),
      (this._delete_ids = function (t) {
       ...
       return (
        ...
        t.children &&
         l.vakata.is_array(t.children) &&
         (t.children = this._delete_ids(t.children)),
        t
       );
      }),
      (this.check = function (t, i, r, a, n) {
       if (s.check.call(this, t, i, r, a, n) === !1) return !1;
       (i = i && (i.id || i.id === 0) ? i : this.get_node(i)),
        (r = r && (r.id || r.id === 0) ? r : this.get_node(r));
       var c =
         i && (i.id || i.id === 0)
          ? n && n.origin
            ? n.origin
            : l.jstree.reference(i.id)
          : null,
        d,
        h,
        o,
        f;
       switch (
        ((c = c && c._model && c._model.data ? c._model.data : null), t)
       ) {
        case 'create_node':
        case 'move_node':
        case 'copy_node':
         if (t !== 'move_node' || l.inArray(i.id, r.children) === -1) {
          if (
           ...
           d.max_children !== y &&
            d.max_children !== -1 &&
            d.max_children === r.children.length)
          )
           return (
            (this._data.core.last_error = {
             error: 'check',
             plugin: 'types',
             id: 'types_01',
             reason: 'max_children prevents function: ' + t,
             data: JSON.stringify({
              chk: t,
              pos: a,
              obj: i && (i.id || i.id === 0) ? i.id : !1,
              par: r && (r.id || r.id === 0) ? r.id : !1,
             }),
            }),
            !1
           );
          if (
           d.valid_children !== y &&
           d.valid_children !== -1 &&
           l.inArray(i.type || 'default', d.valid_children) === -1
          )
           return (
            (this._data.core.last_error = {
             error: 'check',
             plugin: 'types',
             id: 'types_02',
             reason: 'valid_children prevents function: ' + t,
             data: JSON.stringify({
              chk: t,
              pos: a,
              obj: i && (i.id || i.id === 0) ? i.id : !1,
           ...
           if (d.max_depth !== y && d.max_depth !== -1 && d.max_depth < h)
            return (
             (this._data.core.last_error = {
              ...
              plugin: 'types',
              id: 'types_03',
              reason: 'max_depth prevents function: ' + t,
              data: JSON.stringify({
               chk: t,
               pos: a,
               obj: i && (i.id || i.id === 0) ? i.id : !1,
      ...
      (this.get_rules = function (t) {
       if (((t = this.get_node(t)), !t)) return !1;
       var i = this.get_type(t, !0);
       return (
        i.max_depth === y && (i.max_depth = -1),
        i.max_children === y && (i.max_children = -1),
        i.valid_children === y && (i.valid_children = -1),
        i
       );
      }),
      (this.get_type = function (t, i) {
       return (
        ...
        t
         ? i
           ? l.extend({ type: t.type }, this.settings.types[t.type])
           : t.type
         : !1
       );
      }),
      (this.set_type = function (t, i) {
       ...
       if (
        ((f = this.get_node(t, !0)),
        f && f.length && (_ = f.children('.jstree-anchor')),
        (d = t.type),
        (h = this.get_icon(t)),
        (t.type = i),
        (h === !0 || !a[d] || (a[d].icon !== y && h === a[d].icon)) &&
         this.set_icon(t, a[i].icon !== y ? a[i].icon : !0),
        a[d] && a[d].li_attr !== y && typeof a[d].li_attr == 'object')
       ) {
        for (o in a[d].li_attr)
         if (a[d].li_attr.hasOwnProperty(o)) {
          if (o === 'id') continue;
          o === 'class'
           ? ((r[t.id].li_attr.class = (r[t.id].li_attr.class || '').replace(
              a[d].li_attr[o],
              '',
             )),
             f && f.removeClass(a[d].li_attr[o]))
           : r[t.id].li_attr[o] === a[d].li_attr[o] &&
             ((r[t.id].li_attr[o] = null), f && f.removeAttr(o));
         }
       }
       if (a[d] && a[d].a_attr !== y && typeof a[d].a_attr == 'object') {
        for (o in a[d].a_attr)
         if (a[d].a_attr.hasOwnProperty(o)) {
          if (o === 'id') continue;
          o === 'class'
           ? ((r[t.id].a_attr.class = (r[t.id].a_attr.class || '').replace(
              a[d].a_attr[o],
              '',
             )),
             _ && _.removeClass(a[d].a_attr[o]))
           : r[t.id].a_attr[o] === a[d].a_attr[o] &&
             (o === 'href'
              ? ((r[t.id].a_attr[o] = '#'), _ && _.attr('href', '#'))
              : (delete r[t.id].a_attr[o], _ && _.removeAttr(o)));
         }
       }
       if (a[i].li_attr !== y && typeof a[i].li_attr == 'object') {
        for (o in a[i].li_attr)
         if (a[i].li_attr.hasOwnProperty(o)) {
          if (o === 'id') continue;
          r[t.id].li_attr[o] === y
           ? ((r[t.id].li_attr[o] = a[i].li_attr[o]),
             f &&
              (o === 'class'
               ? f.addClass(a[i].li_attr[o])
               : f.attr(o, a[i].li_attr[o])))
           : o === 'class' &&
             ((r[t.id].li_attr.class =
              a[i].li_attr[o] + ' ' + r[t.id].li_attr.class),
             f && f.addClass(a[i].li_attr[o]));
         }
       }
       if (a[i].a_attr !== y && typeof a[i].a_attr == 'object') {
        for (o in a[i].a_attr)
         if (a[i].a_attr.hasOwnProperty(o)) {
          if (o === 'id') continue;
          r[t.id].a_attr[o] === y
           ? ((r[t.id].a_attr[o] = a[i].a_attr[o]),
             _ &&
              (o === 'class'
               ? _.addClass(a[i].a_attr[o])
               : _.attr(o, a[i].a_attr[o])))
           : o === 'href' && r[t.id].a_attr[o] === '#'
             ? ((r[t.id].a_attr.href = a[i].a_attr.href),
               _ && _.attr('href', a[i].a_attr.href))
             : o === 'class' &&
               ((r[t.id].a_attr.class =
                a[i].a_attr.class + ' ' + r[t.id].a_attr.class),
               _ && _.addClass(a[i].a_attr[o]));
         }
       }
       return !0;
      });
    ...
    (l.jstree.plugins.unique = function (e, s) {
     (this.check = function (t, i, r, a, n) {
      ...
      for (_ = 0, u = r.children.length; _ < u; _++)
       (g = f[r.children[_]].text),
        h || (g = g.toLowerCase()),
        o && (g = g.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')),
        d.push(g);
      switch (
       (h || (c = c.toLowerCase()),
       o && (c = c.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')),
       t)
      ) {
       case 'delete_node':
        return !0;
       ...
       case 'move_node':
        return (
         (_ =
          (i.parent === r.id && (!n || !n.is_multi)) || l.inArray(c, d) === -1),
         _ ||
          (this._data.core.last_error = {
           error: 'check',
           plugin: 'unique',
      ...
      (this.create_node = function (t, i, r, a, n) {
       if (!i || (typeof i == 'object' && i.text === y)) {
        ...
        if (
         ((r = r === y ? 'last' : r),
         !r.toString().match(/^(before|after)$/) && !n && !this.is_loaded(t))
        )
         return s.create_node.call(this, t, i, r, a, n);
        i || (i = {});
        var c,
        ...
        for (
         ...
         (m = _[t.children[o]].text),
          u || (m = m.toLowerCase()),
          g && (m = m.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')),
          h.push(m);
        for (
         o = 1,
          m = d,
   ...
   if (
    ...
    (U.className = 'jstree-wholerow'),
    (U.innerHTML = '&#160;'),
    (l.jstree.plugins.wholerow = function (e, s) {
     (this.bind = function () {
      s.bind.call(this),
       this.element
        .on(
        ...
        .on(
         ...
         function (t, i) {
          ...
          for (a = 0, n = i.selected.length; a < n; a++)
           (r = this.get_node(i.selected[a], !0)),
            r &&
             r.length &&
             r.children('.jstree-wholerow').addClass('jstree-wholerow-clicked');
         }.bind(this),
        )
        .on(
         'open_node.jstree',
         function (t, i) {
          this.get_node(i.node, !0)
           .find('.jstree-clicked')
           .parent()
        ...
        .on(
         ...
         function (t, i) {
          (t.type === 'hover_node' && this.is_disabled(i.node)) ||
           this.get_node(i.node, !0)
            .children('.jstree-wholerow')
            [
             t.type === 'hover_node' ? 'addClass' : 'removeClass'
        ...
        .on(
         ...
         function (t) {
          return (
           t.stopImmediatePropagation(),
           this.is_disabled(t.currentTarget) ||
      ...
      (this.redraw_node = function (t, i, r, a) {
       if (((t = s.redraw_node.apply(this, arguments)), t)) {
        var n = U.cloneNode(!0);
        l.inArray(t.id, this._data.core.selected) !== -1 &&
    ...
    $.createdCallback = function () {
     ...
     for (s in l.jstree.plugins)
      l.jstree.plugins.hasOwnProperty(s) &&
       this.attributes[s] &&
       (e.plugins.push(s),
       this.getAttribute(s) &&
        JSON.parse(this.getAttribute(s)) &&
        (e[s] = JSON.parse(this.getAttribute(s))));
     for (s in l.jstree.defaults.core)
      l.jstree.defaults.core.hasOwnProperty(s) &&
       this.attributes[s] &&
       (e.core[s] = JSON.parse(this.getAttribute(s)) || this.getAttribute(s));
     l(this).jstree(e);
    };
    try {
