import { c as V } from './_commonjsHelpers-BosuxZz1.js';
(function () {
 function C(l, n) {
  var u = l.split('.'),
   t = al;
  ...
  for (var e; u.length && (e = u.shift()); )
   u.length || n === void 0 ? (t = t[e] ? t[e] : (t[e] = {})) : (t[e] = n);
 }
 function S(l, n) {
  function u() {}
 ...
 function f(l, n) {
  l != null && this.a.apply(this, arguments);
 }
 function o(l) {
  l.b = '';
 }
 ...
 function $(l, n) {
  for (var u = el(l.j()), t = 0; t < u.length; t++) {
   var e = u[t],
    r = e.b;
   if (n.a[r] != null) {
    l.b && delete l.b[e.b];
    var i = e.a == 11 || e.a == 10;
    if (e.g)
     for (var e = y(n, r) || [], d = 0; d < e.length; d++) {
      var s = l,
       b = r,
       wl = i ? e[d].clone() : e[d];
      s.a[b] || (s.a[b] = []), s.a[b].push(wl), s.b && delete s.b[b];
     }
    else
     (e = y(n, r)),
      i ? ((i = y(l, r)) ? $(i, e) : A(l, r, e.clone())) : A(l, r, e);
   }
  }
 }
 function y(l, n) {
 ...
 function h(l, n) {
  var u;
  if (l.a[n] != null) u = p(l, n, void 0);
  else
   l: {
    if (((u = l.f[n]), u.f === void 0)) {
     var t = u.i;
     if (t === Boolean) u.f = !1;
 ...
 function N(l, n) {
  var u,
   t = [];
  for (u in n) u != 0 && t.push(new rl(u, n[u]));
  return new tl(l, t);
 }
 function g() {
  c.call(this);
 ...
 function D(l, n) {
  ...
  var u = l.a[n];
  if (u == null) {
   if (((u = z[n]), u == null)) return null;
   (u = new _().a(m.j(), u)), (l.a[n] = u);
  }
  return u;
 }
 function E(l) {
  return (l = Z[l]), l == null ? 'ZZ' : l[0];
 }
 function w(l) {
  (this.H = RegExp(' ')),
   (this.C = ''),
 ...
 function j(l, n) {
  var u;
  if (n != null && isNaN(n) && n.toUpperCase() in z) {
   if (((u = D(l.G, n)), u == null)) throw Error('Invalid region code: ' + n);
   u = h(u, 10);
  } else u = 0;
  return (u = D(l.G, E(u))), u ?? Q;
 }
 function T(l) {
  for (var n = l.f.length, u = 0; u < n; ++u) {
   ...
   if (d.indexOf('|') != -1) r = !1;
    ...
    (d = d.replace(vl, '\\d')), (d = d.replace(Sl, '\\d')), o(r.m);
    var s;
    s = r;
    var i = h(i, 2),
     b = '999999999999999'.match(d)[0];
    b.length < s.a.b.length
     ? (s = '')
     : ((s = b.replace(new RegExp(d, 'g'), i)),
       (s = s.replace(RegExp('9', 'g'), ' '))),
     0 < s.length ? (r.m.a(s), (r = !0)) : (r = !1);
   }
   if (r) return (l.w = e), (l.B = W.test(p(t, 4))), (l.s = 0), !0;
  }
  return (l.l = !1);
 }
 function P(l, n) {
  for (var u = [], t = n.length - 3, e = l.f.length, r = 0; r < e; ++r) {
   ...
   M(i, 3) == 0
    ? u.push(l.f[r])
    : ((i = p(i, 3, Math.min(t, M(i, 3) - 1))),
      n.search(i) == 0 && u.push(l.f[r]));
  }
  l.f = u;
 }
 function il(l, n) {
  l.i.a(n);
  var u = n;
  if (bl.test(u) || (l.i.b.length == 1 && ml.test(u))) {
   var t,
    u = n;
   u == '+' ? ((t = u), l.u.a(u)) : ((t = gl[u]), l.u.a(t), l.a.a(t)), (n = t);
  } else (l.l = !1), (l.F = !0);
  if (!l.l) {
   if (!l.F) {
    if (J(l)) {
  ...
  switch (l.u.b.length) {
   ...
   case 2:
    return l.i.toString();
   case 3:
    if (!J(l)) return (l.h = Y(l)), I(l);
    l.A = !0;
   default:
    return l.A
     ? (L(l) && (l.A = !1), l.b.toString() + l.a.toString())
     : 0 < l.f.length
       ? ((u = O(l, n)),
         (t = U(l)),
         0 < t.length
          ? t
          : (P(l, l.a.toString()),
            T(l) ? K(l) : l.l ? B(l, u) : l.i.toString()))
       : I(l);
  }
 }
 function F(l) {
  return (
   (l.l = !0), (l.A = !1), (l.f = []), (l.s = 0), o(l.m), (l.w = ''), I(l)
  );
 }
 function U(l) {
  for (var n = l.a.toString(), u = l.f.length, t = 0; t < u; ++t) {
   ...
   if (new RegExp('^(?:' + r + ')$').test(n))
    return (
     (l.B = W.test(p(e, 4))),
     (n = n.replace(new RegExp(r, 'g'), p(e, 2))),
     B(l, n)
    );
  }
  return '';
 ...
 function I(l) {
  ...
  if (3 <= n.length) {
   for (
    ...
    var r = u[e];
    (0 < l.h.length && R(h(r, 4)) && !p(r, 6) && r.a[5] == null) ||
     ((l.h.length != 0 || l.o || R(h(r, 4)) || p(r, 6)) &&
      _l.test(h(r, 2)) &&
      l.f.push(r));
   }
   return P(l, n), (n = U(l)), 0 < n.length ? n : T(l) ? K(l) : l.i.toString();
  }
  return B(l, n);
 }
 function K(l) {
  var n = l.a.toString(),
   u = n.length;
  if (0 < u) {
   for (var t = '', e = 0; e < u; e++) t = O(l, n.charAt(e));
   return l.l ? B(l, t) : l.i.toString();
  }
  return l.b.toString();
 }
 function Y(l) {
  ...
  return (
   p(l.g, 10) != 1
    ? (n = !1)
    : ((n = l.a.toString()),
      (n = n.charAt(0) == '1' && n.charAt(1) != '0' && n.charAt(1) != '1')),
   n
    ? ((t = 1), l.b.a('1').a(' '), (l.o = !0))
    : l.g.a[15] != null &&
      ((n = new RegExp('^(?:' + p(l.g, 15) + ')')),
      (n = u.match(n)),
      n != null &&
       n[0] != null &&
       0 < n[0].length &&
       ((l.o = !0), (t = n[0].length), l.b.a(u.substring(0, t)))),
   o(l.a),
   l.a.a(u.substring(t)),
   u.substring(0, t)
  );
 ...
 function L(l) {
  if (l.a.b.length == 0) return !1;
  var n,
   u = new f();
  l: {
   if (((n = l.a.toString()), n.length != 0 && n.charAt(0) != '0')) {
    for (var t, e = n.length, r = 1; 3 >= r && r <= e; ++r)
     if (((t = parseInt(n.substring(0, r), 10)), t in Z)) {
      u.a(n.substring(r)), (n = t);
      break l;
     }
   }
   n = 0;
  ...
  return (
   ...
   l.a.a(u.toString()),
   (u = E(n)),
   u == '001' ? (l.g = D(l.G, '' + n)) : u != l.D && (l.g = j(l, u)),
   l.b.a('' + n).a(' '),
   (l.h = ''),
   !0)
  );
 ...
 function O(l, n) {
  ...
  if (0 <= u.substring(l.s).search(l.H)) {
   var t = u.search(l.H),
    u = u.replace(l.H, n);
   return o(l.m), l.m.a(u), (l.s = t), u.substring(0, l.s + 1);
  }
  return l.f.length == 1 && (l.l = !1), (l.w = ''), l.i.toString();
 }
 var al = this;
 (f.prototype.b = ''),
  ...
  (f.prototype.a = function (l, n, u) {
   if (((this.b += String(l)), n != null))
 ...
 (c.prototype.set = function (l, n) {
  ...
  (c.prototype.clone = function () {
   ...
   return l != this && ((l.a = {}), l.b && (l.b = {}), $(l, this)), l;
  }),
  S(g, c);
 var H = null;
 S(a, c);
 ...
 (g.prototype.j = function () {
    ...
    l ||
     (X = l =
      N(m, {
       ...
       1: { name: 'general_desc', c: 11, type: a },
       2: { name: 'fixed_line', c: 11, type: a },
       3: { name: 'mobile', c: 11, type: a },
       4: { name: 'toll_free', c: 11, type: a },
       5: { name: 'premium_rate', c: 11, type: a },
       6: { name: 'shared_cost', c: 11, type: a },
       7: { name: 'personal_number', c: 11, type: a },
       8: { name: 'voip', c: 11, type: a },
       21: { name: 'pager', c: 11, type: a },
       25: { name: 'uan', c: 11, type: a },
       27: { name: 'emergency', c: 11, type: a },
       28: { name: 'voicemail', c: 11, type: a },
       29: { name: 'short_code', c: 11, type: a },
       30: { name: 'standard_rate', c: 11, type: a },
       31: { name: 'carrier_specific', c: 11, type: a },
       33: { name: 'sms_services', c: 11, type: a },
       24: { name: 'no_international_dialling', c: 11, type: a },
  ...
  (x.prototype.b = function (l, n) {
   if (l.a == 11 || l.a == 10)
    return n instanceof c ? n : this.a(l.i.prototype.j(), n);
   if (l.a == 14) {
    if (typeof n == 'string' && k.test(n)) {
     var u = Number(n);
     if (0 < u) return u;
    }
    return n;
   ...
   if (((u = l.i), u === String)) {
    ...
    u === Number &&
    typeof n == 'string' &&
    (n === 'Infinity' || n === '-Infinity' || n === 'NaN' || k.test(n))
   )
    return Number(n);
   return n;
  });
 ...
 S(G, x),
  ...
  (_.prototype.b = function (l, n) {
   return l.a == 8 ? !!n : x.prototype.b.apply(this, arguments);
  }),
 ...
 (w.prototype.K = function () {
  ...
  (w.prototype.L = function (l) {
   return (this.C = il(this, l));
  }),
  C('Cleave.AsYouTypeFormatter', w),
  C('Cleave.AsYouTypeFormatter.prototype.inputDigit', w.prototype.L),
  C('Cleave.AsYouTypeFormatter.prototype.clear', w.prototype.K);
}).call(typeof V == 'object' && V ? V : window);
