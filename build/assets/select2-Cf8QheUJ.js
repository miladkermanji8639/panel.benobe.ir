import { g as K } from './_commonjsHelpers-BosuxZz1.js';
import { r as V } from './jquery-Czc5UB_B.js';
var X = { exports: {} };
/*!
 * Select2 4.0.13
 ...
 */ (function (N, Q) {
 (function (L) {
  N.exports
   ? (N.exports = function (W, z) {
      return (
       z === void 0 && (typeof window < 'u' ? (z = V()) : (z = V()(W))), L(z), z
      );
     })
   : L(jQuery);
 })(function (L) {
  var W = (function () {
    ...
    (function () {
      ...
      (function (r) {
       ...
       function E(f, A) {
        ...
        if (f) {
         for (
          f = f.split('/'),
           P = f.length - 1,
           h.nodeIdCompat && y.test(f[P]) && (f[P] = f[P].replace(y, '')),
           f[0].charAt(0) === '.' &&
            I &&
            ((q = I.slice(0, I.length - 1)), (f = q.concat(f))),
           v = 0;
          v < f.length;
          v++
         )
         ...
         for (w = f.split('/'), v = w.length; v > 0; v -= 1) {
          if (((B = w.slice(0, v).join('/')), I)) {
           for (F = I.length; F > 0; F -= 1)
            if (((x = j[I.slice(0, F).join('/')]), x && ((x = x[B]), x))) {
             (D = x), (d = v);
             break;
            }
          }
       ...
       function O(f, A) {
        return function () {
         ...
         return (
          typeof w[0] != 'string' && w.length === 1 && w.push(null),
          e.apply(r, w.concat([f, A]))
         );
        };
       }
       function T(f) {
       ...
       function R(f) {
        ...
        return (
         w > -1 &&
          ((A = f.substring(0, w)), (f = f.substring(w + 1, f.length))),
         [A, f]
        );
       }
       function H(f) {
       ...
       (i = {
        ...
        module: function (f) {
         return { id: f, uri: '', exports: o[f], config: Y(f) };
        },
       }),
        (t = function (f, A, w, B) {
         var x,
          ...
          S;
         if (
          ((B = B || f), (b = H(B)), F === 'undefined' || F === 'function')
         ) {
          for (
           A = !A.length && w.length ? ['require', 'exports', 'module'] : A,
            C = 0;
           C < A.length;
           C += 1
          )
           if (((d = n(A[C], b)), (D = d.f), D === 'require'))
            v[C] = i.require(f);
           else if (D === 'exports') (v[C] = i.exports(f)), (S = !0);
           else if (D === 'module') x = v[C] = i.module(f);
           else if (m(o, D) || m(a, D) || m(c, D)) v[C] = M(D);
           else if (d.p) d.p.load(d.n, O(B, !0), k(D), {}), (v[C] = o[D]);
           else throw new Error(f + ' missing ' + D);
          (P = w ? w.apply(o[f], v) : void 0),
           f &&
            (x && x.exports !== r && x.exports !== o[f]
             ? (o[f] = x.exports)
             : (P !== r || !S) && (o[f] = P));
         } else f && (o[f] = w);
        }),
        (u =
         ...
         e =
          function (f, A, w, B, x) {
           if (typeof f == 'string') return i[f] ? i[f](A) : M(n(f, H(A)).f);
           if (!f.splice) {
     ...
     g.define('almond', function () {}),
     g.define('jquery', [], function () {
      var u = L || $;
      return (
       u == null &&
        console &&
     ...
     g.define('select2/utils', ['jquery'], function (u) {
      ...
      l.Decorate = function (e, n) {
       ...
       function a() {
        ...
        O > 0 &&
         (E.call(arguments, e.prototype.constructor),
         (T = n.prototype.constructor)),
       ...
       for (
        var _ = function (E) {
          ...
          var T = n.prototype[E];
          return function () {
           var k = Array.prototype.unshift;
           return k.call(arguments, O), T.apply(this, arguments);
          };
         },
         y = 0;
        y < i.length;
      ...
      (r.prototype.on = function (e, n) {
       ...
       (r.prototype.trigger = function (e) {
        ...
        (this.listeners = this.listeners || {}),
         ...
         (i[0]._type = e),
         e in this.listeners &&
          this.invoke(this.listeners[e], n.call(arguments, 1)),
       ...
       (l.hasScroll = function (e, n) {
        var i = u(n),
         o = n.style.overflowX,
         a = n.style.overflowY;
        return o === a && (a === 'hidden' || a === 'visible')
         ? !1
         : o === 'scroll' || a === 'scroll'
           ? !0
           : i.innerHeight() < n.scrollHeight || i.innerWidth() < n.scrollWidth;
       }),
      ...
      var t = 0;
      return (
       (l.GetUniqueElementId = function (e) {
        var n = e.getAttribute('data-select2-id');
        return (
         n == null &&
          (e.id
           ? ((n = e.id), e.setAttribute('data-select2-id', n))
           : (e.setAttribute('data-select2-id', ++t), (n = t.toString()))),
         n
        );
       }),
       ...
       (l.GetData = function (e, n) {
        ...
        return n
         ? l.__cache[i] && l.__cache[i][n] != null
           ? l.__cache[i][n]
           : u(e).data(n)
         : l.__cache[i];
       }),
       (l.RemoveData = function (e) {
        ...
        l.__cache[n] != null && delete l.__cache[n],
     ...
     g.define('select2/results', ['jquery', './utils'], function (u, l) {
      ...
      return (
       l.Extend(s, l.Observable),
       (s.prototype.render = function () {
        var r = u('<ul class="select2-results__options" role="listbox"></ul>');
        return (
         this.options.get('multiple') && r.attr('aria-multiselectable', 'true'),
         (this.$results = r),
         r
        );
       }),
        ...
        this.data.current(function (t) {
         ...
         n.each(function () {
          var i = u(this),
           ...
           a = '' + o.id;
          (o.element != null && o.element.selected) ||
          (o.element == null && u.inArray(a, e) > -1)
       ...
       (s.prototype.showLoading = function (r) {
        ...
        var t = this.options.get('translations').get('searching'),
         e = { disabled: !0, loading: !0, text: t(r) },
         n = this.option(e);
       ...
       (s.prototype.option = function (r) {
        ...
        ((r.element != null && n.call(r.element, ':disabled')) ||
         (r.element == null && r.disabled)) &&
         (delete e['aria-selected'], (e['aria-disabled'] = 'true')),
         r.id == null && delete e['aria-selected'],
         r._resultId != null && (t.id = r._resultId),
       ...
       (s.prototype.bind = function (r, t) {
        ...
        this.$results.attr('id', n),
         r.on('results:all', function (i) {
          e.clear(),
           e.append(i.data),
           r.isOpen() && (e.setClasses(), e.highlightFirstItem());
         }),
         ...
         u.fn.mousewheel &&
          this.$results.on('mousewheel', function (i) {
           ...
           h
            ? (e.$results.scrollTop(0), i.preventDefault(), i.stopPropagation())
            : c &&
              (e.$results.scrollTop(
          ...
          function (i) {
           ...
           if (o.attr('aria-selected') === 'true') {
            e.options.get('multiple')
             ? e.trigger('unselect', { originalEvent: i, data: a })
             : e.trigger('close', {});
            return;
           }
           e.trigger('select', { originalEvent: i, data: a });
          },
         ),
         this.$results.on(
          'mouseenter',
          ...
          function (i) {
           ...
           e
            ...
            e.trigger('results:focus', { data: o, element: u(this) });
          },
         );
       }),
      ...
      function (u, l, s) {
       ...
       return (
        ...
        (r.prototype.render = function () {
         ...
         return (
          (this._tabindex = 0),
          l.GetData(this.$element[0], 'old-tabindex') != null
        ...
        (r.prototype._handleBlur = function (t) {
         ...
         window.setTimeout(function () {
          document.activeElement == e.$selection[0] ||
           u.contains(e.$selection[0], document.activeElement) ||
           e.trigger('blur', t);
         }, 1);
        }),
        ...
        (t.prototype.bind = function (e, n) {
         ...
         this.$selection
          ...
          this.$selection.on('mousedown', function (a) {
           a.which === 1 && i.trigger('toggle', { originalEvent: a });
          }),
       ...
       return (
        ...
        (r.prototype.bind = function (t, e) {
         ...
         r.__super__.bind.apply(this, arguments),
          this.$selection.on('click', function (i) {
           n.trigger('toggle', { originalEvent: i });
          }),
          this.$selection.on(
           'click',
           ...
           function (i) {
            if (!n.isDisabled()) {
             ...
             n.trigger('unselect', { originalEvent: i, data: h });
            }
           },
          );
        }),
     ...
     g.define('select2/selection/placeholder', ['../utils'], function (u) {
      function l(s, r, t) {
       (this.placeholder = this.normalizePlaceholder(t.get('placeholder'))),
        s.call(this, r, t);
      }
      return (
       (l.prototype.normalizePlaceholder = function (s, r) {
        return typeof r == 'string' && (r = { id: '', text: r }), r;
       }),
       (l.prototype.createPlaceholder = function (s, r) {
        var t = this.selectionContainer();
        return (
         t.html(this.display(r)),
         t
      ...
      function (u, l, s) {
       ...
       return (
         ...
         if (!this.isDisabled()) {
          ...
          if (n.length !== 0) {
           ...
           for (var h = 0; h < i.length; h++)
            if (
             ((a = { data: i[h] }), this.trigger('unselect', a), a.prevented)
            ) {
             this.$element.val(o);
             return;
            }
        ...
        (r.prototype._handleKeyboardClear = function (t, e, n) {
         n.isOpen() ||
          ((e.which == l.DELETE || e.which == l.BACKSPACE) &&
           this._handleClear(e));
        }),
       ...
       return (
        ...
        (r.prototype.bind = function (t, e, n) {
         ...
         t.call(this, e, n),
          ...
          e.on('results:focus', function (c) {
           c.data._resultId
            ? i.$search.attr('aria-activedescendant', c.data._resultId)
            : i.$search.removeAttr('aria-activedescendant');
          }),
          this.$selection.on(
           'focusin',
          ...
          this.$selection.on(
           ...
           function (c) {
            c.stopPropagation(),
             i.trigger('keypress', c),
             (i._keyUpPrevented = c.isDefaultPrevented());
            var p = c.which;
        ...
        (r.prototype.resizeSearch = function () {
         ...
         if (this.$search.attr('placeholder') !== '')
          t = this.$selection.find('.select2-selection__rendered').width();
         else {
       ...
       (l.prototype.bind = function (s, r, t) {
        ...
        s.call(this, r, t),
         r.on('*', function (o, a) {
          if (u.inArray(o, n) !== -1) {
           a = a || {};
           var h = u.Event('select2:' + o, { params: a });
           e.$element.trigger(h),
            u.inArray(o, i) !== -1 && (a.prevented = h.isDefaultPrevented());
          }
         });
       }),
       l
     ...
     g.define('select2/data/base', ['../utils'], function (u) {
      ...
      return (
       u.Extend(l, u.Observable),
       (l.prototype.current = function (s) {
        throw new Error(
       ...
       (l.prototype.bind = function (s, r) {}),
       (l.prototype.destroy = function () {}),
       (l.prototype.generateResultId = function (s, r) {
        var t = s.id + '-result-';
        return (
         (t += u.generateChars(4)),
         r.id != null
      ...
      function (u, l, s) {
       ...
       return (
        ...
        (r.prototype.option = function (t) {
         var e;
         t.children
          ? ((e = document.createElement('optgroup')), (e.label = t.text))
          : ((e = document.createElement('option')),
            e.textContent !== void 0
             ? (e.textContent = t.text)
             : (e.innerText = t.text)),
          t.id !== void 0 && (e.value = t.id),
        ...
        (r.prototype._normalizeItem = function (t) {
         ...
         return (
          t.id != null && (t.id = t.id.toString()),
          t.text != null && (t.text = t.text.toString()),
          t._resultId == null &&
           t.id &&
           this.container != null &&
      ...
      function (u, l, s) {
       ...
       return (
        ...
        (r.prototype.select = function (t) {
         ...
         e.length === 0 && ((e = this.option(t)), this.addOptions(e)),
      ...
      function (u, l, s) {
       ...
       return (
        ...
        (r.prototype.query = function (t, e) {
         ...
         typeof i.url == 'function' && (i.url = i.url.call(this.$element, t)),
          ...
          var a = i.transport(
           ...
           function (h) {
            ...
            n.options.get('debug') &&
             window.console &&
             console.error &&
             (!c || !c.results || !s.isArray(c.results)) &&
             console.error(
           ...
           function () {
            ('status' in a && (a.status === 0 || a.status === '0')) ||
             n.trigger('results:message', { message: 'errorLoading' });
           },
          );
          n._request = a;
         }
         this.ajaxOptions.delay && t.term != null
     ...
     g.define('select2/data/tags', ['jquery'], function (u) {
      function l(s, r, t) {
       ...
       if (
        (i !== void 0 && (this.insertTag = i), s.call(this, r, t), u.isArray(e))
       )
       ...
       (l.prototype.query = function (s, r, t) {
        ...
        function n(i, o) {
         for (var a = i.results, h = 0; h < a.length; h++) {
          var c = a[h],
           p = c.children != null && !n({ results: c.children }, !0),
     ...
     g.define('select2/data/tokenizer', ['jquery'], function (u) {
      ...
      return (
       ...
       (l.prototype.tokenizer = function (s, r, t, e) {
        for (
         var n = t.get('tokenSeparators') || [],
          i = r.term,
          o = 0,
          a =
           this.createTag ||
           function (y) {
            return { id: y.term, text: y.term };
           };
         o < i.length;
     ...
     g.define('select2/data/minimumInputLength', [], function () {
      function u(l, s, r) {
       (this.minimumInputLength = r.get('minimumInputLength')),
        l.call(this, s, r);
      }
      return (
       (u.prototype.query = function (l, s, r) {
        if (
         ((s.term = s.term || ''), s.term.length < this.minimumInputLength)
        ) {
         this.trigger('results:message', {
          message: 'inputTooShort',
          args: { minimum: this.minimumInputLength, input: s.term, params: s },
         });
         return;
        }
        l.call(this, s, r);
     ...
     g.define('select2/data/maximumInputLength', [], function () {
      function u(l, s, r) {
       (this.maximumInputLength = r.get('maximumInputLength')),
        l.call(this, s, r);
      }
      return (
       (u.prototype.query = function (l, s, r) {
        if (
         ((s.term = s.term || ''),
         this.maximumInputLength > 0 && s.term.length > this.maximumInputLength)
        ) {
         this.trigger('results:message', {
          message: 'inputTooLong',
          args: { maximum: this.maximumInputLength, input: s.term, params: s },
         });
         return;
        }
        l.call(this, s, r);
     ...
     g.define('select2/data/maximumSelectionLength', [], function () {
      function u(l, s, r) {
       (this.maximumSelectionLength = r.get('maximumSelectionLength')),
        l.call(this, s, r);
      }
      return (
       (u.prototype.bind = function (l, s, r) {
        var t = this;
        l.call(this, s, r),
       ...
       return (
        ...
        (s.prototype.bind = function (r, t, e) {
         var n = this,
          i = t.id + '-results';
         r.call(this, t, e),
          this.$search.on('keydown', function (o) {
           n.trigger('keypress', o),
            (n._keyUpPrevented = o.isDefaultPrevented());
          }),
          ...
          t.on('results:all', function (o) {
           if (o.query.term == null || o.query.term === '') {
            ...
            a
             ? n.$searchContainer.removeClass('select2-search--hide')
             : n.$searchContainer.addClass('select2-search--hide');
           }
          }),
          t.on('results:focus', function (o) {
           o.data._resultId
            ? n.$search.attr('aria-activedescendant', o.data._resultId)
            : n.$search.removeAttr('aria-activedescendant');
          });
        }),
     ...
     g.define('select2/dropdown/hidePlaceholder', [], function () {
      function u(l, s, r, t) {
       (this.placeholder = this.normalizePlaceholder(r.get('placeholder'))),
        l.call(this, s, r, t);
      }
      return (
       (u.prototype.append = function (l, s) {
        (s.results = this.removePlaceholder(s.results)), l.call(this, s);
       }),
       (u.prototype.normalizePlaceholder = function (l, s) {
        return typeof s == 'string' && (s = { id: '', text: s }), s;
       }),
     ...
     g.define('select2/dropdown/infiniteScroll', ['jquery'], function (u) {
      ...
      return (
       (l.prototype.append = function (s, r) {
        this.$loadingMore.remove(),
         (this.loading = !1),
         s.call(this, r),
         this.showLoadingMore(r) &&
          (this.$results.append(this.$loadingMore), this.loadMoreIfNeeded());
       }),
       (l.prototype.bind = function (s, r, t) {
        var e = this;
        s.call(this, r, t),
         r.on('query', function (n) {
       ...
       (l.prototype.loadMore = function () {
        this.loading = !0;
        var s = u.extend({}, { page: 1 }, this.lastParams);
     ...
     g.define(
      ...
      function (u, l) {
       function s(r, t, e) {
        (this.$dropdownParent = u(e.get('dropdownParent') || document.body)),
         r.call(this, t, e);
       }
       return (
        (s.prototype.bind = function (r, t, e) {
        ...
        (s.prototype._positionDropdown = function () {
         ...
         var a = { height: this.$dropdown.outerHeight(!1) },
          h = { top: r.scrollTop(), bottom: r.scrollTop() + r.height() },
          c = h.top < i.top - a.height,
          p = h.bottom > i.bottom + a.height,
          _ = { left: i.left, top: o.bottom },
          y = this.$dropdownParent;
         y.css('position') === 'static' && (y = y.offsetParent());
         var m = { top: 0, left: 0 };
         (u.contains(document.body, y[0]) || y[0].isConnected) &&
          (m = y.offset()),
          (_.top -= m.top),
          (_.left -= m.left),
          !t && !e && (n = 'below'),
          !p && c && !t ? (n = 'above') : !c && p && t && (n = 'below'),
          (n == 'above' || (t && n !== 'below')) &&
           (_.top = o.top - m.top - a.height),
          n != null &&
           (this.$dropdown
          ...
          this.$dropdownContainer.css(_);
        }),
        (s.prototype._resizeDropdown = function () {
         var r = { width: this.$container.outerWidth(!1) + 'px' };
     ...
     g.define('select2/dropdown/minimumResultsForSearch', [], function () {
      ...
      function l(s, r, t, e) {
       (this.minimumResultsForSearch = t.get('minimumResultsForSearch')),
        this.minimumResultsForSearch < 0 &&
         (this.minimumResultsForSearch = 1 / 0),
        s.call(this, r, t, e);
      }
      return (
       (l.prototype.showSearch = function (s, r) {
        return u(r.data.results) < this.minimumResultsForSearch
         ? !1
         : s.call(this, r);
       }),
       l
     ...
     g.define('select2/dropdown/closeOnSelect', [], function () {
      ...
      return (
       ...
       (u.prototype._selectTriggered = function (l, s) {
        ...
        (r && (r.ctrlKey || r.metaKey)) ||
         this.trigger('close', { originalEvent: r, originalSelect2Event: s });
       }),
       u
      );
     }),
     ...
     g.define(
      ...
      function (
       ...
       (D.prototype.apply = function (d) {
        if (((d = u.extend(!0, {}, this.defaults, d)), d.dataAdapter == null)) {
         if (
          ...
          d.minimumInputLength > 0 &&
           (d.dataAdapter = a.Decorate(d.dataAdapter, O)),
          d.maximumInputLength > 0 &&
           (d.dataAdapter = a.Decorate(d.dataAdapter, T)),
          d.maximumSelectionLength > 0 &&
           (d.dataAdapter = a.Decorate(d.dataAdapter, k)),
          d.tags && (d.dataAdapter = a.Decorate(d.dataAdapter, m)),
          (d.tokenSeparators != null || d.tokenizer != null) &&
           (d.dataAdapter = a.Decorate(d.dataAdapter, E)),
          d.query != null)
         ) {
        ...
        if (
         (d.resultsAdapter == null &&
          ((d.resultsAdapter = s),
          d.ajax != null &&
           (d.resultsAdapter = a.Decorate(d.resultsAdapter, Y)),
          d.placeholder != null &&
           (d.resultsAdapter = a.Decorate(d.resultsAdapter, H)),
          d.selectOnClose &&
           (d.resultsAdapter = a.Decorate(d.resultsAdapter, w))),
         d.dropdownAdapter == null)
        ) {
         if (d.multiple) d.dropdownAdapter = M;
         else {
          var v = a.Decorate(M, R);
          d.dropdownAdapter = v;
         }
         if (
          (d.minimumResultsForSearch !== 0 &&
           (d.dropdownAdapter = a.Decorate(d.dropdownAdapter, A)),
          d.closeOnSelect &&
           (d.dropdownAdapter = a.Decorate(d.dropdownAdapter, B)),
          d.dropdownCssClass != null ||
           d.dropdownCss != null ||
           d.adaptDropdownCssClass != null)
         ) {
        ...
        if (d.selectionAdapter == null) {
         if (
          (d.multiple ? (d.selectionAdapter = t) : (d.selectionAdapter = r),
          d.placeholder != null &&
           (d.selectionAdapter = a.Decorate(d.selectionAdapter, e)),
          d.allowClear &&
           (d.selectionAdapter = a.Decorate(d.selectionAdapter, n)),
          d.multiple &&
           (d.selectionAdapter = a.Decorate(d.selectionAdapter, i)),
          d.containerCssClass != null ||
           d.containerCss != null ||
           d.adaptContainerCssClass != null)
         ) {
        ...
        (D.prototype.reset = function () {
         ...
         function C(b, v) {
          ...
          if (v.children && v.children.length > 0) {
           for (
            var F = u.extend(!0, {}, v), S = v.children.length - 1;
            S >= 0;
            S--
           ) {
            var q = v.children[S],
          ...
          var j = d(v.text).toUpperCase(),
           G = d(b.term).toUpperCase();
          return j.indexOf(G) > -1 ? v : null;
         }
         this.defaults = {
          amdBase: './',
        ...
        (D.prototype.applyFromElement = function (d, C) {
         var b = d.language,
          ...
          q = Array.prototype.concat.call(
           this._resolveLanguage(F),
           this._resolveLanguage(b),
        ...
        (D.prototype._resolveLanguage = function (d) {
         ...
         for (var b = [], v = 0; v < C.length; v++)
          if (
           (b.push(C[v]), typeof C[v] == 'string' && C[v].indexOf('-') > 0)
          ) {
           var F = C[v].split('-'),
            S = F[0];
           b.push(S);
     ...
     g.define(
      ...
      function (u, l, s, r) {
       function t(e, n) {
        if (
         ((this.options = e),
         n != null && this.fromElement(n),
         n != null && (this.options = s.applyFromElement(this.options, n)),
       ...
       return (
        (t.prototype.fromElement = function (e) {
         var n = ['select2'];
         ...
         l.fn.jquery &&
          l.fn.jquery.substr(0, 2) == '1.' &&
          e[0].dataset &&
          (i = l.extend(!0, {}, e[0].dataset, i));
         var m = l.extend(!0, {}, r.GetData(e[0]), i);
         m = r._convertData(m);
         for (var E in m)
          l.inArray(E, n) > -1 ||
           (l.isPlainObject(this.options[E])
            ? l.extend(this.options[E], m[E])
            : (this.options[E] = m[E]));
         return this;
        }),
     ...
     g.define(
      ...
      function (u, l, s, r) {
       var t = function (e, n) {
        s.GetData(e[0], 'select2') != null &&
         s.GetData(e[0], 'select2').destroy(),
         (this.$element = e),
         (this.id = this._generateId(e)),
         (n = n || {}),
         (this.options = new l(n, e)),
        ...
        (this.selection = new h(e, this.options)),
        ...
        (this.results = new p(e, this.options, this.dataAdapter)),
        ...
        this._bindAdapters(),
         ...
         this.dataAdapter.current(function (y) {
          _.trigger('selection:update', { data: y });
         }),
       ...
       return (
        s.Extend(t, s.Observable),
        (t.prototype._generateId = function (e) {
         var n = '';
         return (
          e.attr('id') != null
           ? (n = e.attr('id'))
           : e.attr('name') != null
             ? (n = e.attr('name') + '-' + s.generateChars(2))
             : (n = s.generateChars(4)),
          (n = n.replace(/(:|\.|\[|\]|,)/g, '')),
          (n = 'select2-' + n),
          n
        ...
        (t.prototype._registerDomEvents = function () {
         ...
         this.$element.on('change.select2', function () {
          e.dataAdapter.current(function (i) {
           e.trigger('selection:update', { data: i });
          });
         }),
          ...
          this.on('query', function (n) {
           e.isOpen() || e.trigger('open', {}),
            this.dataAdapter.query(n, function (i) {
             e.trigger('results:all', { data: i, query: n });
            });
          }),
          this.on('query:append', function (n) {
           this.dataAdapter.query(n, function (i) {
            e.trigger('results:append', { data: i, query: n });
           });
          }),
          this.on('keypress', function (n) {
           var i = n.which;
           e.isOpen()
            ? i === r.ESC || i === r.TAB || (i === r.UP && n.altKey)
              ? (e.close(n), n.preventDefault())
              : i === r.ENTER
                ? (e.trigger('results:select', {}), n.preventDefault())
                : i === r.SPACE && n.ctrlKey
                  ? (e.trigger('results:toggle', {}), n.preventDefault())
                  : i === r.UP
                    ? (e.trigger('results:previous', {}), n.preventDefault())
                    : i === r.DOWN &&
                      (e.trigger('results:next', {}), n.preventDefault())
            : (i === r.ENTER || i === r.SPACE || (i === r.DOWN && n.altKey)) &&
        ...
        (t.prototype._syncSubtree = function (e, n) {
         ...
         i &&
          this.dataAdapter.current(function (a) {
           o.trigger('selection:update', { data: a });
          });
        }),
     ...
     g.define('select2/compat/utils', ['jquery'], function (u) {
      function l(s, r, t) {
       var e,
        n = [],
        i;
       (e = u.trim(s.attr('class'))),
        e &&
         ((e = '' + e),
         u(e.split(/\s+/)).each(function () {
          this.indexOf('select2-') === 0 && n.push(this);
         })),
        (e = u.trim(r.attr('class'))),
        e &&
         ((e = '' + e),
         u(e.split(/\s+/)).each(function () {
          this.indexOf('select2-') !== 0 &&
           ((i = t(this)), i != null && n.push(i));
         })),
        s.attr('class', n.join(' '));
      }
      return { syncCssClasses: l };
     }),
     g.define(
      ...
      function (u, l) {
       ...
       return (
        (r.prototype.render = function (t) {
         ...
         return (
          u.isFunction(a) && (a = a(this.$element)),
          l.syncCssClasses(e, this.$element, i),
          e.css(a),
          e.addClass(n),
          e
         );
     ...
     g.define('select2/compat/initSelection', ['jquery'], function (u) {
      ...
      return (
       (l.prototype.current = function (s, r) {
        var t = this;
     ...
     g.define(
      ...
      function (u, l) {
       ...
       return (
        (s.prototype.current = function (r, t) {
         function e(a, h) {
          var c = [];
          return (
           a.selected || u.inArray(a.id, h) !== -1
            ? ((a.selected = !0), c.push(a))
            : (a.selected = !1),
           a.children && c.push.apply(c, e(a.children, h)),
           c
          );
         }
         for (var n = [], i = 0; i < this._currentData.length; i++) {
          ...
          n.push.apply(
           n,
           e(o, this.$element.val().split(this._valueSeparator)),
          );
         }
         t(n);
        }),
        ...
        (s.prototype.unselect = function (r, t) {
         ...
         (t.selected = !1),
          this.current(function (n) {
           ...
           e.$element.val(i.join(e._valueSeparator)),
     ...
     g.define('select2/dropdown/attachContainer', [], function () {
      ...
      return (
       (u.prototype.position = function (l, s, r) {
        var t = r.find('.dropdown-wrapper');
        t.append(s),
         s.addClass('select2-dropdown--below'),
         r.addClass('select2-container--below');
       }),
       u
      );
     }),
     ...
     */ return (
     (function (u) {
      typeof g.define == 'function' && g.define.amd
       ? g.define('jquery-mousewheel', ['jquery'], u)
       : (N.exports = u);
     })(function (u) {
      ...
      if (u.event.fixHooks)
       for (var n = l.length; n; )
        u.event.fixHooks[l[--n]] = u.event.mouseHooks;
      var i = (u.event.special.mousewheel = {
       ...
       setup: function () {
        ...
        u.data(this, 'mousewheel-line-height', i.getLineHeight(this)),
         u.data(this, 'mousewheel-page-height', i.getPageHeight(this));
       },
       teardown: function () {
       ...
       getLineHeight: function (c) {
        ...
        return (
         _.length || (_ = u('body')),
         parseInt(_.css('fontSize'), 10) ||
          parseInt(p.css('fontSize'), 10) ||
          16
        );
       },
      ...
      function o(c) {
       ...
       if (
        ((c = u.event.fix(p)),
        (c.type = 'mousewheel'),
        'detail' in p && (E = p.detail * -1),
        'wheelDelta' in p && (E = p.wheelDelta),
        'wheelDeltaY' in p && (E = p.wheelDeltaY),
        'wheelDeltaX' in p && (m = p.wheelDeltaX * -1),
        'axis' in p && p.axis === p.HORIZONTAL_AXIS && ((m = E * -1), (E = 0)),
        (y = E === 0 ? m : E),
        'deltaY' in p && ((E = p.deltaY * -1), (y = E)),
        'deltaX' in p && ((m = p.deltaX), E === 0 && (y = m * -1)),
        !(E === 0 && m === 0))
       ) {
        if (p.deltaMode === 1) {
         ...
         var R = u.data(this, 'mousewheel-page-height');
         (y *= R), (E *= R), (m *= R);
        }
        if (
         ((O = Math.max(Math.abs(E), Math.abs(m))),
         (!e || O < e) && ((e = O), h(p, O) && (e /= 40)),
         h(p, O) && ((y /= 40), (m /= 40), (E /= 40)),
         (y = Math[y >= 1 ? 'floor' : 'ceil'](y / e)),
         (m = Math[m >= 1 ? 'floor' : 'ceil'](m / e)),
         (E = Math[E >= 1 ? 'floor' : 'ceil'](E / e)),
         i.settings.normalizeOffset && this.getBoundingClientRect)
        ) {
         var H = this.getBoundingClientRect();
         (T = c.clientX - H.left), (k = c.clientY - H.top);
        }
        return (
         (c.deltaX = m),
         (c.deltaY = E),
         ...
         t && clearTimeout(t),
         (t = setTimeout(a, 200)),
         (u.event.dispatch || u.event.handle).apply(this, _)
        );
       }
      }
      function a() {
      ...
      function h(c, p) {
       return (
        i.settings.adjustOldDeltas && c.type === 'mousewheel' && p % 120 === 0
       );
      }
     }),
     g.define(
     ...
     { define: g.define, require: g.require }
    );
   })(),
   z = W.require('jquery.select2');
  return (L.fn.select2.amd = W), z;
 });
})(X);
var J = X.exports;
const Z = K(J);
