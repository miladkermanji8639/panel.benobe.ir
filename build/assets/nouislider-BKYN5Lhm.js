...
function Se(r, t) {
 var n = r.getBoundingClientRect(),
  ...
  p = Rt(f);
 return (
  /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (p.x = 0),
  t ? n.top + p.y - u.clientTop : n.left + p.x - u.clientLeft
 );
}
function H(r) {
...
var jt = (function () {
  function r(t, n, f) {
   ...
   for (
    ...
    this.handleEntryPoint(p[u][1], p[u][0]);
   for (
  ...
  return (
   (r.prototype.getDistance = function (t) {
    for (var n = [], f = 0; f < this.xNumSteps.length - 1; f++)
     n[f] = pt(this.xVal, t, f);
    return n;
   }),
   (r.prototype.getAbsoluteDistance = function (t, n, f) {
    ...
    for (
     f
      ? (p = (t - this.xPct[u]) / (this.xPct[u + 1] - this.xPct[u]))
      : (p = (this.xPct[u + 1] - t) / (this.xPct[u + 1] - this.xPct[u]));
     b > 0;

    )
     (v = this.xPct[u + 1 + V] - this.xPct[u + V]),
      n[u + V] * d + 100 - p * 100 > 100
       ? ((M = v * p), (d = (b - 100 * p) / n[u + V]), (p = 1))
       : ((M = ((n[u + V] * v) / 100) * d), (d = 0)),
      f
       ? ((O = O - M), this.xPct.length + V >= 1 && V--)
       : ((O = O + M), this.xPct.length - V >= 1 && V++),
      (b = n[u + V] * d);
    return t + O;
   }),
   ...
   (r.prototype.getDefaultStep = function (t, n, f) {
    var u = T(t, this.xPct);
    return (
     (t === 100 || (n && t === this.xPct[u - 1])) && (u = Math.max(u - 1, 1)),
   ...
   (r.prototype.handleStepPoint = function (t, n) {
    if (n) {
     ...
     this.xSteps[t] =
      pt([this.xVal[t], this.xVal[t + 1]], n, 0) /
      mt(this.xPct[t], this.xPct[t + 1]);
     var f = (this.xVal[t + 1] - this.xVal[t]) / this.xNumSteps[t],
      u = Math.ceil(Number(f.toFixed(3)) - 1),
      p = this.xVal[t] + this.xNumSteps[t] * u;
 ...
 F = { tooltips: '.__tooltips', aria: '.__aria' };
function ye(r, t) {
...
function Oe(r, t) {
 if (((t = Q(t)), !Array.isArray(t) || !t.length))
...
function Be(r, t) {
 ...
 if (Array.isArray(t) && !(t.length === 2 || H(t[0]) || H(t[1])))
  throw new Error(
   "noUiSlider: 'padding' option must be numeric or array of exactly 2 numbers.",
  );
 if (t !== 0) {
  ...
  var f = t[0] + t[1],
   u = r.spectrum.xVal[0],
   p = r.spectrum.xVal[r.spectrum.xVal.length - 1];
  if (f / (p - u) > 1)
   throw new Error(
...
function qe(r, t) {
 ...
 var n = t.indexOf('tap') >= 0,
  ...
  p = t.indexOf('snap') >= 0,
  d = t.indexOf('hover') >= 0,
  b = t.indexOf('unconstrained') >= 0,
  v = t.indexOf('drag-all') >= 0,
  M = t.indexOf('smooth-steps') >= 0;
 if (u) {
  if (r.handles !== 2)
...
function Bt(r) {
 var t = {
  ...
  n = {
   step: { r: !1, t: ye },
   keyboardPageMultiplier: { r: !1, t: Ue },
   keyboardMultiplier: { r: !1, t: Me },
   keyboardDefaultStep: { r: !1, t: Le },
   start: { r: !0, t: Oe },
   connect: { r: !0, t: je },
   direction: { r: !0, t: Ke },
   snap: { r: !1, t: He },
   animate: { r: !1, t: ze },
   animationDuration: { r: !1, t: Re },
   range: { r: !0, t: _e },
   orientation: { r: !1, t: Fe },
   margin: { r: !1, t: Nt },
   limit: { r: !1, t: Ne },
   padding: { r: !1, t: Be },
   behaviour: { r: !0, t: qe },
   ...
   format: { r: !1, t: Ye },
   tooltips: { r: !1, t: Ie },
   keyboardSupport: { r: !0, t: We },
   documentElement: { r: !1, t: Ge },
   cssPrefix: { r: !0, t: Je },
   cssClasses: { r: !0, t: Ze },
 ...
 var u = document.createElement('div'),
  p = u.style.msTransform !== void 0,
  d = u.style.transform !== void 0;
...
function $e(r, t, n) {
 var f = we(),
  ...
  R = {},
  q = r.ownerDocument,
  X = t.documentElement || q.documentElement,
  Y = q.body,
  Kt = q.dir === 'rtl' || t.ort === 1 ? 0 : 100;
 function j(e, i) {
  var a = q.createElement('div');
  return i && U(a, i), e.appendChild(a), a;
 }
 function qt(e, i) {
  var a = j(e, t.cssClasses.origin),
   s = j(a, t.cssClasses.handle);
  if (
   (j(s, t.cssClasses.touchArea),
   s.setAttribute('data-handle', String(i)),
   t.keyboardSupport &&
  ...
  return (
   ...
   s.setAttribute('aria-orientation', t.ort ? 'vertical' : 'horizontal'),
   i === 0
    ? U(s, t.cssClasses.handleLower)
    : i === t.handles - 1 && U(s, t.cssClasses.handleUpper),
   (a.handle = s),
   a
  );
 }
 ...
 function It(e, i) {
  ...
  for (var s = 0; s < t.handles; s++)
   v.push(qt(i, s)), (_[s] = s), M.push(gt(a, e[s + 1]));
 }
 function Tt(e) {
  U(e, t.cssClasses.target),
   t.dir === 0 ? U(e, t.cssClasses.ltr) : U(e, t.cssClasses.rtl),
   t.ort === 0 ? U(e, t.cssClasses.horizontal) : U(e, t.cssClasses.vertical);
  var i = getComputedStyle(e).direction;
  return (
   i === 'rtl'
    ? U(e, t.cssClasses.textDirectionRtl)
    : U(e, t.cssClasses.textDirectionLtr),
   j(e, t.cssClasses.base)
  );
 }
 function Xt(e, i) {
  return !t.tooltips || !t.tooltips[i]
   ? !1
   : j(e.firstChild, t.cssClasses.tooltip);
 }
 function St() {
 ...
 function Yt(e) {
  e != null
   ? (v[e].setAttribute('disabled', ''),
     v[e].handle.removeAttribute('tabindex'))
 ...
 function Wt(e) {
  e != null
   ? (v[e].removeAttribute('disabled'),
     v[e].handle.setAttribute('tabindex', '0'))
 ...
 function xt() {
  rt(),
   (V = v.map(Xt)),
   ot('update' + F.tooltips, function (e, i, a) {
 ...
 function Gt() {
  I('update' + F.aria),
   ot('update' + F.aria, function (e, i, a, s, l) {
    _.forEach(function (o) {
     var h = v[o],
      c = W(C, o, 0, !0, !0, !0),
      x = W(C, o, 100, !0, !0, !0),
      S = l[o],
      w = String(t.ariaFormat.to(a[o]));
     (c = m.fromStepping(c).toFixed(1)),
      ...
      h.children[0].setAttribute('aria-valuemax', x),
      h.children[0].setAttribute('aria-valuenow', S),
      h.children[0].setAttribute('aria-valuetext', w);
    });
   });
 }
 function Jt(e) {
  ...
  return e.mode === N.Positions
   ? bt(e.values, e.stepped)
   : e.mode === N.Values
     ? e.stepped
 ...
 function Zt(e) {
  ...
  var a = Jt(e),
   s = {},
   l = m.xVal[0],
   o = m.xVal[m.xVal.length - 1],
   h = !1,
   c = !1,
   x = 0;
  return (
   (a = me(
    a.slice().sort(function (S, w) {
     return S - w;
    }),
   )),
   a[0] !== l && (a.unshift(l), (h = !0)),
   a[a.length - 1] !== o && (a.push(o), (c = !0)),
   a.forEach(function (S, w) {
    var E,
     g,
     A,
     y = S,
    ...
    for (
     ...
     for (
      ...
      (ct = x + A * Ut), (s[ct.toFixed(5)] = [m.fromStepping(ct), 0]);
     (ht = a.indexOf(g) > -1 ? L.LargeValue : Mt ? L.SmallValue : L.NoValue),
      !w && h && g !== D && (ht = 0),
      (g === D && c) || (s[k.toFixed(5)] = [g, ht]),
      (x = k);
    }
   }),
   s
 ...
 function $t(e, i, a) {
  var s,
   ...
   h =
    ((s = {}),
    (s[L.None] = ''),
    (s[L.NoValue] = t.cssClasses.valueNormal),
    (s[L.LargeValue] = t.cssClasses.valueLarge),
    (s[L.SmallValue] = t.cssClasses.valueSub),
    s),
   c =
    ((l = {}),
    (l[L.None] = ''),
    (l[L.NoValue] = t.cssClasses.markerNormal),
    (l[L.LargeValue] = t.cssClasses.markerLarge),
    (l[L.SmallValue] = t.cssClasses.markerSub),
    l),
   x = [t.cssClasses.valueHorizontal, t.cssClasses.valueVertical],
   S = [t.cssClasses.markerHorizontal, t.cssClasses.markerVertical];
  U(o, t.cssClasses.pips),
   U(o, t.ort === 0 ? t.cssClasses.pipsHorizontal : t.cssClasses.pipsVertical);
  function w(g, A) {
   var y = A === t.cssClasses.value,
    D = y ? x : S,
    k = y ? h : c;
  ...
  function E(g, A, y) {
   if (((y = i ? i(A, y) : y), y !== L.None)) {
    var D = j(o, !1);
    (D.className = w(y, t.cssClasses.marker)),
     (D.style[t.style] = g + '%'),
     y > L.NoValue &&
      ((D = j(o, !1)),
      (D.className = w(y, t.cssClasses.value)),
      D.setAttribute('data-value', String(A)),
      (D.style[t.style] = g + '%'),
      (D.innerHTML = String(a.to(A))));
   }
  }
  return (
 ...
 function B(e, i, a, s) {
  ...
  return (
   e.split(' ').forEach(function (h) {
    i.addEventListener(h, l, p ? { passive: !0 } : !1), o.push([h, l]);
   }),
   o
  );
 }
 function Qt(e, i, a) {
  var s = e.type.indexOf('touch') === 0,
   l = e.type.indexOf('mouse') === 0,
   o = e.type.indexOf('pointer') === 0,
   h = 0,
   c = 0;
  if (
  ...
  if (s) {
   var x = function (E) {
    var g = E.target;
    return (
     g === a || a.contains(g) || (e.composed && e.composedPath().shift() === a)
    );
   };
  ...
  return (
   (i = i || Rt(q)),
   (l || o) && ((h = e.clientX + i.x), (c = e.clientY + i.y)),
   (e.pageOffset = i),
   (e.points = [h, c]),
   (e.cursor = l || o),
   e
 ...
 function st(e, i) {
  i.handle && (Z(i.handle, t.cssClasses.active), (tt -= 1)),
   i.listeners.forEach(function (a) {
    X.removeEventListener(a[0], a[1]);
   }),
   tt === 0 &&
    (Z(d, t.cssClasses.drag),
    ft(),
    e.cursor &&
     ((Y.style.cursor = ''), Y.removeEventListener('selectstart', _t))),
 ...
 function nt(e, i) {
  if (!i.handleNumbers.some(et)) {
   ...
   if (i.handleNumbers.length === 1) {
    ...
    (a = s.children[0]), (tt += 1), U(a, t.cssClasses.active);
   }
   e.stopPropagation();
   var l = [],
    o = B(f.move, X, re, {
   ...
   l.push.apply(l, o.concat(h, c)),
    e.cursor &&
     ((Y.style.cursor = getComputedStyle(e.target).cursor),
     v.length > 1 && U(d, t.cssClasses.drag),
     Y.addEventListener('selectstart', _t, !1)),
    i.handleNumbers.forEach(function (x) {
     P('start', x);
    });
  }
 }
 function ie(e) {
  e.stopPropagation();
  var i = Et(e.calcPoint),
   a = te(i);
  a !== !1 &&
   (t.events.snap || Ot(d, t.cssClasses.tap, t.animationDuration),
   K(a, i, !0, !0),
   ft(),
   P('slide', a, !0),
   P('update', a, !0),
   t.events.snap
    ? nt(e, { handleNumbers: [a] })
 ...
 function se(e, i) {
  ...
  if (w || S) {
   var y = S ? 0 : 1,
    ...
    k = D[y];
   if (k === null) return !1;
   k === !1 && (k = m.getDefaultStep(C[i], S, t.keyboardDefaultStep)),
    x || c ? (k *= t.keyboardPageMultiplier) : (k *= t.keyboardMultiplier),
    (k = Math.max(k, 1e-7)),
    (k = (S ? -1 : 1) * k),
    (A = z[i] + k);
  } else
 ...
 function ne(e) {
  e.fixed ||
   v.forEach(function (i, a) {
    B(f.start, i.children[0], nt, { handleNumbers: [a] });
   }),
   e.tap && B(f.start, b, ie, {}),
   e.hover && B(f.move, b, ae, { hover: !0 }),
   e.drag &&
    M.forEach(function (i, a) {
     if (!(i === !1 || a === 0 || a === M.length - 1)) {
      var s = v[a - 1],
       l = v[a],
       o = [i],
       h = [s, l],
       c = [a - 1, a];
      U(i, t.cssClasses.draggable),
       e.fixed && (o.push(s.children[0]), o.push(l.children[0])),
       e.dragAll && ((h = v), (c = _)),
 ...
 function At(e) {
  if (M[e]) {
   var i = 0,
    a = 100;
   e !== 0 && (i = C[e - 1]), e !== M.length - 1 && (a = C[e]);
   var s = a - i,
    l = 'translate(' + lt(Pt(i, s) + '%', '0') + ')',
    o = 'scale(' + lt(s / 100, '1') + ')';
   M[e].style[t.transformRule] = l + ' ' + o;
  }
 }
 function Vt(e, i) {
  return e === null ||
 ...
 function G(e, i, a) {
  var s = Q(e),
   l = C[0] === void 0;
  (i = i === void 0 ? !0 : i),
   t.animate && !l && Ot(d, t.cssClasses.tap, t.animationDuration),
 ...
 function kt(e) {
  ...
  l !== !1 &&
   s + l > a.stepAfter.startValue &&
   (l = a.stepAfter.startValue - s),
   s > a.thisStep.startValue
    ? (o = a.thisStep.step)
    : a.stepBefore.step === !1
      ? (o = !1)
      : (o = s - a.stepBefore.highestStep),
   i === 100 ? (l = null) : i === 0 && (o = null);
...
const tr = { __spectrum: jt, cssClasses: Ft, create: Qe };
try {
 window.noUiSlider = tr;
} catch {}
