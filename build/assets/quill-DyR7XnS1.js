import { c as vt, g as pt } from './_commonjsHelpers-BosuxZz1.js';
var ht = { exports: {} };
/*!
 * Quill Editor v1.3.7
 * https://quilljs.com/
 ...
 */ (function (ct, gt) {
 (function (_, p) {
  ct.exports = p();
 })(typeof self < 'u' ? self : vt, function () {
  return (function (B) {
   var _ = {};
   function p(P) {
   ...
   return (
    ...
    (p.d = function (P, N, k) {
     p.o(P, N) ||
      Object.defineProperty(P, N, { configurable: !1, enumerable: !0, get: k });
    }),
    (p.n = function (P) {
     var N =
      P && P.__esModule
   ...
   function (B, _, p) {
    var P =
     ...
     (function () {
      ...
      return function (r, i) {
       ...
       r.prototype =
        i === null ? Object.create(i) : ((f.prototype = i.prototype), new f());
      };
     })();
    Object.defineProperty(_, '__esModule', { value: !0 });
    var N = (function (a) {
    ...
    function t(a, r) {
     ...
     var f = i,
      n = a instanceof Node || a.nodeType === Node.TEXT_NODE ? a : f.create(r);
     return new f(n, r);
    }
    _.create = t;
    function e(a, r) {
   ...
   function (B, _, p) {
    ...
    (c.prototype.insert = function (o, t) {
     ...
     (c.prototype.push = function (o) {
      ...
      return (
       t === this.ops.length ? this.ops.push(o) : this.ops.splice(t, 0, o), this
      );
     }),
         ...
         switch (i[0]) {
          ...
          case P.EQUAL:
           ...
           var s = a.next(n),
            A = r.next(n);
           N(s.insert, A.insert)
            ? u.retain(n, m.attributes.diff(s.attributes, A.attributes))
            : u.push(A).delete(n);
           break;
         }
         f -= n;
...
`;
      for (var e = m.iterator(this.ops), u = new c(), l = 0; e.hasNext(); ) {
       ...
       var a = e.peek(),
        ...
        i = typeof a.insert == 'string' ? a.insert.indexOf(t, r) - r : -1;
     ...
     (c.prototype.transform = function (o, t) {
      ...
      for (
       ...
       if (e.peekType() === 'insert' && (t || u.peekType() !== 'insert'))
        ...
        i.delete
         ? l.push(i)
         : l.retain(a, m.attributes.transform(r.attributes, i.attributes, t));
       }
      return l.chop();
     }),
   ...
   function (B, _) {
    ...
    B.exports = function t() {
     var e,
      ...
      A = !1;
     for (
      typeof f == 'boolean' && ((A = f), (f = arguments[1] || {}), (n = 2)),
         ...
         return (
          this.cache.delta == null &&
           (this.cache.delta = this.descendants(t.default.Leaf)
            .reduce(function (T, q) {
             return q.length() === 0 ? T : T.insert(q.value(), v(q));
            }, new c.default())
            .insert(
             `
`,
         ...
         q <= 0 ||
          (t.default.query(D, t.default.Scope.BLOCK)
           ...
           : N(
              ...
              'formatAt',
              this,
             ).call(this, T, Math.min(q, this.length() - T - 1), D, C),
          (this.cache = {}));
        },
       },
       {
...
`),
    ...
    function v(h) {
     ...
     return h == null ||
      (typeof h.formats == 'function' && (d = (0, m.default)(d, h.formats())),
      h.parent == null ||
      ...
      k(I, null, [
       ...
       },
       {
        ...
        value: function (O) {
         return (
          this.imports[O] == null &&
           E.error('Cannot import ' + O + '. Are you sure it was registered?'),
          this.imports[O]
         );
        },
       },
          ...
          return D.call(
           ...
           function () {
            ...
            if (r.default.query(O, r.default.Scope.BLOCK))
             ...
             if (M.length === 0) return L.selection.format(O, S), x;
...
` &&
        ...
        },
        {
         key: 'setSelection',
         value: function (O, S, L) {
          if (O == null) this.selection.setRange(null, S || I.sources.API);
          else {
           var F = C(O, S, L),
            M = N(F, 4);
           (O = M[0]),
     ...
     var S = Object.keys(O.modules).concat(Object.keys(R.modules)),
      L = S.reduce(function (F, M) {
       ...
       return (
        x == null
         ? E.error(
            'Cannot load ' + M + ' module. Are you sure you registered it?',
           )
         : (F[M] = x.DEFAULTS || {}),
        F
       );
   ...
   function (B, _, p) {
    ...
    var l = (function (a) {
     ...
     function r() {
      return (
       t(this, r),
       e(this, (r.__proto__ || Object.getPrototypeOf(r)).apply(this, arguments))
      );
     }
     return (
      P(
         ...
         value: function (f) {
          if (
           ...
           this.parent instanceof r &&
            r.compare(this.statics.blotName, this.parent.statics.blotName) > 0)
          ) {
     ...
     return (
      P(f, [
       ...
       },
       {
        ...
        value: function (s) {
         for (
          var A = arguments.length, g = Array(A > 1 ? A - 1 : 0), b = 1;
          b < A;
          b++
         )
          g[b - 1] = arguments[b];
       ...
       },
       {
        ...
        value: function (s, A, g) {
         this.listeners[s] || (this.listeners[s] = []),
          this.listeners[s].push({ node: A, handler: g });
        },
       },
      ]),
      f
   ...
   function (B, _, p) {
    ...
    var A = (function (b) {
     ...
     function w() {
      return (
       f(this, w),
       n(this, (w.__proto__ || Object.getPrototypeOf(w)).apply(this, arguments))
      );
     }
     return w;
    })(l.default);
      ...
      if (
       (O.attributes != null &&
        ...
        O.attributes.list
         ...
         : ((O.attributes.list = 'bullet'), delete O.attributes.bullet)),
      ...
      return (
       N(b, [
        ...
        },
        {
         key: 'format',
         value: function (v, h) {
          if (!(this.scroll.whitelist != null && !this.scroll.whitelist[v])) {
           this.scroll.update();
         ...
         value: function (v) {
          ...
          if (h > 0) {
           ...
           var L = D.position(C, !0),
            F = P(L, 2);
           return (
            (E = F[0]), (C = F[1]), R.setEnd(E, C), R.getBoundingClientRect()
           );
          } else {
           var M = 'left',
            x = void 0;
           return (
            E instanceof Text
             ? (C < E.data.length
                ...
                : (R.setStart(E, C - 1), R.setEnd(E, C), (M = 'right')),
        ...
        },
        {
         ...
         value: function (v) {
          ...
          var E = d.map(function (D) {
           ...
           T = Math.min(Math.max.apply(Math, i(E)), this.scroll.length() - 1),
          ...
          return (
           [h.start, h.end].forEach(function (d) {
            for (
             ...
             if (E.childNodes.length > T) (E = E.childNodes[T]), (T = 0);
             else if (E.childNodes.length === T)
              (E = E.lastChild),
               (T =
                E instanceof Text ? E.data.length : E.childNodes.length + 1);
             else break;
            (d.node = E), (d.offset = T);
           }),
           h
        ...
        },
        {
         ...
         value: function (v) {
          var h = this,
           d = v.collapsed ? [v.index] : [v.index, v.index + v.length],
           E = [],
          ...
          if (h != null) {
           ...
           if (d != null) {
            var E = this.scroll.length() - 1,
             ...
             C = D;
            if (h.length > 0) {
             var Z = this.scroll.line(Math.min(h.index + h.length, E)),
              I = P(Z, 1);
             C = I[0];
            }
            if (!(D == null || C == null)) {
             ...
             d.top < R.top
              ...
              : d.bottom > R.bottom && (v.scrollTop += d.bottom - R.bottom);
            }
           }
          }
         },
        },
        {
         ...
         value: function (v, h) {
          var d =
           ...
           E =
            arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : h,
           T =
           ...
           if (q != null)
            if (v != null) {
             ...
             if (
              ...
              v.tagName == 'BR' &&
               ((h = [].indexOf.call(v.parentNode.childNodes, v)),
               (v = v.parentNode)),
               d.tagName == 'BR' &&
                ((E = [].indexOf.call(d.parentNode.childNodes, d)),
                (d = d.parentNode));
      ...
      return (
       ...
       (t.prototype.update = function (e, u) {
        ...
        e.forEach(function (i) {
         i.target === l.domNode &&
          i.type === 'childList' &&
          (a.push.apply(a, i.addedNodes), r.push.apply(r, i.removedNodes));
        }),
     ...
     m = (function (y) {
      ...
      return (
       ...
       (c.prototype.value = function () {
        ...
        return (
         (o = {}),
         (o[this.statics.blotName] = this.statics.value(this.domNode) || !0),
         o
        );
       }),
       (c.scope = k.Scope.INLINE_BLOT),
       c
      );
     })(N.default);
    _.default = m;
   ...
   function (B, _, p) {
     ...
     k = {
      attributes: {
       compose: function (y, c, o) {
        ...
        for (var e in y) y[e] !== void 0 && c[e] === void 0 && (t[e] = y[e]);
    ...
    (m.prototype.hasNext = function () {
     ...
     (m.prototype.peekLength = function () {
      return this.ops[this.index]
       ? k.length(this.ops[this.index]) - this.offset
       : 1 / 0;
     }),
      ...
      function g(b, w) {
       ...
       if (Object.getOwnPropertySymbols)
        for (
         ...
         (C && !C.enumerable && !f) ||
          ((v[D] = g(b[D], w - 1)),
          C.enumerable || Object.defineProperty(v, D, { enumerable: !1 }));
        }
       if (f)
          ...
          q = function D(C, Z, I) {
           ...
           return (
            C.children.forEachAt(Z, I, function (S, L, F) {
             b(S)
              ? R.push(S)
              : S instanceof y.default.Container && (R = R.concat(D(S, L, O))),
              (O -= F);
            }),
            R
           );
       ...
       },
       {
        ...
        value: function () {
         ...
         this.batch !== !0 &&
          ...
          E.length > 0 &&
           this.emitter.emit(o.default.events.SCROLL_OPTIMIZE, E, T));
        },
       },
       {
        key: 'path',
        ...
        value: function (E) {
         if (this.batch !== !0) {
          ...
          typeof E == 'string' && (T = E),
           ...
           E.length > 0 &&
            this.emitter.emit(o.default.events.SCROLL_BEFORE_UPDATE, T, E),
           k(
            h.prototype.__proto__ || Object.getPrototypeOf(h.prototype),
            'update',
            this,
     ...
     C = (function (x) {
      ...
      function j(U, H) {
       ...
       return (
        ...
        V.addBinding(
         { key: j.keys.ENTER, metaKey: null, ctrlKey: null, altKey: null },
         function () {},
        ),
        /Firefox/i.test(navigator.userAgent)
         ? (V.addBinding({ key: j.keys.BACKSPACE }, { collapsed: !0 }, I),
            ...
            if (X.length !== 0) {
             ...
             if (!(Q == null || !H.quill.hasFocus())) {
              var nt = H.quill.getLine(Q.index),
               ...
               G = K[1],
               W =
                Q.length === 0 ? [$, G] : H.quill.getLeaf(Q.index + Q.length),
               J = N(W, 2),
               tt = J[0],
               et = J[1],
               ut = $ instanceof f.default.Text ? $.value().slice(0, G) : '',
               ft = tt instanceof f.default.Text ? tt.value().slice(et) : '',
               it = {
                ...
                if (Array.isArray(ot.format)) {
                 ...
                 !Object.keys(ot.format).every(function (st) {
                  return ot.format[st] === !0
                   ...
                   : ot.format[st] === !1
                     ? it.format[st] == null
                     : (0, o.default)(ot.format[st], it.format[st]);
                 })
                )
                 return !1;
       ...
       tab: {
        ...
        handler: function (j) {
         ...
         this.quill.updateContents(U, s.default.sources.USER),
          this.quill.history.cutoff(),
          this.quill.setSelection(j.index + 1, s.default.sources.SILENT);
        },
       },
       'list empty enter': {
        key: C.keys.ENTER,
       ...
       'list autofill': {
        ...
        handler: function (j, U) {
         ...
         this.quill.updateContents(rt, s.default.sources.USER),
          this.quill.history.cutoff(),
          this.quill.setSelection(j.index - H, s.default.sources.SILENT);
        },
       },
       'code exit': {
        key: C.keys.ENTER,
       ...
       return rt instanceof f.default.Embed
        ? (x === C.keys.LEFT
           ? j
             ...
             : this.quill.setSelection(Y.index - 1, s.default.sources.USER)
           : j
             ? this.quill.setSelection(
                Y.index,
                Y.length + 1,
     ...
     if (!(x.index === 0 || this.quill.getLength() <= 1)) {
      ...
      this.quill.deleteText(x.index - lt, lt, s.default.sources.USER),
       Object.keys(Y).length > 0 &&
        this.quill.formatLine(x.index - lt, lt, Y, s.default.sources.USER),
       this.quill.focus();
     }
    }
    function R(x, j) {
     ...
     if (!(x.index >= this.quill.getLength() - U)) {
      ...
      this.quill.deleteText(x.index, U, s.default.sources.USER),
       Object.keys(H).length > 0 &&
        this.quill.formatLine(x.index + V - 1, U, H, s.default.sources.USER);
     }
    }
    function O(x) {
...
`);
    ...
    function M(x) {
     if (typeof x == 'string' || typeof x == 'number') return M({ key: x });
     if (
   ...
   function (B, _, p) {
    ...
    var a = (function (r) {
     l(i, r), k(i, null, [{ key: 'value', value: function () {} }]);
     function i(f, n) {
      e(this, i);
      ...
      k(i, [
       ...
       },
       {
        ...
        value: function (n, s) {
         ...
         for (
          var A = this, g = 0;
          A != null && A.statics.scope !== y.default.Scope.BLOCK_BLOT;
         ...
         A != null &&
          ...
          A.optimize(),
          A.formatAt(g, i.CONTENTS.length, n, s),
          (this._length = 0));
        },
       },
       {
         ...
         if (!(this.selection.composing || this.parent == null)) {
          ...
          if (this.textNode.data !== i.CONTENTS) {
           ...
           this.next instanceof o.default
            ...
            : ((this.textNode.data = v),
              this.parent.insertBefore(y.default.create(this.textNode), this),
          ...
          if ((this.remove(), g != null)) {
           ...
           return (
            (g = d[0]),
            (b = d[1]),
            { startNode: A, startOffset: g, endNode: A, endOffset: b }
           );
          }
         }
        },
      ...
      N(a, [
       ...
       },
       {
        ...
        value: function (i) {
         ...
         return (
          ...
          i.textContent && n.setAttribute('data-label', i.textContent),
       ...
       },
       {
        ...
        value: function () {
         ...
         var n =
          i != null && i !== this.select.querySelector('option[selected]');
   ...
   function (B, _, p) {
    ...
    var P = p(1),
     N = (function () {
      ...
      return (
       Object.defineProperty(k.prototype, 'statics', {
        get: function () {
          ...
          if (n === this.leftGuard)
           if (this.prev instanceof c.default) {
            ...
            this.prev.insertAt(b, g),
             (s = { startNode: this.prev.domNode, startOffset: b + g.length });
           } else
            (A = document.createTextNode(g)),
             this.parent.insertBefore(m.default.create(A), this),
             (s = { startNode: A, startOffset: g.length });
          else
           n === this.rightGuard &&
            (this.next instanceof c.default
             ? (this.next.insertAt(0, g),
               (s = { startNode: this.next.domNode, startOffset: g.length }))
             : ((A = document.createTextNode(g)),
               this.parent.insertBefore(m.default.create(A), this.next),
               (s = { startNode: A, startOffset: g.length })));
          return (n.data = l), s;
         },
        },
         ...
         value: function (n, s) {
          ...
          n.forEach(function (g) {
           if (
            ...
            (g.target === A.leftGuard || g.target === A.rightGuard)
           ) {
   ...
   function (B, _, p) {
    ...
    var a = (function (f) {
     ...
     function n(s, A) {
      ...
      var g = u(
       this,
       (n.__proto__ || Object.getPrototypeOf(n)).call(this, s, A),
      );
      return (
       (g.lastRecorded = 0),
       (g.ignoreChange = !1),
       ...
       g.quill.keyboard.addBinding({ key: 'Z', shortKey: !0 }, g.undo.bind(g)),
       g.quill.keyboard.addBinding(
        { key: 'Z', shortKey: !0, shiftKey: !0 },
        g.redo.bind(g),
       ),
       /Win/i.test(navigator.platform) &&
        g.quill.keyboard.addBinding({ key: 'Y', shortKey: !0 }, g.redo.bind(g)),
       g
      );
     }
     return (
        ...
        value: function (A, g) {
         if (this.stack[A].length !== 0) {
          ...
          this.stack[g].push(b),
           (this.lastRecorded = 0),
           (this.ignoreChange = !0),
           this.quill.updateContents(b[A], y.default.sources.USER),
           (this.ignoreChange = !1);
          var w = i(b[A]);
        ...
        value: function (A, g) {
         if (A.ops.length !== 0) {
          ...
          if (
           ...
           (b = b.compose(v.undo)), (A = v.redo.compose(A));
          } else this.lastRecorded = w;
          this.stack.undo.push({ redo: A, undo: b }),
       ...
       },
       {
        ...
        value: function (A) {
         this.stack.undo.forEach(function (g) {
          (g.undo = A.transform(g.undo, !0)),
           (g.redo = A.transform(g.redo, !0));
         }),
...
`)
   ...
   function (B, _, p) {
          ...
          M.forEach(function (j) {
           ...
           U.split(/\s+/).forEach(function (H) {
            if (H.startsWith('ql-') && ((H = H.slice(3)), x[H] != null))
             if (H === 'direction') j.innerHTML = x[H][''] + x[H].rtl;
             ...
             H.querySelector('option') == null &&
              (H.classList.contains('ql-font')
               ...
               : H.classList.contains('ql-header')
                 ? O(H, D)
                 : H.classList.contains('ql-size') && O(H, C)),
             new A.default(H)
            );
          });
          var U = function () {
           ...
           if (F.files != null && F.files[0] != null) {
            ...
            (M.onload = function (x) {
             ...
             L.quill.updateContents(
              ...
              L.quill.setSelection(j.index + 1, t.default.sources.SILENT),
              (F.value = '');
            }),
    ...
    var I = (function (S) {
     ...
     function L(F, M) {
      ...
      return (
       (x.textbox = x.root.querySelector('input[type="text"]')), x.listen(), x
      );
     }
     return (
      P(L, [
        ...
        value: function () {
         ...
         this.textbox.addEventListener('keydown', function (x) {
          u.default.match(x, 'enter')
           ...
           : u.default.match(x, 'escape') && (M.cancel(), x.preventDefault());
         });
        },
       },
       {
    ...
    var P = (function () {
     ...
     return (
      ...
      (N.prototype.contains = function (k) {
       for (var m, y = this.iterator(); (m = y()); ) if (m === k) return !0;
       return !1;
      }),
      (N.prototype.insertBefore = function (k, m) {
       k &&
        ...
        m != null
         ? ((k.prev = m.prev),
           m.prev != null && (m.prev.next = k),
           (m.prev = k),
           m === this.head && (this.head = k))
         : this.tail != null
           ? ((this.tail.next = k), (k.prev = this.tail), (this.tail = k))
           : ((k.prev = null), (this.head = this.tail = k)),
        (this.length += 1));
      }),
      ...
      (N.prototype.remove = function (k) {
       this.contains(k) &&
        (k.prev != null && (k.prev.next = k.next),
        k.next != null && (k.next.prev = k.prev),
      ...
      (N.prototype.find = function (k, m) {
       ...
       for (var y, c = this.iterator(); (y = c()); ) {
        ...
        if (
         k < o ||
         (m && k === o && (y.next == null || y.next.length() !== 0))
        )
         return [y, k];
        k -= o;
       }
      ...
      (N.prototype.forEach = function (k) {
       for (var m, y = this.iterator(); (m = y()); ) k(m);
      }),
      (N.prototype.forEachAt = function (k, m, y) {
       if (!(m <= 0))
        for (
         ...
         var a = e.length();
         k > u
          ? y(e, k - u, Math.min(m, u + a - k))
          : y(e, 0, Math.min(a, k + m - u)),
          (u += a);
        }
      }),
      ...
      (N.prototype.reduce = function (k, m) {
       for (var y, c = this.iterator(); (y = c()); ) m = k(m, y);
       return m;
      }),
      N
     );
         ...
         var r = function (s, A) {
           A === void 0 && (A = !0),
            !(s == null || s === l) &&
             ...
             (s.domNode[k.DATA_KEY].mutations == null &&
              (s.domNode[k.DATA_KEY].mutations = []),
             A && r(s.parent));
          },
          i = function (s) {
           s.domNode[k.DATA_KEY] == null ||
            s.domNode[k.DATA_KEY].mutations == null ||
            (s instanceof N.default && s.children.forEach(i), s.optimize(u));
          },
          f = e,
          n = 0;
         f.length > 0;
        ...
        u === void 0 && (u = {}),
         ...
         e
          .map(function (a) {
           ...
           return r == null
            ? null
            : r.domNode[k.DATA_KEY].mutations == null
              ? ((r.domNode[k.DATA_KEY].mutations = [a]), r)
              : (r.domNode[k.DATA_KEY].mutations.push(a), null);
          })
          .forEach(function (a) {
           a == null ||
            a === l ||
            a.domNode[k.DATA_KEY] == null ||
            a.update(a.domNode[k.DATA_KEY].mutations || [], u);
          }),
         this.domNode[k.DATA_KEY].mutations != null &&
          o.prototype.update.call(this, this.domNode[k.DATA_KEY].mutations, u),
         this.optimize(e, u);
       }),
       (t.blotName = 'scroll'),
       (t.defaultChild = 'block'),
       (t.scope = k.Scope.BLOCK_BLOT),
       (t.tagName = 'DIV'),
       t
      );
     })(N.default);
   ...
   function (B, _, p) {
    ...
    if (
     (P.classList.toggle('test-class', !1), P.classList.contains('test-class'))
    ) {
     var N = DOMTokenList.prototype.toggle;
     DOMTokenList.prototype.toggle = function (k, m) {
      return arguments.length > 1 && !this.contains(k) == !m
       ? m
       : N.call(this, k);
     };
    }
    String.prototype.startsWith ||
     (String.prototype.startsWith = function (k, m) {
      return (m = m || 0), this.substr(m, k.length) === k;
     }),
     String.prototype.endsWith ||
      (String.prototype.endsWith = function (k, m) {
       var y = this.toString();
       (typeof m != 'number' ||
        !isFinite(m) ||
        Math.floor(m) !== m ||
     ...
     Array.prototype.find ||
      Object.defineProperty(Array.prototype, 'find', {
       value: function (m) {
        ...
        for (
         var y = Object(this), c = y.length >>> 0, o = arguments[1], t, e = 0;
         e < c;
         e++
        )
   ...
   function (B, _) {
    ...
    function m(n, s) {
     ...
     if (w != -1)
      return (
       ...
       n.length > s.length && (A[0][0] = A[2][0] = p),
       A
      );
     if (b.length == 1)
      return [
    ...
    function y(n, s) {
     ...
     (h[w + 1] = 0), (d[w + 1] = 0);
     for (
      var T = A - g, q = T % 2 != 0, D = 0, C = 0, Z = 0, I = 0, R = 0;
      R < b;
      R++
     ) {
      ...
      for (var j = -R + Z; j <= R - I; j += 2) {
       ...
       for (
        var U = x - j;
        x < A && U < g && n.charAt(A - x - 1) == s.charAt(g - U - 1);
    ...
    function o(n, s) {
     ...
     for (var A = 0, g = Math.min(n.length, s.length), b = g, w = 0; A < b; )
      n.substring(w, b) == s.substring(w, b) ? ((A = b), (w = A)) : (g = b),
       (b = Math.floor((g - A) / 2 + A));
     return b;
    }
    function t(n, s) {
    ...
    function e(n, s) {
     ...
     var w = b(A, g, Math.ceil(A.length / 4)),
      v = b(A, g, Math.ceil(A.length / 2)),
      h;
     if (!w && !v) return null;
    ...
    function u(n) {
     n.push([N, '']);
     for (var s = 0, A = 0, g = 0, b = '', w = '', v; s < n.length; )
      switch (n[s][0]) {
       case P:
        g++, (w += n[s][1]), s++;
        break;
       ...
       case N:
        A + g > 1
         ? (A !== 0 &&
            ...
            ((v = o(w, b)),
            v !== 0 &&
             (s - A - g > 0 && n[s - A - g - 1][0] == N
              ? (n[s - A - g - 1][1] += w.substring(0, v))
           ...
           A === 0
            ? n.splice(s - g, A + g, [P, w])
            : g === 0
              ? n.splice(s - A, A + g, [p, b])
              : n.splice(s - A - g, A + g, [p, b], [P, w]),
           (s = s - A - g + (A ? 1 : 0) + (g ? 1 : 0) + 1))
         : s !== 0 && n[s - 1][0] == N
     ...
     for (s = 1; s < n.length - 1; )
      n[s - 1][0] == N &&
       n[s + 1][0] == N &&
       (n[s][1].substring(n[s][1].length - n[s - 1][1].length) == n[s - 1][1]
        ? ((n[s][1] =
           n[s - 1][1] +
        ...
        : n[s][1].substring(0, n[s + 1][1].length) == n[s + 1][1] &&
          ((n[s - 1][1] += n[s + 1][1]),
          (n[s][1] = n[s][1].substring(n[s + 1][1].length) + n[s + 1][1]),
          n.splice(s + 1, 1),
          (h = !0))),
       s++;
     h && u(n);
    ...
    function N(k) {
     return (
      (k &&
       ...
       !Object.prototype.propertyIsEnumerable.call(k, 'callee')) ||
      !1
     );
    }
   },
   function (B, _) {
    ...
    (m.prototype.eventNames = function () {
     ...
     for (t in (o = this._events)) p.call(o, t) && c.push(P ? t.slice(1) : t);
     ...
     (m.prototype.removeListener = function (c, o, t, e) {
      ...
      if (l.fn)
       ...
       for (var a = 0, r = [], i = l.length; a < i; a++)
        (l[a].fn !== o || (e && !l[a].once) || (t && l[a].context !== t)) &&
         r.push(l[a]);
       r.length
     ...
     return (typeof K > 'u' ? 'undefined' : P(K)) === 'object'
      ...
      : z.reduce(function (G, W) {
         return W.attributes && W.attributes[K]
          ? G.push(W)
          : G.insert(W.insert, (0, y.default)({}, E({}, K, $), W.attributes));
        }, new o.default());
    }
    function F(z) {
    ...
    function V(z, K) {
     ...
     if ($.prototype instanceof e.default.Embed) {
      var G = {},
       W = $.value(z);
      W != null &&
       ((G[$.blotName] = W), (K = new o.default().insert(G, $.formats(z))));
     } else
...
`);
    ...
    function lt(z, K) {
     ...
     if (!F(z.parentNode).whiteSpace.startsWith('pre')) {
      var G = function (J, tt) {
       return (
        (tt = tt.replace(/[^\u00a0]/g, '')), tt.length < 1 && J ? ' ' : tt
       );
      };
      ($ = $.replace(/\r\n/g, ' ').replace(/\n/g, ' ')),
   ...
   function (B, _, p) {
    ...
    var A = (0, u.default)('quill:toolbar'),
     g = (function (h) {
      s(d, h);
      function d(E, T) {
       f(this, d);
       ...
       if (!(q.container instanceof HTMLElement)) {
        var C;
        return (
         (C = A.error('Container required for toolbar', q.options)), n(q, C)
        );
       }
       return (
         ...
         value: function (T) {
          ...
          this.controls.forEach(function (D) {
           ...
           if (I.tagName === 'SELECT') {
            var R = void 0;
            if (T == null) R = null;
            else if (q[Z] == null) R = I.querySelector('option[selected]');
            ...
            var S =
             ...
             (q[Z] != null && q[Z].toString() === I.getAttribute('value')) ||
      ...
      P(l, [
       ...
       },
       {
        ...
        value: function (r, i) {
         ...
         f &&
          (f.tagName === 'line' ? (f.style.stroke = n) : (f.style.fill = n));
        },
       },
      ]),
      l
          ...
          this.root
           ...
           .addEventListener('click', function (T) {
            if (E.linkRange != null) {
             var q = E.linkRange;
             E.restoreFocus(),
              E.quill.formatText(q, 'link', !1, o.default.sources.USER),
              delete E.linkRange;
            }
   ...
   function (B, _, p) {
    ...
    var t = (function (e) {
     ...
     function u() {
      return (
       y(this, u),
       c(this, (u.__proto__ || Object.getPrototypeOf(u)).apply(this, arguments))
      );
     }
     return (
      P(u, null, [
   ...
   function (B, _, p) {
       ...
       [
        {
         ...
         value: function (g) {
          return g.tagName === this.tagName
           ? void 0
           : N(s.__proto__ || Object.getPrototypeOf(s), 'formats', this).call(
              this,
              g,
             );
         },
    ...
    var f = (function (n) {
      ...
      P(s, null, [
       {
        ...
        value: function (g) {
         var b = g === 'ordered' ? 'OL' : 'UL',
          w = N(s.__proto__ || Object.getPrototypeOf(s), 'create', this).call(
           this,
           b,
          );
         return (
     ...
     function s(A) {
      l(this, s);
      var g = a(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, A)),
       b = function (v) {
        if (v.target.parentNode === A) {
         var h = g.statics.formats(A),
        ...
        value: function (r) {
         return r === 'super'
          ...
          : r === 'sub'
            ...
            : N(l.__proto__ || Object.getPrototypeOf(l), 'create', this).call(
               this,
               r,
              );
        },
        ...
        [
         {
          ...
          value: function (f) {
           ...
           return (
            typeof f == 'string' && n.setAttribute('src', this.sanitize(f)), n
           );
          },
         },
         {
         ...
         },
         {
          ...
          value: function (f) {
           return (
            /\.(jpe?g|gif|png)$/.test(f) || /^data:image\/.+;base64/.test(f)
           );
          },
         },
         {
      ...
      P(n, null, [
       {
        ...
        value: function (A) {
         ...
         return (
          typeof A == 'string' &&
           (window.katex.render(A, g, { throwOnError: !1, errorColor: '#f00' }),
           g.setAttribute('data-value', A)),
          g
         );
        },
       },
   ...
   function (B, _, p) {
    ...
    var f = (function (A) {
     ...
     function g() {
      return (
       a(this, g),
       r(this, (g.__proto__ || Object.getPrototypeOf(g)).apply(this, arguments))
      );
     }
     return (
      P(g, [
         ...
         value: function () {
          ...
          if (!this.quill.selection.composing) {
           ...
           this.quill.scroll.descendants(f).forEach(function (h) {
            ...
            v != null && this.quill.setSelection(v, c.default.sources.SILENT);
          }
         },
        },
       ]),
       ...
       N(b, [
        {
         key: 'extendToolbar',
         value: function (v) {
          (this.tooltip = new A(this.quill, this.options.bounds)),
