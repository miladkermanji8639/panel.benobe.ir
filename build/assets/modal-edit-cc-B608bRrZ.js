document.addEventListener('DOMContentLoaded', function (o) {
 (function () {
  const n = document.querySelector('.credit-card-mask-edit'),
   i = document.querySelector('.expiry-date-mask-edit'),
  ...
  n &&
   ...
   FormValidation.formValidation(document.getElementById('editCCForm'), {
    fields: {
     modalEditCard: {
      validators: { notEmpty: { message: 'لطفا شماره کارت را وارد کنید' } },
     },
    },
    plugins: {
