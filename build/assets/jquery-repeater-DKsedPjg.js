 ...
 (function (t) {
  var f = function (i, n) {
    ...
    return (
     ...
     (n.publishChange = (function () {
      ...
      return function (y, x) {
       var g = e.get();
       n.equalTo(g, u) || e.publish('change', { e: y, domElement: x }), (u = g);
      };
     })()),
     e
    );
                        ...
                        : e.is('input[type="hidden"]')
                          ...
                          : e.is('input[type="radio"]')
                            ...
                            : e.is('input[type="checkbox"]')
                              ? y('checkbox', e)
                              : u('text', e)
      : (u('button', 'input[type="button"], button, input[type="submit"]'),
        u('text', 'input[type="text"]'),
        u('password', 'input[type="password"]'),
        u('email', 'input[type="email"]'),
        u('url', 'input[type="url"]'),
        u('range', 'input[type="range"]'),
        u('textarea', 'textarea'),
        u('select', 'select:not([multiple])'),
        u('select[multiple]', 'select[multiple]'),
        u('file', 'input[type="file"]:not([multiple])'),
        u('file[multiple]', 'input[type="file"][multiple]'),
        u('hidden', 'input[type="hidden"]'),
        y('radio', 'input[type="radio"]'),
  ...
  (t.fn.inputVal = function (i) {
   ...
   (t.fn.inputDisable = function () {
    var i = t(this);
    return E(m({ $: i }), 'disable'), i;
   }),
   (t.fn.inputEnable = function () {
    var i = t(this);
    return E(m({ $: i }), 'enable'), i;
   }),
   (t.fn.inputClear = function () {
    var i = t(this);
    return E(m({ $: i }), 'clear'), i;
   });
 })(jQuery),
  (v.fn.repeaterVal = function () {
   var t = function (a) {
    ...
    f = function (a) {
     if (
      a.length === 1 &&
      (a[0].key.length === 0 || (a[0].key.length === 1 && !a[0].key[0]))
     )
      return a[0].val;
     d(a, function (c) {
      c.head = c.key.shift();
    ...
    v(this).each(function () {
     var a = v(this),
      ...
      h = function (l, p) {
       return l.filter(function () {
        return p
         ? v(this).closest(K(p, 'selector').join(',')).length === 0
         : !0;
       });
      },
      b = function () {
      ...
      O = h(
       h(v(this).find('[data-repeater-item]'), t.repeaters)
        .first()
     ...
     var k = function () {
       ...
       t.repeaters &&
        l.each(function () {
         ...
         d(t.repeaters, function (m) {
          p.find(m.selector).repeater(U(m, { $parent: p }));
         });
        });
      },
      B = function (l, p, m) {
      ...
      T = function (l, p, m) {
       l.each(function (i) {
        var n = v(this);
        n.data('item-name', p + '[' + i + ']'),
         h(n.find('[name]'), m).each(function () {
          var e = v(this),
           ...
           y =
            ...
            u +
            ']' +
            (e.is(':checkbox') || e.attr('multiple') ? '[]' : '');
          e.attr('name', y),
           B(m, n, function (x) {
            var g = v(this);
            T(
             h(g.find('[data-repeater-item]'), x.repeaters || []),
             p +
              '[' +
              i +
              '][' +
              g.find('[data-repeater-list]').first().data('repeater-list') +
              ']',
             x.repeaters,
            );
           });
       ...
       var l = function (p, m, i) {
        if (m || t.defaultValues) {
         ...
         h(p.find('[name]'), i).each(function () {
          ...
          p.inputVal(
           A(
            z(m || t.defaultValues, function (e, r) {
             return n[r];
            }),
            M,
            function (e) {
          ...
          if (m && m[u]) {
           ...
           r.find('[data-repeater-item]').remove(),
            d(m[u], function (x) {
             var g = y.clone();
             l(g, x, e.repeaters || []),
              r.find('[data-repeater-list]').append(g);
            });
