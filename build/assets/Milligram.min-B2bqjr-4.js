var g = (o, i) => () => (i || o((i = { exports: {} }).exports, i), i.exports);
var P = g((p, l) => {
 (function (o, i) {
  typeof p == 'object' && typeof l < 'u'
   ...
   : typeof define == 'function' && define.amd
     ...
     : ((o = typeof globalThis < 'u' ? globalThis : o || self),
       ...
       (o.FormValidation.plugins.Milligram = i()));
 })(void 0, function () {
  function o(e, t) {
   if (!(e instanceof t))
  ...
  function b(e) {
   ...
   return function () {
    ...
    if (t) {
     ...
     f = Reflect.construct(r, arguments, a);
     ...
     y(n, [
      {
       key: 'onIconPlaced',
       value: function (f) {
        var a = f.element.getAttribute('type'),
         s = f.element.parentElement;
        (a === 'checkbox' || a === 'radio') &&
         (s.parentElement.insertBefore(f.iconElement, s.nextSibling),
