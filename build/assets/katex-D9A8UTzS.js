 ...
 constructor(e) {
  ...
  for (var t in Ae)
   if (Ae.hasOwnProperty(t)) {
    var a = Ae[t];
    this[t] =
     e[t] !== void 0 ? (a.processor ? a.processor(e[t]) : e[t]) : Sa(a);
   }
 }
...
var dt = 0,
 ...
 R = { DISPLAY: b0[dt], TEXT: b0[_0], SCRIPT: b0[le], SCRIPTSCRIPT: b0[ee] },
 at = [
  {
   name: 'latin',
   blocks: [
...
function ft(r, e, t) {
 ...
 var a = r.charCodeAt(0),
  n = y0[e][a];
 if (
  (!n && r[0] in Ot && ((a = Ot[r[0]].charCodeAt(0)), (n = y0[e][a])),
  !n && t === 'text' && vr(a) && (n = y0[e][77]),
  n)
 )
...
class A0 {
 ...
 havingStyle(e) {
  return this.style === e
   ? this
   : this.extend({ style: e, size: Ft(this.textSize, e) });
 }
 havingCrampedStyle() {
 ...
 fontMetrics() {
  return (
   this._fontMetrics || (this._fontMetrics = Va(this.size)), this._fontMetrics
  );
 }
 getColor() {
 ...
 xr = function (e) {
  ...
  for (var s in this.attributes)
   this.attributes.hasOwnProperty(s) &&
    (t += ' ' + s + '="' + I.escape(this.attributes[s]) + '"');
  t += '>';
...
class f0 {
 ...
 toMarkup() {
  var e = !1,
   t = '<span';
  this.classes.length &&
   ((e = !0), (t += ' class="'), (t += I.escape(L0(this.classes))), (t += '"'));
  var a = '';
 ...
 toNode() {
  ...
  return (
   this.alternate
    ...
    : t.setAttribute('d', It[this.pathName]),
   t
  );
 }
 toMarkup() {
...
for (var a0 = 0; a0 < De.length; a0++) {
 var J = De.charAt(a0);
 (E = String.fromCharCode(55349, 56320 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56372 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56424 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56580 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56684 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56736 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56788 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56840 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  (E = String.fromCharCode(55349, 56944 + a0)),
  i(l, u, q, J, E),
  i(k, u, v, J, E),
  a0 < 26 &&
   ((E = String.fromCharCode(55349, 56632 + a0)),
   i(l, u, q, J, E),
   i(k, u, v, J, E),
   (E = String.fromCharCode(55349, 56476 + a0)),
   i(l, u, q, J, E),
   i(k, u, v, J, E));
}
E = '𝕜';
...
for (var Y0 = 0; Y0 < 10; Y0++) {
 var H0 = Y0.toString();
 (E = String.fromCharCode(55349, 57294 + Y0)),
  i(l, u, q, H0, E),
  i(k, u, v, H0, E),
  (E = String.fromCharCode(55349, 57314 + Y0)),
  i(l, u, q, H0, E),
  i(k, u, v, H0, E),
  (E = String.fromCharCode(55349, 57324 + Y0)),
  i(l, u, q, H0, E),
  i(k, u, v, H0, E),
  (E = String.fromCharCode(55349, 57334 + Y0)),
  i(l, u, q, H0, E),
  i(k, u, v, H0, E);
}
var st = 'ÐÞþ';
 ...
 g0 = function (e, t, a, n, s) {
  ...
  if (h) {
   ...
   (a === 'text' || (n && n.font === 'mathit')) && (p = 0),
    (c = new f0(e, h.height, h.depth, p, h.skew, h.width, s));
  } else
   typeof console < 'u' &&
    console.warn(
 ...
 Ja = function (e, t, a, n) {
  return (
   ...
   a.font === 'boldsymbol' && Ee(e, 'Main-Bold', t).metrics
    ? g0(e, 'Main-Bold', t, a, n.concat(['mathbf']))
    : e === '\\' || $[t][e].font === 'main'
      ? g0(e, 'Main-Regular', t, a, n)
      : g0(e, 'AMS-Regular', t, a, n.concat(['amsrm']))
  );
 },
 ...
 _a = function (e, t, a) {
  ...
  if (c) {
   ...
   if (c === 'boldsymbol') {
    ...
    h
     ? ((y = Mr[c].fontName), (w = [c]))
     : ((y = we(c, t.fontWeight, t.fontShape)),
...
var qe = function (e) {
  ...
  return (
   Xt(
    ...
    (z, T) => {
     var C = T.classes[0],
      N = z.classes[0];
     C === 'mbin' && I.contains(c1, N)
      ? (T.classes[0] = 'mord')
      : N === 'mbin' && I.contains(m1, C) && (z.classes[0] = 'mord');
    },
    { node: y },
    w,
    x,
 ...
 Tr = function (e) {
  return e instanceof he ||
   e instanceof pt ||
   (e instanceof me && e.hasClass('enclosing'))
   ? e
   : null;
 },
 p1 = function r(e, t) {
...
function ot(r, e) {
 ...
 var p;
 t
  ? ((p = ke(t0(t, e, !0))), (p.classes = ['tag']), s.push(p))
  : n && s.push(n);
...
class c0 {
 ...
 toMarkup() {
  ...
  for (var t in this.attributes)
   Object.prototype.hasOwnProperty.call(this.attributes, t) &&
    ((e += ' ' + t + '="'), (e += I.escape(this.attributes[t])), (e += '"'));
  this.classes.length > 0 &&
   (e += ' class ="' + I.escape(L0(this.classes)) + '"'),
   (e += '>');
  for (var a = 0; a < this.children.length; a++)
   e += this.children[a].toMarkup();
...
function $t(r, e, t, a, n) {
 ...
 s.length === 1 &&
 s[0] instanceof c0 &&
 I.contains(['mrow', 'mtable'], s[0].type)
  ? (o = s[0])
...
var xt = (r, e) => {
    ...
    (w = b.makeVList(
     {
      ...
      children: [
       { type: 'elem', elem: s },
       {
        ...
        wrapperStyle:
         h > 0
          ? { width: 'calc(100% - ' + A(2 * h) + ')', marginLeft: A(2 * h) }
          : void 0,
       },
      ],
     },
 ...
 Nr = (r, e) => {
  var t = r.isStretchy
    ? N0.mathMLnode(r.label)
    : new S.MathNode('mo', [p0(r.label, r.mode)]),
...
B({
 ...
 handler(r, e) {
  var { parser: t } = r;
  return { type: 'pmb', mode: t.mode, mclass: Oe(e[0]), body: Q(e[0]) };
 },
 htmlBuilder(r, e) {
  var t = t0(r.body, e, !0),
...
var ne = function (e, t, a) {
 ...
 Ze = function (e, t, a) {
  var n = y0['Size4-Regular'][e.charCodeAt(0)]
    ? y0['Size4-Regular'][e.charCodeAt(0)][4]
    : y0['Size1-Regular'][e.charCodeAt(0)][4],
 ...
 Pr = function (e, t, a, n, s, o) {
  ...
  var ae = n.havingBaseStyle(R.TEXT),
   Pe = b.makeVList(
    { positionType: 'bottom', positionData: r0, children: e0 },
    ae,
   );
 ...
 F1 = function (e, t, a, n, s) {
  if (
   (e === '<' || e === '\\lt' || e === '⟨'
    ? (e = '\\langle')
    : (e === '>' || e === '\\gt' || e === '⟩') && (e = '\\rangle'),
   I.contains(Gr, e) || I.contains(Vr, e))
  )
...
var kt = (r, e) => {
 ...
 St = (r, e) => {
  ...
  return (
   r.backgroundColor && a.setAttribute('mathbackground', r.backgroundColor), a
  );
 };
B({
 type: 'enclose',
 ...
 function V() {
  O &&
   (r.gullet.macros.get('\\df@tag')
    ? (O.push(r.subparse([new x0('\\df@tag')])),
...
var k0 = function (e, t) {
  ...
  var z =
    e.colSeparationType === 'CD' ? K({ number: 3, unit: 'ex' }, t) : 12 * y,
   T = 3 * y,
   C = e.arraystretch * z,
   N = 0.7 * C,
   O = 0.3 * C,
  ...
  for (n = 0, R0 = 0; n < h || R0 < U0.length; ++n, ++R0) {
   for (var m0 = U0[R0] || {}, ae = !0; m0.type === 'separator'; ) {
    if (
     (ae ||
      ((v0 = b.makeSpan(['arraycolsep'], [])),
      (v0.style.width = A(t.fontMetrics().doubleRuleSep)),
      s0.push(v0)),
  ...
  if (((c = b.makeSpan(['mtable'], s0)), p.length > 0)) {
   for (
    ...
    var Rt = p.pop(),
     Et = Rt.pos - e0;
    Rt.isDashed
     ? Ge.push({ type: 'elem', elem: ca, shift: Et })
     : Ge.push({ type: 'elem', elem: ma, shift: Et });
   }
...
w0({
 ...
 handler(r, e) {
  ...
  if (
   ((s = V0(r.parser, s, 'script')), s.body.length > 0 && s.body[0].length > 1)
  )
...
B({
 ...
 mathmlBuilder: (r, e) => {
  var t = G0(r.body, e);
  return (
   t instanceof c0 || (t = new c0('mrow', [t])),
 ...
 mathmlBuilder: (r, e) => {
  ...
  if (
   (r.totalheight.number > 0 &&
    ((n = K(r.totalheight, e) - a), t.setAttribute('valign', A(-n))),
...
var _r = (r, e, t, a, n, s, o) => {
 ...
 re = (r, e) => {
  ...
  var C = 0,
   N = 0;
  return (
   (c instanceof f0 || s.name === '\\oiint' || s.name === '\\oiiint') &&
    !s.suppressBaseShift &&
 ...
 ce = (r, e) => {
  var t;
  if (r.symbol)
   (t = new c0('mo', [p0(r.name, r.mode)])),
    I.contains(ea, r.name) && t.setAttribute('largeop', 'false');
...
var ta = (r, e) => {
 ...
 j1 = (r, e) => {
  for (
   var t = o0(r.body, e.withFont('mathrm')), a = !0, n = 0;
   n < t.length;
   n++
  ) {
   var s = t[n];
...
B({
 ...
 mathmlBuilder(r, e) {
  var t = nr[r.style],
   ...
   h = o[r.style];
  return (
   s.setAttribute('scriptlevel', h[0]), s.setAttribute('displaystyle', h[1]), s
  );
 },
});
var K1 = function (e, t) {
 ...
 if (a)
  if (a.type === 'op') {
   var n =
    a.limits && (t.style.size === R.DISPLAY.size || a.alwaysHandleSupSub);
   return n ? re : null;
  } else if (a.type === 'operatorname') {
   var s =
    a.alwaysHandleSupSub && (t.style.size === R.DISPLAY.size || a.limits);
   return s ? ta : null;
  } else {
  ...
  if (t) o = a ? 'mover' : 'munder';
   ...
   if (r.sup) {
    ...
    (c &&
     c.type === 'op' &&
     c.limits &&
     (e.style === R.DISPLAY || c.alwaysHandleSupSub)) ||
    (c &&
     c.type === 'operatorname' &&
   ...
   (h &&
    h.type === 'op' &&
    h.limits &&
    (e.style === R.DISPLAY || h.alwaysHandleSupSub)) ||
   (h &&
    h.type === 'operatorname' &&
...
B({
 ...
 htmlBuilder(r, e) {
  for (
   var t = ur(r), a = [], n = e.havingStyle(e.style.text()), s = 0;
   s < t.length;
   s++
  ) {
   var o = t[s];
...
m('\\dots', function (r) {
 ...
 return (
  t in cr
   ? (e = cr[t])
   : (t.slice(0, 4) === '\\not' ||
      (t in $.math && I.contains(['bin', 'rel'], $.math[t].group))) &&
     (e = '\\dotsb'),
  e
 );
});
...
var ia = A(y0['Main-Regular'][84][1] - 0.7 * y0['Main-Regular'][65][1]);
m(
 '\\LaTeX',
 '\\textrm{\\html@mathml{' +
...
class s4 {
 ...
 scanArgument(e) {
  ...
  return (
   this.pushToken(new x0('EOF', a.loc)), this.pushTokens(n), t.range(a, '')
  );
 }
 consumeSpaces() {
  for (;;) {
 ...
 _getExpansion(e) {
  ...
  if (typeof n == 'string') {
   ...
   for (
    var h = new hr(n, this.settings), c = [], p = h.lex();
    p.text !== 'EOF';
...
class ue {
 ...
 parse() {
  ...
  try {
   ...
   return (
    this.expect('EOF'), this.settings.globalGroup || this.gullet.endGroup(), e
   );
  } finally {
