import { c as g } from './_commonjsHelpers-BosuxZz1.js';
var X = { exports: {} };
/*!
 * Waves v0.7.6
 ...
 */ (function (x, Y) {
 (function (f, p) {
  ...
  function N(t) {
   return C(t) ? t : t.nodeType === 9 && t.defaultView;
  }
  function b(t) {
   var e = typeof t;
  ...
  function E(t) {
   ...
   return (
    (e = n.documentElement),
    typeof t.getBoundingClientRect < 'u' && (r = t.getBoundingClientRect()),
    (a = N(n)),
    {
  ...
  var o = {
    ...
    show: function (t, e, a) {
     ...
     'touches' in t && t.touches.length
      ? ((i = t.touches[0].pageY - n.top), (s = t.touches[0].pageX - n.left))
      : ((i = t.pageY - n.top), (s = t.pageX - n.left)),
      (s = s >= 0 ? s : 0),
      (i = i >= 0 ? i : 0);
     var c = 'scale(' + (e.clientWidth / 100) * 3 + ')',
      l = 'translate(0,0)';
     a && (l = 'translate(' + a.x + 'px, ' + a.y + 'px)'),
      r.setAttribute('data-hold', Date.now()),
      r.setAttribute('data-x', s),
      r.setAttribute('data-y', i),
      r.setAttribute('data-scale', c),
      r.setAttribute('data-translate', l);
     var u = { top: i + 'px', left: s + 'px' };
     r.classList.add('waves-notransition'),
      r.setAttribute('style', w(u)),
      r.classList.remove('waves-notransition'),
      (u['-webkit-transform'] = c + ' ' + l),
      (u['-moz-transform'] = c + ' ' + l),
      (u['-ms-transform'] = c + ' ' + l),
      (u['-o-transform'] = c + ' ' + l),
      (u.transform = c + ' ' + l),
     ...
     (u['-webkit-transition-duration'] = v + 'ms'),
      (u['-moz-transition-duration'] = v + 'ms'),
      (u['-o-transition-duration'] = v + 'ms'),
      (u['transition-duration'] = v + 'ms'),
      r.setAttribute('style', w(u));
    },
    hide: function (t, e) {
     e = e || this;
     for (
      var a = e.getElementsByClassName('waves-rippling'), r = 0, n = a.length;
      r < n;
      r++
     )
      k(t, e, a[r]);
     h &&
      (e.removeEventListener('touchend', o.hide),
      e.removeEventListener('touchcancel', o.hide)),
      e.removeEventListener('mouseup', o.hide),
      e.removeEventListener('mouseleave', o.hide);
    },
   },
   W = {
    input: function (t) {
     var e = t.parentNode;
     if (
      !(e.tagName.toLowerCase() === 'i' && e.classList.contains('waves-effect'))
     ) {
      var a = document.createElement('i');
      (a.className = t.className + ' waves-input-wrapper'),
      ...
      var r = window.getComputedStyle(t, null),
       n = r.color,
       i = r.backgroundColor;
      a.setAttribute('style', 'color:' + n + ';background:' + i),
   ...
   if (e !== null) {
    ...
    if ((d.registerEvent(t), t.type === 'touchstart' && o.delay)) {
     var a = !1,
      ...
      n = function (c) {
       r && (clearTimeout(r), (r = null), o.show(t, e)),
        a || ((a = !0), o.hide(c, e)),
        s();
      },
      i = function (c) {
     ...
     o.show(t, e),
      h &&
       (e.addEventListener('touchend', o.hide, !1),
       e.addEventListener('touchcancel', o.hide, !1)),
      e.addEventListener('mouseup', o.hide, !1),
      e.addEventListener('mouseleave', o.hide, !1);
   }
  }
  return (
   (f.init = function (t) {
    var e = document.body;
    (t = t || {}),
     'duration' in t && (o.duration = t.duration),
     'delay' in t && (o.delay = t.delay),
     h &&
   ...
   (f.attach = function (t, e) {
    (t = m(t)),
     y.call(e) === '[object Array]' && (e = e.join(' ')),
     (e = e ? ' ' + e : '');
    for (var a, r, n = 0, i = t.length; n < i; n++)
     (a = t[n]),
      (r = a.tagName.toLowerCase()),
      ['input', 'img'].indexOf(r) !== -1 && (W[r](a), (a = a.parentElement)),
      a.className.indexOf('waves-effect') === -1 &&
       (a.className += ' waves-effect' + e);
   }),
   (f.ripple = function (t, e) {
    ...
    if (
     ...
     for (
      ...
      if (
       ((r = t[c]),
       (n = e.position || { x: r.clientWidth / 2, y: r.clientHeight / 2 }),
       (i = E(r)),
       (s.x = i.left + n.x),
       (s.y = i.top + n.y),
       (l.pageX = s.x),
   ...
   (f.calm = function (t) {
    t = m(t);
    for (
     var e = { type: 'mouseup', button: 1 }, a = 0, r = t.length;
     a < r;
     a++
    )
     o.hide(e, t[a]);
