...
function Oe(e) {
 for (var i = 1; i < arguments.length; i++) {
  ...
  i % 2
   ? $e(Object(t), !0).forEach(function (s) {
      yt(e, s, t[s]);
     })
   : Object.getOwnPropertyDescriptors
     ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
     : $e(Object(t)).forEach(function (s) {
...
var ie = function (e) {
 ...
 Et = function (e) {
  return (
   Ve(e) ||
   ((Ue(e) || Be(e) || We(e)) && !e.length) ||
   (Fe(e) && !Object.keys(e).length)
  );
 },
 _ = {
  nullOrUndefined: Ve,
     ...
     value: function (i) {
      ...
      return (
       0 > (t = (100 / c.width) * (n.clientX - c.left))
        ? (t = 0)
        : 100 < t && (t = 100),
       50 > t ? (t -= (100 - 2 * t) * u) : 50 < t && (t += 2 * (t - 50) * u),
       a + Pt((t / 100) * (l - a), o)
      );
     },
    },
    {
     ...
     value: function (i) {
      e.enabled &&
       ...
       vt(i.target, i.type === 'touchend' ? 'change' : 'input'));
     },
    },
   ],
   [
     ...
     value: function (i) {
      ...
      if (
       (_.empty(i) || _.string(i)
        ? (s = Array.from(
           document.querySelectorAll(_.string(i) ? i : 'input[type="range"]'),
          ))
        : _.element(i)
          ? (s = [i])
          : _.nodeList(i)
...
const se = (e) => (e != null ? e.constructor : null),
 ...
 Pe = (e) => e == null,
 ze = (e) => se(e) === Object,
 Nt = (e) => se(e) === Number && !Number.isNaN(e),
 de = (e) => se(e) === String,
 xt = (e) => se(e) === Boolean,
 ...
 It = (e) => se(e) === Text,
 $t = (e) => U(e, Event),
 Ot = (e) => U(e, KeyboardEvent),
 _t = (e) => U(e, window.TextTrackCue) || U(e, window.VTTCue),
 jt = (e) => U(e, TextTrack) || (!Pe(e) && de(e.kind)),
 Ht = (e) => U(e, Promise) && Ke(e.then),
 Rt = (e) =>
  e !== null &&
  typeof e == 'object' &&
  e.nodeType === 1 &&
...
const qt = !!window.document.documentMode,
 Vt = /Edge/g.test(navigator.userAgent),
 Ft =
  'WebkitAppearance' in document.documentElement.style &&
  !/Edge/g.test(navigator.userAgent),
 Ut = /iPhone|iPod/gi.test(navigator.userAgent) && navigator.maxTouchPoints > 1,
 Bt = navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1,
 Wt =
...
function ce(e, i) {
 return r.element(i) && r.element(i.parentNode) && r.element(e)
...
const He = {
 ...
 x = {
  ...
  pip: !(
   O.isIPhone ||
   (!r.function(y('video').webkitSetPresentationMode) &&
    (!document.pictureInPictureEnabled || y('video').disablePictureInPicture))
  ),
...
function Z(e, i, t, s = !1, n = !0, a = !1) {
 ...
 const l = i.split(' ');
 let o = a;
 Qt && (o = { passive: n, capture: a }),
  l.forEach((c) => {
   this &&
    this.eventListeners &&
    s &&
    this.eventListeners.push({ element: e, type: c, callback: t, options: o }),
...
function it(e) {
 return r.array(e) || (r.string(e) && e.includes(':'))
  ? (r.array(e) ? e : e.split(':')).map(Number).every(r.number)
  : !1;
}
function he(e) {
...
const W = {
 ...
 setup() {
  ...
  (e.options.speed = e.config.speed.options),
   r.empty(this.config.ratio) || Y.call(e),
...
function at(e, i) {
 ...
 const a = () => document.getElementById(i) !== null,
  l = (o, c) => {
   (o.innerHTML = c),
    (s && a()) || document.body.insertAdjacentElement('afterbegin', o);
  };
 if (!s || !a()) {
  const o = ee.supported,
...
const rt = (e) => Math.trunc((e / 60 / 60) % 60, 10),
 ai = (e) => Math.trunc((e / 60) % 60, 10),
 ri = (e) => Math.trunc(e % 60, 10);
...
const h = {
 ...
 findElements() {
  try {
   return (
    ...
    (this.elements.progress = I.call(this, this.config.selectors.progress)),
    ...
    r.element(this.elements.progress) &&
 ...
 createBadge(e) {
  ...
  return (
   i.appendChild(y('span', { class: this.config.classNames.menu.badge }, e)), i
  );
 },
 createButton(e, i) {
  const t = N({}, i);
  ...
  switch (
   ...
   Object.keys(t).includes('class')
    ? t.class.split(' ').some((l) => l === this.config.classNames.control) ||
      N(t, { class: `${t.class} ${this.config.classNames.control}` })
  ...
  return (
   n.toggle
    ? (a.appendChild(
      ...
      a.appendChild(
       h.createLabel.call(this, n.labelPressed, { class: 'label--pressed' }),
      ),
      a.appendChild(
   ...
   N(t, q(this.config.selectors.buttons[s], t)),
   we(a, t),
   s === 'play'
    ? (r.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
 ...
 createTime(e, i) {
  const t = q(this.config.selectors.display[e], i),
   s = y(
    'div',
    N(t, {
     class:
     ...
     t.key !== ' ' &&
      (t.key === 'ArrowDown' || (s && t.key === 'ArrowRight')
       ? ((n = e.nextElementSibling),
         r.element(n) || (n = e.parentNode.firstElementChild))
       : ((n = e.previousElementSibling),
         r.element(n) || (n = e.parentNode.lastElementChild)),
      ge.call(this, n, !0));
    }
   },
   !1,
 ...
 createMenuItem({
  ...
  const l = q(this.config.selectors.inputs[t]),
   o = y(
    'button',
    N(l, {
     type: 'button',
 ...
 updateVolume() {
  this.supported.ui &&
   (r.element(this.elements.inputs.volume) &&
    h.setRange.call(
     this,
     this.elements.inputs.volume,
     this.muted ? 0 : this.volume,
    ),
   r.element(this.elements.buttons.mute) &&
 ...
 updateProgress(e) {
  ...
  if (e)
   switch (e.type) {
    ...
    case 'seeking':
    case 'seeked':
     (i = ei(this.currentTime, this.duration)),
      e.type === 'timeupdate' &&
 ...
 updateSeekTooltip(e) {
  ...
  if (
   ...
   !r.element(this.elements.inputs.seek) ||
   !r.element(this.elements.display.seekTooltip) ||
   this.duration === 0
  )
   return;
 ...
 timeUpdate(e) {
  const i =
   !r.element(this.elements.display.duration) && this.config.invertTime;
 ...
 durationUpdate() {
  ...
  if (this.duration >= 2 ** 32)
   return (
    z(this.elements.display.currentTime, !0), void z(this.elements.progress, !0)
   );
  r.element(this.elements.inputs.seek) &&
 ...
 updateSetting(e, i, t) {
  ...
  if (e === 'captions') n = this.currentTrack;
   ...
   if (
    ((n = r.empty(t) ? this[e] : t),
    r.empty(n) && (n = this.config[e].default),
    !r.empty(this.options[e]) && !this.options[e].includes(n))
   )
  ...
  if (
   (r.element(a) || (a = s && s.querySelector('[role="menu"]')), !r.element(a))
  )
   return;
 ...
 setQualityMenu(e) {
  ...
  if ((h.toggleMenuButton.call(this, i, s), re(t), h.checkMenu.call(this), !s))
   return;
  const n = (a) => {
 ...
 setCaptionsMenu() {
  ...
  const e = 'captions',
   ...
   s = !!t.length;
  if ((h.toggleMenuButton.call(this, e, s), re(i), h.checkMenu.call(this), !s))
   return;
  const n = t.map((a, l) => ({
   value: l,
 ...
 checkMenu() {
  const { buttons: e } = this.elements.settings,
   i = !r.empty(e) && Object.values(e).some((t) => !t.hidden);
 ...
 toggleMenu(e) {
  ...
  t.setAttribute('aria-expanded', n),
   z(i, !n),
   S(this.elements.container, this.config.classNames.menu.open, n),
   n && r.keyboardEvent(e)
    ? h.focusFirstMenuItem.call(this, null, !0)
    : n || s || ge.call(this, t, r.keyboardEvent(e));
 },
 getMenuSize(e) {
   ...
   const a = h.getMenuSize.call(this, t),
    l = (o) => {
     o.target === s &&
      ...
      ((s.style.width = ''), (s.style.height = ''), me.call(this, s, ve, l));
    };
   C.call(this, s, ve, l),
 ...
 create(e) {
  ...
  return (
   ke(r.array(this.config.controls) ? this.config.controls : []).forEach(
    (f) => {
     if (
      (f === 'restart' && u.appendChild(t.call(this, 'restart', g)),
      f === 'rewind' && u.appendChild(t.call(this, 'rewind', g)),
      f === 'play' && u.appendChild(t.call(this, 'play', g)),
      f === 'fast-forward' && u.appendChild(t.call(this, 'fast-forward', g)),
      f === 'progress')
     ) {
      const d = y('div', { class: `${g.class} plyr__progress__container` }),
       v = y('div', q(this.config.selectors.progress));
      if (
     ...
     if (
      (f === 'current-time' && u.appendChild(a.call(this, 'currentTime', g)),
      f === 'duration' && u.appendChild(a.call(this, 'duration', g)),
      f === 'mute' || f === 'volume')
     ) {
      let { volume: d } = this.elements;
      if (
       ((r.element(d) && u.contains(d)) ||
        ((d = y('div', N({}, g, { class: `${g.class} plyr__volume`.trim() }))),
        (this.elements.volume = d),
        u.appendChild(d)),
       f === 'mute' && d.appendChild(t.call(this, 'mute')),
       f === 'volume' && !O.isIos && !O.isIPadOS)
      ) {
       const v = { max: 1, step: 0.05, value: this.config.volume };
       d.appendChild(
        n.call(this, 'volume', N(v, { id: `plyr-volume-${e.id}` })),
       );
      }
     }
     if (
      (f === 'captions' && u.appendChild(t.call(this, 'captions', g)),
      f === 'settings' && !r.empty(this.config.settings))
     ) {
      const d = y(
       'div',
       N({}, g, { class: `${g.class} plyr__menu`.trim(), hidden: '' }),
      );
      d.appendChild(
      ...
      const v = y('div', {
       ...
       k = y('div'),
       T = y('div', { id: `plyr-settings-${e.id}-home` }),
       M = y('div', { role: 'menu' });
      T.appendChild(M),
       k.appendChild(T),
       ...
       this.config.settings.forEach((w) => {
        ...
        const A = y('span', null, $.get(w, this.config)),
         L = y('span', { class: this.config.classNames.menu.value });
        (L.innerHTML = e[w]),
         A.appendChild(L),
         p.appendChild(A),
         M.appendChild(p);
        const j = y('div', { id: `plyr-settings-${e.id}-${w}`, hidden: '' }),
         H = y('button', {
          type: 'button',
          class: `${this.config.classNames.control} ${this.config.classNames.control}--back`,
         });
        H.appendChild(y('span', { 'aria-hidden': !0 }, $.get(w, this.config))),
         H.appendChild(
          y(
           'span',
         ...
         C.call(
          ...
          (D) => {
           D.key === 'ArrowLeft' &&
            (D.preventDefault(), D.stopPropagation(), c.call(this, 'home', !0));
          },
          !1,
         ),
         C.call(this, H, 'click', () => {
         ...
         j.appendChild(H),
         j.appendChild(y('div', { role: 'menu' })),
         k.appendChild(j),
         (this.elements.settings.buttons[w] = p),
     ...
     if (
      (f === 'pip' && x.pip && u.appendChild(t.call(this, 'pip', g)),
      f === 'airplay' && x.airplay && u.appendChild(t.call(this, 'airplay', g)),
      f === 'download')
     ) {
      const d = N({}, g, {
       element: 'a',
      ...
      !r.url(v) &&
       this.isEmbed &&
       N(d, { icon: `logo-${this.provider}`, label: this.provider }),
 ...
 inject() {
  ...
  let t = !0;
  r.function(this.config.controls) &&
   (this.config.controls = this.config.controls.call(this, i)),
   this.config.controls || (this.config.controls = []),
   r.element(this.config.controls) || r.string(this.config.controls)
  ...
  if (
   ...
   r.string(this.config.selectors.controls.container) &&
    (s = document.querySelector(this.config.selectors.controls.container)),
   r.element(s) || (s = this.elements.container),
   s[r.element(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
    'afterbegin',
    e,
   ),
   r.element(this.elements.controls) || h.findElements.call(this),
   !r.empty(this.elements.buttons))
  ) {
   const n = (a) => {
  ...
  if ((O.isEdge && Je(s), this.config.tooltips.controls)) {
   ...
   Array.from(o).forEach((c) => {
    S(c, this.config.classNames.hidden, !1),
     S(c, this.config.classNames.tooltip, !0);
   });
  }
 },
 setMediaMetadata() {
...
const E = {
  setup() {
   ...
   if (
    (r.element(this.elements.captions) ||
     ((this.elements.captions = y('div', q(this.config.selectors.captions))),
     this.elements.captions.setAttribute('dir', 'auto'),
     Kt(this.elements.captions, this.elements.wrapper)),
    O.isIE && window.URL)
   ) {
   ...
   if (
    (r.boolean(t) || ({ active: t } = this.config.captions),
  ...
  update() {
   const e = E.getTracks.call(this, !0),
    { active: i, language: t, meta: s, currentTrackNode: n } = this.captions,
    ...
    e
     ...
     .forEach((l) => {
      this.debug.log('Track added', l),
       ...
       C.call(this, l, 'cuechange', () => E.updateCues.call(this));
     }),
  ...
  toggle(e, i = !0) {
   ...
   if (n !== t) {
    if (
     ...
     return (
      (this.captions.language = l.language), void E.set.call(this, a.indexOf(l))
     );
    }
     ...
     if (e in t) {
      if (this.captions.currentTrack !== e) {
       ...
       (this.captions.currentTrackNode = s),
        h.updateSetting.call(this, 'captions'),
        i || ((this.captions.language = n), this.storage.set({ language: n })),
  ...
  findTrack(e, i = !1) {
   ...
   let a;
   return (
    e.every((l) => ((a = n.find((o) => o.language === l)), !a)),
    a || (i ? n[0] : void 0)
   );
  },
  getCurrentTrack() {
...
`);
 ...
 fe = { active: 'picture-in-picture', inactive: 'inline' },
...
class R {
 constructor(i) {
  m(this, 'onChange', () => {
   ...
   m(this, 'enter', () => {
    this.supported &&
     (O.isIos && this.player.config.fullscreen.iosNative
      ...
      : !R.nativeSupported || this.forceFallback
   ...
   (this.player.elements.fullscreen =
    ...
    Yt(this.player.elements.container, i.config.fullscreen.container)),
   C.call(
    this.player,
    document,
    this.prefix === 'ms'
   ...
   C.call(this.player, this.player.elements.container, 'dblclick', (t) => {
    (r.element(this.player.elements.controls) &&
 ...
 static get prefix() {
  ...
  return (
   ['webkit', 'moz', 'ms'].some(
    (t) =>
     !(
      !r.function(document[`${t}ExitFullscreen`]) &&
      !r.function(document[`${t}CancelFullScreen`])
     ) && ((i = t), !0),
   ),
   i
  );
 ...
 get supported() {
  return [
   ...
   this.player.isVideo,
   R.nativeSupported || this.player.config.fullscreen.fallback,
 ...
 get active() {
  ...
  if (!R.nativeSupported || this.forceFallback)
...
const P = {
 ...
 build() {
  ...
  r.element(this.elements.controls) ||
 ...
 setTitle() {
  ...
  if (
   (r.string(this.config.title) &&
    !r.empty(this.config.title) &&
    (e += `, ${this.config.title}`),
 ...
 migrateStyles() {
  Object.values({ ...this.media.style })
   .filter((e) => !r.empty(e) && r.string(e) && e.startsWith('--plyr'))
   .forEach((e) => {
...
class ci {
  ...
  m(this, 'firstTouch', () => {
   ...
   m(this, 'global', (t = !0) => {
    ...
    s.config.keyboard.global &&
     Z.call(s, window, 'keydown keyup', this.handleKey, t, !1),
     Z.call(s, document.body, 'click', this.toggleMenu, t),
     Me.call(s, document.body, 'touchstart', this.firstTouch);
   }),
   m(this, 'container', () => {
    const { player: t } = this,
     ...
     C.call(
      ...
      (c) => {
       ...
       ['touchstart', 'touchmove', 'mousemove'].includes(c.type) &&
        (P.toggleControls.call(t, !0), (g = t.touch ? 3e3 : 2e3)),
        clearTimeout(a.controls),
        (a.controls = setTimeout(() => P.toggleControls.call(t, !1), g));
      },
     );
    const l = () => {
      ...
      const [v, k] = Gt(),
       T = v / k > g / f;
      d
       ? ((c.style.width = T ? 'auto' : '100%'),
         (c.style.height = T ? '100%' : 'auto'))
       : ((c.style.maxWidth = T ? (k / f) * g + 'px' : null),
         (c.style.margin = T ? '0 auto' : null));
     },
     o = () => {
    ...
    C.call(t, n.container, 'enterfullscreen exitfullscreen', (c) => {
     ...
     u === n.container &&
      ((!t.isEmbed && r.empty(t.config.ratio)) ||
       (l(),
       (c.type === 'enterfullscreen' ? C : me).call(t, window, 'resize', o)));
    });
   }),
   m(this, 'media', () => {
    const { player: t } = this,
    ...
    C.call(t, t.media, n, (a) => {
     ...
     a.type === 'error' && (l = t.media.error),
      b.call(t, s.container, a.type, !0, l);
    });
   }),
   m(this, 'proxy', (t, s, n) => {
    const { player: a } = this,
    ...
    let o = !0;
    r.function(l) && (o = l.call(a, t)),
     o !== !1 && r.function(s) && s.call(a, t);
   }),
     ...
     this.bind(
      ...
      (a) => {
       [' ', 'Enter'].includes(a.key) &&
        (a.key !== 'Enter'
         ? (a.preventDefault(), a.stopPropagation(), h.toggleMenu.call(t, a))
     ...
     this.bind(
      ...
      (a) => {
       const l = a.currentTarget,
        o = 'play-on-seeked';
       if (r.keyboardEvent(a) && !['ArrowLeft', 'ArrowRight'].includes(a.key))
        return;
       t.lastSeekTime = Date.now();
       const c = l.hasAttribute(o),
        u = ['mouseup', 'touchend', 'keyup'].includes(a.type);
       c && u
        ? (l.removeAttribute(o), V(t.play()))
        : !u && t.playing && (l.setAttribute(o, ''), t.pause());
      },
     ),
     O.isIos)
    ) {
    ...
    this.bind(
     ...
     (a) => {
      ...
      r.empty(o) && (o = l.value),
       ...
       (t.currentTime = (o / l.max) * t.duration);
     },
     'seek',
    ),
     ...
     O.isWebKit &&
      Array.from(G.call(t, 'input[type="range"]')).forEach((a) => {
       this.bind(a, 'input', (l) => h.updateRangeFill.call(t, l.target));
      }),
     t.config.toggleInvert &&
      !r.element(s.display.duration) &&
      this.bind(s.display.currentTime, 'click', () => {
       t.currentTime !== 0 &&
        ((t.config.invertTime = !t.config.invertTime), h.timeUpdate.call(t));
      }),
     this.bind(
      s.inputs.volume,
      n,
     ...
     this.bind(s.controls, 'focusin', () => {
      ...
      S(s.controls, a.classNames.noTransition, !0),
      ...
      clearTimeout(l.controls),
       (l.controls = setTimeout(() => P.toggleControls.call(t, !1), o));
     }),
     this.bind(
      s.inputs.volume,
      'wheel',
 ...
 handleKey(i) {
  const { player: t } = this,
   { elements: s } = t,
   { key: n, type: a, altKey: l, ctrlKey: o, metaKey: c, shiftKey: u } = i,
   g = a === 'keydown',
   f = g && n === this.lastKey;
  if (!(l || o || c || u) && n) {
   if (g) {
    ...
    if (r.element(v)) {
     const { editable: k } = t.config.selectors,
      { seek: T } = s.inputs;
     if (
      (v !== T && K(v, k)) ||
      (i.key === ' ' && K(v, 'button, [role^="menuitem"]'))
     )
      return;
    }
    switch (
 ...
 e.exports = (function () {
  ...
  function l(d, v) {
   ...
   for (
    ...
    (T = d[p]), (M = n[T]) ? k(T, M) : (a[T] = a[T] || []).push(k);
  }
  function o(d, v) {
   if (d) {
    var k = a[d];
  ...
  function u(d, v, k, T) {
   ...
   (T = T || 0),
    /(^css!|\.css$)/.test(H)
     ? (((w = p.createElement('link')).rel = 'stylesheet'),
       (w.href = D),
       (M = 'hideFocus' in w) &&
        w.relList &&
        ((M = 0), (w.rel = 'preload'), (w.as = 'style')))
     : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(H)
       ? ((w = p.createElement('img')).src = D)
       : (((w = p.createElement('script')).src = d),
         (w.async = A === void 0 || A)),
    (w.onload =
     w.onerror =
     w.onbeforeload =
...
const Ce = {
 setup() {
  const e = this;
  S(e.elements.wrapper, e.config.classNames.embed, !0),
   (e.options.speed = e.config.speed.options),
   Y.call(e),
   r.object(window.Vimeo)
    ? Ce.ready.call(e)
    : xe(e.config.urls.vimeo.sdk)
       .then(() => {
        Ce.ready.call(e);
       })
       .catch((i) => {
 ...
 ready() {
  ...
  const c = ot({
   ...
   u = di(a),
   g = y('iframe'),
   f = Te(e.config.urls.vimeo.iframe, u, c);
  if (
   ...
   r.empty(s) || g.setAttribute('referrerPolicy', s),
   t || !i.customControls)
  )
   g.setAttribute('data-poster', e.poster), (e.media = ce(g, e.media));
  else {
   const p = y('div', {
    class: e.config.classNames.embedContainer,
    'data-poster': e.poster,
   });
   p.appendChild(g), (e.media = ce(p, e.media));
  }
  i.customControls ||
   ne(Te(e.config.urls.vimeo.api, f)).then((p) => {
    !r.empty(p) &&
     p.thumbnail_url &&
     P.setPoster.call(e, p.thumbnail_url).catch(() => {});
   }),
   ...
   (e.media.play = () => (Q.call(e, !0), e.embed.play())),
   (e.media.pause = () => (Q.call(e, !1), e.embed.pause())),
   (e.media.stop = () => {
  ...
  Object.defineProperty(e.media, 'currentTime', {
   get: () => d,
   set(p) {
    const { embed: A, media: L, paused: j, volume: H } = e,
     D = j && !A.hasPlayed;
    (L.seeking = !0),
     b.call(e, L, 'seeking'),
     Promise.resolve(D && A.setVolume(0))
      .then(() => A.setCurrentTime(p))
      .then(() => D && A.pause())
      .then(() => D && A.setVolume(H))
      .catch(() => {});
   },
  });
  ...
  Object.defineProperty(e.media, 'loop', {
   ...
   Object.defineProperty(e.media, 'currentSrc', { get: () => M }),
   ...
   e.embed.on('progress', (p) => {
    (e.media.buffered = p.percent),
     ...
     parseInt(p.percent, 10) === 1 && b.call(e, e.media, 'canplaythrough'),
     e.embed.getDuration().then((A) => {
      A !== e.media.duration &&
       ((e.media.duration = A), b.call(e, e.media, 'durationchange'));
     });
   }),
   e.embed.on('seeked', () => {
...
const oe = {
  setup() {
   if (
    (S(this.elements.wrapper, this.config.classNames.embed, !0),
    r.object(window.YT) && r.function(window.YT.Player))
   )
    oe.ready.call(this);
   else {
    const e = window.onYouTubeIframeAPIReady;
    (window.onYouTubeIframeAPIReady = () => {
     r.function(e) && e(), oe.ready.call(this);
    }),
  ...
  getTitle(e) {
   ne(Te(this.config.urls.youtube.api, e))
    .then((i) => {
     if (r.object(i)) {
      const { title: t, height: s, width: n } = i;
      (this.config.title = t),
       P.setTitle.call(this),
       (this.embed.ratio = st(n, s));
     }
     Y.call(this);
    })
    .catch(() => {
  ...
  ready() {
   ...
   if (((e.media = ce(a, e.media)), i.customControls)) {
   ...
   e.embed = new window.YT.Player(e.media, {
    ...
    events: {
     ...
     onReady(l) {
      ...
      (e.options.speed = g.filter((f) => e.config.speed.options.includes(f))),
       e.supported.ui &&
        i.customControls &&
   ...
   this.media
    ? (S(
      ...
      this.isVideo &&
       ...
       Ze(this.media, this.elements.wrapper),
...
class fi {
 constructor(i) {
  m(this, 'load', () => {
   this.enabled &&
    (r.object(window.google) && r.object(window.google.ima)
     ? this.ready()
     : xe(this.player.config.urls.googleIMA.sdk)
        .then(() => {
         this.ready();
        })
        .catch(() => {
   ...
   m(this, 'pollCountdown', (t = !1) => {
    ...
    this.countdownTimer = setInterval(() => {
     const s = pe(Math.max(this.manager.getRemainingTime(), 0)),
   ...
   m(this, 'onAdsManagerLoaded', (t) => {
    ...
    (s.restoreCustomPlaybackStateOnAdBreakComplete = !0),
     ...
     this.manager.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, (n) =>
      this.onAdError(n),
     ),
    ...
    switch (
     ...
     case google.ima.AdEvent.Type.LOADED:
      this.trigger('loaded'),
       ...
       n.isLinear() || ((n.width = s.offsetWidth), (n.height = s.offsetHeight));
      break;
     ...
     case google.ima.AdEvent.Type.LOG:
      a.adError &&
       this.player.debug.warn(`Non-fatal ad error: ${a.adError.getMessage()}`);
    }
   }),
   m(this, 'onAdError', (t) => {
   ...
   m(
    ...
    'on',
    (t, s) => (
     r.array(this.events[t]) || (this.events[t] = []),
   ...
   m(this, 'clearSafetyTimer', (t) => {
    r.nullOrUndefined(this.safetyTimer) ||
 ...
 get enabled() {
  ...
  return (
   ...
   this.player.isVideo &&
   i.enabled &&
   (!r.empty(i.publisherId) || r.url(i.tagUrl))
  );
 }
 get tagUrl() {
  const { config: i } = this;
  return r.url(i.tagUrl)
   ? i.tagUrl
   : `https://go.aniview.com/api/adserver6/vast/?${ot({ AV_PUBLISHERID: '58c25bb0073ef448b1087ad6', AV_CHANNELID: '5a0458dc28a06145e4519d21', AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: i.publisherId })}`;
 }
}
...
class Ae {
 constructor(i) {
  m(this, 'load', () => {
   ...
   m(this, 'startMove', (t) => {
    if (
     ...
     if (t.type === 'touchmove')
      ...
      (this.seekTime = this.player.media.duration * (l / 100)),
   ...
   m(this, 'startScrubbing', (t) => {
    (r.nullOrUndefined(t.button) || t.button === !1 || t.button === 0) &&
     ((this.mouseDown = !0),
     this.player.media.duration &&
   ...
   m(this, 'render', () => {
    ...
    (this.elements.thumb.time = y('span', {}, '00:00')),
     ...
     r.element(this.player.elements.progress) &&
   ...
   m(this, 'loadImage', (t = 0) => {
    ...
    if (
     ...
     this.showImage(this.currentImageElement, l, t, s, o, !1),
     ...
     (u.src = c),
      ...
      (u.onload = () => this.showImage(u, l, t, s, o, !0)),
      (this.loadingImage = u),
   ...
   m(this, 'showImage', (t, s, n, a, l, o = !0) => {
    this.player.debug.log(
     `Showing thumb: ${l}. num: ${a}. qual: ${n}. newimg: ${o}`,
    ),
          ...
          (d.src = f),
           (d.onload = () => {
            this.player.debug.log(`Preloaded thumb filename: ${u}`),
             this.loadedImages.includes(u) || this.loadedImages.push(u),
             n();
           });
         }
        }),
      ...
      l < this.thumbContainerHeight &&
       setTimeout(() => {
        this.showingThumbFilename === a &&
         (this.player.debug.log(`Showing higher quality thumb for: ${a}`),
         this.loadImage(t + 1));
       }, 300);
    }
   }),
   ...
   m(this, 'setScrubbingContainerSize', () => {
    const { width: t, height: s } = qe(this.thumbAspectRatio, {
 ...
 get thumbContainerHeight() {
  if (this.mouseDown) {
   const { height: i } = qe(this.thumbAspectRatio, {
    width: this.player.media.clientWidth,
    height: this.player.media.clientHeight,
   });
   return i;
     ...
     this.destroy.call(
      ...
      () => {
       (this.options.quality = []),
        F(this.media),
        (this.media = null),
        r.element(this.elements.container) &&
         this.elements.container.removeAttribute('class');
       const { sources: i, type: t } = e,
        [{ provider: s = B.html5, src: n }] = i,
        a = s === 'html5' ? t : 'div',
        l = s === 'html5' ? {} : { src: n };
       Object.assign(this, {
        provider: s,
        ...
        this.isHTML5 && Ee.insertElements.call(this, 'source', i),
        (this.config.title = e.title),
        ut.setup.call(this),
        this.isHTML5 &&
         Object.keys(e).includes('tracks') &&
         Ee.insertElements.call(this, 'track', e.tracks),
        (this.isHTML5 || (this.isEmbed && !this.supported.ui)) &&
         P.build.call(this),
        this.isHTML5 && this.media.load(),
        r.empty(e.previewThumbnails) ||
         ...
         this.config.previewThumbnails.enabled &&
          (this.previewThumbnails = new Ae(this))),
...
class te {
 constructor(i, t) {
  if (
   ...
   m(this, 'pause', () =>
    this.playing && r.function(this.media.pause) ? this.media.pause() : null,
   ),
   m(this, 'togglePlay', (o) =>
    (r.boolean(o) ? o : !this.playing) ? this.play() : this.pause(),
   ),
   m(this, 'stop', () => {
    this.isHTML5
     ? (this.pause(), this.restart())
     : r.function(this.media.stop) && this.media.stop();
   }),
   m(this, 'restart', () => {
    this.currentTime = 0;
   }),
   ...
   m(this, 'toggleControls', (o) => {
    if (this.supported.ui && !this.isAudio) {
     const c = ue(this.elements.container, this.config.classNames.hideControls),
      u = o === void 0 ? void 0 : !o,
      g = S(this.elements.container, this.config.classNames.hideControls, u);
     if (
      (g &&
       r.array(this.config.controls) &&
       this.config.controls.includes('settings') &&
       !r.empty(this.config.settings) &&
    ...
    const u = () => {
     (document.body.style.overflow = ''),
      ...
      c
       ...
       : (Xt.call(this),
         W.cancelRequests.call(this),
         ce(this.elements.original, this.elements.container),
         b.call(this, this.elements.original, 'destroyed', !0),
         r.function(o) && o.call(this.elements.original),
         (this.ready = !1),
         setTimeout(() => {
   ...
   (this.touch = x.touch),
   (this.media = i),
   r.string(this.media) && (this.media = document.querySelectorAll(this.media)),
   ((window.jQuery && this.media instanceof jQuery) ||
    r.nodeList(this.media) ||
    r.array(this.media)) &&
   ...
   (this.debug = new oi(this.config.debug)),
   this.debug.log('Config', this.config),
   this.debug.log('Support', x),
   r.nullOrUndefined(this.media) || !r.element(this.media))
  )
  ...
  switch (n) {
   case 'div':
    if (((a = this.media.querySelector('iframe')), r.element(a))) {
     if (
      ((l = lt(a.getAttribute('src'))),
      (this.provider = li(l.toString())),
      ...
      const o = ['1', 'true'];
      o.includes(l.searchParams.get('autoplay')) && (this.config.autoplay = !0),
       o.includes(l.searchParams.get('loop')) && (this.config.loop.active = !0),
       this.isYouTube
    ...
    if (r.empty(this.provider) || !Object.values(B).includes(this.provider))
  ...
  (this.supported = x.check(this.type, this.provider)),
   this.supported.api
    ? ((this.eventListeners = []),
      (this.listeners = new ci(this)),
      (this.storage = new ee(this)),
      (this.media.plyr = this),
      r.element(this.elements.container) ||
       ((this.elements.container = y('div')),
       Ze(this.media, this.elements.container)),
      ...
      this.config.ads.enabled && (this.ads = new fi(this)),
      this.isHTML5 &&
 ...
 set volume(i) {
  let t = i;
  r.string(t) && (t = Number(t)),
   r.number(t) || (t = this.storage.get('volume')),
   r.number(t) || ({ volume: t } = this.config),
   t > 1 && (t = 1),
   t < 0 && (t = 0),
   (this.config.volume = t),
   (this.media.volume = t),
   !r.empty(i) && this.muted && t > 0 && (this.muted = !1);
 }
 get volume() {
 ...
 set muted(i) {
  let t = i;
  r.boolean(t) || (t = this.storage.get('muted')),
   r.boolean(t) || (t = this.config.muted),
   (this.config.muted = t),
   (this.media.muted = t);
 }
 get muted() {
 ...
 set speed(i) {
  let t = null;
  r.number(i) && (t = i),
   r.number(t) || (t = this.storage.get('speed')),
   r.number(t) || (t = this.config.speed.selected);
 ...
 get ratio() {
  ...
  const i = he(Ne.call(this));
  return r.array(i) ? i.join(':') : i;
 }
 set ratio(i) {
  this.isVideo
   ? r.string(i) && it(i)
     ? ((this.config.ratio = he(i)), Y.call(this))
 ...
 set pip(i) {
  ...
  r.function(this.media.webkitSetPresentationMode) &&
   this.media.webkitSetPresentationMode(t ? fe.active : fe.inactive),
   r.function(this.media.requestPictureInPicture) &&
    (!this.pip && t
 ...
 get pip() {
  return x.pip
   ? r.empty(this.media.webkitPresentationMode)
     ...
     : this.media.webkitPresentationMode === fe.active
   : null;
 }
 ...
 static setup(i, t = {}) {
  ...
  return (
   ...
   r.empty(s) ? null : s.map((n) => new te(n, t))
  );
 }
}
te.defaults = zt(ct);
