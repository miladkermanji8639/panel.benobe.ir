import { c as Mn, g as Pn } from './_commonjsHelpers-BosuxZz1.js';
var $e = { exports: {} };
/**!
 * Sortable 1.15.2
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var et = tt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
   yt = tt(/Edge/i),
   _e = tt(/firefox/i),
   Et = tt(/safari/i) && !tt(/chrome/i) && !tt(/android/i),
   Ce = tt(/iP(ad|od|hone)/i),
   Oe = tt(/chrome/i) && tt(/android/i),
   Te = { capture: !1, passive: !1 };
  function y(o, t, e) {
   o.addEventListener(t, e, !et && Te);
  }
  function w(o, t, e) {
   o.removeEventListener(t, e, !et && Te);
  }
  function Ht(o, t) {
   if (t) {
  ...
  function z(o, t, e, n) {
   if (o) {
    ...
    do {
     if (
      (t != null &&
       (t[0] === '>' ? o.parentNode === e && Ht(o, t) : Ht(o, t))) ||
      (n && o === e)
     )
      return o;
     if (o === e) break;
    ...
    if (
     (o !== window && o.parentNode && o !== Z()
      ...
      : ((a = 0),
        ...
        (f = window.innerWidth)),
     (t || e) && o !== window && ((i = i || o.parentNode), !et))
    )
     do
      if (
       i &&
       ...
       (a -= g.top + parseInt(h(i, 'border-top-width'))),
        (l -= g.left + parseInt(h(i, 'border-left-width'))),
        (s = a + r.height),
        (u = l + r.width);
       break;
      }
  ...
  function re(o, t) {
   for (
    ...
    e && (e === p.ghost || h(e, 'display') === 'none' || (t && !Ht(e, t)));
  ...
  var gt = [],
   ue = { initializeByDefault: !0 },
   Dt = {
    mount: function (t) {
     for (var e in ue) ue.hasOwnProperty(e) && !(e in t) && (t[e] = ue[e]);
    ...
    pluginEvent: function (t, e, n) {
     ...
     gt.forEach(function (a) {
      e[a.pluginName] &&
       (e[a.pluginName][r] && e[a.pluginName][r](L({ sortable: e }, n)),
       e.options[a.pluginName] &&
        e[a.pluginName][t] &&
        e[a.pluginName][t](L({ sortable: e }, n)));
     });
    },
    initializePlugins: function (t, e, n, i) {
     gt.forEach(function (l) {
      ...
      if (!(!t.options[s] && !l.initializeByDefault)) {
       ...
       (u.sortable = t), (u.options = t.options), (t[s] = u), j(n, u.defaults);
      }
     });
     ...
     return (
      gt.forEach(function (i) {
       typeof i.eventProperties == 'function' &&
        j(n, i.eventProperties.call(e[i.pluginName], t));
      }),
      n
     );
    },
  ...
  function _t(o) {
   ...
   if (((t = t || (e && e[R])), !!t)) {
    ...
    var P = L(L({}, b), Dt.getEventProperties(n, t));
    for (var H in P) S[H] = P[H];
    e && e.dispatchEvent(S), M[$] && M[$].call(t, S);
   }
  }
  var dn = ['evt'],
   Y = function (t, e) {
  ...
  var c,
   ...
   $t = typeof document < 'u',
   qt = Ce,
   Ye = yt || et ? 'cssFloat' : 'float',
   hn = $t && !Oe && !Ce && 'draggable' in document.createElement('div'),
   Be = (function () {
    if ($t) {
     if (et) return !1;
    ...
    function e(r, a) {
     return function (l, s, u, d) {
      ...
      return (
       r === !0 ||
       (typeof r == 'string' && r === g) ||
       (r.join && r.indexOf(g) > -1)
      );
     };
    }
    var n = {},
     i = t.group;
    (!i || Bt(i) != 'object') && (i = { name: i }),
     (n.name = i.name),
  ...
  function p(o, t) {
   ...
   (this.el = o), (this.options = t = j({}, t)), (o[R] = this);
   var e = {
    group: null,
    sort: !0,
    disabled: !1,
  ...
  p.prototype = {
    ...
    if (t.cancelable) {
     ...
     if (
      ...
      !c &&
       ...
       ((s = z(s, i.draggable, n, !1)), !(s && s.animated) && Gt !== s))
     ) {
      if (((mt = I(s)), (Ct = I(s, i.draggable)), typeof d == 'function')) {
   ...
   _prepareDragStart: function (t, e, n) {
    ...
    if (n && !c && n.parentNode === r) {
     ...
     if (
      ...
      (ke = ct.clientX - u.left),
      (Xe = ct.clientY - u.top),
      (this._lastX = (e || t).clientX),
      (this._lastY = (e || t).clientY),
      (c.style['will-change'] = 'all'),
      (s = function () {
       if ((Y('delayEnded', i, { evt: t }), p.eventCanceled)) {
        i._onDrop();
        return;
       }
       i._disableDelayedDragEvents(),
        !_e && i.nativeDraggable && (c.draggable = !0),
   ...
   _triggerDragStart: function (t, e) {
    (e = e || (t.pointerType == 'touch' && t)),
     !this.nativeDraggable || e
      ...
      : (y(c, 'dragend', this), y(O, 'dragstart', this._onDragStart));
    try {
     document.selection
      ? Zt(function () {
   ...
   _emulateDragOver: function () {
    if (q) {
     ...
     for (
      var t = document.elementFromPoint(q.clientX, q.clientY), e = t;
      t &&
      t.shadowRoot &&
      ((t = t.shadowRoot.elementFromPoint(q.clientX, q.clientY)), t !== e);
   ...
   _appendGhost: function () {
    if (!m) {
     ...
     (m = c.cloneNode(!0)),
      ...
      h(m, 'height', e.height),
      h(m, 'opacity', '0.8'),
      h(m, 'position', qt ? 'absolute' : 'fixed'),
      h(m, 'zIndex', '100000'),
      ...
      h(
       m,
       'transform-origin',
       (ke / parseInt(m.style.width)) * 100 +
        '% ' +
        (Xe / parseInt(m.style.height)) * 100 +
        '%',
      );
    }
   },
   _onDragStart: function (t, e) {
    var n = this,
     i = t.dataTransfer,
     r = n.options;
    if ((Y('dragStart', this, { evt: t }), p.eventCanceled)) {
     this._onDrop();
     return;
    }
    Y('setupClone', this),
     p.eventCanceled ||
      ...
      (A.style['will-change'] = ''),
      this._hideClone(),
      T(A, this.options.chosenClass, !1),
      (p.clone = A)),
     (n.cloneId = Zt(function () {
      Y('clone', n),
       !p.eventCanceled &&
        (n.options.removeCloneOnHide || O.insertBefore(A, c),
        n._hideClone(),
   ...
   _onDragOver: function (t) {
      ...
      L(
       {
        ...
        target: n,
        completed: P,
        onMove: function (Ue, xn) {
         return Vt(O, e, c, i, Ue, C(Ue), t, xn);
        },
        changed: H,
       },
       Nn,
    ...
    function $() {
     M('dragOverAnimationCapture'),
      ...
      b !== g && g.captureAnimationState();
    }
    function P(Yt) {
     return (
      M('dragOverCompleted', { insertion: Yt }),
      Yt &&
       (d ? u._hideClone() : u._showClone(b),
       b !== g &&
        (T(c, F ? F.options.ghostClass : u.options.ghostClass, !1),
        T(c, l.ghostClass, !0)),
       F !== b && b !== p.active ? (F = b) : b === p.active && F && (F = null),
       g === b && (b._ignoreWhileAnimating = n),
       b.animateAll(function () {
        M('dragOverAnimationComplete'), (b._ignoreWhileAnimating = null);
       }),
       b !== g && (g.animateAll(), (g._ignoreWhileAnimating = null))),
      ((n === c && !c.animated) || (n === e && !n.animated)) && (bt = null),
      !l.dragoverBubble &&
       !t.rootEl &&
       n !== document &&
       (c.parentNode[R]._isOutsideThisEl(t.target), !Yt && ft(t)),
    ...
    if (
     ...
     u &&
      ...
      (d
       ? f || (a = N !== O)
       : F === this ||
         ((this.lastPutMode = Wt.checkPull(this, u, c, t)) &&
     ...
     if (a)
      return (
       ...
       this._hideClone(),
       M('revert'),
       p.eventCanceled || (ut ? O.insertBefore(c, ut) : O.appendChild(c)),
       P(!0)
      );
     var D = re(e, l.draggable);
     if (!D || (yn(t, E, this) && !D.animated)) {
      if (D === c) return P(!1);
      if (
       (D && e === t.target && (n = D),
       n && (r = C(n)),
       Vt(O, e, c, i, n, r, t, !!n) !== !1)
      )
       return (
        $(),
        D && D.nextSibling
      ...
      var Q = pt(e, 0, l, !0);
      if (Q === c) return P(!1);
      if (((n = Q), (r = C(n)), Vt(O, e, c, i, n, r, t, !1) !== !1))
       return $(), e.insertBefore(c, Q), (N = e), H(), P(!0);
     } else if (n.parentNode === e) {
      r = C(n);
      var J = 0,
       dt,
       Ft = c.parentNode !== e,
       K = !pn((c.animated && c.toRect) || i, (n.animated && n.toRect) || r, E),
       Rt = E ? 'top' : 'left',
       at = Ne(n, 'top', 'top') || Ne(c, 'top', 'top'),
       kt = at ? at.scrollTop : void 0;
      bt !== n && ((dt = r[Rt]), (At = !1), (jt = (!K && l.invertSwap) || Ft)),
       (J = En(
        t,
        n,
        r,
      ...
      if (J !== 0) {
       var ht = I(c);
       do (ht -= J), (nt = N.children[ht]);
       while (nt && (h(nt, 'display') === 'none' || nt === m));
      }
      if (J === 0 || nt === n) return P(!1);
      (bt = n), (Tt = J);
      var Xt = n.nextElementSibling,
       lt = !1;
      lt = J === 1;
      var ne = Vt(O, e, c, i, n, r, t, lt);
      if (ne !== !1)
       return (
        (ne === 1 || ne === -1) && (lt = ne === 1),
        (he = !0),
        ...
        lt && !Xt
         ? e.appendChild(c)
         : n.parentNode.insertBefore(c, lt ? Xt : n),
        at && Pe(at, 0, kt - at.scrollTop),
        (N = c.parentNode),
        dt !== void 0 && !jt && (zt = Math.abs(dt - C(n)[Rt])),
        H(),
        P(!0)
       );
     }
     if (e.contains(c)) return P(!1);
    }
    return !1;
   },
   ...
   _offMoveEvents: function () {
    w(document, 'mousemove', this._onTouchMove),
     ...
     w(document, 'dragover', ft),
     w(document, 'mousemove', ft),
     w(document, 'touchmove', ft);
   },
   ...
   _onDrop: function (t) {
    ...
    (vt = !1),
     ...
     this.nativeDraggable &&
      (w(document, 'drop', this), w(e, 'dragstart', this._onDragStart)),
     this._offMoveEvents(),
     this._offUpEvents(),
     ...
     t &&
      ...
      (O === N || (F && F.lastPutMode !== 'clone')) &&
       A &&
       A.parentNode &&
       A.parentNode.removeChild(A),
      c &&
       (this.nativeDraggable && w(c, 'dragend', this),
       pe(c),
       (c.style['will-change'] = ''),
       Ot &&
        !vt &&
        T(c, F ? F.options.ghostClass : this.options.ghostClass, !1),
       T(c, this.options.chosenClass, !1),
       X({
        sortable: this,
        name: 'unchoose',
        toEl: N,
       ...
       O !== N
        ? (G >= 0 &&
           (X({ rootEl: N, name: 'add', toEl: N, fromEl: O, originalEvent: t }),
           X({ sortable: this, name: 'remove', toEl: N, originalEvent: t }),
           X({ rootEl: N, name: 'sort', toEl: N, fromEl: O, originalEvent: t }),
           X({ sortable: this, name: 'sort', toEl: N, originalEvent: t })),
          F && F.save())
        : G !== mt &&
          G >= 0 &&
          (X({ sortable: this, name: 'update', toEl: N, originalEvent: t }),
          X({ sortable: this, name: 'sort', toEl: N, originalEvent: t })),
       p.active &&
        ((G == null || G === -1) && ((G = mt), (rt = Ct)),
        X({ sortable: this, name: 'end', toEl: N, originalEvent: t }),
        this.save()))),
     this._nulling();
   },
   _nulling: function () {
   ...
   toArray: function () {
    for (
     var t = [], e, n = this.el.children, i = 0, r = n.length, a = this.options;
     i < r;
     i++
    )
     (e = n[i]),
      z(e, a.draggable, this.el, !1) &&
       t.push(e.getAttribute(a.dataIdAttr) || Dn(e));
    return t;
   },
   sort: function (t, e) {
    var n = {},
   ...
   option: function (t, e) {
    ...
    var i = Dt.modifyOption(this, t, e);
   ...
   destroy: function () {
    ...
    (t[R] = null),
     ...
     this._onDrop(),
     this._disableDelayedDragEvents(),
     Lt.splice(Lt.indexOf(this.el), 1),
     (this.el = t = null);
   },
   _hideClone: function () {
    if (!it) {
     if ((Y('hideClone', this), p.eventCanceled)) return;
     h(A, 'display', 'none'),
   ...
   _showClone: function (t) {
    ...
    if (it) {
     if ((Y('showClone', this), p.eventCanceled)) return;
     c.parentNode == O && !this.options.group.revertClone
      ? O.insertBefore(A, c)
      : ut
        ? O.insertBefore(A, ut)
        : O.appendChild(A),
  ...
  function wn(o, t, e) {
   var n = C(pt(e.el, 0, e.options, !0)),
    i = Re(e.el, e.options, m),
    r = 10;
   return t
  ...
  function yn(o, t, e) {
   var n = C(re(e.el, e.options.draggable)),
    i = Re(e.el, e.options, m),
    r = 10;
   return t
  ...
  function En(o, t, e, n, i, r, a, l) {
   var s = n ? o.clientY : o.clientX,
    ...
    d = n ? e.top : e.left,
    f = n ? e.bottom : e.right,
    g = !1;
   if (!a) {
    if (l && zt < u * i) {
     if (
      (!At &&
       (Tt === 1 ? s > d + (u * r) / 2 : s < f - (u * r) / 2) &&
       (At = !0),
      At)
     )
      g = !0;
     else if (Tt === 1 ? s < d + zt : s > f - zt) return -Tt;
    } else if (s > d + (u * (1 - i)) / 2 && s < f - (u * (1 - i)) / 2)
     return Sn(t);
   }
   return (
    (g = g || a),
    g && (s < d + (u * r) / 2 || s > f - (u * r) / 2)
     ? s > d + u / 2
       ? 1
       : -1
     : 0
  ...
  $t &&
   y(document, 'touchmove', function (o) {
    (p.active || vt) && o.cancelable && o.preventDefault();
   }),
   (p.utils = {
    on: y,
    off: w,
   ...
   (p.mount = function () {
    ...
    t[0].constructor === Array && (t = t[0]),
     t.forEach(function (n) {
      ...
      n.utils && (p.utils = L(L({}, p.utils), n.utils)), Dt.mount(n);
     });
   }),
  ...
  function Cn() {
   ...
   return (
    (o.prototype = {
     ...
     nulling: function () {
      (Qt = me = It = ve = Nt = be = we = null), (x.length = 0);
     },
     ...
     _handleAutoScroll: function (e, n) {
      ...
      if (
       ((Qt = e), n || this.options.forceAutoScrollFallback || yt || et || Et)
      ) {
       ye(e, this.options, l, n);
       var s = ot(l, !0);
       ve &&
        (!Nt || r !== be || a !== we) &&
        (Nt && Le(),
        (Nt = setInterval(function () {
         var u = ot(document.elementFromPoint(r, a), !0);
         u !== s && ((s = u), Jt()), ye(e, i.options, u, n);
        }, 10)),
        (be = r),
        (we = a));
      } else {
       if (!this.options.bubbleScroll || ot(l, !0) === Z()) {
        Jt();
        return;
       }
       ye(e, this.options, ot(l, !1), !1);
      }
     },
    }),
    j(o, { pluginName: 'scroll', initializeByDefault: !0 })
   );
  }
  function Jt() {
       ...
       ? ((Q =
         ...
         (J =
          ...
          (K.overflowY === 'auto' ||
           K.overflowY === 'scroll' ||
           K.overflowY === 'visible')))
       : ((Q = H < dt && (K.overflowX === 'auto' || K.overflowX === 'scroll')),
         (J = D < Ft && (K.overflowY === 'auto' || K.overflowY === 'scroll')));
      var kt =
        Q &&
        (Math.abs(P - i) <= a && Rt + H < dt) - (Math.abs($ - i) <= a && !!Rt),
       nt =
        J &&
        (Math.abs(M - r) <= a && at + D < Ft) - (Math.abs(S - r) <= a && !!at);
      if (!x[f]) for (var ht = 0; ht <= f; ht++) x[ht] || (x[ht] = {});
      (x[f].vx != kt || x[f].vy != nt || x[f].el !== E) &&
       ((x[f].el = E),
       (x[f].vx = kt),
       (x[f].vy = nt),
       ...
       (kt != 0 || nt != 0) &&
        ...
        (x[f].pid = setInterval(
         function () {
          n && this.layer === 0 && p.active._onTouchMove(Qt);
          var Xt = x[this.layer].vy ? x[this.layer].vy * l : 0,
           lt = x[this.layer].vx ? x[this.layer].vx * l : 0;
          (typeof d == 'function' &&
           d.call(p.dragged.parentNode[R], lt, Xt, o, Qt, x[this.layer].el) !==
            'continue') ||
           Pe(x[this.layer].el, lt, Xt);
         }.bind({ layer: f }),
         24,
        )))),
       f++;
     } while (t.bubbleScroll && g !== s && (g = ot(g, !1)));
     ve = u;
    }
   }, 30),
   je = function (t) {
    ...
    (o.prototype = {
     ...
     dragOverValid: function (e) {
      ...
      if (a.options.swap) {
       ...
       if (i && i !== u) {
        var f = U;
        r(i) !== !1 ? (T(i, d.swapClass, !0), (U = i)) : (U = null),
         f && f !== U && T(f, d.swapClass, !1);
       }
       l(), n(!0), s();
      }
     },
    ...
    (o.prototype = {
     ...
     setupClone: function (e) {
      ...
      if (this.isMultiDrag) {
       for (var r = 0; r < v.length; r++)
        W.push(le(v[r])),
         (W[r].sortableIndex = v[r].sortableIndex),
         (W[r].draggable = !1),
         (W[r].style['will-change'] = ''),
         T(W[r], this.options.selectedClass, !1),
         v[r] === _ && T(W[r], this.options.chosenClass, !1);
       n._hideClone(), i();
      }
     },
     clone: function (e) {
     ...
     revert: function (e) {
      ...
      v.length > 1 &&
       (v.forEach(function (l) {
        r.addAnimationState({ target: l, rect: B ? C(l) : a }),
         se(l),
         (l.fromRect = a),
         n.removeAnimationState(l);
       }),
       (B = !1),
       In(!this.options.removeCloneOnHide, i));
     },
     dragOverCompleted: function (e) {
      var n = e.sortable,
       i = e.isOwner,
      ...
      if (r) {
       if (
        (i && a._hideClone(),
        (Mt = !1),
        u.animation && v.length > 1 && (B || (!i && !a.options.sort && !s)))
       ) {
        var d = C(_, !1, !0, !0);
        v.forEach(function (g) {
         g !== _ && (Fe(g, d), l.appendChild(g));
        }),
         (B = !0);
       }
       if (!i)
         ...
         a._showClone(n),
          a.options.animation &&
           ...
           W.forEach(function (g) {
            a.addAnimationState({ target: g, rect: Pt }),
             (g.fromRect = Pt),
     ...
     drop: function (e) {
      ...
      if (n) {
       ...
       if (!wt)
        if (
         (f.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(),
         T(_, f.selectedClass, !~v.indexOf(_)),
         ~v.indexOf(_))
        )
         v.splice(v.indexOf(_), 1),
          (xt = null),
          _t({
           sortable: a,
           rootEl: i,
         ...
         if (
          ...
          n.shiftKey && xt && a.el.contains(xt))
         ) {
          var E = I(xt),
           b = I(_);
          if (~E && ~b && E !== b) {
       ...
       if (wt && this.isMultiDrag) {
        if (((B = !1), (r[R].options.sort || r !== i) && v.length > 1)) {
         var $ = C(_),
          P = I(_, ':not(.' + this.options.selectedClass + ')');
         if (
          (!Mt && f.animation && (_.thisAnimationDuration = null),
           ...
           (f.animation &&
            ...
            v.forEach(function (D) {
             if (((D.thisAnimationDuration = null), D !== _)) {
              var Q = B ? C(D) : $;
              (D.fromRect = Q), d.addAnimationState({ target: D, rect: Q });
             }
            })),
           ee(),
           v.forEach(function (D) {
            g[P] ? r.insertBefore(D, g[P]) : r.appendChild(D), P++;
           }),
           s === I(_)))
         ) {
          var H = !1;
          v.forEach(function (D) {
           if (D.sortableIndex !== I(D)) {
            H = !0;
            return;
           }
          }),
     ...
     nullingGlobal: function () {
      (this.isMultiDrag = wt = !1), (W.length = 0);
     },
     ...
     _deselectMultiDrag: function (e) {
      if (
       ...
       for (; v.length; ) {
        var n = v[0];
        T(n, this.options.selectedClass, !1),
         v.shift(),
         _t({
     ...
     utils: {
      select: function (e) {
       ...
       !n ||
        !n.options.multiDrag ||
        ~v.indexOf(e) ||
        (V && V !== n && (V.multiDrag._deselectMultiDrag(), (V = n)),
        T(e, n.options.selectedClass, !0),
        v.push(e));
      },
      deselect: function (e) {
       var n = e.parentNode[R],
       ...
       !n ||
        !n.options.multiDrag ||
        !~i ||
        (T(e, n.options.selectedClass, !1), v.splice(i, 1));
      },
     },
     eventProperties: function () {
      var e = this,
      ...
      return (
       v.forEach(function (r) {
        ...
        B && r !== _
         ? (a = -1)
         : B
           ? (a = I(r, ':not(.' + e.options.selectedClass + ')'))
           : (a = I(r)),
         i.push({ multiDragElement: r, index: a });
       }),
       { items: Qe(v), clones: [].concat(W), oldIndicies: n, newIndicies: i }
      );
     },
     optionListeners: {
  ...
  return (
   p.mount(new Cn()), p.mount(Se, Ee), p.mount(new On()), p.mount(new An()), p
  );
 });
})($e);
var Fn = $e.exports;
