var V = (o, a) => () => (a || o((a = { exports: {} }).exports, a), a.exports);
var x = V((y, m) => {
 (function (o, a) {
  typeof y == 'object' && typeof m < 'u'
   ? (m.exports = a())
   : typeof define == 'function' && define.amd
     ...
     : ((o = typeof globalThis < 'u' ? globalThis : o || self),
       ...
       (o.FormValidation.plugins.Bootstrap5 = a()));
 })(void 0, function () {
  function o(t, n) {
   if (!(t instanceof n))
  ...
  function O(t) {
   ...
   return function () {
    ...
    if (n) {
     ...
     e = Reflect.construct(l, arguments, i);
  ...
  function k(t, n) {
   for (
    ;
    !Object.prototype.hasOwnProperty.call(t, n) && ((t = c(t)), t !== null);
    ...
    typeof Reflect < 'u' && Reflect.get
     ...
     : (p = function (n, r, l) {
        ...
        if (e) {
         ...
         return i.get ? i.get.call(arguments.length < 3 ? n : l) : i.value;
        }
       }),
    p.apply(this, arguments)
   );
  }
  var s = FormValidation.utils.classSet,
   f = FormValidation.utils.hasClass,
   ...
   P = (function (t) {
    ...
    function r(l) {
     ...
     return (
      ...
      (e.eleValidatedHandler = e.handleElementValidated.bind(h(e))),
      e
     );
    }
    return (
     g(r, [
      {
       key: 'install',
       value: function () {
        p(c(r.prototype), 'install', this).call(this),
      ...
      },
      {
       ...
       value: function (e) {
        ...
        if (
         (i === 'checkbox' || i === 'radio') &&
         e.elements.length > 1 &&
         f(e.element, 'form-check-input')
        ) {
         var u = e.element.parentElement;
         f(u, 'form-check') &&
          f(u, 'form-check-inline') &&
          s(u, { 'is-invalid': !e.valid, 'is-valid': e.valid });
        }
       },
      },
      {
       ...
       value: function (e) {
        ...
        f(i, 'input-group') &&
         ...
         e.element.nextElementSibling &&
          f(e.element.nextElementSibling, 'input-group-text') &&
          s(e.iconElement, { 'fv-plugins-icon-input-group': !0 }));
        var u = e.element.getAttribute('type');
        if (u === 'checkbox' || u === 'radio') {
         var v = i.parentElement;
         f(i, 'form-check')
          ? (s(e.iconElement, { 'fv-plugins-icon-check': !0 }),
            i.parentElement.insertBefore(e.iconElement, i.nextSibling))
          : f(i.parentElement, 'form-check') &&
            (s(e.iconElement, { 'fv-plugins-icon-check': !0 }),
            v.parentElement.insertBefore(e.iconElement, v.nextSibling));
        }
       },
      },
      {
       ...
       value: function (e) {
        ...
        var i = e.element.parentElement;
        if (f(i, 'input-group')) {
         i.appendChild(e.messageElement), s(i, { 'has-validation': !0 });
         return;
        }
        var u = e.element.getAttribute('type');
        (u === 'checkbox' || u === 'radio') &&
