import { c as lt, g as nt } from './_commonjsHelpers-BosuxZz1.js';
var U = { exports: {} };
/*!
 ...
 */ (function (C, it) {
 (function (y, g) {
  ...
  (M.prototype.bind = function (e, l) {
   typeof this.handlers[e] > 'u' && (this.handlers[e] = []),
    this.handlers[e].push(l),
    this.element.addEventListener(e, l, !1);
  }),
  ...
  function q(t, e, l, s, i) {
   ...
   var m = t.element;
   (t.reach[r] = null),
    m[o] < 1 && (t.reach[r] = 'start'),
    m[o] > t[a] - t[n] - 1 && (t.reach[r] = 'end'),
    e &&
     (m.dispatchEvent(D('ps-scroll-' + r)),
     e < 0
      ? m.dispatchEvent(D('ps-scroll-' + c))
      : e > 0 && m.dispatchEvent(D('ps-scroll-' + p)),
     s && $(t, r)),
    t.reach[r] &&
     (e || i) &&
     m.dispatchEvent(D('ps-' + r + '-reach-' + t.reach[r]));
  }
  function d(t) {
  ...
  function z(t) {
   return (
    T(t, 'input,[contenteditable]') ||
    T(t, 'select,[contenteditable]') ||
    T(t, 'textarea,[contenteditable]') ||
    T(t, 'button,[contenteditable]')
   );
  }
  function F(t) {
   var e = y(t);
  ...
  function L(t) {
   ...
   (t.containerWidth = Math.round(s.width)),
    ...
    e.contains(t.scrollbarXRail) ||
     (B(e, v.element.rail('x')).forEach(function (i) {
      return H(i);
     }),
     e.appendChild(t.scrollbarXRail)),
    e.contains(t.scrollbarYRail) ||
     (B(e, v.element.rail('y')).forEach(function (i) {
      return H(i);
     }),
    ...
    t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
     ? ((t.scrollbarXActive = !0),
       ...
       (t.scrollbarXWidth = _(
        t,
        d((t.railXWidth * t.containerWidth) / t.contentWidth),
       )),
       (t.scrollbarXLeft = d(
    ...
    t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
     ? ((t.scrollbarYActive = !0),
       ...
       (t.scrollbarYHeight = _(
        t,
        d((t.railYHeight * t.containerHeight) / t.contentHeight),
       )),
       (t.scrollbarYTop = d(
  ...
  function G(t, e) {
   ...
   e.isRtl
    ...
    e.isScrollbarXUsingBottom
     ? (l.bottom = e.scrollbarXBottom - s)
     : (l.top = e.scrollbarXTop + s),
    g(e.scrollbarXRail, l);
   var i = { top: s, height: e.railYHeight };
  ...
  function j(t, e) {
   var l = e[0],
    ...
    h = null;
   function b(u) {
    u.touches && u.touches[0] && (u[i] = u.touches[0].pageY),
     (m[r] = w + h * (u[i] - W)),
     O(t, c),
     L(t),
     u.stopPropagation(),
     u.type.startsWith('touch') &&
      u.changedTouches.length > 1 &&
      u.preventDefault();
   }
   function Y() {
    K(t, c),
     t[p].classList.remove(v.state.clicking),
     t.event.unbind(t.ownerDocument, 'mousemove', b);
   }
   function f(u, X) {
    (w = m[r]),
     X && u.touches && (u[i] = u.touches[0].pageY),
     (W = u[i]),
     (h = (t[s] - t[l]) / (t[a] - t[o])),
     X
      ? t.event.bind(t.ownerDocument, 'touchmove', b)
      : (t.event.bind(t.ownerDocument, 'mousemove', b),
        t.event.once(t.ownerDocument, 'mouseup', Y),
        u.preventDefault()),
     t[p].classList.add(v.state.clicking),
     u.stopPropagation();
   }
  ...
  function V(t) {
   ...
   t.event.bind(t.ownerDocument, 'keydown', function (a) {
    if (
     !(
      (a.isDefaultPrevented && a.isDefaultPrevented()) ||
      a.defaultPrevented
     ) &&
     !(!l() && !s())
    ) {
     ...
     (t.settings.suppressScrollX && o !== 0) ||
      (t.settings.suppressScrollY && r !== 0) ||
      ((e.scrollTop -= r),
      (e.scrollLeft += o),
      L(t),
      i(o, r) && a.preventDefault());
    }
   });
  }
  function Z(t) {
   ...
   function l(n, o) {
    var r = Math.floor(e.scrollTop),
     ...
     W;
    return (
     Math.abs(o) > Math.abs(n) ? (W = c || p) : (W = m || w),
     W ? !t.settings.wheelPropagation : !0
    );
   }
   function s(n) {
    var o = n.deltaX,
     r = -1 * n.deltaY;
    return (
     (typeof o > 'u' || typeof r > 'u') &&
      ((o = (-1 * n.wheelDeltaX) / 6), (r = n.wheelDeltaY / 6)),
     n.deltaMode && n.deltaMode === 1 && ((o *= 10), (r *= 10)),
     o !== o && r !== r && ((o = 0), (r = n.wheelDelta)),
     n.shiftKey ? [-r, -o] : [o, r]
    );
   }
   function i(n, o, r) {
    ...
    for (var c = n; c && c !== e; ) {
     ...
     if (r && p.overflowY.match(/(scroll|auto)/)) {
      ...
      if (m > 0 && ((c.scrollTop > 0 && r < 0) || (c.scrollTop < m && r > 0)))
       return !0;
     }
     if (o && p.overflowX.match(/(scroll|auto)/)) {
      var w = c.scrollWidth - c.clientWidth;
      if (w > 0 && ((c.scrollLeft > 0 && o < 0) || (c.scrollLeft < w && o > 0)))
       return !0;
     }
     c = c.parentNode;
    }
    ...
    if (!i(n.target, r, c)) {
     ...
     t.settings.useBothWheelAxes
      ? t.scrollbarYActive && !t.scrollbarXActive
        ? (c
           ? (e.scrollTop -= c * t.settings.wheelSpeed)
        ...
        : t.scrollbarXActive &&
          ...
          (r
           ...
           : (e.scrollLeft -= c * t.settings.wheelSpeed),
          (p = !0))
      : ((e.scrollTop -= c * t.settings.wheelSpeed),
        (e.scrollLeft += r * t.settings.wheelSpeed)),
      L(t),
      (p = p || l(r, c)),
      p && !n.ctrlKey && (n.stopPropagation(), n.preventDefault());
    }
   }
   typeof window.onwheel < 'u'
    ? t.event.bind(e, 'wheel', a)
    : typeof window.onmousewheel < 'u' && t.event.bind(e, 'mousewheel', a);
  }
  function tt(t) {
   ...
   function l(h, b) {
    ...
    if (X > u) {
     if (
      (b < 0 && Y === t.contentHeight - t.containerHeight) ||
      (b > 0 && Y === 0)
     )
      return window.scrollY === 0 && b > 0 && S.isChrome;
    } else if (
     u > X &&
     ((h < 0 && f === t.contentWidth - t.containerWidth) || (h > 0 && f === 0))
    )
     return !0;
    return !0;
   }
   ...
   function m(h, b, Y) {
    ...
    for (var f = h; f && f !== e; ) {
     ...
     if (Y && u.overflowY.match(/(scroll|auto)/)) {
      ...
      if (X > 0 && ((f.scrollTop > 0 && Y < 0) || (f.scrollTop < X && Y > 0)))
       return !0;
     }
     if (b && u.overflowX.match(/(scroll|auto)/)) {
      var E = f.scrollWidth - f.clientWidth;
      if (E > 0 && ((f.scrollLeft > 0 && b < 0) || (f.scrollLeft < E && b > 0)))
       return !0;
     }
     f = f.parentNode;
    }
   ...
   function w(h) {
    if (c(h)) {
     ...
     var X = new Date().getTime(),
      E = X - a;
     E > 0 && ((n.x = f / E), (n.y = u / E), (a = X)),
      l(f, u) && h.preventDefault();
    }
   }
   function W() {
    t.settings.swipeEasing &&
     ...
     (o = setInterval(function () {
      ...
      if (Math.abs(n.x) < 0.01 && Math.abs(n.y) < 0.01) {
       clearInterval(o);
       return;
      }
      if (!t.element) {
      ...
      s(n.x * 30, n.y * 30), (n.x *= 0.8), (n.y *= 0.8);
     }, 10)));
   }
   S.supportsTouch
  ...
  var et = function () {
   ...
   rt = { 'click-rail': J, 'drag-thumb': Q, keyboard: V, wheel: Z, touch: tt },
   A = function (e, l) {
    var s = this;
    if (
     (l === void 0 && (l = {}),
    ...
    (this.isRtl = y(e).direction === 'rtl'),
     this.isRtl === !0 && e.classList.add(v.rtl),
    ...
    (this.scrollbarXBottom = parseInt(o.bottom, 10)),
     isNaN(this.scrollbarXBottom)
      ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = d(o.top)))
      : (this.isScrollbarXUsingBottom = !0),
     (this.railBorderXWidth = d(o.borderLeftWidth) + d(o.borderRightWidth)),
     g(this.scrollbarXRail, { display: 'block' }),
     (this.railXMarginWidth = d(o.marginLeft) + d(o.marginRight)),
    ...
    (this.scrollbarYRight = parseInt(r.right, 10)),
     isNaN(this.scrollbarYRight)
      ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = d(r.left)))
      : (this.isScrollbarYUsingRight = !0),
     (this.scrollbarYOuterWidth = this.isRtl ? F(this.scrollbarY) : null),
     (this.railBorderYWidth = d(r.borderTopWidth) + d(r.borderBottomWidth)),
     g(this.scrollbarYRail, { display: 'block' }),
     (this.railYMarginHeight = d(r.marginTop) + d(r.marginBottom)),
   ...
   (A.prototype.update = function () {
    this.isAlive &&
     ...
     (this.railXMarginWidth =
      d(y(this.scrollbarXRail).marginLeft) +
      d(y(this.scrollbarXRail).marginRight)),
     (this.railYMarginHeight =
      d(y(this.scrollbarYRail).marginTop) +
      d(y(this.scrollbarYRail).marginBottom)),
