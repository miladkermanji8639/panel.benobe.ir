  ...
  typeof p == 'object' && typeof l < 'u'
   ...
   : typeof define == 'function' && define.amd
     ...
     : ((o = typeof globalThis < 'u' ? globalThis : o || self),
       ...
       (o.FormValidation.plugins.Shoelace = i()));
 })(void 0, function () {
  function o(e, t) {
   if (!(e instanceof t))
  ...
  function b(e) {
   ...
   return function () {
    ...
    if (t) {
     ...
     f = Reflect.construct(r, arguments, u);
     ...
     y(n, [
      {
       key: 'onIconPlaced',
       value: function (f) {
        var u = f.element.parentElement,
         s = f.element.getAttribute('type');
        (s === 'checkbox' || s === 'radio') &&
         (_(f.iconElement, { 'fv-plugins-icon-check': !0 }),
         u.tagName === 'LABEL' &&
          u.parentElement.insertBefore(f.iconElement, u.nextSibling));
       },
      },
     ]),
     n
