var g = (i, c) => () => (c || i((c = { exports: {} }).exports, c), c.exports);
var w = g((h, d) => {
 (function (i, c) {
  typeof h == 'object' && typeof d < 'u'
   ...
   : typeof define == 'function' && define.amd
     ...
     : ((i = typeof globalThis < 'u' ? globalThis : i || self),
       ...
       (i.FormValidation.plugins.Recaptcha3Token = c()));
 })(void 0, function () {
  function i(e, t) {
   if (!(e instanceof t))
   ...
   p = (function (e) {
    ...
    function o(r) {
     ...
     return (
      ...
      (n.onValidHandler = n.onFormValid.bind(s(n))),
      n
     );
    }
    return (
     y(o, [
      {
       ...
       value: function () {
        ...
        var n =
         typeof window[o.LOADED_CALLBACK] > 'u'
          ? function () {}
      ...
      },
      {
       ...
       value: function () {
        ...
        var n = this.getScript(),
         u = [].slice.call(
          document.body.querySelectorAll('script[src="'.concat(n, '"]')),
         );
      ...
      },
      {
       ...
       value: function () {
        ...
        window.grecaptcha
         ...
         .then(function (u) {
          n.hiddenTokenEle.setAttribute('name', n.opts.hiddenTokenName),
           (n.hiddenTokenEle.value = u);
          var a = n.core.getFormElement();
          a instanceof HTMLFormElement && a.submit();
         });
       },
      },
      {
       key: 'getScript',
       value: function () {
        var n = this.opts.language ? '&hl='.concat(this.opts.language) : '';
        return (
  ...
  return (p.LOADED_CALLBACK = '___reCaptcha3Loaded___'), p;
 });
});
export default w();
