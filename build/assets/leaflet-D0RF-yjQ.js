import { c as Vo, g as qo } from './_commonjsHelpers-BosuxZz1.js';
var Ke = { exports: {} };
/* @preserve
 ...
 */ (function (mn, pn) {
 (function (l, ue) {
  ...
  var de = window.requestAnimationFrame || fe('RequestAnimationFrame') || ei,
   ii =
    window.cancelAnimationFrame ||
    fe('CancelAnimationFrame') ||
    fe('CancelRequestAnimationFrame') ||
    function (t) {
     window.clearTimeout(t);
    };
  function D(t, e, i) {
   if (i && de === ei) t.call(e);
   else return de.call(window, C(t, e));
  }
  function G(t) {
   t && ii.call(window, t);
  }
  ...
  (it.extend = function (t) {
   ...
   return (
    ...
    delete n.includes,
    n.options &&
     ((n.options = i.options ? Wt(i.options) : {}), b(n.options, t.options)),
    (n._initHooks = []),
  ...
  H.prototype = {
   ...
   pad: function (t) {
    ...
    return new H(new T(e.lat - n, e.lng - o), new T(i.lat + n, i.lng + o));
   },
   getCenter: function () {
    return new T(
  ...
  var nt = {
    ...
    wrapLatLng: function (t) {
     var e = this.wrapLng ? Mt(t.lng, this.wrapLng, !0) : t.lng,
      i = this.wrapLat ? Mt(t.lat, this.wrapLat, !0) : t.lat,
      n = t.alt;
     return new T(i, e, n);
    },
  ...
  var ve = document.documentElement.style,
   Gt = 'ActiveXObject' in window,
   xn = Gt && !document.addEventListener,
   ai = 'msLaunchUri' in navigator && !('documentMode' in document),
   ge = $('webkit'),
   hi = $('android'),
   ui = $('android 2') || $('android 3'),
   Pn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
   Ln = hi && $('Google') && Pn < 537 && !('AudioNode' in window),
   ye = !!window.opera,
   li = !ai && $('chrome'),
   ci = $('gecko') && !ge && !ye && !Gt,
   Tn = !li && $('safari'),
   fi = $('phantom'),
   di = 'OTransition' in ve,
   bn = navigator.platform.indexOf('Win') === 0,
   _i = Gt && 'transition' in ve,
   we =
    'WebKitCSSMatrix' in window && 'm11' in new window.WebKitCSSMatrix() && !ui,
   mi = 'MozPerspective' in ve,
   Mn = !window.L_DISABLE_3D && (_i || we || mi) && !di && !fi,
   ...
   xe = !!(document.createElementNS && si('svg').createSVGRect),
   An =
    !!xe &&
    (function () {
  ...
  var f = {
   ...
   Pe = { touchstart: yi, touchmove: wi, touchend: xi, touchcancel: Pi },
   Li = { touchstart: Gn, touchmove: Vt, touchend: Vt, touchcancel: Vt },
   vt = {},
   Ti = !1;
  function Dn(t, e, i) {
   return (
    e === 'touchstart' && Un(),
    Li[e]
     ? ((i = Li[e].bind(this, i)), t.addEventListener(Pe[e], i, !1), i)
  ...
  function Fn(t, e, i) {
   ...
   t.removeEventListener(Pe[e], i, !1);
  }
  function Hn(t) {
   vt[t.pointerId] = t;
  }
  ...
  function Vt(t, e) {
   if (e.pointerType !== (e.MSPOINTER_TYPE_MOUSE || 'mouse')) {
    e.touches = [];
    for (var i in vt) e.touches.push(vt[i]);
    (e.changedTouches = [e]), t(e);
   }
  }
  function Gn(t, e) {
   e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && N(e),
    Vt(t, e);
  }
  function Vn(t) {
   var e = {},
  ...
  var Le = Kt([
   ...
   Mi =
    kt === 'webkitTransition' || kt === 'OTransition'
     ? kt + 'End'
     : 'transitionend';
  function Ci(t) {
  ...
  function v(t, e) {
   if (t.classList !== void 0)
    for (var i = ct(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
   else if (!Te(t, e)) {
    var s = jt(t);
    be(t, (s ? s + ' ' : '') + e);
   }
  ...
  if ('onselectstart' in document)
   ...
   (Zt = function () {
    ...
    (Ot = function () {
     It && ((document.documentElement.style[It] = Me), (Me = void 0));
    });
  }
  function Ce() {
  ...
  function p(t, e, i, n) {
   if (e && typeof e == 'object') for (var o in e) Oe(t, o, e[o], i);
   else {
    e = ct(e);
  ...
  function M(t, e, i, n) {
   if (arguments.length === 1) zi(t), delete t[Q];
   else if (e && typeof e == 'object') for (var o in e) Ie(t, o, e[o], i);
   else if (((e = ct(e)), arguments.length === 2))
    zi(t, function (a) {
     return ce(e, a) !== -1;
    });
   else for (var s = 0, r = e.length; s < r; s++) Ie(t, e[s], i, n);
   return this;
  }
  function zi(t, e) {
   for (var i in t[Q]) {
    var n = i.split(/\d/)[0];
    (!e || e(n)) && Ie(t, n, null, null, i);
   }
  }
  var Ze = {
  ...
  function Ae(t) {
   return Oe(t, 'wheel', _t), this;
  }
  function At(t) {
   return (
    p(t, 'mousedown touchstart dblclick contextmenu', _t),
   ...
   w = Ct.extend({
    ...
    initialize: function (t, e) {
     (e = S(this, e)),
      ...
      e.center &&
       e.zoom !== void 0 &&
       this.setView(y(e.center), e.zoom, { reset: !0 }),
      this.callInitHooks(),
      (this._zoomAnimated =
       kt && f.any3d && !f.mobileOpera && this.options.zoomAnimation),
      this._zoomAnimated &&
    ...
    flyTo: function (t, e, i) {
     ...
     function g(A) {
      var he = A ? -1 : 1,
       Ho = A ? h : a,
       Wo = h * h - a * a + he * d * d * u * u,
       Uo = 2 * Ho * d * u,
       je = Wo / Uo,
       _n = Math.sqrt(je * je + 1) - je,
       Go = _n < 1e-9 ? -18 : Math.log(_n);
      return Go;
     }
     function R(A) {
     ...
     var Do = Date.now(),
      fn = (g(1) - W) / c,
      Fo = i.duration ? 1e3 * i.duration : 1e3 * fn * 0.8;
     function dn() {
      var A = (Date.now() - Do) / Fo,
       he = Ro(A) * fn;
      A <= 1
       ? ((this._flyToFrame = D(dn, this)),
         this._move(
          this.unproject(n.add(o.subtract(n).multiplyBy(No(he) / u)), r),
          this.getScaleZoom(a / bt(he), r),
          { flyTo: !0 },
         ))
    ...
    locate: function (t) {
     ...
     var e = C(this._handleGeolocationResponse, this),
    ...
    _findEventTargets: function (t, e) {
     for (
      ...
      if (
       (n && n.listens(e, !0) && ((o && !Be(s, t)) || (i.push(n), o))) ||
       s === this._container
      )
       break;
      s = s.parentNode;
    ...
    _handleDOMEvent: function (t) {
     ...
     if (
      ...
      var i = t.type;
      i === 'mousedown' && ke(e), this._fireDOMEvent(t, i);
     }
    },
  ...
  var Ii = Y.extend({
    ...
    _initLayout: function () {
     ...
     e.setAttribute('aria-haspopup', !0), At(e), Ae(e);
  ...
  w.mergeOptions({ zoomControl: !0 }),
   w.addInitHook(function () {
    this.options.zoomControl &&
     ((this.zoomControl = new Ne()), this.addControl(this.zoomControl));
   });
  var eo = function (t) {
    return new Ne(t);
   },
  ...
  w.mergeOptions({ attributionControl: !0 }),
   w.addInitHook(function () {
    this.options.attributionControl && new Re().addTo(this);
   });
  var oo = function (t) {
   return new Re(t);
  };
  ...
  var so = { Events: U },
   ...
   ut = Ct.extend({
    ...
    disable: function () {
     this._enabled &&
      (ut._dragging === this && this.finishDrag(!0),
      M(this._dragStartTarget, Bi, this._onDown, this),
      (this._enabled = !1),
      (this._moved = !1));
    },
    _onDown: function (t) {
     if (
      this._enabled &&
      ((this._moved = !1), !Te(this._element, 'leaflet-zoom-anim'))
     ) {
      ...
      if (
       ...
       (this._startPoint = new m(e.clientX, e.clientY)),
        (this._startPos = dt(this._element)),
  ...
  function Ni(t, e, i) {
   var n,
    ...
    d,
    g;
   for (s = 0, c = t.length; s < c; s++) t[s]._code = pt(t[s], e);
   for (a = 0; a < 4; a++) {
    for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
     (h = t[s]),
      ...
      h._code & d
       ? u._code & d ||
         ((g = Jt(u, h, d, e, i)), (g._code = pt(g, e)), n.push(g))
       : (u._code & d &&
          ((g = Jt(u, h, d, e, i)), (g._code = pt(g, e)), n.push(g)),
         n.push(h));
    t = n;
  ...
  function Ri(t, e) {
   ...
   for (a = h = u = 0, i = 0, n = B - 1; i < B; n = i++)
    (o = j[i]),
     ...
     (a += r * 3);
   a === 0 ? (c = j[0]) : (c = [h / a, u / a]);
   var bt = e.unproject(_(c));
   return y([bt.lat + d.lat, bt.lng + d.lng]);
  }
  function De(t) {
  ...
  function Fe(t, e, i, n, o) {
   var s = 0,
    ...
    h;
   for (a = n + 1; a <= o - 1; a++)
    (h = Nt(t[a], t[n], t[o], !0)), h > s && ((r = a), (s = h));
   s > i && ((e[r] = 1), Fe(t, e, i, n, r), Fe(t, e, i, r, o));
  }
  function uo(t, e) {
  ...
  var co = {
   ...
   fo = { __proto__: null, LonLat: He, Mercator: We, SphericalMercator: _e },
   _o = b({}, ht, {
    code: 'EPSG:3395',
    projection: We,
    transformation: (function () {
  ...
  var wt = X.extend({
   ...
   xt = it.extend({
    ...
    _getIconUrl: function (t) {
     return (
      (f.retina && this.options[t + 'RetinaUrl']) || this.options[t + 'Url']
     );
    },
   });
  function go(t) {
  ...
  var Rt = xt.extend({
    ...
    _getIconUrl: function (t) {
     return (
      typeof Rt.imagePath != 'string' &&
       (Rt.imagePath = this._detectIconPath()),
      (this.options.imagePath || Rt.imagePath) +
       xt.prototype._getIconUrl.call(this, t)
     );
    },
   ...
   qi = tt.extend({
    ...
    addHooks: function () {
     ...
     this._draggable || (this._draggable = new ut(t, t, !0)),
      this._draggable
       .on(
        {
    ...
    _removeIcon: function () {
     this.options.riseOnHover &&
      ...
      this.options.autoPanOnFocus &&
       M(this._icon, 'focus', this._panOnFocus, this),
      k(this._icon),
  ...
  var lt = X.extend({
   ...
   Qt = lt.extend({
    ...
    initialize: function (t, e) {
     S(this, e), (this._latlng = y(t)), (this._radius = this.options.radius);
    },
    setLatLng: function (t) {
     var e = this._latlng;
     return (
  ...
  var st = lt.extend({
   ...
   closestLayerPoint: function (t) {
    for (
     var e = 1 / 0, i = null, n = Nt, o, s, r = 0, a = this._parts.length;
     r < a;
     r++
    )
   ...
   _containsPoint: function (t, e) {
    ...
    for (i = 0, s = this._parts.length; i < s; i++)
     for (a = this._parts[i], n = 0, r = a.length, o = r - 1; n < r; o = n++)
      if (!(!e && n === 0) && Fi(t, a[o], a[n]) <= h) return !0;
    return !1;
   },
  });
  function Po(t, e) {
  ...
  var Pt = st.extend({
   ...
   _convertLatLngs: function (t) {
    var e = st.prototype._convertLatLngs.call(this, t),
     i = e.length;
    return i >= 2 && e[0] instanceof T && e[0].equals(e[i - 1]) && e.pop(), e;
   },
   _setLatLngs: function (t) {
    st.prototype._setLatLngs.call(this, t),
  ...
  function te(t, e) {
   ...
   switch (i.type) {
    ...
    case 'MultiLineString':
     return (h = ee(n, i.type === 'LineString' ? 0 : 1, r)), new st(h, e);
    case 'Polygon':
    case 'MultiPolygon':
     return (h = ee(n, i.type === 'Polygon' ? 1 : 2, r)), new Pt(h, e);
  ...
  function ie(t, e, i, n) {
   for (var o = [], s = 0, r = t.length; s < r; s++)
    o.push(e ? ie(t[s], q(t[s]) ? 0 : e - 1, i, n) : Ve(t[s], n));
   return !e && i && o.length > 0 && o.push(o[0].slice()), o;
  }
  function Lt(t, e) {
   return t.feature ? b({}, t.feature, { geometry: e }) : ne(e);
  }
  function ne(t) {
  ...
  var qe = {
   toGeoJSON: function (t) {
    return Lt(this, { type: 'Point', coordinates: Ve(this.getLatLng(), t) });
   },
  };
  $t.include(qe),
   Ue.include(qe),
   ...
   Pt.include({
    toGeoJSON: function (t) {
     ...
     return (
      e || (n = [n]),
      Lt(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: n })
     );
    },
   }),
   wt.include({
    toMultiPoint: function (t) {
     ...
     return (
      ...
      Lt(this, { type: 'MultiPoint', coordinates: e })
     );
    },
    toGeoJSON: function (t) {
     var e =
  ...
  var To = Ki,
   oe = X.extend({
    ...
    initialize: function (t, e, i) {
     (this._url = t), (this._bounds = O(e)), S(this, i);
    },
    onAdd: function () {
     this._image ||
    ...
    _initImage: function () {
     ...
     if (
      ...
      (e.onselectstart = E),
      (e.onmousemove = E),
      (e.onload = C(this.fire, this, 'load')),
      (e.onerror = C(this._overlayOnError, this, 'error')),
      (this.options.crossOrigin || this.options.crossOrigin === '') &&
       (e.crossOrigin =
        this.options.crossOrigin === !0 ? '' : this.options.crossOrigin),
   ...
   Yi = oe.extend({
    ...
    _initImage: function () {
     ...
     if (
      ...
      (e.onselectstart = E),
      (e.onmousemove = E),
      (e.onloadeddata = C(this.fire, this, 'load')),
      t)
     ) {
      for (
  ...
  var et = X.extend({
   ...
   initialize: function (t, e) {
    t && (t instanceof T || K(t))
     ? ((this._latlng = y(t)), S(this, e))
   ...
   onRemove: function (t) {
    t._fadeAnimated
     ? (V(this._container, 0),
       (this._removeTimeout = setTimeout(C(k, void 0, this._container), 200)))
     : k(this._container),
     this.options.interactive &&
  ...
  var se = et.extend({
    ...
    openOn: function (t) {
     return (
      ...
      (t._popup = this),
      et.prototype.openOn.call(this, t)
     );
    },
    onAdd: function (t) {
     et.prototype.onAdd.call(this, t),
      t.fire('popupopen', { popup: this }),
      this._source &&
       (this._source.fire('popupopen', { popup: this }, !0),
       this._source instanceof lt || this._source.on('preclick', _t));
    },
    onRemove: function (t) {
     et.prototype.onRemove.call(this, t),
      t.fire('popupclose', { popup: this }),
      this._source &&
       (this._source.fire('popupclose', { popup: this }, !0),
       this._source instanceof lt || this._source.off('preclick', _t));
    },
    getEvents: function () {
  ...
  var Dt = X.extend({
   ...
   bringToFront: function () {
    return (
     this._map && (gt(this._container), this._setAutoZIndex(Math.max)), this
    );
   },
   bringToBack: function () {
    return (
     this._map && (yt(this._container), this._setAutoZIndex(Math.min)), this
    );
   },
   getContainer: function () {
    return this._container;
   ...
   _updateOpacity: function () {
    if (this._map && !f.ielt9) {
     ...
     i && !this._noPrune && this._pruneTiles(),
      e &&
       (G(this._fadeFrame), (this._fadeFrame = D(this._updateOpacity, this)));
    }
   },
   _onOpaqueTile: E,
   ...
   _update: function (t) {
    ...
    if (e) {
     ...
     if ((t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0)) {
      ...
      if (
       (r.sort(function (W, bt) {
        return W.distanceTo(s) - bt.distanceTo(s);
       }),
       r.length !== 0)
      ) {
   ...
   _addTile: function (t, e) {
    ...
    this._initTile(o),
     this.createTile.length < 2 && D(C(this._tileReady, this, t, null, o)),
     I(o, i),
  ...
  var Tt = Dt.extend({
   ...
   createTile: function (t, e) {
    ...
    return (
     p(i, 'load', C(this._tileOnLoad, this, e, i)),
     p(i, 'error', C(this._tileOnError, this, e, i)),
     (this.options.crossOrigin || this.options.crossOrigin === '') &&
      (i.crossOrigin =
       this.options.crossOrigin === !0 ? '' : this.options.crossOrigin),
   ...
   getTileUrl: function (t) {
    ...
    return Qe(this._url, b(e, this.options));
   },
   _tileOnLoad: function (t, e) {
    f.ielt9 ? setTimeout(C(t, this, null, e), 0) : t(null, e);
   },
   ...
   _removeTile: function (t) {
    ...
    if (e)
     return (
      e.el.setAttribute('src', Ut), Dt.prototype._removeTile.call(this, t)
     );
   },
   _tileReady: function (t, e, i) {
    if (!(!this._map || (i && i.getAttribute('src') === Ut)))
     return Dt.prototype._tileReady.call(this, t, e, i);
   },
  });
  function $i(t, e) {
   return new Tt(t, e);
  ...
  var Qi = Tt.extend({
   ...
   onAdd: function (t) {
    ...
    (this.wmsParams[e] = this._crs.code), Tt.prototype.onAdd.call(this, t);
   },
   getTileUrl: function (t) {
    var e = this._tileCoordsToNwSe(t),
     i = this._crs,
  ...
  var at = X.extend({
   ...
   tn = at.extend({
    ...
    _onMouseMove: function (t) {
     if (
      !(!this._map || this._map.dragging.moving() || this._map._animatingZoom)
     ) {
   ...
   Oo = {
    ...
    _update: function () {
     this._map._animatingZoom ||
      (at.prototype._update.call(this), this.fire('update'));
    },
    _initPath: function (t) {
  ...
  (Ht.create = ae),
   (Ht.pointsToPath = ri),
   (rt.geometryToLayer = te),
   (rt.coordsToLatLng = Ge),
   (rt.coordsToLatLngs = ee),
   (rt.latLngToCoords = Ve),
   (rt.latLngsToCoords = ie),
   (rt.getFeature = Lt),
   (rt.asFeature = ne),
  ...
  w.addInitHook('addHandler', 'boxZoom', sn),
   w.mergeOptions({ doubleClickZoom: !0 });
  var rn = tt.extend({
   addHooks: function () {
  ...
  var an = tt.extend({
   addHooks: function () {
    if (!this._draggable) {
     var t = this._map;
     (this._draggable = new ut(t._mapPane, t._container)),
      this._draggable.on(
       {
        dragstart: this._onDragStart,
        drag: this._onDrag,
  ...
  var un = tt.extend({
   ...
   _onWheelScroll: function (t) {
    ...
    clearTimeout(this._timer),
     (this._timer = setTimeout(C(this._performZoom, this), n)),
     mt(t);
   },
...
var jo = Ke.exports;
const Ye = qo(jo),
 Ko = '/build/assets/marker-icon-2x-_ZA0WGCc.png',
 Yo = '/build/assets/marker-icon-hN30_KVU.png',
 Xo = '/build/assets/marker-shadow-f7SaPCxT.png';
delete Ye.Icon.Default.prototype._getIconUrl;
Ye.Icon.Default.mergeOptions({ iconRetinaUrl: Ko, iconUrl: Yo, shadowUrl: Xo });
try {
 window.leaFlet = Ye;
} catch {}
