import { g as zt } from './_commonjsHelpers-BosuxZz1.js';
var Te = { exports: {} };
/*!
 * ApexCharts v3.28.3
 ...
 */ (function (fe, qe) {
 ...
 function F(v) {
  for (var e = 1; e < arguments.length; e++) {
   ...
   e % 2
    ? Ie(Object(t), !0).forEach(function (i) {
       de(v, i, t[i]);
      })
    : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(v, Object.getOwnPropertyDescriptors(t))
      : Ie(Object(t)).forEach(function (i) {
         Object.defineProperty(v, i, Object.getOwnPropertyDescriptor(t, i));
        });
  }
  return v;
 }
 ...
 function Me(v, e) {
  for (var t = 0; t < e.length; t++) {
   ...
   (i.enumerable = i.enumerable || !1),
    ...
    Object.defineProperty(v, i.key, i);
  }
 }
 function E(v, e, t) {
  return e && Me(v.prototype, e), t && Me(v, t), v;
 }
 function de(v, e, t) {
  return (
   e in v
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
 ...
 function be(v, e) {
  ...
  for (var t = 0, i = new Array(e); t < e; t++) i[t] = v[t];
  return i;
 }
 var L = (function () {
   function v() {
    ...
    E(
     ...
     [
      ...
      },
      {
       key: 'isObject',
       value: function (e) {
        return e && N(e) === 'object' && !Array.isArray(e) && e != null;
       },
      },
      {
       key: 'listToArray',
       ...
       value: function (e, t) {
        ...
        typeof Object.assign != 'function' &&
         (Object.assign = function (s) {
          ...
          for (var n = Object(s), r = 1; r < arguments.length; r++) {
           var o = arguments[r];
           if (o != null) for (var h in o) o.hasOwnProperty(h) && (n[h] = o[h]);
          }
          return n;
         });
        ...
        return (
         this.isObject(e) &&
          ...
          Object.keys(t).forEach(function (s) {
           i.isObject(t[s]) && s in e
            ? (a[s] = i.extend(e[s], t[s]))
            : Object.assign(a, de({}, s, t[s]));
          }),
         a
        );
       },
      ...
      },
      {
       ...
       value: function (e) {
        ...
        if (Object.prototype.toString.call(e) === '[object Null]') return null;
       ...
       value: function () {
        var e =
          arguments.length > 0 && arguments[0] !== void 0
           ...
           : '#999999',
         t =
          arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0.6;
      ...
      },
      {
       ...
       value: function (e, t) {
        for (var i = [], a = (2 * Math.PI) / t, s = 0; s < t; s++) {
         var n = {};
         (n.x = e * Math.sin(s * a)), (n.y = -e * Math.cos(s * a)), i.push(n);
        }
        return i;
       },
      },
  ...
  K = (function () {
   function v(e) {
    X(this, v), (this.ctx = e), (this.w = e.w), this.setEasingFunctions();
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       ...
       c.config.chart.animations.animateGradually.enabled &&
        ...
        this.morphSVG(
         ...
         i,
         a,
         c.config.chart.type !== 'line' || c.globals.comboCharts ? s : 'stroke',
         n,
         r,
         o,
         h * d,
     ...
     {
      key: 'morphSVG',
      value: function (e, t, i, a, s, n, r, o) {
       var h = this,
        c = this.w;
       s || (s = e.attr('pathFrom')), n || (n = e.attr('pathTo'));
       var d = function (g) {
        return (
         c.config.chart.type === 'radar' && (r = 1),
        ...
        e
         ...
         .afterAll(function () {
          L.isNumber(i)
           ...
           : a !== 'none' &&
             c.globals.shouldAnimate &&
             ((!c.globals.comboCharts && t === c.globals.series.length - 1) ||
  ...
  O = (function () {
   function v(e) {
    X(this, v), (this.ctx = e), (this.w = e.w);
   }
   return (
    E(v, [
     {
      ...
      value: function (e, t) {
       ...
       e.unfilter(!0),
        ...
        i.config.states.normal.filter !== 'none'
         ? this.applyFilter(
            e,
            t,
      ...
      value: function (e, t, i) {
       ...
       e.unfilter(!0),
        ...
        e.filter(function (r) {
         ...
         (o.enabled ? a.addShadow(r, t, o) : r).componentTransfer({
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       return (
        e.unfilter(!0),
        (L.isIE() && c.config.chart.type === 'radialBar') ||
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.w;
       if (
        a.globals.selectedDataPoints[t] !== void 0 &&
   ...
   return (
    E(
     ...
     [
        ...
        var s =
         ...
         o =
          arguments.length > 7 && arguments[7] !== void 0
           ...
           : 'butt',
         h = this.w,
         c = h.globals.dom.Paper.line().attr({
          x1: e,
          y1: t,
          x2: i,
          y2: a,
       ...
       value: function () {
        var e =
         ...
         n =
          arguments.length > 5 && arguments[5] !== void 0
           ? arguments[5]
           : '#fefefe',
         r = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 1,
         o =
          arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null,
         h =
          arguments.length > 8 && arguments[8] !== void 0 ? arguments[8] : null,
         c = arguments.length > 9 && arguments[9] !== void 0 ? arguments[9] : 0,
         d = this.w,
        ...
        return (
         g.attr({
          ...
          ry: s,
          opacity: r,
          'stroke-width': o !== null ? o : 0,
          stroke: h !== null ? h : 'none',
          'stroke-dasharray': c,
         }),
        ...
        var t =
         ...
         a =
          arguments.length > 3 && arguments[3] !== void 0
           ...
           : 'none',
         s = this.w,
         n = s.globals.dom.Paper.polygon(e).attr({
          fill: a,
          stroke: t,
          'stroke-width': i,
         });
      ...
      },
      {
       ...
       value: function (e) {
        var t =
         ...
         i = this.w;
        e < 0 && (e = 0);
        var a = i.globals.dom.Paper.circle(2 * e);
      ...
      },
      {
       ...
       value: function (e) {
        var t = e.d,
         ...
         k = this.w;
        return (
         x === null && (x = k.config.stroke.lineCap),
         (i.indexOf('undefined') > -1 || i.indexOf('NaN') > -1) &&
          (i = 'M 0 '.concat(k.globals.gridHeight)),
         k.globals.dom.Paper.path(i).attr({
          fill: o,
          'fill-opacity': c,
          stroke: s,
          'stroke-opacity': g,
      ...
      {
       key: 'arc',
       value: function (e, t, i, a, s, n, r) {
        var o = arguments.length > 7 && arguments[7] !== void 0 && arguments[7],
         h = 'A';
        o && (h = 'a');
        var c = [h, e, t, i, a, s, n, r].join(' ');
        return c;
       },
      },
      {
       ...
       value: function (e) {
        var t,
         ...
         P = S && this.w.config.chart.animations.dynamicAnimation.enabled,
         C = !!(
          (S && !u.globals.resized) ||
          (P && u.globals.dataChanged && u.globals.shouldAnimate)
         );
        C ? (t = s) : ((t = n), (u.globals.animationEnded = !0));
        var M = u.config.stroke.dashArray,
         T = 0;
        T = Array.isArray(M) ? M[a] : u.config.stroke.dashArray;
        var z = this.drawPath({
         d: t,
         stroke: r,
         strokeWidth: o,
        ...
        if (
         ...
         m.getDefaultFilter(z, a);
        else if (
         u.config.chart.dropShadow.enabled &&
         l &&
         (!u.config.chart.dropShadow.enabledOnSeries ||
          (u.config.chart.dropShadow.enabledOnSeries &&
           u.config.chart.dropShadow.enabledOnSeries.indexOf(a) !== -1))
        ) {
         var Y = u.config.chart.dropShadow;
         m.dropShadow(z, Y, a);
        }
        k &&
        ...
        return (
         !S || u.globals.resized || u.globals.dataChanged
          ? (!u.globals.resized && u.globals.dataChanged) ||
            w.showDelayedElements()
          : w.animatePathsGradually(F(F({}, H), {}, { speed: g })),
         u.globals.dataChanged &&
          P &&
          C &&
          w.animatePathsGradually(F(F({}, H), {}, { speed: p })),
         z
        );
       },
      },
      {
       ...
       value: function (e, t, i) {
        var a =
         ...
         s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0,
         n = this.w,
         r = n.globals.dom.Paper.pattern(t, i, function (o) {
          e === 'horizontalLines'
           ? o.line(0, 0, i, 0).stroke({ color: a, width: s + 1 })
           : e === 'verticalLines'
             ? o.line(0, 0, 0, t).stroke({ color: a, width: s + 1 })
             : e === 'slantedLines'
               ? o.line(0, 0, t, i).stroke({ color: a, width: s })
               : e === 'squares'
                 ? o.rect(t, i).fill('none').stroke({ color: a, width: s })
                 : e === 'circles' &&
                   o.circle(t).fill('none').stroke({ color: a, width: s });
         });
        return r;
       },
      },
      {
       ...
       value: function (e, t, i, a, s) {
        var n,
         r =
          arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null,
         o =
          arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : null,
         h =
          arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null,
         ...
         d = this.w;
        t.length < 9 && t.indexOf('#') === 0 && (t = L.hexToRgba(t, a)),
         i.length < 9 && i.indexOf('#') === 0 && (i = L.hexToRgba(i, s));
        var g = 0,
         p = 1,
         f = 1,
         x = null;
        o !== null &&
         ((g = o[0] !== void 0 ? o[0] / 100 : 0),
         (p = o[1] !== void 0 ? o[1] / 100 : 1),
         (f = o[2] !== void 0 ? o[2] / 100 : 1),
         (x = o[3] !== void 0 ? o[3] / 100 : null));
        var b = !(
         ...
         ((n =
          h === null || h.length === 0
           ...
           : d.globals.dom.Paper.gradient(
              b ? 'radial' : 'linear',
              function (A) {
               (Array.isArray(h[c]) ? h[c] : h).forEach(function (l) {
                A.at(l.offset / 100, l.color, l.opacity);
               });
              },
             )),
         b)
        ) {
         var y = d.globals.gridWidth / 2,
          k = d.globals.gridHeight / 2;
         d.config.chart.type !== 'bubble'
          ? n.attr({ gradientUnits: 'userSpaceOnUse', cx: y, cy: k, r })
      ...
      },
      {
       ...
       value: function (e) {
        ...
        return (
         ...
         (h = h || 'regular'),
         (t = Array.isArray(s)
          ? b.globals.dom.Paper.text(function (y) {
             for (var k = 0; k < s.length; k++)
              k === 0 ? y.tspan(s[k]) : y.tspan(s[k]).newLine();
            })
          : x
      ...
      },
      {
       ...
       value: function (e, t, i) {
        ...
        if (i.shape === 'square' || i.shape === 'rect') {
         var n = i.pRadius === void 0 ? a / 2 : i.pRadius;
         (t !== null && a) || ((a = 0), (n = 0));
         var r = 1.2 * a + n,
         ...
         (i.shape !== 'circle' && i.shape) ||
          (L.isNumber(t) || ((a = 0), (t = 0)),
          (s = this.drawCircle(a, {
           cx: e,
           cy: t,
           class: i.class ? i.class : '',
      ...
      },
      {
       ...
       value: function (e, t) {
        ...
        if (
         (typeof i.config.chart.events.dataPointMouseEnter == 'function' &&
         ...
         (i.config.states.active.filter.type === 'none' ||
         ...
         a.applyFilter(e, s, r.type, r.value);
        }
       },
      },
      {
       ...
       value: function (e, t) {
        var i = this.w,
         ...
         s = parseInt(e.node.getAttribute('index'), 10),
         n = parseInt(e.node.getAttribute('j'), 10);
        typeof i.config.chart.events.dataPointMouseLeave == 'function' &&
       ...
       value: function (e, t) {
        ...
        if (e.node.getAttribute('selected') === 'true') {
          ...
          var h = i.globals.dom.Paper.select('.apexcharts-series path').members,
           ...
           d = function (p) {
            Array.prototype.forEach.call(p, function (f) {
             f.node.setAttribute('selected', 'false'), a.getDefaultFilter(f, s);
            });
           };
          d(h), d(c);
         }
         e.node.setAttribute('selected', 'true'),
          (r = 'true'),
          i.globals.selectedDataPoints[s] === void 0 &&
           (i.globals.selectedDataPoints[s] = []),
          i.globals.selectedDataPoints[s].push(n);
        }
        if (r === 'true') {
         var g = i.config.states.active.filter;
         g !== 'none' && a.applyFilter(e, s, g.type, g.value);
        } else
         i.config.states.active.filter.type !== 'none' &&
          a.getDefaultFilter(e, s);
        typeof i.config.chart.events.dataPointSelection == 'function' &&
  ...
  $e = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.annoCtx = e);
   }
   return (
    E(v, [
     {
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = this.w;
       if (!e || !t.label.text || (t.label.text && !t.label.text.trim()))
        return null;
       var a = i.globals.dom.baseEl
         .querySelector('.apexcharts-grid')
         .getBoundingClientRect(),
        s = e.getBoundingClientRect(),
        n = t.label.style.padding.left,
        r = t.label.style.padding.right,
        o = t.label.style.padding.top,
        h = t.label.style.padding.bottom;
       t.label.orientation === 'vertical' &&
        ((o = t.label.style.padding.left),
        (h = t.label.style.padding.right),
        (n = t.label.style.padding.top),
        (r = t.label.style.padding.bottom));
      ...
      value: function () {
       var e = this,
        ...
        i = function (a, s, n) {
         ...
         if (r) {
          var o = r.parentNode,
           h = e.addBackgroundToAnno(r, a);
          h && o.insertBefore(h.node, r);
         }
        };
       ...
       if (L.isNumber(o)) {
        if (e.x2 === null || e.x2 === void 0) {
         var d = this.annoCtx.graphics.drawLine(
          ...
          0 + e.offsetY,
          o + e.offsetX,
          a.globals.gridHeight + e.offsetY,
          e.borderColor,
          c,
          e.borderWidth,
         );
         ...
         var g = (e.x2 - s) / (r / a.globals.gridWidth);
         if (
          (this.annoCtx.inversedReversedAxis &&
           (g = (n - e.x2) / (r / a.globals.gridWidth)),
          (a.config.xaxis.type !== 'category' &&
           !a.config.xaxis.convertedCatToNumeric) ||
           this.invertAxis ||
           a.globals.dataFormatXNumeric ||
           (g = this.annoCtx.helpers.getStringX(e.x2)),
          g < o)
         ) {
          var p = o;
          (o = g), (g = p);
        ...
        var x = e.label.position === 'top' ? 4 : a.globals.gridHeight,
         b = this.annoCtx.graphics.getTextRects(
          h,
     ...
     [
      {
       ...
       value: function () {
        var e = this.w,
         t = [];
        if (e.globals.series.length === 0) return t;
        for (
         var i = 0;
         i < e.globals.series[e.globals.maxValsInArrayIndex].length;
         i++
        ) {
         for (var a = 0, s = 0; s < e.globals.series.length; s++)
          e.globals.series[s][i] !== void 0 && (a += e.globals.series[s][i]);
         t.push(a);
        }
      ...
      },
      {
       ...
       value: function () {
        var e =
         arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        return e === null
         ? this.w.config.series.reduce(function (t, i) {
            return t + i;
           }, 0)
         : this.w.globals.series[e].reduce(function (t, i) {
            return t + i;
           }, 0);
       },
      },
      ...
      },
      {
       ...
       value: function () {
        var e = this.w,
         t = 0;
        return (
         e.globals.markers.size.forEach(function (i) {
          t = Math.max(t, i);
         }),
      ...
      },
      {
       ...
       value: function () {
        ...
        e.globals.seriesTotals = e.globals.series.map(function (t, i) {
         var a = 0;
         if (Array.isArray(t)) for (var s = 0; s < t.length; s++) a += t[s];
         else a += t;
         return a;
        });
       },
         ...
         if (Array.isArray(t))
          for (var s = 0; s < t.length; s++) {
           var n = e.globals.stackedSeriesTotals[s],
            r = 0;
           n && (r = (100 * t[s]) / n), a.push(r);
          }
         else {
          var o =
           (100 * t) /
           e.globals.seriesTotals.reduce(function (h, c) {
            return h + c;
           }, 0);
          a.push(o);
         }
      ...
      },
      {
       ...
       value: function () {
        ...
        if (((s.yRange = []), s.isMultipleYAxis))
         for (var d = 0; d < s.minYArr.length; d++)
          s.yRange.push(Math.abs(s.minYArr[d] - s.maxYArr[d])), o.push(0);
        else s.yRange.push(Math.abs(s.minY - s.maxY));
        (s.xRange = Math.abs(s.maxX - s.minX)),
         (s.zRange = Math.abs(s.maxZ - s.minZ));
        for (var g = 0; g < s.yRange.length; g++)
         n.push(s.yRange[g] / s.gridHeight);
        if (
         ((t = s.xRange / s.gridWidth),
         ...
         o = [];
         for (var p = 0; p < n.length; p++) o.push(-s.minYArr[p] / n[p]);
        } else
         o.push(-s.minY / n[0]),
          s.minY !== Number.MIN_VALUE &&
           Math.abs(s.minY) !== 0 &&
           ((h = -s.minY / e), (c = s.minX / t));
        return {
         yRatio: n,
         invertedYRatio: e,
         zRatio: r,
      ...
      },
      {
       ...
       value: function (e) {
        var t = this,
         i = this.w;
        return (
         (i.globals.seriesLog = e.map(function (a, s) {
          return i.config.yaxis[s] && i.config.yaxis[s].logarithmic
           ? a.map(function (n) {
              return n === null ? null : t.getLogVal(n, s);
             })
           : a;
         })),
      ...
      },
      {
       ...
       value: function (e, t) {
        var i = this.w;
        return (
         (Math.log(e) - Math.log(i.globals.minYArr[t])) /
         (Math.log(i.globals.maxYArr[t]) - Math.log(i.globals.minYArr[t]))
        );
       },
      },
      {
         ...
         (a.logYRange = a.yRange.map(function (s, n) {
          if (i.config.yaxis[n] && t.w.config.yaxis[n].logarithmic) {
           var r,
            ...
            h = Number.MIN_VALUE;
           return (
            a.seriesLog.forEach(function (c, d) {
             c.forEach(function (g) {
              i.config.yaxis[d] &&
               i.config.yaxis[d].logarithmic &&
               ((o = Math.max(g, o)), (h = Math.min(g, h)));
             });
            }),
            (r = Math.pow(a.yRange[n], Math.abs(h - o) / a.yRange[n])),
            (a.yLogRatio[n] = r / a.gridHeight),
            r
           );
          }
         })),
    ...
    E(v, [
     {
      ...
      value: function (e, t, i) {
       ...
       var g = e.label.position === 'right' ? s.globals.gridWidth : 0,
        p = this.annoCtx.graphics.drawText({
         x: g + e.label.offsetX,
         y: (a || r) + e.label.offsetY - 3,
         text: o,
         textAnchor: e.label.textAnchor,
         fontSize: e.label.style.fontSize,
         fontFamily: e.label.style.fontFamily,
      ...
      value: function (e, t) {
       ...
       if (this.annoCtx.invertAxis) {
        ...
        s.config.xaxis.convertedCatToNumeric &&
         (n = s.globals.categoryLabels.indexOf(a));
        ...
        var o;
        s.config.yaxis[t.yAxisIndex].logarithmic
         ? (o =
            (a = new D(this.annoCtx.ctx).getLogVal(a, t.yAxisIndex)) /
            s.globals.yLogRatio[t.yAxisIndex])
         : (o =
            (a - s.globals.minYArr[t.yAxisIndex]) /
    ...
    E(v, [
     {
      ...
      value: function (e, t, i) {
       ...
       if (typeof e.x == 'string') {
        var h = a.globals.labels.indexOf(e.x);
        a.config.xaxis.convertedCatToNumeric &&
         (h = a.globals.categoryLabels.indexOf(e.x)),
         (s = this.annoCtx.helpers.getStringX(e.x)),
         e.y === null && (o = a.globals.series[e.seriesIndex][h]);
       } else
        s = (e.x - a.globals.minX) / (a.globals.xRange / a.globals.gridWidth);
       for (var c, d = [], g = 0, p = 0; p <= e.seriesIndex; p++) {
        var f = a.config.yaxis[p].seriesName;
        if (f)
         for (var x = p + 1; x <= e.seriesIndex; x++)
          a.config.yaxis[x].seriesName === f &&
           d.indexOf(f) === -1 &&
           (g++, d.push(f));
       }
       if (a.config.yaxis[e.yAxisIndex].logarithmic)
        c =
         (o = new D(this.annoCtx.ctx).getLogVal(o, e.yAxisIndex)) /
         a.globals.yLogRatio[e.yAxisIndex];
       else {
        var b = e.yAxisIndex + g;
        c =
         (o - a.globals.minYArr[b]) /
         (a.globals.yRange[b] / a.globals.gridHeight);
       }
       if (
        ((n =
         ...
         parseFloat(e.label.style.fontSize) -
         e.marker.size),
        (r = a.globals.gridHeight - c),
        a.config.yaxis[e.yAxisIndex] &&
         a.config.yaxis[e.yAxisIndex].reversed &&
         ((n = c + parseFloat(e.label.style.fontSize) + e.marker.size),
         (r = c)),
        L.isNumber(s))
       ) {
        var y = {
        ...
        var A = e.label.text ? e.label.text : '',
        ...
        if ((l.attr({ rel: i }), t.appendChild(l.node), e.customSVG.SVG)) {
        ...
        if (e.image.path) {
         var m = e.image.width ? e.image.width : 20,
          w = e.image.height ? e.image.height : 20;
         this.annoCtx.addImage({
          x: s + e.image.offsetX - m / 2,
          y: n + e.image.offsetY - w / 2,
          width: m,
          height: w,
          path: e.image.path,
         ...
         radialBar: {
          ...
          dataLabels: {
           ...
           total: {
            ...
            formatter: function (e) {
             return (
              e.globals.seriesTotals.reduce(function (t, i) {
               return t + i;
              }, 0) /
  ...
  et = (function () {
   function v(e) {
    X(this, v),
     (this.ctx = e),
     (this.w = e.w),
     (this.graphics = new I(this.ctx)),
     this.w.globals.isBarHorizontal && (this.invertAxis = !0),
     (this.helpers = new $e(this)),
     (this.xAxisAnnotations = new Je(this)),
     (this.yAxisAnnotations = new Qe(this)),
     (this.pointsAnnotations = new Ke(this)),
    ...
    E(v, [
       ...
       if (e.globals.axisCharts) {
        for (
         var t = this.yAxisAnnotations.drawYAxisAnnotations(),
          ...
          n = [t, i, a],
          r = [i.node, t.node, a.node],
          o = 0;
         o < 3;
         o++
        )
         e.globals.dom.elGraphical.add(n[o]),
          !s ||
           e.globals.resized ||
          ...
          e.globals.delayedElements.push({ el: r[o], index: 0 });
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = e.x,
        ...
        b = e.borderColor,
        y = e.appendTo,
        k = y === void 0 ? '.apexcharts-annotations' : y,
        A = e.paddingLeft,
        l = A === void 0 ? 4 : A,
        u = e.paddingRight,
        m = u === void 0 ? 4 : u,
        ...
        T = this.graphics.drawText({
         ...
         fontFamily: h || M.config.chart.fontFamily,
         foreColor: r || M.config.chart.foreColor,
         cssClass: d,
        }),
        z = M.globals.dom.baseEl.querySelector(k);
       z && z.appendChild(T.node);
       var Y = T.bbox();
       if (s) {
        var H = this.graphics.drawRect(
         Y.x - l,
         Y.y - C,
         Y.width + l + m,
         Y.height + S + C,
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = this.w,
        ...
        g = d === void 0 ? 20 : d,
        p = e.appendTo,
        f = p === void 0 ? '.apexcharts-annotations' : p,
        x = i.globals.dom.Paper.image(a);
       x.size(c, g).move(n, o);
       var b = i.globals.dom.baseEl.querySelector(f);
       b && b.appendChild(x.node);
      },
     },
     {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       return (
        x && h.insertBefore(x.node, f),
        i &&
         o.globals.memory.methodsToExec.push({
          context: r,
          id: p.id ? p.id : L.randomId(),
          method: n,
          label: 'addAnnotation',
          params: t,
         }),
     ...
     },
     {
      ...
      value: function (e) {
       ...
       t.globals.memory.methodsToExec.map(function (a, s) {
        (a.label !== 'addText' && a.label !== 'addAnnotation') ||
         t.globals.memory.methodsToExec.splice(s, 1);
       }),
        (i = L.listToArray(i)),
      ...
      value: function (e, t) {
       ...
       a &&
        (i.globals.memory.methodsToExec.map(function (s, n) {
         s.id === t && i.globals.memory.methodsToExec.splice(n, 1);
        }),
    ...
    E(v, [
     {
      ...
      value: function (e) {
       ...
       e.width === void 0 && e.height === void 0
        ? i.fill.image.width !== void 0 && i.fill.image.height !== void 0
          ? ((o = i.fill.image.width + 1), (h = i.fill.image.height))
          : ((o = n + 1), (h = n))
        : ((o = e.width), (h = e.height));
       ...
       c.appendChild(d),
        d.setAttributeNS(window.SVG.xlink, 'href', r),
        I.setAttrs(d, {
         x: 0,
         y: 0,
     ...
     },
     {
      ...
      value: function (e) {
       ...
       t.globals.seriesColors[this.seriesIndex] !== void 0 &&
        (r = t.globals.seriesColors[this.seriesIndex]),
        typeof r == 'function' &&
         (r = r({
       ...
       if (
        (r.indexOf('rgb') === -1
         ? r.length < 9 && (c = L.hexToRgba(r, h))
         : r.indexOf('rgba') > -1 && (h = L.getOpacityFromRGBA(r)),
        e.opacity && (h = e.opacity),
        o === 'pattern' && (a = this.handlePatternFill(a, r, h, c)),
        o === 'gradient' &&
         (s = this.handleGradientFill(r, h, this.seriesIndex)),
        o === 'image')
       ) {
        ...
        this.clippedImgArea({
         ...
         (i = 'url(#pattern'
          ...
          .concat(e.seriesNumber + 1)
          .concat(g, ')'));
       } else i = o === 'gradient' ? s : o === 'pattern' ? a : c;
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       var s = this.w.config,
        ...
        r = new I(this.ctx),
        o =
         s.fill.pattern.strokeWidth === void 0
       ...
       return (
        Array.isArray(s.fill.pattern.style)
         ? (e =
            s.fill.pattern.style[n.seriesNumber] !== void 0
             ? r.drawPattern(
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a,
        ...
        r = new I(this.ctx),
        o = new L(),
        h = s.fill.gradient.type,
        c = e,
        d =
         s.fill.gradient.opacityFrom === void 0
          ? t
          : Array.isArray(s.fill.gradient.opacityFrom)
            ? s.fill.gradient.opacityFrom[i]
            : s.fill.gradient.opacityFrom;
       c.indexOf('rgba') > -1 && (d = L.getOpacityFromRGBA(c));
       var g =
        s.fill.gradient.opacityTo === void 0
         ? t
         : Array.isArray(s.fill.gradient.opacityTo)
           ? s.fill.gradient.opacityTo[i]
           : s.fill.gradient.opacityTo;
       if (
        s.fill.gradient.gradientToColors === void 0 ||
        s.fill.gradient.gradientToColors.length === 0
       )
        a =
         s.fill.gradient.shade === 'dark'
          ? o.shadeColor(
        ...
        var p = s.fill.gradient.gradientToColors[n.seriesNumber];
        (a = p), p.indexOf('rgba') > -1 && (g = L.getOpacityFromRGBA(p));
       } else a = e;
       ...
       return (
        c.indexOf('rgb') > -1 && (c = L.rgb2hex(c)),
        a.indexOf('rgb') > -1 && (a = L.rgb2hex(a)),
        r.drawGradient(
         h,
         c,
         a,
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       var s,
        ...
        d = new I(this.ctx);
       if (
        ((r.globals.markers.size[t] > 0 || n) &&
         (c = d.group({ class: n ? '' : 'apexcharts-series-markers' })).attr(
          'clip-path',
        ...
        for (var g = 0; g < h.x.length; g++) {
         var p = i;
         i === 1 && g === 0 && (p = 0), i === 1 && g === 1 && (p = 1);
         var f = 'apexcharts-marker';
         (r.config.chart.type !== 'line' && r.config.chart.type !== 'area') ||
          r.globals.comboCharts ||
          r.config.tooltip.intersect ||
          (f += ' no-pointer-events');
         var x = Array.isArray(r.config.markers.size)
          ? r.globals.markers.size[t] > 0
          : r.config.markers.size > 0;
         if (x || n) {
          L.isNumber(h.y[g])
           ? (f += ' w'.concat(L.randomId()))
          ...
          r.config.series[o].data[p] &&
           (r.config.series[o].data[p].fillColor &&
            (b.pointFillColor = r.config.series[o].data[p].fillColor),
           r.config.series[o].data[p].strokeColor &&
            (b.pointStrokeColor = r.config.series[o].data[p].strokeColor)),
           a && (b.pSize = a),
           (s = d.drawMarker(h.x[g], h.y[g], b)).attr('rel', p),
           s.attr('j', p),
           s.attr('index', t),
           s.node.setAttribute('default-marker-size', b.pSize);
          var y = new O(this.ctx);
          y.setSelectionFilter(s, t, p), this.addEvents(s), c && c.add(s);
         } else
          r.globals.pointsArray[t] === void 0 &&
           (r.globals.pointsArray[t] = []),
           r.globals.pointsArray[t].push([h.x[g], h.y[g]]);
        }
       return c;
      },
     },
     {
      ...
      value: function (e) {
       ...
       return (
        s !== null &&
         d.discrete.length &&
         d.discrete.map(function (g) {
          g.seriesIndex === i &&
           g.dataPointIndex === s &&
           ((h.pointStrokeColor = g.strokeColor),
           (h.pointFillColor = g.fillColor),
           (c = g.size),
           (h.pointShape = g.shape));
         }),
        {
         pSize: r === null ? c : r,
         pRadius: d.radius,
         ...
         pointStrokeWidth: Array.isArray(d.strokeWidth)
          ? d.strokeWidth[i]
          : d.strokeWidth,
         pointStrokeColor: h.pointStrokeColor,
         pointFillColor: h.pointFillColor,
         shape: h.pointShape || (Array.isArray(d.shape) ? d.shape[i] : d.shape),
         class: t,
         pointStrokeOpacity: Array.isArray(d.strokeOpacity)
          ? d.strokeOpacity[i]
          : d.strokeOpacity,
         pointStrokeDashArray: Array.isArray(d.strokeDashArray)
          ? d.strokeDashArray[i]
          : d.strokeDashArray,
         pointFillOpacity: Array.isArray(d.fillOpacity)
          ? d.fillOpacity[i]
          : d.fillOpacity,
         seriesIndex: i,
        }
      ...
      value: function (e, t, i) {
       ...
       if (
        ...
        for (var d = 0; d < r.x.length; d++) {
         ...
         var f = 0,
          x = a.globals.markers.size[n];
         if (o !== 1 / 0) {
          x = a.globals.seriesZ[n][g] / o;
          var b = a.config.plotOptions.bubble;
          b.minBubbleRadius && x < b.minBubbleRadius && (x = b.minBubbleRadius),
           b.maxBubbleRadius &&
            x > b.maxBubbleRadius &&
            (x = b.maxBubbleRadius);
         }
         ...
         if (
          ((f = f || 0),
          (k !== null && a.globals.series[n][g] !== void 0) || (p = !1),
          p)
         ) {
          var A = this.drawPoint(y, k, f, x, n, g, t);
          c.add(A);
         }
         h.add(c);
        }
     ...
     },
     {
      ...
      value: function (e, t, i, a, s, n, r) {
       ...
       if (
        ...
        o.config.series[h].data[n] &&
         o.config.series[h].data[n].fillColor &&
         (y = o.config.series[h].data[n].fillColor),
        b.attr({
        ...
        var k = o.config.chart.dropShadow;
        d.dropShadow(b, k, s);
       }
       if (!this.initialAnim || o.globals.dataChanged || o.globals.resized)
        o.globals.animationEnded = !0;
       else {
        var A = o.config.chart.animations.speed;
        c.animateMarker(
         b,
         0,
         x.shape === 'circle' ? a : { width: x.width, height: x.height },
         A,
         o.globals.easing,
         function () {
       ...
       if (o.globals.dataChanged && x.shape === 'circle')
        if (this.dynamicAnim) {
         var l,
          u,
          m,
          w,
          S = o.config.chart.animations.dynamicAnimation.speed;
         (w = o.globals.previousPaths[s] && o.globals.previousPaths[s][r]) !=
          null && ((l = w.x), (u = w.y), (m = w.r !== void 0 ? w.r : a));
         for (var P = 0; P < o.globals.collapsedSeries.length; P++)
          o.globals.collapsedSeries[P].index === s && ((S = 1), (a = 0));
         e === 0 && t === 0 && (a = 0),
          c.animateCircle(
           b,
           { cx: l, cy: u, r: m },
       ...
       return (
        b.attr({ rel: n, j: n, index: s, 'default-marker-size': a }),
        d.setSelectionFilter(b, s, n),
        p.addEvents(b),
    ...
    E(v, [
     {
      ...
      value: function (e, t, i, a, s, n, r) {
       var o = this.w,
        h = !1,
        c = new I(this.ctx).getTextRects(i, r),
        d = c.width,
        g = c.height;
       t < 0 && (t = 0),
        t > o.globals.gridHeight + g && (t = o.globals.gridHeight + g / 2),
        o.globals.dataLabelsRects[a] === void 0 &&
         (o.globals.dataLabelsRects[a] = []),
        o.globals.dataLabelsRects[a].push({ x: e, y: t, width: d, height: g });
       var p = o.globals.dataLabelsRects[a].length - 2,
        f =
         o.globals.lastDrawnDataLabelsIndexes[a] !== void 0
       ...
       if (o.globals.dataLabelsRects[a][p] !== void 0) {
        var x = o.globals.dataLabelsRects[a][f];
        (e > x.x + x.width + 2 || t > x.y + x.height + 2 || e + d < x.x) &&
         (h = !0);
       }
       return (
        (s === 0 || n) && (h = !0),
        { x: e, y: t, textRects: c, drawnextLabel: h }
       );
      },
     },
     {
      ...
      value: function (e, t, i) {
       var a = this,
        s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 2,
        n = this.w,
        r = new I(this.ctx),
        ...
        d = i,
        g = null;
       if (!o.enabled || !Array.isArray(e.x)) return g;
       g = r.group({ class: 'apexcharts-data-labels' });
       for (var p = 0; p < e.x.length; p++)
        if (
         ((h = e.x[p] + o.offsetX), (c = e.y[p] + o.offsetY + s), !isNaN(h))
        ) {
         i === 1 && p === 0 && (d = 0), i === 1 && p === 1 && (d = 1);
         var f = n.globals.series[t][d],
          x = '',
          b = function (A) {
           return n.config.dataLabels.formatter(A, {
            ctx: a.ctx,
            seriesIndex: t,
            dataPointIndex: d,
            w: n,
         ...
         if (n.config.chart.type === 'bubble') {
          (x = b((f = n.globals.seriesZ[t][d]))), (c = e.y[p]);
          var y = new Ee(this.ctx),
           k = y.centerTextInBubble(c, t, d);
          c = k.y;
         } else f !== void 0 && (x = b(f));
      ...
      value: function (e) {
       ...
       if (
        ...
        x &&
         ...
         t.globals.zoomed || ((a = b.x), (s = b.y)),
         b.textRects &&
          (a < -10 - b.textRects.width ||
           a > t.globals.gridWidth + b.textRects.width + 10) &&
          (o = '');
        var y = t.globals.dataLabels.style.colors[n];
        (((t.config.chart.type === 'bar' ||
         t.config.chart.type === 'rangeBar') &&
         t.config.plotOptions.bar.distributed) ||
         t.config.dataLabels.distributed) &&
         (y = t.globals.dataLabels.style.colors[r]),
         typeof y == 'function' &&
          (y = y({
        ...
        if (
         ...
         if (
          (l.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }),
          g.dropShadow.enabled)
         ) {
          var u = g.dropShadow;
          new O(this.ctx).dropShadow(l, u);
         }
         d.add(l),
          t.globals.lastDrawnDataLabelsIndexes[n] === void 0 &&
           (t.globals.lastDrawnDataLabelsIndexes[n] = []),
          t.globals.lastDrawnDataLabelsIndexes[n].push(r);
        }
       }
      },
     },
     {
      ...
      value: function (e, t) {
       ...
       return (
        a.dropShadow.enabled && new O(this.ctx).dropShadow(h, a.dropShadow), h
       );
      },
     },
     {
       ...
       if (e.config.chart.type !== 'bubble')
        for (
         ...
         var a = t[i],
          ...
          n = null;
         if (
          (s.width && s.height && (n = this.addBackgroundToDataLabel(a, s)), n)
         ) {
     ...
     },
     {
      ...
      value: function () {
       for (
        var e = this.w,
         t = e.globals.dom.baseEl.querySelectorAll('.apexcharts-datalabels'),
  ...
  tt = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.barCtx = e);
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       ...
       x.globals.isXNumeric &&
        ...
        ((k = t + parseFloat(d * (p + 1))),
        (A = i + parseFloat(c * (p + 1)) - y));
       var l = t,
        u = i,
        m = {},
        w = x.config.dataLabels,
        S = this.barCtx.barOptions.dataLabels;
       g !== void 0 && this.barCtx.isTimelineBar && ((A = g), (u = g));
       var P = w.offsetX,
        C = w.offsetY,
        M = { width: 0, height: 0 };
       if (x.config.dataLabels.enabled) {
        var T = this.barCtx.series[n][r];
        M = b.getTextRects(
         x.globals.yLabelFormatters[0](T),
       ...
       return (
        ...
        this.drawCalculatedDataLabels({
         x: m.dataLabelsX,
         y: m.dataLabelsY,
         val: this.barCtx.isTimelineBar ? [a, s] : h[n][r],
         i: o,
         j: r,
         barWidth: d,
         barHeight: c,
     ...
     },
     {
      ...
      value: function (e) {
       var t,
        ...
        x = e.offY;
       h = Math.abs(h);
       var b = i.config.plotOptions.bar.dataLabels.orientation === 'vertical';
       r -= p / 2;
       var y = i.globals.gridWidth / i.globals.dataPoints;
       (t = i.globals.isXNumeric ? r - o / 2 + f : r - y + o / 2 + f),
        b && (t = t + c.height / 2 - p / 2 - 2);
       var k = this.barCtx.series[a][s] < 0;
       (i.config.plotOptions.bar.startingShape !== 'rounded' &&
        i.config.plotOptions.bar.endingShape !== 'rounded') ||
        a === 0 ||
        (n -= i.config.plotOptions.bar.borderRadius);
       var A = n;
       switch (
        (this.barCtx.isReversed && ((A = n - h + (k ? 2 * h : 0)), (n -= h)),
        g.position)
       ) {
        case 'center':
         d = b
       ...
       return (
        i.config.chart.stacked ||
         (d < 0
          ? (d = 0 + p)
          : d + c.height / 3 > i.globals.gridHeight &&
            (d = i.globals.gridHeight - p)),
        { bcx: r, bcy: n, dataLabelsX: t, dataLabelsY: d }
       );
      },
     },
     {
      ...
      value: function (e) {
       ...
       o = Math.abs(o);
       var b =
         n - (this.barCtx.isTimelineBar ? 0 : x) + r / 2 + h.height / 2 + f - 3,
        y = this.barCtx.series[a][s] < 0,
        k = i;
       switch (
        (this.barCtx.isReversed &&
         ((k = i + o - (y ? 2 * o : 0)), (i = t.globals.gridWidth - o)),
        g.position)
       ) {
        case 'center':
         c = y ? k + o / 2 - p : Math.max(h.width / 2, k - o / 2) + p;
         break;
        case 'bottom':
         c = y
          ? k + o - d - Math.round(h.width / 2) - p
          : k - o + d + Math.round(h.width / 2) + p;
         break;
        case 'top':
         c = y
          ? k - d + Math.round(h.width / 2) - p
          : k - d - Math.round(h.width / 2) + p;
       }
       return (
        t.config.chart.stacked ||
         (c < 0
          ? (c = c + h.width + d)
          : c + h.width / 2 > t.globals.gridWidth &&
            (c = t.globals.gridWidth - h.width - d)),
        { bcx: i, bcy: n, dataLabelsX: c, dataLabelsY: b }
       );
      },
     },
     {
      ...
      value: function (e) {
       ...
       d.config.plotOptions.bar.dataLabels.orientation === 'vertical' &&
        (g = 'rotate(-90, '.concat(t, ', ').concat(i, ')'));
       var p = new ee(this.barCtx.ctx),
        f = new I(this.barCtx.ctx),
        x = c.formatter,
        b = null,
        y = d.globals.collapsedSeriesIndices.indexOf(s) > -1;
       if (c.enabled && !y) {
        b = f.group({ class: 'apexcharts-data-labels', transform: g });
        var k = '';
        a !== void 0 && (k = x(a, { seriesIndex: s, dataPointIndex: n, w: d }));
        var A = d.globals.series[s][n] < 0,
         l = d.config.plotOptions.bar.dataLabels.position;
        d.config.plotOptions.bar.dataLabels.orientation === 'vertical' &&
         (l === 'top' && (c.textAnchor = A ? 'end' : 'start'),
         l === 'center' && (c.textAnchor = 'middle'),
         l === 'bottom' && (c.textAnchor = A ? 'end' : 'start')),
         this.barCtx.isTimelineBar &&
          this.barCtx.barOptions.dataLabels.hideOverflowingLabels &&
          h < f.getTextRects(k, parseFloat(c.style.fontSize)).width &&
          (k = ''),
         d.config.chart.stacked &&
          this.barCtx.barOptions.dataLabels.hideOverflowingLabels &&
          (this.barCtx.isHorizontal
           ? r.width / 1.6 > Math.abs(h) && (k = '')
           : r.height / 1.6 > Math.abs(o) && (k = ''));
        var u = F({}, c);
        this.barCtx.isHorizontal &&
         a < 0 &&
         (c.textAnchor === 'start'
          ? (u.textAnchor = 'end')
          : c.textAnchor === 'end' && (u.textAnchor = 'start')),
    ...
    E(v, [
     ...
     },
     {
      ...
      value: function (e) {
       ...
       return (
        this.ctx.legend.legendHelpers.toggleDataSeries(t.realIndex, t.isHidden),
        t.isHidden
       );
      },
     },
     ...
     },
     {
      ...
      value: function () {
       var e =
        ...
        a = this.w,
        s = L.clone(a.globals.initialSeries);
      ...
      value: function (e, t) {
       ...
       if (e.type === 'mousemove') {
        var s = parseInt(t.getAttribute('rel'), 10) - 1,
         n = null,
         r = null;
        i.globals.axisCharts || i.config.chart.type === 'radialBar'
        ...
        n !== null &&
         ...
         r !== null && r.classList.remove(this.legendInactiveClass));
        ...
        n('add'),
         (function (o) {
          for (var h = 0; h < s.length; h++) {
           ...
           c >= o.from &&
            c <= o.to &&
            s[h].classList.remove(i.legendInactiveClass);
          }
     ...
     },
     {
      ...
      value: function () {
       var e = arguments.length > 0 && arguments[0] !== void 0 && arguments[0],
        t =
         arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'asc',
        i = this.w,
        a = 0;
       if (i.config.series.length > 1) {
        for (
         var s = i.config.series.map(function (r, o) {
           var h = !1;
           return (
            e &&
             (h =
              i.config.series[o].type === 'bar' ||
              i.config.series[o].type === 'column'),
            r.data && r.data.length > 0 && !h ? o : -1
           );
          }),
          n = t === 'asc' ? 0 : s.length - 1;
         t === 'asc' ? n < s.length : n >= 0;
         t === 'asc' ? n++ : n--
        )
         if (s[n] !== -1) {
          a = s[n];
     ...
     },
     {
      ...
      value: function () {
       ...
       function t(n, r, o) {
        for (
         var h = n[r].childNodes,
          c = {
           type: o,
           paths: [],
           realIndex: n[r].getAttribute('data:realIndex'),
          },
          d = 0;
         d < h.length;
         d++
           ...
           var r,
            o =
             ...
             e.globals.dom.baseEl.querySelectorAll(
              '.apexcharts-'.concat(r, '-series .apexcharts-series'),
             )),
            h = 0;
           h < o.length;
           h++
           ...
           for (
            var r = e.globals.dom.baseEl.querySelectorAll(
             ...
             h = function (d) {
              ...
              o.push({ rect: p, color: r[d].getAttribute('color') });
             },
             c = 0;
            c < r.length;
            c++
        ...
        for (var a = 0; a < i.length; a++) {
         for (
          var s = t.globals.dom.baseEl.querySelectorAll(
            '.apexcharts-'
             .concat(e, "-series .apexcharts-series[data\\:realIndex='")
             .concat(a, "'] circle"),
           ),
           n = [],
           r = 0;
     ...
     },
     {
      ...
      value: function () {
       ...
       if (
        ...
        t.align === 'left'
         ? ((a = 10), (n = 'start'))
         : t.align === 'right' && ((a = e.globals.svgWidth - 10), (n = 'end')),
        t.verticalAlign === 'top'
         ? (s = 50)
         : t.verticalAlign === 'bottom' && (s = e.globals.svgHeight - 50),
        (a += t.offsetX),
   ...
   return (
    E(v, [
     ...
     },
     {
      ...
      value: function () {
       ...
       if (
        ...
        if (
         ((a = h.globals.gridWidth / this.barCtx.visibleItems),
         h.config.xaxis.convertedCatToNumeric &&
          (a = h.globals.gridWidth / h.globals.dataPoints),
         (n =
         ...
         h.config.xaxis.convertedCatToNumeric &&
          (g = this.barCtx.initialXRatio),
          h.globals.minXDiff &&
           h.globals.minXDiff !== 0.5 &&
           h.globals.minXDiff / g > 0 &&
           (a = h.globals.minXDiff / g),
          (n =
           ((a / this.barCtx.seriesLen) *
            parseInt(this.barCtx.barOptions.columnWidth, 10)) /
           100) < 1 && (n = 1);
        ...
        (r =
         ...
         (this.barCtx.isReversed
          ...
          : 0)),
         (e = h.globals.padHorizontal + (a - n * this.barCtx.seriesLen) / 2);
       }
       return {
        x: e,
        y: t,
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       var s = this.w,
        n = new q(this.barCtx.ctx),
        r = null,
        o = this.barCtx.barOptions.distributed ? i : t;
       return (
        this.barCtx.barOptions.colors.ranges.length > 0 &&
         this.barCtx.barOptions.colors.ranges.map(function (h) {
          e[t][i] >= h.from && e[t][i] <= h.to && (r = h.color);
         }),
        s.config.series[t].data[i] &&
         s.config.series[t].data[i].fillColor &&
         (r = s.config.series[t].data[i].fillColor),
        n.fillPath({
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = 0,
        s = this.w;
       return (
        this.barCtx.series[e][t] === void 0 || this.barCtx.series[e][t] === null
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.j,
        ...
        o = e.elSeries,
        h = this.w,
        c = new I(this.barCtx.ctx),
        d = new j(this.barCtx.ctx).getActiveConfigSeriesIndex();
       if (
        ...
        t >= this.barCtx.barOptions.colors.backgroundBarColors.length &&
         (t -= this.barCtx.barOptions.colors.backgroundBarColors.length);
        var g = this.barCtx.barOptions.colors.backgroundBarColors[t],
         p = c.drawRect(
          a !== void 0 ? a : 0,
          n !== void 0 ? n : 0,
          s !== void 0 ? s : h.globals.gridWidth,
          r !== void 0 ? r : h.globals.gridHeight,
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.barWidth,
        ...
        d = e.j,
        g = e.w,
        p = new I(this.barCtx.ctx);
       ((r = Array.isArray(r) ? r[h] : r) && o[c][d] !== 0) || (r = 0),
        o[c][d] === 0 && (t = 0);
       var f = {
         barWidth: t,
         strokeWidth: r,
        ...
        x = this.getRoundedBars(g, f, o, c, d),
        b = i,
        y = i + t,
        k = p.move(b, x.y1),
        A = p.move(b, x.y1),
       ...
       return (
        g.globals.previousPaths.length > 0 &&
         (A = this.barCtx.getPreviousPath(h, d, !1)),
        (k =
         k +
         p.line(b, x.y2) +
         x.startingShape +
         ...
         x.endingShape +
         'z'),
        (A = A + p.line(b, x.y1) + l + l + l + l + l + p.line(b, x.y1)),
        g.config.chart.stacked &&
         (this.barCtx.yArrj.push(x.y2),
         this.barCtx.yArrjF.push(Math.abs(s - x.y2)),
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.barYPosition,
        ...
        c = e.j,
        d = e.w,
        g = new I(this.barCtx.ctx);
       ((n = Array.isArray(n) ? n[o] : n) && !r[h][c]) || (n = 0),
        r[h][c] === 0 && (i = 0);
       var p = { barHeight: i, strokeWidth: n, barYPosition: t, x2: s, x1: a },
        f = this.getRoundedBars(d, p, r, h, c),
        x = g.move(f.x1, t),
        b = g.move(f.x1, t);
       d.globals.previousPaths.length > 0 &&
        (b = this.barCtx.getPreviousPath(o, c, !1));
       var y = t,
        k = t + i,
        A = g.line(f.x1, k - n);
       return (
        (x =
         ...
         f.endingShape +
         'z'),
        (b = b + g.line(f.x1, y) + A + A + A + A + A + g.line(f.x1, y)),
        d.config.chart.stacked &&
         (this.barCtx.xArrj.push(f.x2),
         this.barCtx.xArrjF.push(Math.abs(f.x1 - f.x2)),
         this.barCtx.xArrjVal.push(this.barCtx.series[h][c])),
        { pathTo: x, pathFrom: b }
       );
      },
     },
     {
      key: 'getRoundedBars',
      value: function (e, t, i, a, s) {
       var n = new I(this.barCtx.ctx),
        r = 0,
        o = e.config.plotOptions.bar.borderRadius;
       if (
        (Array.isArray(o)
         ? (r = o[a > o.length - 1 ? o.length - 1 : a])
         : (r = o),
        this.barCtx.isHorizontal)
       ) {
        var h = '',
         ...
         f = t.x2;
        if (
         (Math.abs(t.x1 - t.x2) < r && (r = Math.abs(t.x1 - t.x2)),
         i[a][s] !== void 0 || i[a][s] !== null)
        ) {
         var x = this.barCtx.isReversed ? i[a][s] > 0 : i[a][s] < 0;
         x && (r *= -1),
          (d = g = r),
          this.barCtx.barOptions.startingShape === 'flat' && (d = 0),
          this.barCtx.barOptions.endingShape === 'flat' && (g = 0),
          this.barCtx.barOptions.startingShape === 'flat' &&
           this.barCtx.barOptions.endingShape === 'flat' &&
           (r = 0),
          e.config.chart.stacked && i.length > 1 && a !== 0
           ? this.barCtx.barOptions.endingShape === 'flat' ||
             this.barCtx.barOptions.startingShape === 'flat'
             ? (p += r)
             : (p += 2 * g)
          ...
          (h =
           n.quadraticCurve(
            ...
            t.barYPosition,
            f + d,
            t.barYPosition + (x ? -1 * d : d),
           ) +
           n.line(
            f + d,
            t.barYPosition + t.barHeight - t.strokeWidth - (x ? -1 * d : d),
           ) +
           n.quadraticCurve(
            f + d,
            t.barYPosition + t.barHeight - t.strokeWidth,
            f,
            t.barYPosition + t.barHeight - t.strokeWidth,
           )),
          (c =
           n.quadraticCurve(
            ...
            t.barYPosition + t.barHeight - t.strokeWidth,
            p - g,
            t.barYPosition + t.barHeight - t.strokeWidth - (x ? -1 * g : g),
           ) +
           n.line(p - g, t.barYPosition + (x ? -1 * g : g)) +
           n.quadraticCurve(p - g, t.barYPosition, p, t.barYPosition));
        }
        return { startingShape: h, endingShape: c, x1: p, x2: f };
       }
       var b = '',
        y = '',
        k = r,
        ...
        u = t.y1;
       if (
        (Math.abs(t.y1 - t.y2) < r && (r = Math.abs(t.y1 - t.y2)),
        i[a][s] !== void 0 || i[a][s] !== null)
       ) {
        var m = i[a][s] < 0;
        m && (r *= -1),
         (k = A = r),
         this.barCtx.barOptions.startingShape === 'flat' && (k = 0),
         this.barCtx.barOptions.endingShape === 'flat' && (A = 0),
         this.barCtx.barOptions.startingShape === 'flat' &&
          this.barCtx.barOptions.endingShape === 'flat' &&
          (r = 0),
         e.config.chart.stacked && i.length > 1 && a !== 0
         ...
         (b =
          n.quadraticCurve(
           t.barXPosition,
           l - k,
           t.barXPosition + (m ? -1 * k : k),
           l - k,
          ) +
          n.line(
           t.barXPosition + t.barWidth - t.strokeWidth - (m ? -1 * k : k),
           l - k,
          ) +
          n.quadraticCurve(
           t.barXPosition + t.barWidth - t.strokeWidth,
           l - k,
           t.barXPosition + t.barWidth - t.strokeWidth,
           l,
          )),
         (y =
          n.quadraticCurve(
           t.barXPosition + t.barWidth - t.strokeWidth,
           u + A,
           t.barXPosition + t.barWidth - t.strokeWidth - (m ? -1 * A : A),
           u + A,
          ) +
          n.line(t.barXPosition + (m ? -1 * A : A), u + A) +
          n.quadraticCurve(t.barXPosition, u + A, t.barXPosition, u));
       }
       return { startingShape: b, endingShape: y, y1: u, y2: l };
      },
     },
     {
      key: 'checkZeroSeries',
      value: function (e) {
       for (var t = e.series, i = this.w, a = 0; a < t.length; a++) {
        for (var s = 0, n = 0; n < t[i.globals.maxValsInArrayIndex].length; n++)
         s += t[a][n];
       ...
       return (
        e != null &&
         (a =
          ...
          2 * (this.barCtx.isReversed ? e / this.barCtx.invertedYRatio : 0)),
        a
       );
      },
     },
     ...
     },
     {
      ...
      value: function (e, t, i, a, s) {
       var n = this,
        ...
        o = [];
       return (
        r.globals.seriesGoals[a] &&
         r.globals.seriesGoals[a][s] &&
         Array.isArray(r.globals.seriesGoals[a][s]) &&
         r.globals.seriesGoals[a][s].forEach(function (h) {
          var c;
          o.push(
           (de(
            (c = {}),
            e,
            e === 'x'
             ? n.getXForValue(h.value, t, !1)
             : n.getYForValue(h.value, i, !1),
           ),
           de(c, 'attrs', h),
           c),
          );
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.barXPosition,
        ...
        n = e.barWidth,
        r = e.barHeight,
        o = new I(this.barCtx.ctx),
        h = o.group({ className: 'apexcharts-bar-goals-groups' }),
        c = null;
       return (
        this.barCtx.isHorizontal
         ? Array.isArray(a) &&
           a.forEach(function (d) {
            var g =
              d.attrs.strokeHeight !== void 0 ? d.attrs.strokeHeight : r / 2,
             p = i + g + r / 2;
            (c = o.drawLine(
             d.x,
             p - 2 * g,
         ...
         : Array.isArray(s) &&
           s.forEach(function (d) {
            var g =
              d.attrs.strokeWidth !== void 0 ? d.attrs.strokeWidth : n / 2,
             p = t + g + n / 2;
            (c = o.drawLine(
             p - 2 * g,
             d.y,
      ...
      value: function (e, t) {
       ...
       for (var r = 0, o = 0; r < e.length; r++, o++) {
        var h,
         ...
         x = [],
         b = [],
         y = i.globals.comboCharts ? t[r] : r,
         k = a.group({
          class: 'apexcharts-series',
          rel: r + 1,
          seriesName: L.escapeString(i.globals.seriesNames[y]),
          'data:realIndex': y,
         });
        ...
        for (
         var m = a.group({
          ...
          S = 0;
         S < i.globals.dataPoints;
         S++
        ) {
         var P = this.barHelpers.getStrokeWidth(r, S, y),
          C = null,
          M = {
           indexes: { i: r, j: S, realIndex: y, bc: o },
           x: p,
           y: f,
           strokeWidth: P,
           elSeries: k,
         ...
         this.isHorizontal
          ? ((C = this.drawBarPaths(
             F(F({}, M), {}, { barHeight: A, zeroW: g, yDivision: c }),
            )),
            (l = this.series[r][S] / this.invertedYRatio))
          : ((C = this.drawColumnPaths(
             F(F({}, M), {}, { xDivision: h, barWidth: l, zeroH: d }),
            )),
            (A = this.series[r][S] / this.yRatio[this.yaxisIndex]));
         ...
         T && w.add(T),
          ...
          S > 0 && b.push(p + l / 2),
          x.push(f);
         var z = this.barHelpers.getPathFillColor(e, r, S, y);
         this.renderSeries({
          realIndex: y,
          pathFill: z,
          j: S,
        ...
        (i.globals.seriesXvalues[y] = b),
         (i.globals.seriesYvalues[y] = x),
         n.add(k);
       }
       return n;
      },
      ...
      value: function (e) {
       ...
       a ||
        (a = this.barOptions.distributed
         ...
         : w.globals.stroke.colors[t]),
        w.config.series[n].data[s] &&
         w.config.series[n].data[s].strokeColor &&
         (a = w.config.series[n].data[s].strokeColor),
       ...
       C.attr('clip-path', 'url(#gridRectMask'.concat(w.globals.cuid, ')'));
       var M = w.config.forecastDataPoints;
       M.count > 0 &&
        s >= w.globals.dataPoints - M.count &&
        (C.node.setAttribute('stroke-dasharray', M.dashArray),
        C.node.setAttribute('stroke-width', M.strokeWidth),
        C.node.setAttribute('fill-opacity', M.fillOpacity)),
        p !== void 0 &&
         f !== void 0 &&
         (C.attr('data-range-y1', p), C.attr('data-range-y2', f)),
        new O(this.ctx).setSelectionFilter(C, t, s),
        c.add(C);
       var T = new tt(this).handleBarDataLabels({
        x: d,
        y: g,
        y1: p,
        y2: f,
       ...
       return T !== null && A.add(T), c.add(A), l && c.add(l), c;
      },
     },
     {
      key: 'drawBarPaths',
      value: function (e) {
       ...
       c.globals.isXNumeric &&
        (r =
         (c.globals.seriesX[d][g] - c.globals.minX) / this.invertedXRatio - i);
       var p = r + i * this.visibleI;
       n = this.barHelpers.getXForValue(this.series[d][g], s);
       ...
       return (
        ...
        }),
        {
         ...
         x: n,
         y: r,
         goalX: this.barHelpers.getGoalValues('x', s, null, d, g),
         barYPosition: p,
        }
       );
      },
      ...
      value: function (e) {
       ...
       if (c.globals.isXNumeric) {
        ...
        c.globals.seriesX[d].length || (x = c.globals.maxValsInArrayIndex),
         (i =
          (c.globals.seriesX[x][p] - c.globals.minX) / this.xRatio -
          (n * this.seriesLen) / 2);
       }
       var b = i + n * this.visibleI;
       a = this.barHelpers.getYForValue(this.series[g][p], r);
       ...
       return (
        ...
        }),
        {
         ...
         x: i,
         y: a,
         goalY: this.barHelpers.getGoalValues('y', null, r, g, p),
         barXPosition: b,
        }
       );
      },
      ...
      value: function (e, t) {
       for (var i, a = this.w, s = 0; s < a.globals.previousPaths.length; s++) {
        ...
        n.paths &&
         ...
         a.globals.previousPaths[s].paths[t] !== void 0 &&
         (i = a.globals.previousPaths[s].paths[t].d);
       }
       return i;
      },
     },
   ...
   return (
    E(v, [
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = this.w.globals.locale,
        ...
        n = [''].concat(U(i.shortMonths)),
        r = [''].concat(U(i.days)),
        o = [''].concat(U(i.shortDays));
       function h(S, P) {
        var C = S + '';
        for (P = P || 2; C.length < P; ) C = '0' + C;
        return C;
       }
       ...
       t = (t = (t = (t = t.replace(/(^|[^\\])MMMM+/g, '$1' + s[0])).replace(
        /(^|[^\\])MMM/g,
        '$1' + n[0],
       )).replace(/(^|[^\\])MM/g, '$1' + h(d))).replace(
        /(^|[^\\])M/g,
        '$1' + d,
       );
       var g = a ? e.getUTCDate() : e.getDate();
       t = (t = (t = (t = t.replace(/(^|[^\\])dddd+/g, '$1' + r[0])).replace(
        /(^|[^\\])ddd/g,
        '$1' + o[0],
       ...
       var p = a ? e.getUTCHours() : e.getHours(),
        f = p > 12 ? p - 12 : p === 0 ? 12 : p;
       t = (t = (t = (t = t.replace(/(^|[^\\])HH+/g, '$1' + h(p))).replace(
        /(^|[^\\])H/g,
        '$1' + p,
       )).replace(/(^|[^\\])hh+/g, '$1' + h(f))).replace(
        /(^|[^\\])h/g,
        '$1' + f,
       );
       var x = a ? e.getUTCMinutes() : e.getMinutes();
       t = (t = t.replace(/(^|[^\\])mm+/g, '$1' + h(x))).replace(
        /(^|[^\\])m/g,
        '$1' + x,
       );
       var b = a ? e.getUTCSeconds() : e.getSeconds();
       t = (t = t.replace(/(^|[^\\])ss+/g, '$1' + h(b))).replace(
        /(^|[^\\])s/g,
        '$1' + b,
       );
       var y = a ? e.getUTCMilliseconds() : e.getMilliseconds();
       (t = t.replace(/(^|[^\\])fff+/g, '$1' + h(y, 3))),
        (y = Math.round(y / 10)),
        (t = t.replace(/(^|[^\\])ff/g, '$1' + h(y))),
        (y = Math.round(y / 10));
       var k = p < 12 ? 'AM' : 'PM';
       t = (t = (t = t.replace(/(^|[^\\])f/g, '$1' + y)).replace(
        /(^|[^\\])TT+/g,
        '$1' + k,
       )).replace(/(^|[^\\])T/g, '$1' + k.charAt(0));
       var A = k.toLowerCase();
       t = (t = t.replace(/(^|[^\\])tt+/g, '$1' + A)).replace(
        /(^|[^\\])t/g,
        '$1' + A.charAt(0),
       );
       var l = -e.getTimezoneOffset(),
        u = a || !l ? 'Z' : l > 0 ? '+' : '-';
       if (!a) {
        var m = (l = Math.abs(l)) % 60;
        u += h(Math.floor(l / 60)) + ':' + h(m);
       }
       t = t.replace(/(^|[^\\])K/g, '$1' + u);
       var w = (a ? e.getUTCDay() : e.getDay()) + 1;
       return (t = (t = (t = (t = (t = t.replace(
        new RegExp(r[0], 'g'),
        r[w],
       )).replace(new RegExp(o[0], 'g'), o[w])).replace(
        new RegExp(s[0], 'g'),
        s[d],
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.w;
       a.config.xaxis.min !== void 0 && (e = a.config.xaxis.min),
        a.config.xaxis.max !== void 0 && (t = a.config.xaxis.max);
      ...
      value: function (i, a) {
       ...
       for (
        ...
        var h,
         ...
         b = n.group({
          class: 'apexcharts-series',
          seriesName: L.escapeString(s.globals.seriesNames[x]),
          rel: o + 1,
          'data:realIndex': x,
         });
        ...
        for (
         ...
         var w = this.barHelpers.getStrokeWidth(o, m, x),
          S = this.seriesRangeStart[o][m],
          P = this.seriesRangeEnd[o][m],
          C = null,
          M = null,
          T = { x: g, y: p, strokeWidth: w, elSeries: b };
         if (((f = A.yDivision), (y = A.barHeight), this.isHorizontal)) {
          M = p + y * this.visibleI;
          var z = this.seriesLen;
          s.config.plotOptions.bar.rangeBarGroupRows && (z = 1);
          var Y = (f - y * z) / 2;
          if (s.config.series[o].data[m] === void 0) break;
          if (this.isTimelineBar && s.config.series[o].data[m].x) {
           ...
           (y = H.barHeight), (M = H.barYPosition);
          }
          k = (C = this.drawRangeBarPaths(
           F(
            {
             indexes: { i: o, j: m, realIndex: x },
             barHeight: y,
             barYPosition: M,
             zeroW: d,
             yDivision: f,
         ...
         R && u.add(R), (p = C.y), (g = C.x);
         var V = this.barHelpers.getPathFillColor(i, o, m, x),
          G = s.globals.stroke.colors[x];
         this.renderSeries({
          realIndex: x,
          pathFill: V,
          lineFill: G,
     ...
     },
     {
      ...
      value: function (i) {
       var a = i.i,
        ...
        d = this.w,
        g = [],
        p = d.config.series[a].data[s].rangeName,
        f = d.config.series[a].data[s].x,
        x = d.globals.labels.indexOf(f),
        b = d.globals.seriesRangeBarTimeline[a].findIndex(function (y) {
         return y.x === f && y.overlaps.length > 0;
        });
       return (
        (n = d.config.plotOptions.bar.rangeBarGroupRows
         ? r + h * x
         : r + o * this.visibleI + h * x),
        b > -1 &&
         !d.config.plotOptions.bar.rangeBarOverlap &&
         (g = d.globals.seriesRangeBarTimeline[a][b].overlaps).indexOf(p) >
          -1 &&
         (n =
          (o = c.barHeight / g.length) * this.visibleI +
          (h * (100 - parseInt(this.barOptions.barHeight, 10))) / 100 / 2 +
          o * (this.visibleI + g.indexOf(p)) +
          h * x),
        { barYPosition: n, barHeight: o }
       );
      },
     },
     {
      ...
      value: function (i) {
       ...
       var n = i.xDivision,
        ...
        p = a.realIndex,
        f = this.getRangeValue(p, d),
        x = Math.min(f.start, f.end),
        b = Math.max(f.start, f.end);
       h.globals.isXNumeric &&
        (s = (h.globals.seriesX[c][d] - h.globals.minX) / this.xRatio - r / 2);
       var y = s + r * this.visibleI;
       this.series[c][d] === void 0 || this.series[c][d] === null
        ? (x = o)
        : ((x = o - x / g), (b = o - b / g));
       var k = Math.abs(b - x),
     ...
     },
     {
      ...
      value: function (i) {
       var a = i.indexes,
        ...
        d = i.zeroW,
        g = this.w,
        p = d + n / this.invertedYRatio,
        f = d + r / this.invertedYRatio,
        x = Math.abs(f - p),
       ...
       return (
        g.globals.isXNumeric || (s += o),
        {
         ...
         barWidth: x,
         x: f,
         goalX: this.barHelpers.getGoalValues('x', d, null, a.realIndex, a.j),
         y: s,
        }
       );
      },
     ...
     },
     {
      ...
      value: function (i) {
       var a = i.ctx,
        ...
        o = i.y2,
        h = i.w,
        c = h.globals.seriesRangeStart[s][n],
        d = h.globals.seriesRangeEnd[s][n],
        g = h.globals.labels[n],
        p = h.config.series[s].name ? h.config.series[s].name : '',
        f = h.config.tooltip.y.formatter,
        x = h.config.tooltip.y.title.formatter,
        b = { w: h, seriesIndex: s, dataPointIndex: n, start: c, end: d };
       typeof x == 'function' && (p = x(p, b)),
        Number.isFinite(r) &&
         Number.isFinite(o) &&
         ((c = r),
         (d = o),
         h.config.series[s].data[n].x &&
          (g = h.config.series[s].data[n].x + ':'),
         typeof f == 'function' && (g = f(g, b)));
       var y = '',
        k = '',
        A = h.globals.colors[s];
       if (h.config.tooltip.x.formatter === void 0)
        if (h.config.xaxis.type === 'datetime') {
         var l = new W(a);
         (y = l.formatDate(l.getDate(c), h.config.tooltip.x.format)),
          (k = l.formatDate(l.getDate(d), h.config.tooltip.x.format));
        } else (y = c), (k = d);
       else
        (y = h.config.tooltip.x.formatter(c)),
         (k = h.config.tooltip.x.formatter(d));
       return {
        start: c,
        end: d,
        startVal: y,
   ...
   return (
    E(v, [
        ...
        tooltip: {
         ...
         custom: function (e) {
          return e.w.config.plotOptions &&
           ...
           ? (function (t) {
              var i = new me(t.ctx, null),
               a = i.getTooltipValues(t),
               s = a.color,
               n = a.seriesName,
               r = a.ylabel,
               o = a.startVal,
      ...
      value: function (e, t, i) {
       (e.xaxis.type = 'numeric'),
        ...
        (e.xaxis.labels.formatter =
         e.xaxis.labels.formatter ||
         function (n) {
          return L.isNumber(n) ? Math.floor(n) : n;
         });
       ...
       return (
        ...
        s &&
         ...
         (e.xaxis.labels.formatter = function (n) {
          return L.isNumber(n) ? a(s[Math.floor(n) - 1]) : a(n);
         }),
        (e.xaxis.categories = []),
        (e.labels = []),
     ...
     },
     {
      key: '_getBoxTooltip',
      value: function (e, t, i, a, s) {
       var n = e.globals.seriesCandleO[t][i],
        r = e.globals.seriesCandleH[t][i],
      ...
      value: function (e) {
       ...
       if (i && N(i) === 'object') {
        ...
        (o =
         ...
         (((i = this.checkForCatToNumericXAxis(this.chartType, o, i)).chart
          .sparkline &&
       ...
       var h = L.extend(r, window.Apex);
       return (n = L.extend(h, i)), (n = this.handleUserInputErrors(n));
      },
     },
     {
      ...
      value: function (e, t, i) {
       var a = new oe(i),
        ...
        n =
         ...
         e === 'radialBar' ||
         e === 'heatmap',
        r = i.xaxis.type !== 'datetime' && i.xaxis.type !== 'numeric',
        o = i.xaxis.tickPlacement
         ? i.xaxis.tickPlacement
         : t.xaxis && t.xaxis.tickPlacement;
       return (
        s || n || !r || o === 'between' || (i = a.convertCatToNumeric(i)), i
       );
      },
     },
     {
      ...
      value: function (e, t) {
       ...
       (e.yaxis === void 0 ||
        ...
        e.yaxis.constructor !== Array
         ? (e.yaxis = [L.extend(i.yAxis, e.yaxis)])
       ...
       return (
        ...
        a &&
         ...
         s.length &&
         (e.yaxis = s.map(function (n, r) {
          if ((n.name || (s[r].name = 'series-'.concat(r + 1)), e.yaxis[r]))
           return (e.yaxis[r].seriesName = s[r].name), e.yaxis[r];
          var o = L.extend(i.yAxis, e.yaxis[0]);
          return (o.show = !1), o;
         })),
        a &&
         s.length > 1 &&
     ...
     },
     {
      ...
      value: function (e) {
       return {
        ...
        panEnabled:
         e.chart.toolbar.autoSelected === 'pan' && e.chart.toolbar.tools.pan,
        selectionEnabled:
     ...
     },
     {
      ...
      value: function (e) {
       ...
       return (
        ...
        (t.initialConfig = L.extend({}, e)),
        (t.initialSeries = L.clone(e.series)),
        (t.lastXAxis = L.clone(t.initialConfig.xaxis)),
        (t.lastYAxis = L.clone(t.initialConfig.yaxis)),
        t
       );
      },
     },
    ...
    E(v, [
     {
      ...
      value: function () {
       ...
       return { config: e, globals: new Ye().init(e) };
      },
     },
    ]),
    v
     ...
     },
     {
      ...
      value: function (e, t) {
       for (
        var i = this.w.config,
         a = this.w.globals,
         s = i.chart.type === 'boxPlot' || i.series[t].type === 'boxPlot',
         n = 0;
        n < e[t].data.length;
        n++
       )
        if (
         (e[t].data[n][1] !== void 0 &&
          (Array.isArray(e[t].data[n][1]) && e[t].data[n][1].length === 4 && !s
           ? this.twoDSeries.push(L.parseNumber(e[t].data[n][1][3]))
           : e[t].data[n].length >= 5
             ? this.twoDSeries.push(L.parseNumber(e[t].data[n][4]))
             : this.twoDSeries.push(L.parseNumber(e[t].data[n][1])),
          (a.dataFormatXNumeric = !0)),
         i.xaxis.type === 'datetime')
        ) {
         var r = new Date(e[t].data[n][0]);
         (r = new Date(r).getTime()), this.twoDSeriesX.push(r);
        } else this.twoDSeriesX.push(e[t].data[n][0]);
       for (var o = 0; o < e[t].data.length; o++)
        e[t].data[o][2] !== void 0 &&
         (this.threeDSeries.push(e[t].data[o][2]), (a.isDataXYZ = !0));
      },
     },
     {
      key: 'handleFormatXY',
      value: function (e, t) {
       var i = this.w.config,
        ...
        s = new W(this.ctx),
        n = t;
       a.collapsedSeriesIndices.indexOf(t) > -1 && (n = this.activeSeriesIndex);
       for (var r = 0; r < e[t].data.length; r++)
        e[t].data[r].y !== void 0 &&
         (Array.isArray(e[t].data[r].y)
          ? this.twoDSeries.push(
             L.parseNumber(e[t].data[r].y[e[t].data[r].y.length - 1]),
            )
          : this.twoDSeries.push(L.parseNumber(e[t].data[r].y))),
         e[t].data[r].goals !== void 0 && Array.isArray(e[t].data[r].goals)
          ? (this.seriesGoals[t] === void 0 && (this.seriesGoals[t] = []),
            this.seriesGoals[t].push(e[t].data[r].goals))
          : (this.seriesGoals[t] === void 0 && (this.seriesGoals[t] = []),
            this.seriesGoals[t].push(null));
       for (var o = 0; o < e[n].data.length; o++) {
        var h = typeof e[n].data[o].x == 'string',
         c = Array.isArray(e[n].data[o].x),
         d = !c && !!s.isValidDate(e[n].data[o].x.toString());
        if (h || d)
         if (h || i.xaxis.convertedCatToNumeric) {
          var g = a.isBarHorizontal && a.isRangeData;
          i.xaxis.type !== 'datetime' || g
           ? ((this.fallbackToCategory = !0),
             this.twoDSeriesX.push(e[n].data[o].x))
           : this.twoDSeriesX.push(s.parseDate(e[n].data[o].x));
         } else
          i.xaxis.type === 'datetime'
           ? this.twoDSeriesX.push(s.parseDate(e[n].data[o].x.toString()))
           : ((a.dataFormatXNumeric = !0),
             (a.isXNumeric = !0),
             this.twoDSeriesX.push(parseFloat(e[n].data[o].x)));
        else
         c
          ? ((this.fallbackToCategory = !0),
            this.twoDSeriesX.push(e[n].data[o].x))
      ...
      value: function (e, t) {
       ...
       return (
        this.isFormat2DArray()
         ? (s = this.handleRangeDataFormat('array', e, t))
         : this.isFormatXY() && (s = this.handleRangeDataFormat('xy', e, t)),
        a.seriesRangeStart.push(s.start),
        a.seriesRangeEnd.push(s.end),
        i.xaxis.type === 'datetime' &&
         a.seriesRangeBarTimeline.push(s.rangeUniques),
        a.seriesRangeBarTimeline.forEach(function (n, r) {
         n &&
          n.forEach(function (o, h) {
           o.y.forEach(function (c, d) {
            for (var g = 0; g < o.y.length; g++)
             if (d !== g) {
              ...
              p <= o.y[g].y2 &&
               ...
               o.overlaps.indexOf(o.y[g].rangeName) < 0 &&
                o.overlaps.push(o.y[g].rangeName));
             }
           });
          });
        }),
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = [],
        s = [],
        n = t[i].data
         .filter(function (g, p, f) {
          return (
           p ===
           f.findIndex(function (x) {
            return x.x === g.x;
           })
          );
         })
        ...
        o = new j(this.ctx).getActiveConfigSeriesIndex();
       if (e === 'array') {
        if (t[o].data[0][1].length !== 2) throw new Error(r);
        for (var h = 0; h < t[i].data.length; h++)
         a.push(t[i].data[h][1][0]), s.push(t[i].data[h][1][1]);
       } else if (e === 'xy') {
        if (t[o].data[0].y.length !== 2) throw new Error(r);
        for (
         var c = function (g) {
           var p = L.randomId(),
            f = t[i].data[g].x,
            x = { y1: t[i].data[g].y[0], y2: t[i].data[g].y[1], rangeName: p };
           t[i].data[g].rangeName = p;
           var b = n.findIndex(function (y) {
            return y.x === f;
           });
           n[b].y.push(x), a.push(x.y1), s.push(x.y2);
          },
          d = 0;
         d < t[i].data.length;
         d++
      ...
      value: function (e, t, i) {
       var a = this.w,
        s =
         ...
         a.config.series[i].type === 'boxPlot',
        n = [],
        r = [],
        o = [],
        h = [],
       ...
       if (e === 'array')
        if (
         (s && t[i].data[0].length === 6) ||
         (!s && t[i].data[0].length === 5)
        )
          ...
          n.push(t[i].data[d][1]),
           ...
           s
            ? (o.push(t[i].data[d][3]),
              h.push(t[i].data[d][4]),
              c.push(t[i].data[d][5]))
            : (h.push(t[i].data[d][3]), c.push(t[i].data[d][4]));
        else
         for (var g = 0; g < t[i].data.length; g++)
          Array.isArray(t[i].data[g][1]) &&
           (n.push(t[i].data[g][1][0]),
           r.push(t[i].data[g][1][1]),
           s
            ? (o.push(t[i].data[g][1][2]),
              h.push(t[i].data[g][1][3]),
              c.push(t[i].data[g][1][4]))
            : (h.push(t[i].data[g][1][2]), c.push(t[i].data[g][1][3])));
       else if (e === 'xy')
        for (var p = 0; p < t[i].data.length; p++)
         Array.isArray(t[i].data[p].y) &&
          (n.push(t[i].data[p].y[0]),
          r.push(t[i].data[p].y[1]),
          s
           ? (o.push(t[i].data[p].y[2]),
             h.push(t[i].data[p].y[3]),
             c.push(t[i].data[p].y[4]))
           : (h.push(t[i].data[p].y[2]), c.push(t[i].data[p].y[3])));
       return { o: n, h: r, m: o, l: h, c };
      },
     },
     {
      ...
      value: function (e) {
       ...
       s.isTimelineBar =
        a.chart.type === 'rangeBar' && a.xaxis.type === 'datetime';
       for (
        var o = function () {
          for (var d = 0; d < r.length; d++)
           if (typeof r[d] == 'string') {
            if (!n.isValidDate(r[d]))
             throw new Error(
              'You have provided invalid Date format. Please provide a valid JavaScript Date',
             );
            t.twoDSeriesX.push(n.parseDate(r[d]));
           } else t.twoDSeriesX.push(r[d]);
         },
         h = 0;
        h < e.length;
        h++
        ...
        if (
         ((a.chart.type !== 'rangeBar' &&
          ...
          e[h].type !== 'rangeBar' &&
          e[h].type !== 'rangeArea') ||
          ((s.isRangeData = !0), this.handleRangeData(e, h)),
         this.isMultiFormat())
        )
         this.isFormat2DArray()
         ...
         a.xaxis.type === 'datetime'
          ...
          s.labels.push(this.twoDSeriesX);
         var c = e[h].data.map(function (d) {
          return L.parseNumber(d);
         });
         s.series.push(c);
        }
          ...
          : this.fallbackToCategory
            ? ((i.labels = i.labels[0]),
              i.seriesRangeBarTimeline.length &&
               (i.seriesRangeBarTimeline.map(function (a) {
                a.forEach(function (s) {
                 i.labels.indexOf(s.x) < 0 && s.x && i.labels.push(s.x);
                });
               }),
               (i.labels = i.labels.filter(function (a, s, n) {
                return n.indexOf(a) === s;
               }))),
              t.xaxis.convertedCatToNumeric &&
               (new oe(t).convertCatToNumericXaxis(t, this.ctx, i.seriesX[0]),
       ...
       if (t.axisCharts) {
        if (t.series.length > 0)
         for (var s = 0; s < t.series[t.maxValsInArrayIndex].length; s++)
          a.push(s + 1);
        t.seriesX = [];
        for (var n = 0; n < e.length; n++) t.seriesX.push(a);
        t.isXNumeric = !0;
       }
       if (a.length === 0) {
        a = t.axisCharts
         ? []
         : t.series.map(function (o, h) {
            return h + 1;
           });
        for (var r = 0; r < e.length; r++) t.seriesX.push(a);
       }
       (t.labels = a),
        i.xaxis.convertedCatToNumeric &&
         (t.categoryLabels = a.map(function (o) {
          return i.xaxis.labels.formatter(o);
         })),
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (
        ...
        i.chart.type === 'bar' && i.chart.stacked)
       ) {
       ...
       for (
        var n = this.coreUtils.getCategoryLabels(a.labels), r = 0;
        r < n.length;
        r++
       )
     ...
     },
     {
      ...
      value: function () {
       var e = this,
        t = this.w;
       return (
        (t.globals.xaxisTooltipFormatter = function (i) {
        ...
        t.config.xaxis.labels.formatter !== void 0
         ...
         : (t.globals.xLabelFormatter = function (i) {
            if (L.isNumber(i)) {
             if (
              !t.config.xaxis.convertedCatToNumeric &&
        ...
        t.config.yaxis.forEach(function (i, a) {
         i.labels.formatter !== void 0
          ? (t.globals.yLabelFormatters[a] = i.labels.formatter)
          : (t.globals.yLabelFormatters[a] = function (s) {
             return t.globals.xyCharts
              ? Array.isArray(s)
                ? s.map(function (n) {
                   return e.defaultYFormatter(n, i, a);
                  })
                : e.defaultYFormatter(s, i, a)
              : s;
            });
        }),
        t.globals
    ...
    E(v, [
     {
      ...
      value: function (e, t, i, a) {
       var s =
        ...
        p = new ge(this.ctx),
        f = o;
       (h = p.xLabelFormat(c, o, f, {
        i: a,
        dateFormatter: new W(this.ctx).formatDate,
        w: r,
       })),
        d !== void 0 &&
         (h = d(o, e[a], {
         ...
         t.forEach(function (u) {
          u.unit === 'month'
           ...
           : u.unit === 'day'
             ...
             : u.unit === 'hour'
               ? (l = 'day')
               : u.unit === 'minute' && (l = 'hour');
         }),
         l === A
        );
       };
       t.length > 0
        ? ((g = x(t[a].unit)), (i = t[a].position), (h = t[a].value))
        : r.config.xaxis.type === 'datetime' && d === void 0 && (h = ''),
        h === void 0 && (h = ''),
        (h = Array.isArray(h) ? h : h.toString());
       var b = new I(this.ctx),
        y = {};
       y = r.globals.rotateXLabels
        ? b.getTextRects(
           h,
           parseInt(n, 10),
           null,
        ...
        : b.getTextRects(h, parseInt(n, 10));
       var k = !r.config.xaxis.labels.showDuplicates && this.ctx.timeScale;
       return (
        !Array.isArray(h) &&
         (h.indexOf('NaN') === 0 ||
          h.toLowerCase().indexOf('invalid') === 0 ||
          h.toLowerCase().indexOf('infinity') >= 0 ||
          (s.indexOf(h) >= 0 && k)) &&
         (h = ''),
        { x: i, text: h, textRect: y, isBold: g }
       );
      },
     },
     {
      ...
      value: function (e, t, i) {
       ...
       return (
        s === 'dataPoints' && (s = Math.round(a.globals.gridWidth / 120)),
     ...
     },
     {
      ...
      value: function (e, t, i, a, s) {
       ...
       if (
        ...
        e === i - 1 && n.globals.skipLastTimelinelabel && (t.text = ''),
        n.config.xaxis.labels.hideOverlappingLabels && a.length > 0)
       ) {
        var r = s[s.length - 1];
        t.x <
         r.textRect.width /
      ...
      value: function (e, t, i, a, s, n, r) {
       ...
       if (a.show && t > 0) {
        ...
        for (var d = t; d >= 0; d--) {
         ...
         o.globals.isBarHorizontal && (g = n * d),
          o.config.chart.type === 'heatmap' && (g += n / 2);
         var p = h.drawLine(
      ...
      value: function (e) {
       ...
       return new Promise(function (i) {
        ...
        if (window.canvg && L.isIE11()) {
         var c = window.canvg.Canvg.fromString(o, h, {
          ignoreClear: !0,
          ignoreDimensions: !0,
         });
         c.start();
         ...
         var g = 'data:image/svg+xml,' + encodeURIComponent(h),
          p = new Image();
         (p.crossOrigin = 'anonymous'),
          (p.onload = function () {
           if ((o.drawImage(p, 0, 0), n.msToBlob)) {
            var f = n.msToBlob();
            i({ blob: f });
           } else {
            var x = n.toDataURL('image/png');
            i({ imgURI: x });
           }
          }),
          (p.src = g);
...
`
         ...
         if (r.globals.axisCharts) {
          if (
           ...
           if (r.globals.isBarHorizontal) {
            var b = r.globals.yLabelFormatters[0],
             y = new j(t.ctx).getActiveConfigSeriesIndex();
            x = b(r.globals.labels[f], {
             seriesIndex: y,
             dataPointIndex: f,
             w: r,
            });
          ...
          r.config.xaxis.type === 'datetime' &&
           (r.config.xaxis.categories.length
            ? (x = r.config.xaxis.categories[f])
            : r.config.labels.length && (x = r.config.labels[f]));
         } else x = r.config.labels[f];
         return (
          Array.isArray(x) && (x = x.join(' ')),
          L.isNumber(x) ? x : x.split(a).join('')
         );
        };
       o.push(r.config.chart.toolbar.export.csv.headerCategory),
        i.map(function (f, x) {
         var b = f.name ? f.name : 'series-'.concat(x);
         r.globals.axisCharts &&
          o.push(
           b.split(a).join('') ? b.split(a).join('') : 'series-'.concat(x),
          );
        }),
        r.globals.axisCharts ||
        ...
        i.map(function (f, x) {
         r.globals.axisCharts
          ? (function (b, y) {
             if (
              (o.length && y === 0 && h.push(o.join(a)),
              b.data && b.data.length)
             )
              for (var k = 0; k < b.data.length; k++) {
               o = [];
               var A = p(k);
               if (
                (A ||
                 (d.isFormatXY()
                  ? (A = i[y].data[k].x)
                  : d.isFormat2DArray() &&
                    (A = i[y].data[k] ? i[y].data[k][0] : '')),
                y === 0)
               ) {
                o.push(
                 ((u = A),
                 r.config.xaxis.type === 'datetime' && String(u).length >= 10
                  ? r.config.chart.toolbar.export.csv.dateFormatter(A)
                  : L.isNumber(A)
                    ? A
                    : A.split(a).join('')),
                );
                for (var l = 0; l < r.globals.series.length; l++)
                 o.push(r.globals.series[l][k]);
               }
               (r.config.chart.type === 'candlestick' ||
                (b.type && b.type === 'candlestick')) &&
                (o.pop(),
                o.push(r.globals.seriesCandleO[y][k]),
                o.push(r.globals.seriesCandleH[y][k]),
                o.push(r.globals.seriesCandleL[y][k]),
                o.push(r.globals.seriesCandleC[y][k])),
                (r.config.chart.type === 'boxPlot' ||
                 (b.type && b.type === 'boxPlot')) &&
                 (o.pop(),
                 o.push(r.globals.seriesCandleO[y][k]),
                 o.push(r.globals.seriesCandleH[y][k]),
                 o.push(r.globals.seriesCandleM[y][k]),
                 o.push(r.globals.seriesCandleL[y][k]),
                 o.push(r.globals.seriesCandleC[y][k])),
                r.config.chart.type === 'rangeBar' &&
                 (o.pop(),
                 o.push(r.globals.seriesRangeStart[y][k]),
                 o.push(r.globals.seriesRangeEnd[y][k])),
                o.length && h.push(o.join(a));
              }
             var u;
            })(f, x)
          : ((o = []).push(r.globals.labels[x].split(a).join('')),
            o.push(r.globals.series[x]),
            h.push(o.join(a)));
        }),
        (c += h.join(n)),
        this.triggerDownload(
   ...
   function v(e) {
    ...
    (this.axesUtils = new J(e)),
     ...
     t.config.xaxis.position === 'top'
      ? (this.offY = 0)
      : (this.offY = t.globals.gridHeight + 1),
     ...
     this.isCategoryBarHorizontal &&
      (this.xaxisBorderWidth = t.config.yaxis[0].axisBorder.width.toString()),
     this.xaxisBorderWidth.indexOf('%') > -1
      ? (this.xaxisBorderWidth =
         (t.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10)) / 100)
    ...
    E(v, [
     {
      ...
      value: function () {
       ...
       s.add(n);
       for (
        var r = i.globals.padHorizontal, o = [], h = 0;
        h < this.xaxisLabels.length;
        h++
       )
        o.push(this.xaxisLabels[h]);
       var c = o.length;
       if (i.globals.isXNumeric) {
        var d = c > 1 ? c - 1 : c;
        (e = i.globals.gridWidth / d),
         (r = r + e / 2 + i.config.xaxis.labels.offsetX);
       } else
        (e = i.globals.gridWidth / o.length),
         (r = r + e + i.config.xaxis.labels.offsetX);
       for (
        var g = function (k) {
          var A = r - e / 2 + i.config.xaxis.labels.offsetX;
          k === 0 &&
           c === 1 &&
           e / 2 === r &&
           i.globals.dataPoints === 1 &&
           (A = i.globals.gridWidth / 2);
          var l = t.axesUtils.getLabel(
            o,
           ...
           u = 28;
          if (
           (i.globals.rotateXLabels && (u = 22),
           (l =
            i.config.xaxis.tickAmount !== void 0 &&
            i.config.xaxis.tickAmount !== 'dataPoints' &&
            i.config.xaxis.type !== 'datetime'
             ? t.axesUtils.checkLabelBasedOnTickamount(k, l, c)
             : t.axesUtils.checkForOverflowingLabels(
                k,
                l,
                c,
                t.drawnLabels,
           ...
           var m = a.drawText({
            ...
            text: l.text,
            textAnchor: 'middle',
            fontWeight: l.isBold ? 600 : i.config.xaxis.labels.style.fontWeight,
            fontSize: t.xaxisFontSize,
            fontFamily: t.xaxisFontFamily,
            foreColor: Array.isArray(t.xaxisForeColors)
             ? i.config.xaxis.convertedCatToNumeric
               ? t.xaxisForeColors[i.globals.minX + k - 1]
               : t.xaxisForeColors[k]
             : t.xaxisForeColors,
            isPlainText: !1,
            cssClass:
             'apexcharts-xaxis-label ' + i.config.xaxis.labels.style.cssClass,
           });
           n.add(m);
           var w = document.createElementNS(i.globals.SVGNS, 'title');
           (w.textContent = Array.isArray(l.text) ? l.text.join(' ') : l.text),
            m.node.appendChild(w),
            l.text !== '' &&
             (t.drawnLabels.push(l.text), t.drawnLabelsRects.push(l));
          }
          r += e;
         },
         p = 0;
       ...
       if (i.config.xaxis.title.text !== void 0) {
        var f = a.group({ class: 'apexcharts-xaxis-title' }),
         x = a.drawText({
          ...
          cssClass:
           'apexcharts-xaxis-title-text ' + i.config.xaxis.title.style.cssClass,
         });
        f.add(x), s.add(f);
       }
       if (i.config.xaxis.axisBorder.show) {
        var b = i.globals.barPadForNumericAxis,
         y = a.drawLine(
          i.globals.padHorizontal + i.config.xaxis.axisBorder.offsetX - b,
          this.offY,
     ...
     },
     {
      ...
      value: function (e) {
       var t,
        ...
        s = this.w,
        n = new I(this.ctx),
        r = s.config.yaxis[0].opposite ? s.globals.translateYAxisX[e] : 0,
        o = n.group({
       ...
       if (p.show)
        for (
         var f = function (u) {
           var m = c[u] === void 0 ? '' : c[u];
           m = g(m, { seriesIndex: e, dataPointIndex: u, w: s });
           var w = a.axesUtils.getYAxisForeColor(p.style.colors, e),
            S = 0;
           Array.isArray(m) &&
            (S = (m.length / 2) * parseInt(p.style.fontSize, 10));
           var P = n.drawText({
            x: p.offsetX - 15,
            y: i + t + p.offsetY - S,
            text: m,
           ...
           h.add(P);
           var C = document.createElementNS(s.globals.SVGNS, 'title');
           if (
            ((C.textContent = Array.isArray(m) ? m.join(' ') : m),
            P.node.appendChild(C),
            s.config.yaxis[e].labels.rotate !== 0)
           ) {
            var M = n.rotateAroundCenter(P.node);
            P.node.setAttribute(
             'transform',
             'rotate('
       ...
       this.isCategoryBarHorizontal &&
        ...
        (k = s.globals.gridWidth);
       var A = s.config.xaxis.axisBorder;
       if (A.show) {
        var l = n.drawLine(
         s.globals.padHorizontal + A.offsetX + k,
         1 + A.offsetY,
         s.globals.padHorizontal + A.offsetX + k,
         s.globals.gridHeight + A.offsetY,
         A.color,
         0,
        );
        o.add(l);
      ...
      value: function (e, t) {
       ...
       if (!(e < 0 || e - 2 > i.globals.gridWidth)) {
        ...
        if (
         ...
         t.add(r), r.node.classList.add('apexcharts-xaxis-tick');
        }
       }
      },
     },
      ...
      value: function () {
       ...
       if (e.globals.timescaleLabels.length > 0)
        ...
        for (var n = i, r = 0; r < n; r++) {
         var o = n;
         e.globals.isXNumeric && e.config.chart.type !== 'bar' && (o -= 1),
      ...
      value: function () {
       ...
       if (e.globals.rotateXLabels || e.config.xaxis.labels.rotateAlways)
        for (var r = 0; r < a.length; r++) {
         var o = t.rotateAroundCenter(a[r]);
         (o.y = o.y - 1),
          (o.x = o.x + 1),
          a[r].setAttribute(
           'transform',
         ...
         var h = a[r].childNodes;
         e.config.xaxis.labels.trim &&
          Array.prototype.forEach.call(h, function (p) {
        ...
        (function () {
         for (
          var p = e.globals.gridWidth / (e.globals.labels.length + 1), f = 0;
          f < a.length;
          f++
         ) {
          var x = a[f].childNodes;
          e.config.xaxis.labels.trim &&
           e.config.xaxis.type !== 'datetime' &&
           Array.prototype.forEach.call(x, function (b) {
       ...
       if (s.length > 0) {
        var c = s[s.length - 1].getBBox(),
         d = s[0].getBBox();
        c.x < -20 && s[s.length - 1].parentNode.removeChild(s[s.length - 1]),
     ...
     },
     {
      ...
      value: function () {
       ...
       (n === 'bar' ||
        ...
        !e.globals.isBarHorizontal &&
        ((r = e.config.grid.padding.left),
        (o = e.config.grid.padding.right),
        t.barPadForNumericAxis > r &&
         ((r = t.barPadForNumericAxis), (o = t.barPadForNumericAxis))),
        ...
        new D(this).getLargestMarkerSize();
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.i,
        ...
        o = e.parent,
        h = this.w;
       (t === 0 && h.globals.skipFirstTimelinelabel) ||
        (t === r - 1 &&
         h.globals.skipLastTimelinelabel &&
         !h.config.xaxis.labels.formatter) ||
        h.config.chart.type === 'radar' ||
        (h.config.grid.xaxis.lines.show &&
         this._drawGridLine({ x1: i, y1: a, x2: s, y2: n, parent: o }),
        new he(this.ctx).drawXaxisTicks(i, this.elg));
      },
     },
     {
      key: '_drawGridLine',
      value: function (e) {
       ...
       d.node.classList.add('apexcharts-gridline'), n.add(d);
      },
     },
     {
      ...
      value: function (e) {
       ...
       if (r !== 'column' || o.config.xaxis.type !== 'datetime') {
        var d = o.config.grid[r].colors[t],
         g = h.drawRect(
          i - (r === 'row' ? c : 0),
          a,
          s + (r === 'row' ? 2 * c : 0),
        ...
        this.elg.add(g),
         ...
         g.node.classList.add('apexcharts-grid-'.concat(r));
       }
      },
     },
     {
      ...
      value: function (e) {
       ...
       if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
        var n,
         r = s.globals.padHorizontal,
         o = s.globals.gridHeight;
        s.globals.timescaleLabels.length
         ? (function (f) {
            for (
             var x = f.xC, b = f.x1, y = f.y1, k = f.x2, A = f.y2, l = 0;
             l < x;
             l++
            )
             (b = t.xaxisLabels[l].position),
              (k = t.xaxisLabels[l].position),
              t._drawGridLines({
               i: l,
               x1: b,
               y1: y,
         ...
         : (s.globals.isXNumeric && (i = s.globals.xAxisScale.result.length),
           ...
           (function (f) {
            ...
            if (
             ...
             for (var l = 0; l < x + (s.globals.isXNumeric ? 0 : 1); l++)
              l === 0 &&
               x === 1 &&
               s.globals.dataPoints === 1 &&
               (k = b = s.globals.gridWidth / 2),
               t._drawGridLines({
                i: l,
                x1: b,
                y1: y,
               ...
               (k = b +=
                s.globals.gridWidth / (s.globals.isXNumeric ? x - 1 : x));
           })({ xC: i, x1: r, y1: 0, x2: n, y2: o }));
       }
       if (s.config.grid.yaxis.lines.show) {
        var h = 0,
         ...
         g = a + 1;
        this.isTimelineBar && (g = s.globals.labels.length);
        for (var p = 0; p < g + (this.isTimelineBar ? 1 : 0); p++)
         this._drawGridLine({
          x1: 0,
          y1: h,
          x2: d,
          ...
          (c = h += s.globals.gridHeight / (this.isTimelineBar ? g : a));
       }
      },
     },
     {
      ...
      value: function (e) {
       ...
       if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
        for (
         var a, s = i.globals.padHorizontal, n = i.globals.gridHeight, r = 0;
         r < t + 1;
         r++
        )
         i.config.grid.xaxis.lines.show &&
          ...
          new he(this.ctx).drawXaxisTicks(s, this.elg),
          (a = s = s + i.globals.gridWidth / t + 0.3);
       if (i.config.grid.yaxis.lines.show)
        for (
         var o = 0, h = 0, c = i.globals.gridWidth, d = 0;
         d < i.globals.dataPoints + 1;
         d++
        )
         this._drawGridLine({
          x1: 0,
     ...
     },
     {
      ...
      value: function () {
       ...
       for (
        ...
        (e.globals.yAxisScale[s] !== void 0 &&
         (a = e.globals.yAxisScale[s].result.length - 1),
        !(a > 2));
        s++
       );
       return (
        !e.globals.isBarHorizontal || this.isTimelineBar
         ? ((i = this.xaxisLabels.length),
           this.isTimelineBar &&
        ...
        { el: this.elg, xAxisTickWidth: e.globals.gridWidth / i }
       );
      },
     },
     {
      ...
      value: function (e, t) {
       var i = this.w;
       if (
        i.config.grid.row.colors !== void 0 &&
       ...
       if (
        i.config.grid.column.colors !== void 0 &&
        ...
        for (
         var h =
          ...
          d = i.globals.padHorizontal + i.globals.gridWidth / h,
          g = i.globals.gridHeight,
          p = 0,
          f = 0;
         p < e;
         p++, f++
    ...
    E(v, [
     {
      ...
      value: function (e, t) {
       var i =
         arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 10,
        a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0,
        s = arguments.length > 4 ? arguments[4] : void 0,
        n = this.w,
        r = Math.abs(t - e);
       if (
        ((i = this._adjustTicksForSmallRange(i, a, r)) === 'dataPoints' &&
         (i = n.globals.dataPoints - 1),
        (e === Number.MIN_VALUE && t === 0) ||
         (!L.isNumber(e) && !L.isNumber(t)) ||
       ...
       e > t
        ? (console.warn('axis.min cannot be greater than axis.max'),
          (t = e + 0.1))
        : e === t && ((e = e === 0 ? 0 : e - 0.5), (t = t === 0 ? 2 : t + 0.5));
       var h = [];
       r < 1 &&
        s &&
        (n.config.chart.type === 'candlestick' ||
         n.config.series[a].type === 'candlestick' ||
         n.config.chart.type === 'boxPlot' ||
         n.config.series[a].type === 'boxPlot' ||
         n.globals.isRangeData) &&
        (t *= 1.01);
       var c = i + 1;
       c < 2 ? (c = 2) : c > 2 && (c -= 2);
       var d = r / c,
        g = Math.floor(L.log10(d)),
        p = Math.pow(10, g),
        f = Math.round(d / p);
       f < 1 && (f = 1);
       var x = f * p,
     ...
     },
     {
      ...
      value: function (e, t) {
       var i =
        ...
        s = Math.abs(t - e);
       (i = this._adjustTicksForSmallRange(i, a, s)) === 'dataPoints' &&
        (i = this.w.globals.dataPoints - 1);
       var n = s / i;
       i === Number.MAX_VALUE && ((i = 10), (n = 1));
       for (var r = [], o = e; i >= 0; ) r.push(o), (o += n), (i -= 1);
     ...
     },
     {
      ...
      value: function (e) {
       for (var t = [], i = Math.ceil(Math.log10(e)) + 1, a = 0; a < i; a++)
        t.push(Math.pow(10, a));
       return { result: t, niceMin: t[0], niceMax: t[t.length - 1] };
      },
     },
     {
      ...
      value: function (e, t, i) {
       ...
       if (
        ...
        var s = this.w.config.yaxis[t].labels.formatter(1);
        L.isNumber(Number(s)) && !L.isFloat(s) && (a = Math.ceil(i));
       }
       return a < e ? a : e;
      },
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.w.globals,
        s = this.w.config,
        n = a.isBarHorizontal ? s.xaxis : s.yaxis[e];
       ...
       if (
        ...
        (a.allSeriesCollapsed = !1),
         (a.yAxisScale[e] = this.logarithmicScale(i));
       else if (i !== -Number.MAX_VALUE && L.isNumber(i))
        if (
         ((a.allSeriesCollapsed = !1),
         (n.min === void 0 && n.max === void 0) || n.forceNiceScale)
        ) {
         var o =
          (s.yaxis[e].max === void 0 && s.yaxis[e].min === void 0) ||
          s.yaxis[e].forceNiceScale;
        ...
        } else a.yAxisScale[e] = this.linearScale(t, i, n.tickAmount, e);
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = this.w,
        ...
        n = Math.abs(t - e);
       return (
        t !== -Number.MAX_VALUE && L.isNumber(t)
       ...
       i.yaxis.forEach(function (r, o) {
        ...
        i.series.forEach(function (g, p) {
         g.name === r.seriesName &&
          ((h = p),
          o !== p
           ? n.push({ index: p, similarIndex: o, alreadyExists: !0 })
           : n.push({ index: p }));
        });
        var c = a[h],
         d = s[h];
     ...
     },
     {
      ...
      value: function (e, t, i) {
       ...
       i.forEach(function (x) {
        x.alreadyExists &&
         (r[x.index] === void 0 && (r[x.index] = []),
         r[x.index].push(x.index),
         r[x.index].push(x.similarIndex));
       }),
        (n.yAxisSameScaleIndices = r),
        r.forEach(function (x, b) {
       ...
       var o = r
        .map(function (x) {
         return x.filter(function (b, y) {
          return x.indexOf(b) === y;
         });
        })
        .map(function (x) {
         return x.sort();
       ...
       h = h.filter(function (x, b) {
        return c.indexOf(JSON.stringify(x)) === b;
       });
       var d = [],
        g = [];
       e.forEach(function (x, b) {
        h.forEach(function (y, k) {
         y.indexOf(b) > -1 &&
          (d[k] === void 0 && ((d[k] = []), (g[k] = [])),
          d[k].push({ key: b, value: x }),
          g[k].push({ key: b, value: t[b] }));
        });
       });
       var p = Array.apply(null, Array(h.length)).map(
         Number.prototype.valueOf,
         Number.MIN_VALUE,
        ),
        f = Array.apply(null, Array(h.length)).map(
         Number.prototype.valueOf,
         -Number.MAX_VALUE,
        );
       d.forEach(function (x, b) {
        x.forEach(function (y, k) {
         p[b] = Math.min(y.value, p[b]);
        });
       }),
        g.forEach(function (x, b) {
         x.forEach(function (y, k) {
          f[b] = Math.max(y.value, f[b]);
         });
        }),
        e.forEach(function (x, b) {
         g.forEach(function (y, k) {
          var A = p[k],
           l = f[k];
          s.chart.stacked &&
           ((l = 0),
           y.forEach(function (u, m) {
            u.value !== -Number.MAX_VALUE && (l += u.value),
             A !== Number.MIN_VALUE && (A += d[k][m].value);
           })),
           y.forEach(function (u, m) {
            y[m].key === b &&
             (s.yaxis[b].min !== void 0 &&
              (A =
               typeof s.yaxis[b].min == 'function'
                ? s.yaxis[b].min(n.minY)
                : s.yaxis[b].min),
             s.yaxis[b].max !== void 0 &&
              (l =
               typeof s.yaxis[b].max == 'function'
                ? s.yaxis[b].max(n.maxY)
                : s.yaxis[b].max),
             a.setYScaleForIndex(b, A, l));
           });
         });
        });
      },
      ...
      value: function (e, t, i) {
       ...
       return (
        t.forEach(function (r, o) {
         ...
         var d,
          g,
          p = a.globals.minYArr[o],
          f = a.globals.maxYArr[o],
          x = a.globals.stackedSeriesTotals;
         a.globals.series.forEach(function (b, y) {
          var k = b[h];
          n
           ? ((k = x[h]),
             (d = g = k),
             x.forEach(function (A, l) {
              s[l] <= i.xaxis.max &&
               s[l] >= i.xaxis.min &&
               (A > g && A !== null && (g = A),
               b[l] < d && b[l] !== null && (d = b[l]));
             }))
           : ((d = g = k),
             b.forEach(function (A, l) {
              if (s[l] <= i.xaxis.max && s[l] >= i.xaxis.min) {
               var u = A,
                m = A;
               a.globals.series.forEach(function (w, S) {
                A !== null &&
                 ((u = Math.min(w[l], u)), (m = Math.max(w[l], m)));
               }),
                m > g && m !== null && (g = m),
                u < d && u !== null && (d = u);
              }
             })),
           d === void 0 && g === void 0 && ((d = p), (g = f)),
           (g *= g < 0 ? 0.9 : 1.1) < 0 && g < f && (g = f),
           (d *= d < 0 ? 1.1 : 0.9) < 0 && d > p && (d = p),
           t.length > 1
            ? ((t[y].min = r.min === void 0 ? d : r.min),
              (t[y].max = r.max === void 0 ? g : r.max))
            : ((t[0].min = r.min === void 0 ? d : r.min),
              (t[0].max = r.max === void 0 ? g : r.max));
         });
        }),
        t
       );
  ...
  ye = (function () {
   function v(e) {
    X(this, v), (this.ctx = e), (this.w = e.w), (this.scales = new ie(e));
   }
   return (
    E(v, [
     {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       s.chart.type === 'candlestick'
        ? ((c = n.seriesCandleL), (d = n.seriesCandleH))
        : s.chart.type === 'boxPlot'
          ? ((c = n.seriesCandleO), (d = n.seriesCandleC))
          : n.isRangeData && ((c = n.seriesRangeStart), (d = n.seriesRangeEnd));
       for (var g = e; g < a; g++) {
        n.dataPoints = Math.max(n.dataPoints, h[g].length);
        for (var p = 0; p < n.series[g].length; p++) {
         var f = h[g][p];
         f !== null && L.isNumber(f)
          ? (d[g][p] !== void 0 && (r = Math.max(r, d[g][p])),
            c[g][p] !== void 0 &&
             ((t = Math.min(t, c[g][p])), (i = Math.max(i, c[g][p]))),
            (this.w.config.chart.type !== 'candlestick' &&
             this.w.config.chart.type !== 'boxPlot') ||
             (n.seriesCandleC[g][p] !== void 0 &&
              ((r = Math.max(r, n.seriesCandleO[g][p])),
              (r = Math.max(r, n.seriesCandleH[g][p])),
              (r = Math.max(r, n.seriesCandleL[g][p])),
              (r = Math.max(r, n.seriesCandleC[g][p])),
              this.w.config.chart.type === 'boxPlot' &&
               (r = Math.max(r, n.seriesCandleM[g][p]))),
             !s.series[g].type ||
              (s.series[g].type === 'candlestick' &&
               s.series[g].type === 'boxPlot') ||
              ((r = Math.max(r, n.series[g][p])),
              (t = Math.min(t, n.series[g][p]))),
             (i = r)),
            n.seriesGoals[g] &&
             n.seriesGoals[g][p] &&
             Array.isArray(n.seriesGoals[g][p]) &&
             n.seriesGoals[g][p].forEach(function (x) {
              o !== Number.MIN_VALUE && ((o = Math.min(o, x.value)), (t = o)),
               (r = Math.max(r, x.value)),
               (i = r);
             }),
            L.isFloat(f) &&
             ((f = L.noExponents(f)),
       ...
       return (
        s.chart.type === 'rangeBar' &&
         ...
         (o = t),
        s.chart.type === 'bar' &&
         (o < 0 && r < 0 && (r = 0), o === Number.MIN_VALUE && (o = 0)),
        { minY: o, maxY: r, lowestY: t, highestY: i }
       );
      },
     },
     {
      ...
      value: function () {
       ...
       var n = this.getMinYMaxY(0, i, null, e.series.length);
       if (
        ((e.minY = n.minY),
        (e.maxY = n.maxY),
        (i = n.lowestY),
        ...
        var r = e.maxY - i;
        ((i >= 0 && i <= 10) ||
         t.yaxis[0].min !== void 0 ||
         t.yaxis[0].max !== void 0) &&
         (r = 0),
         (e.minY = i - (5 * r) / 100),
         i > 0 && e.minY < 0 && (e.minY = 0),
         (e.maxY = e.maxY + (5 * r) / 100);
       }
       return (
        t.yaxis.forEach(function (o, h) {
         o.max !== void 0 &&
          (typeof o.max == 'number'
           ? (e.maxYArr[h] = o.max)
           : typeof o.max == 'function' &&
             (e.maxYArr[h] = o.max(e.isMultipleYAxis ? e.maxYArr[h] : e.maxY)),
          (e.maxY = e.maxYArr[h])),
          o.min !== void 0 &&
           (typeof o.min == 'number'
            ? (e.minYArr[h] = o.min)
            : typeof o.min == 'function' &&
              (e.minYArr[h] = o.min(
               e.isMultipleYAxis
                ? e.minYArr[h] === Number.MIN_VALUE
                  ? 0
                  : e.minYArr[h]
                : e.minY,
              )),
        ...
        e.isBarHorizontal &&
         ['min', 'max'].forEach(function (o) {
          t.xaxis[o] !== void 0 &&
           typeof t.xaxis[o] == 'number' &&
           (o === 'min' ? (e.minY = t.xaxis[o]) : (e.maxY = t.xaxis[o]));
         }),
        e.isMultipleYAxis
     ...
     },
     {
      ...
      value: function () {
       ...
       if (
        (e.isXNumeric &&
         (function () {
          for (var r = 0; r < e.series.length; r++)
           if (e.labels[r])
            for (var o = 0; o < e.labels[r].length; o++)
             e.labels[r][o] !== null &&
              L.isNumber(e.labels[r][o]) &&
              ((e.maxX = Math.max(e.maxX, e.labels[r][o])),
              (e.initialMaxX = Math.max(e.maxX, e.labels[r][o])),
              (e.minX = Math.min(e.minX, e.labels[r][o])),
              (e.initialMinX = Math.min(e.minX, e.labels[r][o])));
         })(),
        e.noLabelsProvided &&
         t.xaxis.categories.length === 0 &&
        ...
        var a;
        if (
         (t.xaxis.tickAmount === void 0
          ? ((a = Math.round(e.svgWidth / 150)),
            t.xaxis.type === 'numeric' &&
             e.dataPoints < 30 &&
             (a = e.dataPoints - 1),
            a > e.dataPoints && e.dataPoints !== 0 && (a = e.dataPoints - 1))
          : t.xaxis.tickAmount === 'dataPoints'
            ? (e.series.length > 1 &&
               (a = e.series[e.maxValsInArrayIndex].length - 1),
              e.isXNumeric && (a = e.maxX - e.minX - 1))
         ...
         (e.xAxisScale = this.scales.linearScale(1, a, a)),
          e.noLabelsProvided &&
           e.labels.length > 0 &&
           ((e.xAxisScale = this.scales.linearScale(1, e.labels.length, a - 1)),
      ...
      value: function () {
       ...
       if (e.minX === e.maxX) {
        ...
        if (t.xaxis.type === 'datetime') {
         ...
         a.setUTCDate(a.getDate() - 2), (e.minX = new Date(a).getTime());
         var s = i.getDate(e.maxX);
         s.setUTCDate(s.getDate() + 2), (e.maxX = new Date(s).getTime());
        } else
         (t.xaxis.type === 'numeric' ||
          (t.xaxis.type === 'category' && !e.noLabelsProvided)) &&
          ((e.minX = e.minX - 2),
        ...
        e.seriesX.forEach(function (t, i) {
         ...
         a.sort(function (s, n) {
          ...
          a.forEach(function (s, n) {
           if (n > 0) {
            var r = s - a[n - 1];
            r > 0 && (e.minXDiff = Math.min(r, e.minXDiff));
           }
          }),
          e.dataPoints === 1 &&
           e.minXDiff === Number.MAX_VALUE &&
     ...
     },
     {
      ...
      value: function () {
       var e = this.w.globals,
        ...
        i = [];
       if (e.series.length)
        for (var a = 0; a < e.series[e.maxValsInArrayIndex].length; a++)
         for (var s = 0, n = 0, r = 0; r < e.series.length; r++)
          e.series[r][a] !== null &&
           L.isNumber(e.series[r][a]) &&
           (e.series[r][a] > 0
            ? (s = s + parseFloat(e.series[r][a]) + 1e-4)
            : (n += parseFloat(e.series[r][a]))),
           r === e.series.length - 1 && (t.push(s), i.push(n));
       for (var o = 0; o < t.length; o++)
        (e.maxY = Math.max(e.maxY, t[o])), (e.minY = Math.min(e.minY, i[o]));
      },
     },
    ]),
    v
   ...
   function v(e) {
    ...
    (this.xaxisFontSize = t.config.xaxis.labels.style.fontSize),
     ...
     t.config.xaxis.position === 'bottom' &&
      (this.xAxisoffX = t.globals.gridHeight),
     (this.drawnLabels = []),
     (this.axesUtils = new J(e));
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       ...
       if (this.axesUtils.isYAxisHidden(e)) return h;
        ...
        for (
         var y = function (P) {
           ...
           i.config.yaxis[e].opposite &&
            i.config.yaxis.length !== 0 &&
            (M *= -1);
           var T = t.axesUtils.getYAxisForeColor(s.colors, e),
            z = a.drawText({
             x: M,
             ...
             fontFamily: r,
             fontWeight: o,
             foreColor: Array.isArray(T) ? T[P] : T,
             isPlainText: !1,
           ...
           if (
            ((Y.textContent = Array.isArray(C) ? C.join(' ') : C),
            z.node.appendChild(Y),
            i.config.yaxis[e].labels.rotate !== 0)
           ) {
            var H = a.rotateAroundCenter(b.node),
             R = a.rotateAroundCenter(z.node);
            z.node.setAttribute(
             'transform',
             'rotate('
       ...
       if (i.config.yaxis[e].title.text !== void 0) {
        var A = a.group({ class: 'apexcharts-yaxis-title' }),
         l = 0;
        i.config.yaxis[e].opposite && (l = i.globals.translateYAxisX[e]);
        var u = a.drawText({
         x: l,
         y:
       ...
       var m = i.config.yaxis[e].axisBorder,
        w = 31 + m.offsetX;
       if ((i.config.yaxis[e].opposite && (w = -31 - m.offsetX), m.show)) {
        var S = a.drawLine(
         w,
         i.globals.translateY + m.offsetY - 2,
         w,
         i.globals.gridHeight + i.globals.translateY + m.offsetY + 2,
         m.color,
         0,
         m.width,
        );
       ...
       if (t.config.xaxis.labels.show)
        for (var p = g ? 0 : n; g ? p < g : p >= 0; g ? p++ : p--) {
         ...
         if (d.length) {
          ...
          (x = b.x),
           (f = b.text),
           this.drawnLabels.push(b.text),
           p === 0 && t.globals.skipFirstTimelinelabel && (f = ''),
           p === c.length - 1 && t.globals.skipLastTimelinelabel && (f = '');
         }
         var y = i.drawText({
          x,
          y:
           ...
           30 -
           (t.config.xaxis.position === 'top'
            ? t.globals.xAxisHeight + t.config.xaxis.axisTicks.height - 2
            : 0),
          text: f,
          textAnchor: 'middle',
          ...
          isPlainText: !1,
          cssClass:
           'apexcharts-xaxis-label ' + t.config.xaxis.labels.style.cssClass,
         });
         s.add(y), y.tspan(f);
         var k = document.createElementNS(t.globals.SVGNS, 'title');
         (k.textContent = f), y.node.appendChild(k), (o += r);
        }
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (a.show) {
        ...
        var n = i.drawLine(
         t.globals.padHorizontal + s + a.offsetX,
         this.xAxisoffX,
         t.globals.gridWidth,
         this.xAxisoffX,
         a.color,
       ...
       if (t.config.xaxis.title.text !== void 0) {
        var a = i.group({
         ...
         s = i.drawText({
          ...
          cssClass:
           'apexcharts-xaxis-title-text ' + t.config.xaxis.title.style.cssClass,
         });
        a.add(s), e.add(a);
       }
      },
     },
     {
      ...
      value: function (e, t) {
       var i = this.w,
        ...
        n = { width: 0, height: 0 },
        r = i.globals.dom.baseEl.querySelector(
         " .apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-texts-g"),
        );
       r !== null && (s = r.getBoundingClientRect());
       var o = i.globals.dom.baseEl.querySelector(
        ".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-title text"),
       );
       if ((o !== null && (n = o.getBoundingClientRect()), o !== null)) {
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       ...
       return s.config.yaxis[e].title.text === void 0 || e < 0
        ...
        : (a
           ? ((r =
              t.width + s.config.yaxis[e].title.offsetX + i.width / 2 + o / 2),
             (n += 1) === 0 && (r -= o / 2))
           : ((r =
              -1 * t.width +
             ...
             s.globals.isBarHorizontal &&
              ((o = 25),
              (r = -1 * t.width - s.config.yaxis[e].title.offsetX - o))),
          { xPos: r, padd: o });
      },
     },
     {
      ...
      value: function (e, t) {
       ...
       i.config.yaxis.length > 1 && (this.multipleYs = !0),
        i.config.yaxis.map(function (o, h) {
         var c =
           i.globals.ignoreYAxisIndexes.indexOf(h) > -1 ||
           !o.show ||
           o.floating ||
           e[h].width === 0,
          d = e[h].width + t[h].width;
         o.opposite
          ? i.globals.isBarHorizontal
            ? ((s = i.globals.gridWidth + i.globals.translateX - 1),
              (i.globals.translateYAxisX[h] = s - o.labels.offsetX))
            : ((s = i.globals.gridWidth + i.globals.translateX + r),
              c || (r = r + d + 20),
              (i.globals.translateYAxisX[h] = s - o.labels.offsetX + 20))
     ...
     },
     {
      ...
      value: function () {
       ...
       (t = L.listToArray(t)).forEach(function (i, a) {
        var s = e.config.yaxis[a];
        if (s && s.labels.align !== void 0) {
         var n = e.globals.dom.baseEl.querySelector(
           ".apexcharts-yaxis[rel='".concat(a, "'] .apexcharts-yaxis-texts-g"),
          ),
          r = e.globals.dom.baseEl.querySelectorAll(
           ".apexcharts-yaxis[rel='".concat(a, "'] .apexcharts-yaxis-label"),
          );
         r = L.listToArray(r);
         ...
         s.labels.align === 'left'
          ? (r.forEach(function (h, c) {
            ...
            s.opposite ||
             n.setAttribute('transform', 'translate(-'.concat(o.width, ', 0)')))
          : s.labels.align === 'center'
            ? (r.forEach(function (h, c) {
              ...
              n.setAttribute(
               'transform',
               'translate('.concat(
                (o.width / 2) * (s.opposite ? 1 : -1),
                ', 0)',
               ),
              ))
            : s.labels.align === 'right' &&
              (r.forEach(function (h, c) {
    ...
    E(v, [
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       if (i.globals.events.hasOwnProperty(e)) {
        (t && t.length) || (t = []);
        for (var a = i.globals.events[e], s = a.length, n = 0; n < s; n++)
         a[n].apply(null, t);
       }
      },
     },
      ...
      value: function (e, t) {
       ...
       s.axisCharts &&
        ...
        (s.isBarHorizontal
         ...
         : ((i = r.drawXaxis()),
           s.dom.elGraphical.add(i),
           n.yaxis.map(function (h, c) {
            s.ignoreYAxisIndexes.indexOf(c) === -1 &&
             ((a = o.drawYaxis(c)), s.dom.Paper.add(a));
           })));
      },
     },
    ]),
    ...
    E(v, [
     {
      ...
      value: function () {
       var e = this.w,
        ...
        b = s.color,
        y = s.opacity,
        k = e.config.xaxis.crosshairs.fill.color;
       if (e.config.xaxis.crosshairs.show) {
        n === 'gradient' &&
         (k = t.drawGradient('vertical', r, o, h, c, null, d, null));
        var A = t.drawRect();
        e.config.xaxis.crosshairs.width === 1 && (A = t.drawLine());
        var l = e.globals.gridHeight;
        (!L.isNumber(l) || l < 0) && (l = 0);
        var u = e.config.xaxis.crosshairs.width;
        (!L.isNumber(u) || u < 0) && (u = 0),
         A.attr({
    ...
    E(v, [
     {
      ...
      value: function (e) {
       ...
       if (a.responsive.length !== 0) {
        ...
        s.sort(function (h, c) {
         return h.breakpoint > c.breakpoint
          ? 1
          : c.breakpoint > h.breakpoint
            ? -1
            : 0;
        }).reverse();
        var n = new le({}),
         r = function () {
          ...
          if (d > c) {
           var g = D.extendArrayProps(n, i.globals.initialConfig, i);
           (h = L.extend(g, h)),
            (h = L.extend(i.config, h)),
            t.overrideResponsiveOptions(h);
          } else
           for (var p = 0; p < s.length; p++)
            d < s[p].breakpoint &&
             ((h = D.extendArrayProps(n, s[p].options, i)),
             (h = L.extend(i.config, h)),
             t.overrideResponsiveOptions(h));
         };
        if (e) {
         var o = D.extendArrayProps(n, e, i);
         (o = L.extend(i.config, o)), r((o = L.extend(o, e)));
        } else r({});
       }
      },
     },
  ...
  lt = (function () {
   function v(e) {
    X(this, v), (this.ctx = e), (this.colors = []), (this.w = e.w);
    var t = this.w;
    (this.isColorFn = !1),
     ...
     (this.isBarDistributed =
      t.config.plotOptions.bar.distributed &&
      (t.config.chart.type === 'bar' || t.config.chart.type === 'rangeBar'));
   }
   return (
    E(v, [
     {
     ...
     },
     {
      ...
      value: function () {
       ...
       if (
        ...
        t.config.colors === void 0
         ? (t.globals.colors = this.predefined())
         : ((t.globals.colors = t.config.colors),
           Array.isArray(t.config.colors) &&
            t.config.colors.length > 0 &&
            typeof t.config.colors[0] == 'function' &&
            (t.globals.colors = t.config.series.map(function (p, f) {
             var x = t.config.colors[f];
             return (
              x || (x = t.config.colors[0]),
              typeof x == 'function'
               ? ((e.isColorFn = !0),
                 x({
                  value: t.globals.axisCharts
                   ? t.globals.series[f][0]
                     ? t.globals.series[f][0]
                     : 0
                   : t.globals.series[f],
                  seriesIndex: f,
        ...
        t.globals.seriesColors.map(function (p, f) {
         p && (t.globals.colors[f] = p);
        }),
        ...
        for (
         var n = t.config.theme.monochrome.color,
          r = 1 / (s / t.config.theme.monochrome.shadeIntensity),
         ...
         var d = void 0;
         o === 'dark'
          ? ((d = i.shadeColor(-1 * h, n)), (h += r))
          : ((d = i.shadeColor(h, n)), (h += r)),
          a.push(d);
        }
        t.globals.colors = a.slice();
       }
       var g = t.globals.colors.slice();
       this.pushExtraColors(t.globals.colors),
        ['fill', 'stroke'].forEach(function (p) {
         t.config[p].colors === void 0
          ? (t.globals[p].colors = e.isColorFn ? t.config.colors : g)
          : (t.globals[p].colors = t.config[p].colors.slice()),
          e.pushExtraColors(t.globals[p].colors);
        }),
        t.config.dataLabels.style.colors === void 0
         ? (t.globals.dataLabels.style.colors = g)
        ...
        t.config.plotOptions.radar.polygons.fill.colors === void 0
         ? (t.globals.radarPolygons.fill.colors = [
            t.config.theme.mode === 'dark' ? '#424242' : 'none',
           ])
         : (t.globals.radarPolygons.fill.colors =
        ...
        t.config.markers.colors === void 0
         ? (t.globals.markers.colors = g)
         : (t.globals.markers.colors = t.config.markers.colors.slice()),
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       if (
        ...
        for (var n = s - e.length, r = 0; r < n; r++) e.push(e[r]);
      },
     },
     {
       ...
       var t = e.theme.mode || 'light',
        ...
        a = e.chart.foreColor
         ...
         : t === 'dark'
           ...
           : '#373d3f';
       return (
        (e.tooltip.theme = t), (e.chart.foreColor = a), (e.theme.palette = i), e
       );
      },
     },
     {
   ...
   return (
    E(v, [
     ...
     },
     {
      ...
      value: function (e) {
       var t = this.w,
        i = e === 'title' ? t.config.title : t.config.subtitle,
       ...
       if (
        (i.align === 'left'
         ? ((a = 10), (n = 'start'))
         : i.align === 'right' && ((a = t.globals.svgWidth - 10), (n = 'end')),
        (a += i.offsetX),
        (s = s + parseInt(i.style.fontSize, 10) + i.margin / 2),
        i.text !== void 0)
       ) {
        var r = new I(this.ctx).drawText({
         x: a,
         y: s,
         text: i.text,
         textAnchor: n,
        ...
        r.node.setAttribute('class', 'apexcharts-'.concat(e, '-text')),
  ...
  ct = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.dCtx = e);
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       ...
       if (n !== null && !s) {
        ...
        (i = r.width), (a = t.globals.axisCharts ? r.height + 5 : r.height);
       }
     ...
     },
     {
      ...
      value: function () {
       ...
       var i = Object.assign({}, L.getBoundingClientRect(t));
       return (
    ...
    E(v, [
      ...
      value: function () {
       ...
       if (
        ...
        var s = t.globals.xLabelFormatter,
         n = L.getLargestStringFromArr(i),
         r = this.dCtx.dimHelpers.getLargestStringFromMultiArr(n, i);
        t.globals.isBarHorizontal &&
         (r = n =
          t.globals.yAxisScale[0].result.reduce(function (f, x) {
           return f.length > x.length ? f : x;
          }, 0));
        var o = new ge(this.dCtx.ctx),
         h = n;
        (n = o.xLabelFormat(s, n, h, {
         i: void 0,
         dateFormatter: new W(this.dCtx.ctx).formatDate,
         w: t,
        })),
         ...
         ((t.config.xaxis.convertedCatToNumeric && n === void 0) ||
          String(n).trim() === '') &&
          (r = n = '1');
        var c = new I(this.dCtx.ctx),
         d = c.getTextRects(n, t.config.xaxis.labels.style.fontSize),
         g = d;
        if (
         (n !== r &&
          (g = c.getTextRects(r, t.config.xaxis.labels.style.fontSize)),
         ((e = {
     ...
     },
     {
      ...
      value: function () {
       ...
       if (e.config.xaxis.title.text !== void 0) {
        var a = new I(this.dCtx.ctx).getTextRects(
     ...
     },
     {
      ...
      value: function () {
       ...
       return (
        1.05 *
         (e = new I(this.dCtx.ctx).getTextRects(
          a,
          t.config.xaxis.labels.style.fontSize,
         )).width *
         i.length >
         ...
         (function (g) {
          ...
          (function (g) {
           if (t.dCtx.timescaleLabels && t.dCtx.timescaleLabels.length) {
            var p = t.dCtx.timescaleLabels[0],
             f =
              t.dCtx.timescaleLabels[t.dCtx.timescaleLabels.length - 1]
               .position +
              r / 1.75 -
              t.dCtx.yAxisWidthRight,
             x = p.position - r / 1.75 + t.dCtx.yAxisWidthLeft,
             b =
              i.config.legend.position === 'right' && t.dCtx.lgRect.width > 0
               ? t.dCtx.lgRect.width
               : 0;
            f > a.svgWidth - a.translateX - b && (a.skipLastTimelinelabel = !0),
             x <
              -((g.show && !g.floating) ||
              (s.chart.type !== 'bar' &&
               s.chart.type !== 'candlestick' &&
               ...
               s.chart.type !== 'boxPlot')
               ? 10
               : r / 1.75) && (a.skipFirstTimelinelabel = !0);
           } else
            n === 'datetime'
             ? t.dCtx.gridPad.right < r &&
               !a.rotateXLabels &&
               (a.skipLastTimelinelabel = !0)
             : n !== 'datetime' &&
               t.dCtx.gridPad.right < r / 2 - t.dCtx.yAxisWidthRight &&
               !a.rotateXLabels &&
               !i.config.xaxis.labels.trim &&
               (i.config.xaxis.tickPlacement !== 'between' ||
                i.globals.isBarHorizontal) &&
               (t.dCtx.xPadRight = r / 2 + 1);
          })(c);
        };
       s.yaxis.forEach(function (c, d) {
        o
         ? (t.dCtx.gridPad.left < r && (t.dCtx.xPadLeft = r / 2 + 1),
           (t.dCtx.xPadRight = r / 2 + 1))
         : h(c, d);
       });
      },
    ...
    E(v, [
     {
      ...
      value: function () {
       ...
       return (
        t.config.yaxis.map(function (n, r) {
         var o = t.globals.yAxisScale[r],
          h = 0;
         if (
          (!s.isYAxisHidden(r) &&
           n.labels.show &&
           ...
           (h = n.labels.minWidth),
          !s.isYAxisHidden(r) && n.labels.show && o.result.length)
         ) {
          var c = t.globals.yLabelFormatters[r],
           d = o.niceMin === Number.MIN_VALUE ? 0 : o.niceMin,
           g = String(d).length > String(o.niceMax).length ? d : o.niceMax,
           p = c(g, { seriesIndex: r, dataPointIndex: -1, w: t }),
           f = p;
          if (
           ((p !== void 0 && p.length !== 0) || (p = g),
           t.globals.isBarHorizontal)
          ) {
           a = 0;
           var x = t.globals.labels.slice();
           (p = c((p = L.getLargestStringFromArr(x)), {
            seriesIndex: r,
            dataPointIndex: -1,
            w: t,
           })),
          ...
          var b = new I(e.dCtx.ctx),
           y = 'rotate('.concat(n.labels.rotate, ' 0 0)'),
           k = b.getTextRects(
            p,
            ...
            width:
             (h > A.width || h > k.width
              ...
              : A.width > k.width
                ? A.width
                : k.width) + a,
            height: A.height > k.height ? A.height : k.height,
           });
       ...
       return (
        t.config.yaxis.map(function (a, s) {
         if (a.show && a.title.text !== void 0) {
          var n = new I(e.dCtx.ctx),
           r = 'rotate('.concat(a.title.rotate, ' 0 0)'),
           o = n.getTextRects(
            a.title.text,
            a.title.style.fontSize,
            a.title.style.fontFamily,
            r,
            !1,
           );
     ...
     },
     {
      ...
      value: function () {
       var e = this.w,
        ...
        r = function (o, h) {
         var c = e.config.yaxis[h].floating,
          d = 0;
         o.width > 0 && !c
          ? ((d = o.width + s),
            (function (g) {
          ...
          : (d = c || n.isYAxisHidden(h) ? 0 : 5),
          e.config.yaxis[h].opposite ? (a += d) : (i += d),
          (t += d);
        };
       return (
        e.globals.yLabelsCoords.map(function (o, h) {
         r(o, h);
        }),
    ...
    E(v, [
     {
      ...
      value: function (e) {
       ...
       var i = function (c) {
        ...
        s = 0,
        n = i(a) ? t.config.series.length : 1;
       if (
        (t.globals.comboBarCount > 0 && (n = t.globals.comboBarCount),
        t.globals.collapsedSeries.forEach(function (c) {
         i(c.type) && (n -= 1);
        }),
        t.config.chart.stacked && (n = 1),
        ...
        var r,
         o,
         h = Math.abs(t.globals.initialMaxX - t.globals.initialMinX);
        h <= 3 && (h = t.globals.dataPoints),
         (r = h / e),
         t.globals.minXDiff &&
          t.globals.minXDiff / r > 0 &&
          (o = t.globals.minXDiff / r),
         o > e / 2 && (o /= 2),
         (s =
          ((o / n) * parseInt(t.config.plotOptions.bar.columnWidth, 10)) /
          100) < 1 && (s = 1),
         (s = s / (n > 1 ? 1 : 1.5) + 5),
         (t.globals.barPadForNumericAxis = s);
       }
       return s;
      },
     },
     {
      ...
      value: function () {
       ...
       (i.gridHeight = i.gridHeight - s.height - n.height - a),
        (i.translateY = i.translateY + s.height + n.height + a);
      },
     },
     {
    ...
    E(v, [
      ...
      value: function () {
       ...
       (t.globals.yLabelsCoords = []),
        ...
        t.config.yaxis.map(function (g, p) {
         t.globals.yLabelsCoords.push({ width: a[p].width, index: p }),
          t.globals.yTitleCoords.push({ width: s[p].width, index: p });
        }),
       ...
       switch (
        (t.config.xaxis.position === 'top' &&
         (c = i.xAxisHeight - t.config.xaxis.axisTicks.height - 5),
       ...
       this.dimGrid.setGridXPosForDualYAxis(s, a),
        new we(this.ctx).setYAxisXPosition(a, s);
      },
     },
     {
      ...
      value: function () {
       ...
       if (!i.legend.show || i.legend.floating)
        return (
         ...
         (t.translateY = n),
         void (t.translateX = r + (t.svgWidth - t.gridWidth) / 2)
        );
       switch (i.legend.position) {
        case 'bottom':
         (t.gridHeight = t.svgHeight - this.lgRect.height - t.goldenPadding),
          ...
          (t.translateY = n - 10),
          (t.translateX = r + (t.svgWidth - t.gridWidth) / 2);
         break;
        case 'top':
         (t.gridHeight = t.svgHeight - this.lgRect.height - t.goldenPadding),
          (t.gridWidth = t.svgWidth),
        ...
        case 'left':
         (t.gridWidth = t.svgWidth - this.lgRect.width - a),
          (t.gridHeight =
           i.chart.height !== 'auto' ? t.svgHeight : t.gridWidth),
          (t.translateY = n),
          (t.translateX = r + this.lgRect.width + a);
         break;
        case 'right':
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       var a = 0,
        s = 0;
       i.config.yaxis.forEach(function (n) {
        (a += n.labels.minWidth), (s += n.labels.maxWidth);
       }),
  ...
  pt = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.lgCtx = e);
   }
   return (
    E(v, [
     {
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       if (a.globals.axisCharts || a.config.chart.type === 'radialBar') {
        ...
        var r = a.globals.dom.Paper.select(
        ...
        if (o === 'pie' || o === 'polarArea' || o === 'donut') {
         ...
         new I(this.lgCtx.ctx).pathMouseDown(r.members[0], null),
          this.lgCtx.ctx.pie.printDataLabelsInner(r.members[0].node, h);
        }
        r.fire('click');
       }
      },
     },
     {
      ...
      value: function (e) {
       ...
       for (var o = t.childNodes, h = 0; h < o.length; h++)
        o[h].classList.contains('apexcharts-series-markers-wrap') &&
         (o[h].classList.contains('apexcharts-hide')
          ? o[h].classList.remove('apexcharts-hide')
          : o[h].classList.add('apexcharts-hide'));
  ...
  He = (function () {
   function v(e, t) {
    X(this, v),
     ...
     (this.legendHelpers = new pt(this));
   }
   return (
    E(v, [
     {
      ...
      value: function () {
       var e = this.w,
        ...
        i = e.config;
       if (
        ((i.legend.showForSingleSeries && t.series.length === 1) ||
         this.isBarsDistributed ||
         t.series.length > 1 ||
         !t.axisCharts) &&
        i.legend.show
        ...
        this.drawLegends(),
         ...
         i.legend.position === 'bottom' || i.legend.position === 'top'
          ? this.legendAlignHorizontal()
          : (i.legend.position !== 'right' && i.legend.position !== 'left') ||
     ...
     },
     {
      ...
      value: function () {
       ...
       if (t.config.chart.type === 'heatmap') {
        var n = t.config.plotOptions.heatmap.colorScale.ranges;
        (a = n.map(function (T) {
       ...
       t.config.legend.customLegendItems.length &&
        (a = t.config.legend.customLegendItems);
       for (
        ...
        if (t.globals.ancillaryCollapsedSeriesIndices.length > 0)
         for (
          ...
          t.globals.ancillaryCollapsedSeriesIndices[f] === h && (g = !0);
        var x = document.createElement('span');
        x.classList.add('apexcharts-legend-marker');
        var b = t.config.legend.markers.offsetX,
         y = t.config.legend.markers.offsetY,
         k = t.config.legend.markers.height,
         A = t.config.legend.markers.width,
         l = t.config.legend.markers.strokeWidth,
         u = t.config.legend.markers.strokeColor,
         m = t.config.legend.markers.radius,
         w = x.style;
        (w.background = s[h]),
         (w.color = s[h]),
         w.setProperty('background', s[h], 'important'),
         t.config.legend.markers.fillColors &&
          t.config.legend.markers.fillColors[h] &&
          (w.background = t.config.legend.markers.fillColors[h]),
         t.globals.seriesColors[h] !== void 0 &&
          ((w.background = t.globals.seriesColors[h]),
          (w.color = t.globals.seriesColors[h])),
         (w.height = Array.isArray(k)
          ? parseFloat(k[h]) + 'px'
          : parseFloat(k) + 'px'),
         (w.width = Array.isArray(A)
          ? parseFloat(A[h]) + 'px'
          : parseFloat(A) + 'px'),
         (w.left =
          (Array.isArray(b) ? parseFloat(b[h]) : parseFloat(b)) + 'px'),
         (w.top = (Array.isArray(y) ? parseFloat(y[h]) : parseFloat(y)) + 'px'),
         (w.borderWidth = Array.isArray(l) ? l[h] : l),
         (w.borderColor = Array.isArray(u) ? u[h] : u),
         (w.borderRadius = Array.isArray(m)
          ? parseFloat(m[h]) + 'px'
          : parseFloat(m) + 'px'),
         t.config.legend.markers.customHTML &&
          (Array.isArray(t.config.legend.markers.customHTML)
           ? t.config.legend.markers.customHTML[h] &&
             (x.innerHTML = t.config.legend.markers.customHTML[h]())
           : (x.innerHTML = t.config.legend.markers.customHTML())),
         I.setAttrs(x, { rel: h + 1, 'data:collapsed': d || g }),
         (d || g) && x.classList.add('apexcharts-inactive-legend');
        var S = document.createElement('div'),
         P = document.createElement('span');
        P.classList.add('apexcharts-legend-text'),
         (P.innerHTML = Array.isArray(c) ? c.join(' ') : c);
        var C = t.config.legend.labels.useSeriesColors
         ? t.globals.colors[h]
         : t.config.legend.labels.colors;
        C || (C = t.config.chart.foreColor),
         (P.style.color = C),
         (P.style.fontSize = parseFloat(t.config.legend.fontSize) + 'px'),
         (P.style.fontWeight = t.config.legend.fontWeight),
         (P.style.fontFamily = i || t.config.chart.fontFamily),
         I.setAttrs(P, {
          rel: h + 1,
          i: h,
         ...
         S.appendChild(x),
         S.appendChild(P);
        var M = new D(this.ctx);
        t.config.legend.showForZeroSeries ||
         (M.getSeriesTotalByIndex(h) === 0 &&
          M.seriesHaveSameValues(h) &&
          !M.isSeriesNull(h) &&
          t.globals.collapsedSeriesIndices.indexOf(h) === -1 &&
          t.globals.ancillaryCollapsedSeriesIndices.indexOf(h) === -1 &&
         ...
         I.setAttrs(S, {
          rel: h + 1,
          seriesName: L.escapeString(a[h]),
          'data:collapsed': d || g,
         }),
         (d || g) && S.classList.add('apexcharts-inactive-legend'),
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       (a.style.position = 'absolute'),
        (n = n + e + i.config.legend.offsetX),
        (r = r + t + i.config.legend.offsetY),
        (a.style.left = n + 'px'),
        (a.style.top = r + 'px'),
     ...
     },
     {
      ...
      value: function () {
       var e = this.w,
        ...
        i = 0;
       e.config.legend.position === 'left' && (i = 20),
        e.config.legend.position === 'right' &&
       ...
       if (t.config.chart.type === 'heatmap' || this.isBarsDistributed) {
        if (i) {
         ...
         this.ctx.events.fireEvent('legendHover', [this.ctx, a, this.w]),
          new j(this.ctx).highlightRangeInSeries(e, e.target);
        }
       } else
        !e.target.classList.contains('apexcharts-inactive-legend') &&
         i &&
         new j(this.ctx).toggleSeriesOnHover(e, e.target);
      },
     },
     {
      key: 'onLegendClick',
      value: function (e) {
       ...
       if (
        ...
        var i = parseInt(e.target.getAttribute('rel'), 10) - 1,
         a = e.target.getAttribute('data:collapsed') === 'true',
         s = this.w.config.chart.events.legendClick;
        typeof s == 'function' && s(this.ctx, i, this.w),
       ...
       var n = [],
        r = function (d, g, p) {
         ...
         e.t[f] &&
          ...
          n.push({
           el: g,
           icon: typeof e.t[f] == 'string' ? e.t[f] : p,
...
`,
    ...
    <path d="M0 0h24v24H0z" fill="none"/>
       ...
       n.forEach(function (d, g) {
        d.index && L.moveIndexInArray(n, g, d.index);
       });
       for (var c = 0; c < n.length; c++)
        I.setAttrs(n[c].el, { class: n[c].class, title: n[c].title }),
         (n[c].el.innerHTML = n[c].icon),
         a.appendChild(n[c].el);
     ...
     },
     {
      ...
      value: function (e) {
       (this.elMenuItems = []),
        ...
        I.setAttrs(this.elMenu, { class: 'apexcharts-menu' });
       var t = [
       ...
       this.elZoomReset.addEventListener(
        ...
        this.elMenuItems.forEach(function (i) {
         i.classList.contains('exportSVG')
          ? i.addEventListener('click', e.handleDownload.bind(e, 'svg'))
          : i.classList.contains('exportPNG')
            ? i.addEventListener('click', e.handleDownload.bind(e, 'png'))
            : i.classList.contains('exportCSV') &&
              i.addEventListener('click', e.handleDownload.bind(e, 'csv'));
        });
     ...
     },
     {
      ...
      value: function (e) {
       this.ctx.getSyncedCharts().forEach(function (t) {
        ...
        var i =
          e === 'selection' ? t.ctx.toolbar.elSelection : t.ctx.toolbar.elZoom,
         a = e === 'selection' ? 'selectionEnabled' : 'zoomEnabled';
     ...
     },
     {
      ...
      value: function (e) {
       ...
       var t = e === 'pan' ? this.elPan : this.elZoom,
        i = e === 'pan' ? this.elZoom : this.elPan;
      ...
      value: function (e, t) {
       ...
       if (e !== void 0 || t !== void 0) {
        if (
         ...
         s && (a = s.xaxis);
         var n = { xaxis: a },
          r = L.clone(i.globals.initialConfig.yaxis);
         i.config.chart.zoom.autoScaleYaxis &&
          (r = new ie(this.ctx).autoScaleY(this.ctx, r, { xaxis: a })),
     ...
     },
     {
      ...
      value: function (e) {
       this.ctx.getSyncedCharts().forEach(function (t) {
        ...
        typeof i.config.chart.events.zoomed == 'function' &&
        ...
        var s = t.ctx.series.emptyCollapsedSeries(
         L.clone(i.globals.initialSeries),
        );
      ...
      value: function (i) {
       ...
       (this.xyRatios = s),
        ...
        this.eventList.forEach(function (o) {
         a.hoverArea.addEventListener(o, r.svgMouseEvents.bind(r, s), {
          capture: !1,
          passive: !0,
         });
        });
      ...
      value: function (i, a) {
       ...
       a.shiftKey
        ? ((this.shiftWasPressed = !0),
          r.enableZoomPanFromToolbar(h === 'pan' ? 'zoom' : 'pan'))
        : this.shiftWasPressed &&
          (r.enableZoomPanFromToolbar(h), (this.shiftWasPressed = !1));
       var c = a.target.classList;
       if (
        !(
         c.contains('apexcharts-selection-rect') ||
         c.contains('apexcharts-legend-marker') ||
         c.contains('apexcharts-legend-text') ||
         a.target.parentNode.classList.contains('apexcharts-toolbar')
        )
       ) {
        if (
         ((n.clientX =
          a.type === 'touchmove' || a.type === 'touchstart'
           ? a.touches[0].clientX
           : a.type === 'touchend'
         ...
         (n.clientY =
          a.type === 'touchmove' || a.type === 'touchstart'
           ...
           : a.type === 'touchend'
             ...
             : a.clientY),
         a.type === 'mousedown' && a.which === 1)
        ) {
         var d = n.gridRect.getBoundingClientRect();
         (n.startX = n.clientX - d.left),
          (n.startY = n.clientY - d.top),
          (n.dragged = !1),
          (n.w.globals.mousedown = !0);
        }
        if (
         (((a.type === 'mousemove' && a.which === 1) ||
          a.type === 'touchmove') &&
          ((n.dragged = !0),
          s.globals.panEnabled
           ? ((s.globals.selection = null),
             n.w.globals.mousedown &&
              n.panDragging({ context: n, zoomtype: o, xyRatios: i }))
           : ((n.w.globals.mousedown && s.globals.zoomEnabled) ||
              (n.w.globals.mousedown && s.globals.selectionEnabled)) &&
             (n.selection = n.selectionDrawing({ context: n, zoomtype: o }))),
         a.type === 'mouseup' ||
          a.type === 'touchend' ||
          a.type === 'mouseleave')
        ) {
         var g = n.gridRect.getBoundingClientRect();
         n.w.globals.mousedown &&
          ((n.endX = n.clientX - g.left),
          (n.endY = n.clientY - g.top),
          (n.dragX = Math.abs(n.endX - n.startX)),
          (n.dragY = Math.abs(n.endY - n.startY)),
          (s.globals.zoomEnabled || s.globals.selectionEnabled) &&
           n.selectionDrawn({ context: n, zoomtype: o }),
          s.globals.panEnabled &&
           s.config.xaxis.convertedCatToNumeric &&
      ...
      value: function () {
       ...
       if (!i.globals.zoomEnabled) {
        if (i.globals.selection !== void 0 && i.globals.selection !== null)
         ...
         i.config.chart.selection.xaxis.min !== void 0 &&
         i.config.chart.selection.xaxis.max !== void 0
        ) {
         var s =
           (i.config.chart.selection.xaxis.min - i.globals.minX) / a.xRatio,
          n = {
           x: s,
           y: 0,
           width:
            i.globals.gridWidth -
            (i.globals.maxX - i.config.chart.selection.xaxis.max) / a.xRatio -
            s,
     ...
     },
     {
      ...
      value: function (i) {
       ...
       if (this.dragged || g.globals.selection !== null) {
        var x = { transform: 'translate(' + h + ', ' + d + ')' };
        g.globals.zoomEnabled &&
         this.dragged &&
         (n < 0 && (n = 1),
         p.attr({
          x: a,
     ...
     },
     {
      ...
      value: function (i) {
       var a = i.context,
        ...
        d = !1,
        g = !1,
        p = r.clientX - o.left - h,
        f = r.clientY - o.top - c,
        x = {};
       return (
        Math.abs(p + h) > n.globals.gridWidth
         ? (p = n.globals.gridWidth - h)
         : r.clientX - o.left < 0 && (p = h),
        h > r.clientX - o.left && ((d = !0), (p = Math.abs(p))),
        c > r.clientY - o.top && ((g = !0), (f = Math.abs(f))),
        (x =
         s === 'x'
          ? { x: d ? h - p : h, y: 0, width: p, height: n.globals.gridHeight }
          : s === 'y'
            ? { x: 0, y: g ? c - f : c, width: n.globals.gridWidth, height: f }
            : { x: d ? h - p : h, y: g ? c - f : c, width: p, height: f }),
        r.drawSelectionRect(x),
        ...
        typeof n.config.chart.events.selection == 'function' &&
         ...
         (this.w.globals.selectionResizeTimer = window.setTimeout(function () {
          var g = s.gridRect.getBoundingClientRect(),
           ...
           f = {
            xaxis: {
             min: n.globals.xAxisScale.niceMin + (p.left - g.left) * r.xRatio,
             max: n.globals.xAxisScale.niceMin + (p.right - g.left) * r.xRatio,
            },
            yaxis: {
             min:
              n.globals.yAxisScale[0].niceMin +
              (g.bottom - p.bottom) * r.yRatio[0],
             max:
              n.globals.yAxisScale[0].niceMax - (p.top - g.top) * r.yRatio[0],
            },
           };
          n.config.chart.events.selection(s.ctx, f),
           n.config.chart.brush.enabled &&
            n.config.chart.events.brushScrolled !== void 0 &&
            n.config.chart.events.brushScrolled(s.ctx, f);
         }, h)));
      },
     },
     {
      ...
      value: function (i) {
       ...
       if (r.startX > r.endX) {
        var c = r.startX;
        (r.startX = r.endX), (r.endX = c);
       }
       if (r.startY > r.endY) {
        var d = r.startY;
        (r.startY = r.endY), (r.endY = d);
       }
       var g = void 0,
        p = void 0;
       n.globals.isTimelineBar
        ? ((g = n.globals.yAxisScale[0].niceMin + r.startX * o.invertedYRatio),
          (p = n.globals.yAxisScale[0].niceMin + r.endX * o.invertedYRatio))
        : ((g = n.globals.xAxisScale.niceMin + r.startX * o.xRatio),
          (p = n.globals.xAxisScale.niceMin + r.endX * o.xRatio));
       var f = [],
        x = [];
       if (
        (n.config.yaxis.forEach(function (w, S) {
         f.push(n.globals.yAxisScale[S].niceMax - o.yRatio[S] * r.startY),
          x.push(n.globals.yAxisScale[S].niceMax - o.yRatio[S] * r.endY);
        }),
        r.dragged && (r.dragX > 10 || r.dragY > 10) && g !== p)
       ) {
        if (n.globals.zoomEnabled) {
         var b = L.clone(n.globals.initialConfig.yaxis),
          y = L.clone(n.globals.initialConfig.xaxis);
         if (
          ((n.globals.zoomed = !0),
          n.config.xaxis.convertedCatToNumeric &&
           ((g = Math.floor(g)),
           (p = Math.floor(p)),
           g < 1 && ((g = 1), (p = n.globals.dataPoints)),
           p - g < 2 && (p = g + 1)),
          (s !== 'xy' && s !== 'x') || (y = { min: g, max: p }),
          (s !== 'xy' && s !== 'y') ||
           b.forEach(function (w, S) {
            (b[S].min = x[S]), (b[S].max = f[S]);
           }),
          n.config.chart.zoom.autoScaleYaxis)
         ) {
          var k = new ie(r.ctx);
          b = k.autoScaleY(r.ctx, b, { xaxis: y });
         }
         if (h) {
          var A = h.getBeforeZoomRange(y, b);
          A && ((y = A.xaxis ? A.xaxis : y), (b = A.yaxis ? A.yaxis : b));
         }
         var l = { xaxis: y };
         n.config.chart.group || (l.yaxis = b),
         ...
         (u = { min: g, max: p }),
          (s !== 'xy' && s !== 'y') ||
           (m = L.clone(n.config.yaxis)).forEach(function (w, S) {
            (m[S].min = x[S]), (m[S].max = f[S]);
           }),
          (n.globals.selection = r.selection),
          typeof n.config.chart.events.selection == 'function' &&
           n.config.chart.events.selection(r.ctx, { xaxis: u, yaxis: m });
        }
       }
      },
     },
     {
      ...
      value: function (i) {
       ...
       if (s.globals.lastClientPosition.x !== void 0) {
        var r = s.globals.lastClientPosition.x - n.clientX,
         o = s.globals.lastClientPosition.y - n.clientY;
       ...
       var h = s.globals.isTimelineBar ? s.globals.minY : s.globals.minX,
        c = s.globals.isTimelineBar ? s.globals.maxY : s.globals.maxX;
       s.config.xaxis.convertedCatToNumeric || n.panScrolled(h, c);
      },
     },
     {
      ...
      value: function () {
       ...
       this.moveDirection === 'left'
        ? ((a = i.globals.minX + n), (s = i.globals.maxX + n))
        : this.moveDirection === 'right' &&
          ((a = i.globals.minX - n), (s = i.globals.maxX - n)),
        (a = Math.floor(a)),
        (s = Math.floor(s)),
     ...
     },
     {
      ...
      value: function (i, a) {
       var s = this.w,
        ...
        h = s.globals.minX,
        c = s.globals.maxX;
       s.globals.isTimelineBar &&
        ((o = n.invertedYRatio), (h = s.globals.minY), (c = s.globals.maxY)),
        this.moveDirection === 'left'
         ? ((i = h + (s.globals.gridWidth / 15) * o),
           (a = c + (s.globals.gridWidth / 15) * o))
         : this.moveDirection === 'right' &&
           ((i = h - (s.globals.gridWidth / 15) * o),
           (a = c - (s.globals.gridWidth / 15) * o)),
        s.globals.isTimelineBar ||
         ((i < s.globals.initialMinX || a > s.globals.initialMaxX) &&
          ((i = h), (a = c)));
       var d = { min: i, max: a };
       s.config.chart.zoom.autoScaleYaxis &&
        (r = new ie(this.ctx).autoScaleY(this.ctx, r, { xaxis: d }));
       var g = { xaxis: { min: i, max: a } };
       s.config.chart.group || (g.yaxis = r), this.updateScrolledChart(g, i, a);
      },
     },
     {
  ...
  Ne = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.ttCtx = e), (this.ctx = e.ctx);
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       var t = e.hoverArea,
        ...
        s = e.clientY,
        n = this.w,
        r = n.globals.gridWidth,
        o = n.globals.gridHeight,
        h = r / (n.globals.dataPoints - 1),
        c = o / n.globals.dataPoints,
        d = i.getBoundingClientRect(),
        g = this.hasBars();
       (!n.globals.comboCharts && !g) ||
        n.config.xaxis.convertedCatToNumeric ||
        (h = r / n.globals.dataPoints);
       var p = a - d.left - n.globals.barPadForNumericAxis,
        f = s - d.top;
       p < 0 || f < 0 || p > n.globals.gridWidth || f > n.globals.gridHeight
       ...
       var x = Math.round(p / h),
        b = Math.floor(f / c);
       g &&
        !n.config.xaxis.convertedCatToNumeric &&
        ((x = Math.ceil(p / h)), (x -= 1));
       for (
        var y, k = null, A = null, l = [], u = 0;
        u < n.globals.seriesXvalues.length;
        u++
       )
        l.push(
         [n.globals.seriesXvalues[u][0] - 1e-6].concat(
          n.globals.seriesXvalues[u],
         ),
        );
       return (
        (l = l.map(function (m) {
        ...
        (y = n.globals.seriesYvalues.map(function (m) {
         return m.filter(function (w) {
          return L.isNumber(w);
         });
        })),
        n.globals.isXNumeric &&
         ((k = (A = this.closestInMultiArray(p, f, l, y)).index),
         (x = A.j),
         k !== null &&
          ((l = n.globals.seriesXvalues[k]),
          (x = (A = this.closestInArray(p, l)).index))),
        (n.globals.capturedSeriesIndex = k === null ? -1 : k),
        (!x || x < 1) && (x = 0),
        n.globals.isBarHorizontal
         ? (n.globals.capturedDataPointIndex = b)
         : (n.globals.capturedDataPointIndex = x),
        {
         capturedSeries: k,
         j: n.globals.isBarHorizontal ? b : x,
         hoverX: p,
         hoverY: f,
        }
       );
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       ...
       return (
        a.map(function (f, x) {
         f.map(function (b, y) {
          var k = Math.abs(t - a[x][y]),
           A = Math.abs(e - i[x][y]),
           l = A + k;
          l < p && ((p = l), (d = A), (g = k), (r = x), (o = y));
         });
        }),
        { index: r, j: o }
       );
     ...
     },
     {
      ...
      value: function (e, t) {
       for (
        var i = t[0], a = null, s = Math.abs(e - i), n = 0;
        n < t.length;
        n++
       ) {
     ...
     },
     {
      key: 'getBarsHeight',
      value: function (e) {
       return U(e).reduce(function (t, i) {
     ...
     },
     {
      ...
      value: function () {
       ...
       (e = U(e)).sort(function (i, a) {
        return Number(a.getAttribute('data:realIndex')) <
         Number(i.getAttribute('data:realIndex'))
         ? 0
         : -1;
       });
       var t = [];
     ...
     },
     {
      ...
      value: function (e) {
       ...
       return (
        i === void 0 &&
         (i = t.globals.markers.size[e] + t.config.markers.hover.sizeOffset),
        i
       );
      },
     },
     {
      ...
      value: function (e) {
       var t = this.w,
        i = this.ttCtx;
       i.allTooltipSeriesGroups.length === 0 &&
        (i.allTooltipSeriesGroups = t.globals.dom.baseEl.querySelectorAll(
         '.apexcharts-tooltip-series-group',
        ));
       for (var a = i.allTooltipSeriesGroups, s = 0; s < a.length; s++)
        e === 'enable'
         ? (a[s].classList.add('apexcharts-active'),
           (a[s].style.display = t.config.tooltip.items.display))
    ...
    E(v, [
     {
      ...
      value: function (e) {
       var t = e.shared,
        ...
        d = e.e,
        g = this.w;
       g.config.tooltip.custom !== void 0
        ? this.handleCustomTooltip({ i: n, j: o, y1: h, y2: c, w: g })
        : this.toggleActiveInactiveSeries(i);
       var p = this.getValuesToPrint({ i: n, j: o });
       this.printLabels({ i: n, j: o, values: p, ttItems: a, shared: i, e: d });
       var f = this.ttCtx.getElTooltip();
       (this.ttCtx.tooltipRect.ttWidth = f.getBoundingClientRect().width),
        (this.ttCtx.tooltipRect.ttHeight = f.getBoundingClientRect().height);
      },
     },
     {
      key: 'printLabels',
      value: function (e) {
       var t,
        ...
        g = function (u) {
         return (
          c.globals.seriesGoals[u] &&
          c.globals.seriesGoals[u][s] &&
          Array.isArray(c.globals.seriesGoals[u][s])
         );
        },
        p = n.xVal,
        f = n.zVal,
        x = n.xAxisTTVal,
        b = '',
        y = c.globals.colors[a];
       s !== null &&
        c.config.plotOptions.bar.distributed &&
        (y = c.globals.colors[s]);
       for (
        var k = function (u, m) {
          var w = i.getFormatters(a);
          (b = i.getSeriesName({
           ...
           c.config.chart.type === 'treemap' &&
            (b = w.yLbTitleFormatter(String(c.config.series[a].data[s].x), {
             series: c.globals.series,
             seriesIndex: a,
             dataPointIndex: s,
             w: c,
            }));
          var S = c.config.tooltip.inverseOrder ? m : u;
          if (c.globals.axisCharts) {
           var P = function (C) {
            return w.yLbFormatter(c.globals.series[C][s], {
             series: c.globals.series,
             seriesIndex: C,
             dataPointIndex: s,
             w: c,
           ...
           o
            ? ((w = i.getFormatters(S)),
              ...
              (t = P(S)),
              g(S) &&
               (d = c.globals.seriesGoals[S][s].map(function (C) {
                return {
                 attrs: C,
                 val: w.yLbFormatter(C.value, {
                  seriesIndex: S,
                  dataPointIndex: s,
                  w: c,
                 }),
            ...
            : (h &&
               ...
               (y = h.target.getAttribute('fill')),
              (t = P(a)),
              g(a) &&
               Array.isArray(c.globals.seriesGoals[a][s]) &&
               (d = c.globals.seriesGoals[a][s].map(function (C) {
                return {
                 attrs: C,
                 val: w.yLbFormatter(C.value, {
                  seriesIndex: a,
          ...
          s === null &&
           (t = w.yLbFormatter(
            c.globals.series[a],
            F(F({}, c), {}, { seriesIndex: a, dataPointIndex: a }),
           )),
           i.DOMHandling({
            i: a,
            t: S,
            j: s,
            ttItems: r,
            values: { val: t, goalVals: d, xVal: p, xAxisTTVal: x, zVal: f },
            seriesName: b,
            shared: o,
            pColor: y,
           });
         ...
         A = 0,
         l = c.globals.series.length - 1;
        A < c.globals.series.length;
        A++, l--
       )
        k(A, l);
      },
        ...
        i.globals.ttVal !== void 0
         ? Array.isArray(i.globals.ttVal)
           ...
           : ((a = i.globals.ttVal.formatter),
             typeof i.globals.ttVal.title.formatter == 'function' &&
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.fn,
        ...
        s = e.j,
        n = this.w;
       return t(String(n.globals.seriesNames[i]), {
      ...
      value: function (e) {
       ...
       (b = a[t].children),
        h.config.tooltip.fillSeriesColor &&
         ((a[t].style.backgroundColor = o), (b[0].style.display = 'none')),
        c.showTooltipTitle &&
         (c.tooltipTitle === null &&
        ...
        c.blxaxisTooltip && (c.xaxisTooltipText.innerHTML = f !== '' ? f : p);
       var y = a[t].querySelector('.apexcharts-tooltip-text-y-label');
       y && (y.innerHTML = n || '');
       var k = a[t].querySelector('.apexcharts-tooltip-text-y-value');
       k && (k.innerHTML = d !== void 0 ? d : ''),
        b[0] &&
         ...
         (h.config.tooltip.marker.fillColors &&
          ...
          (o = h.config.tooltip.marker.fillColors[t]),
         (b[0].style.backgroundColor = o)),
        h.config.tooltip.marker.show || (b[0].style.display = 'none');
       var A = a[t].querySelector('.apexcharts-tooltip-text-goals-label'),
        l = a[t].querySelector('.apexcharts-tooltip-text-goals-value');
         ...
         g.forEach(function (S, P) {
          (m +=
           ' <div style="display: flex"><span class="apexcharts-tooltip-marker" style="background-color: '
            ...
            .concat(S.attrs.name, '</div>')),
           (w += '<div>'.concat(S.val, '</div>'));
         }),
          (A.innerHTML = m + '</div>'),
          (l.innerHTML = w + '</div>');
        };
        r
         ? h.globals.seriesGoals[t][i] &&
           Array.isArray(h.globals.seriesGoals[t][i])
           ? u()
           : ((A.innerHTML = ''), (l.innerHTML = ''))
         : u();
       } else (A.innerHTML = ''), (l.innerHTML = '');
       x !== null &&
        ((a[t].querySelector('.apexcharts-tooltip-text-z-label').innerHTML =
         h.config.tooltip.z.title),
        (a[t].querySelector('.apexcharts-tooltip-text-z-value').innerHTML =
         x !== void 0 ? x : '')),
        r &&
         b[0] &&
         (d == null || h.globals.collapsedSeriesIndices.indexOf(t) > -1
          ? (b[0].parentNode.style.display = 'none')
          : (b[0].parentNode.style.display = h.config.tooltip.items.display));
      },
     },
     {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       i === null
        ? (h = a.globals.series[t])
        : a.globals.isXNumeric && a.config.chart.type !== 'treemap'
          ? ((n = s[t][i]),
            s[t].length === 0 &&
             (n = s[this.tooltipUtil.getFirstActiveXArray(s)][i]))
          : (n = a.globals.labels[i] !== void 0 ? a.globals.labels[i] : '');
       var g = n;
       return (
        a.globals.isXNumeric && a.config.xaxis.type === 'datetime'
         ? (n = new ge(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, g, g, {
            i: void 0,
            dateFormatter: new W(this.ctx).formatDate,
            w: this.w,
           }))
         : (n = a.globals.isBarHorizontal
            ? a.globals.yLabelFormatters[0](g, c)
            : a.globals.xLabelFormatter(g, c)),
        a.config.tooltip.x.formatter !== void 0 &&
         (n = a.globals.ttKeyFormatter(g, c)),
        a.globals.seriesZ.length > 0 &&
         a.globals.seriesZ[t].length > 0 &&
         (o = d(a.globals.seriesZ[t][i], a)),
        (r =
         typeof a.config.xaxis.tooltip.formatter == 'function'
          ? a.globals.xaxisTooltipFormatter(g, c)
          : n),
        {
  ...
  Oe = (function () {
   function v(e) {
    X(this, v), (this.ttCtx = e), (this.ctx = e.ctx), (this.w = e.w);
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       var t =
        ...
        n = e - i.xcrosshairsWidth / 2,
        r = a.globals.labels.slice().length;
       if (
        (t !== null && (n = (a.globals.gridWidth / r) * t),
        s !== null &&
         (s.setAttribute('x', n),
         s.setAttribute('x1', n),
         s.setAttribute('x2', n),
        ...
        var o = n;
        (a.config.xaxis.crosshairs.width !== 'tickWidth' &&
         a.config.xaxis.crosshairs.width !== 'barWidth') ||
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (i.xaxisTooltip !== null) {
        ...
        if (
         ((e -= i.xaxisTooltip.getBoundingClientRect().width / 2), !isNaN(e))
        ) {
         e += t.globals.translateX;
         var s;
         (s = new I(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML)),
     ...
     },
     {
      ...
      value: function (e) {
       ...
       var a = parseInt(i.ycrosshairsHidden.getAttribute('y1'), 10),
        ...
        n = i.yaxisTTEls[e].getBoundingClientRect().height,
        r = t.globals.translateYAxisX[e] - 2;
       t.config.yaxis[e].opposite && (r -= 26),
        (s -= n / 2),
        t.globals.ignoreYAxisIndexes.indexOf(e) === -1
         ? (i.yaxisTTEls[e].classList.add('apexcharts-active'),
           ...
           (i.yaxisTTEls[e].style.left =
            r + t.config.yaxis[e].tooltip.offsetX + 'px'))
     ...
     },
     {
      ...
      value: function (e, t) {
       var i =
        ...
        n = s.getElTooltip(),
        r = s.tooltipRect,
        o = i !== null ? parseFloat(i) : 1,
        h = parseFloat(e) + o + 5,
        c = parseFloat(t) + o / 2;
       if (
        (h > a.globals.gridWidth / 2 && (h = h - r.ttWidth - o - 15),
        h > a.globals.gridWidth - r.ttWidth - 10 &&
         (h = a.globals.gridWidth - r.ttWidth),
        h < -20 && (h = -20),
        a.config.tooltip.followCursor)
       ) {
        var d = s.getElGrid(),
         g = d.getBoundingClientRect();
        c = s.e.clientY + a.globals.translateY - g.top - r.ttHeight / 2;
       } else
        a.globals.isBarHorizontal
         ? (c -= r.ttHeight)
         : (r.ttHeight / 2 + c > a.globals.gridHeight &&
            (c = a.globals.gridHeight - r.ttHeight + a.globals.translateY),
           c < 0 && (c = 0));
       isNaN(h) ||
        ((h += a.globals.translateX),
        (n.style.left = h + 'px'),
        (n.style.top = c + 'px'));
      },
     },
       ...
       if (i.globals.markers.size[e] > 0)
        for (
         ...
         parseInt(s[n].getAttribute('rel'), 10) === t &&
          (a.marker.resetPointsSize(), a.marker.enlargeCurrentPoint(t, s[n]));
     ...
     },
     {
      ...
      value: function (e, t) {
       var i,
        ...
        o = n.tooltipUtil.getHoverMarkerSize(t),
        h = s.config.series[t].type;
       if (!h || (h !== 'column' && h !== 'candlestick' && h !== 'boxPlot')) {
        (i = r[t][e][0]), (a = r[t][e][1] ? r[t][e][1] : 0);
     ...
     },
     {
      ...
      value: function (e) {
       ...
       t = new j(this.ctx).getActiveConfigSeriesIndex(!0);
       var o = i.tooltipUtil.getHoverMarkerSize(t);
       r[t] && ((s = r[t][e][0]), (n = r[t][e][1]));
       var h = i.tooltipUtil.getAllMarkers();
       if (h !== null)
        for (var c = 0; c < a.globals.series.length; c++) {
         var d = r[c];
         if (
          (a.globals.comboCharts && d === void 0 && h.splice(c, 0, null),
          d && d.length)
         ) {
          var g = r[c][e][1];
          h[c].setAttribute('cx', s),
           g !== null && !isNaN(g) && g < a.globals.gridHeight && g > 0
            ? (h[c] && h[c].setAttribute('r', o),
              h[c] && h[c].setAttribute('cy', g))
     ...
     },
     {
      ...
      value: function (e) {
       var t = this.w,
        i = this.ttCtx,
        a = t.globals.columnSeries
         ? t.globals.columnSeries.length
         : t.globals.series.length,
        s = a >= 2 && a % 2 == 0 ? Math.floor(a / 2) : Math.floor(a / 2) + 1;
       t.globals.isBarHorizontal &&
        (s = new j(this.ctx).getActiveConfigSeriesIndex(!1, 'desc') + 1);
       var n = t.globals.dom.baseEl.querySelector(
         ".apexcharts-bar-series .apexcharts-series[rel='"
          ...
          .concat(s, "'] path[j='")
          .concat(e, "'], .apexcharts-boxPlot-series .apexcharts-series[rel='")
          .concat(s, "'] path[j='")
          .concat(e, "'], .apexcharts-rangebar-series .apexcharts-series[rel='")
          .concat(s, "'] path[j='")
          .concat(e, "']"),
        ),
        ...
        (t.globals.isXNumeric
         ? ((r -= a % 2 != 0 ? h / 2 : 0),
           n &&
            ...
            (r -= h / 2))
         : t.globals.isBarHorizontal ||
           ((r = i.xAxisTicksPositions[e - 1] + i.dataPointsDividedWidth / 2),
           isNaN(r) &&
            (r = i.xAxisTicksPositions[e] - i.dataPointsDividedWidth / 2)),
        t.globals.isBarHorizontal
         ? (o += c / 3)
         : (o = i.e.clientY - d.top - i.tooltipRect.ttHeight / 2),
        t.globals.isBarHorizontal || this.moveXCrosshairs(r),
        !i.fixedTooltip)
       ) {
        var g = o || t.globals.gridHeight;
        this.moveTooltip(r, g);
       }
      },
     },
    ]),
        ...
        e.config.chart.stacked &&
         a.sort(function (d, g) {
          return (
           ...
           parseFloat(g.getAttribute('data:realIndex'))
          );
         });
       for (var s = 0; s < a.length; s++) {
        ...
        if (n !== null) {
         ...
         (e.config.chart.type !== 'line' && e.config.chart.type !== 'area') ||
          ...
          (o += ' no-pointer-events');
         var h = i.getMarkerConfig({ cssClass: o, seriesIndex: s });
         (r = t.drawMarker(0, 0, h)).node.setAttribute(
          'default-marker-size',
          0,
         );
      ...
      value: function (e) {
       for (
        var t = this.w,
         ...
         r = t.config.markers.hover.size,
         o = 0;
        o < n.length;
        o++
       ) {
        var h = n[o].getAttribute('rel'),
         c = n[o].getAttribute('index');
        if (
         (r === void 0 &&
          (r = t.globals.markers.size[c] + t.config.markers.hover.sizeOffset),
         s === parseInt(h, 10))
        ) {
         i.newPointSize(s, n[o]);
         var d = n[o].getAttribute('cx'),
          g = n[o].getAttribute('cy');
         i.tooltipPosition.moveXCrosshairs(d),
          a.fixedTooltip || i.tooltipPosition.moveTooltip(d, g, r);
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       if (s.getAttribute('default-marker-size') !== '0') {
        ...
        a === void 0 &&
         (a = i.globals.markers.size[n] + i.config.markers.hover.sizeOffset),
         a < 0 && (a = 0),
         s.setAttribute('r', a);
       }
      },
  ...
  mt = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.ttCtx = e);
   }
   return (
    E(v, [
     {
      ...
      value: function (e) {
       ...
       if (t.target.classList.contains('apexcharts-'.concat(n, '-rect'))) {
        ...
        if (
         ...
         (a = d + r.tooltipRect.ttWidth / 2 + p),
         (s = g + r.tooltipRect.ttHeight / 2 - f / 2),
         r.tooltipPosition.moveXCrosshairs(d + p / 2),
         a > o.globals.gridWidth / 2 && (a = d - r.tooltipRect.ttWidth / 2 + p),
         r.w.config.tooltip.followCursor)
        ) {
         var x = o.globals.dom.elWrap.getBoundingClientRect();
         (a = o.globals.clientX - x.left - r.tooltipRect.ttWidth / 2),
          (s = o.globals.clientY - x.top - r.tooltipRect.ttHeight - 5);
        }
       }
       return { x: a, y: s };
      },
      ...
      value: function (e) {
       ...
       if (a.target.classList.contains('apexcharts-marker')) {
        ...
        if (
         ...
         var p = L.findAncestor(s.paths, 'apexcharts-series');
        ...
        if (
         ...
         a.type === 'mouseup' && h.markerClick(a, t, i),
         (o.globals.capturedSeriesIndex = t),
         (o.globals.capturedDataPointIndex = i),
         (n = c),
         (r = d + o.globals.translateY - 1.4 * h.tooltipRect.ttHeight),
         h.w.config.tooltip.followCursor)
        ) {
         var f = h.getElGrid().getBoundingClientRect();
         r = h.e.clientY + o.globals.translateY - f.top;
        }
        g < 0 && (r = d), h.marker.enlargeCurrentPoint(i, s.paths, n, r);
       }
       return { x: n, y: r };
      },
     },
     {
      ...
      value: function (e) {
       var t,
        ...
        c = 0,
        d = 0,
        g = this.getBarTooltipXY({ e: a, opt: s });
       t = g.i;
       var p = g.barHeight,
        f = g.j;
       (n.globals.capturedSeriesIndex = t),
        ...
        !n.config.tooltip.shared
         ? ((c = g.x),
           ...
           (h = c))
         : n.globals.comboCharts || n.config.tooltip.shared || (h /= 2),
        isNaN(d)
         ? (d = n.globals.svgHeight - r.tooltipRect.ttHeight)
         : d < 0 && (d = 0);
       var x = parseInt(s.paths.parentNode.getAttribute('data:realIndex'), 10),
        b = n.globals.isMultipleYAxis
         ? n.config.yaxis[x] && n.config.yaxis[x].reversed
         : n.config.yaxis[0].reversed;
       if (
        (c + r.tooltipRect.ttWidth > n.globals.gridWidth && !b
         ? (c -= r.tooltipRect.ttWidth)
         : c < 0 && (c = 0),
        r.w.config.tooltip.followCursor)
       ) {
        var y = r.getElGrid().getBoundingClientRect();
        d = r.e.clientY - y.top;
       }
       r.tooltip === null &&
        ...
        n.config.tooltip.shared ||
         (n.globals.comboBarCount > 0
          ? r.tooltipPosition.moveXCrosshairs(h + i / 2)
          : r.tooltipPosition.moveXCrosshairs(h)),
        !r.fixedTooltip &&
         (!n.config.tooltip.shared ||
          (n.globals.isBarHorizontal && r.tooltipUtil.hasBars())) &&
         (b && (c -= r.tooltipRect.ttWidth) < 0 && (c = 0),
         (o.style.left = c + n.globals.translateX + 'px'),
         !b ||
          (n.globals.isBarHorizontal && r.tooltipUtil.hasBars()) ||
          (d = d + p - 2 * (n.globals.series[t][f] < 0 ? p : 0)),
         r.tooltipRect.ttHeight + d > n.globals.gridHeight
          ? ((d =
            ...
            (o.style.top = d + 'px'))
          : (o.style.top =
             d + n.globals.translateY - r.tooltipRect.ttHeight / 2 + 'px'));
      },
     },
     {
      key: 'getBarTooltipXY',
      value: function (e) {
       ...
       if (
        ...
        d = f.height;
        var y = f.width,
         k = parseInt(p.getAttribute('cx'), 10),
         A = parseInt(p.getAttribute('cy'), 10);
        c = parseFloat(p.getAttribute('barWidth'));
        var l = t.type === 'touchmove' ? t.touches[0].clientX : t.clientX;
        (s = parseInt(p.getAttribute('j'), 10)),
         (r = parseInt(p.parentNode.getAttribute('rel'), 10) - 1);
        var u = p.getAttribute('data-range-y1'),
         m = p.getAttribute('data-range-y2');
        a.globals.comboCharts &&
         (r = parseInt(p.parentNode.getAttribute('data:realIndex'), 10)),
         n.tooltipLabels.drawSeriesTexts({
          ttItems: i.ttItems,
          i: r,
          j: s,
          y1: u ? parseInt(u, 10) : null,
          y2: m ? parseInt(m, 10) : null,
         ...
         a.config.tooltip.followCursor
          ? a.globals.isBarHorizontal
            ...
            : ((o = a.globals.isXNumeric
               ? k - y / 2
               : k - n.dataPointsDividedWidth + y / 2),
              (h = t.clientY - x.top - n.tooltipRect.ttHeight / 2 - 15))
          : a.globals.isBarHorizontal
            ? ((o = k) < n.xyRatios.baseLineInvertedY &&
               (o = k - n.tooltipRect.ttWidth),
              (h =
               A -
               n.dataPointsDividedHeight +
               b / 2 -
       ...
       return { x: o, y: h, barHeight: d, barWidth: c, i: r, j: s };
      },
     },
    ]),
    v
    ...
    E(v, [
     {
      ...
      value: function () {
       var e = this.w,
        t = this.ttCtx,
        i = e.config.xaxis.position === 'bottom';
       t.xaxisOffY = i
       ...
       t.blxaxisTooltip &&
        ...
        t.xaxisTooltip.setAttribute(
         'class',
         a + ' apexcharts-theme-' + e.config.tooltip.theme,
        ),
      ...
      value: function () {
       for (
        var e = this.w,
         ...
         i = function (s) {
          var n =
           e.config.yaxis[s].opposite || e.config.yaxis[s].crosshairs.opposite;
          ...
          e.globals.dom.baseEl.querySelector(
           '.apexcharts-yaxistooltip apexcharts-yaxistooltip-'.concat(s),
          ) === null &&
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.ttCtx,
        s = this.w,
        n = s.globals.yLabelFormatters[e];
       if (a.yaxisTooltips[e]) {
        var r = a.getElGrid().getBoundingClientRect(),
         o = (t - r.top) * i.yRatio[e],
         h = s.globals.maxYArr[e] - s.globals.minYArr[e],
         c = s.globals.minYArr[e] + (h - o);
        a.tooltipPosition.moveYCrosshairs(t - r.top),
         (a.yaxisTooltipText[e].innerHTML = n(c)),
  ...
  yt = (function () {
   function v(e) {
    ...
    (this.tConfig = t.config.tooltip),
     ...
     (this.tooltipLabels = new xt(this)),
     (this.tooltipPosition = new Oe(this)),
    ...
    E(v, [
     ...
     },
     {
      ...
      value: function (e) {
       ...
       (this.xyRatios = e),
        ...
        (this.yaxisTooltips = t.config.yaxis.map(function (n, r) {
         ...
         n = function (o) {
          ...
          h.classList.add('apexcharts-tooltip-series-group'),
           ...
           t.tConfig.shared &&
            ...
            t.tConfig.enabledOnSeries.indexOf(o) < 0 &&
            h.classList.add('apexcharts-tooltip-series-group-hidden');
          ...
          d.classList.add('apexcharts-tooltip-text'),
           ...
           ['y', 'goals', 'z'].forEach(function (g) {
            ...
            f.classList.add('apexcharts-tooltip-text-'.concat(g, '-label')),
             p.appendChild(f);
            var x = document.createElement('span');
     ...
     },
     {
      ...
      value: function () {
       ...
       if (this.showOnIntersect) {
        ...
        f.length > 0 && this.addPathsEventListeners(f, d),
     ...
     },
     {
      ...
      value: function () {
       ...
       return (
        o.indexOf('right') > -1 && (n = n + e.globals.svgWidth - a + 10),
        o.indexOf('bottom') > -1 && (r = r + e.globals.svgHeight - s - 10),
        (t.style.left = n + 'px'),
        (t.style.top = r + 'px'),
        ...
        var i = this,
         a = function (n) {
          ...
          ['mousemove', 'mouseup', 'touchmove', 'mouseout', 'touchend'].map(
           function (o) {
            return e[n].addEventListener(o, i.seriesHover.bind(i, r), {
             capture: !1,
             passive: !0,
            });
           },
       ...
       (i.tooltipRect = {
        ...
        !i.tooltipUtil.hasBars() ||
         ...
         (this.tConfig.onDatasetHover.highlightDataSeries &&
          new j(t).toggleSeriesOnHover(s, s.target.parentNode)),
     ...
     },
     {
      ...
      value: function (e) {
       var t,
        ...
        o = a.type === 'touchmove' ? a.touches[0].clientX : a.clientX,
        h = a.type === 'touchmove' ? a.touches[0].clientY : a.clientY;
       if (
        ((this.clientY = h),
        (this.clientX = o),
        (n.globals.capturedSeriesIndex = -1),
        (n.globals.capturedDataPointIndex = -1),
        h < r.top || h > r.top + r.height)
       )
        ...
        if (
         ...
         var f = this.yaxisTooltips.filter(function (y) {
          return y === !0;
         });
         if (
          ...
          this.tooltipUtil.hasBars() &&
           ...
           this.tooltipUtil.hasMarkers() &&
            this.intersect.handleMarkerTooltip({ e: a, opt: s, x: t, y: i });
         if (this.yaxisTooltips.length)
          for (var b = 0; b < n.config.yaxis.length; b++)
           this.axesTooltip.drawYaxisTooltipText(b, h, this.xyRatios);
         s.tooltipEl.classList.add('apexcharts-active');
        } else
         (a.type !== 'mouseout' && a.type !== 'touchend') ||
          this.handleMouseOut(s);
       }
      },
     },
     {
      ...
      value: function (e) {
       ...
       if (t.type === 'mousemove' || t.type === 'touchmove') {
        ...
        var h = s.globals.clientX - o.left - a.ttWidth / 2,
        ...
        if (
         ...
         var d = n - 1,
          g = (0, s.config.legend.tooltipHoverFormatter)(
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       var s = this.w,
        ...
        r = n.j,
        o = n.capturedSeries;
       n.hoverX < 0 || n.hoverX > s.globals.gridWidth
        ? this.handleMouseOut(a)
        : o !== null
          ? this.handleStickyCapturedSeries(e, o, a, r)
          : (this.tooltipUtil.isXoverlap(r) || s.globals.isBarHorizontal) &&
            this.create(e, this, 0, r, a.ttItems);
      },
     },
     {
      ...
      value: function (e, t, i, a) {
       var s = this.w;
       s.globals.series[t][a] === null
        ? this.handleMouseOut(i)
        : s.globals.series[t][a] !== void 0
          ? this.tConfig.shared &&
          ...
          : this.tooltipUtil.isXoverlap(a) &&
            this.create(e, this, 0, a, i.ttItems);
      },
     },
     {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (
        ...
        i !== null && i.classList.remove('apexcharts-active'),
        this.ycrosshairs !== null &&
     ...
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.w;
       typeof a.config.chart.events.markerClick == 'function' &&
     ...
     },
     {
      ...
      value: function (e, t, i, a, s) {
       var n =
        ...
        r = this.w,
        o = t;
       e.type === 'mouseup' && this.markerClick(e, i, a),
        n === null && (n = this.tConfig.shared);
       var h = this.tooltipUtil.hasMarkers(),
        c = this.tooltipUtil.getElBars();
       if (r.config.legend.tooltipHoverFormatter) {
        var d = r.config.legend.tooltipHoverFormatter,
         g = Array.from(this.legendLabels);
        g.forEach(function (u) {
         var m = u.getAttribute('data:default-text');
         u.innerHTML = decodeURIComponent(m);
        });
        for (var p = 0; p < g.length; p++) {
         var f = g[p],
          x = parseInt(f.getAttribute('i'), 10),
          b = decodeURIComponent(f.getAttribute('data:default-text')),
          y = d(b, { seriesIndex: n ? x : i, dataPointIndex: a, w: r });
         if (n)
          f.innerHTML = r.globals.collapsedSeriesIndices.indexOf(x) < 0 ? y : b;
         else if (((f.innerHTML = x === i ? y : b), i === x)) break;
        }
       }
       if (n) {
        if (
         ...
         this.tooltipUtil.hasBars() &&
          ((this.barSeriesHeight = this.tooltipUtil.getBarsHeight(c)),
          this.barSeriesHeight > 0))
        ) {
         var k = new I(this.ctx),
          A = r.globals.dom.Paper.select(
           ".apexcharts-bar-area[j='".concat(a, "']"),
          );
         this.deactivateHoverFilter(),
          this.tooltipPosition.moveStickyTooltipOverBars(a);
         for (var l = 0; l < A.length; l++) k.pathMouseEnter(A[l]);
        }
       } else
        o.tooltipLabels.drawSeriesTexts({ shared: !1, ttItems: s, i, j: a }),
         this.tooltipUtil.hasBars() &&
          o.tooltipPosition.moveStickyTooltipOverBars(a),
         h && o.tooltipPosition.moveMarkers(i, a);
      },
     },
    ]),
    v
    ...
    E(t, [
     {
      ...
      value: function (i, a) {
       var s = this,
        n = this.w;
       (this.graphics = new I(this.ctx)),
        (this.bar = new te(this.ctx, this.xyRatios));
       var r = new D(this.ctx, n);
       (i = r.getLogSeries(i)),
        (this.yRatio = r.getLogYRatios(this.yRatio)),
        this.barHelpers.initVariables(i),
        n.config.chart.stackType === '100%' &&
         (i = n.globals.seriesPercent.slice()),
        (this.series = i),
        (this.totalItems = 0),
        (this.prevY = []),
        (this.prevX = []),
        ...
        var h = this.graphics.group({
         ...
         g = function (x, b) {
          var y = void 0,
           ...
           u = [],
           m = [],
           w = n.globals.comboCharts ? a[x] : x;
          s.yRatio.length > 1 && (s.yaxisIndex = w),
           (s.isReversed =
            n.config.yaxis[s.yaxisIndex] &&
            n.config.yaxis[s.yaxisIndex].reversed);
          var S = s.graphics.group({
           class: 'apexcharts-series',
           seriesName: L.escapeString(n.globals.seriesNames[w]),
           rel: x + 1,
           'data:realIndex': w,
          });
          s.ctx.series.addCollapsedClassToSeries(S, w);
          var P = s.graphics.group({
            class: 'apexcharts-datalabels',
            'data:realIndex': w,
           }),
           C = 0,
           M = 0,
           T = s.initialPositions(c, d, y, k, A, l);
          (d = T.y),
           (C = T.barHeight),
           (k = T.yDivision),
           (l = T.zeroW),
           ...
           (s.xArrjVal = []),
           s.prevY.length === 1 &&
            s.prevY[0].every(function (G) {
             return isNaN(G);
            }) &&
            ((s.prevY[0] = s.prevY[0].map(function (G) {
             return A;
            })),
            (s.prevYF[0] = s.prevYF[0].map(function (G) {
             return 0;
            })));
          for (var z = 0; z < n.globals.dataPoints; z++) {
           var Y = s.barHelpers.getStrokeWidth(x, z, w),
            H = {
             indexes: { i: x, j: z, realIndex: w, bc: b },
             strokeWidth: Y,
             x: c,
             y: d,
             elSeries: S,
            ...
            R = null;
           s.isHorizontal
            ? ((R = s.drawStackedBarPaths(
               F(F({}, H), {}, { zeroW: l, barHeight: C, yDivision: k }),
              )),
              (M = s.series[x][z] / s.invertedYRatio))
            : ((R = s.drawStackedColumnPaths(
               F(F({}, H), {}, { xDivision: y, barWidth: M, zeroH: A }),
              )),
              (C = s.series[x][z] / s.yRatio[s.yaxisIndex])),
            (d = R.y),
            (c = R.x),
            u.push(c),
            m.push(d);
           var V = s.barHelpers.getPathFillColor(i, x, z, w);
           S = s.renderSeries({
            realIndex: w,
            pathFill: V,
            j: z,
          ...
          (n.globals.seriesXvalues[w] = u),
           (n.globals.seriesYvalues[w] = m),
           s.prevY.push(s.yArrj),
           s.prevYF.push(s.yArrjF),
           s.prevYVal.push(s.yArrjVal),
           s.prevX.push(s.xArrj),
           s.prevXF.push(s.xArrjF),
           s.prevXVal.push(s.xArrjVal),
           h.add(S);
         },
         p = 0,
         f = 0;
     ...
     },
     {
      ...
      value: function (i, a, s, n, r, o) {
       ...
       return (
        this.isHorizontal
         ? ((h =
            ((h = n = d.globals.gridHeight / d.globals.dataPoints) *
             parseInt(d.config.plotOptions.bar.barHeight, 10)) /
            100),
           (o =
            this.baseLineInvertedY +
            d.globals.padHorizontal +
            (this.isReversed ? d.globals.gridWidth : 0) -
            (this.isReversed ? 2 * this.baseLineInvertedY : 0)),
           (a = (n - h) / 2))
         : ((c = s = d.globals.gridWidth / d.globals.dataPoints),
           (c =
            d.globals.isXNumeric && d.globals.dataPoints > 1
             ? ((s = d.globals.minXDiff / this.xRatio) *
                parseInt(this.barOptions.columnWidth, 10)) /
               100
             : (c * parseInt(d.config.plotOptions.bar.columnWidth, 10)) / 100),
           (r =
            this.baseLineY[this.yaxisIndex] +
            (this.isReversed ? d.globals.gridHeight : 0) -
            (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0)),
           (i = d.globals.padHorizontal + (s - c) / 2)),
        {
         x: i,
         y: a,
         yDivision: n,
      ...
      value: function (i) {
       for (
        var a,
         ...
         y = 0,
         k = 0;
        k < this.prevXF.length;
        k++
       )
        y += this.prevXF[k][b];
       if (x > 0) {
        var A = o;
        this.prevXVal[x - 1][b] < 0
         ? (A =
            this.series[x][b] >= 0
             ? this.prevX[x - 1][b] + y - 2 * (this.isReversed ? y : 0)
             : this.prevX[x - 1][b])
         : this.prevXVal[x - 1][b] >= 0 &&
           (A =
            this.series[x][b] >= 0
       ...
       h =
        this.series[x][b] === null
         ? a
         : a +
           this.series[x][b] / this.invertedYRatio -
           2 * (this.isReversed ? this.series[x][b] / this.invertedYRatio : 0);
       var l = this.barHelpers.getBarpaths({
        barYPosition: f,
        barHeight: n,
        x1: a,
        x2: h,
       ...
       return (
        ...
        (c += d),
        { pathTo: l.pathTo, pathFrom: l.pathFrom, x: h, y: c }
       );
      },
     },
     {
      ...
      value: function (i) {
       ...
       if (d.globals.isXNumeric) {
        ...
        x || (x = 0), (s = (x - d.globals.minX) / this.xRatio - o / 2);
       }
       for (var b, y = s, k = 0, A = 0; A < this.prevYF.length; A++)
        k += isNaN(this.prevYF[A][p]) ? 0 : this.prevYF[A][p];
       if (
        (g > 0 && !d.globals.isXNumeric) ||
        (g > 0 &&
         d.globals.isXNumeric &&
         d.globals.seriesX[g - 1][p] === d.globals.seriesX[g][p])
       ) {
        var l,
         u,
         m = Math.min(this.yRatio.length + 1, g + 1);
        if (this.prevY[g - 1] !== void 0) {
         for (var w = 1; w < m; w++)
        ...
        for (var S = 1; S < m; S++) {
         if (this.prevYVal[g - S][p] < 0) {
          l =
           this.series[g][p] >= 0 ? u - k + 2 * (this.isReversed ? k : 0) : u;
          break;
         }
         if (this.prevYVal[g - S][p] >= 0) {
          l =
           this.series[g][p] >= 0 ? u : u + k - 2 * (this.isReversed ? k : 0);
          break;
         }
        }
        l === void 0 && (l = d.globals.gridHeight),
         (b =
          this.prevYF[0].every(function (C) {
           return C === 0;
          }) &&
          this.prevYF.slice(1, g).every(function (C) {
           return C.every(function (M) {
            return isNaN(M);
           });
          })
           ? d.globals.gridHeight - h
           : l);
       } else b = d.globals.gridHeight - h;
       n =
        b -
    ...
    E(t, [
       ...
       for (
        var c = r.group({
         ...
         d = function (p) {
          s.isBoxPlot =
           n.config.chart.type === 'boxPlot' ||
           n.config.series[p].type === 'boxPlot';
          var f,
           x,
           b = void 0,
           y = void 0,
           k = [],
           A = [],
           l = n.globals.comboCharts ? a[p] : p,
           u = r.group({
            class: 'apexcharts-series',
            seriesName: L.escapeString(n.globals.seriesNames[l]),
            rel: p + 1,
            'data:realIndex': l,
           });
          i[p].length > 0 && (s.visibleI = s.visibleI + 1);
          var m, w;
          s.yRatio.length > 1 && (s.yaxisIndex = l);
          ...
          for (
           var P = r.group({
            ...
            C = function (T) {
             var z = s.barHelpers.getStrokeWidth(p, T, l),
              Y = s.drawBoxPaths({
               indexes: { i: p, j: T, realIndex: l },
               x: b,
               y,
               xDivision: f,
               barWidth: w,
             ...
             (y = Y.y),
              ...
              T > 0 && A.push(b + w / 2),
              k.push(y),
              Y.pathTo.forEach(function (H, R) {
               var V =
                 !s.isBoxPlot && s.candlestickOptions.wick.useFillColor
                  ? Y.color[R]
                  : n.globals.stroke.colors[p],
                G = o.fillPath({
                 seriesNumber: l,
                 dataPointIndex: T,
                 color: Y.color[R],
            ...
            M = 0;
           M < n.globals.dataPoints;
           M++
          )
           C(M);
          (n.globals.seriesXvalues[l] = A),
           (n.globals.seriesYvalues[l] = k),
           c.add(u);
         },
         g = 0;
        g < i.length;
     ...
     },
     {
      ...
      value: function (i) {
       ...
       var n = i.xDivision,
        ...
        b = c.config.plotOptions.candlestick.colors.downward,
        y = '';
       this.isBoxPlot &&
        (y = [this.boxOptions.colors.lower, this.boxOptions.colors.upper]);
       var k = this.yRatio[this.yaxisIndex],
        A = a.realIndex,
        l = this.getOHLCValue(A, p),
        u = o,
        m = o;
       l.o > l.c && (f = !1);
       var w = Math.min(l.o, l.c),
        S = Math.max(l.o, l.c),
        P = l.m;
       c.globals.isXNumeric &&
        (s = (c.globals.seriesX[A][p] - c.globals.minX) / this.xRatio - r / 2);
       var C = s + r * this.visibleI;
       this.series[g][p] === void 0 || this.series[g][p] === null
        ? ((w = o), (S = o))
        : ((w = o - w / k),
          (S = o - S / k),
          (u = o - l.h / k),
     ...
     },
     {
      ...
      value: function (i, a) {
       ...
       return {
        o: this.isBoxPlot
         ? s.globals.seriesCandleH[i][a]
         : s.globals.seriesCandleO[i][a],
        h: this.isBoxPlot
         ? s.globals.seriesCandleO[i][a]
         : s.globals.seriesCandleH[i][a],
        m: s.globals.seriesCandleM[i][a],
        l: this.isBoxPlot
         ? s.globals.seriesCandleC[i][a]
         : s.globals.seriesCandleL[i][a],
        c: this.isBoxPlot
         ? s.globals.seriesCandleL[i][a]
         : s.globals.seriesCandleC[i][a],
       };
    ...
    E(v, [
     ...
     },
     {
      ...
      value: function (e, t, i, a) {
       var s = this.w,
        n = 1,
        r = s.config.plotOptions[e].shadeIntensity,
       ...
       s.globals.hasNegs || a
        ? (n = s.config.plotOptions[e].reverseNegativeShade
           ...
           : o.percent <= 0
             ...
             : (1 - o.percent / 100) * r)
        : ((n = 1 - o.percent / 100),
          e === 'treemap' && (n = (1 - o.percent / 100) * (1.25 * r)));
       var h = o.color,
        c = new L();
       return (
        s.config.plotOptions[e].enableShades &&
         (h =
          this.w.config.theme.mode === 'dark'
           ? L.hexToRgba(c.shadeColor(-1 * n, o.color), s.config.fill.opacity)
           : L.hexToRgba(c.shadeColor(n, o.color), s.config.fill.opacity)),
        { color: h, colorProps: o }
       );
      },
     },
     {
      ...
      value: function (e, t, i) {
       var a = this.w,
        ...
        n = a.config.plotOptions[e],
        r = n.colorScale.inverse ? i : t;
       a.config.plotOptions[e].distributed && (r = i);
       var o = a.globals.colors[r],
        h = null,
        c = Math.min.apply(Math, U(a.globals.series[t])),
        d = Math.max.apply(Math, U(a.globals.series[t]));
       n.distributed ||
        e !== 'heatmap' ||
        ((c = a.globals.minY), (d = a.globals.maxY)),
        n.colorScale.min !== void 0 &&
         ((c =
          n.colorScale.min < a.globals.minY
           ? n.colorScale.min
           : a.globals.minY),
         (d =
          n.colorScale.max > a.globals.maxY
           ? n.colorScale.max
           : a.globals.maxY));
       var g = Math.abs(d) + Math.abs(c),
        p = (100 * s) / (g === 0 ? g - 1e-6 : g);
       return (
        n.colorScale.ranges.length > 0 &&
         n.colorScale.ranges.map(function (f, x) {
          if (s >= f.from && s <= f.to) {
           (o = f.color),
            (h = f.foreColor ? f.foreColor : null),
            (c = f.from),
            (d = f.to);
           var b = Math.abs(d) + Math.abs(c);
           p = (100 * s) / (b === 0 ? b - 1e-6 : b);
          }
         }),
      ...
      value: function (e) {
       ...
       if (h.enabled) {
        ...
        var p = h.offsetX,
         f = h.offsetY,
         x = i + p,
         b = a + parseFloat(h.style.fontSize) / 3 + f;
    ...
    E(v, [
     {
      ...
      value: function (e) {
       ...
       for (
        var c = o ? 0 : h.length - 1;
        o ? c < h.length : c >= 0;
        o ? c++ : c--
       ) {
        var d = i.group({
         class: 'apexcharts-series apexcharts-heatmap-series',
         seriesName: L.escapeString(t.globals.seriesNames[c]),
         rel: c + 1,
         'data:realIndex': c,
        });
        if (
         ...
         new O(this.ctx).dropShadow(d, g, c);
        }
        for (
         var p = 0, f = t.config.plotOptions.heatmap.shadeIntensity, x = 0;
         x < h[c].length;
         x++
        ) {
         ...
         t.config.fill.type === 'image' &&
          (y = new q(this.ctx).fillPath({
           ...
           height: t.config.fill.image.height ? t.config.fill.image.height : n,
          }));
         var A = this.rectRadius,
          l = i.drawRect(p, r, s, n, A);
         if (
          (l.attr({ cx: p, cy: r }),
          l.node.classList.add('apexcharts-heatmap-rect'),
          d.add(l),
          l.attr({
           fill: y,
           i: c,
         ...
         if (t.globals.dataChanged) {
          ...
          if (this.dynamicAnim.enabled && t.globals.shouldAnimate) {
           ...
           var w =
            ...
            t.globals.previousPaths[c][x] &&
            t.globals.previousPaths[c][x].color;
           w || (w = 'rgba(255, 255, 255, 0)'),
            this.animateHeatColor(
             l,
             L.isColorHex(w) ? w : L.rgb2hex(w),
             L.isColorHex(y) ? y : L.rgb2hex(y),
             m,
            );
          }
         }
       ...
       t.config.yaxis[0].reversed ? C.unshift('') : C.push(''),
        (t.globals.yAxisScale[0].result = C);
       var M = t.globals.gridHeight / t.globals.series.length;
       return (t.config.yaxis[0].labels.offsetY = -M / 2), a;
      },
     },
     {
      key: 'animateHeatMap',
      value: function (e, t, i, a, s, n) {
       ...
       r.animateRect(
        e,
        { x: t + a / 2, y: i + s / 2, width: 0, height: 0 },
        { x: t, y: i, width: a, height: s },
        n,
        function () {
   ...
   function v(e) {
    ...
    (this.chartType = this.w.config.chart.type),
     ...
     (t.globals.radialSize =
      ...
      (t.config.chart.sparkline.enabled ? 0 : t.config.chart.dropShadow.blur)),
     (this.donutSize =
      (t.globals.radialSize *
    ...
    E(v, [
     {
      ...
      value: function (e) {
       var t = this,
        ...
        a = new I(this.ctx);
       if (
        ((this.ret = a.group({ class: 'apexcharts-pie' })), i.globals.noData)
       )
        return this.ret;
       for (var s = 0, n = 0; n < e.length; n++) s += L.negToZero(e[n]);
       var r = [],
        o = a.group();
       s === 0 && (s = 1e-5),
       ...
       for (var h = 0; h < e.length; h++) {
        var c = (this.fullAngle * L.negToZero(e[h])) / s;
        r.push(c),
         this.chartType === 'polarArea'
          ? ((r[h] = this.fullAngle / e.length),
            this.sliceSizes.push((i.globals.radialSize * e[h]) / this.maxY))
          : this.sliceSizes.push(i.globals.radialSize);
       }
       if (i.globals.dataChanged) {
        for (var d, g = 0, p = 0; p < i.globals.previousPaths.length; p++)
         g += L.negToZero(i.globals.previousPaths[p]);
        for (var f = 0; f < i.globals.previousPaths.length; f++)
         (d = (this.fullAngle * L.negToZero(i.globals.previousPaths[f])) / g),
       ...
       var x = i.config.plotOptions.pie.customScale,
        ...
        k = b - (i.globals.gridWidth / 2) * x,
        A = y - (i.globals.gridHeight / 2) * x;
       if (this.chartType === 'donut') {
        var l = a.drawCircle(this.donutSize);
        l.attr({
         cx: this.centerX,
         cy: this.centerY,
      ...
      value: function (e, t) {
       ...
       for (var g = 0; g < e.length; g++) {
        var p = s.group({
         ...
         seriesName: L.escapeString(i.globals.seriesNames[g]),
         rel: g + 1,
         'data:realIndex': g,
        });
        r.add(p),
        ...
        if (
         (!this.initialAnim || i.globals.resized || i.globals.dataChanged
          ...
          : ((l = (f / this.fullAngle) * i.config.chart.animations.speed) ===
             0 && (l = 1),
            (this.animDur = l + this.animDur),
         ...
         i.globals.selectedDataPoints[0] !== void 0 &&
         ...
         var u = A.x,
          m = A.y,
          w = (100 * f) / this.fullAngle + '%';
         if (
          f !== 0 &&
          i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < e[g]
         ) {
          var S = i.config.dataLabels.formatter;
          S !== void 0 &&
           (w = S(i.globals.seriesPercent[g][0], { seriesIndex: g, w: i }));
          var P = i.globals.dataLabels.style.colors[g],
           C = s.group({ class: 'apexcharts-datalabels' }),
           M = s.drawText({
            x: u,
            y: m,
            text: w,
          ...
          if ((C.add(M), i.config.dataLabels.dropShadow.enabled)) {
      ...
      value: function (e, t) {
       ...
       t.prevStartAngle !== void 0 &&
        ...
        t.i === i.config.series.length - 1 &&
         (a + r > this.fullAngle
          ? (t.endAngle = t.endAngle - (a + r))
          : a + r < this.fullAngle &&
            (t.endAngle = t.endAngle + (this.fullAngle - (a + r)))),
        a === this.fullAngle && (a = this.fullAngle - 0.01),
        this.animateArc(e, n, r, a, s, t);
      },
     },
     {
      key: 'animateArc',
      value: function (e, t, i, a, s, n) {
       var r,
        ...
        c = new K(this.ctx),
        d = n.size;
       (isNaN(t) || isNaN(s)) && ((t = i), (s = a), (n.dur = 0));
       var g = a,
        p = i,
       ...
       h.globals.dataChanged &&
        ...
        n.dur !== 0
         ? e
            .animate(n.dur, h.globals.easing, n.animBeginArr[n.i])
            .afterAll(function () {
             (o.chartType !== 'pie' &&
              o.chartType !== 'donut' &&
              o.chartType !== 'polarArea') ||
              this.animate(
               h.config.chart.animations.dynamicAnimation.speed,
              ).attr({ 'stroke-width': o.strokeWidth }),
              n.i === h.config.series.length - 1 && c.animationCompleted(e);
            })
            .during(function (x) {
             (g = f + (a - f) * x),
              n.animateStartingPos &&
               ((g = s + (a - s) * x), (p = t - s + (i - (t - s)) * x)),
              (r = o.getPiePath({ me: o, startAngle: p, angle: g, size: d })),
              e.node.setAttribute('data:pathOrig', r),
              e.attr({ d: r });
            })
         : ((r = o.getPiePath({ me: o, startAngle: p, angle: a, size: d })),
           n.isTrack || (h.globals.animationEnded = !0),
           e.node.setAttribute('data:pathOrig', r),
      ...
      value: function (e) {
       var t,
        ...
        n = i.globals.dom.Paper.select(
         '.apexcharts-'.concat(a.chartType.toLowerCase(), '-slice-').concat(e),
        ).members[0];
       if (n.attr('data:pieClicked') !== 'true') {
        ...
        var o = parseInt(n.attr('data:startAngle'), 10),
         h = parseInt(n.attr('data:angle'), 10);
        (t = a.getPiePath({ me: a, startAngle: o, angle: h, size: s })),
         h !== 360 && n.plot(t);
       } else {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       var h = (Math.PI * (o - 90)) / 180,
        c = t.centerX + s * Math.cos(r),
        d = t.centerY + s * Math.sin(r),
        g = t.centerX + s * Math.cos(h),
        p = t.centerY + s * Math.sin(h),
        f = L.polarToCartesian(t.centerX, t.centerY, t.donutSize, o),
        x = L.polarToCartesian(t.centerX, t.centerY, t.donutSize, n),
        b = a > 180 ? 1 : 0,
        y = ['M', c, d, 'A', s, s, 0, b, 1, g, p];
       return t.chartType === 'donut'
        ...
        : t.chartType === 'pie' || t.chartType === 'polarArea'
          ? [].concat(y, ['L', t.centerX, t.centerY, 'L', c, d]).join(' ')
          : [].concat(y).join(' ');
      },
     },
     {
      ...
      value: function (e) {
       ...
       this.maxY = o.niceMax;
       for (
        var d = t.globals.radialSize, g = d / (c - 1), p = 0;
        p < c - 1;
        p++
       ) {
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       var r,
        ...
        h = t.centerX,
        c = t.centerY;
       r = e.name.color === void 0 ? i.globals.colors[0] : e.name.color;
       var d = e.name.fontSize,
        g = e.name.fontFamily,
        p = e.value.fontWeight;
       ...
       if (
        (n
         ...
         : i.globals.series.length === 1 &&
           ((x = f(i.globals.series[0], i)), (b = i.globals.seriesNames[0])),
        ...
        y.node.classList.add('apexcharts-datalabel-label'), s.add(y);
       }
       if (e.value.show) {
        var k = e.name.show
        ...
        A.node.classList.add('apexcharts-datalabel-value'), s.add(A);
       }
       return s;
      },
     },
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (s.strokeWidth !== 0) {
        for (
         var n = [], r = 360 / i.globals.series.length, o = 0;
       ...
       var a = this,
        ...
        h = function (g) {
         ...
         Array.prototype.forEach.call(o, function (x) {
          x.getAttribute('data:pieClicked') === 'true' &&
           (p && (r = !0), f && a.printDataLabelsInner(x, t));
         });
        };
       if (
        (h({ makeSliceOut: !0, printLabel: !1 }),
        t.total.show && s.globals.series.length > 1)
       )
        r && !t.total.showAlways
         ? h({ makeSliceOut: !1, printLabel: !0 })
         : this.printInnerLabels(t, t.total.label, t.total.formatter(s));
       else if ((h({ makeSliceOut: !1, printLabel: !0 }), !r))
        if (s.globals.selectedDataPoints.length && s.globals.series.length > 1)
         if (s.globals.selectedDataPoints[0].length > 0) {
          ...
          n &&
           ...
           s.globals.selectedDataPoints[0].length === 0 &&
           (n.style.opacity = 0);
    ...
    E(v, [
     {
      ...
      value: function (e) {
       ...
       var r = i.globals.gridWidth / 2,
        ...
        h = r + i.config.plotOptions.radar.offsetX,
       ...
       if (
        ...
        e.forEach(function (b, y) {
         var k = b.length === i.globals.dataPoints,
          A = t.graphics
           .group()
           .attr({
            class: 'apexcharts-series',
            'data:longestSeries': k,
            seriesName: L.escapeString(i.globals.seriesNames[y]),
            rel: y + 1,
            'data:realIndex': y,
           });
         (t.dataRadiusOfPercent[y] = []),
          (t.dataRadius[y] = []),
          (t.angleArr[y] = []),
          b.forEach(function (z, Y) {
           var H = Math.abs(t.maxValue - t.minValue);
           (z += Math.abs(t.minValue)),
            t.isLog && (z = t.coreUtils.getLogVal(z, 0)),
            (t.dataRadiusOfPercent[y][Y] = z / H),
            (t.dataRadius[y][Y] = t.dataRadiusOfPercent[y][Y] * t.size),
            (t.angleArr[y][Y] = Y * t.disAngle);
          }),
          (g = t.getDataPointsPos(t.dataRadius[y], t.angleArr[y]));
         var l = t.createPaths(g, { x: 0, y: 0 });
         (p = t.graphics.group({
          ...
          i.globals.delayedElements.push({ el: p.node, index: y });
         var u = {
           i: y,
           realIndex: y,
           animationDelay: y,
           ...
           shouldClipToGrid: !1,
           bindEventsOnPaths: !1,
           stroke: i.globals.stroke.colors[y],
           strokeLineCap: i.config.stroke.lineCap,
          },
          m = null;
         i.globals.previousPaths.length > 0 && (m = t.getPreviousPath(y));
         for (var w = 0; w < l.linePathsTo.length; w++) {
          var S = t.graphics.renderPaths(
           F(
            F({}, u),
            {},
            {
             pathFrom: m === null ? l.linePathsFrom[w] : m,
             pathTo: l.linePathsTo[w],
          ...
          A.add(S);
          var P = a.fillPath({ seriesNumber: y }),
           C = t.graphics.renderPaths(
            F(
             F({}, u),
             {},
             {
              pathFrom: m === null ? l.areaPathsFrom[w] : m,
              pathTo: l.areaPathsTo[w],
              strokeWidth: 0,
              fill: P,
              drawShadow: !1,
             },
          ...
          if (i.config.chart.dropShadow.enabled) {
           var M = new O(t.ctx),
            T = i.config.chart.dropShadow;
           M.dropShadow(C, Object.assign({}, T, { noUserSpaceOnUse: !0 }), y);
          }
          A.add(C);
         }
         b.forEach(function (z, Y) {
          var H = new ne(t.ctx).getMarkerConfig({
            cssClass: 'apexcharts-marker',
            seriesIndex: y,
            dataPointIndex: Y,
           }),
           R = t.graphics.drawMarker(g[Y].x, g[Y].y, H);
          R.attr('rel', Y),
           R.attr('j', Y),
           R.attr('index', y),
           R.node.setAttribute('default-marker-size', H.pSize);
          var V = t.graphics.group({ class: 'apexcharts-series-markers' });
          V && V.add(R), p.add(V), A.add(p);
          var G = i.config.dataLabels;
          if (G.enabled) {
           var Z = G.formatter(i.globals.series[y][Y], {
            seriesIndex: y,
            dataPointIndex: Y,
            w: i,
           });
     ...
     },
     {
      ...
      value: function (e) {
       ...
       o.forEach(function (p, f) {
        var x = L.getPolygonPos(p, t.dataPointsLen),
         b = '';
        x.forEach(function (y, k) {
         if (f === 0) {
          var A = t.graphics.drawLine(
           ...
           Array.isArray(t.polygons.connectorColors)
            ? t.polygons.connectorColors[k]
            : t.polygons.connectorColors,
          );
          g.push(A);
         }
         k === 0 && t.yaxisLabelsTextsPos.push({ x: y.x, y: y.y }),
          (b += y.x + ',' + y.y + ' ');
        }),
         d.push(b);
       }),
        d.forEach(function (p, f) {
         var x = t.polygons.strokeColors,
          b = t.polygons.strokeWidth,
          y = t.graphics.drawPolygon(
           p,
           Array.isArray(x) ? x[f] : x,
           Array.isArray(b) ? b[f] : b,
           i.globals.radarPolygons.fill.colors[f],
          );
         a.add(y);
        }),
        ...
        i.config.yaxis[0].show &&
         this.yaxisLabelsTextsPos.forEach(function (p, f) {
          var x = s.drawYAxisTexts(p.x, p.y, f, n[f]);
          t.yaxisLabels.add(x);
         });
      },
     },
     {
      ...
      value: function () {
       var e = this,
        ...
        s = L.getPolygonPos(this.size, this.dataPointsLen);
       return (
        t.globals.labels.forEach(function (n, r) {
         var o = t.config.xaxis.labels.formatter,
          h = new ee(e.ctx);
         if (s[r]) {
          var c = e.getTextPos(s[r], e.size),
           d = o(n, { seriesIndex: -1, dataPointIndex: r, w: t });
       ...
       if (e.length) {
        ...
        e.forEach(function (c, d) {
         (o += i.graphics.line(c.x, c.y)),
          (h += i.graphics.line(c.x, c.y)),
          d === e.length - 1 && ((o += 'Z'), (h += 'Z'));
        }),
         a.push(o),
         n.push(h);
       }
      ...
      value: function (e) {
       for (
        ...
        s.paths.length > 0 &&
         ...
         t.globals.previousPaths[a].paths[0] !== void 0 &&
  ...
  At = (function (v) {
   ...
   function t(i) {
    ...
    return (
     ...
     a.endAngle === 360 && (a.endAngle = 359.99),
    ...
    E(t, [
     {
      ...
      value: function (i) {
       ...
       a.config.chart.sparkline.enabled ||
        (c = c - a.config.stroke.width - a.config.chart.dropShadow.blur);
       ...
       var x = (360 - f) / 360;
       if (
        ((a.globals.radialSize = c - c * x), this.radialDataLabels.value.show)
       ) {
        var b = Math.max(
         this.radialDataLabels.value.offsetY,
         this.radialDataLabels.name.offsetY,
        );
        a.globals.radialSize += b * x;
       }
       return (
        r.add(p.g),
        a.config.plotOptions.radialBar.hollow.position === 'front' &&
         (p.g.add(p.elHollow), p.dataLabels && p.g.add(p.dataLabels)),
        n.add(r),
        n
       );
      },
     },
     {
      ...
      value: function (i) {
       ...
       for (var c = 0; c < i.series.length; c++) {
        ...
        n.add(d), d.attr({ rel: c + 1 }), (i.size = i.size - h - this.margin);
        var g = a.config.plotOptions.radialBar.track,
         p = o.fillPath({
          seriesNumber: 0,
          size: i.size,
          fillColors: Array.isArray(g.background)
           ? g.background[c]
           : g.background,
          solid: !0,
         }),
        ...
        Math.abs(x) + Math.abs(f) >= 360 &&
         (x = 360 - Math.abs(this.startAngle) - 0.1);
        var b = s.drawPath({
         d: '',
         stroke: p,
         strokeWidth: (h * parseInt(g.strokeWidth, 10)) / 100,
         fill: 'none',
        ...
        d.add(b),
         b.attr('id', 'apexcharts-radialbarTrack-' + c),
         this.animatePaths(b, {
          centerX: i.centerX,
          centerY: i.centerY,
          endAngle: x,
      ...
      value: function (i) {
       ...
       var c = a.config.plotOptions.radialBar.hollow.background,
        d =
         i.size -
         h * i.series.length -
         this.margin * i.series.length -
         (h * parseInt(a.config.plotOptions.radialBar.track.strokeWidth, 10)) /
          100 /
          2,
        g = d - a.config.plotOptions.radialBar.hollow.margin;
       a.config.plotOptions.radialBar.hollow.image !== void 0 &&
        (c = this.drawHollowImage(i, o, d, c));
       ...
       this.radialDataLabels.show &&
        (b = this.renderInnerDataLabels(this.radialDataLabels, {
         hollowSize: d,
         centerX: i.centerX,
         centerY: i.centerY,
         opacity: x,
        })),
        a.config.plotOptions.radialBar.hollow.position === 'back' &&
         (o.add(p), b && o.add(b));
       var y = !1;
       a.config.plotOptions.radialBar.inverseOrder && (y = !0);
       for (
        var k = y ? i.series.length - 1 : 0;
        y ? k >= 0 : k < i.series.length;
        y ? k-- : k++
       ) {
        var A = s.group({
         class: 'apexcharts-series apexcharts-radial-series',
         seriesName: L.escapeString(a.globals.seriesNames[k]),
        });
        o.add(A),
         A.attr({ rel: k + 1, 'data:realIndex': k }),
         this.ctx.series.addCollapsedClassToSeries(A, k),
        ...
        var l = n.fillPath({
         ...
         u = this.startAngle,
         m = void 0,
         w = L.negToZero(i.series[k] > 100 ? 100 : i.series[k]) / 100,
         S = Math.round(this.totalAngle * w) + this.startAngle,
         P = void 0;
        a.globals.dataChanged &&
         ((m = this.startAngle),
         (P =
          Math.round(
           (this.totalAngle * L.negToZero(a.globals.previousPaths[k])) / 100,
          ) + m)),
         Math.abs(S) + Math.abs(u) >= 360 && (S -= 0.01),
         Math.abs(P) + Math.abs(m) >= 360 && (P -= 0.01);
        var C = S - u,
         M = Array.isArray(a.config.stroke.dashArray)
          ? a.config.stroke.dashArray[k]
        ...
        if (
         (I.setAttrs(T.node, { 'data:angle': C, 'data:value': i.series[k] }),
         a.config.chart.dropShadow.enabled)
        ) {
         var z = a.config.chart.dropShadow;
         r.dropShadow(T, z, k);
        }
        r.setSelectionFilter(T, 0, k),
        ...
        !this.initialAnim ||
         a.globals.resized ||
         a.globals.dataChanged ||
         ((Y = ((S - u) / 360) * a.config.chart.animations.speed),
         (this.animDur = Y / (1.2 * i.series.length) + this.animDur),
         this.animBeginArr.push(this.animDur)),
         a.globals.dataChanged &&
          ((Y =
           ((S - u) / 360) * a.config.chart.animations.dynamicAnimation.speed),
          (this.animDur = Y / (1.2 * i.series.length) + this.animDur),
          this.animBeginArr.push(this.animDur)),
         this.animatePaths(T, {
          centerX: i.centerX,
     ...
     },
     {
      key: 'drawHollow',
      value: function (i) {
       var a = new I(this.ctx).drawCircle(2 * i.size);
       return (
        a.attr({
      ...
      value: function (i, a, s, n) {
       ...
       if (r.config.plotOptions.radialBar.hollow.imageClipped)
        o.clippedImgArea({
         ...
         height: s,
         image: c,
         patternID: 'pattern'.concat(r.globals.cuid).concat(h),
        }),
         (n = 'url(#pattern'.concat(r.globals.cuid).concat(h, ')'));
       else {
        var d = r.config.plotOptions.radialBar.hollow.imageWidth,
         g = r.config.plotOptions.radialBar.hollow.imageHeight;
        if (d === void 0 && g === void 0) {
         var p = r.globals.dom.Paper.image(c).loaded(function (x) {
          this.move(
           i.centerX -
            x.width / 2 +
         ...
         var f = r.globals.dom.Paper.image(c).loaded(function (x) {
          this.move(
           i.centerX -
            d / 2 +
            r.config.plotOptions.radialBar.hollow.imageOffsetX,
     ...
     },
     {
      ...
      value: function (i) {
       ...
       return (
        (i.size *
         (100 - parseInt(a.config.plotOptions.radialBar.hollow.size, 10))) /
         100 /
         (i.series.length + 1) -
        this.margin
       );
  ...
  St = (function () {
   function v(e) {
    X(this, v), (this.w = e.w), (this.lineCtx = e);
   }
   return (
    E(v, [
     {
      ...
      value: function (e, t) {
       ...
       if (
        ...
        (i.config.fill.type === 'gradient' ||
         i.config.fill.type[e] === 'gradient') &&
        new D(this.lineCtx.ctx, i).seriesHaveSameValues(e)
       ) {
        var a = t[e].slice();
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (r === 0) {
        ...
        h.globals.isXNumeric &&
         (g =
          (h.globals.seriesX[i][0] - h.globals.minX) / this.lineCtx.xRatio +
          h.config.markers.offsetX),
         c.push(g),
         d.push(L.isNumber(t[n][0]) ? o + h.config.markers.offsetY : null),
         c.push(a + h.config.markers.offsetX),
         d.push(L.isNumber(t[n][r + 1]) ? s + h.config.markers.offsetY : null);
       } else
        c.push(a + h.config.markers.offsetX),
         d.push(L.isNumber(t[n][r + 1]) ? s + h.config.markers.offsetY : null);
       return { x: c, y: d };
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (i[t][0] !== void 0)
        a =
         (s =
          n.config.chart.stacked && t > 0
           ? this.lineCtx.prevSeriesY[t - 1][0]
           : this.lineCtx.zeroY) -
         i[t][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] +
         2 *
          (this.lineCtx.isReversed
           ? i[t][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex]
           : 0);
       else if (n.config.chart.stacked && t > 0 && i[t][0] === void 0) {
        for (var r = t - 1; r >= 0; r--)
         if (i[r][0] !== null && i[r][0] !== void 0) {
  ...
  Se = (function () {
   function v(e, t, i) {
    X(this, v),
     ...
     (this.scatter = new Ee(this.ctx)),
     (this.noNegatives = this.w.globals.minX === Number.MAX_VALUE),
     (this.lineHelpers = new St(this)),
     (this.markers = new ne(this.ctx)),
     (this.prevSeriesY = []),
    ...
    E(v, [
     {
      ...
      value: function (e, t, i) {
       var a = this.w,
        s = new I(this.ctx),
        n = a.globals.comboCharts ? t : a.config.chart.type,
        r = s.group({
       ...
       for (var h = [], c = 0; c < e.length; c++) {
        ...
        var d = a.globals.comboCharts ? i[c] : c;
        ...
        this.ctx.series.addCollapsedClassToSeries(this.elSeries, d),
         a.globals.isXNumeric &&
          ...
          (f = (a.globals.seriesX[d][0] - a.globals.minX) / this.xRatio),
         p.push(f);
        var x,
         b = f,
         y = b,
        ...
        this._handlePaths({ type: n, realIndex: d, i: c, paths: l }),
         this.elSeries.add(this.elPointsMain),
         this.elSeries.add(this.elDataLabelsWrap),
         h.push(this.elSeries);
       }
       if (a.config.chart.stacked)
        for (var u = h.length; u > 0; u--) r.add(h[u - 1]);
       else for (var m = 0; m < h.length; m++) r.add(h[m]);
       return r;
      },
     },
     {
      ...
      value: function (e, t, i) {
       ...
       (this.xDivision =
        ...
        (a.globals.dataPoints -
         (a.config.xaxis.tickPlacement === 'on' ? 1 : 0))),
        ...
        (this.zeroY > a.globals.gridHeight ||
         a.config.plotOptions.area.fillTo === 'end') &&
     ...
     },
     {
      ...
      value: function (e) {
       var t,
        ...
        g = new I(this.ctx);
       if (n[r][0] === null) {
        for (var p = 0; p < n[r].length; p++)
         if (n[r][p] !== null) {
          (h = this.xDivision * p),
           (c = this.zeroY - n[r][p] / this.yRatio[this.yaxisIndex]),
           (t = g.move(h, c)),
           (i = g.move(h, this.areaBottomY));
          break;
         }
       } else
        (t = g.move(h, c)), (i = g.move(h, this.areaBottomY) + g.line(h, c));
       if (
     ...
     },
     {
      ...
      value: function (e) {
       ...
       this.prevSeriesY.push(s.yArrj),
        (n.globals.seriesXvalues[i] = s.xArrj),
        (n.globals.seriesYvalues[i] = s.yArrj);
       var h = n.config.forecastDataPoints;
       if (h.count > 0) {
        var c =
          n.globals.seriesXvalues[i][
           n.globals.seriesXvalues[i].length - h.count - 1
          ],
         d = r.drawRect(c, 0, n.globals.gridWidth, n.globals.gridHeight, 0);
        n.globals.dom.elForecastMask.appendChild(d.node);
        var g = r.drawRect(0, 0, c, n.globals.gridHeight, 0);
        n.globals.dom.elNonForecastMask.appendChild(g.node);
       }
       this.pointsChart ||
       ...
       if (t === 'area')
        for (
         var f = o.fillPath({ seriesNumber: i }), x = 0;
         x < s.areaPaths.length;
         x++
        ) {
         var b = r.renderPaths(
          F(
       ...
       if (n.config.stroke.show && !this.pointsChart) {
        ...
        for (var k = 0; k < s.linePaths.length; k++) {
         var A = F(
           F({}, p),
           {},
           {
            pathFrom: s.pathFromLine,
            pathTo: s.linePaths[k],
            stroke: y,
            strokeWidth: this.strokeWidth,
          ...
          l = r.renderPaths(A);
         if ((this.elSeries.add(l), h.count > 0)) {
          var u = r.renderPaths(A);
          u.node.setAttribute('stroke-dasharray', h.dashArray),
           h.strokeWidth && u.node.setAttribute('stroke-width', h.strokeWidth),
           this.elSeries.add(u),
           u.attr('clip-path', 'url(#forecastMask'.concat(n.globals.cuid, ')')),
           l.attr(
            'clip-path',
      ...
      value: function (e) {
       for (
        var t = e.series,
         ...
         m = h.pathFromLine,
         w = h.pathFromArea,
         S = L.isNumber(b.globals.minYArr[i])
          ? b.globals.minYArr[i]
          : b.globals.minY,
         P =
        ...
        var M = t[a][C + 1] === void 0 || t[a][C + 1] === null;
        if (b.globals.isXNumeric) {
         var T = b.globals.seriesX[i][C + 1];
         b.globals.seriesX[i][C + 1] === void 0 &&
          (T = b.globals.seriesX[i][P - 1]),
        ...
        b.config.chart.stacked
         ? a > 0 &&
           ...
           ? (p =
              this.prevSeriesY[
               (function (H) {
                for (var R = H, V = 0; V < b.globals.series.length; V++)
                 if (b.globals.collapsedSeriesIndices.indexOf(H) > -1) {
                  R--;
                  break;
                 }
                return R >= 0 ? R : 0;
         ...
         (n = M
          ? p -
            S / k[this.yaxisIndex] +
            2 * (this.isReversed ? S / k[this.yaxisIndex] : 0)
          : p -
            t[a][C + 1] / k[this.yaxisIndex] +
            2 * (this.isReversed ? t[a][C + 1] / k[this.yaxisIndex] : 0)),
         f.push(s),
         x.push(n);
        ...
        (d = Y.areaPaths),
         ...
         (l = Y.linePath),
         this.appendPathFrom &&
          ((m += y.line(s, this.zeroY)), (w += y.line(s, this.zeroY))),
         this.handleNullDataPoints(t, z, a, C, i),
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (this.pointsChart)
        ...
        n.globals.series[i].length > 1 &&
         this.elPointsMain.node.classList.add('apexcharts-element-hidden');
        var o = this.markers.plotChartMarkers(t, s, a + 1);
        o !== null && this.elPointsMain.add(o);
       }
       var h = r.drawDataLabel(t, s, a + 1, null);
      ...
      value: function (e) {
       ...
       if (
        ...
        x.globals.hasNullValues
         ? (t[i][s] !== null &&
            (t[i][s + 1] !== null
             ? ((c = b.move(o, h) + b.curve(o + A, h, n - A, r, n + 1, r)),
               (d =
                b.move(o + 1, h) +
                b.curve(o + A, h, n - A, r, n + 1, r) +
                b.line(n, k) +
                b.line(o, k) +
                'z'))
             : ((c = b.move(o, h)), (d = b.move(o, h) + 'z'))),
           g.push(c),
           p.push(d))
         : ((c += b.curve(o + A, h, n - A, r, n, r)),
           (d += b.curve(o + A, h, n - A, r, n, r))),
         (o = n),
         (h = r),
         s === t[i].length - 2 &&
          ((d = d + b.curve(o, h, n, r, n, k) + b.move(n, r) + 'z'),
          x.globals.hasNullValues || (g.push(c), p.push(d)));
       } else {
        if (t[i][s + 1] === null) {
         c += b.move(n, r);
         var l = x.globals.isXNumeric
          ? (x.globals.seriesX[a][s] - x.globals.minX) / this.xRatio
          : n - this.xDivision;
         d = d + b.line(l, k) + b.move(n, r) + 'z';
        }
        t[i][s] === null && ((c += b.move(n, r)), (d += b.move(n, k))),
         y === 'stepline'
          ? ((c = c + b.line(n, null, 'H') + b.line(null, r, 'V')),
            (d = d + b.line(n, null, 'H') + b.line(null, r, 'V')))
          : y === 'straight' && ((c += b.line(n, r)), (d += b.line(n, r))),
         s === t[i].length - 2 &&
          ((d = d + b.line(n, k) + b.move(n, r) + 'z'), g.push(c), p.push(d));
       }
       return {
        linePaths: g,
        areaPaths: p,
     ...
     },
     {
      ...
      value: function (e, t, i, a, s) {
       var n = this.w;
       if (
        (e[i][a] === null && n.config.markers.showNullDataPoints) ||
        e[i].length === 1
       ) {
        ...
        r !== null && this.elPointsMain.add(r);
       }
      },
     },
    ]),
 ...
 (window.TreemapSquared = {}),
  (window.TreemapSquared.generate = (function () {
    ...
    (this.xoffset = r),
     ...
     (this.getCoordinates = function (d) {
      ...
      if (this.width >= this.height)
       for (g = 0; g < d.length; g++)
        p.push([f, x, f + b, x + d[g] / b]), (x += d[g] / b);
      else
       for (g = 0; g < d.length; g++)
        p.push([f, x, f + d[g] / y, x + y]), (f += d[g] / y);
      return p;
     }),
     (this.cutArea = function (d) {
      ...
      if (this.width >= this.height) {
       var p = d / this.height,
        f = this.width - p;
       g = new v(this.xoffset + p, this.yoffset, f, this.height);
      } else {
       var x = d / this.width,
        b = this.height - x;
       g = new v(this.xoffset, this.yoffset + x, this.width, b);
      }
      return g;
     });
   }
   function e(r, o, h, c, d) {
    return (
     (c = c === void 0 ? 0 : c),
     (d = d === void 0 ? 0 : d),
     (function (g) {
      ...
      for (p = 0; p < g.length; p++)
       for (f = 0; f < g[p].length; f++) x.push(g[p][f]);
      return x;
     })(
      t(
       (function (g, p) {
        var f,
         x = [],
         b = p / s(g);
        for (f = 0; f < g.length; f++) x[f] = g[f] * b;
        return x;
       })(r, o * h),
       [],
       new v(c, d, o, h),
   ...
   function i(r, o) {
    var h = Math.min.apply(Math, r),
     c = Math.max.apply(Math, r),
     d = s(r);
    return Math.max(
     (Math.pow(o, 2) * c) / Math.pow(d, 2),
     Math.pow(d, 2) / (Math.pow(o, 2) * h),
    );
   }
   function a(r) {
   ...
   function s(r) {
    var o,
     h = 0;
    for (o = 0; o < r.length; o++) h += r[o];
    return h;
   }
   function n(r) {
    var o,
     h = 0;
    if (a(r[0])) for (o = 0; o < r.length; o++) h += n(r[o]);
    else h = s(r);
    return h;
   }
   return function r(o, h, c, d, g) {
    ...
    var p,
     ...
     b = [];
    if (a(o[0])) {
     for (f = 0; f < o.length; f++) x[f] = n(o[f]);
     for (p = e(x, h, c, d, g), f = 0; f < o.length; f++)
      b.push(r(o[f], p[f][2] - p[f][0], p[f][3] - p[f][1], p[f][0], p[f][1]));
    } else b = e(o, h, c, d, g);
    return b;
   };
  })());
 var Q,
       ...
       return (
        ...
        window.TreemapSquared.generate(
         ...
         var c = a.group({
          ...
          seriesName: L.escapeString(i.globals.seriesNames[h]),
          rel: h + 1,
          'data:realIndex': h,
         });
         if (i.config.chart.dropShadow.enabled) {
          var d = i.config.chart.dropShadow;
          new O(t.ctx).dropShadow(n, d, h);
         }
         ...
         o.forEach(function (p, f) {
          ...
          var l = t.helpers.getShadeColor(
           ...
           u = l.color;
          i.config.series[h].data[f] !== void 0 &&
           i.config.series[h].data[f].fillColor &&
           (u = i.config.series[h].data[f].fillColor);
          var m = s.fillPath({ color: u, seriesNumber: h, dataPointIndex: f });
          A.node.classList.add('apexcharts-treemap-rect'),
           A.attr({ fill: m }),
           t.helpers.addListeners(A);
          var w = {
            x: x + (y - x) / 2,
            y: b + (k - b) / 2,
            width: 0,
           ...
           S = { x, y: b, width: y - x, height: k - b };
          if (i.config.chart.animations.enabled && !i.globals.dataChanged) {
           var P = 1;
           i.globals.resized || (P = i.config.chart.animations.speed),
            t.animateTreemap(A, w, S, P);
          }
          if (i.globals.dataChanged) {
           var C = 1;
           t.dynamicAnim.enabled &&
            i.globals.shouldAnimate &&
            ((C = t.dynamicAnim.speed),
            i.globals.previousPaths[h] &&
             i.globals.previousPaths[h][f] &&
             i.globals.previousPaths[h][f].rect &&
             (w = i.globals.previousPaths[h][f].rect),
            t.animateTreemap(A, w, S, C));
          }
          var M = t.getFontSize(p),
           T = i.config.dataLabels.formatter(t.labels[h][f], {
            value: i.globals.series[h][f],
            seriesIndex: h,
            dataPointIndex: f,
            w: i,
           }),
           z = t.helpers.calculateDataLabels({
            text: T,
            x: (x + y) / 2,
            y: (b + k) / 2 + t.strokeWidth / 2 + M / 3,
            i: h,
            j: f,
            colorProps: l,
            fontSize: M,
          ...
          i.config.dataLabels.enabled &&
           z &&
           t.rotateToFitLabel(z, T, x, b, y, k),
           c.add(A),
           z !== null && c.add(z);
         }),
          c.add(g),
     ...
     },
     {
      ...
      value: function (e) {
       var t = this.w,
        ...
        r =
         (function o(h) {
          var c,
           d = 0;
          if (Array.isArray(h[0])) for (c = 0; c < h.length; c++) d += o(h[c]);
          else for (c = 0; c < h.length; c++) d += h[c].length;
          return d;
         })(this.labels) /
         (function o(h) {
          var c,
       ...
       return (
        ...
        (s = i * a),
        (n = Math.pow(s, 0.5)),
        Math.min(n / r, parseInt(t.config.dataLabels.style.fontSize, 10))
       );
      },
     },
     {
      ...
      value: function (e, t, i, a, s, n) {
       var r = new I(this.ctx),
        o = r.getTextRects(t);
       if (o.width + 5 > s - i && o.width <= n - a) {
        var h = r.rotateAroundCenter(e.node);
        e.node.setAttribute(
         'transform',
    ...
    E(v, [
     {
      ...
      value: function (e, t) {
       ...
       var r = s.getTimeUnitsfromTimestamp(e, t, this.utc),
        ...
        A = {
         firstVal: k,
         currentMillisecond: k.minMillisecond,
         currentSecond: k.minSecond,
         currentMinute: k.minMinute,
         currentHour: k.minHour,
         currentMonthDate: k.minDate,
         currentDate: k.minDate,
         currentMonth: k.minMonth,
         currentYear: k.minYear,
         daysWidthOnXAxis: o,
         hoursWidthOnXAxis: h,
       ...
       switch (this.tickInterval) {
        case 'years':
         this.generateYearScale(A);
         break;
        case 'months':
        case 'half_year':
         this.generateMonthScale(A);
         break;
        case 'months_days':
        case 'months_fortnight':
        case 'days':
        case 'week_days':
         this.generateDayScale(A);
         break;
        case 'hours':
         this.generateHourScale(A);
         break;
        case 'minutes_fives':
        case 'minutes':
         this.generateMinuteScale(A);
         break;
        case 'seconds_tens':
        case 'seconds_fives':
        case 'seconds':
         this.generateSecondScale(A);
       }
       var l = this.timeScaleArray.map(function (u) {
        var m = {
         position: u.position,
         unit: u.unit,
         year: u.year,
        ...
        return u.unit === 'month'
         ? F(F({}, m), {}, { day: 1, value: u.value + 1 })
         : u.unit === 'day' || u.unit === 'hour'
           ? F(F({}, m), {}, { value: u.value })
           : u.unit === 'minute'
             ? F(F({}, m), {}, { value: u.value, minute: u.value })
             : u.unit === 'second'
               ? F(
                  F({}, m),
                  {},
                  { value: u.value, minute: u.minute, second: u.second },
                 )
               : u;
       });
       return l.filter(function (u) {
        var m = 1,
         w = Math.ceil(a.globals.gridWidth / 120),
         S = u.value;
        a.config.xaxis.tickAmount !== void 0 && (w = a.config.xaxis.tickAmount),
         l.length > w && (m = Math.floor(l.length / w));
        var P = !1,
         C = !1;
        switch (i.tickInterval) {
         ...
         case 'months_fortnight':
          (m = 15),
           (u.unit !== 'year' && u.unit !== 'month') || (P = !0),
           S === 30 && (C = !0);
          break;
         case 'months_days':
          (m = 10), u.unit === 'month' && (P = !0), S === 30 && (C = !0);
          break;
         case 'week_days':
          (m = 8), u.unit === 'month' && (P = !0);
          break;
         case 'days':
          (m = 1), u.unit === 'month' && (P = !0);
          break;
         case 'hours':
          u.unit === 'day' && (P = !0);
          break;
        ...
        if (
         i.tickInterval === 'hours' ||
         i.tickInterval === 'minutes_fives' ||
         i.tickInterval === 'seconds_tens' ||
         i.tickInterval === 'seconds_fives'
        ) {
         if (!C) return !0;
        } else if ((S % m == 0 || P) && !C) return !0;
       });
      },
     },
     {
      ...
      value: function (e, t) {
       ...
       (i.globals.timescaleLabels = s.slice()), new ue(this.ctx).plotCoords();
      },
     },
     {
     ...
     },
     {
      ...
      value: function (e) {
       ...
       if (t.minDate > 1 || t.minMonth > 0) {
        var d = h.determineRemainingDaysOfYear(
         t.minYear,
         t.minMonth,
         t.minDate,
        );
        (o = (h.determineDaysOfYear(t.minYear) - d + 1) * s),
         (r = t.minYear + 1),
       ...
       for (var g = r, p = o, f = 0; f < n; f++)
        g++,
         (p = h.determineDaysOfYear(g - 1) * s + p),
         this.timeScaleArray.push({
          position: p,
          value: g,
          unit: c,
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.firstVal,
        ...
        g = 0;
       if (t.minDate > 1) {
        (h = (c.determineDaysOfMonths(a + 1, t.minYear) - i + 1) * n),
         (o = L.monthMod(a + 1));
        var p = s + g,
         f = L.monthMod(o),
         x = o;
        o === 0 && ((d = 'year'), (x = p), (f = 1), (p += g += 1)),
         this.timeScaleArray.push({
          position: h,
          value: x,
          unit: d,
       ...
       for (var b = o + 1, y = h, k = 0, A = 1; k < r; k++, A++) {
        (b = L.monthMod(b)) === 0 ? ((d = 'year'), (g += 1)) : (d = 'month');
        var l = this._getYear(s, b, g);
        y = c.determineDaysOfMonths(b, l) * n + y;
        var u = b === 0 ? l : b;
        this.timeScaleArray.push({
         position: y,
         value: u,
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.firstVal,
        ...
        d = function (A, l, u) {
         return (
          A > r.determineDaysOfMonths(l + 1, u) &&
           ((c = 1), (o = 'month'), (p = l += 1)),
          l
         );
        },
       ...
       t.minHour === 0 && t.minDate === 1
        ...
        : t.minDate !== 1 &&
          t.minHour === 0 &&
          t.minMinute === 0 &&
          ((g = 0), (h = t.minDate), (p = h), (f = d((c = h), i, a))),
        this.timeScaleArray.push({
         position: g,
         value: p,
         unit: o,
       ...
       for (var x = g, b = 0; b < n; b++) {
        (o = 'day'), (f = d((c += 1), f, this._getYear(a, f, 0)));
        var y = this._getYear(a, f, 0);
        x = 24 * s + x;
        var k = c === 1 ? L.monthMod(f) : c;
        this.timeScaleArray.push({
         position: x,
         value: k,
         unit: o,
     ...
     },
     {
      ...
      value: function (e) {
       var t = e.firstVal,
        ...
        c = function (m, w) {
         return (
          m > o.determineDaysOfMonths(w + 1, s) && ((b = 1), (w += 1)),
          { month: w, date: b }
         );
        },
        d = function (m, w) {
         return m > o.determineDaysOfMonths(w + 1, s) ? (w += 1) : w;
        },
        g = 60 - (t.minMinute + t.minSecond / 60),
        p = g * n,
        f = t.minHour + 1,
        x = f + 1;
       g === 60 && ((p = 0), (x = (f = t.minHour) + 1));
       var b = i,
        y = d(b, a);
       this.timeScaleArray.push({
        position: p,
       ...
       for (var k = p, A = 0; A < r; A++) {
        (h = 'hour'),
         x >= 24 &&
          ((x = 0), (h = 'day'), (y = c((b += 1), y).month), (y = d(b, y)));
        var l = this._getYear(s, y, 0);
        k = x === 0 && A === 0 ? g * n : 60 * n + k;
        var u = x === 0 ? b : x;
        this.timeScaleArray.push({
         position: k,
         value: u,
     ...
     },
     {
      ...
      value: function (e, t) {
       ...
       return (
        ...
        e.unit === 'day'
         ? (i += e.unit === 'day' ? '-' + ('0' + t).slice(-2) : '-01')
         : (i += '-' + ('0' + (e.day ? e.day : '1')).slice(-2)),
        e.unit === 'hour'
         ? (i += e.unit === 'hour' ? 'T' + ('0' + t).slice(-2) : 'T00')
         : (i += 'T' + ('0' + (e.hour ? e.hour : '0')).slice(-2)),
        e.unit === 'minute'
         ? (i += ':' + ('0' + t).slice(-2))
         : (i += ':' + (e.minute ? ('0' + e.minute).slice(-2) : '00')),
        e.unit === 'second' ? (i += ':' + ('0' + t).slice(-2)) : (i += ':00'),
        this.utc && (i += '.000Z'),
        i
       );
      },
      ...
      value: function (e) {
       ...
       return e.map(function (a) {
        var s = a.value.toString(),
         n = new W(t.ctx),
         r = t.createRawDateString(a, s),
         o = n.getDate(n.parseDate(r));
        if (
         (t.utc || (o = n.getDate(n.parseDateWithTimezone(r))),
         i.config.xaxis.labels.format === void 0)
        ) {
         var h = 'dd MMM',
          c = i.config.xaxis.labels.datetimeFormatter;
         a.unit === 'year' && (h = c.year),
          a.unit === 'month' && (h = c.month),
          a.unit === 'day' && (h = c.day),
          a.unit === 'hour' && (h = c.hour),
          a.unit === 'minute' && (h = c.minute),
          a.unit === 'second' && (h = c.second),
          (s = n.formatDate(o, h));
        } else s = n.formatDate(o, i.config.xaxis.labels.format);
        return {
         dateString: r,
         position: a.position,
         value: s,
     ...
     },
     {
      ...
      value: function (e) {
       ...
       var n = 0,
        r = e.map(function (o, h) {
         if (h > 0 && i.w.config.xaxis.labels.hideOverlappingLabels) {
          var c = s ? t : a.getTextRects(e[n].value).width,
           d = e[n].position;
          return o.position > d + c + 10 ? ((n = h), o) : null;
         }
         return o;
        });
  ...
  Pt = (function () {
   function v(e, t) {
    X(this, v), (this.ctx = t), (this.w = t.w), (this.el = e);
   }
   return (
    E(v, [
     {
     ...
     },
     {
      ...
      value: function (e, t) {
       var i = this.w,
        ...
        d = { series: [], i: [] },
        g = { series: [], i: [] };
       s.series.map(function (u, m) {
        var w = 0;
        e[m].type !== void 0
         ? (e[m].type === 'column' || e[m].type === 'bar'
            ? (s.series.length > 1 &&
            ...
            : e[m].type === 'area'
              ? (r.series.push(u), r.i.push(m), w++)
              : e[m].type === 'line'
                ? (n.series.push(u), n.i.push(m), w++)
                : e[m].type === 'scatter'
                  ? (o.series.push(u), o.i.push(m))
                  : e[m].type === 'bubble'
                    ? (h.series.push(u), h.i.push(m), w++)
                    : e[m].type === 'candlestick'
                      ? (d.series.push(u), d.i.push(m), w++)
                      : e[m].type === 'boxPlot'
                        ? (g.series.push(u), g.i.push(m), w++)
                        : console.warn(
                           'You have specified an unrecognized chart type. Available types for this property are line/area/column/bar/scatter/bubble',
                          ),
           w > 1 && (s.comboCharts = !0))
         : (n.series.push(u), n.i.push(m));
       });
       var p = new Se(this.ctx, t),
        f = new Ae(this.ctx, t);
       this.ctx.pie = new Ge(this.ctx);
       var x = new At(this.ctx);
       this.ctx.rangeBar = new me(this.ctx, t);
       var b = new kt(this.ctx),
        y = [];
       if (s.comboCharts) {
        if (
         (r.series.length > 0 && y.push(p.draw(r.series, 'area', r.i)),
         c.series.length > 0)
        )
         if (i.config.chart.stacked) {
          var k = new We(this.ctx, t);
          y.push(k.draw(c.series, c.i));
         } else
          (this.ctx.bar = new te(this.ctx, t)),
           y.push(this.ctx.bar.draw(c.series, c.i));
        if (
         (n.series.length > 0 && y.push(p.draw(n.series, 'line', n.i)),
         d.series.length > 0 && y.push(f.draw(d.series, d.i)),
         g.series.length > 0 && y.push(f.draw(g.series, g.i)),
         o.series.length > 0)
        ) {
         var A = new Se(this.ctx, t, !0);
         y.push(A.draw(o.series, 'scatter', o.i));
        }
        if (h.series.length > 0) {
         var l = new Se(this.ctx, t, !0);
         y.push(l.draw(h.series, 'bubble', h.i));
        }
       } else
        switch (a.chart.type) {
         case 'line':
          y = p.draw(s.series, 'line');
          break;
         case 'area':
          y = p.draw(s.series, 'area');
          break;
         case 'bar':
          a.chart.stacked
           ? (y = new We(this.ctx, t).draw(s.series))
           : ((this.ctx.bar = new te(this.ctx, t)),
             (y = this.ctx.bar.draw(s.series)));
          break;
         case 'candlestick':
          y = new Ae(this.ctx, t).draw(s.series);
          break;
         case 'boxPlot':
          y = new Ae(this.ctx, t).draw(s.series);
          break;
         case 'rangeBar':
          ...
          break;
         case 'heatmap':
          y = new wt(this.ctx, t).draw(s.series);
          break;
         case 'treemap':
          y = new Ct(this.ctx, t).draw(s.series);
          break;
         case 'pie':
         case 'donut':
         case 'polarArea':
     ...
     },
     {
      ...
      value: function () {
       ...
       a === '%'
        ? L.isNumber(i[0]) &&
          (i[0].width === 0 && (i = L.getDimensions(this.el.parentNode)),
          (e.svgWidth = (i[0] * parseInt(t.chart.width, 10)) / 100))
        : (a !== 'px' && a !== '') ||
          (e.svgWidth = parseInt(t.chart.width, 10));
       var s = t.chart.height
        .toString()
        .split(/[0-9]+/g)
        .pop();
       if (e.svgHeight !== 'auto' && e.svgHeight !== '')
        if (s === '%') {
         var n = L.getDimensions(this.el.parentNode);
         e.svgHeight = (n[1] * parseInt(t.chart.height, 10)) / 100;
     ...
     },
     {
      ...
      value: function () {
       ...
       I.setAttrs(e.dom.elGraphical.node, i);
      },
     },
     {
      ...
      value: function () {
       ...
       (a += e.config.grid.padding.bottom),
        (e.config.legend.position !== 'top' &&
         ...
         (i = new He(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
       var s = e.globals.dom.baseEl.querySelector(
         '.apexcharts-radialbar, .apexcharts-pie',
        ),
        n = 2.05 * e.globals.radialSize;
       if (s && !e.config.chart.sparkline.enabled) {
        var r = L.getBoundingClientRect(s);
        n = r.bottom;
        var o = r.bottom - r.top;
        n = Math.max(2.05 * e.globals.radialSize, o);
       }
       var h = n + t.translateY + i + a;
       t.dom.elLegendForeign && t.dom.elLegendForeign.setAttribute('height', h),
        (t.dom.elWrap.style.height = h + 'px'),
        I.setAttrs(t.dom.Paper.node, { height: h }),
       ...
       if (t.globals.axisCharts) {
        if (
         (t.config.xaxis.crosshairs.position === 'back' &&
          new ke(this.ctx).drawXCrosshairs(),
         t.config.yaxis[0].crosshairs.position === 'back' &&
          new ke(this.ctx).drawYCrosshairs(),
         t.config.xaxis.type === 'datetime' &&
          t.config.xaxis.labels.formatter === void 0)
        ) {
         this.ctx.timeScale = new Lt(this.ctx);
         var i = [];
        ...
        e = new D(this.ctx).getCalculatedRatios();
       }
       return e;
      },
     },
       ...
       if (
        ...
        i.forEach(function (a) {
         ...
         (s.w.globals.brushSource = e.ctx),
          typeof s.w.config.chart.events.zoomed != 'function' &&
           (s.w.config.chart.events.zoomed = function () {
            e.updateSourceChart(s);
           }),
          typeof s.w.config.chart.events.scrolled != 'function' &&
         ...
         (t.config.chart.events.selection = function (a, s) {
          i.forEach(function (n) {
           var r = ApexCharts.getChartByID(n),
            o = L.clone(t.config.yaxis);
           if (
            t.config.chart.brush.autoScaleYaxis &&
            r.w.globals.series.length === 1
           ) {
            var h = new ie(r);
            o = h.autoScaleY(r, o, s);
           }
           var c = r.w.config.yaxis.reduce(function (d, g, p) {
            return [].concat(U(d), [
             F(
              F({}, r.w.config.yaxis[p]),
              {},
              { min: o[0].min, max: o[0].max },
             ),
            ]);
           }, []);
           r.ctx.updateHelpers._updateOptions(
            { xaxis: { min: s.xaxis.min, max: s.xaxis.max }, yaxis: c },
            !1,
            !1,
            !1,
            !1,
    ...
    E(v, [
     {
      ...
      value: function (e) {
       var t = this,
        ...
        n = arguments.length > 4 && arguments[4] !== void 0 && arguments[4],
        r = [this.ctx];
       s && (r = this.ctx.getSyncedCharts()),
        this.ctx.w.globals.isExecCalled &&
         ((r = [this.ctx]), (this.ctx.w.globals.isExecCalled = !1)),
        r.forEach(function (o) {
         ...
         return (
          ...
          i ||
           ...
           a && o.series.getPreviousPaths()),
          e &&
           N(e) === 'object' &&
           ((o.config = new le(e)),
           (e = D.extendArrayProps(o.config, e, h)),
           o.w.globals.chartID !== t.ctx.w.globals.chartID && delete e.series,
           (h.config = L.extend(h.config, e)),
           n &&
            ((h.globals.lastXAxis = e.xaxis ? L.clone(e.xaxis) : []),
            (h.globals.lastYAxis = e.yaxis ? L.clone(e.yaxis) : []),
            (h.globals.initialConfig = L.extend({}, h.config)),
     ...
     },
     {
      ...
      value: function (e, t) {
       var i,
        ...
        n = this.w;
       return (
        (n.globals.shouldAnimate = t),
        (n.globals.dataChanged = !0),
        t && this.ctx.series.getPreviousPaths(),
        n.globals.axisCharts
         ? ((i = e.map(function (r, o) {
            return a._extendSeries(r, o);
           })).length === 0 && (i = [{ data: [] }]),
           (n.config.series = i))
         : (n.config.series = e.slice()),
        s && (n.globals.initialSeries = L.clone(n.config.series)),
        this.ctx.update()
       );
      },
     },
       ...
       return (
        i.globals.axisCharts
         ...
         : t === void 0 &&
           ...
           (i.config.chart.type !== 'pie' &&
            i.config.chart.type !== 'polarArea' &&
            i.config.chart.type !== 'donut') ||
            this.ctx.pie.pieClicked(e)),
        a
         ? (new I(this.ctx).pathMouseDown(a, null), a.node ? a.node : null)
     ...
     },
     {
      ...
      value: function (e) {
       ...
       var n = function (r) {
        s[r] !== void 0 &&
         ((i.config.yaxis[r].min = s[r].min),
         (i.config.yaxis[r].max = s[r].max));
       };
       i.config.yaxis.map(function (r, o) {
        i.globals.zoomed || s[o] !== void 0
         ? n(o)
         : t.ctx.opts.yaxis[o] !== void 0 &&
           ((r.min = t.ctx.opts.yaxis[o].min),
           (r.max = t.ctx.opts.yaxis[o].max));
       });
      },
     },
    ]),
 ...
 (Q = typeof window < 'u' ? window : void 0),
  (pe = function (v, e) {
   var t = ((this !== void 0 ? this : v).SVG = function (l) {
   ...
   (t.did = 1e3),
    ...
    (t.extend = function () {
     ...
     for (var m = l.length - 1; m >= 0; m--)
      if (l[m]) for (var w in u) l[m].prototype[w] = u[w];
     t.Set && t.Set.inherit && t.Set.inherit();
    }),
    (t.invent = function (l) {
     var u =
      typeof l.create == 'function'
       ? l.create
       : function () {
          this.constructor.call(this, t.create(l.create));
         };
     return (
      l.inherit && (u.prototype = new l.inherit()),
      l.extend && t.extend(u, l.extend),
    ...
    (t.adopt = function (l) {
     return l
      ? l.instance
        ...
        : (((u =
           l.nodeName == 'svg'
            ? l.parentNode instanceof v.SVGElement
              ? new t.Nested()
              : new t.Doc()
            : l.nodeName == 'linearGradient'
              ? new t.Gradient('linear')
              : l.nodeName == 'radialGradient'
                ? new t.Gradient('radial')
                : t[c(l.nodeName)]
                  ? new t[c(l.nodeName)]()
                  : new t.Element(l)).type = l.nodeName),
          (u.node = l),
          (l.instance = u),
          u instanceof t.Doc && u.namespace().defs(),
          u.setData(JSON.parse(l.getAttribute('svgjs:data')) || {}),
          u)
      : null;
     var u;
    }),
    (t.prepare = function () {
     var l = e.getElementsByTagName('body')[0],
      u = (l ? new t.Doc(l) : t.adopt(e.documentElement).nested()).size(2, 0);
     t.parser = {
    ...
    (t.utils = {
     map: function (l, u) {
      for (var m = l.length, w = [], S = 0; S < m; S++) w.push(u(l[S]));
      return w;
     },
     filter: function (l, u) {
      for (var m = l.length, w = [], S = 0; S < m; S++) u(l[S]) && w.push(l[S]);
      return w;
     },
     filterSVGElements: function (l) {
      return this.filter(l, function (u) {
       return u instanceof v.SVGElement;
      });
     },
    }),
    (t.defaults = {
    ...
    (t.Color = function (l) {
     ...
     (this.r = 0),
      ...
      l &&
       (typeof l == 'string'
        ? t.regex.isRgb.test(l)
          ? ((u = t.regex.rgb.exec(l.replace(t.regex.whitespace, ''))),
            (this.r = parseInt(u[1])),
            (this.g = parseInt(u[2])),
            (this.b = parseInt(u[3])))
          : t.regex.isHex.test(l) &&
            ((u = t.regex.hex.exec(
             (m = l).length == 4
              ? [
                 '#',
    ...
    t.extend(t.Color, {
     ...
     at: function (l) {
      return this.destination
       ? ((l = l < 0 ? 0 : l > 1 ? 1 : l),
         new t.Color({
          r: ~~(this.r + (this.destination.r - this.r) * l),
    ...
    (t.Array = function (l, u) {
     (l = (l || []).valueOf()).length == 0 && u && (l = u.valueOf()),
   ...
   for (
    var i = {
      M: function (l, u, m) {
       return (u.x = m.x = l[0]), (u.y = m.y = l[1]), ['M', u.x, u.y];
      },
      L: function (l, u) {
      ...
      C: function (l, u) {
       return (
        (u.x = l[4]), (u.y = l[5]), ['C', l[0], l[1], l[2], l[3], l[4], l[5]]
       );
      },
      Q: function (l, u) {
    ...
    i[a[s]] = (function (l) {
     return function (u, m, w) {
      if (l == 'H') u[0] = u[0] + m.x;
      else if (l == 'V') u[0] = u[0] + m.y;
      else if (l == 'A') (u[5] = u[5] + m.x), (u[6] = u[6] + m.y);
      else
   ...
   (t.PathArray = function (l, u) {
    ...
    t.extend(t.PathArray, {
     toString: function () {
      return (function (l) {
       for (var u = 0, m = l.length, w = ''; u < m; u++)
        (w += l[u][0]),
         l[u][1] != null &&
          ((w += l[u][1]),
          l[u][2] != null &&
     ...
     at: function (l) {
      ...
      for (
       ...
       w[P] = [u[P][0]];
       for (var M = 1, T = u[P].length; M < T; M++)
        w[P][M] = u[P][M] + (m[P][M] - u[P][M]) * l;
       w[P][0] === 'A' &&
        ((w[P][4] = +(w[P][4] != 0)), (w[P][5] = +(w[P][5] != 0)));
      }
      return (S.value = w), S;
     },
     parse: function (l) {
      ...
      var u,
       m = { M: 2, L: 2, H: 1, V: 1, C: 6, S: 4, Q: 4, T: 2, A: 7, Z: 0 };
      l =
       typeof l == 'string'
        ? l
           .replace(t.regex.numbersWithDots, o)
           .replace(t.regex.pathLetters, ' $& ')
           .replace(t.regex.hyphen, '$1 -')
           .trim()
           .split(t.regex.delimiter)
        : l.reduce(function (T, z) {
           return [].concat.call(T, z);
          }, []);
      var w = [],
       S = new t.Point(),
       P = new t.Point(),
      ...
      do
       t.regex.isPathLetter.test(l[C])
        ...
        w.push(
         i[u].call(
          null,
          l.slice(C, (C += m[u.toUpperCase()])).map(parseFloat),
          S,
          P,
         ),
        );
     ...
     create: function (l, u) {
      (this.value = 0),
       ...
       typeof l == 'number'
        ...
        : typeof l == 'string'
          ? (u = l.match(t.regex.numberAndUnit)) &&
            ((this.value = parseFloat(u[1])),
            u[5] == '%'
             ? (this.value /= 100)
             : u[5] == 's' && (this.value *= 1e3),
            (this.unit = u[5]))
          : l instanceof t.Number &&
            ((this.value = l.valueOf()), (this.unit = l.unit));
     },
     extend: {
      toString: function () {
       return (
      ...
      plus: function (l) {
       return (
        (l = new t.Number(l)), new t.Number(this + l, this.unit || l.unit)
       );
      },
      minus: function (l) {
       return (
      ...
      morph: function (l) {
       return (
        (this.destination = new t.Number(l)),
      ...
      at: function (l) {
       return this.destination
        ? new t.Number(this.destination).minus(this).times(l).plus(this)
        : this;
      },
     },
    })),
    (t.Element = t.invent({
     ...
     extend: {
      ...
      size: function (l, u) {
       var m = g(this, l, u);
       return this.width(new t.Number(m.width)).height(new t.Number(m.height));
      },
      clone: function (l) {
       this.writeDataToDom();
      ...
      parent: function (l) {
       ...
       if (((u = t.adopt(u.node.parentNode)), !l)) return u;
       for (; u && u.node instanceof v.SVGElement; ) {
        if (typeof l == 'string' ? u.matches(l) : u instanceof l) return u;
      ...
      svg: function (l) {
       ...
       if (!(l && this instanceof t.Parent))
        return (
         u.appendChild((l = e.createElement('svg'))),
         this.writeDataToDom(),
       ...
       u.innerHTML =
        ...
        l.replace(/\n/, '').replace(/<([\w:-]+)([^<]+?)\/>/g, '<$1$2></$1>') +
        '</svg>';
       for (var m = 0, w = u.firstChild.childNodes.length; m < w; m++)
    ...
    (t.morph = function (l) {
     return function (u, m) {
      return new t.MorphObj(u, m).at(l);
     };
    }),
    ...
    (t.FX = t.invent({
     ...
     extend: {
      animate: function (l, u, m) {
       N(l) === 'object' && ((u = l.ease), (m = l.delay), (l = l.duration));
       var w = new t.Situation({
        duration: l || 1e3,
        delay: m || 0,
        ease: t.easing[u || '-'] || u,
       });
       return this.queue(w), this;
      },
      target: function (l) {
       return l && l instanceof t.Element
        ? ((this._target = l), this)
        : this._target;
      },
      timeToAbsPos: function (l) {
       return (
        (l - this.situation.start) / (this.situation.duration / this._speed)
       );
      },
      absPosToTime: function (l) {
       return (
        (this.situation.duration / this._speed) * l + this.situation.start
       );
      },
      startAnimFrame: function () {
       this.stopAnimFrame(),
        (this.animationFrame = v.requestAnimationFrame(
         function () {
          this.step();
         }.bind(this),
        ));
      ...
      stopAnimFrame: function () {
       v.cancelAnimationFrame(this.animationFrame);
      },
      start: function () {
       return (
        !this.active &&
      ...
      queue: function (l) {
       return (
        (typeof l == 'function' || l instanceof t.Situation) &&
         this.situations.push(l),
      ...
      dequeue: function () {
       return (
        ...
        this.situation &&
         (this.situation instanceof t.Situation
          ? this.start()
      ...
      initAnimations: function () {
       ...
       for (var m in u.animations) {
        (l = this.target()[m]()),
         Array.isArray(l) || (l = [l]),
         Array.isArray(u.animations[m]) ||
          (u.animations[m] = [u.animations[m]]);
        for (var w = l.length; w--; )
         u.animations[m][w] instanceof t.Number && (l[w] = new t.Number(l[w])),
          (u.animations[m][w] = l[w].morph(u.animations[m][w]));
       }
       for (var m in u.attrs)
        u.attrs[m] = new t.MorphObj(this.target().attr(m), u.attrs[m]);
       for (var m in u.styles)
        u.styles[m] = new t.MorphObj(this.target().style(m), u.styles[m]);
       return (
        (u.initialTransformation = this.target().matrixify()),
        (u.init = !0),
        this
       );
      },
      ...
      stop: function (l, u) {
       ...
       return (
        (this.active = !1),
        u && this.clearQueue(),
        l && this.situation && (!m && this.startCurrent(), this.atEnd()),
        this.stopAnimFrame(),
        this.clearCurrent()
       );
      },
      after: function (l) {
       var u = this.last();
       return (
        this.target().on('finished.fx', function m(w) {
         w.detail.situation == u &&
          (l.call(this, u), this.off('finished.fx', m));
        }),
        this._callStart()
       );
      },
      during: function (l) {
       var u = this.last(),
        m = function (w) {
         w.detail.situation == u &&
          l.call(this, w.detail.pos, t.morph(w.detail.pos), w.detail.eased, u);
        };
       return (
        this.target().off('during.fx', m).on('during.fx', m),
        this.after(function () {
      ...
      afterAll: function (l) {
       var u = function m(w) {
        l.call(this), this.off('allfinished.fx', m);
       };
       return (
        this.target().off('allfinished.fx', u).on('allfinished.fx', u),
        this._callStart()
       );
      },
      last: function () {
      ...
      add: function (l, u, m) {
       return (this.last()[m || 'animations'][l] = u), this._callStart();
      },
      step: function (l) {
       var u, m, w;
       l || (this.absPos = this.timeToAbsPos(+new Date())),
        this.situation.loops !== !1
         ? ((u = Math.max(this.absPos, 0)),
           (m = Math.floor(u)),
           this.situation.loops === !0 || m < this.situation.loops
            ? ((this.pos = u - m),
              (w = this.situation.loop),
              (this.situation.loop = m))
           ...
           this.situation.reversing &&
            (this.situation.reversed =
             this.situation.reversed != !!((this.situation.loop - w) % 2)))
       ...
       for (var P in this.situation.once)
        P > this.lastPos &&
         P <= S &&
         (this.situation.once[P].call(this.target(), this.pos, S),
         delete this.situation.once[P]);
       return (
        this.active &&
      ...
      eachAt: function () {
       var l,
        ...
        m = this.target(),
        w = this.situation;
       for (var S in w.animations)
        (l = [].concat(w.animations[S]).map(function (M) {
         return typeof M != 'string' && M.at ? M.at(w.ease(u.pos), u.pos) : M;
        })),
         m[S].apply(m, l);
       for (var S in w.attrs)
        (l = [S].concat(w.attrs[S]).map(function (T) {
         return typeof T != 'string' && T.at ? T.at(w.ease(u.pos), u.pos) : T;
        })),
         m.attr.apply(m, l);
       for (var S in w.styles)
        (l = [S].concat(w.styles[S]).map(function (T) {
         return typeof T != 'string' && T.at ? T.at(w.ease(u.pos), u.pos) : T;
        })),
         m.style.apply(m, l);
       if (w.transforms.length) {
        (l = w.initialTransformation), (S = 0);
        for (var P = w.transforms.length; S < P; S++) {
         var C = w.transforms[S];
         C instanceof t.Matrix
          ? (l = C.relative
             ? l.multiply(new t.Matrix().morph(C).at(w.ease(this.pos)))
             : l.morph(C).at(w.ease(this.pos)))
          : (C.relative || C.undo(l.extract()),
            (l = l.multiply(C.at(w.ease(this.pos)))));
        }
        m.matrix(l);
       }
       return this;
      ...
      once: function (l, u, m) {
       var w = this.last();
       return m || (l = w.ease(l)), (w.once[l] = u), this;
      },
      _callStart: function () {
       return (
        setTimeout(
     ...
     construct: {
      animate: function (l, u, m) {
       return (this.fx || (this.fx = new t.FX(this))).animate(l, u, m);
      },
      delay: function (l) {
    ...
    (t.MorphObj = t.invent({
     create: function (l, u) {
      return t.Color.isColor(u)
       ? new t.Color(l).morph(u)
       : t.regex.delimiter.test(l)
         ? t.regex.pathLetters.test(l)
           ? new t.PathArray(l).morph(u)
           : new t.Array(l).morph(u)
         : t.regex.numberAndUnit.test(u)
           ? new t.Number(l).morph(u)
           : ((this.value = l), void (this.destination = u));
     },
     extend: {
      at: function (l, u) {
    ...
    t.extend(t.FX, {
     attr: function (l, u, m) {
      if (N(l) === 'object') for (var w in l) this.attr(w, l[w]);
      else this.add(l, u, 'attrs');
      return this;
     },
     plot: function (l, u, m, w) {
      return arguments.length == 4
       ? this.plot([l, u, m, w])
       : this.add('plot', new (this.target().morphArray)(l));
     },
    }),
    (t.Box = t.invent({
     create: function (l, u, m, w) {
      if (!(N(l) !== 'object' || l instanceof t.Element))
       return t.Box.call(
        this,
        l.left != null ? l.left : l.x,
        l.top != null ? l.top : l.y,
        l.width,
        l.height,
       );
      arguments.length == 4 &&
       ((this.x = l), (this.y = u), (this.width = m), (this.height = w)),
       b(this);
     },
    })),
    (t.BBox = t.invent({
     create: function (l) {
      if (
       (t.Box.apply(this, [].slice.call(arguments)), l instanceof t.Element)
      ) {
       var u;
       try {
        if (!e.documentElement.contains) {
         for (var m = l.node; m.parentNode; ) m = m.parentNode;
         if (m != e) throw new Error('Element not in the dom');
        }
        u = l.node.getBBox();
       } catch {
        if (l instanceof t.Shape) {
         t.parser.draw || t.prepare();
         var w = l.clone(t.parser.draw.instance).show();
         (u = w.node.getBBox()), w.remove();
        } else
         u = {
          x: l.node.clientLeft,
          y: l.node.clientTop,
    ...
    (t.Matrix = t.invent({
     create: function (l) {
      ...
      l =
       l === null
        ...
        : l instanceof t.Element
          ? l.matrixify()
          : typeof l == 'string'
            ? f(l.split(t.regex.delimiter).map(parseFloat))
            : arguments.length == 6
      ...
      for (var m = k.length - 1; m >= 0; --m)
       this[k[m]] = l[k[m]] != null ? l[k[m]] : u[k[m]];
     },
     extend: {
      extract: function () {
       var l = p(this, 0, 1);
       ...
       return {
        ...
        y: this.f,
        transformedX:
         (this.e * Math.cos((u * Math.PI) / 180) +
          this.f * Math.sin((u * Math.PI) / 180)) /
         Math.sqrt(this.a * this.a + this.b * this.b),
        transformedY:
         (this.f * Math.cos((u * Math.PI) / 180) +
          this.e * Math.sin((-u * Math.PI) / 180)) /
      ...
      native: function () {
       for (
        var l = t.parser.native.createSVGMatrix(), u = k.length - 1;
        u >= 0;
        u--
       )
        l[k[u]] = this[k[u]];
    ...
    t.extend(t.Element, {
     attr: function (l, u, m) {
      if (l == null) {
       for (l = {}, m = (u = this.node.attributes).length - 1; m >= 0; m--)
        l[u[m].nodeName] = t.regex.isNumber.test(u[m].nodeValue)
         ? parseFloat(u[m].nodeValue)
         : u[m].nodeValue;
       return l;
      }
      if (N(l) === 'object') for (var w in l) this.attr(w, l[w]);
      else if (u === null) this.node.removeAttribute(l);
      else {
       if (u == null)
        return (u = this.node.getAttribute(l)) == null
         ? t.defaults.attrs[l]
         : t.regex.isNumber.test(u)
           ? parseFloat(u)
           : u;
       l == 'stroke-width'
        ? this.attr('stroke', parseFloat(u) > 0 ? this._stroke : null)
        : l == 'stroke' && (this._stroke = u),
        (l != 'fill' && l != 'stroke') ||
         (t.regex.isImage.test(u) && (u = this.doc().defs().image(u, 0, 0)),
         u instanceof t.Image &&
          (u = this.doc()
           .defs()
        ...
        typeof u == 'number'
         ...
         : t.Color.isColor(u)
           ? (u = new t.Color(u))
           : Array.isArray(u) && (u = new t.Array(u)),
        l == 'leading'
         ? this.leading && this.leading(u)
         : typeof m == 'string'
           ? this.node.setAttributeNS(m, l, u.toString())
           : this.node.setAttribute(l, u.toString()),
        !this.rebuild || (l != 'font-size' && l != 'x') || this.rebuild(l, u);
      }
      return this;
     },
    }),
    t.extend(t.Element, {
     transform: function (l, u) {
      var m;
      return N(l) !== 'object'
       ? ((m = new t.Matrix(this).extract()), typeof l == 'string' ? m[l] : m)
       : ((m = new t.Matrix(this)),
         (u = !!u || !!l.relative),
         l.a != null && (m = u ? m.multiply(new t.Matrix(l)) : new t.Matrix(l)),
    ...
    t.extend(t.Element, {
     ...
     matrixify: function () {
      return (this.attr('transform') || '')
       .split(t.regex.transforms)
       .slice(0, -1)
       .map(function (l) {
        var u = l.trim().split('(');
        return [
         u[0],
         u[1].split(t.regex.delimiter).map(function (m) {
          return parseFloat(m);
         }),
        ];
       })
     ...
     toParent: function (l) {
      ...
      var u = this.screenCTM(),
       m = l.screenCTM().inverse();
      return this.addTo(l).untransform().transform(m.multiply(u)), this;
     },
     toDoc: function () {
    ...
    (t.Transformation = t.invent({
     create: function (l, u) {
      ...
      if (Array.isArray(l))
       for (var m = 0, w = this.arguments.length; m < w; ++m)
        this[this.arguments[m]] = l[m];
      else if (l && N(l) === 'object')
       for (m = 0, w = this.arguments.length; m < w; ++m)
        this[this.arguments[m]] = l[this.arguments[m]];
    ...
    t.extend(t.Element, {
     style: function (l, u) {
      ...
      if (arguments.length < 2)
       if (N(l) === 'object') for (var m in l) this.style(m, l[m]);
       else {
    ...
    (t.Parent = t.invent({
     ...
     extend: {
      children: function () {
       return t.utils.map(
        t.utils.filterSVGElements(this.node.childNodes),
        function (l) {
         return t.adopt(l);
        },
       );
      ...
      add: function (l, u) {
       return (
        u == null
         ...
         : l.node != this.node.childNodes[u] &&
           this.node.insertBefore(l.node, this.node.childNodes[u]),
        this
       );
      },
      put: function (l, u) {
      ...
      each: function (l, u) {
       for (var m = this.children(), w = 0, S = m.length; w < S; w++)
        m[w] instanceof t.Element && l.apply(m[w], [w, m]),
         u && m[w] instanceof t.Container && m[w].each(l, u);
       return this;
      },
    ...
    t.extend(t.Parent, {
     ungroup: function (l, u) {
      return (
       u === 0 ||
        this instanceof t.Defs ||
        this.node == t.parser.draw ||
        ((l = l || (this instanceof t.Doc ? this : this.parent(t.Parent))),
        (u = u || 1 / 0),
        this.each(function () {
         return this instanceof t.Defs
          ? this
          : this instanceof t.Parent
            ? this.ungroup(l, u - 1)
            : this.toParent(l);
        }),
    ...
    (t.ViewBox = t.invent({ parent: t.Container, construct: {} })),
    [
     'click',
     'dblclick',
     'mousedown',
    ...
    (t.handlerMap = []),
    (t.listenerId = 0),
    (t.on = function (l, u, m, w, S) {
     var P = m.bind(w || l.instance || l),
      C = (t.handlerMap.indexOf(l) + 1 || t.handlerMap.push(l)) - 1,
      M = u.split('.')[0],
      T = u.split('.')[1] || '*';
     (t.listeners[C] = t.listeners[C] || {}),
      (t.listeners[C][M] = t.listeners[C][M] || {}),
      (t.listeners[C][M][T] = t.listeners[C][M][T] || {}),
      m._svgjsListenerId || (m._svgjsListenerId = ++t.listenerId),
      (t.listeners[C][M][T][m._svgjsListenerId] = P),
      l.addEventListener(M, P, S || { passive: !0 });
    }),
    (t.off = function (l, u, m) {
     var w = t.handlerMap.indexOf(l),
      S = u && u.split('.')[0],
      P = u && u.split('.')[1],
      C = '';
     if (w != -1)
      if (m) {
       if ((typeof m == 'function' && (m = m._svgjsListenerId), !m)) return;
       t.listeners[w][S] &&
        t.listeners[w][S][P || '*'] &&
        (l.removeEventListener(S, t.listeners[w][S][P || '*'][m], !1),
        delete t.listeners[w][S][P || '*'][m]);
      } else if (P && S) {
       if (t.listeners[w][S] && t.listeners[w][S][P]) {
        for (var M in t.listeners[w][S][P]) t.off(l, [S, P].join('.'), M);
        delete t.listeners[w][S][P];
       }
      } else if (P)
       for (var T in t.listeners[w])
        for (var C in t.listeners[w][T]) P === C && t.off(l, [T, P].join('.'));
      else if (S) {
       if (t.listeners[w][S]) {
        for (var C in t.listeners[w][S]) t.off(l, [S, C].join('.'));
        delete t.listeners[w][S];
       }
      } else {
       for (var T in t.listeners[w]) t.off(l, T);
       delete t.listeners[w], delete t.handlerMap[w];
      }
    }),
    t.extend(t.Element, {
     on: function (l, u, m, w) {
      return t.on(this.node, l, u, m, w), this;
     },
     off: function (l, u) {
     ...
     fire: function (l, u) {
      return (
       l instanceof v.Event
        ? this.node.dispatchEvent(l)
        : this.node.dispatchEvent(
           (l = new t.CustomEvent(l, { detail: u, cancelable: !0 })),
          ),
       (this._event = l),
       this
      );
    ...
    (t.Defs = t.invent({ create: 'defs', inherit: t.Container })),
    (t.G = t.invent({
     create: 'g',
     inherit: t.Container,
     extend: {
    ...
    (t.Doc = t.invent({
     create: function (l) {
      l &&
       ((l = typeof l == 'string' ? e.getElementById(l) : l).nodeName == 'svg'
        ? this.constructor.call(this, l)
     ...
     extend: {
      namespace: function () {
       return this.attr({ xmlns: t.ns, version: '1.1' })
        .attr('xmlns:xlink', t.xlink, t.xmlns)
        .attr('xmlns:svgjs', t.svgjs, t.xmlns);
      },
      defs: function () {
       var l;
       return (
        this._defs ||
         ((l = this.node.getElementsByTagName('defs')[0])
          ? (this._defs = t.adopt(l))
          : (this._defs = new t.Defs()),
      ...
      clear: function () {
       ...
       return (
        delete this._defs,
        t.parser.draw &&
         !t.parser.draw.parentNode &&
         this.node.appendChild(t.parser.draw),
        this
       );
      },
      clone: function (l) {
       ...
       return (
        l
         ? (l.node || l).appendChild(m.node)
         : u.parentNode.insertBefore(m.node, u.nextSibling),
        m
       );
      },
     },
    ...
    (t.Gradient = t.invent({
     ...
     extend: {
      at: function (l, u, m) {
       return this.put(new t.Stop()).update(l, u, m);
      },
      update: function (l) {
      ...
      attr: function (l, u, m) {
       return (
        l == 'transform' && (l = 'gradientTransform'),
        t.Container.prototype.attr.call(this, l, u, m)
       );
      },
     },
     construct: {
      gradient: function (l, u) {
    ...
    t.extend(t.Gradient, t.FX, {
     from: function (l, u) {
      return (this._target || this).type == 'radial'
       ? this.attr({ fx: new t.Number(l), fy: new t.Number(u) })
       : this.attr({ x1: new t.Number(l), y1: new t.Number(u) });
     },
     to: function (l, u) {
      return (this._target || this).type == 'radial'
       ? this.attr({ cx: new t.Number(l), cy: new t.Number(u) })
       : this.attr({ x2: new t.Number(l), y2: new t.Number(u) });
     },
    }),
    t.extend(t.Defs, {
     gradient: function (l, u) {
    ...
    (t.Stop = t.invent({
     ...
     extend: {
      update: function (l) {
       return (
        (typeof l == 'number' || l instanceof t.Number) &&
         (l = {
          offset: arguments[0],
          color: arguments[1],
          opacity: arguments[2],
         }),
        l.opacity != null && this.attr('stop-opacity', l.opacity),
        l.color != null && this.attr('stop-color', l.color),
        l.offset != null && this.attr('offset', new t.Number(l.offset)),
        this
       );
      },
     },
    ...
    (t.Pattern = t.invent({
     ...
     extend: {
      ...
      attr: function (l, u, m) {
       return (
        l == 'transform' && (l = 'patternTransform'),
        t.Container.prototype.attr.call(this, l, u, m)
       );
      },
     },
     construct: {
      pattern: function (l, u, m) {
       return this.defs().pattern(l, u, m);
      },
     },
    })),
    t.extend(t.Defs, {
     pattern: function (l, u, m) {
      return this.put(new t.Pattern())
       .update(m)
       .attr({
        x: 0,
        y: 0,
    ...
    t.extend(t.Circle, t.Ellipse, {
     ...
     size: function (l, u) {
      var m = g(this, l, u);
      return this.rx(new t.Number(m.width).divide(2)).ry(
       new t.Number(m.height).divide(2),
      );
     },
    }),
    (t.Line = t.invent({
     ...
     construct: {
      line: function (l, u, m, w) {
       return t.Line.prototype.plot.apply(
        this.put(new t.Line()),
        l != null ? [l, u, m, w] : [0, 0, 0, 0],
       );
      },
     },
    })),
    ...
    t.extend(t.Polyline, t.Polygon, {
     array: function () {
      return (
       this._array || (this._array = new t.PointArray(this.attr('points')))
      );
     },
     plot: function (l) {
      return l == null
       ...
       : this.clear().attr(
          'points',
          typeof l == 'string' ? l : (this._array = new t.PointArray(l)),
         );
     },
     clear: function () {
     ...
     extend: {
      ...
      plot: function (l) {
       return l == null
        ...
        : this.clear().attr(
           'd',
           typeof l == 'string' ? l : (this._array = new t.PathArray(l)),
          );
      },
      clear: function () {
       return delete this._array, this;
    ...
    (t.Image = t.invent({
      ...
      load: function (l) {
       ...
       return (
        t.on(m, 'load', function () {
         ...
         w !== null &&
          (u.width() == 0 && u.height() == 0 && u.size(m.width, m.height),
          w &&
           w.width() == 0 &&
           w.height() == 0 &&
           w.size(u.width(), u.height()),
          typeof u._loaded == 'function' &&
           u._loaded.call(u, {
            width: m.width,
            height: m.height,
        ...
        t.on(m, 'error', function (w) {
         t.off(m), typeof u._error == 'function' && u._error.call(u, w);
        }),
        this.attr('href', (m.src = this.src = l), t.xlink)
       );
      },
      loaded: function (l) {
     ...
     construct: {
      image: function (l, u, m) {
       return this.put(new t.Image())
        .load(l)
        .size(u || 0, m || u || 0);
      },
     },
    ...
    (t.Text = t.invent({
     ...
     extend: {
      ...
      text: function (l) {
       if (l === void 0) {
        l = '';
        for (var u = this.node.childNodes, m = 0, w = u.length; m < w; ++m)
         m != 0 &&
          u[m].nodeType != 3 &&
          t.adopt(u[m]).dom.newLined == 1 &&
          (l += `
`),
          (l += u[m].textContent);
        return l;
...
`)).length;
      ...
      leading: function (l) {
       return l == null
        ? this.dom.leading
        : ((this.dom.leading = new t.Number(l)), this.rebuild());
      },
      lines: function () {
       var l = ((this.textPath && this.textPath()) || this).node,
        u = t.utils.map(t.utils.filterSVGElements(l.childNodes), function (m) {
         return t.adopt(m);
        });
       return new t.Set(u);
      },
      rebuild: function (l) {
       if ((typeof l == 'boolean' && (this._rebuild = l), this._rebuild)) {
        ...
        this.lines().each(function () {
         this.dom.newLined &&
          (u.textPath() || this.attr('x', u.attr('x')),
          this.text() ==
          `
`
           ? (m += w)
           : (this.attr('dy', w + m), (m = 0)));
        }),
         this.fire('rebuild');
       }
       return this;
...
`
    ...
    t.extend(t.Text, t.Tspan, {
     ...
     tspan: function (l) {
      var u = ((this.textPath && this.textPath()) || this).node,
       m = new t.Tspan();
      return (
       this._build === !1 && this.clear(), u.appendChild(m.node), m.text(l)
      );
     },
     clear: function () {
      for (
    ...
    (t.TextPath = t.invent({
     ...
     construct: {
      ...
      plot: function (l) {
       var u = this.track(),
        m = null;
       return u && (m = u.plot(l)), l == null ? m : this;
      },
      track: function () {
       var l = this.textPath();
   ...
   function o(l, u, m, w) {
    return m + w.replace(t.regex.dots, ' .');
   }
   function h(l) {
    return l.toLowerCase().replace(/-(.)/g, function (u, m) {
   ...
   function g(l, u, m) {
    if (u == null || m == null) {
     var w = l.bbox();
     u == null
      ? (u = (w.width / w.height) * m)
      : m == null && (m = (w.height / w.width) * u);
    }
    return { width: u, height: m };
   }
   function p(l, u, m) {
    return { x: u * l.a + m * l.c + 0, y: u * l.b + m * l.d + 0 };
   }
   function f(l) {
   ...
   function x(l) {
    for (var u = l.childNodes.length - 1; u >= 0; u--)
     l.childNodes[u] instanceof v.SVGElement && x(l.childNodes[u]);
    return t.adopt(l).id(t.eid(l.nodeName));
   }
   function b(l) {
    return (
     l.x == null && ((l.x = 0), (l.y = 0), (l.width = 0), (l.height = 0)),
     (l.w = l.width),
     (l.h = l.height),
     (l.x2 = l.x + l.width),
     (l.y2 = l.y + l.height),
   ...
   ['fill', 'stroke'].forEach(function (l) {
    var u = {};
    (u[l] = function (m) {
     if (m === void 0) return this;
     if (
      typeof m == 'string' ||
      t.Color.isRgb(m) ||
      (m && typeof m.fill == 'function')
     )
      this.attr(l, m);
     else
      for (var w = r[l].length - 1; w >= 0; w--)
       m[r[l][w]] != null && this.attr(r.prefix(l, r[l][w]), m[r[l][w]]);
     return this;
    }),
    ...
    t.extend(t.Element, t.FX, {
     ...
     matrix: function (l) {
      return this.attr(
       'transform',
       new t.Matrix(arguments.length == 6 ? [].slice.call(arguments) : l),
      );
     },
     opacity: function (l) {
     ...
     dx: function (l) {
      return this.x(
       new t.Number(l).plus(this instanceof t.FX ? 0 : this.x()),
       !0,
      );
     },
     dy: function (l) {
      return this.y(
       new t.Number(l).plus(this instanceof t.FX ? 0 : this.y()),
       !0,
      );
     },
    }),
    ...
    (t.Set = t.invent({
     ...
     extend: {
      add: function () {
       for (var l = [].slice.call(arguments), u = 0, m = l.length; u < m; u++)
      ...
      each: function (l) {
       for (var u = 0, m = this.members.length; u < m; u++)
    ...
    (t.Set.inherit = function () {
     ...
     for (var u in t.Shape.prototype)
      typeof t.Shape.prototype[u] == 'function' &&
       typeof t.Set.prototype[u] != 'function' &&
       l.push(u);
     for (var u in (l.forEach(function (w) {
      t.Set.prototype[w] = function () {
       for (var S = 0, P = this.members.length; S < P; S++)
        this.members[S] &&
         typeof this.members[S][w] == 'function' &&
         this.members[S][w].apply(this.members[S], arguments);
       return w == 'animate' ? this.fx || (this.fx = new t.FX.Set(this)) : this;
      };
     }),
     (l = []),
     t.FX.prototype))
      typeof t.FX.prototype[u] == 'function' &&
       typeof t.FX.Set.prototype[u] != 'function' &&
       l.push(u);
     l.forEach(function (m) {
      t.FX.Set.prototype[m] = function () {
       for (var w = 0, S = this.set.members.length; w < S; w++)
        this.set.members[w].fx[m].apply(this.set.members[w].fx, arguments);
       return this;
      };
     });
    }),
    t.extend(t.Element, {}),
    t.extend(t.Element, {
     remember: function (l, u) {
      if (N(arguments[0]) === 'object') for (var m in l) this.remember(m, l[m]);
      else {
    ...
    (t.get = function (l) {
     var u = e.getElementById(
      (function (m) {
       var w = (m || '').toString().match(t.regex.reference);
       if (w) return w[1];
      })(l) || l,
     );
     return t.adopt(u);
    ...
    (t.select = function (l, u) {
     return new t.Set(
      t.utils.map((u || e).querySelectorAll(l), function (m) {
       return t.adopt(m);
      }),
     );
    }),
   ...
   var k = 'abcdef'.split('');
   if (typeof v.CustomEvent != 'function') {
    var A = function (l, u) {
     u = u || { bubbles: !1, cancelable: !1, detail: void 0 };
     var m = e.createEvent('CustomEvent');
     return m.initCustomEvent(l, u.bubbles, u.cancelable, u.detail), m;
    };
    (A.prototype = v.Event.prototype), (t.CustomEvent = A);
   } else t.CustomEvent = v.CustomEvent;
   return t;
  }),
  N(qe) === 'object'
   ? (fe.exports = Q.document
      ? pe(Q, Q.document)
      : function (v) {
         return pe(v, v.document);
        })
   : (Q.SVG = pe(Q, Q.document)),
  function () {
   (SVG.Filter = SVG.invent({
    ...
    extend: {
     ...
     blend: function (r, o, h) {
      return this.put(new SVG.BlendEffect(r, o, h));
     },
     ...
     composite: function (r, o, h) {
      return this.put(new SVG.CompositeEffect(r, o, h));
     },
     flood: function (r, o) {
     ...
     merge: function () {
      var r = [void 0];
      for (var o in arguments) r.push(arguments[o]);
     ...
     diffuseLighting: function (r, o, h) {
      return this.put(new SVG.DiffuseLightingEffect(r, o, h));
     },
     displacementMap: function (r, o, h, c, d) {
      return this.put(new SVG.DisplacementMapEffect(r, o, h, c, d));
     },
     specularLighting: function (r, o, h, c) {
      return this.put(new SVG.SpecularLightingEffect(r, o, h, c));
     },
     tile: function () {
      return this.put(new SVG.TileEffect());
     },
     turbulence: function (r, o, h, c, d) {
    ...
    SVG.extend(SVG.Element, SVG.G, SVG.Nested, {
     filter: function (r) {
      return (
       (this.filterer = r instanceof SVG.Element ? r : this.doc().filter(r)),
       this.doc() &&
     ...
     unfilter: function (r) {
      return (
       this.filterer && r === !0 && this.filterer.remove(),
   ...
   var v = {
    ...
    diffuseLighting: function (r, o, h) {
     return this.parent() && this.parent().diffuseLighting(r, o, h).in(this);
    },
    displacementMap: function (r, o, h, c) {
     return this.parent() && this.parent().displacementMap(this, r, o, h, c);
    },
    specularLighting: function (r, o, h, c) {
     return (
      this.parent() && this.parent().specularLighting(r, o, h, c).in(this)
     );
    },
    tile: function () {
    ...
    turbulence: function (r, o, h, c, d) {
     return this.parent() && this.parent().turbulence(r, o, h, c, d).in(this);
    },
   };
   SVG.extend(SVG.Effect, v),
    SVG.extend(SVG.ParentEffect, v),
   ...
   var e = {
     blend: function (r, o, h) {
      this.attr({ in: r, in2: o, mode: h || 'normal' });
     },
     colorMatrix: function (r, o) {
      r == 'matrix' && (o = a(o)),
       this.attr({ type: r, values: o === void 0 ? null : o });
     },
     convolveMatrix: function (r) {
      (r = a(r)),
     ...
     composite: function (r, o, h) {
      this.attr({ in: r, in2: o, operator: h });
     },
     flood: function (r, o) {
     ...
     gaussianBlur: function (r, o) {
      r != null || o != null
       ? this.attr('stdDeviation', s(Array.prototype.slice.call(arguments)))
    ...
    t = {
       ...
       arguments[0].each(function (c) {
        this instanceof SVG.MergeNode
         ...
         : (this instanceof SVG.Effect || this instanceof SVG.ParentEffect) &&
           o.put(new SVG.MergeNode(this));
       });
      } else {
       r = Array.isArray(arguments[0]) ? arguments[0] : arguments;
       for (var h = 0; h < r.length; h++)
        r[h] instanceof SVG.MergeNode
         ? this.put(r[h])
         : this.put(new SVG.MergeNode(r[h]));
      }
     },
     componentTransfer: function (r) {
      if (
       ...
       ['r', 'g', 'b', 'a'].forEach(
        function (h) {
         (this[h] = new SVG['Func' + h.toUpperCase()]('identity')),
          this.rgb.add(this[h]),
          this.node.appendChild(this[h].node);
        }.bind(this),
       ),
       r)
      )
     ...
     diffuseLighting: function (r, o, h) {
      this.attr({ surfaceScale: r, diffuseConstant: o, kernelUnitLength: h });
     },
     specularLighting: function (r, o, h, c) {
      this.attr({
       surfaceScale: r,
    ...
    i = {
     distantLight: function (r, o) {
      this.attr({ azimuth: r, elevation: o });
     },
     pointLight: function (r, o, h) {
      this.attr({ x: r, y: o, z: h });
     },
     spotLight: function (r, o, h, c, d, g) {
      this.attr({ x: r, y: o, z: h, pointsAtX: c, pointsAtY: d, pointsAtZ: g });
     },
   ...
   function a(r) {
    return (
     Array.isArray(r) && (r = new SVG.Array(r)),
     r.toString().replace(/^\s+/, '').replace(/\s+$/, '').replace(/\s+/g, ' ')
    );
   }
   function s(r) {
    if (!Array.isArray(r)) return r;
    for (var o = 0, h = r.length, c = []; o < h; o++) c.push(r[o]);
    return c.join(' ');
   }
   function n() {
    var r = function () {};
    for (var o in (typeof arguments[arguments.length - 1] == 'function' &&
     ((r = arguments[arguments.length - 1]),
     Array.prototype.splice.call(arguments, arguments.length - 1, 1)),
    arguments))
     for (var h in arguments[o]) r(arguments[o][h], h, arguments[o]);
   }
   ['r', 'g', 'b', 'a'].forEach(function (r) {
    ...
    n(e, function (r, o) {
     var h = o.charAt(0).toUpperCase() + o.slice(1);
     SVG[h + 'Effect'] = SVG.invent({
      create: function () {
       this.constructor.call(this, SVG.create('fe' + h)),
     ...
     in: function (r) {
      return (
       r instanceof SVG.MergeNode
        ? this.add(r, 0)
        : this.add(new SVG.MergeNode(r), 0),
       this
      );
     },
    }),
  ...
  (function () {
   function v(s, n, r, o, h, c, d) {
    for (
     ...
     (g[f] = e.call(x, g[f])),
      ...
      g[f][0] != p[f][0] ||
      g[f][0] == 'M' ||
      (g[f][0] == 'A' && (g[f][4] != p[f][4] || g[f][5] != p[f][5]))
       ? (Array.prototype.splice.apply(g, [f, 1].concat(i.call(x, g[f]))),
         Array.prototype.splice.apply(p, [f, 1].concat(i.call(b, p[f]))))
       : ((g[f] = t.call(x, g[f])), (p[f] = t.call(b, p[f]))),
      !(++f == g.length && f == p.length);

    )
     f == g.length &&
      g.push(['C', x.pos[0], x.pos[1], x.pos[0], x.pos[1], x.pos[0], x.pos[1]]),
      f == p.length &&
       p.push([
        'C',
        b.pos[0],
     ...
     case 'A':
      s = (n = (function (r, o) {
       var h,
        ...
        Pe = o[7],
        _ = new SVG.Point(r),
        B = new SVG.Point(Le, Pe),
        Ue = [];
       if (Z === 0 || ae === 0 || (_.x === B.x && _.y === B.y))
        return [['C', _.x, _.y, B.x, B.y, B.x, B.y]];
       for (
        h = new SVG.Point((_.x - B.x) / 2, (_.y - B.y) / 2).transform(
         new SVG.Matrix().rotate(ce),
        ),
         (c = (h.x * h.x) / (Z * Z) + (h.y * h.y) / (ae * ae)) > 1 &&
          ((Z *= c = Math.sqrt(c)), (ae *= c)),
         d = new SVG.Matrix()
          .rotate(ce)
          .scale(1 / Z, 1 / ae)
          .rotate(-ce),
         ...
         g[0] /= p,
         g[1] /= p,
         x = f < 4 ? Math.sqrt(1 - f / 4) : 0,
         Mt === Ce && (x *= -1),
         b = new SVG.Point(
          (B.x + _.x) / 2 + x * -g[1],
          (B.y + _.y) / 2 + x * g[0],
         ),
         y = new SVG.Point(_.x - b.x, _.y - b.y),
         k = new SVG.Point(B.x - b.x, B.y - b.y),
         A = Math.acos(y.x / Math.sqrt(y.x * y.x + y.y * y.y)),
         y.y < 0 && (A *= -1),
         l = Math.acos(k.x / Math.sqrt(k.x * k.x + k.y * k.y)),
         k.y < 0 && (l *= -1),
         Ce && A > l && (l += 2 * Math.PI),
         !Ce && A < l && (l -= 2 * Math.PI),
         m = Math.ceil((2 * Math.abs(A - l)) / Math.PI),
         S = [],
         P = A,
         u = (l - A) / m,
         w = (4 * Math.tan(u / 4)) / 3,
        ...
        (M = Math.cos(P)),
         (C = Math.sin(P)),
         (T = new SVG.Point(b.x + M, b.y + C)),
         (S[z] = [
          new SVG.Point(T.x + w * C, T.y - w * M),
          T,
          new SVG.Point(T.x - w * C, T.y + w * M),
         ]),
         (P += u);
       for (
        S[0][0] = S[0][1].clone(),
         ...
         d = new SVG.Matrix().rotate(ce).scale(Z, ae).rotate(-ce),
         z = 0,
         Y = S.length;
        z < Y;
        z++
       )
        (S[z][0] = S[z][0].transform(d)),
         (S[z][1] = S[z][1].transform(d)),
         (S[z][2] = S[z][2].transform(d));
       for (z = 1, Y = S.length; z < Y; z++)
        (H = (T = S[z - 1][2]).x),
         (R = T.y),
         (V = (T = S[z][0]).x),
         (G = T.y),
   ...
   function a(s, n) {
    if (n === !1) return !1;
    for (var r = n, o = s.length; r < o; ++r) if (s[r][0] == 'M') return r;
    return !1;
   }
   SVG.extend(SVG.PathArray, {
    morph: function (s) {
     for (
      var n = this.value, r = this.parse(s), o = 0, h = 0, c = !1, d = !1;
      o !== !1 || h !== !1;
      ...
      (c = a(n, o !== !1 && o + 1)),
       ...
       o === !1 &&
        (o =
         (g = new SVG.PathArray(p.start).bbox()).height == 0 || g.width == 0
          ? n.push(n[0]) - 1
          : n.push(['M', g.x + g.width / 2, g.y + g.height / 2]) - 1),
       h === !1 &&
        (h =
         (g = new SVG.PathArray(p.dest).bbox()).height == 0 || g.width == 0
          ? r.push(r[0]) - 1
          : r.push(['M', g.x + g.width / 2, g.y + g.height / 2]) - 1);
      var p = v(n, o, c, r, h, d);
      (n = n.slice(0, o).concat(p.start, c === !1 ? [] : n.slice(c))),
       (r = r.slice(0, h).concat(p.dest, d === !1 ? [] : r.slice(d))),
       (o = c !== !1 && o + p.start.length),
       (h = d !== !1 && h + p.dest.length);
     }
     return (
      (this.value = n),
  ...
  function () {
   ...
   (v.prototype.init = function (e, t) {
    ...
    (v.prototype.transformPoint = function (e, t) {
     var i =
      ((e = e || window.event).changedTouches && e.changedTouches[0]) || e;
     return (
    ...
    (v.prototype.start = function (e) {
     if (
      (e.type != 'click' && e.type != 'mousedown' && e.type != 'mousemove') ||
      (e.which || e.buttons) == 1
     ) {
      var t = this;
      if (
    ...
    (v.prototype.drag = function (e) {
     ...
     if (
      (this.el.fire('dragmove', { event: e, p: i, m: this.m, handler: this }),
      this.el.event().defaultPrevented)
     )
      return i;
     if (typeof n == 'function') {
      var h = n.call(this.el, a, s, this.m);
      typeof h == 'boolean' && (h = { x: h, y: h }),
       h.x === !0 ? this.el.x(a) : h.x !== !1 && this.el.x(h.x),
       h.y === !0 ? this.el.y(s) : h.y !== !1 && this.el.y(h.y);
     } else
      typeof n == 'object' &&
       (n.minX != null && a < n.minX
        ? (r = (a = n.minX) - this.startPoints.box.x)
        : n.maxX != null &&
          a > n.maxX - t.width &&
          (r = (a = n.maxX - t.width) - this.startPoints.box.x),
       n.minY != null && s < n.minY
        ? (o = (s = n.minY) - this.startPoints.box.y)
        : n.maxY != null &&
          s > n.maxY - t.height &&
          (o = (s = n.maxY - t.height) - this.startPoints.box.y),
       n.snapToGrid != null &&
        ((a -= a % n.snapToGrid),
        (s -= s % n.snapToGrid),
        (r -= r % n.snapToGrid),
    ...
    SVG.extend(SVG.Element, {
     draggable: function (e, t) {
      ...
      var i = this.remember('_draggable') || new v(this);
      return (
       (e = e === void 0 || e)
        ? i.init(t || {}, e)
   ...
   function v(e) {
    (this.el = e),
     ...
     (this.pointCoords = function (t, i) {
      ...
      return {
       x: this.pointCoord(a[0], i, t === 't' || t === 'b'),
       y: this.pointCoord(a[1], i, t === 'r' || t === 'l'),
      };
     });
   }
   (v.prototype.init = function (e, t) {
    ...
    (v.prototype.selectPoints = function (e) {
     return (
    ...
    (v.prototype.getPointArray = function () {
     var e = this.el.bbox();
     return this.el
      .array()
      .valueOf()
    ...
    (v.prototype.drawPoints = function () {
     for (
      ...
      var s = (function (r) {
        return function (o) {
         (o = o || window.event).preventDefault
          ...
          : (o.returnValue = !1),
          o.stopPropagation();
         var h = o.pageX || o.touches[0].pageX,
          c = o.pageY || o.touches[0].pageY;
         e.el.fire('point', { x: h, y: c, i: r, event: o });
        };
       })(i),
       n = this.drawPoint(t[i][0], t[i][1])
    ...
    (v.prototype.drawPoint = function (e, t) {
    ...
    (v.prototype.drawCircle = function (e, t) {
     return this.nested.circle(this.options.pointSize).center(e, t);
    }),
    (v.prototype.drawRect = function (e, t) {
     return this.nested
      .rect(this.options.pointSize, this.options.pointSize)
      .center(e, t);
    }),
    (v.prototype.updatePointSelection = function () {
    ...
    (v.prototype.updateRectSelection = function () {
     var e = this,
      t = this.el.bbox();
     if (
      ...
      this.options.points.length &&
       this.options.points.map(function (a, s) {
        ...
        e.rectSelection.set.get(s + 1).center(n.x, n.y);
       }),
    ...
    (v.prototype.selectRect = function (e) {
     var t = this,
      i = this.el.bbox();
     function a(r) {
      return function (o) {
     ...
     if (
      ...
      this.options.points.length &&
       ...
       (this.options.points.map(function (r, o) {
        var h = t.pointCoords(r, i),
         c = t
          .drawPoint(h.x, h.y)
          .attr('class', t.options.classPoints + '_' + r)
          .on('mousedown', a(r))
          .on('touchstart', a(r));
      ...
      var s = function (r) {
        (r = r || window.event).preventDefault
         ...
         : (r.returnValue = !1),
         r.stopPropagation();
        var o = r.pageX || r.touches[0].pageX,
         h = r.pageY || r.touches[0].pageY;
        t.el.fire('rot', { x: o, y: h, event: r });
       },
    ...
    SVG.extend(SVG.Element, {
     selectize: function (e, t) {
      return (
       ...
       (this.remember('_selectHandler') || new v(this)).init(
        e === void 0 || e,
        t || {},
       ),
       this
  ...
  (function () {
   (function () {
    ...
    (v.prototype.transformPoint = function (e, t, i) {
     return (
     ...
     (v.prototype._extractPosition = function (e) {
      return {
      ...
      switch (e.type) {
       case 'lt':
        this.calc = function (s, n) {
         var r = this.snapToGrid(s, n);
         if (
          this.parameters.box.width - r[0] > 0 &&
          this.parameters.box.height - r[1] > 0
         ) {
          if (this.parameters.type === 'text')
           return (
            this.el.move(this.parameters.box.x + r[0], this.parameters.box.y),
            void this.el.attr('font-size', this.parameters.fontSize - r[0])
           );
          (r = this.checkAspectRatio(r)),
           this.el
            .move(this.parameters.box.x + r[0], this.parameters.box.y + r[1])
            .size(
             this.parameters.box.width - r[0],
             this.parameters.box.height - r[1],
            );
         }
        };
        break;
       case 'rt':
        this.calc = function (s, n) {
         ...
         if (
          ...
          (r = this.checkAspectRatio(r, !0)),
           this.el
            .move(this.parameters.box.x, this.parameters.box.y + r[1])
            .size(
             this.parameters.box.width + r[0],
             this.parameters.box.height - r[1],
            );
       ...
       case 'lb':
        this.calc = function (s, n) {
         ...
         if (
          ...
          (r = this.checkAspectRatio(r, !0)),
           this.el
            .move(this.parameters.box.x + r[0], this.parameters.box.y)
            .size(
             this.parameters.box.width - r[0],
             this.parameters.box.height + r[1],
            );
       ...
       case 't':
        this.calc = function (s, n) {
         var r = this.snapToGrid(s, n, 2);
         if (this.parameters.box.height - r[1] > 0) {
          if (this.parameters.type === 'text') return;
          this.el
           .move(this.parameters.box.x, this.parameters.box.y + r[1])
           .height(this.parameters.box.height - r[1]);
         }
        };
        break;
       case 'r':
        this.calc = function (s, n) {
         var r = this.snapToGrid(s, n, 0);
         if (this.parameters.box.width + r[0] > 0) {
          if (this.parameters.type === 'text') return;
          this.el
           .move(this.parameters.box.x, this.parameters.box.y)
           .width(this.parameters.box.width + r[0]);
         }
        };
        break;
       case 'b':
       ...
       case 'rot':
        this.calc = function (s, n) {
         var r = s + this.parameters.p.x,
          o = n + this.parameters.p.y,
          h = Math.atan2(
           this.parameters.p.y -
          ...
          c = Math.atan2(
           o - this.parameters.box.y - this.parameters.box.height / 2,
           r - this.parameters.box.x - this.parameters.box.width / 2,
          ),
          d =
       ...
       case 'point':
        this.calc = function (s, n) {
         ...
         (o[this.parameters.i][0] = this.parameters.pointCoords[0] + r[0]),
          (o[this.parameters.i][1] = this.parameters.pointCoords[1] + r[1]),
          this.el.plot(o);
        };
      }
     ...
     (v.prototype.update = function (e) {
      if (e) {
       ...
       (this.lastUpdateCall = [a, s]),
        this.calc(a, s),
        this.el.fire('resizing', { dx: a, dy: s, event: e });
      } else
       this.lastUpdateCall &&
     ...
     (v.prototype.snapToGrid = function (e, t, i, a) {
      var s;
      return (
       a !== void 0
        ? (s = [
       ...
       (e -=
        Math.abs(s[0]) < this.options.snapToGrid / 2
         ? s[0]
         : s[0] - (e < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
       (t -=
        Math.abs(s[1]) < this.options.snapToGrid / 2
         ? s[1]
         : s[1] - (t < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
       this.constraintToBox(e, t, i, a)
      );
     }),
     (v.prototype.constraintToBox = function (e, t, i, a) {
      var s,
       n,
      ...
      return (
       ...
       r.minX !== void 0 && s + e < r.minX && (e = r.minX - s),
       r.maxX !== void 0 && s + e > r.maxX && (e = r.maxX - s),
       r.minY !== void 0 && n + t < r.minY && (t = r.minY - n),
       r.maxY !== void 0 && n + t > r.maxY && (t = r.maxY - n),
       [e, t]
      );
     }),
     (v.prototype.checkAspectRatio = function (e, t) {
      ...
      var i = e.slice(),
       ...
       n = this.parameters.box.height - e[1],
       r = s / n;
      return (
       r < a
        ? ((i[1] = s / a - this.parameters.box.height), t && (i[1] = -i[1]))
        : r > a &&
          ((i[0] = this.parameters.box.width - n * a), t && (i[0] = -i[0])),
       i
      );
     }),
     SVG.extend(SVG.Element, {
      resize: function (e) {
       return (
        (this.remember('_resizeHandler') || new v(this)).init(e || {}), this
       );
      },
     }),
...
.contract-trigger:before {
  ...
  (function () {
   function v(g) {
    var p = g.__resizeTriggers__,
     f = p.firstElementChild,
     x = p.lastElementChild,
     b = f ? f.firstElementChild : null;
    x && ((x.scrollLeft = x.scrollWidth), (x.scrollTop = x.scrollHeight)),
     b &&
      ((b.style.width = f.offsetWidth + 1 + 'px'),
      (b.style.height = f.offsetHeight + 1 + 'px')),
     f && ((f.scrollLeft = f.scrollWidth), (f.scrollTop = f.scrollHeight));
   }
   function e(g) {
    var p = this;
    v(this),
     ...
     (this.__resizeRAF__ = a(function () {
      (function (f) {
       return (
        f.offsetWidth != f.__resizeLast__.width ||
        f.offsetHeight != f.__resizeLast__.height
       );
      })(p) &&
       ((p.__resizeLast__.width = p.offsetWidth),
       (p.__resizeLast__.height = p.offsetHeight),
       p.__resizeListeners__.forEach(function (f) {
        f.call(g);
       }));
     }));
   }
   ...
   if ((c.style.animationName !== void 0 && (n = !0), n === !1)) {
    for (var d = 0; d < o.length; d++)
     if (c.style[o[d] + 'AnimationName'] !== void 0) {
      r = h[d];
      break;
     }
   }
   (window.addResizeListener = function (g, p) {
    g.__resizeTriggers__ ||
     (getComputedStyle(g).position == 'static' &&
      (g.style.position = 'relative'),
     (g.__resizeLast__ = {}),
     (g.__resizeListeners__ = []),
     ((g.__resizeTriggers__ = document.createElement('div')).className =
      'resize-triggers'),
     (g.__resizeTriggers__.innerHTML =
      '<div class="expand-trigger"><div></div></div><div class="contract-trigger"></div>'),
     g.appendChild(g.__resizeTriggers__),
     v(g),
     g.addEventListener('scroll', e, !0),
     r &&
      g.__resizeTriggers__.addEventListener(r, function (f) {
       f.animationName == 'resizeanim' && v(g);
      })),
     g.__resizeListeners__.push(p);
   }),
    (window.removeResizeListener = function (g, p) {
     g &&
      (g.__resizeListeners__.splice(g.__resizeListeners__.indexOf(p), 1),
      g.__resizeListeners__.length ||
       (g.removeEventListener('scroll', e),
       g.__resizeTriggers__.parentNode &&
    ...
    E(v, [
     {
      ...
      value: function () {
       (this.ctx.publicMethods = [
        ...
        (this.ctx.animations = new K(this.ctx)),
        (this.ctx.axes = new nt(this.ctx)),
        (this.ctx.core = new Pt(this.ctx.el, this.ctx)),
        (this.ctx.config = new le({})),
        (this.ctx.data = new Fe(this.ctx)),
        (this.ctx.grid = new Re(this.ctx)),
        (this.ctx.graphics = new I(this.ctx)),
        (this.ctx.coreUtils = new D(this.ctx)),
        (this.ctx.crosshairs = new ke(this.ctx)),
        (this.ctx.events = new st(this.ctx)),
        (this.ctx.exports = new ve(this.ctx)),
        (this.ctx.localization = new rt(this.ctx)),
        (this.ctx.options = new $()),
        (this.ctx.responsive = new ot(this.ctx)),
        (this.ctx.series = new j(this.ctx)),
        (this.ctx.theme = new lt(this.ctx)),
        (this.ctx.formatters = new ge(this.ctx)),
        ...
        (this.ctx.zoomPanSelection = new ft(this.ctx)),
      ...
      value: function (e) {
       ...
       s &&
        this.ctx.eventList.forEach(function (r) {
         s.removeEventListener(r, t.ctx.events.documentEvent);
        });
     ...
     [
       ...
       value: function () {
        ...
        return new Promise(function (t, i) {
         if (e.el !== null) {
          ...
          typeof a == 'function' && a(e, e.w),
           e.events.fireEvent('beforeMount', [e, e.w]),
           window.addEventListener('resize', e.windowResizeHandler),
           window.addResizeListener(e.el.parentNode, e.parentResizeHandler);
          var s = e.create(e.w.config.series, {});
          if (!s) return t(e);
          e.mount(s)
           .then(function () {
      ...
      },
      {
       ...
       value: function (e, t) {
        ...
        if (
         ...
         i.config.xaxis.convertedCatToNumeric &&
          new oe(i.config).convertCatToNumericXaxis(i.config, this.ctx),
         this.el === null ||
        ...
        var s = D.checkComboSeries(e);
        (a.comboCharts = s.comboCharts), (a.comboBarCount = s.comboBarCount);
        var n = e.every(function (d) {
         return d.data && d.data.length === 0;
        });
        (e.length === 0 || n) && this.series.handleNoData(),
         this.events.setupEventHandlers(),
         this.data.parseData(e),
         this.theme.init(),
         new ne(this).setGlobalMarkerSize(),
        ...
        var o = this.core.plotChartType(e, r),
         h = new ee(this);
        h.bringForward(),
        ...
        return new Promise(function (s, n) {
         ...
         if (
          (r !== null &&
           ...
           a.config.yaxis.map(function (g, p) {
            a.globals.ignoreYAxisIndexes.indexOf(p) === -1 &&
             h.yAxisTitleRotate(p, g.opposite);
           })),
          a.config.annotations.position === 'back' &&
         ...
         if (
          (a.config.grid.position === 'front' &&
           r &&
           a.globals.dom.elGraphical.add(r.el),
          a.config.xaxis.crosshairs.position === 'front' &&
           i.crosshairs.drawXCrosshairs(),
          a.config.yaxis[0].crosshairs.position === 'front' &&
           i.crosshairs.drawYCrosshairs(),
          a.config.annotations.position === 'front' &&
           (a.globals.dom.Paper.add(a.globals.dom.elAnnotations),
           i.annotations.drawAxesAnnotations()),
          !a.globals.noData)
         ) {
         ...
         a.globals.memory.methodsToExec.length > 0 &&
          a.globals.memory.methodsToExec.forEach(function (g) {
      ...
      },
      {
       ...
       value: function () {
        ...
        e &&
         Apex._chartInstances.forEach(function (t, i) {
          t.id === L.escapeString(e) && Apex._chartInstances.splice(i, 1);
         }),
         new je(this.ctx).clear({ isUpdating: !1 });
       },
      },
      {
       key: 'updateOptions',
       value: function (e) {
        ...
        return (
         ...
         e.series &&
          ...
          e.series.length &&
           e.series[0].data &&
           (e.series = e.series.map(function (o, h) {
         ...
         this.updateHelpers._updateOptions(e, i, a, s, n)
        );
       },
      },
      {
        ...
        for (var a = i.w.config.series.slice(), s = 0; s < a.length; s++)
         if (e[s] !== null && e[s] !== void 0)
          for (var n = 0; n < e[s].data.length; n++)
           a[s].data.push(e[s].data[n]);
        return (
         (i.w.config.series = a),
         t && (i.w.globals.initialSeries = L.clone(i.w.config.series)),
         this.update()
        );
       },
      },
      {
       ...
       value: function (e) {
        ...
        return new Promise(function (i, a) {
         new je(t.ctx).clear({ isUpdating: !0 });
      ...
      },
      {
       key: 'dataURI',
       value: function (e) {
        return new ve(this.ctx).dataURI(e);
       },
      },
      {
       key: 'paper',
      ...
      },
      {
       ...
       value: function () {
        for (
         ...
         new v(e[t], JSON.parse(e[t].getAttribute('data-options'))).render();
       },
      },
      {
       key: 'exec',
