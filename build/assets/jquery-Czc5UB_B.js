    ...
    (function (j, Je) {
         ...
         : ((t = Rt(e)),
           t
            ? ((n = Ie.call(t, 'constructor') && t.constructor),
              typeof n == 'function' && Wt.call(n) === Ln)
            : !0);
       },
     ...
     (function () {
        ...
        p == a ||
         ...
         q.getById
          ...
          : ((t.filter.ID = function (g) {
             ...
             return function (m) {
              var T =
               typeof m.getAttributeNode < 'u' && m.getAttributeNode('id');
              return T && T.value === v;
             };
            }),
            (t.find.ID = function (g, v) {
       ...
       (t = i.expr =
        {
             ...
             D(s, function (p) {
              return l.test(
               (typeof p.className == 'string' && p.className) ||
                (typeof p.getAttribute < 'u' && p.getAttribute('class')) ||
                '',
              );
             }))
           );
         ...
         pseudos: {
            ...
            function (l) {
             ...
             do
              if (
               ...
               return (
                (p = p.toLowerCase()), p === s || p.indexOf(s + '-') === 0
               );
          ...
          focus: function (s) {
           return (
            s === Mr() && a.hasFocus() && !!(s.type || s.href || ~s.tabIndex)
           );
          },
          enabled: Dn(!1),
          disabled: Dn(!0),
          checked: function (s) {
           return (
            ($(s, 'input') && !!s.checked) || ($(s, 'option') && !!s.selected)
           );
          },
          selected: function (s) {
      ...
      function ft(s, l, p) {
       ...
       return l.first
        ? function (C, O, A) {
           for (; (C = C[g]); ) if (C.nodeType === 1 || T) return s(C, O, A);
           return !1;
          }
        : function (C, O, A) {
           var N,
      ...
      function Ot(s) {
       for (
        ...
        if ((p = t.relative[s[w].type])) A = [ft(Lt(A), p)];
        else {
       ...
       var p = l.length > 0,
        ...
        v = function (m, T, w, C, O) {
         ...
         for (
          ...
          if (g && A) {
           for (
            N = 0, !T && A.ownerDocument != a && (me(A), (w = !f));
            (P = s[N++]);
         ...
         if (((E += F), p && F !== E)) {
          ...
          if (m) {
           if (E > 0) for (; F--; ) K[F] || X[F] || (X[F] = Pn.call(C));
           X = ct(X);
          }
          u.apply(C, X),
      ...
      function kn(s, l, p, g) {
       ...
       if (((p = p || []), A.length === 1)) {
        if (
         ...
         if (((l = (t.find.ID(T.matches[0].replace(ye, ve), l) || [])[0]), l))
          O && (l = l.parentNode);
         else return p;
        ...
        if (
         ...
         if (r[1]) {
          if (
           ...
           i.merge(
            this,
            i.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : k, !0),
           ),
             ...
             H = function () {
              ...
              if (!(y < f)) {
               ...
               (ae =
                ...
                L(ae)
                 ? x
                   ? ae.call(z, d(f, b, ke, x), d(f, b, et, x))
                   : (f++,
                     ae.call(
                      z,
                      d(f, b, ke, x),
                      d(f, b, et, x),
                      d(f, b, ke, b.notifyWith),
                     ))
                 : (h !== ke && ((D = void 0), (R = [z])),
                   (x || b.resolveWith)(D, R));
              }
              ...
              : function () {
                 try {
                  ...
                  i.Deferred.exceptionHook &&
                   ...
                   y + 1 >= f &&
                    (h !== et && ((D = void 0), (R = [z])), b.rejectWith(D, R));
                 }
                };
            y
             ? V()
        ...
        if (e === void 0) {
         if (
          ...
          for (n = a.length; n--; )
           a[n] &&
            ((r = a[n].name),
            r.indexOf('data-') === 0 && ((r = ue(r.slice(5))), Qt(u, r, o[r])));
         ...
         : he(
            ...
            function (c) {
             ...
             if (u && c === void 0)
              return (
               (f = Q.get(u, e)),
               f !== void 0 || ((f = Qt(u, e)), f !== void 0) ? f : void 0
              );
             this.each(function () {
              Q.set(this, e, c);
             });
     ...
     Te.getRootNode &&
      (je = function (e) {
       return (
        i.contains(e.ownerDocument, e) || e.getRootNode(Kn) === e.ownerDocument
       );
      });
     var nt = function (e, t) {
      return (
         ...
         (c = nn.exec(t[d]) || []),
          ...
          x &&
           ...
           (h = f[x]) ||
            ((h = f[x] = []),
            (h.delegateCount = 0),
            (!b.setup || b.setup.call(e, r, D, a) === !1) &&
             e.addEventListener &&
             e.addEventListener(x, a)),
           b.add &&
            (b.add.call(e, y), y.handler.guid || (y.handler.guid = n.guid)),
      ...
      remove: function (e, t, n, r, o) {
       ...
       if (!(!H || !(f = H.events))) {
        for (t = (t || '').match(oe) || [''], d = t.length; d--; ) {
         ...
         a &&
          !h.length &&
          ((!b.teardown || b.teardown.call(e, D, H.handle) === !1) &&
           i.removeEvent(e, x, H.handle),
          delete f[x]);
        }
        ...
        for (
         ...
         for (
          ...
          (!f.rnamespace ||
           ...
           ((f.handleObj = u),
           (f.data = u.data),
           (r = ((i.event.special[u.origType] || {}).handle || u.handler).apply(
            o.elem,
            c,
           )),
           r !== void 0 &&
      ...
      special: {
       ...
       click: {
        setup: function (e) {
         var t = this || e;
         return (
          Be.test(t.type) && t.click && $(t, 'input') && rt(t, 'click', !0), !1
         );
        },
        trigger: function (e) {
         var t = this || e;
        ...
        _default: function (e) {
         var t = e.target;
         return (
          (Be.test(t.type) && t.click && $(t, 'input') && S.get(t, 'click')) ||
          $(t, 'a')
         );
        },
       },
     ...
     function Oe(e, t, n, r) {
      ...
      if (
       ...
       for (a = i.map(Y(o, 'script'), ir), c = a.length; y < b; y++)
        (f = o),
         y !== h && ((f = i.clone(f, !0, !0)), c && i.merge(a, Y(f, 'script'))),
         n.call(e[y], f, y);
       if (c)
         ...
         (f = a[y]),
          en.test(f.type || '') &&
           ...
           (f.src && (f.type || '').toLowerCase() !== 'module'
            ...
            : Ft(f.textContent.replace(rr, ''), f, d));
      }
      return e;
     }
     function un(e, t, n) {
         ...
         function (t) {
          ...
          if (
           ...
           try {
            for (; r < o; r++)
             (n = this[r] || {}),
              n.nodeType === 1 && (i.cleanData(Y(n, !1)), (n.innerHTML = t));
            n = 0;
           } catch {}
          }
       ...
       n === 'margin' && (d += i.css(e, n + ge[a], !0, o)),
        r
         ? (n === 'content' && (f -= i.css(e, 'padding' + ge[a], !0, o)),
           n !== 'margin' && (f -= i.css(e, 'border' + ge[a] + 'Width', !0, o)))
      ...
      style: function (e, t, n, r) {
       if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
        var o,
         ...
         d = e.style;
        if (
         (f || (t = xt(c)), (a = i.cssHooks[t] || i.cssHooks[c]), n !== void 0)
        ) {
         if (
          ((u = typeof n),
          u === 'string' &&
       ...
       _default: {
        ...
        set: function (e) {
         i.fx.step[e.prop]
          ? i.fx.step[e.prop](e)
          : e.elem.nodeType === 1 &&
              (i.cssHooks[e.prop] || e.elem.style[xt(e.prop)] != null)
     ...
     function pr(e, t, n) {
      ...
      for (r in t)
       if (((o = t[r]), lr.test(o))) {
        if (
         (delete t[r], (u = u || o === 'toggle'), o === (R ? 'hide' : 'show'))
        )
      ...
      if (((f = !i.isEmptyObject(t)), !(!f && i.isEmptyObject(x)))) {
       ...
       for (r in x)
        f ||
         ...
         (f = yn(R ? H[r] : 0, r, h)),
         r in H || ((H[r] = f.start), R && ((f.end = f.start), (f.start = 0)));
      }
     }
     function hr(e, t) {
      var n, r, o, u, a;
        ...
        ? ((r = L(e)),
          this.each(function (u) {
           ...
           this.nodeType === 1 &&
            ...
            (t =
             i.valHooks[this.type] || i.valHooks[this.nodeName.toLowerCase()]),
        ...
        for (o = 0; (u = h[o++]) && !e.isPropagationStopped(); )
         (b = u),
          ...
          d &&
           d.apply &&
           We(u) &&
           ((e.result = d.apply(u, t)), e.result === !1 && e.preventDefault());
        return (
         (e.type = x),
         !r &&
...
`,
      ...
      ajax: function (e, t) {
       ...
       var n,
        ...
        M = {
         ...
         setRequestHeader: function (I, B) {
          return (
           f == null &&
            ((I = ae[I.toLowerCase()] = ae[I.toLowerCase()] || I), (z[I] = B)),
           this
          );
         },
       ...
       function Se(I, B, Ge, kt) {
        ...
        f ||
         ...
         fe
          ? (h.ifModified &&
             ((xe = M.getResponseHeader('Last-Modified')),
            ...
            I === 204 || h.type === 'HEAD'
             ...
             : I === 304
               ? (te = 'notmodified')
               : ((te = be.state), (Qe = be.data), (ce = be.error), (fe = !ce)))
        ...
        return (
         ...
         n.always(function () {
          o === void 0 ? i(j).removeProp(r) : (j[r] = o),
           e[r] && ((e.jsonpCallback = t.jsonpCallback), An.push(r)),
           u && L(o) && o(u[0]),
           (u = o = void 0);
         }),
         'script'
      ...
      (i.offset = {
       setOffset: function (e, t, n) {
        ...
        y === 'static' && (e.style.position = 'relative'),
         ...
         (f = i.css(e, 'left')),
         (d =
          (y === 'absolute' || y === 'fixed') && (u + f).indexOf('auto') > -1),
         d
     ...
     return (
      (i.noConflict = function (e) {
       return (
        j.$ === i && (j.$ = Hr), e && j.jQuery === i && (j.jQuery = Lr), i
       );
      }),
