...
!(function (e, t) {
 ...
 var o = function (e) {
  ...
  l = {
   ...
   K: function (e, t, n) {
    e.setHours(
     (e.getHours() % 12) + 12 * a(new RegExp(n.amPM[1], 'i').test(t)),
    );
   },
   M: function (e, t, n) {
    ...
    if (0 === e || e) {
     ...
     if (e instanceof Date) o = new Date(e.getTime());
      ...
      var c = t || (n || h).dateFormat,
       s = String(e).trim();
      if ('today' === s) (o = new Date()), (a = !0);
      else if (/Z$/.test(s) || /GMT$/.test(s)) o = new Date(e);
       ...
       for (var u = void 0, f = [], m = 0, g = 0, p = ''; m < c.length; m++) {
        ...
        if (d[v] && !b) {
         ...
         w &&
          (u = !0) &&
          f['Y' !== v ? 'push' : 'unshift']({ fn: l[v], val: w[++g] });
        } else D || (p += '.');
 ...
 var w,
  M = 300;
 function C(e, r) {
  var l = { config: t({}, w.defaultConfig), l10n: u };
  function s(e) {
   return e.bind(l);
  }
  function h(e) {
   l.config.noCalendar &&
    0 === l.selectedDates.length &&
    (l.setDate(
     void 0 !== l.config.minDate
      ? new Date(l.config.minDate.getTime())
      : new Date().setHours(
         l.config.defaultHour,
         l.config.defaultMinute,
         l.config.defaultSeconds,
         0,
        ),
     !1,
    ),
    ...
    (function (e) {
     ...
     void 0 !== l.amPM &&
      e.target === l.amPM &&
      (l.amPM.textContent =
       l.l10n.amPM[a(l.amPM.textContent === l.l10n.amPM[0])]);
     ...
     if (void 0 !== i.value && 2 === i.value.length) {
      var f = i === l.hourElement,
       m = i === l.minuteElement;
      u < o
       ? ((u = r + u + a(!f) + (a(f) && a(!l.amPM))),
         m && P(void 0, -1, l.hourElement))
       : u > r &&
         ((u = i === l.hourElement ? u - r - a(!l.amPM) : o),
         m && P(void 0, 1, l.hourElement)),
       l.amPM &&
        f &&
  ...
  function C() {
   if (void 0 !== l.hourElement && void 0 !== l.minuteElement) {
    var e,
     t,
     n = (parseInt(l.hourElement.value.slice(-2), 10) || 0) % 24,
     i = (parseInt(l.minuteElement.value, 10) || 0) % 60,
     o =
      void 0 !== l.secondElement
       ? (parseInt(l.secondElement.value, 10) || 0) % 60
       : 0;
    void 0 !== l.amPM &&
     ((e = n),
    ...
    var r =
     void 0 !== l.config.minTime ||
     (l.config.minDate &&
      l.minDateHasTime &&
      l.latestSelectedDateObj &&
      0 === g(l.latestSelectedDateObj, l.config.minDate, !0));
    if (
     void 0 !== l.config.maxTime ||
     (l.config.maxDate &&
      l.maxDateHasTime &&
      l.latestSelectedDateObj &&
      0 === g(l.latestSelectedDateObj, l.config.maxDate, !0))
    ) {
     var c = void 0 !== l.config.maxTime ? l.config.maxTime : l.config.maxDate;
     (n = Math.min(n, c.getHours())) === c.getHours() &&
      (i = Math.min(i, c.getMinutes())),
  ...
  function x(e, t, i) {
   void 0 !== l.latestSelectedDateObj &&
    l.latestSelectedDateObj.setHours(e % 24, t, i || 0, 0),
    l.hourElement &&
     l.minuteElement &&
     !l.isMobile &&
     ((l.hourElement.value = n(
      l.config.time_24hr ? e : ((12 + e) % 12) + 12 * a(e % 12 == 0),
     )),
  ...
  function E(e) {
   ...
   (4 !== t.toString().length && 'Enter' !== e.key) ||
    (l.currentYearElement.blur(), /[^\d]/.test(t.toString()) || L(t));
  }
  function T(e, t, n, a) {
   return t instanceof Array
    ...
    : e instanceof Array
      ...
      : (e.addEventListener(t, n, a),
        void l._handlers.push({ element: e, event: t, handler: n }));
  }
  function k(e) {
   return function (t) {
    1 === t.which && e(t);
  ...
  function S(e) {
   var t =
    void 0 !== e
     ? l.parseDate(e)
     : l.latestSelectedDateObj ||
       (l.config.minDate && l.config.minDate > l.now
        ? l.config.minDate
        : l.config.maxDate && l.config.maxDate < l.now
          ? l.config.maxDate
          : l.now);
   try {
    void 0 !== t &&
     ((l.currentYear = t.getFullYear()), (l.currentMonth = t.getMonth()));
   } catch (e) {
  ...
  function Y(e, t, n, a) {
   ...
   return (
    ...
    0 === g(t, l.now) && ((l.todayDateElem = r), r.classList.add('today')),
    o
     ? ((r.tabIndex = -1),
       ee(t) &&
        ...
        'range' === l.config.mode &&
         (v(
          r,
          'startRange',
          l.selectedDates[0] && 0 === g(t, l.selectedDates[0]),
         ),
         v(
          r,
          'endRange',
          l.selectedDates[1] && 0 === g(t, l.selectedDates[1]),
         ))))
    ...
    'range' === l.config.mode &&
     ((i = t),
     !('range' !== l.config.mode || l.selectedDates.length < 2) &&
      g(i, l.selectedDates[0]) >= 0 &&
      g(i, l.selectedDates[1]) <= 0 &&
      !ee(t) &&
      r.classList.add('inRange'),
     1 === l.selectedDates.length &&
      void 0 !== l.minRangeDate &&
      void 0 !== l.maxRangeDate &&
      (t < l.minRangeDate || t > l.maxRangeDate) &&
      r.classList.add('notAllowed')),
    l.weekNumbers &&
     'prevMonthDay' !== e &&
     n % 7 == 1 &&
     l.weekNumbers.insertAdjacentHTML(
      'beforeend',
      "<span class='flatpickr-day'>" + l.config.getWeek(t) + '</span>',
     ),
    Q('onDayCreate', r),
    r
   );
  ...
  function A(e, t) {
   var n = e + t || 0,
    a =
     void 0 !== e
      ? l.days.childNodes[n]
      : l.selectedDateElem || l.todayDateElem || l.days.childNodes[0];
   void 0 === a &&
    0 !== t &&
    (t > 0
     ? (l.changeMonth(1, !0, !0), (n %= 42))
     : t < 0 && (l.changeMonth(-1, !0, !0), (n += 42))),
  ...
  function O() {
   if (void 0 !== l.daysContainer) {
    var e =
      (new Date(l.currentYear, l.currentMonth, 1).getDay() -
       l.l10n.firstDayOfWeek +
       7) %
      7,
    ...
    for (
     l.weekNumbers &&
      l.weekNumbers.firstChild &&
      (l.weekNumbers.textContent = ''),
      t &&
       ((l.minRangeDate = new Date(l.currentYear, l.currentMonth - 1, o)),
       (l.maxRangeDate = new Date(
        l.currentYear,
        l.currentMonth + 1,
        (42 - e) % a,
       )));
     ...
     i.appendChild(
      Y('prevMonthDay', new Date(l.currentYear, l.currentMonth - 1, o), o, r),
     );
    for (o = 1; o <= a; o++, r++)
     i.appendChild(Y('', new Date(l.currentYear, l.currentMonth, o), o, r));
    for (var c = a + 1; c <= 42 - e; c++, r++)
     i.appendChild(
      Y(
       'nextMonthDay',
       new Date(l.currentYear, l.currentMonth + 1, c % a),
       c,
       r,
      ),
     );
    t && 1 === l.selectedDates.length && i.childNodes[0]
     ? ((l._hidePrevMonthArrow =
        l._hidePrevMonthArrow ||
        (!!l.minRangeDate && l.minRangeDate > i.childNodes[0].dateObj)),
       (l._hideNextMonthArrow =
        l._hideNextMonthArrow ||
        (!!l.maxRangeDate &&
         l.maxRangeDate < new Date(l.currentYear, l.currentMonth + 1, 1))))
     : te();
  ...
  function F(e, t, n) {
   ...
   (a < 0 && l._hidePrevMonthArrow) ||
    (a > 0 && l._hideNextMonthArrow) ||
    ((l.currentMonth += a),
    (l.currentMonth < 0 || l.currentMonth > 11) &&
     ((l.currentYear += l.currentMonth > 11 ? 1 : -1),
  ...
  function j(e) {
   return (
    !(!l.config.appendTo || !l.config.appendTo.contains(e)) ||
    l.calendarContainer.contains(e)
   );
  }
  function H(e) {
   if (l.isOpen && !l.config.inline) {
    var t = j(e.target),
     n =
      e.target === l.input ||
      e.target === l.altInput ||
      l.element.contains(e.target) ||
      (e.path &&
       e.path.indexOf &&
       (~e.path.indexOf(l.input) || ~e.path.indexOf(l.altInput))),
     a =
      'blur' === e.type
  ...
  function L(e) {
   if (
    !(
     !e ||
     (l.currentYearElement.getAttribute('data-min') &&
      e < parseInt(l.currentYearElement.getAttribute('data-min'))) ||
     (l.currentYearElement.getAttribute('data-max') &&
      e > parseInt(l.currentYearElement.getAttribute('data-max')))
    )
   ) {
    var t = e,
     n = l.currentYear !== t;
    (l.currentYear = t || l.currentYear),
     l.config.maxDate && l.currentYear === l.config.maxDate.getFullYear()
      ? (l.currentMonth = Math.min(l.config.maxDate.getMonth(), l.currentMonth))
      : l.config.minDate &&
        l.currentYear === l.config.minDate.getFullYear() &&
        (l.currentMonth = Math.max(
         l.config.minDate.getMonth(),
         l.currentMonth,
        )),
     n && (l.redraw(), Q('onYearChange'));
   }
  }
  function R(e, t) {
   void 0 === t && (t = !0);
   ...
   if (
    (l.config.minDate &&
     n &&
     g(n, l.config.minDate, void 0 !== t ? t : !l.minDateHasTime) < 0) ||
    (l.config.maxDate &&
     n &&
     g(n, l.config.maxDate, void 0 !== t ? t : !l.maxDateHasTime) > 0)
   )
    return !1;
   if (!l.config.enable.length && !l.config.disable.length) return !0;
   if (void 0 === n) return !1;
   for (
    var a = l.config.enable.length > 0,
     i = a ? l.config.enable : l.config.disable,
     o = 0,
     r = void 0;
    o < i.length;
    o++
  ...
  function W(e) {
   ...
   if (13 === e.keyCode && t) {
    if (a)
     return (
      l.setDate(
       l._input.value,
       !0,
       e.target === l.altInput ? l.config.altFormat : l.config.dateFormat,
      ),
      e.target.blur()
     );
    l.open();
    ...
    switch (e.keyCode) {
     ...
     case 37:
     case 39:
      if (r) l.hourElement && l.hourElement.focus();
      else if ((e.preventDefault(), l.daysContainer)) {
     ...
     case 40:
      ...
      l.daysContainer && void 0 !== e.target.$i
       ? e.ctrlKey
         ? (L(l.currentYear - d), A(e.target.$i, 0))
         : r || A(e.target.$i, 7 * d)
       : l.config.enableTime &&
         (!r && l.hourElement && l.hourElement.focus(),
         h(e),
         l._debouncedChange());
      break;
     case 9:
      e.target === l.hourElement
       ? (e.preventDefault(), l.minuteElement.select())
       : e.target === l.minuteElement && (l.secondElement || l.amPM)
         ? (e.preventDefault(),
           void 0 !== l.secondElement
            ? l.secondElement.focus()
            : void 0 !== l.amPM && l.amPM.focus())
         : e.target === l.secondElement &&
           l.amPM &&
           (e.preventDefault(), l.amPM.focus());
    }
    switch (e.key) {
     ...
     case l.l10n.amPM[0].charAt(0).toLowerCase():
      void 0 !== l.amPM &&
       e.target === l.amPM &&
       ((l.amPM.textContent = l.l10n.amPM[0]), C(), ne());
      break;
     case l.l10n.amPM[1].charAt(0):
     case l.l10n.amPM[1].charAt(0).toLowerCase():
      void 0 !== l.amPM &&
       e.target === l.amPM &&
       ((l.amPM.textContent = l.l10n.amPM[1]), C(), ne());
    }
    Q('onKeyDown', e);
   }
  }
  function J(e) {
   if (
    ...
    for (
     var t = e.dateObj,
      n = l.parseDate(l.selectedDates[0], void 0, !0),
      a = Math.min(t.getTime(), l.selectedDates[0].getTime()),
      i = Math.max(t.getTime(), l.selectedDates[0].getTime()),
      o = !1,
      r = a;
     r < i;
     r += p.DAY
     ...
     var c = function (r, c) {
       ...
       e.classList.add(t < l.selectedDates[0] ? 'startRange' : 'endRange'),
        n < t && d === n.getTime()
         ...
         : n > t && d === n.getTime() && u.classList.add('endRange'),
        d >= f && d <= m && u.classList.add('inRange');
      },
      d = 0,
      s = l.days.childNodes[d].dateObj;
     d < 42;
     d++, s = l.days.childNodes[d] && l.days.childNodes[d].dateObj
    )
     c(d, s);
   }
  }
  ...
  function B(e) {
   return function (t) {
    ...
    void 0 !== n &&
     (l['min' === e ? 'minDateHasTime' : 'maxDateHasTime'] =
      n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0),
     l.selectedDates &&
      ((l.selectedDates = l.selectedDates.filter(function (e) {
       return R(e);
      })),
     ...
     l.daysContainer &&
      (q(),
      void 0 !== n
       ? (l.currentYearElement[e] = n.getFullYear().toString())
       : l.currentYearElement.removeAttribute(e),
      (l.currentYearElement.disabled =
       !!a && void 0 !== n && a.getFullYear() === n.getFullYear()));
   };
  }
  function $() {
   'object' != typeof l.config.locale &&
    void 0 === w.l10ns[l.config.locale] &&
    l.config.errorHandler(
     new Error('flatpickr: invalid locale ' + l.config.locale),
    ),
    (l.l10n = t(
     {},
     w.l10ns.default,
     'object' == typeof l.config.locale
      ? l.config.locale
      : 'default' !== l.config.locale
        ? w.l10ns[l.config.locale]
        : void 0,
    )),
    (d.K =
     '(' +
     ...
     l.l10n.amPM[1] +
     '|' +
     l.l10n.amPM[0].toLowerCase() +
     '|' +
     l.l10n.amPM[1].toLowerCase() +
     ')'),
    (l.formatDate = f(l));
  }
  function U(e) {
   if (void 0 !== l.calendarContainer) {
    ...
    if (
     (v(l.calendarContainer, 'arrowTop', !c),
     ...
     v(l.calendarContainer, 'rightMost', f),
      l.config.static ||
       ((l.calendarContainer.style.top = d + 'px'),
       f
        ? ((l.calendarContainer.style.left = 'auto'),
          (l.calendarContainer.style.right = u + 'px'))
        : ((l.calendarContainer.style.left = s + 'px'),
          (l.calendarContainer.style.right = 'auto')));
    }
   }
  }
  function q() {
   l.config.noCalendar || l.isMobile || (N(), te(), O());
  }
  function z(e) {
   ...
   if (void 0 !== t) {
    ...
    if (((l.selectedDateElem = n), 'single' === l.config.mode))
     l.selectedDates = [a];
     ...
     'range' === l.config.mode &&
      (2 === l.selectedDates.length && l.clear(),
      l.selectedDates.push(a),
      0 !== g(a, l.selectedDates[0], !0) &&
       l.selectedDates.sort(function (e, t) {
    ...
    if (
      ...
      (1 === l.selectedDates.length
       ? (J(n),
         (l._hidePrevMonthArrow =
          l._hidePrevMonthArrow ||
          (void 0 !== l.minRangeDate &&
           l.minRangeDate > l.days.childNodes[0].dateObj)),
         (l._hideNextMonthArrow =
          l._hideNextMonthArrow ||
          (void 0 !== l.maxRangeDate &&
           l.maxRangeDate < new Date(l.currentYear, l.currentMonth + 1, 1))))
     ...
     var c = 'single' === l.config.mode && !l.config.enableTime,
      d =
       'range' === l.config.mode &&
       2 === l.selectedDates.length &&
       !l.config.enableTime;
     (c || d) &&
      (l._input.focus(),
      -1 !== window.navigator.userAgent.indexOf('MSIE') ||
      void 0 !== navigator.msMaxTouchPoints
       ? setTimeout(l.close, 0)
       : l.close());
    }
    I();
   }
  }
  (l.parseDate = m({ config: l.config, l10n: l.l10n })),
   (l._handlers = []),
   (l._bind = T),
   ...
   (l.clear = function (e) {
    void 0 === e && (e = !0);
    (l.input.value = ''), l.altInput && (l.altInput.value = '');
    ...
    l.redraw(), e && Q('onChange');
   }),
   (l.close = function () {
    (l.isOpen = !1),
     l.isMobile ||
      (l.calendarContainer.classList.remove('open'),
   ...
   (l.destroy = function () {
    ...
    (l._handlers = []),
     l.mobileInput
      ? (l.mobileInput.parentNode &&
         l.mobileInput.parentNode.removeChild(l.mobileInput),
        (l.mobileInput = void 0))
      : l.calendarContainer &&
        l.calendarContainer.parentNode &&
        l.calendarContainer.parentNode.removeChild(l.calendarContainer);
    l.altInput &&
     ((l.input.type = 'text'),
     l.altInput.parentNode && l.altInput.parentNode.removeChild(l.altInput),
     delete l.altInput);
    l.input &&
     ((l.input.type = l.input._type),
   ...
   (l.open = function (e, t) {
    ...
    (l.isOpen = !0),
     n ||
      (l.calendarContainer.classList.add('open'),
   ...
   return e
    .map(function (e) {
     return 'string' == typeof e || 'number' == typeof e || e instanceof Date
      ? l.parseDate(e, void 0, !0)
      : e && 'object' == typeof e && e.from && e.to
        ? { from: l.parseDate(e.from, void 0), to: l.parseDate(e.to, void 0) }
        : e;
    })
    .filter(function (e) {
     return e;
  ...
  function Q(e, t) {
   ...
   'onChange' === e &&
    (l.input.dispatchEvent(X('change')), l.input.dispatchEvent(X('input')));
  }
  function X(e) {
  ...
  function ee(e) {
   for (var t = 0; t < l.selectedDates.length; t++)
    if (0 === g(l.selectedDates[t], e)) return '' + t;
   return !1;
  }
  function te() {
   l.config.noCalendar ||
    l.isMobile ||
    !l.monthNav ||
    ((l.currentMonthElement.textContent =
     c(l.currentMonth, l.config.shorthandCurrentMonth, l.l10n) + ' '),
    (l.currentYearElement.value = l.currentYear.toString()),
    (l._hidePrevMonthArrow =
     void 0 !== l.config.minDate &&
     (l.currentYear === l.config.minDate.getFullYear()
      ? l.currentMonth <= l.config.minDate.getMonth()
      : l.currentYear < l.config.minDate.getFullYear())),
    (l._hideNextMonthArrow =
     void 0 !== l.config.maxDate &&
     (l.currentYear === l.config.maxDate.getFullYear()
      ? l.currentMonth + 1 > l.config.maxDate.getMonth()
      : l.currentYear > l.config.maxDate.getFullYear())));
  }
  function ne(e) {
   if ((void 0 === e && (e = !0), !l.selectedDates.length)) return l.clear(e);
   void 0 !== l.mobileInput &&
    l.mobileFormatStr &&
    (l.mobileInput.value =
     void 0 !== l.latestSelectedDateObj
      ? l.formatDate(l.latestSelectedDateObj, l.mobileFormatStr)
      : '');
   var t =
    'range' !== l.config.mode ? l.config.conjunction : l.l10n.rangeSeparator;
   (l.input.value = l.selectedDates
    .map(function (e) {
     return l.formatDate(e, l.config.dateFormat);
    })
    .join(t)),
    void 0 !== l.altInput &&
     (l.altInput.value = l.selectedDates
      .map(function (e) {
  ...
  function ae(e) {
   ...
   t || n
    ? F(t ? -1 : 1)
    : e.target === l.currentYearElement
      ? l.currentYearElement.select()
      : e.target.classList.contains('arrowUp')
        ? l.changeYear(l.currentYear + 1)
    ...
    (l.element = l.input = e),
     ...
     (function () {
      ...
      (l.config.parseDate = i.parseDate),
       ...
       !i.dateFormat &&
        i.enableTime &&
        (c.dateFormat = i.noCalendar
         ? 'H:i' + (i.enableSeconds ? ':S' : '')
         : w.defaultConfig.dateFormat + ' H:i' + (i.enableSeconds ? ':S' : '')),
       i.altInput &&
        i.enableTime &&
        !i.altFormat &&
        (c.altFormat = i.noCalendar
         ? 'h:i' + (i.enableSeconds ? ':S K' : ' K')
         : w.defaultConfig.altFormat +
           ' h:i' +
           (i.enableSeconds ? ':S' : '') +
           ' K'),
      ...
      for (var u = a.length; u--; )
       void 0 !== l.config[a[u]] &&
        (l.config[a[u]] = o(l.config[a[u]] || []).map(s));
      'time' === l.config.mode &&
       ((l.config.noCalendar = !0), (l.config.enableTime = !0));
      for (var u = 0; u < l.config.plugins.length; u++) {
       var f = l.config.plugins[u](l) || {};
       for (var m in f)
        ~a.indexOf(m)
         ? (l.config[m] = o(f[m]).map(s).concat(l.config[m]))
         : void 0 === i[m] && (l.config[m] = f[m]);
      }
      (l.isMobile =
       !l.config.disableMobile &&
       !l.config.inline &&
       'single' === l.config.mode &&
       !l.config.disable.length &&
       !l.config.enable.length &&
     ...
     l.input
      ? ((l.input._type = l.input.type),
        ...
        l.config.altInput &&
         ((l.altInput = D(
          l.input.nodeName,
          l.input.className + ' ' + l.config.altInputClass,
         )),
         (l._input = l.altInput),
         ...
         !l.config.static &&
          l.input.parentNode &&
          l.input.parentNode.insertBefore(l.altInput, l.input.nextSibling)),
        l.config.allowInput || l._input.setAttribute('readonly', 'readonly'),
        (l._positionElement = l.config.positionElement || l._input))
      : l.config.errorHandler(new Error('Invalid input element specified')),
     (function () {
      (l.selectedDates = []), (l.now = new Date());
      var e = l.config.defaultDate || l.input.value;
      e && V(e, l.config.dateFormat);
      var t = l.selectedDates.length
       ? l.selectedDates[0]
       : l.config.minDate && l.config.minDate.getTime() > l.now.getTime()
         ? l.config.minDate
         : l.config.maxDate && l.config.maxDate.getTime() < l.now.getTime()
           ? l.config.maxDate
           : l.now;
      (l.currentYear = t.getFullYear()),
       ...
       void 0 !== l.config.minTime &&
        (l.config.minTime = l.parseDate(l.config.minTime, 'H:i')),
       void 0 !== l.config.maxTime &&
        (l.config.maxTime = l.parseDate(l.config.maxTime, 'H:i')),
       (l.minDateHasTime =
        !!l.config.minDate &&
        (l.config.minDate.getHours() > 0 ||
         l.config.minDate.getMinutes() > 0 ||
         l.config.minDate.getSeconds() > 0)),
       (l.maxDateHasTime =
        !!l.config.maxDate &&
        (l.config.maxDate.getHours() > 0 ||
         l.config.maxDate.getMinutes() > 0 ||
         l.config.maxDate.getSeconds() > 0)),
       ...
       if (
        ...
        return (
         ...
         a < 6
          ...
          : a < 11
            ? 30
            : (682 * (((n - (n > 0 ? 474 : 473)) % 2820) + 474 + 38)) % 2816 <
                682
              ? 30
              : 29
        );
     ...
     l.isMobile ||
      (function () {
       ...
       if (
        ((l.calendarContainer = D('div', 'flatpickr-calendar')),
        ...
        if (
         (e.appendChild(
          (function () {
           ...
           var t = b('cur-year', { tabindex: '-1' });
           return (
            (l.currentYearElement = t.childNodes[0]),
            l.config.minDate &&
             l.currentYearElement.setAttribute(
              'data-min',
              l.config.minDate.getFullYear().toString(),
             ),
            l.config.maxDate &&
             (l.currentYearElement.setAttribute(
              'data-max',
              l.config.maxDate.getFullYear().toString(),
             ),
             (l.currentYearElement.disabled =
              !!l.config.minDate &&
              l.config.minDate.getFullYear() ===
               l.config.maxDate.getFullYear())),
            ...
            Object.defineProperty(l, '_hidePrevMonthArrow', {
             ...
             set: function (e) {
              l.__hidePrevMonthArrow !== e &&
               (l.prevMonthNav.style.display = e ? 'none' : 'block'),
               (l.__hidePrevMonthArrow = e);
             },
            }),
            Object.defineProperty(l, '_hideNextMonthArrow', {
             ...
             set: function (e) {
              l.__hideNextMonthArrow !== e &&
               (l.nextMonthNav.style.display = e ? 'none' : 'block'),
               (l.__hideNextMonthArrow = e);
             },
            }),
            te(),
         ...
         var t = (function () {
           ...
           e.appendChild(
            D('span', 'flatpickr-weekday', l.l10n.weekAbbreviation),
           );
        ...
        (l.rContainer = D('div', 'flatpickr-rContainer')),
         ...
         l.daysContainer ||
          ((l.daysContainer = D('div', 'flatpickr-days')),
        ...
        e.appendChild(
         (function () {
          l.calendarContainer.classList.add('hasTime'),
           l.config.noCalendar &&
            l.calendarContainer.classList.add('noCalendar'),
          ...
          if (
           ((l.minuteElement = i.childNodes[0]),
           (l.hourElement.tabIndex = l.minuteElement.tabIndex = -1),
           (l.hourElement.value = n(
            l.latestSelectedDateObj
             ? l.latestSelectedDateObj.getHours()
             : l.config.time_24hr
               ? l.config.defaultHour
               : (function (e) {
                  switch (e % 24) {
           ...
           (l.minuteElement.value = n(
            l.latestSelectedDateObj
             ? l.latestSelectedDateObj.getMinutes()
             : l.config.defaultMinute,
           )),
           l.hourElement.setAttribute(
            'data-step',
            l.config.hourIncrement.toString(),
           ),
           l.minuteElement.setAttribute(
            'data-step',
            l.config.minuteIncrement.toString(),
           ),
           l.hourElement.setAttribute(
            'data-min',
            l.config.time_24hr ? '0' : '1',
           ),
           l.hourElement.setAttribute(
            'data-max',
            l.config.time_24hr ? '23' : '12',
           ),
           ...
           (l.secondElement = o.childNodes[0]),
            (l.secondElement.value = n(
             l.latestSelectedDateObj
              ? l.latestSelectedDateObj.getSeconds()
              : l.config.defaultSeconds,
            )),
            l.secondElement.setAttribute(
             'data-step',
             l.minuteElement.getAttribute('data-step'),
            ),
            l.secondElement.setAttribute(
             'data-min',
             l.minuteElement.getAttribute('data-min'),
            ),
            l.secondElement.setAttribute(
             'data-max',
             l.minuteElement.getAttribute('data-max'),
            ),
            l.timeContainer.appendChild(
       ...
       var r =
        void 0 !== l.config.appendTo && void 0 !== l.config.appendTo.nodeType;
       if (
        (l.config.inline || l.config.static) &&
        (l.calendarContainer.classList.add(
         l.config.inline ? 'inline' : 'static',
        ),
        l.config.inline &&
         (!r && l.element.parentNode
          ? l.element.parentNode.insertBefore(
             l.calendarContainer,
             l._input.nextSibling,
            )
          : void 0 !== l.config.appendTo &&
            l.config.appendTo.appendChild(l.calendarContainer)),
        l.config.static)
       ) {
       ...
       l.config.static ||
        ...
        ).appendChild(l.calendarContainer);
      })(),
     (function () {
      if (
       (l.config.wrap &&
        ['open', 'close', 'toggle', 'clear'].forEach(function (e) {
         Array.prototype.forEach.call(
          l.element.querySelectorAll('[data-' + e + ']'),
          function (t) {
       ...
       !(function () {
        ...
        (l.mobileInput = D('input', l.input.className + ' flatpickr-mobile')),
         ...
         l.selectedDates.length &&
          (l.mobileInput.defaultValue = l.mobileInput.value =
           l.formatDate(l.selectedDates[0], l.mobileFormatStr)),
         l.config.minDate &&
          (l.mobileInput.min = l.formatDate(l.config.minDate, 'Y-m-d')),
         l.config.maxDate &&
          (l.mobileInput.max = l.formatDate(l.config.maxDate, 'Y-m-d')),
         (l.input.type = 'hidden'),
         void 0 !== l.altInput && (l.altInput.type = 'hidden');
        try {
         l.input.parentNode &&
          l.input.parentNode.insertBefore(l.mobileInput, l.input.nextSibling);
        } catch (e) {}
       ...
       (l._debouncedChange = i(I, M)),
        l.daysContainer &&
         ...
         T(l.daysContainer, 'mouseover', function (e) {
        ...
        T(window.document, 'focus', H, { capture: !0 }),
        !0 === l.config.clickOpens &&
         (T(l._input, 'focus', l.open), T(l._input, 'mousedown', k(l.open))),
        void 0 !== l.daysContainer &&
         (T(l.monthNav, 'mousedown', k(ae)),
         T(l.monthNav, ['keyup', 'increment'], E),
         T(l.daysContainer, 'mousedown', k(z))),
        void 0 !== l.timeContainer &&
         void 0 !== l.minuteElement &&
         void 0 !== l.hourElement &&
         (T(l.timeContainer, ['input', 'increment'], h),
         ...
         void 0 !== l.secondElement &&
          T(l.secondElement, 'focus', function () {
     ...
     (l.selectedDates.length || l.config.noCalendar) &&
      (l.config.enableTime &&
       y(
        l.config.noCalendar
         ? l.latestSelectedDateObj || l.config.minDate
         : void 0,
       ),
      ne(!1)),
     (l.showTimeInput = l.selectedDates.length > 0 || l.config.noCalendar),
     void 0 !== l.weekWrapper &&
      void 0 !== l.daysContainer &&
      ((l.calendarContainer.style.visibility = 'hidden'),
      (l.calendarContainer.style.display = 'block'),
      (l.calendarContainer.style.width =
       l.daysContainer.offsetWidth + l.weekWrapper.offsetWidth + 'px'),
 ...
 'undefined' != typeof HTMLElement &&
  ...
  (w = function (e, t) {
   return e instanceof NodeList
    ? y(e, t)
    : y('string' == typeof e ? window.document.querySelectorAll(e) : [e], t);
  }),
  'object' == typeof window && (window.flatpickr = w),
  (w.defaultConfig = h),
  (w.l10ns = { en: t({}, u), default: t({}, u) }),
