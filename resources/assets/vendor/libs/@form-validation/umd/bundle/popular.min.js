       ...
       [].slice
        ...
        .forEach(function (i) {
         ...
         if (!e.isEmptyOption(r)) {
          var o =
           i.getAttribute('name') || i.getAttribute(''.concat(t, 'field'));
   ...
   i = (function (e) {
    ...
    return (
     ...
     (i.defaultIgnore = function (e, t, n) {
      ...
      return (
       '' === r || 'disabled' === r || 'hidden' === t.getAttribute('type') || !i
      );
     }),
    ...
    return (
     ...
     (i.prototype.onValidatorValidated = function (e) {
      var t,
       ...
       o =
        ('radio' === r || 'checkbox' === r) && i.length > 0 ? i[0] : e.element;
   ...
   (Dt.stringLength = function () {
    return {
     validate: function (e) {
      ...
      switch (
       (((o && s < parseInt(o, 10)) || (a && s > parseInt(a, 10))) && (l = !1),
       !0)
      ) {
       case !!o && !!a:
        d = t(e.l10n ? i.message || e.l10n.stringLength.between : i.message, [
         o,
         a,
        ]);
        break;
