...
(function (global, factory) {
 ...
 var i = /*#__PURE__*/ (function (_e) {
  ...
  function i(e) {
   ...
   _this.fieldResetHandler = _this.onResetField.bind(
    _assertThisInitialized(_this),
   );
   _this.preValidateFilter = _this.preValidate.bind(
    _assertThisInitialized(_this),
   );
  ...
  _createClass(i, [
   {
    ...
    value: function install() {
     ...
     var e =
      typeof window[i.LOADED_CALLBACK] === 'undefined'
       ? function () {}
       ...
       validators: {
        promise: {
         ...
         promise: function promise(e) {
          var s = _this2.widgetIds.has(_this2.opts.element)
           ? window['grecaptcha'].getResponse(
              _this2.widgetIds.get(_this2.opts.element),
             )
           : e.value;
