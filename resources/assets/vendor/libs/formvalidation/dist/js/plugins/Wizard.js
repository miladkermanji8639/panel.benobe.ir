...
(function (global, factory) {
 ...
 var i = /*#__PURE__*/ (function (_t) {
  ...
  function i(t) {
   ...
   _this.prevStepHandler = _this.onClickPrev.bind(
    _assertThisInitialized(_this),
   );
   _this.nextStepHandler = _this.onClickNext.bind(
    _assertThisInitialized(_this),
   );
   return _this;
  }
     ...
     this.prevButton =
      typeof this.opts.prevButton === 'string'
       ? this.opts.prevButton.substring(0, 1) === '#'
         ...
         : t.querySelector(this.opts.prevButton)
     ...
     this.nextButton =
      typeof this.opts.nextButton === 'string'
       ? this.opts.nextButton.substring(0, 1) === '#'
         ...
         : t.querySelector(this.opts.nextButton)
     ...
     this.core.validate().then(function (t) {
      if (t === 'Valid') {
       ...
       if (_t2 >= _this4.numSteps) {
        ...
        var _e3 = _this4.opts.isStepSkipped
         ? _this4.stepIndexes.slice(_t2, _this4.numSteps).find(function (t, e) {
   ...
   },
   {
    ...
    value: function goToStep(t) {
     e(
      ...
      _defineProperty({}, this.opts.activeStepClass, false),
     );
