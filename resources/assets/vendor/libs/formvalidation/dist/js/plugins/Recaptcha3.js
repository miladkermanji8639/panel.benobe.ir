  ...
  _createClass(s, [
   {
    ...
    value: function install() {
     ...
     var e =
      typeof window[s.LOADED_CALLBACK] === 'undefined'
       ? function () {}
           ...
           window['grecaptcha']
            ...
            .then(function (o) {
             t(_this2.opts.backendVerificationUrl, {
              ...
              .then(function (t) {
               var _s =
                ''.concat(t.success) === 'true' &&
                t.score >= _this2.opts.minimumScore;
   ...
   },
   {
    ...
    value: function getScript() {
     ...
     return (
      ...
      'onload='
       .concat(s.LOADED_CALLBACK, '&render=')
