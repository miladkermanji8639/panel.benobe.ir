        ...
        <div class="wrapper-md">
          <form method="post"
            ...
            <div class="panel panel-default"
              ...
              <div class="panel-heading">افزودن صفحه جدید</div>
              <div class="panel-body">

                <div class="form-group mt-3">
                  <label class="control-label col-lg-2">آدرس صفحه URL: <span class="red">*</span></label>
                  <div class="col-lg-12">
                    <input type="text"
                           class="form-control "
                           style=""
                ...
                <div class="form-group mt-3">
                  <label class="control-label col-lg-2">عنوان: <span class="red">*</span></label>
                  <div class="col-lg-12">
                    <input type="text"
                           class="form-control "
                           style=""
                ...
                <div class="form-group mt-3"><label class="control-label col-lg-2">تصویر</label>
                  <div class="col-lg-12">
                    <div class="input-group">
                      <input type="text"
                           ...
                           class="btngroup btn btn-primary"><i class="fa fa-file"></i> انتخاب فایل</a></span>
                    </div>
                  </div>
                </div>
                <div class="form-group mt-3"><label class="control-label col-lg-2">توضیحات</label>
                  <div class="col-lg-12"><textarea name="lead"
                              class="form-control"
                            ...
                            style="height: auto; user-select: none;"><span id="cke_8"
                              ...
                              onmousedown="return false;"><span id="cke_11"
                                ...
                                role="toolbar"><span id="cke_39_label"
                                 ...
                                 aria-disabled="true"><span class="cke_button_icon cke_button__indent_icon"
                                 ...
                                 class="cke_button cke_button__bidirtl cke_button_on"
                                 ...
                                 aria-pressed="true"><span class="cke_button_icon cke_button__bidirtl_icon"
                                ...
                                role="toolbar"><span id="cke_47_label"
                                 ...
                                 onclick="CKEDITOR.tools.callFunction(89,this);return false;"><span id="cke_10_text"
                                      class="cke_combo_text">معمولی</span><span class="cke_combo_open"><span
                      ...
                      <div id="cke_1_contents"
                           ...
                           style="height: 300px;"><span id="cke_54"
                            ...
                            style="user-select: none;"><span id="cke_1_resizer"
                              ...
                              class="cke_path"
                              role="group"
                              aria-labelledby="cke_1_path_label"><a id="cke_elementspath_7_1"
                             href="javascript:void('body')"
                             tabindex="-1"
                             class="cke_path_item"
                             title="body عنصر"
                             hidefocus="true"
                             onkeydown="return CKEDITOR.tools.callFunction(96,1, event );"
                             onclick="CKEDITOR.tools.callFunction(95,1); return false;"
                             role="button"
                             aria-label="body عنصر">body</a><a id="cke_elementspath_7_0"
                             href="javascript:void('p')"
                             tabindex="-1"
                             class="cke_path_item"
                             title="p عنصر"
                             hidefocus="true"
                             onkeydown="return CKEDITOR.tools.callFunction(96,0, event );"
                             onclick="CKEDITOR.tools.callFunction(95,0); return false;"
                             role="button"
                             aria-label="p عنصر">p</a><span class="cke_path_empty">&nbsp;</span></span></span>
                    </div>
                  </div>
                  <script>
                ...
                <div class="form-group mt-3">
                  <label class="control-label col-lg-2">انتشار:</label>
                  <div class="col-lg-12">
                    <select name="approve"
                            class="form-control ">
                      <option value="1"
                ...
                <div class="form-group mt-3">
                  <label class="control-label col-lg-2">قالب جداگانه:</label>
                  <div class="col-lg-12">
                    <div class="input-group">
                      <span class="input-group-addon ltr">.tpl</span>
                      <input type="text"
                             class="form-control ltr text-right"
                             name="tplname">
                    </div>
                  </div>
                </div>
