  ...
  <div class="subuser-cards mt-4">
   @for ($i = 0; $i < 2; $i++)
    <div class="subuser-card p-3 w-100 d-flex justify-content-between align-items-end">
     <div>
      <span class="d-block font-weight-bold text-dark"> مطب آفتاب</span>
      <span class="font-size-13 font-weight-bold">
       شهر: <span>دهگلان</span>
      </span>
      <span class="font-size-13 mx-2 font-weight-bold">
       آدرس:خیابان استقلال ، کوچه نیلوفر ، طبقه همکف دندانپزشکی دکتر احمدی
      </span>
     </div>
     <div>
      <div class="d-flex  gap-4">
        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
         <div class="modal-content border-radius-8">
          <div class="modal-header">
           <h5 class="modal-title" id="exampleModalLongTitle"> ویرایش مطب </h5>
          ...
          <div class="modal-body">
           <div>
            <form action="" method="post">
             <div class="d-flex flex-column mt-2">
              <div class="position-relative d-flex gap-4 w-100">
               <div class="position-relative w-100">
                <label class="label-top-input-special-takhasos" for="date">نام مطب: </label>
                <input type="text" id="date" class="form-control h-50 w-100 ">
               </div>
               <div class="position-relative w-100">
                <label class="label-top-input-special-takhasos" for="date"> انتخاب شهر: </label>
                <select name="" id="" class="form-control h-50 w-100" disabled>
                 <option selected value="">دهگلان</option>
                </select>
               </div>
              </div>
             </div>
             ...
             <div class="w-100 position-relative mt-4">
              <label for="" class="label-top-input-special-takhasos"> آدرس: </label>

              <textarea name="" class="form-control h-50 w-100" placeholder="آدرس" id="" cols="30" rows="10"></textarea>
             </div>
             <div class="w-100 position-relative mt-4">
              <label for="" class="label-top-input-special-takhasos">توضیحات: </label>

              <textarea name="" class="form-control h-50 w-100" placeholder="توضیحات" id="" cols="30" rows="10"></textarea>
             </div>
             <script>
             ...
             <div class="w-100">
              <button class="btn btn-primary  w-100 h-50 mt-3">ویرایش مطب</button>
             </div>
            </form>
           </div>
          </div>
       ...
       <script>
        function deleteVacationConfirm() {
         Swal.fire({
          title: 'حذف مطب',
          text: 'آیا از حذف مطب  اطمینان دارید؟',
          icon: 'warning',
   ...
   <div class="w-100 d-flex justify-content-center mt-3">
    <button class="btn btn-primary h-50" data-toggle="modal" data-target="#exampleModalCenterAddSubuser">افزودن مطب
     جدید</button>
