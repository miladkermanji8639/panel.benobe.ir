...
<head>
 ...
 @yield('styles')
 <title>
  پنل {{ Auth::guard('doctor')->user()->user_type == 1 ? 'منشی' : 'دکتر' }} | به نوبه
 </title>
</head>
<body>
   ...
   <div class="d-flex align-items-center">
    <div class="my-tooltip mx-2">
     <svg data-toggle="tooltip" data-placement="bottom"
      ...
      viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="hidden lg:block svg-help" color="#3f4079"
      ...
      <path d="M7.9955 12.0692H8.0045" stroke="#3f4079" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
      <circle cx="8" cy="8.99445" r="7.25" stroke="#3f4079" stroke-width="1.5"></circle>
     </svg>
    </div>
    <div class="">
     <div class="dropdown">
      <div class="dropdown-trigger btn  h-40 w-300 bg-light-blue text-left d-flex justify-content-between align-items-center"
