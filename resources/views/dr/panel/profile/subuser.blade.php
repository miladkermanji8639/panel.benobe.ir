  ...
  <div class="subuser-content-wrapper p-3">
   ...
   <div class="subuser-cards mt-4">
            ...
            <div>
             <form action="" method="post">
              ...
              <div class="form-check">
               ...
               <label class="form-check-label" for="full-day-vacation-edit"> اتباع خارجی</label>
              </div>
              ...
              <div class="w-100">
               <button class="btn btn-primary  w-100 h-50 mt-3">ویرایش کاربر</button>
              </div>
             </form>
            </div>
           </div>
    ...
    <div class="w-100 d-flex justify-content-center mt-3">
     <button class="btn btn-primary h-50" data-toggle="modal" data-target="#exampleModalCenterAddSubuser">افزودن کاربر
      جدید</button>
           ...
           <div class="modal-body">
            <div>
             <form action="" method="post">
              ...
              <div class="w-100">
               <button class="btn btn-primary  w-100 h-50 mt-3">افزودن کاربر</button>
              </div>
             </form>
            </div>
           </div>
