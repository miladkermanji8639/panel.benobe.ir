...
<div class="w-100 d-flex justify-content-center" dir="ltr">
 <div class="auto-scheule-content-top ">
  <x-my-toggle-appointment :isChecked="true" id="appointment-toggle" day="نوبت دهی خودکار" />
 </div>
</div>
 ...
 <div class="workhours-wrapper-content p-3">
  <div>
     ...
     <div>
      <div class="input-group position-relative mx-2">
       ...
       <input type="text" value="" class="form-control   text-center h-50 border-radius-0"
        name="appointment-count" placeholder="تعداد روز مورد نظر خود را وارد کنید">
       <div class="input-group-append count-span-prepand-style"><span class="input-group-text px-2">روز</span></div>
      </div>
     </div>
     <label class="text-dark font-weight-bold mt-3">برنامه نوبت ها</label>
     <div class="mt-2">
   ...
   <div class="d-flex w-100 justify-content-end mt-3">
    <button class="btn btn-primary h-50 w-100" tabindex="0" type="button" id=":rs:">ثبت تغییرات<span></span>
    </button>
   </div>
   <hr>
   @if (isset($_GET['activation-path']) && $_GET['activation-path'] == true)
    <div class="w-100">
     <button class="btn btn-outline-primary w-100 h-50" tabindex="0" type="button" id=":rs:" data-toggle="modal"
      data-target="#activation-modal">پایان فعالسازی<span></span>
     </button>
    </div>
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content border-radius-8">
       ...
       <div class="modal-body">
        <div>
         <p>اطلاعات شما ثبت شد و ویزیت آنلاین شما تا ساعاتی دیگر فعال می‌شود. بیماران می‌توانند مستقیماً از طریق پروفایل
          شما
          ویزیت آنلاین رزرو کنند.</p>
         ...
         <p>برای هر گونه سوال یا توضیح بیشتر، لطفا با ما <a style="color: blue"
          ...
          اینجاست تا
          از شما در هر مرحله حمایت کند.</p>
        </div>
       </div>
       <div class="p-3">
