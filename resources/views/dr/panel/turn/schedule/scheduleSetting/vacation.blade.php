...
@section('styles')
 ...
 <link type="text/css" href="{{ asset('dr-assets/panel/css/turn/schedule/scheduleSetting/vacation.css') }}" rel="stylesheet" />
@endsection
@section('site-header')
 {{ 'به نوبه | پنل دکتر' }}
@endsection
   ...
   <div class="">
    <div class="muirtl-60hgb7">
     <div class="" role="alert">
      <div class="">
       ...
       <p class="alert alert-warning font-size-13 font-weight-bold">شما می توانید برای ساعاتی که طبق ساعت کاری خود حضور ندارید،
        مرخصی اعمال کنید.</p>
       <div class="w-100">
        <button data-toggle="modal" data-target="#exampleModalCenterAddVacation" class="h-50 w-100 btn btn-outline-primary"
         tabindex="0" type="button" id=":r18:">اضافه کردن مرخصی<span class=""></span>
        </button>
             ...
             <form action="" method="post">
              <div class="d-flex flex-column">
               <div class="form-group position-relative">
                <label class="label-top-input-special-takhasos" for="date">تاریخ:</label>
                <input type="text" id="date" class="form-control observer-example h-50 w-100" readonly>
               </div>
               <div class="d-flex justify-content-between gap-4">
                <div class="form-group position-relative w-100 hide-show-input">
                 <label for="start-time" class="label-top-input-special-takhasos"> از ساعت: </label>
                 <input type="time" id="start-time" class="form-control h-50 w-100">
                </div>
                <div class="form-group position-relative w-100 hide-show-input">
                 <label for="end-time" class="label-top-input-special-takhasos"> تا ساعت: </label>
                 <input type="time" id="end-time" class="form-control h-50 w-100">
                </div>
               </div>
              </div>
              <div class="form-check">
               <input type="checkbox" class="form-check-input" id="full-day-vacation">
               <label class="form-check-label" for="full-day-vacation">ثبت مرخصی برای تمام روز</label>
              </div>

              <script>
               $(document).ready(function() {
                $('#full-day-vacation').change(function() {
                 if ($(this).is(':checked')) {
                  $('.hide-show-input').addClass('d-none');
                 } else {
                  $('.hide-show-input').removeClass('d-none');
                 }
                });
               });
              </script>
              ...
              <div class="w-100">
               <button class="btn btn-primary disabled w-100 h-50 mt-3" disabled>ثبت مرخصی</button>
              </div>
             </form>
            </div>
           </div>
    ...
    <div class="">
     <div class="d-flex flex-column w-100 gap-4 mt-3">
       ...
       <div>
        <form action="" method="post">
         <div class="d-flex gap-4">
          <div>
           <select name="" id="" class="form-control h-50">
      ...
      <div class="vacation-list d-flex justify-content-center  mt-3">
       <div class="nothing-vacation w-100 d-flex  justify-content-center ">
        <div class="d-none">
         <span class="font-weight-bold text-dark">مرخصی وجود ندارد</span>
        </div>
        <div class="has-list-vacation w-100 bg-white d-flex justify-content-between align-items-center p-2 h-24">
         <div class="d-flex flex-column gap-4 mt-2">
          <span class="text-dark font-weight-bold d-block font-size-13">سه‌شنبه 13 آذر-00:00 الی سه‌شنبه 13
           آذر-03:01</span>
          <span class="text-start text-black font-size-13">مدت زمان: 3 ساعت</span>
         </div>
         <div>
          <div class="d-flex flex-column align-items-center gap-4">
           <button data-toggle="modal" data-target="#exampleModalCenterEditVacation"
           ...
           <div class="modal fade " id="exampleModalCenterEditVacation" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered " role="document">
             <div class="modal-content border-radius-8">
              <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLongTitle"> ویرایش مرخصی </h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
               </button>
              </div>
              <div class="modal-body">
               <div>
                <form action="" method="post">
                 ...
                 <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="full-day-vacation-edit">
                  <label class="form-check-label" for="full-day-vacation-edit">ثبت مرخصی برای تمام روز</label>
                 </div>
                 ...
                 <div class="w-100">
                  <button class="btn btn-primary disabled w-100 h-50 mt-3" disabled>ویرایش مرخصی</button>
                 </div>
                </form>
               </div>
              </div>
           ...
           <script>
            function deleteVacationConfirm() {
             Swal.fire({
              title: 'حذف مرخصی',
              text: 'آیا از حذف مرخصی خود اطمینان دارید؟',
              icon: 'warning',
