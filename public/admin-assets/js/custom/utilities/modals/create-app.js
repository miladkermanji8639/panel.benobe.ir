   ...
   (e = document.querySelector('#kt_modal_create_app')) &&
    ...
    n.push(
     FormValidation.formValidation(o, {
      fields: {
       name: { validators: { notEmpty: { message: 'نام اپ اجباری است' } } },
       category: { validators: { notEmpty: { message: 'دسته بندی اجباری' } } },
      },
      plugins: {
    ...
    n.push(
     FormValidation.formValidation(o, {
      fields: {
       framework: {
        validators: { notEmpty: { message: 'انتخاب فریمورک اجباری' } },
       },
      },
      plugins: {
       trigger: new FormValidation.plugins.Trigger(),
    ...
    n.push(
     FormValidation.formValidation(o, {
      fields: {
       dbname: { validators: { notEmpty: { message: 'نام دییتابیس اجباری' } } },
       dbengine: {
        validators: {
         notEmpty: { message: 'موتور پایگاه داده مورد نیاز است' },
        },
       },
      },
      plugins: {
    ...
    n.push(
     FormValidation.formValidation(o, {
      fields: {
       ...
       card_expiry_year: {
        validators: { notEmpty: { message: 'سال اجباری' } },
       },
       card_cvv: {
        validators: {
