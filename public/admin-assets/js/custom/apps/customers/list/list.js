...
var KTCustomersList = (function () {
 var t,
  ...
  n,
  c = () => {
   n.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach(
    (e) => {
  ...
  r = () => {
   ...
   e.forEach((t) => {
    ...
    o.addEventListener('click', function () {
     Swal.fire({
      text: 'آیا مطمئن هستید که می خواهید مشتریان انتخابی را حذف کنید؟',
      icon: 'warning',
      showCancelButton: !0,
      buttonsStyling: !1,
      confirmButtonText: 'بله، حذف!',
      ...
      o.value
       ? Swal.fire({
          text: 'شما همه مشتریان انتخابی را حذف کرده اید!.',
          icon: 'success',
          buttonsStyling: !1,
          confirmButtonText: 'باشه فهمیدم!',
          customClass: { confirmButton: 'btn fw-bold btn-primary' },
       ...
       : 'cancel' === o.dismiss &&
         Swal.fire({
          text: 'مشتریان انتخابی حذف نشدند.',
          icon: 'error',
          buttonsStyling: !1,
          confirmButtonText: 'باشه فهمیدم!',
          customClass: { confirmButton: 'btn fw-bold btn-primary' },
