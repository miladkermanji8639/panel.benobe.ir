 ...
 const l = () => {
   t.querySelectorAll(
    ...
    t.addEventListener('click', function (t) {
     ...
     Swal.fire({
      text: 'آیا مطمئنید که میخواهید حذف کنید ' + n + '?',
      icon: 'warning',
      showCancelButton: !0,
      buttonsStyling: !1,
  ...
  i = () => {
   ...
   o.forEach((e) => {
    ...
    n.addEventListener('click', function () {
     Swal.fire({
      text:
       'آیا مطمئن هستید که می خواهید فایل ها یا پوشه های انتخاب شده را حذف کنید',
      icon: 'warning',
      showCancelButton: !0,
      buttonsStyling: !1,
      confirmButtonText: 'بله، حذف!',
      ...
      n.value
       ? Swal.fire({
          text: 'شما حذف کرده اید همه فایل ها یا پوشه های انتخاب شده!',
          icon: 'success',
          buttonsStyling: !1,
          confirmButtonText: 'باشه فهمیدم!',
          customClass: { confirmButton: 'btn fw-bold btn-primary' },
       ...
       : 'cancel' === n.dismiss &&
         Swal.fire({
          text: 'فایل ها یا پوشه های انتخاب شده حذف نشدند.',
          icon: 'error',
          buttonsStyling: !1,
          confirmButtonText: 'باشه فهمیدم!',
          customClass: { confirmButton: 'btn fw-bold btn-primary' },
  ...
  u = (o) => {
   ...
   if (
    ...
    return void Swal.fire({
     text: 'ورودی ذخیره نشده شناسایی شد. لطفاً مورد فعلی را ذخیره یا لغو کنید',
     icon: 'warning',
     buttonsStyling: !1,
     confirmButtonText: 'باشه فهمیدم!',
   ...
   var c = FormValidation.formValidation(l, {
    fields: {
     rename_folder_name: {
      validators: { notEmpty: { message: 'نام الزامی است' } },
     },
    },
    plugins: {
       ...
       c.validate().then(function (t) {
        console.log('validated!'),
         'Valid' == t &&
          Swal.fire({
           text:
            'آیا مطمئن هستید که می خواهید نام خود را تغییر دهید ' + r + '?',
           icon: 'warning',
           showCancelButton: !0,
           buttonsStyling: !1,
   ...
   (t = document.querySelector('#kt_file_manager_list')) &&
    ...
    document
     ...
     .addEventListener('click', (n) => {
      if (
       (n.preventDefault(), t.querySelector('#kt_file_manager_new_folder_row'))
      )
       return;
      ...
      var p = FormValidation.formValidation(s, {
       fields: {
        new_folder_name: {
         validators: { notEmpty: { message: 'نام پوشه الزامی است' } },
        },
       },
       plugins: {
        trigger: new FormValidation.plugins.Trigger(),
       ...
       .addEventListener('click', function () {
        r.files.forEach((e) => {
         ...
         var o = 1,
          n = setInterval(function () {
           o >= 100
            ? (r.emit('success', e), r.emit('complete', e), clearInterval(n))
            : (o++, (t.style.width = o + '%'));
          }, 20);
        });
       }),
    ...
    (() => {
     ...
     var r = FormValidation.formValidation(t, {
      fields: {
       move_to_folder: {
        validators: { notEmpty: { message: 'لطفا یک پوشه را انتخاب کنید.' } },
       },
      },
      plugins: {
       trigger: new FormValidation.plugins.Trigger(),
        ...
        r.validate().then(function (e) {
         console.log('validated!'),
          'Valid' == e
           ? setTimeout(function () {
              Swal.fire({
               text: 'آیا مطمئن هستید که می خواهید به این پوشه منتقل شوید',
               icon: 'warning',
               showCancelButton: !0,
               buttonsStyling: !1,
