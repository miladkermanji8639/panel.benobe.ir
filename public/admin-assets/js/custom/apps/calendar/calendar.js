...
var KTAppCalendar = (function () {
 ...
 const x = () => {
   (v.innerText = 'یک رویداد جدید اضافه کنید'), u.show();
          ...
          ? (D.setAttribute('data-kt-indicator', 'on'),
            ...
            setTimeout(function () {
             D.removeAttribute('data-kt-indicator'),
              Swal.fire({
               text: 'رویداد جدید به تقویم اضافه شد!',
               icon: 'success',
               buttonsStyling: !1,
                  ...
                  if (o.isConfirmed) {
                   ...
                   if (!o) {
                    const e = moment(r.selectedDates[0]).format('YYYY-MM-DD'),
                     t = e;
                    (d =
                     e + 'T' + moment(c.selectedDates[0]).format('HH:mm:ss')),
                     (s =
                      t + 'T' + moment(m.selectedDates[0]).format('HH:mm:ss'));
                   }
                   e.addEvent({
                    id: A(),
                    title: t.value,
   ...
   (w = new bootstrap.Modal(H)),
    ...
    (e = new FullCalendar.Calendar(F, {
     ...
     events: [
      ...
      {
       id: A(),
       title: 'اکسپوی ICT 2021 - عرضه محصول',
       start: I + '-03',
       description: 'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ',
       end: I + '-05',
    ...
    (p = FormValidation.formValidation(f, {
     fields: {
      calendar_event_name: {
       validators: { notEmpty: { message: 'نام رویداد الزامی است' } },
      },
      calendar_event_start_date: {
       validators: { notEmpty: { message: 'تاریخ شروع الزامی است' } },
      },
      calendar_event_end_date: {
       validators: { notEmpty: { message: 'تاریخ پایان الزامی است' } },
      },
     },
     plugins: {
    ...
    E.addEventListener('click', (t) => {
     t.preventDefault(),
      Swal.fire({
       text: 'آیا مطمئن هستید که می خواهید این رویداد را حذف کنید؟',
       icon: 'warning',
       showCancelButton: !0,
       buttonsStyling: !1,
