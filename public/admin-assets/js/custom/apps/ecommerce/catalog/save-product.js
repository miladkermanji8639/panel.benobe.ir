   ...
   [
    ...
    (() => {
     ...
     (e = FormValidation.formValidation(t, {
      fields: {
       product_name: {
        validators: { notEmpty: { message: 'نام محصول الزامی است' } },
       },
       sku: { validators: { notEmpty: { message: 'SKU مورد نیاز است' } } },
       sku: {
        validators: { notEmpty: { message: 'بارکد محصول مورد نیاز است' } },
       },
       shelf: {
        validators: { notEmpty: { message: 'مقدار قفسه مورد نیاز است' } },
       },
       price: {
        validators: { notEmpty: { message: 'قیمت پایه محصول الزامی است' } },
       },
       tax: {
        validators: {
         notEmpty: { message: 'طبقه مالیات محصول مورد نیاز است' },
        },
       },
      },
      plugins: {
         ...
         e.validate().then(function (e) {
          console.log('validated!'),
           'Valid' == e
            ...
            : Swal.fire({
               html:
                'متأسفیم ، به نظر می رسد برخی خطاها شناسایی شده است ، لطفاً دوباره امتحان کنید. <br/><br/>لطفا توجه داشته باشید که ممکن است خطاهایی در <strong>عمومی</strong> یا <strong>پیشرفته</strong> tabs',
               icon: 'error',
               buttonsStyling: !1,
               confirmButtonText: 'باشه فهمیدم!',
               customClass: { confirmButton: 'btn btn-primary' },
