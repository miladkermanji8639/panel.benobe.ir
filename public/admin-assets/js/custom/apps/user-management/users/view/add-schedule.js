   ...
   (() => {
    ...
    var i = FormValidation.formValidation(e, {
     fields: {
      event_datetime: {
       validators: {
        notEmpty: { message: 'تاریخ و زمان رویداد مورد نیاز است' },
       },
      },
      event_name: {
      ...
      event_org: {
       validators: {
        notEmpty: { message: 'برگزارکننده رویداد مورد نیاز است' },
       },
      },
      event_invitees: {
       validators: { notEmpty: { message: 'دعوت شدگان رویداد الزامی است' } },
      },
     },
     plugins: {
