  ...
  !(function () {
   ...
   [].slice.call(t).map(function (e) {
    ...
    if (e) {
     ...
     new ApexCharts(e, {
      series: [{ name: 'سود', data: [30, 45, 32, 70, 40] }],
      chart: {
       fontFamily: 'inherit',
       type: 'area',
       height: t,
    ...
    [].slice.call(e).map(function (e) {
     ...
     if (e) {
      var a = e.getAttribute('data-kt-chart-color'),
       ...
       s = KTUtil.getCssVariableValue('--bs-' + a + '-light');
      new ApexCharts(e, {
       series: [{ name: 'سود', data: [40, 40, 30, 30, 35, 35, 50] }],
       chart: {
        fontFamily: 'inherit',
        type: 'area',
        height: t,
     ...
     var t = { self: null, rendered: !1 },
      a = function () {
       var a = parseInt(KTUtil.css(e, 'height')),
        ...
        s = {
         series: [
          { name: 'سود', data: [44, 55, 57, 56, 61, 58] },
          { name: 'درآمد:', data: [76, 85, 101, 98, 87, 105] },
         ],
         chart: {
          fontFamily: 'inherit',
          type: 'bar',
     ...
     var t = { self: null, rendered: !1 },
      a = function () {
       ...
       var a = KTUtil.getCssVariableValue('--bs-gray-500'),
        ...
        s = {
         series: [{ name: 'سود', data: [30, 40, 40, 90, 90, 70, 70] }],
         chart: {
          fontFamily: 'inherit',
          type: 'area',
          height: 350,
     ...
     var t = { self: null, rendered: !1 },
      a = function () {
       ...
       var a = KTUtil.getCssVariableValue('--bs-gray-500'),
        ...
        n = {
         series: [
          { name: 'سود', data: [60, 50, 80, 40, 100, 60] },
          { name: 'درآمد:', data: [70, 60, 110, 40, 50, 70] },
         ],
         chart: {
          fontFamily: 'inherit',
          type: 'area',
     ...
     var t = { self: null, rendered: !1 },
      a = function () {
       ...
       var a = KTUtil.getCssVariableValue('--bs-gray-500'),
        ...
        r = {
         series: [
          { name: 'سود', data: [40, 50, 65, 70, 50, 30] },
          { name: 'درآمد:', data: [-30, -40, -55, -60, -40, -20] },
         ],
         chart: {
          fontFamily: 'inherit',
          type: 'bar',
         ...
         plotOptions: {
          bar: { horizontal: !1, columnWidth: ['12%'], borderRadius: [6, 6] },
         },
         legend: { show: !1 },
         dataLabels: { enabled: !1 },
         stroke: { show: !0, width: 2, colors: ['transparent'] },
       ...
       var a = KTUtil.getCssVariableValue('--bs-gray-500'),
        ...
        l = {
         series: [
          ...
          { name: 'هزینه ها:', type: 'area', data: [50, 80, 60, 90, 50, 70] },
         ],
         chart: {
          fontFamily: 'inherit',
          stacked: !0,
     ...
     var t = { self: null, rendered: !1 },
      a = function () {
       var a = parseInt(KTUtil.css(e, 'height')),
        ...
        h = {
         series: [
          { name: 'سود', data: [30, 30, 50, 50, 35, 35] },
          { name: 'درآمد:', data: [55, 20, 20, 20, 70, 70] },
          { name: 'هزینه ها:', data: [60, 60, 40, 40, 30, 30] },
         ],
         chart: {
          fontFamily: 'inherit',
          type: 'area',
   ...
   (function () {
    ...
    [].slice.call(o).map(function (o) {
     (a = parseInt(KTUtil.css(o, 'height'))),
      ...
      new ApexCharts(o, {
       series: [{ name: 'سود', data: [30, 45, 32, 70, 40, 40, 40] }],
       chart: {
        fontFamily: 'inherit',
        type: 'area',
        height: a,
   ...
   (function () {
    ...
    [].slice.call(e).map(function (e) {
     ...
     if (e) {
      ...
      new ApexCharts(e, {
       series: [{ name: 'سود', data: [30, 25, 45, 30, 55, 55] }],
       chart: {
        fontFamily: 'inherit',
        type: 'area',
        height: t,
     ...
     t = function (e, t) {
      ...
      if (t) {
       var o = t.getAttribute('data-kt-chart-color'),
        ...
        n = {
         series: [{ name: 'سود', data: [30, 30, 60, 25, 25, 40] }],
         chart: {
          fontFamily: 'inherit',
          type: 'area',
          height: a,
    ...
    [].slice.call(e).map(function (e) {
     ...
     if (e) {
      var a = e.getAttribute('data-kt-chart-color'),
       ...
       l = KTUtil.getCssVariableValue('--bs-' + a + '-light');
      new ApexCharts(e, {
       series: [{ name: 'سود', data: [15, 25, 15, 40, 20, 50] }],
       chart: {
        fontFamily: 'inherit',
        type: 'area',
        height: t,
   ...
   (function () {
    ...
    [].slice.call(o).map(function (o) {
     (e = o.getAttribute('data-kt-color')),
      ...
      new ApexCharts(o, {
       series: [
        { name: 'سود', data: [50, 60, 70, 80, 60, 50, 70, 60] },
        { name: 'درآمد:', data: [50, 60, 70, 80, 60, 50, 70, 60] },
       ],
       chart: {
        fontFamily: 'inherit',
        type: 'bar',
   ...
   (function () {
    ...
    [].slice.call(t).map(function (t) {
     (e = parseInt(KTUtil.css(t, 'height'))),
      new ApexCharts(t, {
       series: [
        { name: 'سود', data: [35, 65, 75, 55, 45, 60, 55] },
        { name: 'درآمد:', data: [40, 70, 80, 60, 50, 65, 60] },
       ],
       chart: {
        fontFamily: 'inherit',
        type: 'bar',
