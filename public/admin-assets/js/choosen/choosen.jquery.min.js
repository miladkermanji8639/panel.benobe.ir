  ...
  (AbstractChosen = (function () {
   ...
   return (
    ...
    (AbstractChosen.prototype.outerHTML = function (a) {
     ...
     return a.outerHTML
      ? a.outerHTML
      : ((b = document.createElement('div')), b.appendChild(a), b.innerHTML);
    }),
     ...
     ? this.each(function (c) {
        ...
        return (
         ...
         'destroy' === b
          ...
          : void (e instanceof Chosen || d.data('chosen', new Chosen(this, b)))
        );
       })
     : this;
   },
      ...
      ? ((b = this.result_highlight),
        ...
        this.is_multiple && this.max_selected_options <= this.choices_count()
         ...
         : (this.is_multiple
           ...
           (c =
            this.results_data[b[0].getAttribute('data-option-array-index')]),
           (c.selected = !0),
