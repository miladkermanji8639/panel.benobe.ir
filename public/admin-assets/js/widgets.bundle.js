   ...
   if (t) {
    var a = t.hasAttribute('data-kt-negative-color')
     ...
     i = {
      ...
      plotOptions: {
       bar: { columnWidth: '35%', barHeight: '70%', borderRadius: [6, 6] },
      },
      legend: { show: !1 },
      dataLabels: { enabled: !1 },
      xaxis: {
  ...
  r = function (e, t, a, l, r) {
   ...
   if (o) {
    var i = parseInt(KTUtil.css(o, 'height')),
     ...
     d = {
      series: [{ name: 'به هدف دست یافت', data: l }],
      chart: {
       fontFamily: 'inherit',
       type: 'bar',
       height: i,
    ...
    if (e) {
     var t,
      a = function () {
       ...
       a.set('cursor', am5xy.XYCursor.new(t, { behavior: 'none' })).lineY.set(
        'visible',
        !1,
       );
       var l = [
       ...
       r
        ...
        r.data.setAll(l);
       var o = a.yAxes.push(
        am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }),
       );
       function i(e, i, s) {
        var n = a.series.push(
   ...
   if ('undefined' != typeof am5) {
    ...
    e &&
     am5.ready(function () {
      ...
      var s = a.yAxes.push(
       am5xy.CategoryAxis.new(t, { categoryField: 'category', renderer: i }),
      );
      s.data.setAll(l);
      var n = a.series.push(
         ...
         [
          {
           ...
           visits: 725,
           icon:
            'https://www.amcharts.com/wp-content/uploads/flags/united-states.svg',
           columnSettings: {
            fill: am5.color(KTUtil.getCssVariableValue('--bs-primary')),
           },
          },
          {
           ...
           visits: 625,
           icon:
            'https://www.amcharts.com/wp-content/uploads/flags/united-kingdom.svg',
           columnSettings: {
            fill: am5.color(KTUtil.getCssVariableValue('--bs-primary')),
           },
          },
          ...
          },
          {
           ...
           visits: 322,
           icon:
            'https://www.amcharts.com/wp-content/uploads/flags/germany.svg',
           columnSettings: {
            fill: am5.color(KTUtil.getCssVariableValue('--bs-primary')),
           },
          },
       ...
       var a = t.container.children.push(
        ...
        l =
         ...
         [
          ...
          { country: 'چین', visits: 602 },
          { country: 'ژاپن', visits: 509 },
          { country: 'آلمان', visits: 322 },
          { country: 'فرانسه', visits: 214 },
          { country: 'هند', visits: 204 },
          { country: 'Spain', visits: 198 },
          { country: 'ایتالیا', visits: 165 },
          { country: 'Russia', visits: 130 },
          { country: 'نروژ', visits: 93 },
     ...
     if (t) {
      var a = function () {
       ...
       i.labels.template.setAll({
        ...
        i.grid.template.setAll({ forceHidden: !0 });
       var s = a.yAxes.push(
        am5xy.CategoryAxis.new(e, { categoryField: 'category', renderer: i }),
       );
       s.data.setAll(l);
       var n = a.series.push(
  ...
  t = function () {
   ...
   if (t) {
    var a = t.getAttribute('data-kt-chart-color'),
     ...
     n = {
      series: [
       { name: 'Overview', data: [15, 15, 45, 45, 25, 25, 55, 55, 20, 20, 37] },
      ],
      chart: {
       fontFamily: 'inherit',
       type: 'area',
      ...
      series: [
       {
        ...
        data: [
         34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5,
         35, 35, 35.4, 35.4, 35,
        ],
       },
      ],
 ...
 var e = function (e, t, a, l) {
  ...
  if (r) {
   ...
   var o = {
     ...
     plotOptions: {
      pie: { donut: { size: '50%', labels: { value: { fontSize: '10px' } } } },
     },
     colors: [
     ...
     var t,
      a = function () {
       ...
       m.columns.template.setAll({
        tooltipText:
         "مردها, سن {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)",
        tooltipX: am5.p100,
        cornerRadiusBR: 4,
        cornerRadiusTR: 4,
        cornerRadiusBL: 0,
       ...
       c.columns.template.setAll({
        tooltipText:
         "مردها, سن {categoryY}: {female} ({femalePercent.formatNumber('#.0s')}%)",
        tooltipX: am5.p100,
        cornerRadiusBR: 4,
        cornerRadiusTR: 4,
        cornerRadiusBL: 0,
    ...
    if (e) {
     var t,
      a = function () {
       ...
       var m = [
        { name: 'اپن لاین', value1: 160.2, value2: 26.9 },
        { name: 'یارن', value1: 120.1, value2: 50.5 },
        { name: 'گود سیلر', value1: 150.7, value2: 12.3 },
        { name: 'کاندکس', value1: 69.4, value2: 74.5 },
        { name: 'اپن تچ', value1: 78.5, value2: 29.7 },
        { name: 'گلدکس', value1: 77.6, value2: 102.2 },
        { name: 'ایزدوم', value1: 69.8, value2: 22.6 },
        { name: 'پلاس', value1: 63.6, value2: 45.3 },
        { name: 'کانوس', value1: 59.7, value2: 12.8 },
        { name: 'زیگوتی', value1: 64.3, value2: 19.6 },
        { name: 'استندریکس', value1: 52.9, value2: 96.3 },
        { name: 'کاندکس', value1: 42.9, value2: 11.9 },
        { name: 'زندکوریشن', value1: 40.9, value2: 16.8 },
        { name: 'ایزتریک', value1: 39.2, value2: 9.9 },
        { name: 'تریک', value1: 76.6, value2: 36.9 },
        { name: 'سامس', value1: 34.8, value2: 14.6 },
        { name: 'لکسوس', value1: 32.1, value2: 35.6 },
        { name: 'سانمکس', value1: 31.8, value2: 5.9 },
        { name: 'فاکس', value1: 29.3, value2: 14.7 },
        { name: 'دانور', value1: 23, value2: 2.8 },
        { name: 'وارفیس', value1: 21.5, value2: 12.1 },
        { name: 'دانکویت', value1: 19.7, value2: 10.8 },
        { name: 'نام زیز', value1: 15.5, value2: 4.1 },
        { name: 'کوریشن', value1: 14.2, value2: 11.3 },
       ];
       s.data.setAll(m),
        n.data.setAll(m),
        r.data.setAll(m),
     ...
     if (e) {
      var t,
       a = function () {
        ...
        var m = [
         { name: 'اپن لاین', value1: 160.2, value2: 66.9 },
         { name: 'یارن', value1: 150.1, value2: 50.5 },
         { name: 'گود سیلر', value1: 120.7, value2: 32.3 },
         { name: 'کاندکس', value1: 89.4, value2: 74.5 },
         { name: 'اپن تچ', value1: 78.5, value2: 29.7 },
         { name: 'گلدکس', value1: 77.6, value2: 102.2 },
         { name: 'ایزدوم', value1: 69.8, value2: 22.6 },
         { name: 'پلاس', value1: 63.6, value2: 45.3 },
         { name: 'کانوس', value1: 59.7, value2: 12.8 },
         { name: 'زیگوتی', value1: 54.3, value2: 19.6 },
         { name: 'استندریکس', value1: 52.9, value2: 96.3 },
         { name: 'کاندکس', value1: 42.9, value2: 11.9 },
         { name: 'زندکوریشن', value1: 40.9, value2: 16.8 },
         { name: 'ایزتریک', value1: 39.2, value2: 9.9 },
         { name: 'تریک', value1: 36.6, value2: 36.9 },
         { name: 'سامس', value1: 34.8, value2: 14.6 },
         { name: 'لکسوس', value1: 32.1, value2: 35.6 },
         { name: 'سانمکس', value1: 31.8, value2: 5.9 },
         { name: 'فاکس', value1: 29.3, value2: 14.7 },
   ...
   if (t) {
    var a = KTUtil.getCssVariableValue('--bs-gray-800'),
     ...
     r = {
      ...
      xaxis: {
       categories: ['USA', 'هند', 'Canada', 'Brasil', 'فرانسه'],
       labels: {
        formatter: function (e) {
         return e + 'K';
        },
...
var KTChartsWidget33 = (function () {
 ...
 return {
  init: function () {
   var i = [
     2100, 3200, 3200, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 3e3, 3e3,
     3250, 3250,
    ],
    s = [
     '10AM',
   ...
   var g = [
     1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300, 2400, 2400, 3e3,
     3200, 3100,
    ],
    f = [
     'Jun 2021',
   ...
   var u = [
     3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3,
     2400, 2800,
    ],
    p = [
     'Sep 2021',
...
var KTChartsWidget34 = (function () {
 ...
 return {
  init: function () {
   ...
   var g = [
     1800, 1800, 2400, 2400, 3100, 3100, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3,
     3200, 3100,
    ],
    f = [
     'Jun 2021',
   ...
   var u = [
     3e3, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3,
     2400, 2800,
    ],
    p = [
     'Sep 2021',
...
var KTChartsWidget35 = (function () {
 ...
 return {
  init: function () {
   ...
   var g = [
     1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3,
     3200, 3100,
    ],
    f = [
     'Jun 2021',
   ...
   var u = [
     3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400, 2400, 3250, 3e3,
     2400, 2800,
    ],
    p = [
     'Sep 2021',
  ...
  t = function () {
   ...
   if (t) {
    var a = parseInt(KTUtil.css(t, 'height')),
     ...
     r = KTUtil.getCssVariableValue('--bs-border-dashed-color'),
     o = {
      series: [{ name: 'LOI صادر شد', data: [54, 42, 75, 110, 23, 87, 50] }],
      chart: {
       fontFamily: 'inherit',
       type: 'bar',
       height: a,
  ...
  t = function () {
   ...
   if (t) {
    var a = t.getAttribute('data-kt-chart-color'),
     ...
     n = {
      series: [
       { name: 'Overview', data: [30, 30, 45, 45, 35, 35, 25, 25, 50, 50] },
      ],
      chart: {
       fontFamily: 'inherit',
       type: 'area',
   ...
   if (t) {
    var a = t.hasAttribute('data-kt-negative-color')
     ...
     i = {
      ...
      plotOptions: {
       bar: { columnWidth: '35%', barHeight: '70%', borderRadius: [4, 4] },
      },
      legend: { show: !1 },
      dataLabels: { enabled: !1 },
      xaxis: {
   ...
   if (t) {
    var a = KTUtil.getCssVariableValue('--bs-border-dashed-color'),
     l = {
      ...
      plotOptions: {
       bar: { borderRadius: 4, horizontal: !0, distributed: !0, barHeight: 23 },
      },
      dataLabels: { enabled: !1 },
      legend: { show: !1 },
      colors: [
    ...
    var a = parseInt(KTUtil.css(t, 'height')),
     ...
     s = {
      series: [
       ...
       { name: 'درآمد:', data: [12, 16, 16, 21, 21, 18, 18] },
      ],
      chart: {
       fontFamily: 'inherit',
       type: 'area',
      ...
      '#kt_timeline_widget_1_tab_week' === e.getAttribute('href') &&
       (() => {
        ...
        var a = Date.now(),
         ...
         r = new vis.DataSet([
          { id: 1, content: 'تحقیقات', order: 1 },
          { id: 2, content: 'فاز 2.6 QA', order: 2 },
          { id: 3, content: 'طراحی', order: 3 },
          { id: 4, content: 'توسعه', order: 4 },
         ]),
         o = new vis.DataSet([
          {
           id: 1,
       ...
       '#kt_timeline_widget_1_tab_month' === e.getAttribute('href') &&
        (() => {
         ...
         var a = Date.now(),
          l = e.getAttribute('data-kt-timeline-widget-1-image-root'),
          r = new vis.DataSet([
           { id: 'research', content: 'تحقیقات', order: 1 },
           { id: 'qa', content: 'فاز 2.6 QA', order: 2 },
           { id: 'ui', content: 'طراحی', order: 3 },
           { id: 'dev', content: 'توسعه', order: 4 },
          ]),
          o = new vis.DataSet([
           {
            id: 1,
