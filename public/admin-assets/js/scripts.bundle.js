  ...
  init: function () {
   ...
   !(function () {
      ...
      function (e) {
       if (
        ...
        var t = this.getAttribute('data-kt-toggle-text'),
         n =
          (n = this.querySelector('[data-kt-toggle-text-target="true"]')) ||
          this;
    ...
    [].slice.call(document.querySelectorAll('.toast')).map(function (e) {
     if ('1' !== e.getAttribute('data-kt-initialized'))
      return (
       e.setAttribute('data-kt-initialized', '1'), new bootstrap.Toast(e, {})
      );
    }),
    (function () {
 ...
 KTMenu = function (e, t) {
  ...
  if (null != e) {
   var i = {
    ...
    f = function (e) {
     return (
      KTUtil.hasClass(e, 'menu-item') && e.hasAttribute('data-kt-menu-trigger')
     );
    },
    p = function (e) {
  ...
  if (e) {
   var i = { saveState: !0 },
    ...
    d = function () {
     ...
     return (
      null !== o && 'object' != typeof o && (t -= parseInt(o)), String(t) + 'px'
     );
    },
    c = function (e) {
     var t = 0;
  ...
  var i = {
   ...
   a = function () {
    n.element.classList.add('focus'),
     (!0 === g('show-on-focus') || n.inputElement.value.length >= minLength) &&
      f();
   },
   l = function () {
  ...
  colorLighten: function (e, t) {
   const n = function (e, t) {
    let n = parseInt(e, 16) + t,
     i = n > 255 ? 255 : n;
    return (
     (i = i.toString(16).length > 1 ? i.toString(16) : `0${i.toString(16)}`), i
    );
   };
   return (
     ...
     r.addEventListener('click', function (i) {
      i.preventDefault(),
       toastr.success(
        ...
        'Generating HTML!',
        { timeOut: 0, extendedTimeOut: 0, closeButton: !0, closeDuration: 0 },
       ),
 ...
 var e,
  ...
  i = function (i, r) {
   ...
   document.documentElement.setAttribute(
    ...
    i !== l &&
     KTEventHandler.trigger(document.documentElement, 'kt.thememode.change', t);
  },
  r = function () {
   if (!e) return null;
  ...
  init: function () {
   ...
   null !== e) &&
    ...
    i &&
     ...
     i.scroll({ top: KTUtil.getRelativeTopPosition(l, i), behavior: 'smooth' }),
    n &&
