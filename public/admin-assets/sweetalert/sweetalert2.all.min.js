!(function (t, e) {
 ...
 function H() {
  var t = m(
    W().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),
   ).sort(function (t, e) {
    return (
  ...
  ft = function (t) {
   ...
   if (
    ...
    h.appendChild(n),
     ...
     (a = h),
     'rtl' === window.getComputedStyle(a).direction && st(z(), F.rtl),
     (c = k()),
     (s = lt(c, F.input)),
     (u = lt(c, F.file)),
     (l = c.querySelector('.'.concat(F.range, ' input'))),
     (d = c.querySelector('.'.concat(F.range, ' output'))),
     (p = lt(c, F.select)),
     (f = c.querySelector('.'.concat(F.checkbox, ' input'))),
     (m = lt(c, F.textarea)),
     (s.oninput = it),
     (u.onchange = it),
     (p.onchange = it),
  ...
  if (n) {
   ...
   (o = n),
    'string' == typeof (i = e.backdrop)
     ...
     : i || st([document.documentElement, document.body], F['no-backdrop']),
    !e.backdrop &&
     e.allowOutsideClick &&
     R(
 ...
 (Pt.text =
  ...
  (Pt.range = function (t, e) {
   ...
   return (
    (n.value = e.inputValue), (n.type = e.input), (o.value = e.inputValue), t
   );
  }),
   ...
   s.progressSteps.forEach(function (t, e) {
    var n,
     ...
     a =
      ...
      st(o, F['progress-step']),
      (o.innerHTML = n),
      o);
    if (
     (u.appendChild(a),
     e === l && st(a, F['active-progress-step']),
     e !== s.progressSteps.length - 1)
    ) {
     var c =
      ((i = t),
      (r = document.createElement('li')),
      st(r, F['progress-step-line']),
      i.progressStepsDistance && (r.style.width = i.progressStepsDistance),
      r);
     u.appendChild(c);
    }
   });
 ...
 var Mt = function () {
  ...
  qt = function (t, e) {
   (t.className = ''
    ...
    e.toast
     ? (st([document.documentElement, document.body], F['toast-shown']),
       st(t, F.toast))
     : st(t, F.modal),
    I(t, e, 'popup'),
    'string' == typeof e.customClass && st(t, e.customClass),
    e.icon && st(t, F['icon-'.concat(e.icon)]);
  };
 function Rt() {
  var t = W();
  t || Je.fire(), (t = W());
 ...
 function $t() {
  ...
  if (t) {
   ...
   t.showConfirmButton ||
    ...
    ut([e.popup, e.actions], F.loading),
 ...
 var te = function () {
   ...
   (o.ontouchstart = function (t) {
    ...
    n =
     t.target === o ||
     (!((e = o).scrollHeight > e.clientHeight) && 'INPUT' !== t.target.tagName);
   }),
 ...
 var Ce = function (t, e) {
   ht && et(e)
    ? ((t.style.overflowY = 'hidden'), e.addEventListener(ht, fe))
  ...
  xe = function (t, e, n) {
   st(t, n.showClass.backdrop),
    ...
    st([document.documentElement, document.body], F.shown),
    n.heightAuto &&
     n.backdrop &&
     !n.toast &&
  ...
  ze = function (e, n, o) {
   e.container.onclick = function (t) {
    Ue
     ? (Ue = !1)
     : t.target === e.container && D(n.allowOutsideClick) && o(U.backdrop);
   };
  };
     ...
     for (var e in t)
      Ft((i = e)) || R('Unknown parameter "'.concat(i, '"')),
       t.toast &&
        ((o = e),
        -1 !== Zt.indexOf(o) &&
         R('The parameter "'.concat(o, '" is incompatible with toasts'))),
       _t((n = e)) && h(n, _t(n));
     var n, o, i;
    })(t),
     W() &&
