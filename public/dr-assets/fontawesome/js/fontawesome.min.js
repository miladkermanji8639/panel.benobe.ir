...
!(function () {
    ...
    a.found && n.found
     ? ((k = (w = V).children),
       ...
       (I = {
        ...
        children: [
         Et(Q({ tag: M.tag, attributes: Q({}, M.attributes, j.path) }, R)),
        ],
       }),
        ...
        children: [
         {
          ...
          attributes: Q({}, X, {
           id:
            !0 === B
             ? ''.concat(U, '-').concat($.familyPrefix, '-').concat(W)
             : B,
          }),
          children: q,
         },
 ...
 function Lt(t) {
  ...
  return (
   ...
   i &&
    x.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [i] }),
   x
  );
 }
 var Rt = function () {},
   ...
   Xt = Ft(
    ...
    function (t, e) {
     var n = e[0],
      ...
      r = e[2];
     return (
      'far' !== a || i || (a = 'fas'), (t[n] = { prefix: a, iconName: r }), t
     );
    },
    {},
   );
  ...
  ge = {
   ...
   children: [
    ...
    },
    {
     ...
     children: [
      { tag: 'animate', attributes: Q({}, he, { values: '1;0;0;0;0;1;' }) },
     ],
    },
    {
     tag: 'path',
     ...
     children: [
      { tag: 'animate', attributes: Q({}, he, { values: '0;0;1;1;0;0;' }) },
     ],
    },
   ],
  },
  ...
  return new vt(function (t, e) {
   ...
   'object' === i(g.FontAwesomeKitConfig) &&
    ...
    a && r && !$.showMissingIcons
     ? e(
        new ue(
         'Icon is missing for prefix '.concat(r, ' with icon name ').concat(a),
        ),
       )
     : t(n);
  });
  ...
  Te =
   ...
   function (t) {
    var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
     ...
     a = e.mask;
    return (
     a && (a = (a || {}).icon ? a : je(a || {})), Le(n, Q({}, e, { mask: a }))
    );
   }),
  Ye = {
   noAuto: function () {
