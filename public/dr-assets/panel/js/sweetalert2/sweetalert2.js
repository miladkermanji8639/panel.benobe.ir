!(function (t, e) {
 ...
 function R() {
  var t = g(
    A().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),
   ).sort(function (t, e) {
    return (
 ...
 var Ve = ['swal-title', 'swal-html', 'swal-footer'],
    ...
    g(t.querySelectorAll('swal-button')).forEach(function (t) {
     ...
     (n[''.concat(e, 'ButtonText')] = t.innerHTML),
      ...
      t.hasAttribute('aria-label') &&
       (n[''.concat(e, 'ButtonAriaLabel')] = t.getAttribute('aria-label'));
    }),
    n
   );
  },
  ...
  gn = function (t) {
   -1 !== [T(), L(), q()].indexOf(document.activeElement) &&
    ((t =
     -1 !== ln.indexOf(t) ? 'nextElementSibling' : 'previousElementSibling'),
