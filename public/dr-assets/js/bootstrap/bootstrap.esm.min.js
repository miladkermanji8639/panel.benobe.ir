 ...
 allowedAttribute = (e, t) => {
  ...
  if (t.includes(n))
   return (
    !uriAttrs.has(n) ||
    Boolean(
     SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue),
    )
   );
...
class Tooltip extends BaseComponent {
 ...
 getTipElement() {
  ...
  const e = document.createElement('div');
  return (
   (e.innerHTML = this._config.template), (this.tip = e.children[0]), this.tip
  );
 }
 setContent() {
  const e = this.getTipElement();
...
class Tab extends BaseComponent {
 ...
 show() {
  ...
  if (n) {
   const t =
    'UL' === n.nodeName || 'OL' === n.nodeName ? SELECTOR_ACTIVE_UL : '.active';
